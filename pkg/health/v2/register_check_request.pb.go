...
// 	protoc        (unknown)
// source: health/v2/register_check_request.proto
...
func (x *RegisterCheckRequest) Reset() {
	*x = RegisterCheckRequest{}
	mi := &file_health_v2_register_check_request_proto_msgTypes[0]
...
var File_health_v2_register_check_request_proto protoreflect.FileDescriptor

const file_health_v2_register_check_request_proto_rawDesc = "" +
	"\n" +
	"&health/v2/register_check_request.proto\x12\thealth.v2\x1a\x1chealth/v2/health_check.proto\x1a common/v2/request_metadata.proto\x1a!google/protobuf/go_features.proto\"\xb4\x01\n" +
...
var file_health_v2_register_check_request_proto_depIdxs = []int32{
...
func init() { file_health_v2_register_check_request_proto_init() }
func file_health_v2_register_check_request_proto_init() {
	if File_health_v2_register_check_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_health_v2_register_check_request_proto_rawDesc), len(file_health_v2_register_check_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_health_v2_register_check_request_proto_goTypes,
		DependencyIndexes: file_health_v2_register_check_request_proto_depIdxs,
		MessageInfos:      file_health_v2_register_check_request_proto_msgTypes,
	}.Build()
	File_health_v2_register_check_request_proto = out.File
	file_health_v2_register_check_request_proto_goTypes = nil
	file_health_v2_register_check_request_proto_depIdxs = nil
}
