...
// 	protoc        (unknown)
// source: health/v2/liveness_check.proto
...
func (x *LivenessCheck) Reset() {
	*x = LivenessCheck{}
	mi := &file_health_v2_liveness_check_proto_msgTypes[0]
...
var File_health_v2_liveness_check_proto protoreflect.FileDescriptor

const file_health_v2_liveness_check_proto_rawDesc = "" +
	"\n" +
	"\x1ehealth/v2/liveness_check.proto\x12\thealth.v2\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x95\x03\n" +
...
var file_health_v2_liveness_check_proto_depIdxs = []int32{
...
func init() { file_health_v2_liveness_check_proto_init() }
func file_health_v2_liveness_check_proto_init() {
	if File_health_v2_liveness_check_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_health_v2_liveness_check_proto_rawDesc), len(file_health_v2_liveness_check_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_health_v2_liveness_check_proto_goTypes,
		DependencyIndexes: file_health_v2_liveness_check_proto_depIdxs,
		MessageInfos:      file_health_v2_liveness_check_proto_msgTypes,
	}.Build()
	File_health_v2_liveness_check_proto = out.File
	file_health_v2_liveness_check_proto_goTypes = nil
	file_health_v2_liveness_check_proto_depIdxs = nil
}
