...
// 	protoc        (unknown)
// source: health/v2/health_metrics.proto
...
func (x *HealthMetrics) Reset() {
	*x = HealthMetrics{}
	mi := &file_health_v2_health_metrics_proto_msgTypes[0]
...
func (x *ServiceHealthMetrics) Reset() {
	*x = ServiceHealthMetrics{}
	mi := &file_health_v2_health_metrics_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_health_v2_health_metrics_proto protoreflect.FileDescriptor

const file_health_v2_health_metrics_proto_rawDesc = "" +
	"\n" +
	"\x1ehealth/v2/health_metrics.proto\x12\thealth.v2\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa9\x05\n" +
	"\rHealthMetrics\x12=\n" +
...
var file_health_v2_health_metrics_proto_depIdxs = []int32{
...
func init() { file_health_v2_health_metrics_proto_init() }
func file_health_v2_health_metrics_proto_init() {
	if File_health_v2_health_metrics_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_health_v2_health_metrics_proto_rawDesc), len(file_health_v2_health_metrics_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_health_v2_health_metrics_proto_goTypes,
		DependencyIndexes: file_health_v2_health_metrics_proto_depIdxs,
		MessageInfos:      file_health_v2_health_metrics_proto_msgTypes,
	}.Build()
	File_health_v2_health_metrics_proto = out.File
	file_health_v2_health_metrics_proto_goTypes = nil
	file_health_v2_health_metrics_proto_depIdxs = nil
}
