...
// 	protoc        (unknown)
// source: health/v2/health_check_request.proto
...
func (x *HealthCheckRequest) Reset() {
	*x = HealthCheckRequest{}
	mi := &file_health_v2_health_check_request_proto_msgTypes[0]
...
var File_health_v2_health_check_request_proto protoreflect.FileDescriptor

const file_health_v2_health_check_request_proto_rawDesc = "" +
	"\n" +
	"$health/v2/health_check_request.proto\x12\thealth.v2\x1a common/v2/request_metadata.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\"\xc8\x02\n" +
	...
	"\x04tags\x18\b \x03(\tR\x04tagsB1Z'github.com/jdfalk/gcommon/pkg/health/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_health_v2_health_check_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_health_v2_health_check_request_proto_goTypes = []any{
	(*HealthCheckRequest)(nil),  // 0: health.v2.HealthCheckRequest
	(*v2.RequestMetadata)(nil),  // 1: common.v2.RequestMetadata
	(*durationpb.Duration)(nil), // 2: google.protobuf.Duration
}
var file_health_v2_health_check_request_proto_depIdxs = []int32{
...
func init() { file_health_v2_health_check_request_proto_init() }
func file_health_v2_health_check_request_proto_init() {
	if File_health_v2_health_check_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_health_v2_health_check_request_proto_rawDesc), len(file_health_v2_health_check_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_health_v2_health_check_request_proto_goTypes,
		DependencyIndexes: file_health_v2_health_check_request_proto_depIdxs,
		MessageInfos:      file_health_v2_health_check_request_proto_msgTypes,
	}.Build()
	File_health_v2_health_check_request_proto = out.File
	file_health_v2_health_check_request_proto_goTypes = nil
	file_health_v2_health_check_request_proto_depIdxs = nil
}
