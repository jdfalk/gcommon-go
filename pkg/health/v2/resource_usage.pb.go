...
// 	protoc        (unknown)
// source: health/v2/resource_usage.proto
...
func (x *ResourceUsage) Reset() {
	*x = ResourceUsage{}
	mi := &file_health_v2_resource_usage_proto_msgTypes[0]
...
func (x *CpuUsage) Reset() {
	*x = CpuUsage{}
	mi := &file_health_v2_resource_usage_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *MemoryUsage) Reset() {
	*x = MemoryUsage{}
	mi := &file_health_v2_resource_usage_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *DiskUsage) Reset() {
	*x = DiskUsage{}
	mi := &file_health_v2_resource_usage_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *NetworkUsage) Reset() {
	*x = NetworkUsage{}
	mi := &file_health_v2_resource_usage_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_health_v2_resource_usage_proto protoreflect.FileDescriptor

const file_health_v2_resource_usage_proto_rawDesc = "" +
	"\n" +
	"\x1ehealth/v2/resource_usage.proto\x12\thealth.v2\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa9\x02\n" +
	"\rResourceUsage\x12=\n" +
...
var file_health_v2_resource_usage_proto_depIdxs = []int32{
...
func init() { file_health_v2_resource_usage_proto_init() }
func file_health_v2_resource_usage_proto_init() {
	if File_health_v2_resource_usage_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_health_v2_resource_usage_proto_rawDesc), len(file_health_v2_resource_usage_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_health_v2_resource_usage_proto_goTypes,
		DependencyIndexes: file_health_v2_resource_usage_proto_depIdxs,
		MessageInfos:      file_health_v2_resource_usage_proto_msgTypes,
	}.Build()
	File_health_v2_resource_usage_proto = out.File
	file_health_v2_resource_usage_proto_goTypes = nil
	file_health_v2_resource_usage_proto_depIdxs = nil
}
