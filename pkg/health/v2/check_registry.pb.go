...
// 	protoc        (unknown)
// source: health/v2/check_registry.proto
...
func (x *CheckRegistry) Reset() {
	*x = CheckRegistry{}
	mi := &file_health_v2_check_registry_proto_msgTypes[0]
...
var File_health_v2_check_registry_proto protoreflect.FileDescriptor

const file_health_v2_check_registry_proto_rawDesc = "" +
	"\n" +
	"\x1ehealth/v2/check_registry.proto\x12\thealth.v2\x1a\x1chealth/v2/health_check.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf2\x02\n" +
	"\rCheckRegistry\x12<\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x16.health.v2.HealthCheckR\x05value:\x028\x01B1Z'github.com/jdfalk/gcommon/pkg/health/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_health_v2_check_registry_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_health_v2_check_registry_proto_goTypes = []any{
...
var file_health_v2_check_registry_proto_depIdxs = []int32{
...
func init() { file_health_v2_check_registry_proto_init() }
func file_health_v2_check_registry_proto_init() {
	if File_health_v2_check_registry_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_health_v2_check_registry_proto_rawDesc), len(file_health_v2_check_registry_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_health_v2_check_registry_proto_goTypes,
		DependencyIndexes: file_health_v2_check_registry_proto_depIdxs,
		MessageInfos:      file_health_v2_check_registry_proto_msgTypes,
	}.Build()
	File_health_v2_check_registry_proto = out.File
	file_health_v2_check_registry_proto_goTypes = nil
	file_health_v2_check_registry_proto_depIdxs = nil
}
