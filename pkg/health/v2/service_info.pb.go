...
// 	protoc        (unknown)
// source: health/v2/service_info.proto
...
func (x *ServiceInfo) Reset() {
	*x = ServiceInfo{}
	mi := &file_health_v2_service_info_proto_msgTypes[0]
...
var File_health_v2_service_info_proto protoreflect.FileDescriptor

const file_health_v2_service_info_proto_rawDesc = "" +
	"\n" +
	"\x1chealth/v2/service_info.proto\x12\thealth.v2\x1a\x1dhealth/v2/health_status.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa1\x04\n" +
...
var file_health_v2_service_info_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_health_v2_service_info_proto_goTypes = []any{
...
var file_health_v2_service_info_proto_depIdxs = []int32{
...
func init() { file_health_v2_service_info_proto_init() }
func file_health_v2_service_info_proto_init() {
	if File_health_v2_service_info_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_health_v2_service_info_proto_rawDesc), len(file_health_v2_service_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_health_v2_service_info_proto_goTypes,
		DependencyIndexes: file_health_v2_service_info_proto_depIdxs,
		MessageInfos:      file_health_v2_service_info_proto_msgTypes,
	}.Build()
	File_health_v2_service_info_proto = out.File
	file_health_v2_service_info_proto_goTypes = nil
	file_health_v2_service_info_proto_depIdxs = nil
}
