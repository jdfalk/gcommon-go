...
// 	protoc        (unknown)
// source: health/v2/check_type.proto
...
func (CheckType) Descriptor() protoreflect.EnumDescriptor {
	return file_health_v2_check_type_proto_enumTypes[0].Descriptor()
}

func (CheckType) Type() protoreflect.EnumType {
	return &file_health_v2_check_type_proto_enumTypes[0]
}
...
var File_health_v2_check_type_proto protoreflect.FileDescriptor

const file_health_v2_check_type_proto_rawDesc = "" +
	"\n" +
	"\x1ahealth/v2/check_type.proto\x12\thealth.v2\x1a!google/protobuf/go_features.proto*\xed\x01\n" +
	"\tCheckType\x12\x1a\n" +
	...
	"\x11CHECK_TYPE_CUSTOM\x10\bB1Z'github.com/jdfalk/gcommon/pkg/health/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_health_v2_check_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_health_v2_check_type_proto_goTypes = []any{
	(CheckType)(0), // 0: health.v2.CheckType
}
var file_health_v2_check_type_proto_depIdxs = []int32{
...
func init() { file_health_v2_check_type_proto_init() }
func file_health_v2_check_type_proto_init() {
	if File_health_v2_check_type_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_health_v2_check_type_proto_rawDesc), len(file_health_v2_check_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_health_v2_check_type_proto_goTypes,
		DependencyIndexes: file_health_v2_check_type_proto_depIdxs,
		EnumInfos:         file_health_v2_check_type_proto_enumTypes,
	}.Build()
	File_health_v2_check_type_proto = out.File
	file_health_v2_check_type_proto_goTypes = nil
	file_health_v2_check_type_proto_depIdxs = nil
}
