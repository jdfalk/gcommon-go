...
// 	protoc        (unknown)
// source: health/v1/liveness_check.proto
...
func (x *LivenessCheck) Reset() {
	*x = LivenessCheck{}
	mi := &file_health_v1_liveness_check_proto_msgTypes[0]
...
var File_health_v1_liveness_check_proto protoreflect.FileDescriptor

const file_health_v1_liveness_check_proto_rawDesc = "" +
	"\n" +
	"\x1ehealth/v1/liveness_check.proto\x12\thealth.v1\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x95\x03\n" +
	...
	"\x06active\x18\t \x01(\bR\x06activeB.Z$github.com/jdfalk/gcommon/pkg/health\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_health_v1_liveness_check_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_health_v1_liveness_check_proto_goTypes = []any{
	(*LivenessCheck)(nil),         // 0: health.v1.LivenessCheck
	(*durationpb.Duration)(nil),   // 1: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_health_v1_liveness_check_proto_depIdxs = []int32{
	1, // 0: health.v1.LivenessCheck.interval:type_name -> google.protobuf.Duration
	1, // 1: health.v1.LivenessCheck.timeout:type_name -> google.protobuf.Duration
	1, // 2: health.v1.LivenessCheck.initial_delay:type_name -> google.protobuf.Duration
	2, // 3: health.v1.LivenessCheck.created_at:type_name -> google.protobuf.Timestamp
...
func init() { file_health_v1_liveness_check_proto_init() }
func file_health_v1_liveness_check_proto_init() {
	if File_health_v1_liveness_check_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_health_v1_liveness_check_proto_rawDesc), len(file_health_v1_liveness_check_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_health_v1_liveness_check_proto_goTypes,
		DependencyIndexes: file_health_v1_liveness_check_proto_depIdxs,
		MessageInfos:      file_health_v1_liveness_check_proto_msgTypes,
	}.Build()
	File_health_v1_liveness_check_proto = out.File
	file_health_v1_liveness_check_proto_goTypes = nil
	file_health_v1_liveness_check_proto_depIdxs = nil
}
