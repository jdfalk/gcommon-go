...
func (x *WatchHealthResponse) Reset() {
	*x = WatchHealthResponse{}
	mi := &file_health_v1_watch_health_response_proto_msgTypes[0]
...
var File_health_v1_watch_health_response_proto protoreflect.FileDescriptor

const file_health_v1_watch_health_response_proto_rawDesc = "" +
	"\n" +
	"%health/v1/watch_health_response.proto\x12\thealth.v1\x1a\x1dhealth/v1/health_result.proto\x1a\x1chealth/v1/health_event.proto\x1a!common/v1/response_metadata.proto\x1a!google/protobuf/go_features.proto\"\xce\x01\n" +
...
func init() { file_health_v1_watch_health_response_proto_init() }
func file_health_v1_watch_health_response_proto_init() {
	if File_health_v1_watch_health_response_proto != nil {
		return
	}
	file_health_v1_health_result_proto_init()
	file_health_v1_health_event_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_health_v1_watch_health_response_proto_rawDesc), len(file_health_v1_watch_health_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_health_v1_watch_health_response_proto_goTypes,
		DependencyIndexes: file_health_v1_watch_health_response_proto_depIdxs,
		MessageInfos:      file_health_v1_watch_health_response_proto_msgTypes,
	}.Build()
	File_health_v1_watch_health_response_proto = out.File
	file_health_v1_watch_health_response_proto_goTypes = nil
	file_health_v1_watch_health_response_proto_depIdxs = nil
}
