...
// 	protoc        (unknown)
// source: health/v1/check_registry.proto
...
func (x *CheckRegistry) Reset() {
	*x = CheckRegistry{}
	mi := &file_health_v1_check_registry_proto_msgTypes[0]
...
var File_health_v1_check_registry_proto protoreflect.FileDescriptor

const file_health_v1_check_registry_proto_rawDesc = "" +
	"\n" +
	"\x1ehealth/v1/check_registry.proto\x12\thealth.v1\x1a\x1chealth/v1/health_check.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf2\x02\n" +
	"\rCheckRegistry\x12<\n" +
	"\x06checks\x18\x01 \x03(\v2$.health.v1.CheckRegistry.ChecksEntryR\x06checks\x12!\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x16.health.v1.HealthCheckR\x05value:\x028\x01B.Z$github.com/jdfalk/gcommon/pkg/health\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_health_v1_check_registry_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_health_v1_check_registry_proto_goTypes = []any{
	(*CheckRegistry)(nil),         // 0: health.v1.CheckRegistry
	nil,                           // 1: health.v1.CheckRegistry.ChecksEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*HealthCheck)(nil),           // 3: health.v1.HealthCheck
}
var file_health_v1_check_registry_proto_depIdxs = []int32{
	1, // 0: health.v1.CheckRegistry.checks:type_name -> health.v1.CheckRegistry.ChecksEntry
	2, // 1: health.v1.CheckRegistry.last_updated:type_name -> google.protobuf.Timestamp
	3, // 2: health.v1.CheckRegistry.ChecksEntry.value:type_name -> health.v1.HealthCheck
...
func init() { file_health_v1_check_registry_proto_init() }
func file_health_v1_check_registry_proto_init() {
	if File_health_v1_check_registry_proto != nil {
		return
	}
	file_health_v1_health_check_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_health_v1_check_registry_proto_rawDesc), len(file_health_v1_check_registry_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_health_v1_check_registry_proto_goTypes,
		DependencyIndexes: file_health_v1_check_registry_proto_depIdxs,
		MessageInfos:      file_health_v1_check_registry_proto_msgTypes,
	}.Build()
	File_health_v1_check_registry_proto = out.File
	file_health_v1_check_registry_proto_goTypes = nil
	file_health_v1_check_registry_proto_depIdxs = nil
}
