...
// 	protoc        (unknown)
// source: health/v1/health_metrics.proto
...
func (x *HealthMetrics) Reset() {
	*x = HealthMetrics{}
	mi := &file_health_v1_health_metrics_proto_msgTypes[0]
...
func (x *ServiceHealthMetrics) Reset() {
	*x = ServiceHealthMetrics{}
	mi := &file_health_v1_health_metrics_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_health_v1_health_metrics_proto protoreflect.FileDescriptor

const file_health_v1_health_metrics_proto_rawDesc = "" +
	"\n" +
	"\x1ehealth/v1/health_metrics.proto\x12\thealth.v1\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa9\x05\n" +
	"\rHealthMetrics\x12=\n" +
	...
	"\x14avg_response_time_ms\x18\x05 \x01(\x01R\x11avgResponseTimeMsB.Z$github.com/jdfalk/gcommon/pkg/health\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_health_v1_health_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_health_v1_health_metrics_proto_goTypes = []any{
...
var file_health_v1_health_metrics_proto_depIdxs = []int32{
...
func init() { file_health_v1_health_metrics_proto_init() }
func file_health_v1_health_metrics_proto_init() {
	if File_health_v1_health_metrics_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_health_v1_health_metrics_proto_rawDesc), len(file_health_v1_health_metrics_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_health_v1_health_metrics_proto_goTypes,
		DependencyIndexes: file_health_v1_health_metrics_proto_depIdxs,
		MessageInfos:      file_health_v1_health_metrics_proto_msgTypes,
	}.Build()
	File_health_v1_health_metrics_proto = out.File
	file_health_v1_health_metrics_proto_goTypes = nil
	file_health_v1_health_metrics_proto_depIdxs = nil
}
