...
// 	protoc        (unknown)
// source: commonpb/v1/filter_value.proto
...
type FilterValue struct {
	...
	xxx_hidden_Operation FilterOperation        `protobuf:"varint,7,opt,name=operation,enum=common.v1.FilterOperation"`
...
func (x *FilterValue) Reset() {
	*x = FilterValue{}
	mi := &file_commonpb_v1_filter_value_proto_msgTypes[0]
...
func (x case_FilterValue_Value) String() string {
	md := file_commonpb_v1_filter_value_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_commonpb_v1_filter_value_proto protoreflect.FileDescriptor

const file_commonpb_v1_filter_value_proto_rawDesc = "" +
	"\n" +
	"\x1ecommonpb/v1/filter_value.proto\x12\tcommon.v1\x1a\"commonpb/v1/filter_operation.proto\x1a\x1dcommonpb/v1/int64_array.proto\x1a\x1ecommonpb/v1/string_array.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf7\x02\n" +
	"\vFilterValue\x12,\n" +
	...
	"\x05valueB\x96\x01\n" +
	"\rcom.common.v1B\x10FilterValueProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_filter_value_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v1_filter_value_proto_goTypes = []any{
	(*FilterValue)(nil),  // 0: common.v1.FilterValue
	(*StringArray)(nil),  // 1: common.v1.StringArray
	(*Int64Array)(nil),   // 2: common.v1.Int64Array
	(FilterOperation)(0), // 3: common.v1.FilterOperation
}
var file_commonpb_v1_filter_value_proto_depIdxs = []int32{
	1, // 0: common.v1.FilterValue.string_array:type_name -> common.v1.StringArray
	2, // 1: common.v1.FilterValue.int_array:type_name -> common.v1.Int64Array
	3, // 2: common.v1.FilterValue.operation:type_name -> common.v1.FilterOperation
...
func init() { file_commonpb_v1_filter_value_proto_init() }
func file_commonpb_v1_filter_value_proto_init() {
	if File_commonpb_v1_filter_value_proto != nil {
		return
	}
	file_commonpb_v1_filter_operation_proto_init()
	file_commonpb_v1_int64_array_proto_init()
	file_commonpb_v1_string_array_proto_init()
	file_commonpb_v1_filter_value_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_filter_value_proto_rawDesc), len(file_commonpb_v1_filter_value_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_filter_value_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_filter_value_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_filter_value_proto_msgTypes,
	}.Build()
	File_commonpb_v1_filter_value_proto = out.File
	file_commonpb_v1_filter_value_proto_goTypes = nil
	file_commonpb_v1_filter_value_proto_depIdxs = nil
}
