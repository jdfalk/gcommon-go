...
// 	protoc        (unknown)
// source: commonpb/v1/logger_config.proto
...
func (x *LoggerConfig) Reset() {
	*x = LoggerConfig{}
	mi := &file_commonpb_v1_logger_config_proto_msgTypes[0]
...
var File_commonpb_v1_logger_config_proto protoreflect.FileDescriptor

const file_commonpb_v1_logger_config_proto_rawDesc = "" +
	"\n" +
	"\x1fcommonpb/v1/logger_config.proto\x12\tcommon.v1\x1a!commonpb/v1/appender_config.proto\x1a\x1bcommonpb/v1/log_level.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xcf\x02\n" +
	"\fLoggerConfig\x12)\n" +
	...
	"\rcom.common.v1B\x11LoggerConfigProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_logger_config_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_commonpb_v1_logger_config_proto_goTypes = []any{
...
var file_commonpb_v1_logger_config_proto_depIdxs = []int32{
...
func init() { file_commonpb_v1_logger_config_proto_init() }
func file_commonpb_v1_logger_config_proto_init() {
	if File_commonpb_v1_logger_config_proto != nil {
		return
	}
	file_commonpb_v1_appender_config_proto_init()
	file_commonpb_v1_log_level_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_logger_config_proto_rawDesc), len(file_commonpb_v1_logger_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_logger_config_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_logger_config_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_logger_config_proto_msgTypes,
	}.Build()
	File_commonpb_v1_logger_config_proto = out.File
	file_commonpb_v1_logger_config_proto_goTypes = nil
	file_commonpb_v1_logger_config_proto_depIdxs = nil
}
