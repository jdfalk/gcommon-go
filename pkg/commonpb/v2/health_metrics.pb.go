...
// 	protoc        (unknown)
// source: commonpb/v2/health_metrics.proto
...
func (x *HealthMetrics) Reset() {
	*x = HealthMetrics{}
	mi := &file_commonpb_v2_health_metrics_proto_msgTypes[0]
...
var File_commonpb_v2_health_metrics_proto protoreflect.FileDescriptor

const file_commonpb_v2_health_metrics_proto_rawDesc = "" +
	"\n" +
	" commonpb/v2/health_metrics.proto\x12\tcommon.v2\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa4\x04\n" +
	"\rHealthMetrics\x12*\n" +
	...
	"\x05value\x18\x02 \x01(\x01R\x05value:\x028\x01B\x9b\x01\n" +
	"\rcom.common.v2B\x12HealthMetricsProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_health_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_commonpb_v2_health_metrics_proto_goTypes = []any{
	(*HealthMetrics)(nil),         // 0: common.v2.HealthMetrics
	nil,                           // 1: common.v2.HealthMetrics.CustomMetricsEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_commonpb_v2_health_metrics_proto_depIdxs = []int32{
	2, // 0: common.v2.HealthMetrics.last_updated:type_name -> google.protobuf.Timestamp
	1, // 1: common.v2.HealthMetrics.custom_metrics:type_name -> common.v2.HealthMetrics.CustomMetricsEntry
...
func init() { file_commonpb_v2_health_metrics_proto_init() }
func file_commonpb_v2_health_metrics_proto_init() {
	if File_commonpb_v2_health_metrics_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_health_metrics_proto_rawDesc), len(file_commonpb_v2_health_metrics_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_health_metrics_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_health_metrics_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_health_metrics_proto_msgTypes,
	}.Build()
	File_commonpb_v2_health_metrics_proto = out.File
	file_commonpb_v2_health_metrics_proto_goTypes = nil
	file_commonpb_v2_health_metrics_proto_depIdxs = nil
}
