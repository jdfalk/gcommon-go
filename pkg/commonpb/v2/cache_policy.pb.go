...
// 	protoc        (unknown)
// source: commonpb/v2/cache_policy.proto
...
type CachePolicy struct {
	...
	xxx_hidden_Expiration   ExpirationPolicy       `protobuf:"varint,1,opt,name=expiration,enum=common.v2.ExpirationPolicy"`
	xxx_hidden_Eviction     EvictionPolicy         `protobuf:"varint,2,opt,name=eviction,enum=common.v2.EvictionPolicy"`
...
func (x *CachePolicy) Reset() {
	*x = CachePolicy{}
	mi := &file_commonpb_v2_cache_policy_proto_msgTypes[0]
...
var File_commonpb_v2_cache_policy_proto protoreflect.FileDescriptor

const file_commonpb_v2_cache_policy_proto_rawDesc = "" +
	"\n" +
	"\x1ecommonpb/v2/cache_policy.proto\x12\tcommon.v2\x1a!commonpb/v2/eviction_policy.proto\x1a#commonpb/v2/expiration_policy.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xde\x02\n" +
	"\vCachePolicy\x12;\n" +
	"\n" +
	"expiration\x18\x01 \x01(\x0e2\x1b.common.v2.ExpirationPolicyR\n" +
	"expiration\x125\n" +
	"\beviction\x18\x02 \x01(\x0e2\x19.common.v2.EvictionPolicyR\beviction\x12-\n" +
	...
	"\fenable_stats\x18\a \x01(\bR\venableStatsB\x99\x01\n" +
	"\rcom.common.v2B\x10CachePolicyProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_cache_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v2_cache_policy_proto_goTypes = []any{
	(*CachePolicy)(nil),         // 0: common.v2.CachePolicy
	(ExpirationPolicy)(0),       // 1: common.v2.ExpirationPolicy
	(EvictionPolicy)(0),         // 2: common.v2.EvictionPolicy
	(*durationpb.Duration)(nil), // 3: google.protobuf.Duration
}
var file_commonpb_v2_cache_policy_proto_depIdxs = []int32{
	1, // 0: common.v2.CachePolicy.expiration:type_name -> common.v2.ExpirationPolicy
	2, // 1: common.v2.CachePolicy.eviction:type_name -> common.v2.EvictionPolicy
	3, // 2: common.v2.CachePolicy.default_ttl:type_name -> google.protobuf.Duration
...
func init() { file_commonpb_v2_cache_policy_proto_init() }
func file_commonpb_v2_cache_policy_proto_init() {
	if File_commonpb_v2_cache_policy_proto != nil {
		return
	}
	file_commonpb_v2_eviction_policy_proto_init()
	file_commonpb_v2_expiration_policy_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_cache_policy_proto_rawDesc), len(file_commonpb_v2_cache_policy_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_cache_policy_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_cache_policy_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_cache_policy_proto_msgTypes,
	}.Build()
	File_commonpb_v2_cache_policy_proto = out.File
	file_commonpb_v2_cache_policy_proto_goTypes = nil
	file_commonpb_v2_cache_policy_proto_depIdxs = nil
}
