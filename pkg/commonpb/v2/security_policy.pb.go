...
// 	protoc        (unknown)
// source: commonpb/v2/security_policy.proto
...
func (x *SecurityPolicy) Reset() {
	*x = SecurityPolicy{}
	mi := &file_commonpb_v2_security_policy_proto_msgTypes[0]
...
var File_commonpb_v2_security_policy_proto protoreflect.FileDescriptor

const file_commonpb_v2_security_policy_proto_rawDesc = "" +
	"\n" +
	"!commonpb/v2/security_policy.proto\x12\tcommon.v2\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc0\x01\n" +
...
var file_commonpb_v2_security_policy_proto_goTypes = []any{
	(*SecurityPolicy)(nil),      // 0: common.v2.SecurityPolicy
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_commonpb_v2_security_policy_proto_depIdxs = []int32{
...
func init() { file_commonpb_v2_security_policy_proto_init() }
func file_commonpb_v2_security_policy_proto_init() {
	if File_commonpb_v2_security_policy_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_security_policy_proto_rawDesc), len(file_commonpb_v2_security_policy_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_security_policy_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_security_policy_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_security_policy_proto_msgTypes,
	}.Build()
	File_commonpb_v2_security_policy_proto = out.File
	file_commonpb_v2_security_policy_proto_goTypes = nil
	file_commonpb_v2_security_policy_proto_depIdxs = nil
}
