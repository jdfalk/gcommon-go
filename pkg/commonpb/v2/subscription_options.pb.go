...
// 	protoc        (unknown)
// source: commonpb/v2/subscription_options.proto
...
type SubscriptionOptions struct {
	...
	xxx_hidden_AckMode        AckMode                `protobuf:"varint,3,opt,name=ack_mode,json=ackMode,enum=common.v2.AckMode"`
...
func (x *SubscriptionOptions) Reset() {
	*x = SubscriptionOptions{}
	mi := &file_commonpb_v2_subscription_options_proto_msgTypes[0]
...
var File_commonpb_v2_subscription_options_proto protoreflect.FileDescriptor

const file_commonpb_v2_subscription_options_proto_rawDesc = "" +
	"\n" +
	"&commonpb/v2/subscription_options.proto\x12\tcommon.v2\x1a\x1acommonpb/v2/ack_mode.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd6\x01\n" +
	...
	"\back_mode\x18\x03 \x01(\x0e2\x12.common.v2.AckModeR\aackMode\x128\n" +
	"\n" +
	"keep_alive\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\tkeepAliveB\xa1\x01\n" +
	"\rcom.common.v2B\x18SubscriptionOptionsProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_subscription_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v2_subscription_options_proto_goTypes = []any{
	(*SubscriptionOptions)(nil), // 0: common.v2.SubscriptionOptions
	(AckMode)(0),                // 1: common.v2.AckMode
	(*durationpb.Duration)(nil), // 2: google.protobuf.Duration
}
var file_commonpb_v2_subscription_options_proto_depIdxs = []int32{
	1, // 0: common.v2.SubscriptionOptions.ack_mode:type_name -> common.v2.AckMode
	2, // 1: common.v2.SubscriptionOptions.keep_alive:type_name -> google.protobuf.Duration
...
func init() { file_commonpb_v2_subscription_options_proto_init() }
func file_commonpb_v2_subscription_options_proto_init() {
	if File_commonpb_v2_subscription_options_proto != nil {
		return
	}
	file_commonpb_v2_ack_mode_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_subscription_options_proto_rawDesc), len(file_commonpb_v2_subscription_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_subscription_options_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_subscription_options_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_subscription_options_proto_msgTypes,
	}.Build()
	File_commonpb_v2_subscription_options_proto = out.File
	file_commonpb_v2_subscription_options_proto_goTypes = nil
	file_commonpb_v2_subscription_options_proto_depIdxs = nil
}
