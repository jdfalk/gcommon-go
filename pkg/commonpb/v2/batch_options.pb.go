...
// 	protoc        (unknown)
// source: commonpb/v2/batch_options.proto
...
func (x *CommonBatchOptions) Reset() {
	*x = CommonBatchOptions{}
	mi := &file_commonpb_v2_batch_options_proto_msgTypes[0]
...
var File_commonpb_v2_batch_options_proto protoreflect.FileDescriptor

const file_commonpb_v2_batch_options_proto_rawDesc = "" +
	"\n" +
	"\x1fcommonpb/v2/batch_options.proto\x12\tcommon.v2\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb9\x01\n" +
	...
	"\x0ereturn_partial\x18\x04 \x01(\bR\rreturnPartialB\x9a\x01\n" +
	"\rcom.common.v2B\x11BatchOptionsProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_batch_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v2_batch_options_proto_goTypes = []any{
	(*CommonBatchOptions)(nil),  // 0: common.v2.CommonBatchOptions
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_commonpb_v2_batch_options_proto_depIdxs = []int32{
	1, // 0: common.v2.CommonBatchOptions.timeout:type_name -> google.protobuf.Duration
...
func init() { file_commonpb_v2_batch_options_proto_init() }
func file_commonpb_v2_batch_options_proto_init() {
	if File_commonpb_v2_batch_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_batch_options_proto_rawDesc), len(file_commonpb_v2_batch_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_batch_options_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_batch_options_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_batch_options_proto_msgTypes,
	}.Build()
	File_commonpb_v2_batch_options_proto = out.File
	file_commonpb_v2_batch_options_proto_goTypes = nil
	file_commonpb_v2_batch_options_proto_depIdxs = nil
}
