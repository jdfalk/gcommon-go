...
// 	protoc        (unknown)
// source: commonpb/v2/get_user_permissions_response.proto
...
func (x *GetUserPermissionsResponse) Reset() {
	*x = GetUserPermissionsResponse{}
	mi := &file_commonpb_v2_get_user_permissions_response_proto_msgTypes[0]
...
var File_commonpb_v2_get_user_permissions_response_proto protoreflect.FileDescriptor

const file_commonpb_v2_get_user_permissions_response_proto_rawDesc = "" +
	"\n" +
	"/commonpb/v2/get_user_permissions_response.proto\x12\tcommon.v2\x1a\x16commonpb/v2/role.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xef\x01\n" +
	...
	"\xbaH\x05\x92\x01\x02\b\x01(\x01R\x05rolesB\xa8\x01\n" +
	"\rcom.common.v2B\x1fGetUserPermissionsResponseProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_get_user_permissions_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v2_get_user_permissions_response_proto_goTypes = []any{
	(*GetUserPermissionsResponse)(nil), // 0: common.v2.GetUserPermissionsResponse
	(*Role)(nil),                       // 1: common.v2.Role
}
var file_commonpb_v2_get_user_permissions_response_proto_depIdxs = []int32{
	1, // 0: common.v2.GetUserPermissionsResponse.roles:type_name -> common.v2.Role
...
func init() { file_commonpb_v2_get_user_permissions_response_proto_init() }
func file_commonpb_v2_get_user_permissions_response_proto_init() {
	if File_commonpb_v2_get_user_permissions_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_get_user_permissions_response_proto_rawDesc), len(file_commonpb_v2_get_user_permissions_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_get_user_permissions_response_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_get_user_permissions_response_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_get_user_permissions_response_proto_msgTypes,
	}.Build()
	File_commonpb_v2_get_user_permissions_response_proto = out.File
	file_commonpb_v2_get_user_permissions_response_proto_goTypes = nil
	file_commonpb_v2_get_user_permissions_response_proto_depIdxs = nil
}
