...
// 	protoc        (unknown)
// source: commonpb/v2/validate_token_response.proto
...
func (x *ValidateTokenResponse) Reset() {
	*x = ValidateTokenResponse{}
	mi := &file_commonpb_v2_validate_token_response_proto_msgTypes[0]
...
var File_commonpb_v2_validate_token_response_proto protoreflect.FileDescriptor

const file_commonpb_v2_validate_token_response_proto_rawDesc = "" +
	"\n" +
	")commonpb/v2/validate_token_response.proto\x12\tcommon.v2\x1a\x1bcommonpb/v2/user_info.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xb0\x02\n" +
	"\x15ValidateTokenResponse\x12\x14\n" +
	"\x05valid\x18\x01 \x01(\bR\x05valid\x12=\n" +
	"\n" +
	"expires_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x02(\x01R\texpiresAt\x124\n" +
	...
	"\n" +
	"expires_in\x18\a \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\texpiresInB\xa3\x01\n" +
	"\rcom.common.v2B\x1aValidateTokenResponseProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_validate_token_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v2_validate_token_response_proto_goTypes = []any{
	(*ValidateTokenResponse)(nil), // 0: common.v2.ValidateTokenResponse
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
	(*UserInfo)(nil),              // 2: common.v2.UserInfo
}
var file_commonpb_v2_validate_token_response_proto_depIdxs = []int32{
	1, // 0: common.v2.ValidateTokenResponse.expires_at:type_name -> google.protobuf.Timestamp
	2, // 1: common.v2.ValidateTokenResponse.user_info:type_name -> common.v2.UserInfo
...
func init() { file_commonpb_v2_validate_token_response_proto_init() }
func file_commonpb_v2_validate_token_response_proto_init() {
	if File_commonpb_v2_validate_token_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_validate_token_response_proto_rawDesc), len(file_commonpb_v2_validate_token_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_validate_token_response_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_validate_token_response_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_validate_token_response_proto_msgTypes,
	}.Build()
	File_commonpb_v2_validate_token_response_proto = out.File
	file_commonpb_v2_validate_token_response_proto_goTypes = nil
	file_commonpb_v2_validate_token_response_proto_depIdxs = nil
}
