...
// 	protoc        (unknown)
// source: commonpb/v2/nack_error_category.proto
...
func (NackErrorCategory) Descriptor() protoreflect.EnumDescriptor {
	return file_commonpb_v2_nack_error_category_proto_enumTypes[0].Descriptor()
}

func (NackErrorCategory) Type() protoreflect.EnumType {
	return &file_commonpb_v2_nack_error_category_proto_enumTypes[0]
}
...
var File_commonpb_v2_nack_error_category_proto protoreflect.FileDescriptor

const file_commonpb_v2_nack_error_category_proto_rawDesc = "" +
	"\n" +
	"%commonpb/v2/nack_error_category.proto\x12\tcommon.v2\x1a!google/protobuf/go_features.proto*\x88\x02\n" +
	...
	"\x1eNACK_ERROR_CATEGORY_RATE_LIMIT\x10\x06B\x9f\x01\n" +
	"\rcom.common.v2B\x16NackErrorCategoryProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_nack_error_category_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_commonpb_v2_nack_error_category_proto_goTypes = []any{
	(NackErrorCategory)(0), // 0: common.v2.NackErrorCategory
}
var file_commonpb_v2_nack_error_category_proto_depIdxs = []int32{
...
func init() { file_commonpb_v2_nack_error_category_proto_init() }
func file_commonpb_v2_nack_error_category_proto_init() {
	if File_commonpb_v2_nack_error_category_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_nack_error_category_proto_rawDesc), len(file_commonpb_v2_nack_error_category_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_nack_error_category_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_nack_error_category_proto_depIdxs,
		EnumInfos:         file_commonpb_v2_nack_error_category_proto_enumTypes,
	}.Build()
	File_commonpb_v2_nack_error_category_proto = out.File
	file_commonpb_v2_nack_error_category_proto_goTypes = nil
	file_commonpb_v2_nack_error_category_proto_depIdxs = nil
}
