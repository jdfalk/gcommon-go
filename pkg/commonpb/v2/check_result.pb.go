...
// 	protoc        (unknown)
// source: commonpb/v2/check_result.proto
...
type CheckResult struct {
	...
	xxx_hidden_Status        CommonHealthStatus     `protobuf:"varint,2,opt,name=status,enum=common.v2.CommonHealthStatus"`
...
func (x *CheckResult) Reset() {
	*x = CheckResult{}
	mi := &file_commonpb_v2_check_result_proto_msgTypes[0]
...
var File_commonpb_v2_check_result_proto protoreflect.FileDescriptor

const file_commonpb_v2_check_result_proto_rawDesc = "" +
	"\n" +
	"\x1ecommonpb/v2/check_result.proto\x12\tcommon.v2\x1a\x17commonpb/v2/error.proto\x1a\x1fcommonpb/v2/health_status.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa0\x03\n" +
	"\vCheckResult\x12\x1d\n" +
	"\x04name\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x04name\x125\n" +
	"\x06status\x18\x02 \x01(\x0e2\x1d.common.v2.CommonHealthStatusR\x06status\x128\n" +
	"\ttimestamp\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12@\n" +
	"\x0eexecution_time\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\rexecutionTime\x12\x18\n" +
	"\amessage\x18\x05 \x01(\tR\amessage\x12&\n" +
	"\x05error\x18\x06 \x01(\v2\x10.common.v2.ErrorR\x05error\x12@\n" +
	"\bmetadata\x18\a \x03(\v2$.common.v2.CheckResult.MetadataEntryR\bmetadata\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x99\x01\n" +
	"\rcom.common.v2B\x10CheckResultProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_check_result_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_commonpb_v2_check_result_proto_goTypes = []any{
	(*CheckResult)(nil),           // 0: common.v2.CheckResult
	nil,                           // 1: common.v2.CheckResult.MetadataEntry
	(CommonHealthStatus)(0),       // 2: common.v2.CommonHealthStatus
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 4: google.protobuf.Duration
	(*Error)(nil),                 // 5: common.v2.Error
}
var file_commonpb_v2_check_result_proto_depIdxs = []int32{
	2, // 0: common.v2.CheckResult.status:type_name -> common.v2.CommonHealthStatus
	3, // 1: common.v2.CheckResult.timestamp:type_name -> google.protobuf.Timestamp
	4, // 2: common.v2.CheckResult.execution_time:type_name -> google.protobuf.Duration
	5, // 3: common.v2.CheckResult.error:type_name -> common.v2.Error
	1, // 4: common.v2.CheckResult.metadata:type_name -> common.v2.CheckResult.MetadataEntry
...
func init() { file_commonpb_v2_check_result_proto_init() }
func file_commonpb_v2_check_result_proto_init() {
	if File_commonpb_v2_check_result_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_check_result_proto_rawDesc), len(file_commonpb_v2_check_result_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_check_result_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_check_result_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_check_result_proto_msgTypes,
	}.Build()
	File_commonpb_v2_check_result_proto = out.File
	file_commonpb_v2_check_result_proto_goTypes = nil
	file_commonpb_v2_check_result_proto_depIdxs = nil
}
