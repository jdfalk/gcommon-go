...
// 	protoc        (unknown)
// source: commonpb/v2/error_info.proto
...
func (x *ErrorInfo) Reset() {
	*x = ErrorInfo{}
	mi := &file_commonpb_v2_error_info_proto_msgTypes[0]
...
var File_commonpb_v2_error_info_proto protoreflect.FileDescriptor

const file_commonpb_v2_error_info_proto_rawDesc = "" +
	"\n" +
	"\x1ccommonpb/v2/error_info.proto\x12\tcommon.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc3\x02\n" +
	"\tErrorInfo\x12!\n" +
	"\amessage\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\amessage\x12\x1b\n" +
	"\x04type\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x04type\x12(\n" +
	"\vstack_trace\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\n" +
	"stackTrace\x12\x1b\n" +
	"\x04code\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x04code\x12;\n" +
	"\acontext\x18\x05 \x03(\v2!.common.v2.ErrorInfo.ContextEntryR\acontext\x126\n" +
	"\x06causes\x18\x06 \x03(\v2\x14.common.v2.ErrorInfoB\b\xbaH\x05\x92\x01\x02\b\x01R\x06causes\x1a:\n" +
	"\fContextEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x97\x01\n" +
	"\rcom.common.v2B\x0eErrorInfoProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_error_info_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_commonpb_v2_error_info_proto_goTypes = []any{
	(*ErrorInfo)(nil), // 0: common.v2.ErrorInfo
	nil,               // 1: common.v2.ErrorInfo.ContextEntry
}
var file_commonpb_v2_error_info_proto_depIdxs = []int32{
	1, // 0: common.v2.ErrorInfo.context:type_name -> common.v2.ErrorInfo.ContextEntry
	0, // 1: common.v2.ErrorInfo.causes:type_name -> common.v2.ErrorInfo
...
func init() { file_commonpb_v2_error_info_proto_init() }
func file_commonpb_v2_error_info_proto_init() {
	if File_commonpb_v2_error_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_error_info_proto_rawDesc), len(file_commonpb_v2_error_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_error_info_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_error_info_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_error_info_proto_msgTypes,
	}.Build()
	File_commonpb_v2_error_info_proto = out.File
	file_commonpb_v2_error_info_proto_goTypes = nil
	file_commonpb_v2_error_info_proto_depIdxs = nil
}
