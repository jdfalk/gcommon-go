...
// 	protoc        (unknown)
// source: commonpb/v2/log_statistics.proto
...
func (x *LogStatistics) Reset() {
	*x = LogStatistics{}
	mi := &file_commonpb_v2_log_statistics_proto_msgTypes[0]
...
var File_commonpb_v2_log_statistics_proto protoreflect.FileDescriptor

const file_commonpb_v2_log_statistics_proto_rawDesc = "" +
	"\n" +
	" commonpb/v2/log_statistics.proto\x12\tcommon.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa7\x02\n" +
	"\rLogStatistics\x12,\n" +
	...
	"errorCount\x12,\n" +
	"\rwarning_count\x18\x06 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\fwarningCountB\x9b\x01\n" +
	"\rcom.common.v2B\x12LogStatisticsProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_log_statistics_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v2_log_statistics_proto_goTypes = []any{
	(*LogStatistics)(nil), // 0: common.v2.LogStatistics
}
var file_commonpb_v2_log_statistics_proto_depIdxs = []int32{
...
func init() { file_commonpb_v2_log_statistics_proto_init() }
func file_commonpb_v2_log_statistics_proto_init() {
	if File_commonpb_v2_log_statistics_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_log_statistics_proto_rawDesc), len(file_commonpb_v2_log_statistics_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_log_statistics_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_log_statistics_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_log_statistics_proto_msgTypes,
	}.Build()
	File_commonpb_v2_log_statistics_proto = out.File
	file_commonpb_v2_log_statistics_proto_goTypes = nil
	file_commonpb_v2_log_statistics_proto_depIdxs = nil
}
