...
// 	protoc        (unknown)
// source: commonpb/v2/paginated_response.proto
...
func (x *PaginatedResponse) Reset() {
	*x = PaginatedResponse{}
	mi := &file_commonpb_v2_paginated_response_proto_msgTypes[0]
...
var File_commonpb_v2_paginated_response_proto protoreflect.FileDescriptor

const file_commonpb_v2_paginated_response_proto_rawDesc = "" +
	"\n" +
	"$commonpb/v2/paginated_response.proto\x12\tcommon.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa4\x02\n" +
	"\x11PaginatedResponse\x12/\n" +
	"\x0fnext_page_token\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\rnextPageToken\x12/\n" +
	"\x0fprev_page_token\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\rprevPageToken\x12(\n" +
	"\vtotal_count\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\n" +
	"totalCount\x12-\n" +
	"\fcurrent_page\x18\x04 \x01(\x05B\n" +
	"\xbaH\a\x1a\x05\x18\x96\x01(\x00R\vcurrentPage\x12+\n" +
	"\vtotal_pages\x18\x05 \x01(\x05B\n" +
	"\xbaH\a\x1a\x05\x18\x96\x01(\x00R\n" +
	"totalPages\x12'\n" +
	"\tpage_size\x18\x06 \x01(\x05B\n" +
	"\xbaH\a\x1a\x05\x18\x96\x01(\x00R\bpageSizeB\x9f\x01\n" +
	"\rcom.common.v2B\x16PaginatedResponseProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_paginated_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v2_paginated_response_proto_goTypes = []any{
	(*PaginatedResponse)(nil), // 0: common.v2.PaginatedResponse
}
var file_commonpb_v2_paginated_response_proto_depIdxs = []int32{
...
func init() { file_commonpb_v2_paginated_response_proto_init() }
func file_commonpb_v2_paginated_response_proto_init() {
	if File_commonpb_v2_paginated_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_paginated_response_proto_rawDesc), len(file_commonpb_v2_paginated_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_paginated_response_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_paginated_response_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_paginated_response_proto_msgTypes,
	}.Build()
	File_commonpb_v2_paginated_response_proto = out.File
	file_commonpb_v2_paginated_response_proto_goTypes = nil
	file_commonpb_v2_paginated_response_proto_depIdxs = nil
}
