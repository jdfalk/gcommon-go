...
// 	protoc        (unknown)
// source: commonpb/v2/organization_access_control.proto
...
func (x *OrganizationAccessControl) Reset() {
	*x = OrganizationAccessControl{}
	mi := &file_commonpb_v2_organization_access_control_proto_msgTypes[0]
...
var File_commonpb_v2_organization_access_control_proto protoreflect.FileDescriptor

const file_commonpb_v2_organization_access_control_proto_rawDesc = "" +
	"\n" +
	"-commonpb/v2/organization_access_control.proto\x12\tcommon.v2\x1a\"commonpb/v2/time_restriction.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf2\x02\n" +
...
var file_commonpb_v2_organization_access_control_proto_goTypes = []any{
	(*OrganizationAccessControl)(nil), // 0: common.v2.OrganizationAccessControl
	(*TimeRestriction)(nil),           // 1: common.v2.TimeRestriction
}
var file_commonpb_v2_organization_access_control_proto_depIdxs = []int32{
...
func init() { file_commonpb_v2_organization_access_control_proto_init() }
func file_commonpb_v2_organization_access_control_proto_init() {
	if File_commonpb_v2_organization_access_control_proto != nil {
		return
	}
	file_commonpb_v2_time_restriction_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_organization_access_control_proto_rawDesc), len(file_commonpb_v2_organization_access_control_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_organization_access_control_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_organization_access_control_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_organization_access_control_proto_msgTypes,
	}.Build()
	File_commonpb_v2_organization_access_control_proto = out.File
	file_commonpb_v2_organization_access_control_proto_goTypes = nil
	file_commonpb_v2_organization_access_control_proto_depIdxs = nil
}
