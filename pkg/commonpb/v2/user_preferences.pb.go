...
// 	protoc        (unknown)
// source: commonpb/v2/user_preferences.proto
...
func (x *UserPreferences) Reset() {
	*x = UserPreferences{}
	mi := &file_commonpb_v2_user_preferences_proto_msgTypes[0]
...
var File_commonpb_v2_user_preferences_proto protoreflect.FileDescriptor

const file_commonpb_v2_user_preferences_proto_rawDesc = "" +
	"\n" +
	"\"commonpb/v2/user_preferences.proto\x12\tcommon.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd7\x02\n" +
...
var file_commonpb_v2_user_preferences_proto_goTypes = []any{
	(*UserPreferences)(nil), // 0: common.v2.UserPreferences
}
var file_commonpb_v2_user_preferences_proto_depIdxs = []int32{
...
func init() { file_commonpb_v2_user_preferences_proto_init() }
func file_commonpb_v2_user_preferences_proto_init() {
	if File_commonpb_v2_user_preferences_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_user_preferences_proto_rawDesc), len(file_commonpb_v2_user_preferences_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_user_preferences_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_user_preferences_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_user_preferences_proto_msgTypes,
	}.Build()
	File_commonpb_v2_user_preferences_proto = out.File
	file_commonpb_v2_user_preferences_proto_goTypes = nil
	file_commonpb_v2_user_preferences_proto_depIdxs = nil
}
