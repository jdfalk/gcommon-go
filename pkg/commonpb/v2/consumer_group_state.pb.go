...
// 	protoc        (unknown)
// source: commonpb/v2/consumer_group_state.proto
...
func (ConsumerGroupState) Descriptor() protoreflect.EnumDescriptor {
	return file_commonpb_v2_consumer_group_state_proto_enumTypes[0].Descriptor()
}

func (ConsumerGroupState) Type() protoreflect.EnumType {
	return &file_commonpb_v2_consumer_group_state_proto_enumTypes[0]
}
...
var File_commonpb_v2_consumer_group_state_proto protoreflect.FileDescriptor

const file_commonpb_v2_consumer_group_state_proto_rawDesc = "" +
	"\n" +
	"&commonpb/v2/consumer_group_state.proto\x12\tcommon.v2\x1a!google/protobuf/go_features.proto*\xf7\x01\n" +
	...
	"\x1aCONSUMER_GROUP_STATE_EMPTY\x10\x05B\xa0\x01\n" +
	"\rcom.common.v2B\x17ConsumerGroupStateProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_consumer_group_state_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_commonpb_v2_consumer_group_state_proto_goTypes = []any{
	(ConsumerGroupState)(0), // 0: common.v2.ConsumerGroupState
}
var file_commonpb_v2_consumer_group_state_proto_depIdxs = []int32{
...
func init() { file_commonpb_v2_consumer_group_state_proto_init() }
func file_commonpb_v2_consumer_group_state_proto_init() {
	if File_commonpb_v2_consumer_group_state_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_consumer_group_state_proto_rawDesc), len(file_commonpb_v2_consumer_group_state_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_consumer_group_state_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_consumer_group_state_proto_depIdxs,
		EnumInfos:         file_commonpb_v2_consumer_group_state_proto_enumTypes,
	}.Build()
	File_commonpb_v2_consumer_group_state_proto = out.File
	file_commonpb_v2_consumer_group_state_proto_goTypes = nil
	file_commonpb_v2_consumer_group_state_proto_depIdxs = nil
}
