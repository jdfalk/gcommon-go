...
// 	protoc        (unknown)
// source: commonpb/v2/pagination.proto
...
func (x *Pagination) Reset() {
	*x = Pagination{}
	mi := &file_commonpb_v2_pagination_proto_msgTypes[0]
...
var File_commonpb_v2_pagination_proto protoreflect.FileDescriptor

const file_commonpb_v2_pagination_proto_rawDesc = "" +
	"\n" +
	"\x1ccommonpb/v2/pagination.proto\x12\tcommon.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x8a\x01\n" +
	"\n" +
	"Pagination\x12'\n" +
	...
	"\vpage_number\x18\x03 \x01(\x05B\n" +
	"\xbaH\a\x1a\x05\x18\x96\x01(\x00R\n" +
	"pageNumberB\x98\x01\n" +
	"\rcom.common.v2B\x0fPaginationProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_pagination_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v2_pagination_proto_goTypes = []any{
	(*Pagination)(nil), // 0: common.v2.Pagination
}
var file_commonpb_v2_pagination_proto_depIdxs = []int32{
...
func init() { file_commonpb_v2_pagination_proto_init() }
func file_commonpb_v2_pagination_proto_init() {
	if File_commonpb_v2_pagination_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_pagination_proto_rawDesc), len(file_commonpb_v2_pagination_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_pagination_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_pagination_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_pagination_proto_msgTypes,
	}.Build()
	File_commonpb_v2_pagination_proto = out.File
	file_commonpb_v2_pagination_proto_goTypes = nil
	file_commonpb_v2_pagination_proto_depIdxs = nil
}
