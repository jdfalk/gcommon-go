...
// 	protoc        (unknown)
// source: commonpb/v2/batch_operation.proto
...
func (x *CommonBatchOperation) Reset() {
	*x = CommonBatchOperation{}
	mi := &file_commonpb_v2_batch_operation_proto_msgTypes[0]
...
var File_commonpb_v2_batch_operation_proto protoreflect.FileDescriptor

const file_commonpb_v2_batch_operation_proto_rawDesc = "" +
	"\n" +
	"!commonpb/v2/batch_operation.proto\x12\tcommon.v2\x1a\x1bbuf/validate/validate.proto\x1a\x1fcommonpb/v2/batch_options.proto\x1a\"commonpb/v2/request_metadata.proto\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\"\xa5\x02\n" +
	"\x14CommonBatchOperation\x12\"\n" +
	"\bbatch_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\abatchId\x12.\n" +
	"\x0eoperation_type\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\roperationType\x12@\n" +
	"\n" +
	"operations\x18\x03 \x03(\v2\x14.google.protobuf.AnyB\n" +
	"\xbaH\x05\x92\x01\x02\b\x01(\x01R\n" +
	"operations\x12;\n" +
	"\aoptions\x18\x04 \x01(\v2\x1d.common.v2.CommonBatchOptionsB\x02(\x01R\aoptions\x12:\n" +
	"\bmetadata\x18\x05 \x01(\v2\x1a.common.v2.RequestMetadataB\x02(\x01R\bmetadataB\x9c\x01\n" +
	"\rcom.common.v2B\x13BatchOperationProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_batch_operation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v2_batch_operation_proto_goTypes = []any{
	(*CommonBatchOperation)(nil), // 0: common.v2.CommonBatchOperation
	(*anypb.Any)(nil),            // 1: google.protobuf.Any
	(*CommonBatchOptions)(nil),   // 2: common.v2.CommonBatchOptions
	(*RequestMetadata)(nil),      // 3: common.v2.RequestMetadata
}
var file_commonpb_v2_batch_operation_proto_depIdxs = []int32{
	1, // 0: common.v2.CommonBatchOperation.operations:type_name -> google.protobuf.Any
	2, // 1: common.v2.CommonBatchOperation.options:type_name -> common.v2.CommonBatchOptions
	3, // 2: common.v2.CommonBatchOperation.metadata:type_name -> common.v2.RequestMetadata
...
func init() { file_commonpb_v2_batch_operation_proto_init() }
func file_commonpb_v2_batch_operation_proto_init() {
	if File_commonpb_v2_batch_operation_proto != nil {
		return
	}
	file_commonpb_v2_batch_options_proto_init()
	file_commonpb_v2_request_metadata_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_batch_operation_proto_rawDesc), len(file_commonpb_v2_batch_operation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_batch_operation_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_batch_operation_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_batch_operation_proto_msgTypes,
	}.Build()
	File_commonpb_v2_batch_operation_proto = out.File
	file_commonpb_v2_batch_operation_proto_goTypes = nil
	file_commonpb_v2_batch_operation_proto_depIdxs = nil
}
