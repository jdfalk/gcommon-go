...
// 	protoc        (unknown)
// source: commonpb/v2/get_system_stats_response.proto
...
func (x *GetSystemStatsResponse) Reset() {
	*x = GetSystemStatsResponse{}
	mi := &file_commonpb_v2_get_system_stats_response_proto_msgTypes[0]
...
var File_commonpb_v2_get_system_stats_response_proto protoreflect.FileDescriptor

const file_commonpb_v2_get_system_stats_response_proto_rawDesc = "" +
	"\n" +
	"+commonpb/v2/get_system_stats_response.proto\x12\tcommon.v2\x1a\x17commonpb/v2/error.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa6\x02\n" +
...
var file_commonpb_v2_get_system_stats_response_proto_goTypes = []any{
	(*GetSystemStatsResponse)(nil), // 0: common.v2.GetSystemStatsResponse
	(*Error)(nil),                  // 1: common.v2.Error
}
var file_commonpb_v2_get_system_stats_response_proto_depIdxs = []int32{
...
func init() { file_commonpb_v2_get_system_stats_response_proto_init() }
func file_commonpb_v2_get_system_stats_response_proto_init() {
	if File_commonpb_v2_get_system_stats_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_get_system_stats_response_proto_rawDesc), len(file_commonpb_v2_get_system_stats_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_get_system_stats_response_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_get_system_stats_response_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_get_system_stats_response_proto_msgTypes,
	}.Build()
	File_commonpb_v2_get_system_stats_response_proto = out.File
	file_commonpb_v2_get_system_stats_response_proto_goTypes = nil
	file_commonpb_v2_get_system_stats_response_proto_depIdxs = nil
}
