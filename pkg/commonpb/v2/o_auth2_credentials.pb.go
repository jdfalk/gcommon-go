...
// 	protoc        (unknown)
// source: commonpb/v2/o_auth2_credentials.proto
...
func (x *OAuth2Credentials) Reset() {
	*x = OAuth2Credentials{}
	mi := &file_commonpb_v2_o_auth2_credentials_proto_msgTypes[0]
...
var File_commonpb_v2_o_auth2_credentials_proto protoreflect.FileDescriptor

const file_commonpb_v2_o_auth2_credentials_proto_rawDesc = "" +
	"\n" +
	"%commonpb/v2/o_auth2_credentials.proto\x12\tcommon.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x96\x01\n" +
	"\x11OAuth2Credentials\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\x12+\n" +
	"\fredirect_uri\x18\x02 \x01(\tB\b\xbaH\x05r\x03\x88\x01\x01R\vredirectUri\x12\x1b\n" +
	"\tclient_id\x18\x03 \x01(\tR\bclientId\x12#\n" +
	"\rclient_secret\x18\x04 \x01(\tR\fclientSecretB\x9f\x01\n" +
	"\rcom.common.v2B\x16OAuth2CredentialsProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_o_auth2_credentials_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v2_o_auth2_credentials_proto_goTypes = []any{
	(*OAuth2Credentials)(nil), // 0: common.v2.OAuth2Credentials
}
var file_commonpb_v2_o_auth2_credentials_proto_depIdxs = []int32{
...
func init() { file_commonpb_v2_o_auth2_credentials_proto_init() }
func file_commonpb_v2_o_auth2_credentials_proto_init() {
	if File_commonpb_v2_o_auth2_credentials_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_o_auth2_credentials_proto_rawDesc), len(file_commonpb_v2_o_auth2_credentials_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_o_auth2_credentials_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_o_auth2_credentials_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_o_auth2_credentials_proto_msgTypes,
	}.Build()
	File_commonpb_v2_o_auth2_credentials_proto = out.File
	file_commonpb_v2_o_auth2_credentials_proto_goTypes = nil
	file_commonpb_v2_o_auth2_credentials_proto_depIdxs = nil
}
