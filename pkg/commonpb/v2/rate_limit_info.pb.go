...
// 	protoc        (unknown)
// source: commonpb/v2/rate_limit_info.proto
...
func (x *RateLimitInfo) Reset() {
	*x = RateLimitInfo{}
	mi := &file_commonpb_v2_rate_limit_info_proto_msgTypes[0]
...
var File_commonpb_v2_rate_limit_info_proto protoreflect.FileDescriptor

const file_commonpb_v2_rate_limit_info_proto_rawDesc = "" +
	"\n" +
	"!commonpb/v2/rate_limit_info.proto\x12\tcommon.v2\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xcc\x01\n" +
	"\rRateLimitInfo\x12%\n" +
	"\tremaining\x18\x01 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\tremaining\x12\x1d\n" +
	"\x05limit\x18\x02 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x05limit\x129\n" +
	"\n" +
	...
	"retryAfterB\x9b\x01\n" +
	"\rcom.common.v2B\x12RateLimitInfoProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_rate_limit_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v2_rate_limit_info_proto_goTypes = []any{
	(*RateLimitInfo)(nil),         // 0: common.v2.RateLimitInfo
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 2: google.protobuf.Duration
}
var file_commonpb_v2_rate_limit_info_proto_depIdxs = []int32{
	1, // 0: common.v2.RateLimitInfo.reset_time:type_name -> google.protobuf.Timestamp
	2, // 1: common.v2.RateLimitInfo.retry_after:type_name -> google.protobuf.Duration
...
func init() { file_commonpb_v2_rate_limit_info_proto_init() }
func file_commonpb_v2_rate_limit_info_proto_init() {
	if File_commonpb_v2_rate_limit_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_rate_limit_info_proto_rawDesc), len(file_commonpb_v2_rate_limit_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_rate_limit_info_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_rate_limit_info_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_rate_limit_info_proto_msgTypes,
	}.Build()
	File_commonpb_v2_rate_limit_info_proto = out.File
	file_commonpb_v2_rate_limit_info_proto_goTypes = nil
	file_commonpb_v2_rate_limit_info_proto_depIdxs = nil
}
