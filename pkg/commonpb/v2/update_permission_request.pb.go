...
// 	protoc        (unknown)
// source: commonpb/v2/update_permission_request.proto
...
func (x *UpdatePermissionRequest) Reset() {
	*x = UpdatePermissionRequest{}
	mi := &file_commonpb_v2_update_permission_request_proto_msgTypes[0]
...
var File_commonpb_v2_update_permission_request_proto protoreflect.FileDescriptor

const file_commonpb_v2_update_permission_request_proto_rawDesc = "" +
	"\n" +
	"+commonpb/v2/update_permission_request.proto\x12\tcommon.v2\x1a\"commonpb/v2/request_metadata.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe6\x02\n" +
	...
	"\x06reason\x18\n" +
	" \x01(\tR\x06reasonB\xa5\x01\n" +
	"\rcom.common.v2B\x1cUpdatePermissionRequestProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_update_permission_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v2_update_permission_request_proto_goTypes = []any{
	(*UpdatePermissionRequest)(nil), // 0: common.v2.UpdatePermissionRequest
	(*RequestMetadata)(nil),         // 1: common.v2.RequestMetadata
}
var file_commonpb_v2_update_permission_request_proto_depIdxs = []int32{
	1, // 0: common.v2.UpdatePermissionRequest.metadata:type_name -> common.v2.RequestMetadata
...
func init() { file_commonpb_v2_update_permission_request_proto_init() }
func file_commonpb_v2_update_permission_request_proto_init() {
	if File_commonpb_v2_update_permission_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_update_permission_request_proto_rawDesc), len(file_commonpb_v2_update_permission_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_update_permission_request_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_update_permission_request_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_update_permission_request_proto_msgTypes,
	}.Build()
	File_commonpb_v2_update_permission_request_proto = out.File
	file_commonpb_v2_update_permission_request_proto_goTypes = nil
	file_commonpb_v2_update_permission_request_proto_depIdxs = nil
}
