...
// 	protoc        (unknown)
// source: commonpb/v2/filter_value.proto
...
type FilterValue struct {
	...
	xxx_hidden_Operation FilterOperation        `protobuf:"varint,7,opt,name=operation,enum=common.v2.FilterOperation"`
...
func (x *FilterValue) Reset() {
	*x = FilterValue{}
	mi := &file_commonpb_v2_filter_value_proto_msgTypes[0]
...
func (x case_FilterValue_Value) String() string {
	md := file_commonpb_v2_filter_value_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_commonpb_v2_filter_value_proto protoreflect.FileDescriptor

const file_commonpb_v2_filter_value_proto_rawDesc = "" +
	"\n" +
	"\x1ecommonpb/v2/filter_value.proto\x12\tcommon.v2\x1a\"commonpb/v2/filter_operation.proto\x1a\x1dcommonpb/v2/int64_array.proto\x1a\x1ecommonpb/v2/string_array.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf7\x02\n" +
	"\vFilterValue\x12,\n" +
	...
	"\x05valueB\x99\x01\n" +
	"\rcom.common.v2B\x10FilterValueProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_filter_value_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v2_filter_value_proto_goTypes = []any{
	(*FilterValue)(nil),  // 0: common.v2.FilterValue
	(*StringArray)(nil),  // 1: common.v2.StringArray
	(*Int64Array)(nil),   // 2: common.v2.Int64Array
	(FilterOperation)(0), // 3: common.v2.FilterOperation
}
var file_commonpb_v2_filter_value_proto_depIdxs = []int32{
	1, // 0: common.v2.FilterValue.string_array:type_name -> common.v2.StringArray
	2, // 1: common.v2.FilterValue.int_array:type_name -> common.v2.Int64Array
	3, // 2: common.v2.FilterValue.operation:type_name -> common.v2.FilterOperation
...
func init() { file_commonpb_v2_filter_value_proto_init() }
func file_commonpb_v2_filter_value_proto_init() {
	if File_commonpb_v2_filter_value_proto != nil {
		return
	}
	file_commonpb_v2_filter_operation_proto_init()
	file_commonpb_v2_int64_array_proto_init()
	file_commonpb_v2_string_array_proto_init()
	file_commonpb_v2_filter_value_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_filter_value_proto_rawDesc), len(file_commonpb_v2_filter_value_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_filter_value_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_filter_value_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_filter_value_proto_msgTypes,
	}.Build()
	File_commonpb_v2_filter_value_proto = out.File
	file_commonpb_v2_filter_value_proto_goTypes = nil
	file_commonpb_v2_filter_value_proto_depIdxs = nil
}
