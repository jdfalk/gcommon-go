...
// 	protoc        (unknown)
// source: commonpb/v2/debug_info.proto
...
func (x *DebugInfo) Reset() {
	*x = DebugInfo{}
	mi := &file_commonpb_v2_debug_info_proto_msgTypes[0]
...
var File_commonpb_v2_debug_info_proto protoreflect.FileDescriptor

const file_commonpb_v2_debug_info_proto_rawDesc = "" +
	"\n" +
	"\x1ccommonpb/v2/debug_info.proto\x12\tcommon.v2\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa0\x02\n" +
	"\tDebugInfo\x12!\n" +
	"\aservice\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\aservice\x12\x1f\n" +
	"\x06method\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06method\x128\n" +
	"\ttimestamp\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12;\n" +
	"\adetails\x18\x04 \x03(\v2!.common.v2.DebugInfo.DetailsEntryR\adetails\x12\x1c\n" +
	"\x04tags\x18\x05 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x04tags\x1a:\n" +
	"\fDetailsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x97\x01\n" +
	"\rcom.common.v2B\x0eDebugInfoProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_debug_info_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_commonpb_v2_debug_info_proto_goTypes = []any{
	(*DebugInfo)(nil),             // 0: common.v2.DebugInfo
	nil,                           // 1: common.v2.DebugInfo.DetailsEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_commonpb_v2_debug_info_proto_depIdxs = []int32{
	2, // 0: common.v2.DebugInfo.timestamp:type_name -> google.protobuf.Timestamp
	1, // 1: common.v2.DebugInfo.details:type_name -> common.v2.DebugInfo.DetailsEntry
...
func init() { file_commonpb_v2_debug_info_proto_init() }
func file_commonpb_v2_debug_info_proto_init() {
	if File_commonpb_v2_debug_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_debug_info_proto_rawDesc), len(file_commonpb_v2_debug_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_debug_info_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_debug_info_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_debug_info_proto_msgTypes,
	}.Build()
	File_commonpb_v2_debug_info_proto = out.File
	file_commonpb_v2_debug_info_proto_goTypes = nil
	file_commonpb_v2_debug_info_proto_depIdxs = nil
}
