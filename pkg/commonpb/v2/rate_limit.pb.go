...
// 	protoc        (unknown)
// source: commonpb/v2/rate_limit.proto
...
func (x *RateLimit) Reset() {
	*x = RateLimit{}
	mi := &file_commonpb_v2_rate_limit_proto_msgTypes[0]
...
var File_commonpb_v2_rate_limit_proto protoreflect.FileDescriptor

const file_commonpb_v2_rate_limit_proto_rawDesc = "" +
	"\n" +
	"\x1ccommonpb/v2/rate_limit.proto\x12\tcommon.v2\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbe\x01\n" +
	"\tRateLimit\x12\x1d\n" +
	"\x05limit\x18\x01 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x05limit\x121\n" +
	...
	"\n" +
	"reset_time\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\tresetTimeB\x97\x01\n" +
	"\rcom.common.v2B\x0eRateLimitProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_rate_limit_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v2_rate_limit_proto_goTypes = []any{
	(*RateLimit)(nil),           // 0: common.v2.RateLimit
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_commonpb_v2_rate_limit_proto_depIdxs = []int32{
	1, // 0: common.v2.RateLimit.window:type_name -> google.protobuf.Duration
	1, // 1: common.v2.RateLimit.reset_time:type_name -> google.protobuf.Duration
...
func init() { file_commonpb_v2_rate_limit_proto_init() }
func file_commonpb_v2_rate_limit_proto_init() {
	if File_commonpb_v2_rate_limit_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_rate_limit_proto_rawDesc), len(file_commonpb_v2_rate_limit_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_rate_limit_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_rate_limit_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_rate_limit_proto_msgTypes,
	}.Build()
	File_commonpb_v2_rate_limit_proto = out.File
	file_commonpb_v2_rate_limit_proto_goTypes = nil
	file_commonpb_v2_rate_limit_proto_depIdxs = nil
}
