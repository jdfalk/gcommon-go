...
// 	protoc        (unknown)
// source: commonpb/v2/response_metadata.proto
...
func (x *ResponseMetadata) Reset() {
	*x = ResponseMetadata{}
	mi := &file_commonpb_v2_response_metadata_proto_msgTypes[0]
...
var File_commonpb_v2_response_metadata_proto protoreflect.FileDescriptor

const file_commonpb_v2_response_metadata_proto_rawDesc = "" +
	"\n" +
	"#commonpb/v2/response_metadata.proto\x12\tcommon.v2\x1a\x17commonpb/v2/error.proto\x1a!commonpb/v2/pagination_info.proto\x1a!commonpb/v2/rate_limit_info.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xde\x04\n" +
	"\x10ResponseMetadata\x12\"\n" +
	"\btrace_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\atraceId\x12&\n" +
	"\n" +
	"request_id\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\trequestId\x128\n" +
	...
	"\x0fservice_version\x18\x05 \x01(\tB\x17\xbaH\x14r\x122\x10^v?\\d+\\.\\d+\\.\\d+R\x0eserviceVersion\x12\x18\n" +
	"\asuccess\x18\x06 \x01(\bR\asuccess\x12&\n" +
	"\x05error\x18\a \x01(\v2\x10.common.v2.ErrorR\x05error\x12E\n" +
	"\bmetadata\x18\b \x03(\v2).common.v2.ResponseMetadata.MetadataEntryR\bmetadata\x127\n" +
	"\n" +
	"rate_limit\x18\t \x01(\v2\x18.common.v2.RateLimitInfoR\trateLimit\x12?\n" +
	"\n" +
	"pagination\x18\n" +
	" \x01(\v2\x1f.common.v2.CommonPaginationInfoR\n" +
	"pagination\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x9e\x01\n" +
	"\rcom.common.v2B\x15ResponseMetadataProtoP\x01Z)github.com/jdfalk/gcommon/pkg/commonpb/v2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
	"Common::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v2_response_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_commonpb_v2_response_metadata_proto_goTypes = []any{
	(*ResponseMetadata)(nil),      // 0: common.v2.ResponseMetadata
	nil,                           // 1: common.v2.ResponseMetadata.MetadataEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 3: google.protobuf.Duration
	(*Error)(nil),                 // 4: common.v2.Error
	(*RateLimitInfo)(nil),         // 5: common.v2.RateLimitInfo
	(*CommonPaginationInfo)(nil),  // 6: common.v2.CommonPaginationInfo
}
var file_commonpb_v2_response_metadata_proto_depIdxs = []int32{
	2, // 0: common.v2.ResponseMetadata.timestamp:type_name -> google.protobuf.Timestamp
	3, // 1: common.v2.ResponseMetadata.processing_time:type_name -> google.protobuf.Duration
	4, // 2: common.v2.ResponseMetadata.error:type_name -> common.v2.Error
	1, // 3: common.v2.ResponseMetadata.metadata:type_name -> common.v2.ResponseMetadata.MetadataEntry
	5, // 4: common.v2.ResponseMetadata.rate_limit:type_name -> common.v2.RateLimitInfo
	6, // 5: common.v2.ResponseMetadata.pagination:type_name -> common.v2.CommonPaginationInfo
...
func init() { file_commonpb_v2_response_metadata_proto_init() }
func file_commonpb_v2_response_metadata_proto_init() {
	if File_commonpb_v2_response_metadata_proto != nil {
		return
	}
	file_commonpb_v2_error_proto_init()
	file_commonpb_v2_pagination_info_proto_init()
	file_commonpb_v2_rate_limit_info_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v2_response_metadata_proto_rawDesc), len(file_commonpb_v2_response_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v2_response_metadata_proto_goTypes,
		DependencyIndexes: file_commonpb_v2_response_metadata_proto_depIdxs,
		MessageInfos:      file_commonpb_v2_response_metadata_proto_msgTypes,
	}.Build()
	File_commonpb_v2_response_metadata_proto = out.File
	file_commonpb_v2_response_metadata_proto_goTypes = nil
	file_commonpb_v2_response_metadata_proto_depIdxs = nil
}
