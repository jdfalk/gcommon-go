...
// 	protoc        (unknown)
// source: commonpb/v1/validate_token_response.proto
...
func (x *ValidateTokenResponse) Reset() {
	*x = ValidateTokenResponse{}
	mi := &file_commonpb_v1_validate_token_response_proto_msgTypes[0]
...
var File_commonpb_v1_validate_token_response_proto protoreflect.FileDescriptor

const file_commonpb_v1_validate_token_response_proto_rawDesc = "" +
	"\n" +
	")commonpb/v1/validate_token_response.proto\x12\tcommon.v1\x1a\x1bcommonpb/v1/user_info.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xb0\x02\n" +
	...
	"\n" +
	"expires_in\x18\a \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\texpiresInB\xa0\x01\n" +
	"\rcom.common.v1B\x1aValidateTokenResponseProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_validate_token_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v1_validate_token_response_proto_goTypes = []any{
	(*ValidateTokenResponse)(nil), // 0: common.v1.ValidateTokenResponse
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
	(*UserInfo)(nil),              // 2: common.v1.UserInfo
}
var file_commonpb_v1_validate_token_response_proto_depIdxs = []int32{
	1, // 0: common.v1.ValidateTokenResponse.expires_at:type_name -> google.protobuf.Timestamp
	2, // 1: common.v1.ValidateTokenResponse.user_info:type_name -> common.v1.UserInfo
...
func init() { file_commonpb_v1_validate_token_response_proto_init() }
func file_commonpb_v1_validate_token_response_proto_init() {
	if File_commonpb_v1_validate_token_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_validate_token_response_proto_rawDesc), len(file_commonpb_v1_validate_token_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_validate_token_response_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_validate_token_response_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_validate_token_response_proto_msgTypes,
	}.Build()
	File_commonpb_v1_validate_token_response_proto = out.File
	file_commonpb_v1_validate_token_response_proto_goTypes = nil
	file_commonpb_v1_validate_token_response_proto_depIdxs = nil
}
