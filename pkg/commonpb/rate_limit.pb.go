...
// 	protoc        (unknown)
// source: commonpb/v1/rate_limit.proto
...
func (x *RateLimit) Reset() {
	*x = RateLimit{}
	mi := &file_commonpb_v1_rate_limit_proto_msgTypes[0]
...
var File_commonpb_v1_rate_limit_proto protoreflect.FileDescriptor

const file_commonpb_v1_rate_limit_proto_rawDesc = "" +
	"\n" +
	"\x1ccommonpb/v1/rate_limit.proto\x12\tcommon.v1\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbe\x01\n" +
	"\tRateLimit\x12\x1d\n" +
...
var file_commonpb_v1_rate_limit_proto_goTypes = []any{
	(*RateLimit)(nil),           // 0: common.v1.RateLimit
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_commonpb_v1_rate_limit_proto_depIdxs = []int32{
...
func init() { file_commonpb_v1_rate_limit_proto_init() }
func file_commonpb_v1_rate_limit_proto_init() {
	if File_commonpb_v1_rate_limit_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_rate_limit_proto_rawDesc), len(file_commonpb_v1_rate_limit_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_rate_limit_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_rate_limit_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_rate_limit_proto_msgTypes,
	}.Build()
	File_commonpb_v1_rate_limit_proto = out.File
	file_commonpb_v1_rate_limit_proto_goTypes = nil
	file_commonpb_v1_rate_limit_proto_depIdxs = nil
}
