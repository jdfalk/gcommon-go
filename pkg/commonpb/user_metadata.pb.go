...
// 	protoc        (unknown)
// source: commonpb/v1/user_metadata.proto
...
func (x *UserMetadata) Reset() {
	*x = UserMetadata{}
	mi := &file_commonpb_v1_user_metadata_proto_msgTypes[0]
...
var File_commonpb_v1_user_metadata_proto protoreflect.FileDescriptor

const file_commonpb_v1_user_metadata_proto_rawDesc = "" +
	"\n" +
	"\x1fcommonpb/v1/user_metadata.proto\x12\tcommon.v1\x1a\"commonpb/v1/user_preferences.proto\x1a%commonpb/v1/verification_status.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x9c\x05\n" +
	"\fUserMetadata\x12,\n" +
	...
	"\rcustom_fields\x18\r \x03(\v2).common.v1.UserMetadata.CustomFieldsEntryR\fcustomFields\x12<\n" +
	"\vpreferences\x18\x0e \x01(\v2\x1a.common.v1.UserPreferencesR\vpreferences\x12A\n" +
	"\fverification\x18\x0f \x01(\v2\x1d.common.v1.VerificationStatusR\fverification\x1a?\n" +
	"\x11CustomFieldsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x97\x01\n" +
	"\rcom.common.v1B\x11UserMetadataProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_user_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_commonpb_v1_user_metadata_proto_goTypes = []any{
	(*UserMetadata)(nil),          // 0: common.v1.UserMetadata
	nil,                           // 1: common.v1.UserMetadata.CustomFieldsEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*UserPreferences)(nil),       // 3: common.v1.UserPreferences
	(*VerificationStatus)(nil),    // 4: common.v1.VerificationStatus
}
var file_commonpb_v1_user_metadata_proto_depIdxs = []int32{
	2, // 0: common.v1.UserMetadata.birth_date:type_name -> google.protobuf.Timestamp
	1, // 1: common.v1.UserMetadata.custom_fields:type_name -> common.v1.UserMetadata.CustomFieldsEntry
	3, // 2: common.v1.UserMetadata.preferences:type_name -> common.v1.UserPreferences
	4, // 3: common.v1.UserMetadata.verification:type_name -> common.v1.VerificationStatus
...
func init() { file_commonpb_v1_user_metadata_proto_init() }
func file_commonpb_v1_user_metadata_proto_init() {
	if File_commonpb_v1_user_metadata_proto != nil {
		return
	}
	file_commonpb_v1_user_preferences_proto_init()
	file_commonpb_v1_verification_status_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_user_metadata_proto_rawDesc), len(file_commonpb_v1_user_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_user_metadata_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_user_metadata_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_user_metadata_proto_msgTypes,
	}.Build()
	File_commonpb_v1_user_metadata_proto = out.File
	file_commonpb_v1_user_metadata_proto_goTypes = nil
	file_commonpb_v1_user_metadata_proto_depIdxs = nil
}
