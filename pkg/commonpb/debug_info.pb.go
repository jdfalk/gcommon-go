...
// 	protoc        (unknown)
// source: commonpb/v1/debug_info.proto
...
func (x *DebugInfo) Reset() {
	*x = DebugInfo{}
	mi := &file_commonpb_v1_debug_info_proto_msgTypes[0]
...
var File_commonpb_v1_debug_info_proto protoreflect.FileDescriptor

const file_commonpb_v1_debug_info_proto_rawDesc = "" +
	"\n" +
	"\x1ccommonpb/v1/debug_info.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa0\x02\n" +
	"\tDebugInfo\x12!\n" +
	...
	"\adetails\x18\x04 \x03(\v2!.common.v1.DebugInfo.DetailsEntryR\adetails\x12\x1c\n" +
	...
	"\rcom.common.v1B\x0eDebugInfoProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_debug_info_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_commonpb_v1_debug_info_proto_goTypes = []any{
	(*DebugInfo)(nil),             // 0: common.v1.DebugInfo
	nil,                           // 1: common.v1.DebugInfo.DetailsEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_commonpb_v1_debug_info_proto_depIdxs = []int32{
	2, // 0: common.v1.DebugInfo.timestamp:type_name -> google.protobuf.Timestamp
	1, // 1: common.v1.DebugInfo.details:type_name -> common.v1.DebugInfo.DetailsEntry
...
func init() { file_commonpb_v1_debug_info_proto_init() }
func file_commonpb_v1_debug_info_proto_init() {
	if File_commonpb_v1_debug_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_debug_info_proto_rawDesc), len(file_commonpb_v1_debug_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_debug_info_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_debug_info_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_debug_info_proto_msgTypes,
	}.Build()
	File_commonpb_v1_debug_info_proto = out.File
	file_commonpb_v1_debug_info_proto_goTypes = nil
	file_commonpb_v1_debug_info_proto_depIdxs = nil
}
