...
// 	protoc        (unknown)
// source: commonpb/v1/key_value.proto
...
func (x *KeyValue) Reset() {
	*x = KeyValue{}
	mi := &file_commonpb_v1_key_value_proto_msgTypes[0]
...
var File_commonpb_v1_key_value_proto protoreflect.FileDescriptor

const file_commonpb_v1_key_value_proto_rawDesc = "" +
	"\n" +
	"\x1bcommonpb/v1/key_value.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"D\n" +
	"\bKeyValue\x12\x19\n" +
...
var file_commonpb_v1_key_value_proto_goTypes = []any{
	(*KeyValue)(nil), // 0: common.v1.KeyValue
}
var file_commonpb_v1_key_value_proto_depIdxs = []int32{
...
func init() { file_commonpb_v1_key_value_proto_init() }
func file_commonpb_v1_key_value_proto_init() {
	if File_commonpb_v1_key_value_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_key_value_proto_rawDesc), len(file_commonpb_v1_key_value_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_key_value_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_key_value_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_key_value_proto_msgTypes,
	}.Build()
	File_commonpb_v1_key_value_proto = out.File
	file_commonpb_v1_key_value_proto_goTypes = nil
	file_commonpb_v1_key_value_proto_depIdxs = nil
}
