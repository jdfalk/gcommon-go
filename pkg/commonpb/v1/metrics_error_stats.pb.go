...
// 	protoc        (unknown)
// source: commonpb/v1/metrics_error_stats.proto
...
func (x *MetricsErrorStats) Reset() {
	*x = MetricsErrorStats{}
	mi := &file_commonpb_v1_metrics_error_stats_proto_msgTypes[0]
...
var File_commonpb_v1_metrics_error_stats_proto protoreflect.FileDescriptor

const file_commonpb_v1_metrics_error_stats_proto_rawDesc = "" +
	"\n" +
	"%commonpb/v1/metrics_error_stats.proto\x12\tcommon.v1\x1a\"commonpb/v1/error_type_count.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xde\x01\n" +
	...
	"\verror_types\x18\x03 \x03(\v2\x19.common.v1.ErrorTypeCountB\b\xbaH\x05\x92\x01\x02\b\x01R\n" +
	"errorTypes\x12(\n" +
	"\verror_trend\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\n" +
	"errorTrendB\x9c\x01\n" +
	"\rcom.common.v1B\x16MetricsErrorStatsProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_metrics_error_stats_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v1_metrics_error_stats_proto_goTypes = []any{
	(*MetricsErrorStats)(nil), // 0: common.v1.MetricsErrorStats
	(*ErrorTypeCount)(nil),    // 1: common.v1.ErrorTypeCount
}
var file_commonpb_v1_metrics_error_stats_proto_depIdxs = []int32{
	1, // 0: common.v1.MetricsErrorStats.error_types:type_name -> common.v1.ErrorTypeCount
...
func init() { file_commonpb_v1_metrics_error_stats_proto_init() }
func file_commonpb_v1_metrics_error_stats_proto_init() {
	if File_commonpb_v1_metrics_error_stats_proto != nil {
		return
	}
	file_commonpb_v1_error_type_count_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_metrics_error_stats_proto_rawDesc), len(file_commonpb_v1_metrics_error_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_metrics_error_stats_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_metrics_error_stats_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_metrics_error_stats_proto_msgTypes,
	}.Build()
	File_commonpb_v1_metrics_error_stats_proto = out.File
	file_commonpb_v1_metrics_error_stats_proto_goTypes = nil
	file_commonpb_v1_metrics_error_stats_proto_depIdxs = nil
}
