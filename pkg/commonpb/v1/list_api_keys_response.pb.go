...
// 	protoc        (unknown)
// source: commonpb/v1/list_api_keys_response.proto
...
func (x *ListApiKeysResponse) Reset() {
	*x = ListApiKeysResponse{}
	mi := &file_commonpb_v1_list_api_keys_response_proto_msgTypes[0]
...
var File_commonpb_v1_list_api_keys_response_proto protoreflect.FileDescriptor

const file_commonpb_v1_list_api_keys_response_proto_rawDesc = "" +
	"\n" +
	"(commonpb/v1/list_api_keys_response.proto\x12\tcommon.v1\x1a\x19commonpb/v1/api_key.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa8\x01\n" +
...
var file_commonpb_v1_list_api_keys_response_proto_goTypes = []any{
	(*ListApiKeysResponse)(nil), // 0: common.v1.ListApiKeysResponse
	(*APIKey)(nil),              // 1: common.v1.APIKey
}
var file_commonpb_v1_list_api_keys_response_proto_depIdxs = []int32{
	1, // 0: common.v1.ListApiKeysResponse.api_keys:type_name -> common.v1.APIKey
...
func init() { file_commonpb_v1_list_api_keys_response_proto_init() }
func file_commonpb_v1_list_api_keys_response_proto_init() {
	if File_commonpb_v1_list_api_keys_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_list_api_keys_response_proto_rawDesc), len(file_commonpb_v1_list_api_keys_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_list_api_keys_response_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_list_api_keys_response_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_list_api_keys_response_proto_msgTypes,
	}.Build()
	File_commonpb_v1_list_api_keys_response_proto = out.File
	file_commonpb_v1_list_api_keys_response_proto_goTypes = nil
	file_commonpb_v1_list_api_keys_response_proto_depIdxs = nil
}
