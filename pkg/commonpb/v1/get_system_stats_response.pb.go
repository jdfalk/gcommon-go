...
// 	protoc        (unknown)
// source: commonpb/v1/get_system_stats_response.proto
...
func (x *GetSystemStatsResponse) Reset() {
	*x = GetSystemStatsResponse{}
	mi := &file_commonpb_v1_get_system_stats_response_proto_msgTypes[0]
...
var File_commonpb_v1_get_system_stats_response_proto protoreflect.FileDescriptor

const file_commonpb_v1_get_system_stats_response_proto_rawDesc = "" +
	"\n" +
	"+commonpb/v1/get_system_stats_response.proto\x12\tcommon.v1\x1a\x17commonpb/v1/error.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa6\x02\n" +
	"\x16GetSystemStatsResponse\x12*\n" +
	"\factive_users\x18\x01 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\vactiveUsers\x12(\n" +
	"\vtotal_roles\x18\x02 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\n" +
	"totalRoles\x120\n" +
	...
	"\x05error\x18\x06 \x01(\v2\x10.common.v1.ErrorR\x05errorB\xa1\x01\n" +
	"\rcom.common.v1B\x1bGetSystemStatsResponseProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_get_system_stats_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v1_get_system_stats_response_proto_goTypes = []any{
	(*GetSystemStatsResponse)(nil), // 0: common.v1.GetSystemStatsResponse
	(*Error)(nil),                  // 1: common.v1.Error
}
var file_commonpb_v1_get_system_stats_response_proto_depIdxs = []int32{
	1, // 0: common.v1.GetSystemStatsResponse.error:type_name -> common.v1.Error
...
func init() { file_commonpb_v1_get_system_stats_response_proto_init() }
func file_commonpb_v1_get_system_stats_response_proto_init() {
	if File_commonpb_v1_get_system_stats_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_get_system_stats_response_proto_rawDesc), len(file_commonpb_v1_get_system_stats_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_get_system_stats_response_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_get_system_stats_response_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_get_system_stats_response_proto_msgTypes,
	}.Build()
	File_commonpb_v1_get_system_stats_response_proto = out.File
	file_commonpb_v1_get_system_stats_response_proto_goTypes = nil
	file_commonpb_v1_get_system_stats_response_proto_depIdxs = nil
}
