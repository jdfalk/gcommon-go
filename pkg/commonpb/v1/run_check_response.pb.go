...
// 	protoc        (unknown)
// source: commonpb/v1/run_check_response.proto
...
type RunCheckResponse struct {
	...
	xxx_hidden_Status        CommonHealthStatus     `protobuf:"varint,3,opt,name=status,enum=common.v1.CommonHealthStatus"`
...
func (x *RunCheckResponse) Reset() {
	*x = RunCheckResponse{}
	mi := &file_commonpb_v1_run_check_response_proto_msgTypes[0]
...
var File_commonpb_v1_run_check_response_proto protoreflect.FileDescriptor

const file_commonpb_v1_run_check_response_proto_rawDesc = "" +
	"\n" +
	"$commonpb/v1/run_check_response.proto\x12\tcommon.v1\x1a\x17commonpb/v1/error.proto\x1a\x1fcommonpb/v1/health_status.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xd1\x02\n" +
	"\x10RunCheckResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\"\n" +
	"\bcheck_id\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\acheckId\x125\n" +
	"\x06status\x18\x03 \x01(\x0e2\x1d.common.v1.CommonHealthStatusR\x06status\x12;\n" +
	...
	"\x05error\x18\a \x01(\v2\x10.common.v1.ErrorR\x05errorB\x9b\x01\n" +
	"\rcom.common.v1B\x15RunCheckResponseProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_run_check_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v1_run_check_response_proto_goTypes = []any{
	(*RunCheckResponse)(nil),      // 0: common.v1.RunCheckResponse
	(CommonHealthStatus)(0),       // 1: common.v1.CommonHealthStatus
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 3: google.protobuf.Duration
	(*Error)(nil),                 // 4: common.v1.Error
}
var file_commonpb_v1_run_check_response_proto_depIdxs = []int32{
	1, // 0: common.v1.RunCheckResponse.status:type_name -> common.v1.CommonHealthStatus
	2, // 1: common.v1.RunCheckResponse.executed_at:type_name -> google.protobuf.Timestamp
	3, // 2: common.v1.RunCheckResponse.execution_time:type_name -> google.protobuf.Duration
	4, // 3: common.v1.RunCheckResponse.error:type_name -> common.v1.Error
...
func init() { file_commonpb_v1_run_check_response_proto_init() }
func file_commonpb_v1_run_check_response_proto_init() {
	if File_commonpb_v1_run_check_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_run_check_response_proto_rawDesc), len(file_commonpb_v1_run_check_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_run_check_response_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_run_check_response_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_run_check_response_proto_msgTypes,
	}.Build()
	File_commonpb_v1_run_check_response_proto = out.File
	file_commonpb_v1_run_check_response_proto_goTypes = nil
	file_commonpb_v1_run_check_response_proto_depIdxs = nil
}
