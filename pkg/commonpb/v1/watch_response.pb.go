...
// 	protoc        (unknown)
// source: commonpb/v1/watch_response.proto
...
func (x *WatchResponse) Reset() {
	*x = WatchResponse{}
	mi := &file_commonpb_v1_watch_response_proto_msgTypes[0]
...
var File_commonpb_v1_watch_response_proto protoreflect.FileDescriptor

const file_commonpb_v1_watch_response_proto_rawDesc = "" +
	"\n" +
	" commonpb/v1/watch_response.proto\x12\tcommon.v1\x1a\x1ecommonpb/v1/check_result.proto\x1a\x17commonpb/v1/error.proto\x1a commonpb/v1/health_metrics.proto\x1a\x1fcommonpb/v1/health_status.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa9\x03\n" +
	"\rWatchResponse\x125\n" +
	...
	"\ametrics\x18\b \x01(\v2\x18.common.v1.HealthMetricsR\ametricsB\x98\x01\n" +
	"\rcom.common.v1B\x12WatchResponseProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_watch_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v1_watch_response_proto_goTypes = []any{
	(*WatchResponse)(nil),         // 0: common.v1.WatchResponse
...
var file_commonpb_v1_watch_response_proto_depIdxs = []int32{
	1, // 0: common.v1.WatchResponse.status:type_name -> common.v1.CommonHealthStatus
	2, // 1: common.v1.WatchResponse.timestamp:type_name -> google.protobuf.Timestamp
	3, // 2: common.v1.WatchResponse.response_time:type_name -> google.protobuf.Duration
	4, // 3: common.v1.WatchResponse.check_results:type_name -> common.v1.CheckResult
	5, // 4: common.v1.WatchResponse.error:type_name -> common.v1.Error
	6, // 5: common.v1.WatchResponse.metrics:type_name -> common.v1.HealthMetrics
...
func init() { file_commonpb_v1_watch_response_proto_init() }
func file_commonpb_v1_watch_response_proto_init() {
	if File_commonpb_v1_watch_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_watch_response_proto_rawDesc), len(file_commonpb_v1_watch_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_watch_response_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_watch_response_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_watch_response_proto_msgTypes,
	}.Build()
	File_commonpb_v1_watch_response_proto = out.File
	file_commonpb_v1_watch_response_proto_goTypes = nil
	file_commonpb_v1_watch_response_proto_depIdxs = nil
}
