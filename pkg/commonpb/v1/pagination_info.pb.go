...
// 	protoc        (unknown)
// source: commonpb/v1/pagination_info.proto
...
func (x *CommonPaginationInfo) Reset() {
	*x = CommonPaginationInfo{}
	mi := &file_commonpb_v1_pagination_info_proto_msgTypes[0]
...
var File_commonpb_v1_pagination_info_proto protoreflect.FileDescriptor

const file_commonpb_v1_pagination_info_proto_rawDesc = "" +
	"\n" +
	"!commonpb/v1/pagination_info.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xed\x02\n" +
...
var file_commonpb_v1_pagination_info_proto_goTypes = []any{
	(*CommonPaginationInfo)(nil), // 0: common.v1.CommonPaginationInfo
}
var file_commonpb_v1_pagination_info_proto_depIdxs = []int32{
...
func init() { file_commonpb_v1_pagination_info_proto_init() }
func file_commonpb_v1_pagination_info_proto_init() {
	if File_commonpb_v1_pagination_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_pagination_info_proto_rawDesc), len(file_commonpb_v1_pagination_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_pagination_info_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_pagination_info_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_pagination_info_proto_msgTypes,
	}.Build()
	File_commonpb_v1_pagination_info_proto = out.File
	file_commonpb_v1_pagination_info_proto_goTypes = nil
	file_commonpb_v1_pagination_info_proto_depIdxs = nil
}
