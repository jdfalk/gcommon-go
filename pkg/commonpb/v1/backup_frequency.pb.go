...
// 	protoc        (unknown)
// source: commonpb/v1/backup_frequency.proto
...
func (BackupFrequency) Descriptor() protoreflect.EnumDescriptor {
	return file_commonpb_v1_backup_frequency_proto_enumTypes[0].Descriptor()
}

func (BackupFrequency) Type() protoreflect.EnumType {
	return &file_commonpb_v1_backup_frequency_proto_enumTypes[0]
}
...
var File_commonpb_v1_backup_frequency_proto protoreflect.FileDescriptor

const file_commonpb_v1_backup_frequency_proto_rawDesc = "" +
	"\n" +
	"\"commonpb/v1/backup_frequency.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto*\xe4\x01\n" +
	...
	"\x1aBACKUP_FREQUENCY_ON_CHANGE\x10\x06B\x9a\x01\n" +
	"\rcom.common.v1B\x14BackupFrequencyProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_backup_frequency_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_commonpb_v1_backup_frequency_proto_goTypes = []any{
	(BackupFrequency)(0), // 0: common.v1.BackupFrequency
}
var file_commonpb_v1_backup_frequency_proto_depIdxs = []int32{
...
func init() { file_commonpb_v1_backup_frequency_proto_init() }
func file_commonpb_v1_backup_frequency_proto_init() {
	if File_commonpb_v1_backup_frequency_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_backup_frequency_proto_rawDesc), len(file_commonpb_v1_backup_frequency_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_backup_frequency_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_backup_frequency_proto_depIdxs,
		EnumInfos:         file_commonpb_v1_backup_frequency_proto_enumTypes,
	}.Build()
	File_commonpb_v1_backup_frequency_proto = out.File
	file_commonpb_v1_backup_frequency_proto_goTypes = nil
	file_commonpb_v1_backup_frequency_proto_depIdxs = nil
}
