...
// 	protoc        (unknown)
// source: commonpb/v1/health_metrics.proto
...
func (x *HealthMetrics) Reset() {
	*x = HealthMetrics{}
	mi := &file_commonpb_v1_health_metrics_proto_msgTypes[0]
...
var File_commonpb_v1_health_metrics_proto protoreflect.FileDescriptor

const file_commonpb_v1_health_metrics_proto_rawDesc = "" +
	"\n" +
	" commonpb/v1/health_metrics.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa4\x04\n" +
	"\rHealthMetrics\x12*\n" +
	"\ftotal_checks\x18\x01 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\vtotalChecks\x12.\n" +
	"\x0ehealthy_checks\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\rhealthyChecks\x122\n" +
	"\x10unhealthy_checks\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x0funhealthyChecks\x12.\n" +
	"\x0eunknown_checks\x18\x04 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\runknownChecks\x12G\n" +
	"\x18average_response_time_ms\x18\x05 \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\x15averageResponseTimeMs\x12=\n" +
	"\flast_updated\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\vlastUpdated\x125\n" +
	"\x0euptime_seconds\x18\a \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\ruptimeSeconds\x12R\n" +
	"\x0ecustom_metrics\x18\b \x03(\v2+.common.v1.HealthMetrics.CustomMetricsEntryR\rcustomMetrics\x1a@\n" +
	"\x12CustomMetricsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05value:\x028\x01B\x98\x01\n" +
	"\rcom.common.v1B\x12HealthMetricsProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_health_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_commonpb_v1_health_metrics_proto_goTypes = []any{
	(*HealthMetrics)(nil),         // 0: common.v1.HealthMetrics
	nil,                           // 1: common.v1.HealthMetrics.CustomMetricsEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_commonpb_v1_health_metrics_proto_depIdxs = []int32{
	2, // 0: common.v1.HealthMetrics.last_updated:type_name -> google.protobuf.Timestamp
	1, // 1: common.v1.HealthMetrics.custom_metrics:type_name -> common.v1.HealthMetrics.CustomMetricsEntry
...
func init() { file_commonpb_v1_health_metrics_proto_init() }
func file_commonpb_v1_health_metrics_proto_init() {
	if File_commonpb_v1_health_metrics_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_health_metrics_proto_rawDesc), len(file_commonpb_v1_health_metrics_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_health_metrics_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_health_metrics_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_health_metrics_proto_msgTypes,
	}.Build()
	File_commonpb_v1_health_metrics_proto = out.File
	file_commonpb_v1_health_metrics_proto_goTypes = nil
	file_commonpb_v1_health_metrics_proto_depIdxs = nil
}
