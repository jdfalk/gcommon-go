...
// 	protoc        (unknown)
// source: commonpb/v1/version_deployment_status.proto
...
func (VersionDeploymentStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_commonpb_v1_version_deployment_status_proto_enumTypes[0].Descriptor()
}

func (VersionDeploymentStatus) Type() protoreflect.EnumType {
	return &file_commonpb_v1_version_deployment_status_proto_enumTypes[0]
}
...
var File_commonpb_v1_version_deployment_status_proto protoreflect.FileDescriptor

const file_commonpb_v1_version_deployment_status_proto_rawDesc = "" +
	"\n" +
	"+commonpb/v1/version_deployment_status.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto*\xb7\x02\n" +
	...
	"#VERSION_DEPLOYMENT_STATUS_CANCELLED\x10\x06B\xa2\x01\n" +
	"\rcom.common.v1B\x1cVersionDeploymentStatusProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_version_deployment_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_commonpb_v1_version_deployment_status_proto_goTypes = []any{
	(VersionDeploymentStatus)(0), // 0: common.v1.VersionDeploymentStatus
}
var file_commonpb_v1_version_deployment_status_proto_depIdxs = []int32{
...
func init() { file_commonpb_v1_version_deployment_status_proto_init() }
func file_commonpb_v1_version_deployment_status_proto_init() {
	if File_commonpb_v1_version_deployment_status_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_version_deployment_status_proto_rawDesc), len(file_commonpb_v1_version_deployment_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_version_deployment_status_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_version_deployment_status_proto_depIdxs,
		EnumInfos:         file_commonpb_v1_version_deployment_status_proto_enumTypes,
	}.Build()
	File_commonpb_v1_version_deployment_status_proto = out.File
	file_commonpb_v1_version_deployment_status_proto_goTypes = nil
	file_commonpb_v1_version_deployment_status_proto_depIdxs = nil
}
