...
// 	protoc        (unknown)
// source: commonpb/v1/ack_mode.proto
...
func (AckMode) Descriptor() protoreflect.EnumDescriptor {
	return file_commonpb_v1_ack_mode_proto_enumTypes[0].Descriptor()
}

func (AckMode) Type() protoreflect.EnumType {
	return &file_commonpb_v1_ack_mode_proto_enumTypes[0]
}
...
var File_commonpb_v1_ack_mode_proto protoreflect.FileDescriptor

const file_commonpb_v1_ack_mode_proto_rawDesc = "" +
	"\n" +
	"\x1acommonpb/v1/ack_mode.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto*`\n" +
	"\aAckMode\x12\x18\n" +
...
var file_commonpb_v1_ack_mode_proto_goTypes = []any{
	(AckMode)(0), // 0: common.v1.AckMode
}
var file_commonpb_v1_ack_mode_proto_depIdxs = []int32{
...
func init() { file_commonpb_v1_ack_mode_proto_init() }
func file_commonpb_v1_ack_mode_proto_init() {
	if File_commonpb_v1_ack_mode_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_ack_mode_proto_rawDesc), len(file_commonpb_v1_ack_mode_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_ack_mode_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_ack_mode_proto_depIdxs,
		EnumInfos:         file_commonpb_v1_ack_mode_proto_enumTypes,
	}.Build()
	File_commonpb_v1_ack_mode_proto = out.File
	file_commonpb_v1_ack_mode_proto_goTypes = nil
	file_commonpb_v1_ack_mode_proto_depIdxs = nil
}
