...
// 	protoc        (unknown)
// source: commonpb/v1/serving_status.proto
...
func (ServingStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_commonpb_v1_serving_status_proto_enumTypes[0].Descriptor()
}

func (ServingStatus) Type() protoreflect.EnumType {
	return &file_commonpb_v1_serving_status_proto_enumTypes[0]
}
...
var File_commonpb_v1_serving_status_proto protoreflect.FileDescriptor

const file_commonpb_v1_serving_status_proto_rawDesc = "" +
	"\n" +
	" commonpb/v1/serving_status.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto*\x90\x01\n" +
...
var file_commonpb_v1_serving_status_proto_goTypes = []any{
	(ServingStatus)(0), // 0: common.v1.ServingStatus
}
var file_commonpb_v1_serving_status_proto_depIdxs = []int32{
...
func init() { file_commonpb_v1_serving_status_proto_init() }
func file_commonpb_v1_serving_status_proto_init() {
	if File_commonpb_v1_serving_status_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_serving_status_proto_rawDesc), len(file_commonpb_v1_serving_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_serving_status_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_serving_status_proto_depIdxs,
		EnumInfos:         file_commonpb_v1_serving_status_proto_enumTypes,
	}.Build()
	File_commonpb_v1_serving_status_proto = out.File
	file_commonpb_v1_serving_status_proto_goTypes = nil
	file_commonpb_v1_serving_status_proto_depIdxs = nil
}
