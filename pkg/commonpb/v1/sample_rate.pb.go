...
// 	protoc        (unknown)
// source: commonpb/v1/sample_rate.proto
...
func (SampleRate) Descriptor() protoreflect.EnumDescriptor {
	return file_commonpb_v1_sample_rate_proto_enumTypes[0].Descriptor()
}

func (SampleRate) Type() protoreflect.EnumType {
	return &file_commonpb_v1_sample_rate_proto_enumTypes[0]
}
...
var File_commonpb_v1_sample_rate_proto protoreflect.FileDescriptor

const file_commonpb_v1_sample_rate_proto_rawDesc = "" +
	"\n" +
	"\x1dcommonpb/v1/sample_rate.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto*\x89\x02\n" +
	"\n" +
	"SampleRate\x12\x1b\n" +
...
var file_commonpb_v1_sample_rate_proto_goTypes = []any{
	(SampleRate)(0), // 0: common.v1.SampleRate
}
var file_commonpb_v1_sample_rate_proto_depIdxs = []int32{
...
func init() { file_commonpb_v1_sample_rate_proto_init() }
func file_commonpb_v1_sample_rate_proto_init() {
	if File_commonpb_v1_sample_rate_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_sample_rate_proto_rawDesc), len(file_commonpb_v1_sample_rate_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_sample_rate_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_sample_rate_proto_depIdxs,
		EnumInfos:         file_commonpb_v1_sample_rate_proto_enumTypes,
	}.Build()
	File_commonpb_v1_sample_rate_proto = out.File
	file_commonpb_v1_sample_rate_proto_goTypes = nil
	file_commonpb_v1_sample_rate_proto_depIdxs = nil
}
