...
// 	protoc        (unknown)
// source: commonpb/v1/config_value.proto
...
type ConfigValue struct {
	...
	xxx_hidden_Type      ValueType              `protobuf:"varint,7,opt,name=type,enum=common.v1.ValueType"`
...
func (x *ConfigValue) Reset() {
	*x = ConfigValue{}
	mi := &file_commonpb_v1_config_value_proto_msgTypes[0]
...
func (x case_ConfigValue_Value) String() string {
	md := file_commonpb_v1_config_value_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_commonpb_v1_config_value_proto protoreflect.FileDescriptor

const file_commonpb_v1_config_value_proto_rawDesc = "" +
	"\n" +
	"\x1ecommonpb/v1/config_value.proto\x12\tcommon.v1\x1a\x1ccommonpb/v1/value_type.proto\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe9\x03\n" +
	"\vConfigValue\x12,\n" +
	...
	"\x04type\x18\a \x01(\x0e2\x14.common.v1.ValueTypeR\x04type\x12\x1c\n" +
	"\tencrypted\x18\b \x01(\bR\tencrypted\x12D\n" +
	"\bmetadata\x18\t \x03(\v2$.common.v1.ConfigValue.MetadataEntryB\x02(\x01R\bmetadata\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\a\n" +
	"\x05valueB\x96\x01\n" +
	"\rcom.common.v1B\x10ConfigValueProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_config_value_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_commonpb_v1_config_value_proto_goTypes = []any{
	(*ConfigValue)(nil), // 0: common.v1.ConfigValue
	nil,                 // 1: common.v1.ConfigValue.MetadataEntry
	(*anypb.Any)(nil),   // 2: google.protobuf.Any
	(ValueType)(0),      // 3: common.v1.ValueType
}
var file_commonpb_v1_config_value_proto_depIdxs = []int32{
	2, // 0: common.v1.ConfigValue.any_value:type_name -> google.protobuf.Any
	3, // 1: common.v1.ConfigValue.type:type_name -> common.v1.ValueType
	1, // 2: common.v1.ConfigValue.metadata:type_name -> common.v1.ConfigValue.MetadataEntry
...
func init() { file_commonpb_v1_config_value_proto_init() }
func file_commonpb_v1_config_value_proto_init() {
	if File_commonpb_v1_config_value_proto != nil {
		return
	}
	file_commonpb_v1_value_type_proto_init()
	file_commonpb_v1_config_value_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_config_value_proto_rawDesc), len(file_commonpb_v1_config_value_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_config_value_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_config_value_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_config_value_proto_msgTypes,
	}.Build()
	File_commonpb_v1_config_value_proto = out.File
	file_commonpb_v1_config_value_proto_goTypes = nil
	file_commonpb_v1_config_value_proto_depIdxs = nil
}
