...
// 	protoc        (unknown)
// source: commonpb/v1/error.proto
...
type Error struct {
	...
	xxx_hidden_Code        ErrorCode              `protobuf:"varint,1,opt,name=code,enum=common.v1.ErrorCode"`
...
func (x *Error) Reset() {
	*x = Error{}
	mi := &file_commonpb_v1_error_proto_msgTypes[0]
...
var File_commonpb_v1_error_proto protoreflect.FileDescriptor

const file_commonpb_v1_error_proto_rawDesc = "" +
	"\n" +
	"\x17commonpb/v1/error.proto\x12\tcommon.v1\x1a\x1ccommonpb/v1/error_code.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xc8\x02\n" +
	"\x05Error\x12(\n" +
	...
	"\adetails\x18\x03 \x03(\v2\x1d.common.v1.Error.DetailsEntryR\adetails\x12\"\n" +
	...
	"\rcom.common.v1B\n" +
	"ErrorProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_error_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_commonpb_v1_error_proto_goTypes = []any{
	(*Error)(nil),                 // 0: common.v1.Error
	nil,                           // 1: common.v1.Error.DetailsEntry
	(ErrorCode)(0),                // 2: common.v1.ErrorCode
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_commonpb_v1_error_proto_depIdxs = []int32{
	2, // 0: common.v1.Error.code:type_name -> common.v1.ErrorCode
	1, // 1: common.v1.Error.details:type_name -> common.v1.Error.DetailsEntry
	3, // 2: common.v1.Error.timestamp:type_name -> google.protobuf.Timestamp
...
func init() { file_commonpb_v1_error_proto_init() }
func file_commonpb_v1_error_proto_init() {
	if File_commonpb_v1_error_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_error_proto_rawDesc), len(file_commonpb_v1_error_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_error_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_error_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_error_proto_msgTypes,
	}.Build()
	File_commonpb_v1_error_proto = out.File
	file_commonpb_v1_error_proto_goTypes = nil
	file_commonpb_v1_error_proto_depIdxs = nil
}
