...
// 	protoc        (unknown)
// source: commonpb/v1/o_auth_client.proto
...
type OAuthClient struct {
	...
	xxx_hidden_Status        ResourceStatus         `protobuf:"varint,11,opt,name=status,enum=common.v1.ResourceStatus"`
...
func (x *OAuthClient) Reset() {
	*x = OAuthClient{}
	mi := &file_commonpb_v1_o_auth_client_proto_msgTypes[0]
...
var File_commonpb_v1_o_auth_client_proto protoreflect.FileDescriptor

const file_commonpb_v1_o_auth_client_proto_rawDesc = "" +
	"\n" +
	"\x1fcommonpb/v1/o_auth_client.proto\x12\tcommon.v1\x1a!commonpb/v1/resource_status.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xaf\x05\n" +
	...
	"\x06status\x18\v \x01(\x0e2\x19.common.v1.ResourceStatusR\x06status\x12D\n" +
	"\bmetadata\x18\f \x03(\v2$.common.v1.OAuthClient.MetadataEntryB\x02(\x01R\bmetadata\x12#\n" +
	...
	"\rcom.common.v1B\x10OAuthClientProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_o_auth_client_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_commonpb_v1_o_auth_client_proto_goTypes = []any{
	(*OAuthClient)(nil),           // 0: common.v1.OAuthClient
	nil,                           // 1: common.v1.OAuthClient.MetadataEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(ResourceStatus)(0),           // 3: common.v1.ResourceStatus
}
var file_commonpb_v1_o_auth_client_proto_depIdxs = []int32{
	2, // 0: common.v1.OAuthClient.created_at:type_name -> google.protobuf.Timestamp
	3, // 1: common.v1.OAuthClient.status:type_name -> common.v1.ResourceStatus
	1, // 2: common.v1.OAuthClient.metadata:type_name -> common.v1.OAuthClient.MetadataEntry
...
func init() { file_commonpb_v1_o_auth_client_proto_init() }
func file_commonpb_v1_o_auth_client_proto_init() {
	if File_commonpb_v1_o_auth_client_proto != nil {
		return
	}
	file_commonpb_v1_resource_status_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_o_auth_client_proto_rawDesc), len(file_commonpb_v1_o_auth_client_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_o_auth_client_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_o_auth_client_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_o_auth_client_proto_msgTypes,
	}.Build()
	File_commonpb_v1_o_auth_client_proto = out.File
	file_commonpb_v1_o_auth_client_proto_goTypes = nil
	file_commonpb_v1_o_auth_client_proto_depIdxs = nil
}
