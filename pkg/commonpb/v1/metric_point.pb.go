...
// 	protoc        (unknown)
// source: commonpb/v1/metric_point.proto
...
func (x *MetricPoint) Reset() {
	*x = MetricPoint{}
	mi := &file_commonpb_v1_metric_point_proto_msgTypes[0]
...
var File_commonpb_v1_metric_point_proto protoreflect.FileDescriptor

const file_commonpb_v1_metric_point_proto_rawDesc = "" +
	"\n" +
	"\x1ecommonpb/v1/metric_point.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x87\x02\n" +
	...
	"\x06labels\x18\x04 \x03(\v2\".common.v1.MetricPoint.LabelsEntryR\x06labels\x12\x12\n" +
	"\x04unit\x18\x05 \x01(\tR\x04unit\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x96\x01\n" +
	"\rcom.common.v1B\x10MetricPointProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_metric_point_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_commonpb_v1_metric_point_proto_goTypes = []any{
	(*MetricPoint)(nil),           // 0: common.v1.MetricPoint
	nil,                           // 1: common.v1.MetricPoint.LabelsEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_commonpb_v1_metric_point_proto_depIdxs = []int32{
	2, // 0: common.v1.MetricPoint.timestamp:type_name -> google.protobuf.Timestamp
	1, // 1: common.v1.MetricPoint.labels:type_name -> common.v1.MetricPoint.LabelsEntry
...
func init() { file_commonpb_v1_metric_point_proto_init() }
func file_commonpb_v1_metric_point_proto_init() {
	if File_commonpb_v1_metric_point_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_metric_point_proto_rawDesc), len(file_commonpb_v1_metric_point_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_metric_point_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_metric_point_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_metric_point_proto_msgTypes,
	}.Build()
	File_commonpb_v1_metric_point_proto = out.File
	file_commonpb_v1_metric_point_proto_goTypes = nil
	file_commonpb_v1_metric_point_proto_depIdxs = nil
}
