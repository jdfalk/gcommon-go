...
const (
	LogService_WriteLog_FullMethodName = "/common.v1.LogService/WriteLog"
	LogService_ReadLogs_FullMethodName = "/common.v1.LogService/ReadLogs"
)
...
func _LogService_ReadLogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(LogServiceServer).ReadLogs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var LogService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "common.v1.LogService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReadLogs",
			Handler:    _LogService_ReadLogs_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "commonpb/v1/log_service.proto",
}
