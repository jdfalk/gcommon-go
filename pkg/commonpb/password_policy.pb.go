...
// 	protoc        (unknown)
// source: commonpb/v1/password_policy.proto
...
func (x *PasswordPolicy) Reset() {
	*x = PasswordPolicy{}
	mi := &file_commonpb_v1_password_policy_proto_msgTypes[0]
...
var File_commonpb_v1_password_policy_proto protoreflect.FileDescriptor

const file_commonpb_v1_password_policy_proto_rawDesc = "" +
	"\n" +
	"!commonpb/v1/password_policy.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd2\x02\n" +
	...
	"allowReuseB\x99\x01\n" +
	"\rcom.common.v1B\x13PasswordPolicyProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_password_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v1_password_policy_proto_goTypes = []any{
	(*PasswordPolicy)(nil), // 0: common.v1.PasswordPolicy
}
var file_commonpb_v1_password_policy_proto_depIdxs = []int32{
...
func init() { file_commonpb_v1_password_policy_proto_init() }
func file_commonpb_v1_password_policy_proto_init() {
	if File_commonpb_v1_password_policy_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_password_policy_proto_rawDesc), len(file_commonpb_v1_password_policy_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_password_policy_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_password_policy_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_password_policy_proto_msgTypes,
	}.Build()
	File_commonpb_v1_password_policy_proto = out.File
	file_commonpb_v1_password_policy_proto_goTypes = nil
	file_commonpb_v1_password_policy_proto_depIdxs = nil
}
