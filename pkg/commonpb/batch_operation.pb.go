...
// 	protoc        (unknown)
// source: commonpb/v1/batch_operation.proto
...
func (x *CommonBatchOperation) Reset() {
	*x = CommonBatchOperation{}
	mi := &file_commonpb_v1_batch_operation_proto_msgTypes[0]
...
var File_commonpb_v1_batch_operation_proto protoreflect.FileDescriptor

const file_commonpb_v1_batch_operation_proto_rawDesc = "" +
	"\n" +
	"!commonpb/v1/batch_operation.proto\x12\tcommon.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1fcommonpb/v1/batch_options.proto\x1a\"commonpb/v1/request_metadata.proto\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\"\xa5\x02\n" +
	...
	"operations\x12;\n" +
	"\aoptions\x18\x04 \x01(\v2\x1d.common.v1.CommonBatchOptionsB\x02(\x01R\aoptions\x12:\n" +
	"\bmetadata\x18\x05 \x01(\v2\x1a.common.v1.RequestMetadataB\x02(\x01R\bmetadataB\x99\x01\n" +
	"\rcom.common.v1B\x13BatchOperationProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_batch_operation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v1_batch_operation_proto_goTypes = []any{
	(*CommonBatchOperation)(nil), // 0: common.v1.CommonBatchOperation
	(*anypb.Any)(nil),            // 1: google.protobuf.Any
	(*CommonBatchOptions)(nil),   // 2: common.v1.CommonBatchOptions
	(*RequestMetadata)(nil),      // 3: common.v1.RequestMetadata
}
var file_commonpb_v1_batch_operation_proto_depIdxs = []int32{
	1, // 0: common.v1.CommonBatchOperation.operations:type_name -> google.protobuf.Any
	2, // 1: common.v1.CommonBatchOperation.options:type_name -> common.v1.CommonBatchOptions
	3, // 2: common.v1.CommonBatchOperation.metadata:type_name -> common.v1.RequestMetadata
...
func init() { file_commonpb_v1_batch_operation_proto_init() }
func file_commonpb_v1_batch_operation_proto_init() {
	if File_commonpb_v1_batch_operation_proto != nil {
		return
	}
	file_commonpb_v1_batch_options_proto_init()
	file_commonpb_v1_request_metadata_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_batch_operation_proto_rawDesc), len(file_commonpb_v1_batch_operation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_batch_operation_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_batch_operation_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_batch_operation_proto_msgTypes,
	}.Build()
	File_commonpb_v1_batch_operation_proto = out.File
	file_commonpb_v1_batch_operation_proto_goTypes = nil
	file_commonpb_v1_batch_operation_proto_depIdxs = nil
}
