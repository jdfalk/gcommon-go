...
// 	protoc        (unknown)
// source: commonpb/v1/response_metadata.proto
...
func (x *ResponseMetadata) Reset() {
	*x = ResponseMetadata{}
	mi := &file_commonpb_v1_response_metadata_proto_msgTypes[0]
...
var File_commonpb_v1_response_metadata_proto protoreflect.FileDescriptor

const file_commonpb_v1_response_metadata_proto_rawDesc = "" +
	"\n" +
	"#commonpb/v1/response_metadata.proto\x12\tcommon.v1\x1a\x17commonpb/v1/error.proto\x1a!commonpb/v1/pagination_info.proto\x1a!commonpb/v1/rate_limit_info.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xde\x04\n" +
	...
	"\x05error\x18\a \x01(\v2\x10.common.v1.ErrorR\x05error\x12E\n" +
	"\bmetadata\x18\b \x03(\v2).common.v1.ResponseMetadata.MetadataEntryR\bmetadata\x127\n" +
	"\n" +
	"rate_limit\x18\t \x01(\v2\x18.common.v1.RateLimitInfoR\trateLimit\x12?\n" +
	"\n" +
	"pagination\x18\n" +
	" \x01(\v2\x1f.common.v1.CommonPaginationInfoR\n" +
	"pagination\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x9b\x01\n" +
	"\rcom.common.v1B\x15ResponseMetadataProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_response_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_commonpb_v1_response_metadata_proto_goTypes = []any{
	(*ResponseMetadata)(nil),      // 0: common.v1.ResponseMetadata
	nil,                           // 1: common.v1.ResponseMetadata.MetadataEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 3: google.protobuf.Duration
	(*Error)(nil),                 // 4: common.v1.Error
	(*RateLimitInfo)(nil),         // 5: common.v1.RateLimitInfo
	(*CommonPaginationInfo)(nil),  // 6: common.v1.CommonPaginationInfo
}
var file_commonpb_v1_response_metadata_proto_depIdxs = []int32{
	2, // 0: common.v1.ResponseMetadata.timestamp:type_name -> google.protobuf.Timestamp
	3, // 1: common.v1.ResponseMetadata.processing_time:type_name -> google.protobuf.Duration
	4, // 2: common.v1.ResponseMetadata.error:type_name -> common.v1.Error
	1, // 3: common.v1.ResponseMetadata.metadata:type_name -> common.v1.ResponseMetadata.MetadataEntry
	5, // 4: common.v1.ResponseMetadata.rate_limit:type_name -> common.v1.RateLimitInfo
	6, // 5: common.v1.ResponseMetadata.pagination:type_name -> common.v1.CommonPaginationInfo
...
func init() { file_commonpb_v1_response_metadata_proto_init() }
func file_commonpb_v1_response_metadata_proto_init() {
	if File_commonpb_v1_response_metadata_proto != nil {
		return
	}
	file_commonpb_v1_error_proto_init()
	file_commonpb_v1_pagination_info_proto_init()
	file_commonpb_v1_rate_limit_info_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_response_metadata_proto_rawDesc), len(file_commonpb_v1_response_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_response_metadata_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_response_metadata_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_response_metadata_proto_msgTypes,
	}.Build()
	File_commonpb_v1_response_metadata_proto = out.File
	file_commonpb_v1_response_metadata_proto_goTypes = nil
	file_commonpb_v1_response_metadata_proto_depIdxs = nil
}
