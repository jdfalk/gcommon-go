...
// 	protoc        (unknown)
// source: commonpb/v1/service_version.proto
...
func (x *ServiceVersion) Reset() {
	*x = ServiceVersion{}
	mi := &file_commonpb_v1_service_version_proto_msgTypes[0]
...
var File_commonpb_v1_service_version_proto protoreflect.FileDescriptor

const file_commonpb_v1_service_version_proto_rawDesc = "" +
	"\n" +
	"!commonpb/v1/service_version.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xbb\x01\n" +
	...
	"\n" +
	"go_version\x18\x05 \x01(\tR\tgoVersionB\x99\x01\n" +
	"\rcom.common.v1B\x13ServiceVersionProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_service_version_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v1_service_version_proto_goTypes = []any{
	(*ServiceVersion)(nil),        // 0: common.v1.ServiceVersion
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_commonpb_v1_service_version_proto_depIdxs = []int32{
	1, // 0: common.v1.ServiceVersion.build_time:type_name -> google.protobuf.Timestamp
...
func init() { file_commonpb_v1_service_version_proto_init() }
func file_commonpb_v1_service_version_proto_init() {
	if File_commonpb_v1_service_version_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_service_version_proto_rawDesc), len(file_commonpb_v1_service_version_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_service_version_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_service_version_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_service_version_proto_msgTypes,
	}.Build()
	File_commonpb_v1_service_version_proto = out.File
	file_commonpb_v1_service_version_proto_goTypes = nil
	file_commonpb_v1_service_version_proto_depIdxs = nil
}
