...
// 	protoc        (unknown)
// source: commonpb/v1/organization_access_control.proto
...
func (x *OrganizationAccessControl) Reset() {
	*x = OrganizationAccessControl{}
	mi := &file_commonpb_v1_organization_access_control_proto_msgTypes[0]
...
var File_commonpb_v1_organization_access_control_proto protoreflect.FileDescriptor

const file_commonpb_v1_organization_access_control_proto_rawDesc = "" +
	"\n" +
	"-commonpb/v1/organization_access_control.proto\x12\tcommon.v1\x1a\"commonpb/v1/time_restriction.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf2\x02\n" +
	...
	"\x11time_restrictions\x18\x06 \x03(\v2\x1a.common.v1.TimeRestrictionB\b\xbaH\x05\x92\x01\x02\b\x01R\x10timeRestrictionsB\xa4\x01\n" +
	"\rcom.common.v1B\x1eOrganizationAccessControlProtoP\x01Z&github.com/jdfalk/gcommon/pkg/commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
	"Common::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_commonpb_v1_organization_access_control_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_commonpb_v1_organization_access_control_proto_goTypes = []any{
	(*OrganizationAccessControl)(nil), // 0: common.v1.OrganizationAccessControl
	(*TimeRestriction)(nil),           // 1: common.v1.TimeRestriction
}
var file_commonpb_v1_organization_access_control_proto_depIdxs = []int32{
	1, // 0: common.v1.OrganizationAccessControl.time_restrictions:type_name -> common.v1.TimeRestriction
...
func init() { file_commonpb_v1_organization_access_control_proto_init() }
func file_commonpb_v1_organization_access_control_proto_init() {
	if File_commonpb_v1_organization_access_control_proto != nil {
		return
	}
	file_commonpb_v1_time_restriction_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_commonpb_v1_organization_access_control_proto_rawDesc), len(file_commonpb_v1_organization_access_control_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_commonpb_v1_organization_access_control_proto_goTypes,
		DependencyIndexes: file_commonpb_v1_organization_access_control_proto_depIdxs,
		MessageInfos:      file_commonpb_v1_organization_access_control_proto_msgTypes,
	}.Build()
	File_commonpb_v1_organization_access_control_proto = out.File
	file_commonpb_v1_organization_access_control_proto_goTypes = nil
	file_commonpb_v1_organization_access_control_proto_depIdxs = nil
}
