...
// 	protoc        (unknown)
// source: common/v1/sample_rate.proto
...
func (SampleRate) Descriptor() protoreflect.EnumDescriptor {
	return file_common_v1_sample_rate_proto_enumTypes[0].Descriptor()
}

func (SampleRate) Type() protoreflect.EnumType {
	return &file_common_v1_sample_rate_proto_enumTypes[0]
}
...
var File_common_v1_sample_rate_proto protoreflect.FileDescriptor

const file_common_v1_sample_rate_proto_rawDesc = "" +
	"\n" +
	"\x1bcommon/v1/sample_rate.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto*\x89\x02\n" +
	"\n" +
	"SampleRate\x12\x1b\n" +
	...
	"\x12SAMPLE_RATE_CUSTOM\x10\tB/Z%github.com/jdfalk/gcommon/pkg/common/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v1_sample_rate_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_common_v1_sample_rate_proto_goTypes = []any{
	(SampleRate)(0), // 0: common.v1.SampleRate
}
var file_common_v1_sample_rate_proto_depIdxs = []int32{
...
func init() { file_common_v1_sample_rate_proto_init() }
func file_common_v1_sample_rate_proto_init() {
	if File_common_v1_sample_rate_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_sample_rate_proto_rawDesc), len(file_common_v1_sample_rate_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_sample_rate_proto_goTypes,
		DependencyIndexes: file_common_v1_sample_rate_proto_depIdxs,
		EnumInfos:         file_common_v1_sample_rate_proto_enumTypes,
	}.Build()
	File_common_v1_sample_rate_proto = out.File
	file_common_v1_sample_rate_proto_goTypes = nil
	file_common_v1_sample_rate_proto_depIdxs = nil
}
