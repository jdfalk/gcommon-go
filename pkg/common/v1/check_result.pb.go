...
// 	protoc        (unknown)
// source: common/v1/check_result.proto
...
func (x *CheckResult) Reset() {
	*x = CheckResult{}
	mi := &file_common_v1_check_result_proto_msgTypes[0]
...
var File_common_v1_check_result_proto protoreflect.FileDescriptor

const file_common_v1_check_result_proto_rawDesc = "" +
	"\n" +
	"\x1ccommon/v1/check_result.proto\x12\tcommon.v1\x1a\x15common/v1/error.proto\x1a\x1dcommon/v1/health_status.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa0\x03\n" +
...
var file_common_v1_check_result_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_common_v1_check_result_proto_goTypes = []any{
...
var file_common_v1_check_result_proto_depIdxs = []int32{
...
func init() { file_common_v1_check_result_proto_init() }
func file_common_v1_check_result_proto_init() {
	if File_common_v1_check_result_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_check_result_proto_rawDesc), len(file_common_v1_check_result_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_check_result_proto_goTypes,
		DependencyIndexes: file_common_v1_check_result_proto_depIdxs,
		MessageInfos:      file_common_v1_check_result_proto_msgTypes,
	}.Build()
	File_common_v1_check_result_proto = out.File
	file_common_v1_check_result_proto_goTypes = nil
	file_common_v1_check_result_proto_depIdxs = nil
}
