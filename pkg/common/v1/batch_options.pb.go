...
// 	protoc        (unknown)
// source: common/v1/batch_options.proto
...
func (x *CommonBatchOptions) Reset() {
	*x = CommonBatchOptions{}
	mi := &file_common_v1_batch_options_proto_msgTypes[0]
...
var File_common_v1_batch_options_proto protoreflect.FileDescriptor

const file_common_v1_batch_options_proto_rawDesc = "" +
	"\n" +
	"\x1dcommon/v1/batch_options.proto\x12\tcommon.v1\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb9\x01\n" +
	...
	"\x0ereturn_partial\x18\x04 \x01(\bR\rreturnPartialB-Z#github.com/jdfalk/gcommon/common/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_common_v1_batch_options_proto_depIdxs = []int32{
...
func init() { file_common_v1_batch_options_proto_init() }
func file_common_v1_batch_options_proto_init() {
	if File_common_v1_batch_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_batch_options_proto_rawDesc), len(file_common_v1_batch_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_batch_options_proto_goTypes,
		DependencyIndexes: file_common_v1_batch_options_proto_depIdxs,
		MessageInfos:      file_common_v1_batch_options_proto_msgTypes,
	}.Build()
	File_common_v1_batch_options_proto = out.File
	file_common_v1_batch_options_proto_goTypes = nil
	file_common_v1_batch_options_proto_depIdxs = nil
}
