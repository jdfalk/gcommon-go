...
func (x *ListApiKeysResponse) Reset() {
	*x = ListApiKeysResponse{}
	mi := &file_common_v1_list_api_keys_response_proto_msgTypes[0]
...
var File_common_v1_list_api_keys_response_proto protoreflect.FileDescriptor

const file_common_v1_list_api_keys_response_proto_rawDesc = "" +
	"\n" +
	"&common/v1/list_api_keys_response.proto\x12\tcommon.v1\x1a\x17common/v1/api_key.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa8\x01\n" +
...
var file_common_v1_list_api_keys_response_proto_depIdxs = []int32{
...
func init() { file_common_v1_list_api_keys_response_proto_init() }
func file_common_v1_list_api_keys_response_proto_init() {
	if File_common_v1_list_api_keys_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_list_api_keys_response_proto_rawDesc), len(file_common_v1_list_api_keys_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_list_api_keys_response_proto_goTypes,
		DependencyIndexes: file_common_v1_list_api_keys_response_proto_depIdxs,
		MessageInfos:      file_common_v1_list_api_keys_response_proto_msgTypes,
	}.Build()
	File_common_v1_list_api_keys_response_proto = out.File
	file_common_v1_list_api_keys_response_proto_goTypes = nil
	file_common_v1_list_api_keys_response_proto_depIdxs = nil
}
