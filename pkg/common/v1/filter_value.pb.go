...
// 	protoc        (unknown)
// source: common/v1/filter_value.proto
...
func (x *FilterValue) Reset() {
	*x = FilterValue{}
	mi := &file_common_v1_filter_value_proto_msgTypes[0]
...
func (x case_FilterValue_Value) String() string {
	md := file_common_v1_filter_value_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_common_v1_filter_value_proto protoreflect.FileDescriptor

const file_common_v1_filter_value_proto_rawDesc = "" +
	"\n" +
	"\x1ccommon/v1/filter_value.proto\x12\tcommon.v1\x1a common/v1/filter_operation.proto\x1a\x1bcommon/v1/int64_array.proto\x1a\x1ccommon/v1/string_array.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf7\x02\n" +
	"\vFilterValue\x12,\n" +
...
var file_common_v1_filter_value_proto_depIdxs = []int32{
...
func init() { file_common_v1_filter_value_proto_init() }
func file_common_v1_filter_value_proto_init() {
	if File_common_v1_filter_value_proto != nil {
		return
	}
	file_common_v1_filter_operation_proto_init()
	file_common_v1_int64_array_proto_init()
	file_common_v1_string_array_proto_init()
	file_common_v1_filter_value_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_filter_value_proto_rawDesc), len(file_common_v1_filter_value_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_filter_value_proto_goTypes,
		DependencyIndexes: file_common_v1_filter_value_proto_depIdxs,
		MessageInfos:      file_common_v1_filter_value_proto_msgTypes,
	}.Build()
	File_common_v1_filter_value_proto = out.File
	file_common_v1_filter_value_proto_goTypes = nil
	file_common_v1_filter_value_proto_depIdxs = nil
}
