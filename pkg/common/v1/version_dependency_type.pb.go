...
func (VersionDependencyType) Descriptor() protoreflect.EnumDescriptor {
	return file_common_v1_version_dependency_type_proto_enumTypes[0].Descriptor()
}

func (VersionDependencyType) Type() protoreflect.EnumType {
	return &file_common_v1_version_dependency_type_proto_enumTypes[0]
}
...
var File_common_v1_version_dependency_type_proto protoreflect.FileDescriptor

const file_common_v1_version_dependency_type_proto_rawDesc = "" +
	"\n" +
	"'common/v1/version_dependency_type.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto*\x93\x02\n" +
...
var file_common_v1_version_dependency_type_proto_depIdxs = []int32{
...
func init() { file_common_v1_version_dependency_type_proto_init() }
func file_common_v1_version_dependency_type_proto_init() {
	if File_common_v1_version_dependency_type_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_version_dependency_type_proto_rawDesc), len(file_common_v1_version_dependency_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_version_dependency_type_proto_goTypes,
		DependencyIndexes: file_common_v1_version_dependency_type_proto_depIdxs,
		EnumInfos:         file_common_v1_version_dependency_type_proto_enumTypes,
	}.Build()
	File_common_v1_version_dependency_type_proto = out.File
	file_common_v1_version_dependency_type_proto_goTypes = nil
	file_common_v1_version_dependency_type_proto_depIdxs = nil
}
