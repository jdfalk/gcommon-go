...
// 	protoc        (unknown)
// source: common/v1/paginated_response.proto
...
func (x *PaginatedResponse) Reset() {
	*x = PaginatedResponse{}
	mi := &file_common_v1_paginated_response_proto_msgTypes[0]
...
var File_common_v1_paginated_response_proto protoreflect.FileDescriptor

const file_common_v1_paginated_response_proto_rawDesc = "" +
	"\n" +
	"\"common/v1/paginated_response.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa4\x02\n" +
	...
	"\xbaH\a\x1a\x05\x18\x96\x01(\x00R\bpageSizeB-Z#github.com/jdfalk/gcommon/common/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_common_v1_paginated_response_proto_depIdxs = []int32{
...
func init() { file_common_v1_paginated_response_proto_init() }
func file_common_v1_paginated_response_proto_init() {
	if File_common_v1_paginated_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_paginated_response_proto_rawDesc), len(file_common_v1_paginated_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_paginated_response_proto_goTypes,
		DependencyIndexes: file_common_v1_paginated_response_proto_depIdxs,
		MessageInfos:      file_common_v1_paginated_response_proto_msgTypes,
	}.Build()
	File_common_v1_paginated_response_proto = out.File
	file_common_v1_paginated_response_proto_goTypes = nil
	file_common_v1_paginated_response_proto_depIdxs = nil
}
