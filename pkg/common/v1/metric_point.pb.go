...
// 	protoc        (unknown)
// source: common/v1/metric_point.proto
...
func (x *MetricPoint) Reset() {
	*x = MetricPoint{}
	mi := &file_common_v1_metric_point_proto_msgTypes[0]
...
var File_common_v1_metric_point_proto protoreflect.FileDescriptor

const file_common_v1_metric_point_proto_rawDesc = "" +
	"\n" +
	"\x1ccommon/v1/metric_point.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x87\x02\n" +
...
var file_common_v1_metric_point_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_common_v1_metric_point_proto_goTypes = []any{
	(*MetricPoint)(nil),           // 0: common.v1.MetricPoint
	nil,                           // 1: common.v1.MetricPoint.LabelsEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_common_v1_metric_point_proto_depIdxs = []int32{
...
func init() { file_common_v1_metric_point_proto_init() }
func file_common_v1_metric_point_proto_init() {
	if File_common_v1_metric_point_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_metric_point_proto_rawDesc), len(file_common_v1_metric_point_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_metric_point_proto_goTypes,
		DependencyIndexes: file_common_v1_metric_point_proto_depIdxs,
		MessageInfos:      file_common_v1_metric_point_proto_msgTypes,
	}.Build()
	File_common_v1_metric_point_proto = out.File
	file_common_v1_metric_point_proto_goTypes = nil
	file_common_v1_metric_point_proto_depIdxs = nil
}
