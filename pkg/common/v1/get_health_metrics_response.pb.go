...
func (x *GetHealthMetricsResponse) Reset() {
	*x = GetHealthMetricsResponse{}
	mi := &file_common_v1_get_health_metrics_response_proto_msgTypes[0]
...
var File_common_v1_get_health_metrics_response_proto protoreflect.FileDescriptor

const file_common_v1_get_health_metrics_response_proto_rawDesc = "" +
	"\n" +
...
var file_common_v1_get_health_metrics_response_proto_depIdxs = []int32{
...
func init() { file_common_v1_get_health_metrics_response_proto_init() }
func file_common_v1_get_health_metrics_response_proto_init() {
	if File_common_v1_get_health_metrics_response_proto != nil {
		return
	}
	file_common_v1_health_metric_data_proto_init()
	file_common_v1_request_metadata_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_get_health_metrics_response_proto_rawDesc), len(file_common_v1_get_health_metrics_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_get_health_metrics_response_proto_goTypes,
		DependencyIndexes: file_common_v1_get_health_metrics_response_proto_depIdxs,
		MessageInfos:      file_common_v1_get_health_metrics_response_proto_msgTypes,
	}.Build()
	File_common_v1_get_health_metrics_response_proto = out.File
	file_common_v1_get_health_metrics_response_proto_goTypes = nil
	file_common_v1_get_health_metrics_response_proto_depIdxs = nil
}
