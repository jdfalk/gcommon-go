...
// 	protoc        (unknown)
// source: common/v1/o_auth2_credentials.proto
...
func (x *OAuth2Credentials) Reset() {
	*x = OAuth2Credentials{}
	mi := &file_common_v1_o_auth2_credentials_proto_msgTypes[0]
...
var File_common_v1_o_auth2_credentials_proto protoreflect.FileDescriptor

const file_common_v1_o_auth2_credentials_proto_rawDesc = "" +
	"\n" +
	"#common/v1/o_auth2_credentials.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x96\x01\n" +
	"\x11OAuth2Credentials\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\x12+\n" +
	"\fredirect_uri\x18\x02 \x01(\tB\b\xbaH\x05r\x03\x88\x01\x01R\vredirectUri\x12\x1b\n" +
	"\tclient_id\x18\x03 \x01(\tR\bclientId\x12#\n" +
	"\rclient_secret\x18\x04 \x01(\tR\fclientSecretB/Z%github.com/jdfalk/gcommon/pkg/common/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v1_o_auth2_credentials_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_v1_o_auth2_credentials_proto_goTypes = []any{
	(*OAuth2Credentials)(nil), // 0: common.v1.OAuth2Credentials
}
var file_common_v1_o_auth2_credentials_proto_depIdxs = []int32{
...
func init() { file_common_v1_o_auth2_credentials_proto_init() }
func file_common_v1_o_auth2_credentials_proto_init() {
	if File_common_v1_o_auth2_credentials_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_o_auth2_credentials_proto_rawDesc), len(file_common_v1_o_auth2_credentials_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_o_auth2_credentials_proto_goTypes,
		DependencyIndexes: file_common_v1_o_auth2_credentials_proto_depIdxs,
		MessageInfos:      file_common_v1_o_auth2_credentials_proto_msgTypes,
	}.Build()
	File_common_v1_o_auth2_credentials_proto = out.File
	file_common_v1_o_auth2_credentials_proto_goTypes = nil
	file_common_v1_o_auth2_credentials_proto_depIdxs = nil
}
