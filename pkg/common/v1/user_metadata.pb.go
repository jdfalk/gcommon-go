...
// 	protoc        (unknown)
// source: common/v1/user_metadata.proto
...
func (x *UserMetadata) Reset() {
	*x = UserMetadata{}
	mi := &file_common_v1_user_metadata_proto_msgTypes[0]
...
var File_common_v1_user_metadata_proto protoreflect.FileDescriptor

const file_common_v1_user_metadata_proto_rawDesc = "" +
	"\n" +
	"\x1dcommon/v1/user_metadata.proto\x12\tcommon.v1\x1a common/v1/user_preferences.proto\x1a#common/v1/verification_status.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x9c\x05\n" +
	"\fUserMetadata\x12,\n" +
...
var file_common_v1_user_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_common_v1_user_metadata_proto_goTypes = []any{
...
var file_common_v1_user_metadata_proto_depIdxs = []int32{
...
func init() { file_common_v1_user_metadata_proto_init() }
func file_common_v1_user_metadata_proto_init() {
	if File_common_v1_user_metadata_proto != nil {
		return
	}
	file_common_v1_user_preferences_proto_init()
	file_common_v1_verification_status_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_user_metadata_proto_rawDesc), len(file_common_v1_user_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_user_metadata_proto_goTypes,
		DependencyIndexes: file_common_v1_user_metadata_proto_depIdxs,
		MessageInfos:      file_common_v1_user_metadata_proto_msgTypes,
	}.Build()
	File_common_v1_user_metadata_proto = out.File
	file_common_v1_user_metadata_proto_goTypes = nil
	file_common_v1_user_metadata_proto_depIdxs = nil
}
