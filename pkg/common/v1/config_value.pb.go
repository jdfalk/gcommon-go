...
// 	protoc        (unknown)
// source: common/v1/config_value.proto
...
func (x *ConfigValue) Reset() {
	*x = ConfigValue{}
	mi := &file_common_v1_config_value_proto_msgTypes[0]
...
func (x case_ConfigValue_Value) String() string {
	md := file_common_v1_config_value_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_common_v1_config_value_proto protoreflect.FileDescriptor

const file_common_v1_config_value_proto_rawDesc = "" +
	"\n" +
	"\x1ccommon/v1/config_value.proto\x12\tcommon.v1\x1a\x1acommon/v1/value_type.proto\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe9\x03\n" +
	"\vConfigValue\x12,\n" +
	...
	"\x05valueB-Z#github.com/jdfalk/gcommon/common/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v1_config_value_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_common_v1_config_value_proto_goTypes = []any{
	(*ConfigValue)(nil), // 0: common.v1.ConfigValue
	nil,                 // 1: common.v1.ConfigValue.MetadataEntry
	(*anypb.Any)(nil),   // 2: google.protobuf.Any
	(ValueType)(0),      // 3: common.v1.ValueType
}
var file_common_v1_config_value_proto_depIdxs = []int32{
...
func init() { file_common_v1_config_value_proto_init() }
func file_common_v1_config_value_proto_init() {
	if File_common_v1_config_value_proto != nil {
		return
	}
	file_common_v1_value_type_proto_init()
	file_common_v1_config_value_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_config_value_proto_rawDesc), len(file_common_v1_config_value_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_config_value_proto_goTypes,
		DependencyIndexes: file_common_v1_config_value_proto_depIdxs,
		MessageInfos:      file_common_v1_config_value_proto_msgTypes,
	}.Build()
	File_common_v1_config_value_proto = out.File
	file_common_v1_config_value_proto_goTypes = nil
	file_common_v1_config_value_proto_depIdxs = nil
}
