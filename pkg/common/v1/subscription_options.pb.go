...
// 	protoc        (unknown)
// source: common/v1/subscription_options.proto
...
func (x *SubscriptionOptions) Reset() {
	*x = SubscriptionOptions{}
	mi := &file_common_v1_subscription_options_proto_msgTypes[0]
...
var File_common_v1_subscription_options_proto protoreflect.FileDescriptor

const file_common_v1_subscription_options_proto_rawDesc = "" +
	"\n" +
	"$common/v1/subscription_options.proto\x12\tcommon.v1\x1a\x18common/v1/ack_mode.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd6\x01\n" +
	...
	"\n" +
	"keep_alive\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\tkeepAliveB/Z%github.com/jdfalk/gcommon/pkg/common/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v1_subscription_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_v1_subscription_options_proto_goTypes = []any{
	(*SubscriptionOptions)(nil), // 0: common.v1.SubscriptionOptions
	(AckMode)(0),                // 1: common.v1.AckMode
	(*durationpb.Duration)(nil), // 2: google.protobuf.Duration
}
var file_common_v1_subscription_options_proto_depIdxs = []int32{
...
func init() { file_common_v1_subscription_options_proto_init() }
func file_common_v1_subscription_options_proto_init() {
	if File_common_v1_subscription_options_proto != nil {
		return
	}
	file_common_v1_ack_mode_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_subscription_options_proto_rawDesc), len(file_common_v1_subscription_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_subscription_options_proto_goTypes,
		DependencyIndexes: file_common_v1_subscription_options_proto_depIdxs,
		MessageInfos:      file_common_v1_subscription_options_proto_msgTypes,
	}.Build()
	File_common_v1_subscription_options_proto = out.File
	file_common_v1_subscription_options_proto_goTypes = nil
	file_common_v1_subscription_options_proto_depIdxs = nil
}
