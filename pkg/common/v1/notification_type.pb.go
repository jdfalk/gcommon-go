...
// 	protoc        (unknown)
// source: common/v1/notification_type.proto
...
func (NotificationType) Descriptor() protoreflect.EnumDescriptor {
	return file_common_v1_notification_type_proto_enumTypes[0].Descriptor()
}

func (NotificationType) Type() protoreflect.EnumType {
	return &file_common_v1_notification_type_proto_enumTypes[0]
}
...
var File_common_v1_notification_type_proto protoreflect.FileDescriptor

const file_common_v1_notification_type_proto_rawDesc = "" +
	"\n" +
	"!common/v1/notification_type.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto*\xb7\x03\n" +
	...
	"\x17NOTIFICATION_TYPE_VOICE\x10\rB/Z%github.com/jdfalk/gcommon/pkg/common/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v1_notification_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_common_v1_notification_type_proto_goTypes = []any{
	(NotificationType)(0), // 0: common.v1.NotificationType
}
var file_common_v1_notification_type_proto_depIdxs = []int32{
...
func init() { file_common_v1_notification_type_proto_init() }
func file_common_v1_notification_type_proto_init() {
	if File_common_v1_notification_type_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_notification_type_proto_rawDesc), len(file_common_v1_notification_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_notification_type_proto_goTypes,
		DependencyIndexes: file_common_v1_notification_type_proto_depIdxs,
		EnumInfos:         file_common_v1_notification_type_proto_enumTypes,
	}.Build()
	File_common_v1_notification_type_proto = out.File
	file_common_v1_notification_type_proto_goTypes = nil
	file_common_v1_notification_type_proto_depIdxs = nil
}
