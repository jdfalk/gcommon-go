...
// 	protoc        (unknown)
// source: common/v1/enable_check_response.proto
...
func (x *EnableCheckResponse) Reset() {
	*x = EnableCheckResponse{}
	mi := &file_common_v1_enable_check_response_proto_msgTypes[0]
...
var File_common_v1_enable_check_response_proto protoreflect.FileDescriptor

const file_common_v1_enable_check_response_proto_rawDesc = "" +
	"\n" +
	"%common/v1/enable_check_response.proto\x12\tcommon.v1\x1a\x15common/v1/error.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9c\x01\n" +
	...
	"\x06status\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06statusB.Z$github.com/jdfalk/gcommon/pkg/common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v1_enable_check_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_v1_enable_check_response_proto_goTypes = []any{
	(*EnableCheckResponse)(nil), // 0: common.v1.EnableCheckResponse
	(*Error)(nil),               // 1: common.v1.Error
}
var file_common_v1_enable_check_response_proto_depIdxs = []int32{
...
func init() { file_common_v1_enable_check_response_proto_init() }
func file_common_v1_enable_check_response_proto_init() {
	if File_common_v1_enable_check_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_enable_check_response_proto_rawDesc), len(file_common_v1_enable_check_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_enable_check_response_proto_goTypes,
		DependencyIndexes: file_common_v1_enable_check_response_proto_depIdxs,
		MessageInfos:      file_common_v1_enable_check_response_proto_msgTypes,
	}.Build()
	File_common_v1_enable_check_response_proto = out.File
	file_common_v1_enable_check_response_proto_goTypes = nil
	file_common_v1_enable_check_response_proto_depIdxs = nil
}
