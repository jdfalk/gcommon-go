...
// 	protoc        (unknown)
// source: common/v1/cache_policy.proto
...
func (x *CachePolicy) Reset() {
	*x = CachePolicy{}
	mi := &file_common_v1_cache_policy_proto_msgTypes[0]
...
var File_common_v1_cache_policy_proto protoreflect.FileDescriptor

const file_common_v1_cache_policy_proto_rawDesc = "" +
	"\n" +
	"\x1ccommon/v1/cache_policy.proto\x12\tcommon.v1\x1a\x1fcommon/v1/eviction_policy.proto\x1a!common/v1/expiration_policy.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xde\x02\n" +
	"\vCachePolicy\x12;\n" +
	"\n" +
	...
	"\fenable_stats\x18\a \x01(\bR\venableStatsB/Z%github.com/jdfalk/gcommon/pkg/common/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v1_cache_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_v1_cache_policy_proto_goTypes = []any{
...
var file_common_v1_cache_policy_proto_depIdxs = []int32{
...
func init() { file_common_v1_cache_policy_proto_init() }
func file_common_v1_cache_policy_proto_init() {
	if File_common_v1_cache_policy_proto != nil {
		return
	}
	file_common_v1_eviction_policy_proto_init()
	file_common_v1_expiration_policy_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_cache_policy_proto_rawDesc), len(file_common_v1_cache_policy_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_cache_policy_proto_goTypes,
		DependencyIndexes: file_common_v1_cache_policy_proto_depIdxs,
		MessageInfos:      file_common_v1_cache_policy_proto_msgTypes,
	}.Build()
	File_common_v1_cache_policy_proto = out.File
	file_common_v1_cache_policy_proto_goTypes = nil
	file_common_v1_cache_policy_proto_depIdxs = nil
}
