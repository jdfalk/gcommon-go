...
// 	protoc        (unknown)
// source: common/v1/pagination_info.proto
...
func (x *CommonPaginationInfo) Reset() {
	*x = CommonPaginationInfo{}
	mi := &file_common_v1_pagination_info_proto_msgTypes[0]
...
var File_common_v1_pagination_info_proto protoreflect.FileDescriptor

const file_common_v1_pagination_info_proto_rawDesc = "" +
	"\n" +
	"\x1fcommon/v1/pagination_info.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xed\x02\n" +
	...
	"\x13previous_page_token\x18\b \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x11previousPageTokenB.Z$github.com/jdfalk/gcommon/pkg/common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v1_pagination_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_v1_pagination_info_proto_goTypes = []any{
	(*CommonPaginationInfo)(nil), // 0: common.v1.CommonPaginationInfo
}
var file_common_v1_pagination_info_proto_depIdxs = []int32{
...
func init() { file_common_v1_pagination_info_proto_init() }
func file_common_v1_pagination_info_proto_init() {
	if File_common_v1_pagination_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_pagination_info_proto_rawDesc), len(file_common_v1_pagination_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_pagination_info_proto_goTypes,
		DependencyIndexes: file_common_v1_pagination_info_proto_depIdxs,
		MessageInfos:      file_common_v1_pagination_info_proto_msgTypes,
	}.Build()
	File_common_v1_pagination_info_proto = out.File
	file_common_v1_pagination_info_proto_goTypes = nil
	file_common_v1_pagination_info_proto_depIdxs = nil
}
