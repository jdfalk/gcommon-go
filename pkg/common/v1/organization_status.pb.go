...
// 	protoc        (unknown)
// source: common/v1/organization_status.proto
...
func (OrganizationStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_common_v1_organization_status_proto_enumTypes[0].Descriptor()
}

func (OrganizationStatus) Type() protoreflect.EnumType {
	return &file_common_v1_organization_status_proto_enumTypes[0]
}
...
var File_common_v1_organization_status_proto protoreflect.FileDescriptor

const file_common_v1_organization_status_proto_rawDesc = "" +
	"\n" +
	"#common/v1/organization_status.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto*\x82\x02\n" +
	...
	"\x1bORGANIZATION_STATUS_DELETED\x10\x06B/Z%github.com/jdfalk/gcommon/pkg/common/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v1_organization_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_common_v1_organization_status_proto_goTypes = []any{
	(OrganizationStatus)(0), // 0: common.v1.OrganizationStatus
}
var file_common_v1_organization_status_proto_depIdxs = []int32{
...
func init() { file_common_v1_organization_status_proto_init() }
func file_common_v1_organization_status_proto_init() {
	if File_common_v1_organization_status_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_organization_status_proto_rawDesc), len(file_common_v1_organization_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_organization_status_proto_goTypes,
		DependencyIndexes: file_common_v1_organization_status_proto_depIdxs,
		EnumInfos:         file_common_v1_organization_status_proto_enumTypes,
	}.Build()
	File_common_v1_organization_status_proto = out.File
	file_common_v1_organization_status_proto_goTypes = nil
	file_common_v1_organization_status_proto_depIdxs = nil
}
