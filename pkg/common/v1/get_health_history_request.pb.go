...
// 	protoc        (unknown)
// source: common/v1/get_health_history_request.proto
...
func (x *GetHealthHistoryRequest) Reset() {
	*x = GetHealthHistoryRequest{}
	mi := &file_common_v1_get_health_history_request_proto_msgTypes[0]
...
var File_common_v1_get_health_history_request_proto protoreflect.FileDescriptor

const file_common_v1_get_health_history_request_proto_rawDesc = "" +
	"\n" +
	"*common/v1/get_health_history_request.proto\x12\tcommon.v1\x1a common/v1/request_metadata.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xea\x01\n" +
	...
	"\bmetadata\x18\x04 \x01(\v2\x1a.common.v1.RequestMetadataB\x02(\x01R\bmetadataB/Z%github.com/jdfalk/gcommon/pkg/common/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v1_get_health_history_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_v1_get_health_history_request_proto_goTypes = []any{
	(*GetHealthHistoryRequest)(nil), // 0: common.v1.GetHealthHistoryRequest
	(*timestamppb.Timestamp)(nil),   // 1: google.protobuf.Timestamp
	(*RequestMetadata)(nil),         // 2: common.v1.RequestMetadata
}
var file_common_v1_get_health_history_request_proto_depIdxs = []int32{
...
func init() { file_common_v1_get_health_history_request_proto_init() }
func file_common_v1_get_health_history_request_proto_init() {
	if File_common_v1_get_health_history_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_get_health_history_request_proto_rawDesc), len(file_common_v1_get_health_history_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_get_health_history_request_proto_goTypes,
		DependencyIndexes: file_common_v1_get_health_history_request_proto_depIdxs,
		MessageInfos:      file_common_v1_get_health_history_request_proto_msgTypes,
	}.Build()
	File_common_v1_get_health_history_request_proto = out.File
	file_common_v1_get_health_history_request_proto_goTypes = nil
	file_common_v1_get_health_history_request_proto_depIdxs = nil
}
