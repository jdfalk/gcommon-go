...
// 	protoc        (unknown)
// source: common/v1/log_statistics.proto
...
func (x *LogStatistics) Reset() {
	*x = LogStatistics{}
	mi := &file_common_v1_log_statistics_proto_msgTypes[0]
...
var File_common_v1_log_statistics_proto protoreflect.FileDescriptor

const file_common_v1_log_statistics_proto_rawDesc = "" +
	"\n" +
	"\x1ecommon/v1/log_statistics.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa7\x02\n" +
	"\rLogStatistics\x12,\n" +
	...
	"errorCount\x12,\n" +
	"\rwarning_count\x18\x06 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\fwarningCountB-Z#github.com/jdfalk/gcommon/common/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_common_v1_log_statistics_proto_depIdxs = []int32{
...
func init() { file_common_v1_log_statistics_proto_init() }
func file_common_v1_log_statistics_proto_init() {
	if File_common_v1_log_statistics_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_log_statistics_proto_rawDesc), len(file_common_v1_log_statistics_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_log_statistics_proto_goTypes,
		DependencyIndexes: file_common_v1_log_statistics_proto_depIdxs,
		MessageInfos:      file_common_v1_log_statistics_proto_msgTypes,
	}.Build()
	File_common_v1_log_statistics_proto = out.File
	file_common_v1_log_statistics_proto_goTypes = nil
	file_common_v1_log_statistics_proto_depIdxs = nil
}
