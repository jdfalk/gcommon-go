...
const file_common_v1_error_code_proto_rawDesc = "" +
	"\n" +
	"\x1acommon/v1/error_code.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto*\xc4\x03\n" +
	"\tErrorCode\x12\x1a\n" +
	...
	"\x14ERROR_CODE_DATA_LOSS\x10\x0eB.Z$github.com/jdfalk/gcommon/pkg/common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v1_error_code_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_common_v1_error_code_proto_goTypes = []any{
...
func file_common_v1_error_code_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_error_code_proto_rawDesc), len(file_common_v1_error_code_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
