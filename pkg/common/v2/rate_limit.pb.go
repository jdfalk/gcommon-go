...
// 	protoc        (unknown)
// source: common/v2/rate_limit.proto
...
func (x *RateLimit) Reset() {
	*x = RateLimit{}
	mi := &file_common_v2_rate_limit_proto_msgTypes[0]
...
var File_common_v2_rate_limit_proto protoreflect.FileDescriptor

const file_common_v2_rate_limit_proto_rawDesc = "" +
	"\n" +
	"\x1acommon/v2/rate_limit.proto\x12\tcommon.v2\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbe\x01\n" +
	"\tRateLimit\x12\x1d\n" +
	...
	"\n" +
	"reset_time\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\tresetTimeB1Z'github.com/jdfalk/gcommon/pkg/common/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v2_rate_limit_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_v2_rate_limit_proto_goTypes = []any{
	(*RateLimit)(nil),           // 0: common.v2.RateLimit
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_common_v2_rate_limit_proto_depIdxs = []int32{
...
func init() { file_common_v2_rate_limit_proto_init() }
func file_common_v2_rate_limit_proto_init() {
	if File_common_v2_rate_limit_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_rate_limit_proto_rawDesc), len(file_common_v2_rate_limit_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_rate_limit_proto_goTypes,
		DependencyIndexes: file_common_v2_rate_limit_proto_depIdxs,
		MessageInfos:      file_common_v2_rate_limit_proto_msgTypes,
	}.Build()
	File_common_v2_rate_limit_proto = out.File
	file_common_v2_rate_limit_proto_goTypes = nil
	file_common_v2_rate_limit_proto_depIdxs = nil
}
