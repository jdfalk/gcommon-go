...
// 	protoc        (unknown)
// source: common/v2/permission_scope.proto
...
func (PermissionScope) Descriptor() protoreflect.EnumDescriptor {
	return file_common_v2_permission_scope_proto_enumTypes[0].Descriptor()
}

func (PermissionScope) Type() protoreflect.EnumType {
	return &file_common_v2_permission_scope_proto_enumTypes[0]
}
...
var File_common_v2_permission_scope_proto protoreflect.FileDescriptor

const file_common_v2_permission_scope_proto_rawDesc = "" +
	"\n" +
	" common/v2/permission_scope.proto\x12\tcommon.v2\x1a!google/protobuf/go_features.proto*\xcb\x01\n" +
...
var file_common_v2_permission_scope_proto_depIdxs = []int32{
...
func init() { file_common_v2_permission_scope_proto_init() }
func file_common_v2_permission_scope_proto_init() {
	if File_common_v2_permission_scope_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_permission_scope_proto_rawDesc), len(file_common_v2_permission_scope_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_permission_scope_proto_goTypes,
		DependencyIndexes: file_common_v2_permission_scope_proto_depIdxs,
		EnumInfos:         file_common_v2_permission_scope_proto_enumTypes,
	}.Build()
	File_common_v2_permission_scope_proto = out.File
	file_common_v2_permission_scope_proto_goTypes = nil
	file_common_v2_permission_scope_proto_depIdxs = nil
}
