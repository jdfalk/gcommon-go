...
// 	protoc        (unknown)
// source: common/v2/pagination.proto
...
func (x *Pagination) Reset() {
	*x = Pagination{}
	mi := &file_common_v2_pagination_proto_msgTypes[0]
...
var File_common_v2_pagination_proto protoreflect.FileDescriptor

const file_common_v2_pagination_proto_rawDesc = "" +
	"\n" +
	"\x1acommon/v2/pagination.proto\x12\tcommon.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x8a\x01\n" +
	"\n" +
	"Pagination\x12'\n" +
	...
	"pageNumberB1Z'github.com/jdfalk/gcommon/pkg/common/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v2_pagination_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_v2_pagination_proto_goTypes = []any{
	(*Pagination)(nil), // 0: common.v2.Pagination
}
var file_common_v2_pagination_proto_depIdxs = []int32{
...
func init() { file_common_v2_pagination_proto_init() }
func file_common_v2_pagination_proto_init() {
	if File_common_v2_pagination_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_pagination_proto_rawDesc), len(file_common_v2_pagination_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_pagination_proto_goTypes,
		DependencyIndexes: file_common_v2_pagination_proto_depIdxs,
		MessageInfos:      file_common_v2_pagination_proto_msgTypes,
	}.Build()
	File_common_v2_pagination_proto = out.File
	file_common_v2_pagination_proto_goTypes = nil
	file_common_v2_pagination_proto_depIdxs = nil
}
