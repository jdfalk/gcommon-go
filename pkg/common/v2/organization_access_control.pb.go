...
// 	protoc        (unknown)
// source: common/v2/organization_access_control.proto
...
func (x *OrganizationAccessControl) Reset() {
	*x = OrganizationAccessControl{}
	mi := &file_common_v2_organization_access_control_proto_msgTypes[0]
...
var File_common_v2_organization_access_control_proto protoreflect.FileDescriptor

const file_common_v2_organization_access_control_proto_rawDesc = "" +
	"\n" +
	"+common/v2/organization_access_control.proto\x12\tcommon.v2\x1a common/v2/time_restriction.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf2\x02\n" +
	...
	"\x11time_restrictions\x18\x06 \x03(\v2\x1a.common.v2.TimeRestrictionB\b\xbaH\x05\x92\x01\x02\b\x01R\x10timeRestrictionsB1Z'github.com/jdfalk/gcommon/pkg/common/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v2_organization_access_control_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_v2_organization_access_control_proto_goTypes = []any{
	(*OrganizationAccessControl)(nil), // 0: common.v2.OrganizationAccessControl
	(*TimeRestriction)(nil),           // 1: common.v2.TimeRestriction
}
var file_common_v2_organization_access_control_proto_depIdxs = []int32{
	1, // 0: common.v2.OrganizationAccessControl.time_restrictions:type_name -> common.v2.TimeRestriction
...
func init() { file_common_v2_organization_access_control_proto_init() }
func file_common_v2_organization_access_control_proto_init() {
	if File_common_v2_organization_access_control_proto != nil {
		return
	}
	file_common_v2_time_restriction_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_organization_access_control_proto_rawDesc), len(file_common_v2_organization_access_control_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_organization_access_control_proto_goTypes,
		DependencyIndexes: file_common_v2_organization_access_control_proto_depIdxs,
		MessageInfos:      file_common_v2_organization_access_control_proto_msgTypes,
	}.Build()
	File_common_v2_organization_access_control_proto = out.File
	file_common_v2_organization_access_control_proto_goTypes = nil
	file_common_v2_organization_access_control_proto_depIdxs = nil
}
