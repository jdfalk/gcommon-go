...
// 	protoc        (unknown)
// source: common/v2/tenant_status.proto
...
func (TenantStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_common_v2_tenant_status_proto_enumTypes[0].Descriptor()
}

func (TenantStatus) Type() protoreflect.EnumType {
	return &file_common_v2_tenant_status_proto_enumTypes[0]
}
...
var File_common_v2_tenant_status_proto protoreflect.FileDescriptor

const file_common_v2_tenant_status_proto_rawDesc = "" +
	"\n" +
	"\x1dcommon/v2/tenant_status.proto\x12\tcommon.v2\x1a!google/protobuf/go_features.proto*\x8d\x02\n" +
...
var file_common_v2_tenant_status_proto_depIdxs = []int32{
...
func init() { file_common_v2_tenant_status_proto_init() }
func file_common_v2_tenant_status_proto_init() {
	if File_common_v2_tenant_status_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_tenant_status_proto_rawDesc), len(file_common_v2_tenant_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_tenant_status_proto_goTypes,
		DependencyIndexes: file_common_v2_tenant_status_proto_depIdxs,
		EnumInfos:         file_common_v2_tenant_status_proto_enumTypes,
	}.Build()
	File_common_v2_tenant_status_proto = out.File
	file_common_v2_tenant_status_proto_goTypes = nil
	file_common_v2_tenant_status_proto_depIdxs = nil
}
