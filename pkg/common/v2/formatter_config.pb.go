...
// 	protoc        (unknown)
// source: common/v2/formatter_config.proto
...
func (x *LogFormatterConfig) Reset() {
	*x = LogFormatterConfig{}
	mi := &file_common_v2_formatter_config_proto_msgTypes[0]
...
var File_common_v2_formatter_config_proto protoreflect.FileDescriptor

const file_common_v2_formatter_config_proto_rawDesc = "" +
	"\n" +
...
var file_common_v2_formatter_config_proto_depIdxs = []int32{
...
func init() { file_common_v2_formatter_config_proto_init() }
func file_common_v2_formatter_config_proto_init() {
	if File_common_v2_formatter_config_proto != nil {
		return
	}
	file_common_v2_formatter_type_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_formatter_config_proto_rawDesc), len(file_common_v2_formatter_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_formatter_config_proto_goTypes,
		DependencyIndexes: file_common_v2_formatter_config_proto_depIdxs,
		MessageInfos:      file_common_v2_formatter_config_proto_msgTypes,
	}.Build()
	File_common_v2_formatter_config_proto = out.File
	file_common_v2_formatter_config_proto_goTypes = nil
	file_common_v2_formatter_config_proto_depIdxs = nil
}
