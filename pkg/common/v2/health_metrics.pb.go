...
// 	protoc        (unknown)
// source: common/v2/health_metrics.proto
...
func (x *HealthMetrics) Reset() {
	*x = HealthMetrics{}
	mi := &file_common_v2_health_metrics_proto_msgTypes[0]
...
var File_common_v2_health_metrics_proto protoreflect.FileDescriptor

const file_common_v2_health_metrics_proto_rawDesc = "" +
	"\n" +
	"\x1ecommon/v2/health_metrics.proto\x12\tcommon.v2\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa4\x04\n" +
	"\rHealthMetrics\x12*\n" +
	...
	"\x05value\x18\x02 \x01(\x01R\x05value:\x028\x01B1Z'github.com/jdfalk/gcommon/pkg/common/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v2_health_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_common_v2_health_metrics_proto_goTypes = []any{
	(*HealthMetrics)(nil),         // 0: common.v2.HealthMetrics
	nil,                           // 1: common.v2.HealthMetrics.CustomMetricsEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_common_v2_health_metrics_proto_depIdxs = []int32{
...
func init() { file_common_v2_health_metrics_proto_init() }
func file_common_v2_health_metrics_proto_init() {
	if File_common_v2_health_metrics_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_health_metrics_proto_rawDesc), len(file_common_v2_health_metrics_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_health_metrics_proto_goTypes,
		DependencyIndexes: file_common_v2_health_metrics_proto_depIdxs,
		MessageInfos:      file_common_v2_health_metrics_proto_msgTypes,
	}.Build()
	File_common_v2_health_metrics_proto = out.File
	file_common_v2_health_metrics_proto_goTypes = nil
	file_common_v2_health_metrics_proto_depIdxs = nil
}
