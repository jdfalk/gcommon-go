...
// 	protoc        (unknown)
// source: common/v2/security_policy.proto
...
func (x *SecurityPolicy) Reset() {
	*x = SecurityPolicy{}
	mi := &file_common_v2_security_policy_proto_msgTypes[0]
...
var File_common_v2_security_policy_proto protoreflect.FileDescriptor

const file_common_v2_security_policy_proto_rawDesc = "" +
	"\n" +
	"\x1fcommon/v2/security_policy.proto\x12\tcommon.v2\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc0\x01\n" +
	...
	"\x13max_failed_attempts\x18\x03 \x01(\rB\a\xbaH\x04*\x02(\x00R\x11maxFailedAttemptsB1Z'github.com/jdfalk/gcommon/pkg/common/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v2_security_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_v2_security_policy_proto_goTypes = []any{
	(*SecurityPolicy)(nil),      // 0: common.v2.SecurityPolicy
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_common_v2_security_policy_proto_depIdxs = []int32{
	1, // 0: common.v2.SecurityPolicy.password_ttl:type_name -> google.protobuf.Duration
...
func init() { file_common_v2_security_policy_proto_init() }
func file_common_v2_security_policy_proto_init() {
	if File_common_v2_security_policy_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_security_policy_proto_rawDesc), len(file_common_v2_security_policy_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_security_policy_proto_goTypes,
		DependencyIndexes: file_common_v2_security_policy_proto_depIdxs,
		MessageInfos:      file_common_v2_security_policy_proto_msgTypes,
	}.Build()
	File_common_v2_security_policy_proto = out.File
	file_common_v2_security_policy_proto_goTypes = nil
	file_common_v2_security_policy_proto_depIdxs = nil
}
