...
// 	protoc        (unknown)
// source: common/v2/validate_token_response.proto
...
func (x *ValidateTokenResponse) Reset() {
	*x = ValidateTokenResponse{}
	mi := &file_common_v2_validate_token_response_proto_msgTypes[0]
...
var File_common_v2_validate_token_response_proto protoreflect.FileDescriptor

const file_common_v2_validate_token_response_proto_rawDesc = "" +
	"\n" +
	"'common/v2/validate_token_response.proto\x12\tcommon.v2\x1a\x19common/v2/user_info.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xb0\x02\n" +
	...
	"\n" +
	"expires_in\x18\a \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\texpiresInB1Z'github.com/jdfalk/gcommon/pkg/common/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v2_validate_token_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_v2_validate_token_response_proto_goTypes = []any{
	(*ValidateTokenResponse)(nil), // 0: common.v2.ValidateTokenResponse
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
	(*UserInfo)(nil),              // 2: common.v2.UserInfo
}
var file_common_v2_validate_token_response_proto_depIdxs = []int32{
...
func init() { file_common_v2_validate_token_response_proto_init() }
func file_common_v2_validate_token_response_proto_init() {
	if File_common_v2_validate_token_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_validate_token_response_proto_rawDesc), len(file_common_v2_validate_token_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_validate_token_response_proto_goTypes,
		DependencyIndexes: file_common_v2_validate_token_response_proto_depIdxs,
		MessageInfos:      file_common_v2_validate_token_response_proto_msgTypes,
	}.Build()
	File_common_v2_validate_token_response_proto = out.File
	file_common_v2_validate_token_response_proto_goTypes = nil
	file_common_v2_validate_token_response_proto_depIdxs = nil
}
