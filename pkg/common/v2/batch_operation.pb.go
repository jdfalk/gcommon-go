...
// 	protoc        (unknown)
// source: common/v2/batch_operation.proto
...
func (x *CommonBatchOperation) Reset() {
	*x = CommonBatchOperation{}
	mi := &file_common_v2_batch_operation_proto_msgTypes[0]
...
var File_common_v2_batch_operation_proto protoreflect.FileDescriptor

const file_common_v2_batch_operation_proto_rawDesc = "" +
	"\n" +
	"\x1fcommon/v2/batch_operation.proto\x12\tcommon.v2\x1a\x1bbuf/validate/validate.proto\x1a\x1dcommon/v2/batch_options.proto\x1a common/v2/request_metadata.proto\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\"\xa5\x02\n" +
	...
	"\bmetadata\x18\x05 \x01(\v2\x1a.common.v2.RequestMetadataB\x02(\x01R\bmetadataB1Z'github.com/jdfalk/gcommon/pkg/common/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v2_batch_operation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_v2_batch_operation_proto_goTypes = []any{
...
var file_common_v2_batch_operation_proto_depIdxs = []int32{
...
func init() { file_common_v2_batch_operation_proto_init() }
func file_common_v2_batch_operation_proto_init() {
	if File_common_v2_batch_operation_proto != nil {
		return
	}
	file_common_v2_batch_options_proto_init()
	file_common_v2_request_metadata_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_batch_operation_proto_rawDesc), len(file_common_v2_batch_operation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_batch_operation_proto_goTypes,
		DependencyIndexes: file_common_v2_batch_operation_proto_depIdxs,
		MessageInfos:      file_common_v2_batch_operation_proto_msgTypes,
	}.Build()
	File_common_v2_batch_operation_proto = out.File
	file_common_v2_batch_operation_proto_goTypes = nil
	file_common_v2_batch_operation_proto_depIdxs = nil
}
