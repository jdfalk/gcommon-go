...
// 	protoc        (unknown)
// source: common/v2/grant_permission_response.proto
...
func (x *GrantPermissionResponse) Reset() {
	*x = GrantPermissionResponse{}
	mi := &file_common_v2_grant_permission_response_proto_msgTypes[0]
...
var File_common_v2_grant_permission_response_proto protoreflect.FileDescriptor

const file_common_v2_grant_permission_response_proto_rawDesc = "" +
	"\n" +
	")common/v2/grant_permission_response.proto\x12\tcommon.v2\x1a!common/v2/response_metadata.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf0\x01\n" +
...
var file_common_v2_grant_permission_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_v2_grant_permission_response_proto_goTypes = []any{
	(*GrantPermissionResponse)(nil), // 0: common.v2.GrantPermissionResponse
	(*ResponseMetadata)(nil),        // 1: common.v2.ResponseMetadata
}
var file_common_v2_grant_permission_response_proto_depIdxs = []int32{
...
func init() { file_common_v2_grant_permission_response_proto_init() }
func file_common_v2_grant_permission_response_proto_init() {
	if File_common_v2_grant_permission_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_grant_permission_response_proto_rawDesc), len(file_common_v2_grant_permission_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_grant_permission_response_proto_goTypes,
		DependencyIndexes: file_common_v2_grant_permission_response_proto_depIdxs,
		MessageInfos:      file_common_v2_grant_permission_response_proto_msgTypes,
	}.Build()
	File_common_v2_grant_permission_response_proto = out.File
	file_common_v2_grant_permission_response_proto_goTypes = nil
	file_common_v2_grant_permission_response_proto_depIdxs = nil
}
