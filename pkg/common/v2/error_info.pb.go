...
// 	protoc        (unknown)
// source: common/v2/error_info.proto
...
func (x *ErrorInfo) Reset() {
	*x = ErrorInfo{}
	mi := &file_common_v2_error_info_proto_msgTypes[0]
...
var File_common_v2_error_info_proto protoreflect.FileDescriptor

const file_common_v2_error_info_proto_rawDesc = "" +
	"\n" +
	"\x1acommon/v2/error_info.proto\x12\tcommon.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc3\x02\n" +
	"\tErrorInfo\x12!\n" +
...
var file_common_v2_error_info_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_common_v2_error_info_proto_goTypes = []any{
	(*ErrorInfo)(nil), // 0: common.v2.ErrorInfo
	nil,               // 1: common.v2.ErrorInfo.ContextEntry
}
var file_common_v2_error_info_proto_depIdxs = []int32{
...
func init() { file_common_v2_error_info_proto_init() }
func file_common_v2_error_info_proto_init() {
	if File_common_v2_error_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_error_info_proto_rawDesc), len(file_common_v2_error_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_error_info_proto_goTypes,
		DependencyIndexes: file_common_v2_error_info_proto_depIdxs,
		MessageInfos:      file_common_v2_error_info_proto_msgTypes,
	}.Build()
	File_common_v2_error_info_proto = out.File
	file_common_v2_error_info_proto_goTypes = nil
	file_common_v2_error_info_proto_depIdxs = nil
}
