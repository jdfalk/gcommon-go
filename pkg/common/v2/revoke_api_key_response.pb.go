...
// 	protoc        (unknown)
// source: common/v2/revoke_api_key_response.proto
...
func (x *RevokeApiKeyResponse) Reset() {
	*x = RevokeApiKeyResponse{}
	mi := &file_common_v2_revoke_api_key_response_proto_msgTypes[0]
...
var File_common_v2_revoke_api_key_response_proto protoreflect.FileDescriptor

const file_common_v2_revoke_api_key_response_proto_rawDesc = "" +
	"\n" +
	"'common/v2/revoke_api_key_response.proto\x12\tcommon.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x86\x01\n" +
	"\x14RevokeApiKeyResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12,\n" +
	"\rerror_message\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\ferrorMessage\x12&\n" +
	"\n" +
	"revoked_at\x18\x03 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\trevokedAtB1Z'github.com/jdfalk/gcommon/pkg/common/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v2_revoke_api_key_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_v2_revoke_api_key_response_proto_goTypes = []any{
	(*RevokeApiKeyResponse)(nil), // 0: common.v2.RevokeApiKeyResponse
}
var file_common_v2_revoke_api_key_response_proto_depIdxs = []int32{
...
func init() { file_common_v2_revoke_api_key_response_proto_init() }
func file_common_v2_revoke_api_key_response_proto_init() {
	if File_common_v2_revoke_api_key_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_revoke_api_key_response_proto_rawDesc), len(file_common_v2_revoke_api_key_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_revoke_api_key_response_proto_goTypes,
		DependencyIndexes: file_common_v2_revoke_api_key_response_proto_depIdxs,
		MessageInfos:      file_common_v2_revoke_api_key_response_proto_msgTypes,
	}.Build()
	File_common_v2_revoke_api_key_response_proto = out.File
	file_common_v2_revoke_api_key_response_proto_goTypes = nil
	file_common_v2_revoke_api_key_response_proto_depIdxs = nil
}
