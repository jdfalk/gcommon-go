...
// 	protoc        (unknown)
// source: common/v2/archive_criteria.proto
...
func (x *ArchiveCriteria) Reset() {
	*x = ArchiveCriteria{}
	mi := &file_common_v2_archive_criteria_proto_msgTypes[0]
...
var File_common_v2_archive_criteria_proto protoreflect.FileDescriptor

const file_common_v2_archive_criteria_proto_rawDesc = "" +
	"\n" +
	" common/v2/archive_criteria.proto\x12\tcommon.v2\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x86\x01\n" +
...
var file_common_v2_archive_criteria_proto_depIdxs = []int32{
...
func init() { file_common_v2_archive_criteria_proto_init() }
func file_common_v2_archive_criteria_proto_init() {
	if File_common_v2_archive_criteria_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_archive_criteria_proto_rawDesc), len(file_common_v2_archive_criteria_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_archive_criteria_proto_goTypes,
		DependencyIndexes: file_common_v2_archive_criteria_proto_depIdxs,
		MessageInfos:      file_common_v2_archive_criteria_proto_msgTypes,
	}.Build()
	File_common_v2_archive_criteria_proto = out.File
	file_common_v2_archive_criteria_proto_goTypes = nil
	file_common_v2_archive_criteria_proto_depIdxs = nil
}
