...
// 	protoc        (unknown)
// source: common/v2/appender_type.proto
...
func (AppenderType) Descriptor() protoreflect.EnumDescriptor {
	return file_common_v2_appender_type_proto_enumTypes[0].Descriptor()
}

func (AppenderType) Type() protoreflect.EnumType {
	return &file_common_v2_appender_type_proto_enumTypes[0]
}
...
var File_common_v2_appender_type_proto protoreflect.FileDescriptor

const file_common_v2_appender_type_proto_rawDesc = "" +
	"\n" +
	"\x1dcommon/v2/appender_type.proto\x12\tcommon.v2\x1a!google/protobuf/go_features.proto*\xd1\x01\n" +
	...
	"\x16APPENDER_TYPE_DATABASE\x10\x06B1Z'github.com/jdfalk/gcommon/pkg/common/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v2_appender_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_common_v2_appender_type_proto_goTypes = []any{
	(AppenderType)(0), // 0: common.v2.AppenderType
}
var file_common_v2_appender_type_proto_depIdxs = []int32{
...
func init() { file_common_v2_appender_type_proto_init() }
func file_common_v2_appender_type_proto_init() {
	if File_common_v2_appender_type_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_appender_type_proto_rawDesc), len(file_common_v2_appender_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_appender_type_proto_goTypes,
		DependencyIndexes: file_common_v2_appender_type_proto_depIdxs,
		EnumInfos:         file_common_v2_appender_type_proto_enumTypes,
	}.Build()
	File_common_v2_appender_type_proto = out.File
	file_common_v2_appender_type_proto_goTypes = nil
	file_common_v2_appender_type_proto_depIdxs = nil
}
