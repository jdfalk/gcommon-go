...
// 	protoc        (unknown)
// source: common/v2/rate_limit_info.proto
...
func (x *RateLimitInfo) Reset() {
	*x = RateLimitInfo{}
	mi := &file_common_v2_rate_limit_info_proto_msgTypes[0]
...
var File_common_v2_rate_limit_info_proto protoreflect.FileDescriptor

const file_common_v2_rate_limit_info_proto_rawDesc = "" +
	"\n" +
	"\x1fcommon/v2/rate_limit_info.proto\x12\tcommon.v2\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xcc\x01\n" +
	"\rRateLimitInfo\x12%\n" +
	...
	"retryAfterB1Z'github.com/jdfalk/gcommon/pkg/common/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v2_rate_limit_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_v2_rate_limit_info_proto_goTypes = []any{
	(*RateLimitInfo)(nil),         // 0: common.v2.RateLimitInfo
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 2: google.protobuf.Duration
}
var file_common_v2_rate_limit_info_proto_depIdxs = []int32{
...
func init() { file_common_v2_rate_limit_info_proto_init() }
func file_common_v2_rate_limit_info_proto_init() {
	if File_common_v2_rate_limit_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_rate_limit_info_proto_rawDesc), len(file_common_v2_rate_limit_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_rate_limit_info_proto_goTypes,
		DependencyIndexes: file_common_v2_rate_limit_info_proto_depIdxs,
		MessageInfos:      file_common_v2_rate_limit_info_proto_msgTypes,
	}.Build()
	File_common_v2_rate_limit_info_proto = out.File
	file_common_v2_rate_limit_info_proto_goTypes = nil
	file_common_v2_rate_limit_info_proto_depIdxs = nil
}
