...
// 	protoc        (unknown)
// source: common/v2/get_api_key_response.proto
...
func (x *GetApiKeyResponse) Reset() {
	*x = GetApiKeyResponse{}
	mi := &file_common_v2_get_api_key_response_proto_msgTypes[0]
...
var File_common_v2_get_api_key_response_proto protoreflect.FileDescriptor

const file_common_v2_get_api_key_response_proto_rawDesc = "" +
	"\n" +
	"$common/v2/get_api_key_response.proto\x12\tcommon.v2\x1a\x17common/v2/api_key.proto\x1a\x1dcommon/v2/api_key_stats.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9b\x01\n" +
...
var file_common_v2_get_api_key_response_proto_depIdxs = []int32{
...
func init() { file_common_v2_get_api_key_response_proto_init() }
func file_common_v2_get_api_key_response_proto_init() {
	if File_common_v2_get_api_key_response_proto != nil {
		return
	}
	file_common_v2_api_key_proto_init()
	file_common_v2_api_key_stats_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_get_api_key_response_proto_rawDesc), len(file_common_v2_get_api_key_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_get_api_key_response_proto_goTypes,
		DependencyIndexes: file_common_v2_get_api_key_response_proto_depIdxs,
		MessageInfos:      file_common_v2_get_api_key_response_proto_msgTypes,
	}.Build()
	File_common_v2_get_api_key_response_proto = out.File
	file_common_v2_get_api_key_response_proto_goTypes = nil
	file_common_v2_get_api_key_response_proto_depIdxs = nil
}
