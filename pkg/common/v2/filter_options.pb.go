...
// 	protoc        (unknown)
// source: common/v2/filter_options.proto
...
func (x *FilterOptions) Reset() {
	*x = FilterOptions{}
	mi := &file_common_v2_filter_options_proto_msgTypes[0]
...
var File_common_v2_filter_options_proto protoreflect.FileDescriptor

const file_common_v2_filter_options_proto_rawDesc = "" +
	"\n" +
	"\x1ecommon/v2/filter_options.proto\x12\tcommon.v2\x1a\x1ccommon/v2/filter_value.proto\x1a\"common/v2/metrics_time_range.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x8b\x02\n" +
	"\rFilterOptions\x12?\n" +
...
var file_common_v2_filter_options_proto_depIdxs = []int32{
...
func init() { file_common_v2_filter_options_proto_init() }
func file_common_v2_filter_options_proto_init() {
	if File_common_v2_filter_options_proto != nil {
		return
	}
	file_common_v2_filter_value_proto_init()
	file_common_v2_metrics_time_range_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v2_filter_options_proto_rawDesc), len(file_common_v2_filter_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v2_filter_options_proto_goTypes,
		DependencyIndexes: file_common_v2_filter_options_proto_depIdxs,
		MessageInfos:      file_common_v2_filter_options_proto_msgTypes,
	}.Build()
	File_common_v2_filter_options_proto = out.File
	file_common_v2_filter_options_proto_goTypes = nil
	file_common_v2_filter_options_proto_depIdxs = nil
}
