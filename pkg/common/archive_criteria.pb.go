...
// 	protoc        (unknown)
// source: common/v1/archive_criteria.proto
...
func (x *ArchiveCriteria) Reset() {
	*x = ArchiveCriteria{}
	mi := &file_common_v1_archive_criteria_proto_msgTypes[0]
...
var File_common_v1_archive_criteria_proto protoreflect.FileDescriptor

const file_common_v1_archive_criteria_proto_rawDesc = "" +
	"\n" +
	" common/v1/archive_criteria.proto\x12\tcommon.v1\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x86\x01\n" +
	"\x0fArchiveCriteria\x128\n" +
	"\n" +
	"older_than\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\tolderThan\x129\n" +
	"\x14size_threshold_bytes\x18\x02 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x12sizeThresholdBytesB.Z$github.com/jdfalk/gcommon/pkg/common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v1_archive_criteria_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_v1_archive_criteria_proto_goTypes = []any{
	(*ArchiveCriteria)(nil),     // 0: common.v1.ArchiveCriteria
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_common_v1_archive_criteria_proto_depIdxs = []int32{
...
func init() { file_common_v1_archive_criteria_proto_init() }
func file_common_v1_archive_criteria_proto_init() {
	if File_common_v1_archive_criteria_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_archive_criteria_proto_rawDesc), len(file_common_v1_archive_criteria_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_archive_criteria_proto_goTypes,
		DependencyIndexes: file_common_v1_archive_criteria_proto_depIdxs,
		MessageInfos:      file_common_v1_archive_criteria_proto_msgTypes,
	}.Build()
	File_common_v1_archive_criteria_proto = out.File
	file_common_v1_archive_criteria_proto_goTypes = nil
	file_common_v1_archive_criteria_proto_depIdxs = nil
}
