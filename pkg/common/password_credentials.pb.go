...
// 	protoc        (unknown)
// source: common/v1/password_credentials.proto
...
func (x *PasswordCredentials) Reset() {
	*x = PasswordCredentials{}
	mi := &file_common_v1_password_credentials_proto_msgTypes[0]
...
var File_common_v1_password_credentials_proto protoreflect.FileDescriptor

const file_common_v1_password_credentials_proto_rawDesc = "" +
	"\n" +
	"$common/v1/password_credentials.proto\x12\tcommon.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x80\x01\n" +
	...
	"rememberMeB.Z$github.com/jdfalk/gcommon/pkg/common\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_common_v1_password_credentials_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_v1_password_credentials_proto_goTypes = []any{
	(*PasswordCredentials)(nil), // 0: common.v1.PasswordCredentials
}
var file_common_v1_password_credentials_proto_depIdxs = []int32{
...
func init() { file_common_v1_password_credentials_proto_init() }
func file_common_v1_password_credentials_proto_init() {
	if File_common_v1_password_credentials_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_v1_password_credentials_proto_rawDesc), len(file_common_v1_password_credentials_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_v1_password_credentials_proto_goTypes,
		DependencyIndexes: file_common_v1_password_credentials_proto_depIdxs,
		MessageInfos:      file_common_v1_password_credentials_proto_msgTypes,
	}.Build()
	File_common_v1_password_credentials_proto = out.File
	file_common_v1_password_credentials_proto_goTypes = nil
	file_common_v1_password_credentials_proto_depIdxs = nil
}
