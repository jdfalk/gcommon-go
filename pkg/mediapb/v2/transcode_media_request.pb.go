...
// 	protoc        (unknown)
// source: mediapb/v2/transcode_media_request.proto
...
func (x *TranscodeMediaRequest) Reset() {
	*x = TranscodeMediaRequest{}
	mi := &file_mediapb_v2_transcode_media_request_proto_msgTypes[0]
...
var File_mediapb_v2_transcode_media_request_proto protoreflect.FileDescriptor

const file_mediapb_v2_transcode_media_request_proto_rawDesc = "" +
	"\n" +
	"(mediapb/v2/transcode_media_request.proto\x12\bmedia.v2\x1a\"mediapb/v2/transcode_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc2\x01\n" +
	...
	"\aoptions\x18\x04 \x01(\v2\x1a.media.v2.TranscodeOptionsR\aoptionsB\x9d\x01\n" +
	"\fcom.media.v2B\x1aTranscodeMediaRequestProtoP\x01Z(github.com/jdfalk/gcommon/pkg/mediapb/v2\xa2\x02\x03MXX\xaa\x02\bMedia.V2\xca\x02\bMedia\\V2\xe2\x02\x14Media\\V2\\GPBMetadata\xea\x02\tMedia::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_mediapb_v2_transcode_media_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_mediapb_v2_transcode_media_request_proto_goTypes = []any{
	(*TranscodeMediaRequest)(nil), // 0: media.v2.TranscodeMediaRequest
	(*TranscodeOptions)(nil),      // 1: media.v2.TranscodeOptions
}
var file_mediapb_v2_transcode_media_request_proto_depIdxs = []int32{
	1, // 0: media.v2.TranscodeMediaRequest.options:type_name -> media.v2.TranscodeOptions
...
func init() { file_mediapb_v2_transcode_media_request_proto_init() }
func file_mediapb_v2_transcode_media_request_proto_init() {
	if File_mediapb_v2_transcode_media_request_proto != nil {
		return
	}
	file_mediapb_v2_transcode_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mediapb_v2_transcode_media_request_proto_rawDesc), len(file_mediapb_v2_transcode_media_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mediapb_v2_transcode_media_request_proto_goTypes,
		DependencyIndexes: file_mediapb_v2_transcode_media_request_proto_depIdxs,
		MessageInfos:      file_mediapb_v2_transcode_media_request_proto_msgTypes,
	}.Build()
	File_mediapb_v2_transcode_media_request_proto = out.File
	file_mediapb_v2_transcode_media_request_proto_goTypes = nil
	file_mediapb_v2_transcode_media_request_proto_depIdxs = nil
}
