...
// 	protoc        (unknown)
// source: mediapb/v2/upload_media_request.proto
...
func (x *UploadMediaRequest) Reset() {
	*x = UploadMediaRequest{}
	mi := &file_mediapb_v2_upload_media_request_proto_msgTypes[0]
...
func (x case_UploadMediaRequest_Data) String() string {
	md := file_mediapb_v2_upload_media_request_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_mediapb_v2_upload_media_request_proto protoreflect.FileDescriptor

const file_mediapb_v2_upload_media_request_proto_rawDesc = "" +
	"\n" +
	"%mediapb/v2/upload_media_request.proto\x12\bmedia.v2\x1a!google/protobuf/go_features.proto\x1a mediapb/v2/upload_metadata.proto\"l\n" +
	"\x12UploadMediaRequest\x126\n" +
	"\bmetadata\x18\x01 \x01(\v2\x18.media.v2.UploadMetadataH\x00R\bmetadata\x12\x16\n" +
	"\x05chunk\x18\x02 \x01(\fH\x00R\x05chunkB\x06\n" +
	"\x04dataB\x9a\x01\n" +
	"\fcom.media.v2B\x17UploadMediaRequestProtoP\x01Z(github.com/jdfalk/gcommon/pkg/mediapb/v2\xa2\x02\x03MXX\xaa\x02\bMedia.V2\xca\x02\bMedia\\V2\xe2\x02\x14Media\\V2\\GPBMetadata\xea\x02\tMedia::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_mediapb_v2_upload_media_request_proto_goTypes = []any{
	...
	(*UploadMetadata)(nil),     // 1: media.v2.UploadMetadata
}
var file_mediapb_v2_upload_media_request_proto_depIdxs = []int32{
	1, // 0: media.v2.UploadMediaRequest.metadata:type_name -> media.v2.UploadMetadata
...
func init() { file_mediapb_v2_upload_media_request_proto_init() }
func file_mediapb_v2_upload_media_request_proto_init() {
	if File_mediapb_v2_upload_media_request_proto != nil {
		return
	}
	file_mediapb_v2_upload_metadata_proto_init()
	file_mediapb_v2_upload_media_request_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mediapb_v2_upload_media_request_proto_rawDesc), len(file_mediapb_v2_upload_media_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mediapb_v2_upload_media_request_proto_goTypes,
		DependencyIndexes: file_mediapb_v2_upload_media_request_proto_depIdxs,
		MessageInfos:      file_mediapb_v2_upload_media_request_proto_msgTypes,
	}.Build()
	File_mediapb_v2_upload_media_request_proto = out.File
	file_mediapb_v2_upload_media_request_proto_goTypes = nil
	file_mediapb_v2_upload_media_request_proto_depIdxs = nil
}
