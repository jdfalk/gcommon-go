...
// 	protoc        (unknown)
// source: mediapb/v2/upload_metadata.proto
...
func (x *UploadMetadata) Reset() {
	*x = UploadMetadata{}
	mi := &file_mediapb_v2_upload_metadata_proto_msgTypes[0]
...
var File_mediapb_v2_upload_metadata_proto protoreflect.FileDescriptor

const file_mediapb_v2_upload_metadata_proto_rawDesc = "" +
	"\n" +
	" mediapb/v2/upload_metadata.proto\x12\bmedia.v2\x1a\x1fmediapb/v2/media_metadata.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc9\x01\n" +
	...
	"\x0emedia_metadata\x18\x04 \x01(\v2\x17.media.v2.MediaMetadataR\rmediaMetadataB\x96\x01\n" +
	"\fcom.media.v2B\x13UploadMetadataProtoP\x01Z(github.com/jdfalk/gcommon/pkg/mediapb/v2\xa2\x02\x03MXX\xaa\x02\bMedia.V2\xca\x02\bMedia\\V2\xe2\x02\x14Media\\V2\\GPBMetadata\xea\x02\tMedia::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_mediapb_v2_upload_metadata_proto_goTypes = []any{
	(*UploadMetadata)(nil), // 0: media.v2.UploadMetadata
	(*MediaMetadata)(nil),  // 1: media.v2.MediaMetadata
}
var file_mediapb_v2_upload_metadata_proto_depIdxs = []int32{
	1, // 0: media.v2.UploadMetadata.media_metadata:type_name -> media.v2.MediaMetadata
...
func init() { file_mediapb_v2_upload_metadata_proto_init() }
func file_mediapb_v2_upload_metadata_proto_init() {
	if File_mediapb_v2_upload_metadata_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mediapb_v2_upload_metadata_proto_rawDesc), len(file_mediapb_v2_upload_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mediapb_v2_upload_metadata_proto_goTypes,
		DependencyIndexes: file_mediapb_v2_upload_metadata_proto_depIdxs,
		MessageInfos:      file_mediapb_v2_upload_metadata_proto_msgTypes,
	}.Build()
	File_mediapb_v2_upload_metadata_proto = out.File
	file_mediapb_v2_upload_metadata_proto_goTypes = nil
	file_mediapb_v2_upload_metadata_proto_depIdxs = nil
}
