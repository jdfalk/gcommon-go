...
// 	protoc        (unknown)
// source: mediapb/v1/media_analysis.proto
...
func (x *MediaAnalysis) Reset() {
	*x = MediaAnalysis{}
	mi := &file_mediapb_v1_media_analysis_proto_msgTypes[0]
...
var File_mediapb_v1_media_analysis_proto protoreflect.FileDescriptor

const file_mediapb_v1_media_analysis_proto_rawDesc = "" +
	"\n" +
	"\x1fmediapb/v1/media_analysis.proto\x12\bmedia.v1\x1a\x1emediapb/v1/media_quality.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\x1a\x1fmediapb/v1/audio_analysis.proto\x1a mediapb/v1/scene_detection.proto\x1a#mediapb/v1/technical_metadata.proto\x1a\x1fmediapb/v1/thumbnail_info.proto\"\xcc\x02\n" +
	"\rMediaAnalysis\x129\n" +
	...
	"thumbnails\x12>\n" +
	"\x0eaudio_analysis\x18\x05 \x01(\v2\x17.media.v1.AudioAnalysisR\raudioAnalysisB\x92\x01\n" +
	"\fcom.media.v1B\x12MediaAnalysisProtoP\x01Z%github.com/jdfalk/gcommon/pkg/mediapb\xa2\x02\x03MXX\xaa\x02\bMedia.V1\xca\x02\bMedia\\V1\xe2\x02\x14Media\\V1\\GPBMetadata\xea\x02\tMedia::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_mediapb_v1_media_analysis_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_mediapb_v1_media_analysis_proto_goTypes = []any{
...
var file_mediapb_v1_media_analysis_proto_depIdxs = []int32{
...
func init() { file_mediapb_v1_media_analysis_proto_init() }
func file_mediapb_v1_media_analysis_proto_init() {
	if File_mediapb_v1_media_analysis_proto != nil {
		return
	}
	file_mediapb_v1_media_quality_proto_init()
	file_mediapb_v1_audio_analysis_proto_init()
	file_mediapb_v1_scene_detection_proto_init()
	file_mediapb_v1_technical_metadata_proto_init()
	file_mediapb_v1_thumbnail_info_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mediapb_v1_media_analysis_proto_rawDesc), len(file_mediapb_v1_media_analysis_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mediapb_v1_media_analysis_proto_goTypes,
		DependencyIndexes: file_mediapb_v1_media_analysis_proto_depIdxs,
		MessageInfos:      file_mediapb_v1_media_analysis_proto_msgTypes,
	}.Build()
	File_mediapb_v1_media_analysis_proto = out.File
	file_mediapb_v1_media_analysis_proto_goTypes = nil
	file_mediapb_v1_media_analysis_proto_depIdxs = nil
}
