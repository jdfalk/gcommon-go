...
// 	protoc        (unknown)
// source: mediapb/v1/merge_options.proto
...
type MergeOptions struct {
	...
	xxx_hidden_ConflictResolution commonpb.ConflictResolution `protobuf:"varint,3,opt,name=conflict_resolution,json=conflictResolution,enum=common.v1.ConflictResolution"`
...
func (x *MergeOptions) Reset() {
	*x = MergeOptions{}
	mi := &file_mediapb_v1_merge_options_proto_msgTypes[0]
...
func (x *MergeOptions) GetConflictResolution() commonpb.ConflictResolution {
	if x != nil {
...
func (x *MergeOptions) SetConflictResolution(v commonpb.ConflictResolution) {
...
var File_mediapb_v1_merge_options_proto protoreflect.FileDescriptor

const file_mediapb_v1_merge_options_proto_rawDesc = "" +
	"\n" +
	"\x1emediapb/v1/merge_options.proto\x12\bmedia.v1\x1a%commonpb/v1/conflict_resolution.proto\x1a!google/protobuf/go_features.proto\"\xe0\x01\n" +
	"\fMergeOptions\x12#\n" +
...
var file_mediapb_v1_merge_options_proto_goTypes = []any{
	...
	(commonpb.ConflictResolution)(0), // 1: common.v1.ConflictResolution
}
var file_mediapb_v1_merge_options_proto_depIdxs = []int32{
...
func init() { file_mediapb_v1_merge_options_proto_init() }
func file_mediapb_v1_merge_options_proto_init() {
	if File_mediapb_v1_merge_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mediapb_v1_merge_options_proto_rawDesc), len(file_mediapb_v1_merge_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mediapb_v1_merge_options_proto_goTypes,
		DependencyIndexes: file_mediapb_v1_merge_options_proto_depIdxs,
		MessageInfos:      file_mediapb_v1_merge_options_proto_msgTypes,
	}.Build()
	File_mediapb_v1_merge_options_proto = out.File
	file_mediapb_v1_merge_options_proto_goTypes = nil
	file_mediapb_v1_merge_options_proto_depIdxs = nil
}
