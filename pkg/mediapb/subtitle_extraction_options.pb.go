...
// 	protoc        (unknown)
// source: mediapb/v1/subtitle_extraction_options.proto
...
func (x *SubtitleExtractionOptions) Reset() {
	*x = SubtitleExtractionOptions{}
	mi := &file_mediapb_v1_subtitle_extraction_options_proto_msgTypes[0]
...
var File_mediapb_v1_subtitle_extraction_options_proto protoreflect.FileDescriptor

const file_mediapb_v1_subtitle_extraction_options_proto_rawDesc = "" +
	"\n" +
	",mediapb/v1/subtitle_extraction_options.proto\x12\bmedia.v1\x1a!google/protobuf/go_features.proto\"\xbf\x01\n" +
...
var file_mediapb_v1_subtitle_extraction_options_proto_depIdxs = []int32{
...
func init() { file_mediapb_v1_subtitle_extraction_options_proto_init() }
func file_mediapb_v1_subtitle_extraction_options_proto_init() {
	if File_mediapb_v1_subtitle_extraction_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mediapb_v1_subtitle_extraction_options_proto_rawDesc), len(file_mediapb_v1_subtitle_extraction_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mediapb_v1_subtitle_extraction_options_proto_goTypes,
		DependencyIndexes: file_mediapb_v1_subtitle_extraction_options_proto_depIdxs,
		MessageInfos:      file_mediapb_v1_subtitle_extraction_options_proto_msgTypes,
	}.Build()
	File_mediapb_v1_subtitle_extraction_options_proto = out.File
	file_mediapb_v1_subtitle_extraction_options_proto_goTypes = nil
	file_mediapb_v1_subtitle_extraction_options_proto_depIdxs = nil
}
