...
// 	protoc        (unknown)
// source: mediapb/v1/split_point.proto
...
func (x *SplitPoint) Reset() {
	*x = SplitPoint{}
	mi := &file_mediapb_v1_split_point_proto_msgTypes[0]
...
var File_mediapb_v1_split_point_proto protoreflect.FileDescriptor

const file_mediapb_v1_split_point_proto_rawDesc = "" +
	"\n" +
	"\x1cmediapb/v1/split_point.proto\x12\bmedia.v1\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"s\n" +
	"\n" +
	"SplitPoint\x127\n" +
...
var file_mediapb_v1_split_point_proto_depIdxs = []int32{
...
func init() { file_mediapb_v1_split_point_proto_init() }
func file_mediapb_v1_split_point_proto_init() {
	if File_mediapb_v1_split_point_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mediapb_v1_split_point_proto_rawDesc), len(file_mediapb_v1_split_point_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mediapb_v1_split_point_proto_goTypes,
		DependencyIndexes: file_mediapb_v1_split_point_proto_depIdxs,
		MessageInfos:      file_mediapb_v1_split_point_proto_msgTypes,
	}.Build()
	File_mediapb_v1_split_point_proto = out.File
	file_mediapb_v1_split_point_proto_goTypes = nil
	file_mediapb_v1_split_point_proto_depIdxs = nil
}
