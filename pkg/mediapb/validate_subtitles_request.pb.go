...
// 	protoc        (unknown)
// source: mediapb/v1/validate_subtitles_request.proto
...
func (x *ValidateSubtitlesRequest) Reset() {
	*x = ValidateSubtitlesRequest{}
	mi := &file_mediapb_v1_validate_subtitles_request_proto_msgTypes[0]
...
var File_mediapb_v1_validate_subtitles_request_proto protoreflect.FileDescriptor

const file_mediapb_v1_validate_subtitles_request_proto_rawDesc = "" +
	"\n" +
	"+mediapb/v1/validate_subtitles_request.proto\x12\bmedia.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc4\x01\n" +
	...
	"\x0fexpected_format\x18\x04 \x01(\tR\x0eexpectedFormatB\x9d\x01\n" +
	"\fcom.media.v1B\x1dValidateSubtitlesRequestProtoP\x01Z%github.com/jdfalk/gcommon/pkg/mediapb\xa2\x02\x03MXX\xaa\x02\bMedia.V1\xca\x02\bMedia\\V1\xe2\x02\x14Media\\V1\\GPBMetadata\xea\x02\tMedia::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_mediapb_v1_validate_subtitles_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_mediapb_v1_validate_subtitles_request_proto_goTypes = []any{
	(*ValidateSubtitlesRequest)(nil), // 0: media.v1.ValidateSubtitlesRequest
}
var file_mediapb_v1_validate_subtitles_request_proto_depIdxs = []int32{
...
func init() { file_mediapb_v1_validate_subtitles_request_proto_init() }
func file_mediapb_v1_validate_subtitles_request_proto_init() {
	if File_mediapb_v1_validate_subtitles_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mediapb_v1_validate_subtitles_request_proto_rawDesc), len(file_mediapb_v1_validate_subtitles_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mediapb_v1_validate_subtitles_request_proto_goTypes,
		DependencyIndexes: file_mediapb_v1_validate_subtitles_request_proto_depIdxs,
		MessageInfos:      file_mediapb_v1_validate_subtitles_request_proto_msgTypes,
	}.Build()
	File_mediapb_v1_validate_subtitles_request_proto = out.File
	file_mediapb_v1_validate_subtitles_request_proto_goTypes = nil
	file_mediapb_v1_validate_subtitles_request_proto_depIdxs = nil
}
