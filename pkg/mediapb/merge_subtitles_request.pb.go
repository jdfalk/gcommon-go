...
// 	protoc        (unknown)
// source: mediapb/v1/merge_subtitles_request.proto
...
func (x *MergeSubtitlesRequest) Reset() {
	*x = MergeSubtitlesRequest{}
	mi := &file_mediapb_v1_merge_subtitles_request_proto_msgTypes[0]
...
var File_mediapb_v1_merge_subtitles_request_proto protoreflect.FileDescriptor

const file_mediapb_v1_merge_subtitles_request_proto_rawDesc = "" +
	"\n" +
	"(mediapb/v1/merge_subtitles_request.proto\x12\bmedia.v1\x1a\x1emediapb/v1/merge_options.proto\x1a!google/protobuf/go_features.proto\"\xa6\x01\n" +
	...
	"\rmerge_options\x18\x03 \x01(\v2\x16.media.v1.MergeOptionsR\fmergeOptionsB\x9a\x01\n" +
	"\fcom.media.v1B\x1aMergeSubtitlesRequestProtoP\x01Z%github.com/jdfalk/gcommon/pkg/mediapb\xa2\x02\x03MXX\xaa\x02\bMedia.V1\xca\x02\bMedia\\V1\xe2\x02\x14Media\\V1\\GPBMetadata\xea\x02\tMedia::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_mediapb_v1_merge_subtitles_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_mediapb_v1_merge_subtitles_request_proto_goTypes = []any{
	(*MergeSubtitlesRequest)(nil), // 0: media.v1.MergeSubtitlesRequest
	(*MergeOptions)(nil),          // 1: media.v1.MergeOptions
}
var file_mediapb_v1_merge_subtitles_request_proto_depIdxs = []int32{
...
func init() { file_mediapb_v1_merge_subtitles_request_proto_init() }
func file_mediapb_v1_merge_subtitles_request_proto_init() {
	if File_mediapb_v1_merge_subtitles_request_proto != nil {
		return
	}
	file_mediapb_v1_merge_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mediapb_v1_merge_subtitles_request_proto_rawDesc), len(file_mediapb_v1_merge_subtitles_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mediapb_v1_merge_subtitles_request_proto_goTypes,
		DependencyIndexes: file_mediapb_v1_merge_subtitles_request_proto_depIdxs,
		MessageInfos:      file_mediapb_v1_merge_subtitles_request_proto_msgTypes,
	}.Build()
	File_mediapb_v1_merge_subtitles_request_proto = out.File
	file_mediapb_v1_merge_subtitles_request_proto_goTypes = nil
	file_mediapb_v1_merge_subtitles_request_proto_depIdxs = nil
}
