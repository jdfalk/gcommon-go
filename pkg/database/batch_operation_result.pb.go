...
func (x *BatchOperationResult) Reset() {
	*x = BatchOperationResult{}
	mi := &file_database_v1_batch_operation_result_proto_msgTypes[0]
...
var File_database_v1_batch_operation_result_proto protoreflect.FileDescriptor

const file_database_v1_batch_operation_result_proto_rawDesc = "" +
	"\n" +
	"(database/v1/batch_operation_result.proto\x12\vdatabase.v1\x1a\x15common/v1/error.proto\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd3\x01\n" +
...
func init() { file_database_v1_batch_operation_result_proto_init() }
func file_database_v1_batch_operation_result_proto_init() {
	if File_database_v1_batch_operation_result_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_database_v1_batch_operation_result_proto_rawDesc), len(file_database_v1_batch_operation_result_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_database_v1_batch_operation_result_proto_goTypes,
		DependencyIndexes: file_database_v1_batch_operation_result_proto_depIdxs,
		MessageInfos:      file_database_v1_batch_operation_result_proto_msgTypes,
	}.Build()
	File_database_v1_batch_operation_result_proto = out.File
	file_database_v1_batch_operation_result_proto_goTypes = nil
	file_database_v1_batch_operation_result_proto_depIdxs = nil
}
