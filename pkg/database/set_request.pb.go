...
func (x *SetRequest) Reset() {
	*x = SetRequest{}
	mi := &file_database_v1_set_request_proto_msgTypes[0]
...
var File_database_v1_set_request_proto protoreflect.FileDescriptor

const file_database_v1_set_request_proto_rawDesc = "" +
	"\n" +
	"\x1ddatabase/v1/set_request.proto\x12\vdatabase.v1\x1a common/v1/request_metadata.proto\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa2\x03\n" +
	"\n" +
	"SetRequest\x12\x19\n" +
...
func init() { file_database_v1_set_request_proto_init() }
func file_database_v1_set_request_proto_init() {
	if File_database_v1_set_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_database_v1_set_request_proto_rawDesc), len(file_database_v1_set_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_database_v1_set_request_proto_goTypes,
		DependencyIndexes: file_database_v1_set_request_proto_depIdxs,
		MessageInfos:      file_database_v1_set_request_proto_msgTypes,
	}.Build()
	File_database_v1_set_request_proto = out.File
	file_database_v1_set_request_proto_goTypes = nil
	file_database_v1_set_request_proto_depIdxs = nil
}
