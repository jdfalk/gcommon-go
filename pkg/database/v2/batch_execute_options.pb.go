...
// 	protoc        (unknown)
// source: database/v2/batch_execute_options.proto
...
func (x *BatchExecuteOptions) Reset() {
	*x = BatchExecuteOptions{}
	mi := &file_database_v2_batch_execute_options_proto_msgTypes[0]
...
var File_database_v2_batch_execute_options_proto protoreflect.FileDescriptor

const file_database_v2_batch_execute_options_proto_rawDesc = "" +
	"\n" +
	"'database/v2/batch_execute_options.proto\x12\vdatabase.v2\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x97\x01\n" +
	...
	"\fmax_parallel\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\vmaxParallelB3Z)github.com/jdfalk/gcommon/pkg/database/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_database_v2_batch_execute_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_database_v2_batch_execute_options_proto_goTypes = []any{
	(*BatchExecuteOptions)(nil), // 0: database.v2.BatchExecuteOptions
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_database_v2_batch_execute_options_proto_depIdxs = []int32{
...
func init() { file_database_v2_batch_execute_options_proto_init() }
func file_database_v2_batch_execute_options_proto_init() {
	if File_database_v2_batch_execute_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_database_v2_batch_execute_options_proto_rawDesc), len(file_database_v2_batch_execute_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_database_v2_batch_execute_options_proto_goTypes,
		DependencyIndexes: file_database_v2_batch_execute_options_proto_depIdxs,
		MessageInfos:      file_database_v2_batch_execute_options_proto_msgTypes,
	}.Build()
	File_database_v2_batch_execute_options_proto = out.File
	file_database_v2_batch_execute_options_proto_goTypes = nil
	file_database_v2_batch_execute_options_proto_depIdxs = nil
}
