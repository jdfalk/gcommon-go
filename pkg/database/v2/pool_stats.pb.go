...
// 	protoc        (unknown)
// source: database/v2/pool_stats.proto
...
func (x *PoolStats) Reset() {
	*x = PoolStats{}
	mi := &file_database_v2_pool_stats_proto_msgTypes[0]
...
var File_database_v2_pool_stats_proto protoreflect.FileDescriptor

const file_database_v2_pool_stats_proto_rawDesc = "" +
	"\n" +
	"\x1cdatabase/v2/pool_stats.proto\x12\vdatabase.v2\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf2\x01\n" +
	"\tPoolStats\x12,\n" +
...
var file_database_v2_pool_stats_proto_depIdxs = []int32{
...
func init() { file_database_v2_pool_stats_proto_init() }
func file_database_v2_pool_stats_proto_init() {
	if File_database_v2_pool_stats_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_database_v2_pool_stats_proto_rawDesc), len(file_database_v2_pool_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_database_v2_pool_stats_proto_goTypes,
		DependencyIndexes: file_database_v2_pool_stats_proto_depIdxs,
		MessageInfos:      file_database_v2_pool_stats_proto_msgTypes,
	}.Build()
	File_database_v2_pool_stats_proto = out.File
	file_database_v2_pool_stats_proto_goTypes = nil
	file_database_v2_pool_stats_proto_depIdxs = nil
}
