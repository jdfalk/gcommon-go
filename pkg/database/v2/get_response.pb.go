...
// 	protoc        (unknown)
// source: database/v2/get_response.proto
...
func (x *GetResponse) Reset() {
	*x = GetResponse{}
	mi := &file_database_v2_get_response_proto_msgTypes[0]
...
var File_database_v2_get_response_proto protoreflect.FileDescriptor

const file_database_v2_get_response_proto_rawDesc = "" +
	"\n" +
	"\x1edatabase/v2/get_response.proto\x12\vdatabase.v2\x1a\x1ddatabase/v2/cache_entry.proto\x1a!google/protobuf/go_features.proto\"s\n" +
	"\vGetResponse\x121\n" +
	"\x05entry\x18\x01 \x01(\v2\x17.database.v2.CacheEntryB\x02(\x01R\x05entry\x12\x14\n" +
	"\x05found\x18\x02 \x01(\bR\x05found\x12\x1b\n" +
	"\tcache_hit\x18\x03 \x01(\bR\bcacheHitB3Z)github.com/jdfalk/gcommon/pkg/database/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_database_v2_get_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_database_v2_get_response_proto_goTypes = []any{
	(*GetResponse)(nil), // 0: database.v2.GetResponse
	(*CacheEntry)(nil),  // 1: database.v2.CacheEntry
}
var file_database_v2_get_response_proto_depIdxs = []int32{
	1, // 0: database.v2.GetResponse.entry:type_name -> database.v2.CacheEntry
...
func init() { file_database_v2_get_response_proto_init() }
func file_database_v2_get_response_proto_init() {
	if File_database_v2_get_response_proto != nil {
		return
	}
	file_database_v2_cache_entry_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_database_v2_get_response_proto_rawDesc), len(file_database_v2_get_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_database_v2_get_response_proto_goTypes,
		DependencyIndexes: file_database_v2_get_response_proto_depIdxs,
		MessageInfos:      file_database_v2_get_response_proto_msgTypes,
	}.Build()
	File_database_v2_get_response_proto = out.File
	file_database_v2_get_response_proto_goTypes = nil
	file_database_v2_get_response_proto_depIdxs = nil
}
