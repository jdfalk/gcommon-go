...
// 	protoc        (unknown)
// source: database/v2/prepend_request.proto
...
func (x *PrependRequest) Reset() {
	*x = PrependRequest{}
	mi := &file_database_v2_prepend_request_proto_msgTypes[0]
...
var File_database_v2_prepend_request_proto protoreflect.FileDescriptor

const file_database_v2_prepend_request_proto_rawDesc = "" +
	"\n" +
	"!database/v2/prepend_request.proto\x12\vdatabase.v2\x1a common/v2/request_metadata.proto\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbe\x01\n" +
...
var file_database_v2_prepend_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_database_v2_prepend_request_proto_goTypes = []any{
	(*PrependRequest)(nil),     // 0: database.v2.PrependRequest
	(*anypb.Any)(nil),          // 1: google.protobuf.Any
	(*v2.RequestMetadata)(nil), // 2: common.v2.RequestMetadata
}
var file_database_v2_prepend_request_proto_depIdxs = []int32{
...
func init() { file_database_v2_prepend_request_proto_init() }
func file_database_v2_prepend_request_proto_init() {
	if File_database_v2_prepend_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_database_v2_prepend_request_proto_rawDesc), len(file_database_v2_prepend_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_database_v2_prepend_request_proto_goTypes,
		DependencyIndexes: file_database_v2_prepend_request_proto_depIdxs,
		MessageInfos:      file_database_v2_prepend_request_proto_msgTypes,
	}.Build()
	File_database_v2_prepend_request_proto = out.File
	file_database_v2_prepend_request_proto_goTypes = nil
	file_database_v2_prepend_request_proto_depIdxs = nil
}
