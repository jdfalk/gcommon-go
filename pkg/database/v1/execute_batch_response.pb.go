...
func (x *ExecuteBatchResponse) Reset() {
	*x = ExecuteBatchResponse{}
	mi := &file_database_v1_execute_batch_response_proto_msgTypes[0]
...
var File_database_v1_execute_batch_response_proto protoreflect.FileDescriptor

const file_database_v1_execute_batch_response_proto_rawDesc = "" +
	"\n" +
	"(database/v1/execute_batch_response.proto\x12\vdatabase.v1\x1a\x15common/v1/error.proto\x1a(database/v1/batch_operation_result.proto\x1a\x1ddatabase/v1/batch_stats.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc6\x01\n" +
...
func init() { file_database_v1_execute_batch_response_proto_init() }
func file_database_v1_execute_batch_response_proto_init() {
	if File_database_v1_execute_batch_response_proto != nil {
		return
	}
	file_database_v1_batch_operation_result_proto_init()
	file_database_v1_batch_stats_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_database_v1_execute_batch_response_proto_rawDesc), len(file_database_v1_execute_batch_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_database_v1_execute_batch_response_proto_goTypes,
		DependencyIndexes: file_database_v1_execute_batch_response_proto_depIdxs,
		MessageInfos:      file_database_v1_execute_batch_response_proto_msgTypes,
	}.Build()
	File_database_v1_execute_batch_response_proto = out.File
	file_database_v1_execute_batch_response_proto_goTypes = nil
	file_database_v1_execute_batch_response_proto_depIdxs = nil
}
