...
// 	protoc        (unknown)
// source: database/v1/pebble_config.proto
...
func (x *PebbleConfig) Reset() {
	*x = PebbleConfig{}
	mi := &file_database_v1_pebble_config_proto_msgTypes[0]
...
var File_database_v1_pebble_config_proto protoreflect.FileDescriptor

const file_database_v1_pebble_config_proto_rawDesc = "" +
	"\n" +
	"\x1fdatabase/v1/pebble_config.proto\x12\vdatabase.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd2\x01\n" +
	...
	"\vcompression\x18\x05 \x01(\bR\vcompressionB1Z'github.com/jdfalk/gcommon/pkg/database/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_database_v1_pebble_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_database_v1_pebble_config_proto_goTypes = []any{
	(*PebbleConfig)(nil), // 0: database.v1.PebbleConfig
}
var file_database_v1_pebble_config_proto_depIdxs = []int32{
...
func init() { file_database_v1_pebble_config_proto_init() }
func file_database_v1_pebble_config_proto_init() {
	if File_database_v1_pebble_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_database_v1_pebble_config_proto_rawDesc), len(file_database_v1_pebble_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_database_v1_pebble_config_proto_goTypes,
		DependencyIndexes: file_database_v1_pebble_config_proto_depIdxs,
		MessageInfos:      file_database_v1_pebble_config_proto_msgTypes,
	}.Build()
	File_database_v1_pebble_config_proto = out.File
	file_database_v1_pebble_config_proto_goTypes = nil
	file_database_v1_pebble_config_proto_depIdxs = nil
}
