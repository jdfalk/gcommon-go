...
func (x *ResultSet) Reset() {
	*x = ResultSet{}
	mi := &file_database_v1_result_set_proto_msgTypes[0]
...
var File_database_v1_result_set_proto protoreflect.FileDescriptor

const file_database_v1_result_set_proto_rawDesc = "" +
	"\n" +
	"\x1cdatabase/v1/result_set.proto\x12\vdatabase.v1\x1a!database/v1/column_metadata.proto\x1a\x15database/v1/row.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc5\x01\n" +
	"\tResultSet\x12A\n" +
	...
	"totalCount\x12\x19\n" +
	"\bhas_more\x18\x04 \x01(\bR\ahasMoreB0Z&github.com/jdfalk/gcommon/pkg/database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_database_v1_result_set_proto_depIdxs = []int32{
...
func init() { file_database_v1_result_set_proto_init() }
func file_database_v1_result_set_proto_init() {
	if File_database_v1_result_set_proto != nil {
		return
	}
	file_database_v1_column_metadata_proto_init()
	file_database_v1_row_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_database_v1_result_set_proto_rawDesc), len(file_database_v1_result_set_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_database_v1_result_set_proto_goTypes,
		DependencyIndexes: file_database_v1_result_set_proto_depIdxs,
		MessageInfos:      file_database_v1_result_set_proto_msgTypes,
	}.Build()
	File_database_v1_result_set_proto = out.File
	file_database_v1_result_set_proto_goTypes = nil
	file_database_v1_result_set_proto_depIdxs = nil
}
