...
func (x *QueryRowRequest) Reset() {
	*x = QueryRowRequest{}
	mi := &file_database_v1_query_row_request_proto_msgTypes[0]
...
var File_database_v1_query_row_request_proto protoreflect.FileDescriptor

const file_database_v1_query_row_request_proto_rawDesc = "" +
	"\n" +
	"#database/v1/query_row_request.proto\x12\vdatabase.v1\x1a common/v1/request_metadata.proto\x1a\x1fdatabase/v1/query_options.proto\x1a!database/v1/query_parameter.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbf\x02\n" +
	...
	"\bmetadata\x18\x06 \x01(\v2\x1a.common.v1.RequestMetadataR\bmetadataB0Z&github.com/jdfalk/gcommon/pkg/database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_database_v1_query_row_request_proto_init() }
func file_database_v1_query_row_request_proto_init() {
	if File_database_v1_query_row_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_database_v1_query_row_request_proto_rawDesc), len(file_database_v1_query_row_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_database_v1_query_row_request_proto_goTypes,
		DependencyIndexes: file_database_v1_query_row_request_proto_depIdxs,
		MessageInfos:      file_database_v1_query_row_request_proto_msgTypes,
	}.Build()
	File_database_v1_query_row_request_proto = out.File
	file_database_v1_query_row_request_proto_goTypes = nil
	file_database_v1_query_row_request_proto_depIdxs = nil
}
