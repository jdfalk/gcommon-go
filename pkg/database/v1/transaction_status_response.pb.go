...
func (x *TransactionStatusResponse) Reset() {
	*x = TransactionStatusResponse{}
	mi := &file_database_v1_transaction_status_response_proto_msgTypes[0]
...
var File_database_v1_transaction_status_response_proto protoreflect.FileDescriptor

const file_database_v1_transaction_status_response_proto_rawDesc = "" +
	"\n" +
...
func init() { file_database_v1_transaction_status_response_proto_init() }
func file_database_v1_transaction_status_response_proto_init() {
	if File_database_v1_transaction_status_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_database_v1_transaction_status_response_proto_rawDesc), len(file_database_v1_transaction_status_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_database_v1_transaction_status_response_proto_goTypes,
		DependencyIndexes: file_database_v1_transaction_status_response_proto_depIdxs,
		MessageInfos:      file_database_v1_transaction_status_response_proto_msgTypes,
	}.Build()
	File_database_v1_transaction_status_response_proto = out.File
	file_database_v1_transaction_status_response_proto_goTypes = nil
	file_database_v1_transaction_status_response_proto_depIdxs = nil
}
