...
// 	protoc        (unknown)
// source: database/v1/column_metadata.proto
...
func (x *ColumnMetadata) Reset() {
	*x = ColumnMetadata{}
	mi := &file_database_v1_column_metadata_proto_msgTypes[0]
...
var File_database_v1_column_metadata_proto protoreflect.FileDescriptor

const file_database_v1_column_metadata_proto_rawDesc = "" +
	"\n" +
	"!database/v1/column_metadata.proto\x12\vdatabase.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x91\x02\n" +
...
var file_database_v1_column_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_database_v1_column_metadata_proto_goTypes = []any{
	(*ColumnMetadata)(nil), // 0: database.v1.ColumnMetadata
	nil,                    // 1: database.v1.ColumnMetadata.MetadataEntry
}
var file_database_v1_column_metadata_proto_depIdxs = []int32{
...
func init() { file_database_v1_column_metadata_proto_init() }
func file_database_v1_column_metadata_proto_init() {
	if File_database_v1_column_metadata_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_database_v1_column_metadata_proto_rawDesc), len(file_database_v1_column_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_database_v1_column_metadata_proto_goTypes,
		DependencyIndexes: file_database_v1_column_metadata_proto_depIdxs,
		MessageInfos:      file_database_v1_column_metadata_proto_msgTypes,
	}.Build()
	File_database_v1_column_metadata_proto = out.File
	file_database_v1_column_metadata_proto_goTypes = nil
	file_database_v1_column_metadata_proto_depIdxs = nil
}
