...
func (x *SetMultipleResponse) Reset() {
	*x = SetMultipleResponse{}
	mi := &file_database_v1_set_multiple_response_proto_msgTypes[0]
...
var File_database_v1_set_multiple_response_proto protoreflect.FileDescriptor

const file_database_v1_set_multiple_response_proto_rawDesc = "" +
	"\n" +
	"'database/v1/set_multiple_response.proto\x12\vdatabase.v1\x1a\x15common/v1/error.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa8\x01\n" +
	...
	"\tset_count\x18\x04 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\bsetCountB0Z&github.com/jdfalk/gcommon/pkg/database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_database_v1_set_multiple_response_proto_init() }
func file_database_v1_set_multiple_response_proto_init() {
	if File_database_v1_set_multiple_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_database_v1_set_multiple_response_proto_rawDesc), len(file_database_v1_set_multiple_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_database_v1_set_multiple_response_proto_goTypes,
		DependencyIndexes: file_database_v1_set_multiple_response_proto_depIdxs,
		MessageInfos:      file_database_v1_set_multiple_response_proto_msgTypes,
	}.Build()
	File_database_v1_set_multiple_response_proto = out.File
	file_database_v1_set_multiple_response_proto_goTypes = nil
	file_database_v1_set_multiple_response_proto_depIdxs = nil
}
