...
// 	protoc        (unknown)
// source: database/v1/cache_entry.proto
...
func (x *CacheEntry) Reset() {
	*x = CacheEntry{}
	mi := &file_database_v1_cache_entry_proto_msgTypes[0]
...
var File_database_v1_cache_entry_proto protoreflect.FileDescriptor

const file_database_v1_cache_entry_proto_rawDesc = "" +
	"\n" +
	"\x1ddatabase/v1/cache_entry.proto\x12\vdatabase.v1\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x80\x04\n" +
	"\n" +
	"CacheEntry\x12\x10\n" +
...
var file_database_v1_cache_entry_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_database_v1_cache_entry_proto_goTypes = []any{
	(*CacheEntry)(nil),            // 0: database.v1.CacheEntry
	nil,                           // 1: database.v1.CacheEntry.MetadataEntry
	(*anypb.Any)(nil),             // 2: google.protobuf.Any
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_database_v1_cache_entry_proto_depIdxs = []int32{
...
func init() { file_database_v1_cache_entry_proto_init() }
func file_database_v1_cache_entry_proto_init() {
	if File_database_v1_cache_entry_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_database_v1_cache_entry_proto_rawDesc), len(file_database_v1_cache_entry_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_database_v1_cache_entry_proto_goTypes,
		DependencyIndexes: file_database_v1_cache_entry_proto_depIdxs,
		MessageInfos:      file_database_v1_cache_entry_proto_msgTypes,
	}.Build()
	File_database_v1_cache_entry_proto = out.File
	file_database_v1_cache_entry_proto_goTypes = nil
	file_database_v1_cache_entry_proto_depIdxs = nil
}
