...
func (x *ExistsResponse) Reset() {
	*x = ExistsResponse{}
	mi := &file_database_v1_exists_response_proto_msgTypes[0]
...
var File_database_v1_exists_response_proto protoreflect.FileDescriptor

const file_database_v1_exists_response_proto_rawDesc = "" +
	"\n" +
	...
	"\x05error\x18\x02 \x01(\v2\x10.common.v1.ErrorR\x05errorB0Z&github.com/jdfalk/gcommon/pkg/database\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_database_v1_exists_response_proto_init() }
func file_database_v1_exists_response_proto_init() {
	if File_database_v1_exists_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_database_v1_exists_response_proto_rawDesc), len(file_database_v1_exists_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_database_v1_exists_response_proto_goTypes,
		DependencyIndexes: file_database_v1_exists_response_proto_depIdxs,
		MessageInfos:      file_database_v1_exists_response_proto_msgTypes,
	}.Build()
	File_database_v1_exists_response_proto = out.File
	file_database_v1_exists_response_proto_goTypes = nil
	file_database_v1_exists_response_proto_depIdxs = nil
}
