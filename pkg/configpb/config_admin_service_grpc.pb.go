...
const (
	ConfigAdminService_BackupConfig_FullMethodName     = "/config.v1.ConfigAdminService/BackupConfig"
	ConfigAdminService_RestoreConfig_FullMethodName    = "/config.v1.ConfigAdminService/RestoreConfig"
	ConfigAdminService_ImportConfig_FullMethodName     = "/config.v1.ConfigAdminService/ImportConfig"
	ConfigAdminService_ExportConfig_FullMethodName     = "/config.v1.ConfigAdminService/ExportConfig"
	ConfigAdminService_ReloadConfig_FullMethodName     = "/config.v1.ConfigAdminService/ReloadConfig"
	ConfigAdminService_RollbackConfig_FullMethodName   = "/config.v1.ConfigAdminService/RollbackConfig"
	ConfigAdminService_SetConfigSchema_FullMethodName  = "/config.v1.ConfigAdminService/SetConfigSchema"
	ConfigAdminService_GetConfigHistory_FullMethodName = "/config.v1.ConfigAdminService/GetConfigHistory"
	ConfigAdminService_GetConfigStats_FullMethodName   = "/config.v1.ConfigAdminService/GetConfigStats"
	ConfigAdminService_HealthCheck_FullMethodName      = "/config.v1.ConfigAdminService/HealthCheck"
	ConfigAdminService_UnwatchConfig_FullMethodName    = "/config.v1.ConfigAdminService/UnwatchConfig"
)
...
var ConfigAdminService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "config.v1.ConfigAdminService",
	...
	Metadata: "configpb/v1/config_admin_service.proto",
}
