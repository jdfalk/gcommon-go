...
// 	protoc        (unknown)
// source: configpb/v1/version_compatibility_info.proto
...
func (x *VersionCompatibilityInfo) Reset() {
	*x = VersionCompatibilityInfo{}
	mi := &file_configpb_v1_version_compatibility_info_proto_msgTypes[0]
...
var File_configpb_v1_version_compatibility_info_proto protoreflect.FileDescriptor

const file_configpb_v1_version_compatibility_info_proto_rawDesc = "" +
	"\n" +
	",configpb/v1/version_compatibility_info.proto\x12\tconfig.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xaf\x03\n" +
...
var file_configpb_v1_version_compatibility_info_proto_goTypes = []any{
	(*VersionCompatibilityInfo)(nil), // 0: config.v1.VersionCompatibilityInfo
}
var file_configpb_v1_version_compatibility_info_proto_depIdxs = []int32{
...
func init() { file_configpb_v1_version_compatibility_info_proto_init() }
func file_configpb_v1_version_compatibility_info_proto_init() {
	if File_configpb_v1_version_compatibility_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_configpb_v1_version_compatibility_info_proto_rawDesc), len(file_configpb_v1_version_compatibility_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_configpb_v1_version_compatibility_info_proto_goTypes,
		DependencyIndexes: file_configpb_v1_version_compatibility_info_proto_depIdxs,
		MessageInfos:      file_configpb_v1_version_compatibility_info_proto_msgTypes,
	}.Build()
	File_configpb_v1_version_compatibility_info_proto = out.File
	file_configpb_v1_version_compatibility_info_proto_goTypes = nil
	file_configpb_v1_version_compatibility_info_proto_depIdxs = nil
}
