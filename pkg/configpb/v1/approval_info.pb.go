...
// 	protoc        (unknown)
// source: configpb/v1/approval_info.proto
...
type ApprovalInfo struct {
	...
	xxx_hidden_Status      commonpb.ApprovalStatus `protobuf:"varint,2,opt,name=status,enum=common.v1.ApprovalStatus"`
...
func (x *ApprovalInfo) Reset() {
	*x = ApprovalInfo{}
	mi := &file_configpb_v1_approval_info_proto_msgTypes[0]
...
func (x *ApprovalInfo) GetStatus() commonpb.ApprovalStatus {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			return x.xxx_hidden_Status
		}
	}
	return commonpb.ApprovalStatus(0)
}
...
func (x *ApprovalInfo) SetStatus(v commonpb.ApprovalStatus) {
...
func (x *ApprovalInfo) ClearStatus() {
	...
	x.xxx_hidden_Status = commonpb.ApprovalStatus_APPROVAL_STATUS_UNSPECIFIED
}
...
type ApprovalInfo_builder struct {
	...
	Required *bool
	// Approval status
	Status *commonpb.ApprovalStatus
	// User who approved
	ApprovedBy *string
	// Approval timestamp
...
var File_configpb_v1_approval_info_proto protoreflect.FileDescriptor

const file_configpb_v1_approval_info_proto_rawDesc = "" +
	"\n" +
	"\x1fconfigpb/v1/approval_info.proto\x12\tconfig.v1\x1a!commonpb/v1/approval_status.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa4\x02\n" +
	"\fApprovalInfo\x12\x1a\n" +
	"\brequired\x18\x01 \x01(\bR\brequired\x121\n" +
	"\x06status\x18\x02 \x01(\x0e2\x19.common.v1.ApprovalStatusR\x06status\x12\x1f\n" +
	...
	"policyNameB\x97\x01\n" +
	"\rcom.config.v1B\x11ApprovalInfoProtoP\x01Z&github.com/jdfalk/gcommon/pkg/configpb\xa2\x02\x03CXX\xaa\x02\tConfig.V1\xca\x02\tConfig\\V1\xe2\x02\x15Config\\V1\\GPBMetadata\xea\x02\n" +
	"Config::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_configpb_v1_approval_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_configpb_v1_approval_info_proto_goTypes = []any{
	(*ApprovalInfo)(nil),          // 0: config.v1.ApprovalInfo
	(commonpb.ApprovalStatus)(0),  // 1: common.v1.ApprovalStatus
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_configpb_v1_approval_info_proto_depIdxs = []int32{
	1, // 0: config.v1.ApprovalInfo.status:type_name -> common.v1.ApprovalStatus
	2, // 1: config.v1.ApprovalInfo.approved_at:type_name -> google.protobuf.Timestamp
...
func init() { file_configpb_v1_approval_info_proto_init() }
func file_configpb_v1_approval_info_proto_init() {
	if File_configpb_v1_approval_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_configpb_v1_approval_info_proto_rawDesc), len(file_configpb_v1_approval_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_configpb_v1_approval_info_proto_goTypes,
		DependencyIndexes: file_configpb_v1_approval_info_proto_depIdxs,
		MessageInfos:      file_configpb_v1_approval_info_proto_msgTypes,
	}.Build()
	File_configpb_v1_approval_info_proto = out.File
	file_configpb_v1_approval_info_proto_goTypes = nil
	file_configpb_v1_approval_info_proto_depIdxs = nil
}
