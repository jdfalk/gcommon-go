...
// 	protoc        (unknown)
// source: configpb/v1/rotation_settings.proto
...
type RotationSettings struct {
	...
	xxx_hidden_Frequency              commonpb.RotationFrequency `protobuf:"varint,2,opt,name=frequency,enum=common.v1.RotationFrequency"`
...
func (x *RotationSettings) Reset() {
	*x = RotationSettings{}
	mi := &file_configpb_v1_rotation_settings_proto_msgTypes[0]
...
func (x *RotationSettings) GetFrequency() commonpb.RotationFrequency {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			return x.xxx_hidden_Frequency
		}
	}
	return commonpb.RotationFrequency(0)
}
...
func (x *RotationSettings) SetFrequency(v commonpb.RotationFrequency) {
...
func (x *RotationSettings) ClearFrequency() {
	...
	x.xxx_hidden_Frequency = commonpb.RotationFrequency_ROTATION_FREQUENCY_UNSPECIFIED
}
...
type RotationSettings_builder struct {
	...
	Enabled *bool
	// Rotation frequency
	Frequency *commonpb.RotationFrequency
...
var File_configpb_v1_rotation_settings_proto protoreflect.FileDescriptor

const file_configpb_v1_rotation_settings_proto_rawDesc = "" +
	"\n" +
	"#configpb/v1/rotation_settings.proto\x12\tconfig.v1\x1a$commonpb/v1/rotation_frequency.proto\x1a configpb/v1/rotation_event.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa4\x04\n" +
	"\x10RotationSettings\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12:\n" +
	"\tfrequency\x18\x02 \x01(\x0e2\x1c.common.v1.RotationFrequencyR\tfrequency\x12#\n" +
	...
	" \x03(\v2\x18.config.v1.RotationEventB\b\xbaH\x05\x92\x01\x02\b\x01R\x0frotationHistoryB\x9b\x01\n" +
	"\rcom.config.v1B\x15RotationSettingsProtoP\x01Z&github.com/jdfalk/gcommon/pkg/configpb\xa2\x02\x03CXX\xaa\x02\tConfig.V1\xca\x02\tConfig\\V1\xe2\x02\x15Config\\V1\\GPBMetadata\xea\x02\n" +
	"Config::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_configpb_v1_rotation_settings_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_configpb_v1_rotation_settings_proto_goTypes = []any{
	(*RotationSettings)(nil),        // 0: config.v1.RotationSettings
	(commonpb.RotationFrequency)(0), // 1: common.v1.RotationFrequency
	(*timestamppb.Timestamp)(nil),   // 2: google.protobuf.Timestamp
	(*RotationEvent)(nil),           // 3: config.v1.RotationEvent
}
var file_configpb_v1_rotation_settings_proto_depIdxs = []int32{
	1, // 0: config.v1.RotationSettings.frequency:type_name -> common.v1.RotationFrequency
	2, // 1: config.v1.RotationSettings.last_rotated_at:type_name -> google.protobuf.Timestamp
	2, // 2: config.v1.RotationSettings.next_rotation_at:type_name -> google.protobuf.Timestamp
	3, // 3: config.v1.RotationSettings.rotation_history:type_name -> config.v1.RotationEvent
...
func init() { file_configpb_v1_rotation_settings_proto_init() }
func file_configpb_v1_rotation_settings_proto_init() {
	if File_configpb_v1_rotation_settings_proto != nil {
		return
	}
	file_configpb_v1_rotation_event_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_configpb_v1_rotation_settings_proto_rawDesc), len(file_configpb_v1_rotation_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_configpb_v1_rotation_settings_proto_goTypes,
		DependencyIndexes: file_configpb_v1_rotation_settings_proto_depIdxs,
		MessageInfos:      file_configpb_v1_rotation_settings_proto_msgTypes,
	}.Build()
	File_configpb_v1_rotation_settings_proto = out.File
	file_configpb_v1_rotation_settings_proto_goTypes = nil
	file_configpb_v1_rotation_settings_proto_depIdxs = nil
}
