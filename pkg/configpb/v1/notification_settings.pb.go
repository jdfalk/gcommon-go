...
// 	protoc        (unknown)
// source: configpb/v1/notification_settings.proto
...
type ConfigNotificationSettings struct {
	...
	xxx_hidden_Triggers     []commonpb.NotificationTrigger `protobuf:"varint,3,rep,packed,name=triggers,enum=common.v1.NotificationTrigger"`
...
func (x *ConfigNotificationSettings) Reset() {
	*x = ConfigNotificationSettings{}
	mi := &file_configpb_v1_notification_settings_proto_msgTypes[0]
...
func (x *ConfigNotificationSettings) GetTriggers() []commonpb.NotificationTrigger {
	if x != nil {
...
func (x *ConfigNotificationSettings) SetTriggers(v []commonpb.NotificationTrigger) {
...
type ConfigNotificationSettings_builder struct {
	...
	Triggers []commonpb.NotificationTrigger
...
var File_configpb_v1_notification_settings_proto protoreflect.FileDescriptor

const file_configpb_v1_notification_settings_proto_rawDesc = "" +
	"\n" +
	"'configpb/v1/notification_settings.proto\x12\tconfig.v1\x1a&commonpb/v1/notification_trigger.proto\x1a#configpb/v1/batching_settings.proto\x1a&configpb/v1/notification_channel.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xfe\x02\n" +
...
var file_configpb_v1_notification_settings_proto_goTypes = []any{
	...
	(commonpb.NotificationTrigger)(0),  // 2: common.v1.NotificationTrigger
	(*BatchingSettings)(nil),           // 3: config.v1.BatchingSettings
}
var file_configpb_v1_notification_settings_proto_depIdxs = []int32{
...
func init() { file_configpb_v1_notification_settings_proto_init() }
func file_configpb_v1_notification_settings_proto_init() {
	if File_configpb_v1_notification_settings_proto != nil {
		return
	}
	file_configpb_v1_batching_settings_proto_init()
	file_configpb_v1_notification_channel_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_configpb_v1_notification_settings_proto_rawDesc), len(file_configpb_v1_notification_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_configpb_v1_notification_settings_proto_goTypes,
		DependencyIndexes: file_configpb_v1_notification_settings_proto_depIdxs,
		MessageInfos:      file_configpb_v1_notification_settings_proto_msgTypes,
	}.Build()
	File_configpb_v1_notification_settings_proto = out.File
	file_configpb_v1_notification_settings_proto_goTypes = nil
	file_configpb_v1_notification_settings_proto_depIdxs = nil
}
