...
// 	protoc        (unknown)
// source: configpb/v2/approval_info.proto
...
type ApprovalInfo struct {
	...
	xxx_hidden_Status      v2.ApprovalStatus      `protobuf:"varint,2,opt,name=status,enum=common.v2.ApprovalStatus"`
...
func (x *ApprovalInfo) Reset() {
	*x = ApprovalInfo{}
	mi := &file_configpb_v2_approval_info_proto_msgTypes[0]
...
func (x *ApprovalInfo) GetStatus() v2.ApprovalStatus {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			return x.xxx_hidden_Status
		}
	}
	return v2.ApprovalStatus(0)
}
...
func (x *ApprovalInfo) SetStatus(v v2.ApprovalStatus) {
...
func (x *ApprovalInfo) ClearStatus() {
	...
	x.xxx_hidden_Status = v2.ApprovalStatus_APPROVAL_STATUS_UNSPECIFIED
}
...
var File_configpb_v2_approval_info_proto protoreflect.FileDescriptor

const file_configpb_v2_approval_info_proto_rawDesc = "" +
	"\n" +
	"\x1fconfigpb/v2/approval_info.proto\x12\tconfig.v2\x1a!commonpb/v2/approval_status.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa4\x02\n" +
	"\fApprovalInfo\x12\x1a\n" +
	"\brequired\x18\x01 \x01(\bR\brequired\x121\n" +
	"\x06status\x18\x02 \x01(\x0e2\x19.common.v2.ApprovalStatusR\x06status\x12\x1f\n" +
	...
	"policyNameB\x9a\x01\n" +
	"\rcom.config.v2B\x11ApprovalInfoProtoP\x01Z)github.com/jdfalk/gcommon/pkg/configpb/v2\xa2\x02\x03CXX\xaa\x02\tConfig.V2\xca\x02\tConfig\\V2\xe2\x02\x15Config\\V2\\GPBMetadata\xea\x02\n" +
	"Config::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_configpb_v2_approval_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_configpb_v2_approval_info_proto_goTypes = []any{
	(*ApprovalInfo)(nil),          // 0: config.v2.ApprovalInfo
	(v2.ApprovalStatus)(0),        // 1: common.v2.ApprovalStatus
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_configpb_v2_approval_info_proto_depIdxs = []int32{
	1, // 0: config.v2.ApprovalInfo.status:type_name -> common.v2.ApprovalStatus
	2, // 1: config.v2.ApprovalInfo.approved_at:type_name -> google.protobuf.Timestamp
...
func init() { file_configpb_v2_approval_info_proto_init() }
func file_configpb_v2_approval_info_proto_init() {
	if File_configpb_v2_approval_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_configpb_v2_approval_info_proto_rawDesc), len(file_configpb_v2_approval_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_configpb_v2_approval_info_proto_goTypes,
		DependencyIndexes: file_configpb_v2_approval_info_proto_depIdxs,
		MessageInfos:      file_configpb_v2_approval_info_proto_msgTypes,
	}.Build()
	File_configpb_v2_approval_info_proto = out.File
	file_configpb_v2_approval_info_proto_goTypes = nil
	file_configpb_v2_approval_info_proto_depIdxs = nil
}
