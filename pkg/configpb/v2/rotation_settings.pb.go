...
// 	protoc        (unknown)
// source: configpb/v2/rotation_settings.proto
...
type RotationSettings struct {
	...
	xxx_hidden_Frequency              v2.RotationFrequency   `protobuf:"varint,2,opt,name=frequency,enum=common.v2.RotationFrequency"`
...
func (x *RotationSettings) Reset() {
	*x = RotationSettings{}
	mi := &file_configpb_v2_rotation_settings_proto_msgTypes[0]
...
func (x *RotationSettings) GetFrequency() v2.RotationFrequency {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			return x.xxx_hidden_Frequency
		}
	}
	return v2.RotationFrequency(0)
}
...
func (x *RotationSettings) SetFrequency(v v2.RotationFrequency) {
...
func (x *RotationSettings) ClearFrequency() {
	...
	x.xxx_hidden_Frequency = v2.RotationFrequency_ROTATION_FREQUENCY_UNSPECIFIED
}
...
type RotationSettings_builder struct {
	...
	Enabled *bool
	// Rotation frequency
	Frequency *v2.RotationFrequency
...
var File_configpb_v2_rotation_settings_proto protoreflect.FileDescriptor

const file_configpb_v2_rotation_settings_proto_rawDesc = "" +
	"\n" +
	"#configpb/v2/rotation_settings.proto\x12\tconfig.v2\x1a$commonpb/v2/rotation_frequency.proto\x1a configpb/v2/rotation_event.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa4\x04\n" +
	"\x10RotationSettings\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12:\n" +
	"\tfrequency\x18\x02 \x01(\x0e2\x1c.common.v2.RotationFrequencyR\tfrequency\x12#\n" +
	...
	" \x03(\v2\x18.config.v2.RotationEventB\b\xbaH\x05\x92\x01\x02\b\x01R\x0frotationHistoryB\x9e\x01\n" +
	"\rcom.config.v2B\x15RotationSettingsProtoP\x01Z)github.com/jdfalk/gcommon/pkg/configpb/v2\xa2\x02\x03CXX\xaa\x02\tConfig.V2\xca\x02\tConfig\\V2\xe2\x02\x15Config\\V2\\GPBMetadata\xea\x02\n" +
...
var file_configpb_v2_rotation_settings_proto_goTypes = []any{
	(*RotationSettings)(nil),      // 0: config.v2.RotationSettings
	(v2.RotationFrequency)(0),     // 1: common.v2.RotationFrequency
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*RotationEvent)(nil),         // 3: config.v2.RotationEvent
}
var file_configpb_v2_rotation_settings_proto_depIdxs = []int32{
	1, // 0: config.v2.RotationSettings.frequency:type_name -> common.v2.RotationFrequency
	2, // 1: config.v2.RotationSettings.last_rotated_at:type_name -> google.protobuf.Timestamp
	2, // 2: config.v2.RotationSettings.next_rotation_at:type_name -> google.protobuf.Timestamp
	3, // 3: config.v2.RotationSettings.rotation_history:type_name -> config.v2.RotationEvent
...
func init() { file_configpb_v2_rotation_settings_proto_init() }
func file_configpb_v2_rotation_settings_proto_init() {
	if File_configpb_v2_rotation_settings_proto != nil {
		return
	}
	file_configpb_v2_rotation_event_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_configpb_v2_rotation_settings_proto_rawDesc), len(file_configpb_v2_rotation_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_configpb_v2_rotation_settings_proto_goTypes,
		DependencyIndexes: file_configpb_v2_rotation_settings_proto_depIdxs,
		MessageInfos:      file_configpb_v2_rotation_settings_proto_msgTypes,
	}.Build()
	File_configpb_v2_rotation_settings_proto = out.File
	file_configpb_v2_rotation_settings_proto_goTypes = nil
	file_configpb_v2_rotation_settings_proto_depIdxs = nil
}
