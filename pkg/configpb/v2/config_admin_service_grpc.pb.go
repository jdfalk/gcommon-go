...
const (
	ConfigAdminService_BackupConfig_FullMethodName     = "/config.v2.ConfigAdminService/BackupConfig"
	ConfigAdminService_RestoreConfig_FullMethodName    = "/config.v2.ConfigAdminService/RestoreConfig"
	ConfigAdminService_ImportConfig_FullMethodName     = "/config.v2.ConfigAdminService/ImportConfig"
	ConfigAdminService_ExportConfig_FullMethodName     = "/config.v2.ConfigAdminService/ExportConfig"
	ConfigAdminService_ReloadConfig_FullMethodName     = "/config.v2.ConfigAdminService/ReloadConfig"
	ConfigAdminService_RollbackConfig_FullMethodName   = "/config.v2.ConfigAdminService/RollbackConfig"
	ConfigAdminService_SetConfigSchema_FullMethodName  = "/config.v2.ConfigAdminService/SetConfigSchema"
	ConfigAdminService_GetConfigHistory_FullMethodName = "/config.v2.ConfigAdminService/GetConfigHistory"
	ConfigAdminService_GetConfigStats_FullMethodName   = "/config.v2.ConfigAdminService/GetConfigStats"
	ConfigAdminService_HealthCheck_FullMethodName      = "/config.v2.ConfigAdminService/HealthCheck"
	ConfigAdminService_UnwatchConfig_FullMethodName    = "/config.v2.ConfigAdminService/UnwatchConfig"
)
...
var ConfigAdminService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "config.v2.ConfigAdminService",
	...
	Metadata: "configpb/v2/config_admin_service.proto",
}
