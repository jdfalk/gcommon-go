...
const (
	ConfigService_Get_FullMethodName         = "/config.v2.ConfigService/Get"
	ConfigService_Set_FullMethodName         = "/config.v2.ConfigService/Set"
	ConfigService_Delete_FullMethodName      = "/config.v2.ConfigService/Delete"
	ConfigService_List_FullMethodName        = "/config.v2.ConfigService/List"
	ConfigService_Watch_FullMethodName       = "/config.v2.ConfigService/Watch"
	ConfigService_GetMultiple_FullMethodName = "/config.v2.ConfigService/GetMultiple"
	ConfigService_SetMultiple_FullMethodName = "/config.v2.ConfigService/SetMultiple"
	ConfigService_Validate_FullMethodName    = "/config.v2.ConfigService/Validate"
	ConfigService_GetSchema_FullMethodName   = "/config.v2.ConfigService/GetSchema"
)
...
var ConfigService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "configpb/v2/config_service.proto",
}
