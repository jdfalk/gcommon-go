...
// 	protoc        (unknown)
// source: configpb/v2/batching_settings.proto
...
func (x *BatchingSettings) Reset() {
	*x = BatchingSettings{}
	mi := &file_configpb_v2_batching_settings_proto_msgTypes[0]
...
var File_configpb_v2_batching_settings_proto protoreflect.FileDescriptor

const file_configpb_v2_batching_settings_proto_rawDesc = "" +
	"\n" +
	"#configpb/v2/batching_settings.proto\x12\tconfig.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb2\x01\n" +
	...
	"\fgrouping_key\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\vgroupingKeyB\x9e\x01\n" +
	"\rcom.config.v2B\x15BatchingSettingsProtoP\x01Z)github.com/jdfalk/gcommon/pkg/configpb/v2\xa2\x02\x03CXX\xaa\x02\tConfig.V2\xca\x02\tConfig\\V2\xe2\x02\x15Config\\V2\\GPBMetadata\xea\x02\n" +
	"Config::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_configpb_v2_batching_settings_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_configpb_v2_batching_settings_proto_goTypes = []any{
	(*BatchingSettings)(nil), // 0: config.v2.BatchingSettings
}
var file_configpb_v2_batching_settings_proto_depIdxs = []int32{
...
func init() { file_configpb_v2_batching_settings_proto_init() }
func file_configpb_v2_batching_settings_proto_init() {
	if File_configpb_v2_batching_settings_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_configpb_v2_batching_settings_proto_rawDesc), len(file_configpb_v2_batching_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_configpb_v2_batching_settings_proto_goTypes,
		DependencyIndexes: file_configpb_v2_batching_settings_proto_depIdxs,
		MessageInfos:      file_configpb_v2_batching_settings_proto_msgTypes,
	}.Build()
	File_configpb_v2_batching_settings_proto = out.File
	file_configpb_v2_batching_settings_proto_goTypes = nil
	file_configpb_v2_batching_settings_proto_depIdxs = nil
}
