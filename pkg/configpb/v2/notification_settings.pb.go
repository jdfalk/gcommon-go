...
// 	protoc        (unknown)
// source: configpb/v2/notification_settings.proto
...
type ConfigNotificationSettings struct {
	...
	xxx_hidden_Triggers     []v2.NotificationTrigger      `protobuf:"varint,3,rep,packed,name=triggers,enum=common.v2.NotificationTrigger"`
...
func (x *ConfigNotificationSettings) Reset() {
	*x = ConfigNotificationSettings{}
	mi := &file_configpb_v2_notification_settings_proto_msgTypes[0]
...
func (x *ConfigNotificationSettings) GetTriggers() []v2.NotificationTrigger {
	if x != nil {
...
func (x *ConfigNotificationSettings) SetTriggers(v []v2.NotificationTrigger) {
...
type ConfigNotificationSettings_builder struct {
	...
	Triggers []v2.NotificationTrigger
...
var File_configpb_v2_notification_settings_proto protoreflect.FileDescriptor

const file_configpb_v2_notification_settings_proto_rawDesc = "" +
	"\n" +
	"'configpb/v2/notification_settings.proto\x12\tconfig.v2\x1a&commonpb/v2/notification_trigger.proto\x1a#configpb/v2/batching_settings.proto\x1a&configpb/v2/notification_channel.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xfe\x02\n" +
	"\x1aConfigNotificationSettings\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12J\n" +
	"\bchannels\x18\x02 \x03(\v2$.config.v2.ConfigNotificationChannelB\b\xbaH\x05\x92\x01\x02\b\x01R\bchannels\x12D\n" +
	"\btriggers\x18\x03 \x03(\x0e2\x1e.common.v2.NotificationTriggerB\b\xbaH\x05\x92\x01\x02\b\x01R\btriggers\x12#\n" +
	...
	"\bbatching\x18\a \x01(\v2\x1b.config.v2.BatchingSettingsR\bbatchingB\xa2\x01\n" +
	"\rcom.config.v2B\x19NotificationSettingsProtoP\x01Z)github.com/jdfalk/gcommon/pkg/configpb/v2\xa2\x02\x03CXX\xaa\x02\tConfig.V2\xca\x02\tConfig\\V2\xe2\x02\x15Config\\V2\\GPBMetadata\xea\x02\n" +
	"Config::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_configpb_v2_notification_settings_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_configpb_v2_notification_settings_proto_goTypes = []any{
	(*ConfigNotificationSettings)(nil), // 0: config.v2.ConfigNotificationSettings
	(*ConfigNotificationChannel)(nil),  // 1: config.v2.ConfigNotificationChannel
	(v2.NotificationTrigger)(0),        // 2: common.v2.NotificationTrigger
	(*BatchingSettings)(nil),           // 3: config.v2.BatchingSettings
}
var file_configpb_v2_notification_settings_proto_depIdxs = []int32{
	1, // 0: config.v2.ConfigNotificationSettings.channels:type_name -> config.v2.ConfigNotificationChannel
	2, // 1: config.v2.ConfigNotificationSettings.triggers:type_name -> common.v2.NotificationTrigger
	3, // 2: config.v2.ConfigNotificationSettings.batching:type_name -> config.v2.BatchingSettings
...
func init() { file_configpb_v2_notification_settings_proto_init() }
func file_configpb_v2_notification_settings_proto_init() {
	if File_configpb_v2_notification_settings_proto != nil {
		return
	}
	file_configpb_v2_batching_settings_proto_init()
	file_configpb_v2_notification_channel_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_configpb_v2_notification_settings_proto_rawDesc), len(file_configpb_v2_notification_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_configpb_v2_notification_settings_proto_goTypes,
		DependencyIndexes: file_configpb_v2_notification_settings_proto_depIdxs,
		MessageInfos:      file_configpb_v2_notification_settings_proto_msgTypes,
	}.Build()
	File_configpb_v2_notification_settings_proto = out.File
	file_configpb_v2_notification_settings_proto_goTypes = nil
	file_configpb_v2_notification_settings_proto_depIdxs = nil
}
