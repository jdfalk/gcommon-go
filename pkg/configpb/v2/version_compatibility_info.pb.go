...
// 	protoc        (unknown)
// source: configpb/v2/version_compatibility_info.proto
...
func (x *VersionCompatibilityInfo) Reset() {
	*x = VersionCompatibilityInfo{}
	mi := &file_configpb_v2_version_compatibility_info_proto_msgTypes[0]
...
var File_configpb_v2_version_compatibility_info_proto protoreflect.FileDescriptor

const file_configpb_v2_version_compatibility_info_proto_rawDesc = "" +
	"\n" +
	",configpb/v2/version_compatibility_info.proto\x12\tconfig.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xaf\x03\n" +
	"\x18VersionCompatibilityInfo\x12/\n" +
	"\x13backward_compatible\x18\x01 \x01(\bR\x12backwardCompatible\x12-\n" +
	"\x12forward_compatible\x18\x02 \x01(\bR\x11forwardCompatible\x123\n" +
	"\x10breaking_changes\x18\x03 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x0fbreakingChanges\x12\x1d\n" +
	"\x05notes\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x05notes\x128\n" +
	"\vmin_version\x18\x05 \x01(\tB\x17\xbaH\x14r\x122\x10^v?\\d+\\.\\d+\\.\\d+R\n" +
	"minVersion\x128\n" +
	...
	"\x0fmigration_guide\x18\b \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x0emigrationGuideB\xa6\x01\n" +
	"\rcom.config.v2B\x1dVersionCompatibilityInfoProtoP\x01Z)github.com/jdfalk/gcommon/pkg/configpb/v2\xa2\x02\x03CXX\xaa\x02\tConfig.V2\xca\x02\tConfig\\V2\xe2\x02\x15Config\\V2\\GPBMetadata\xea\x02\n" +
...
var file_configpb_v2_version_compatibility_info_proto_goTypes = []any{
	(*VersionCompatibilityInfo)(nil), // 0: config.v2.VersionCompatibilityInfo
}
var file_configpb_v2_version_compatibility_info_proto_depIdxs = []int32{
...
func init() { file_configpb_v2_version_compatibility_info_proto_init() }
func file_configpb_v2_version_compatibility_info_proto_init() {
	if File_configpb_v2_version_compatibility_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_configpb_v2_version_compatibility_info_proto_rawDesc), len(file_configpb_v2_version_compatibility_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_configpb_v2_version_compatibility_info_proto_goTypes,
		DependencyIndexes: file_configpb_v2_version_compatibility_info_proto_depIdxs,
		MessageInfos:      file_configpb_v2_version_compatibility_info_proto_msgTypes,
	}.Build()
	File_configpb_v2_version_compatibility_info_proto = out.File
	file_configpb_v2_version_compatibility_info_proto_goTypes = nil
	file_configpb_v2_version_compatibility_info_proto_depIdxs = nil
}
