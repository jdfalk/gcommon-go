...
// 	protoc        (unknown)
// source: configpb/v1/config_watch_event.proto
...
func (x *ConfigWatchEvent) Reset() {
	*x = ConfigWatchEvent{}
	mi := &file_configpb_v1_config_watch_event_proto_msgTypes[0]
...
var File_configpb_v1_config_watch_event_proto protoreflect.FileDescriptor

const file_configpb_v1_config_watch_event_proto_rawDesc = "" +
	"\n" +
	"$configpb/v1/config_watch_event.proto\x12\tconfig.v1\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xc6\x03\n" +
	...
	"\bmetadata\x18\b \x03(\v2).config.v1.ConfigWatchEvent.MetadataEntryR\bmetadata\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x9b\x01\n" +
	"\rcom.config.v1B\x15ConfigWatchEventProtoP\x01Z&github.com/jdfalk/gcommon/pkg/configpb\xa2\x02\x03CXX\xaa\x02\tConfig.V1\xca\x02\tConfig\\V1\xe2\x02\x15Config\\V1\\GPBMetadata\xea\x02\n" +
	"Config::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_configpb_v1_config_watch_event_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_configpb_v1_config_watch_event_proto_goTypes = []any{
	(*ConfigWatchEvent)(nil),      // 0: config.v1.ConfigWatchEvent
	nil,                           // 1: config.v1.ConfigWatchEvent.MetadataEntry
	(*anypb.Any)(nil),             // 2: google.protobuf.Any
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_configpb_v1_config_watch_event_proto_depIdxs = []int32{
	2, // 0: config.v1.ConfigWatchEvent.old_value:type_name -> google.protobuf.Any
	2, // 1: config.v1.ConfigWatchEvent.new_value:type_name -> google.protobuf.Any
	3, // 2: config.v1.ConfigWatchEvent.timestamp:type_name -> google.protobuf.Timestamp
	1, // 3: config.v1.ConfigWatchEvent.metadata:type_name -> config.v1.ConfigWatchEvent.MetadataEntry
...
func init() { file_configpb_v1_config_watch_event_proto_init() }
func file_configpb_v1_config_watch_event_proto_init() {
	if File_configpb_v1_config_watch_event_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_configpb_v1_config_watch_event_proto_rawDesc), len(file_configpb_v1_config_watch_event_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_configpb_v1_config_watch_event_proto_goTypes,
		DependencyIndexes: file_configpb_v1_config_watch_event_proto_depIdxs,
		MessageInfos:      file_configpb_v1_config_watch_event_proto_msgTypes,
	}.Build()
	File_configpb_v1_config_watch_event_proto = out.File
	file_configpb_v1_config_watch_event_proto_goTypes = nil
	file_configpb_v1_config_watch_event_proto_depIdxs = nil
}
