...
// 	protoc        (unknown)
// source: webpb/v2/websocket_message.proto
...
func (x *WebsocketMessage) Reset() {
	*x = WebsocketMessage{}
	mi := &file_webpb_v2_websocket_message_proto_msgTypes[0]
...
var File_webpb_v2_websocket_message_proto protoreflect.FileDescriptor

const file_webpb_v2_websocket_message_proto_rawDesc = "" +
	"\n" +
	" webpb/v2/websocket_message.proto\x12\x06web.v2\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xb5\x01\n" +
	"\x10WebsocketMessage\x12,\n" +
	"\rconnection_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\fconnectionId\x12\x12\n" +
	"\x04data\x18\x02 \x01(\fR\x04data\x12*\n" +
	"\fmessage_type\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\vmessageType\x123\n" +
	"\asent_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x06sentAtB\x8c\x01\n" +
	"\n" +
	"com.web.v2B\x15WebsocketMessageProtoP\x01Z&github.com/jdfalk/gcommon/pkg/webpb/v2\xa2\x02\x03WXX\xaa\x02\x06Web.V2\xca\x02\x06Web\\V2\xe2\x02\x12Web\\V2\\GPBMetadata\xea\x02\aWeb::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_webpb_v2_websocket_message_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_webpb_v2_websocket_message_proto_goTypes = []any{
	(*WebsocketMessage)(nil),      // 0: web.v2.WebsocketMessage
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_webpb_v2_websocket_message_proto_depIdxs = []int32{
	1, // 0: web.v2.WebsocketMessage.sent_at:type_name -> google.protobuf.Timestamp
...
func init() { file_webpb_v2_websocket_message_proto_init() }
func file_webpb_v2_websocket_message_proto_init() {
	if File_webpb_v2_websocket_message_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_webpb_v2_websocket_message_proto_rawDesc), len(file_webpb_v2_websocket_message_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_webpb_v2_websocket_message_proto_goTypes,
		DependencyIndexes: file_webpb_v2_websocket_message_proto_depIdxs,
		MessageInfos:      file_webpb_v2_websocket_message_proto_msgTypes,
	}.Build()
	File_webpb_v2_websocket_message_proto = out.File
	file_webpb_v2_websocket_message_proto_goTypes = nil
	file_webpb_v2_websocket_message_proto_depIdxs = nil
}
