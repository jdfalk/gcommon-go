...
// 	protoc        (unknown)
// source: webpb/v2/file_upload.proto
...
func (x *FileUpload) Reset() {
	*x = FileUpload{}
	mi := &file_webpb_v2_file_upload_proto_msgTypes[0]
...
var File_webpb_v2_file_upload_proto protoreflect.FileDescriptor

const file_webpb_v2_file_upload_proto_rawDesc = "" +
	"\n" +
	"\x1awebpb/v2/file_upload.proto\x12\x06web.v2\x1a\x18webpb/v2/mime_type.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9f\x01\n" +
	"\n" +
	"FileUpload\x12&\n" +
	...
	"\vdestination\x18\x04 \x01(\tR\vdestinationB\x86\x01\n" +
	"\n" +
	"com.web.v2B\x0fFileUploadProtoP\x01Z&github.com/jdfalk/gcommon/pkg/webpb/v2\xa2\x02\x03WXX\xaa\x02\x06Web.V2\xca\x02\x06Web\\V2\xe2\x02\x12Web\\V2\\GPBMetadata\xea\x02\aWeb::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_webpb_v2_file_upload_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_webpb_v2_file_upload_proto_goTypes = []any{
	(*FileUpload)(nil), // 0: web.v2.FileUpload
	(*MimeType)(nil),   // 1: web.v2.MimeType
}
var file_webpb_v2_file_upload_proto_depIdxs = []int32{
	1, // 0: web.v2.FileUpload.content_type:type_name -> web.v2.MimeType
...
func init() { file_webpb_v2_file_upload_proto_init() }
func file_webpb_v2_file_upload_proto_init() {
	if File_webpb_v2_file_upload_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_webpb_v2_file_upload_proto_rawDesc), len(file_webpb_v2_file_upload_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_webpb_v2_file_upload_proto_goTypes,
		DependencyIndexes: file_webpb_v2_file_upload_proto_depIdxs,
		MessageInfos:      file_webpb_v2_file_upload_proto_msgTypes,
	}.Build()
	File_webpb_v2_file_upload_proto = out.File
	file_webpb_v2_file_upload_proto_goTypes = nil
	file_webpb_v2_file_upload_proto_depIdxs = nil
}
