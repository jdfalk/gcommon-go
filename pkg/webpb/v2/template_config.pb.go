...
// 	protoc        (unknown)
// source: webpb/v2/template_config.proto
...
func (x *TemplateConfig) Reset() {
	*x = TemplateConfig{}
	mi := &file_webpb_v2_template_config_proto_msgTypes[0]
...
var File_webpb_v2_template_config_proto protoreflect.FileDescriptor

const file_webpb_v2_template_config_proto_rawDesc = "" +
	"\n" +
	"\x1ewebpb/v2/template_config.proto\x12\x06web.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9e\x01\n" +
	"\x0eTemplateConfig\x12%\n" +
	"\tdirectory\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\tdirectory\x12%\n" +
	"\textension\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\textension\x12\x16\n" +
	"\x06reload\x18\x03 \x01(\bR\x06reload\x12&\n" +
	"\tfunctions\x18\x04 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\tfunctionsB\x8a\x01\n" +
	"\n" +
	"com.web.v2B\x13TemplateConfigProtoP\x01Z&github.com/jdfalk/gcommon/pkg/webpb/v2\xa2\x02\x03WXX\xaa\x02\x06Web.V2\xca\x02\x06Web\\V2\xe2\x02\x12Web\\V2\\GPBMetadata\xea\x02\aWeb::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_webpb_v2_template_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_webpb_v2_template_config_proto_goTypes = []any{
	(*TemplateConfig)(nil), // 0: web.v2.TemplateConfig
}
var file_webpb_v2_template_config_proto_depIdxs = []int32{
...
func init() { file_webpb_v2_template_config_proto_init() }
func file_webpb_v2_template_config_proto_init() {
	if File_webpb_v2_template_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_webpb_v2_template_config_proto_rawDesc), len(file_webpb_v2_template_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_webpb_v2_template_config_proto_goTypes,
		DependencyIndexes: file_webpb_v2_template_config_proto_depIdxs,
		MessageInfos:      file_webpb_v2_template_config_proto_msgTypes,
	}.Build()
	File_webpb_v2_template_config_proto = out.File
	file_webpb_v2_template_config_proto_goTypes = nil
	file_webpb_v2_template_config_proto_depIdxs = nil
}
