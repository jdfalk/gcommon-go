...
// 	protoc        (unknown)
// source: webpb/v2/cookie_data.proto
...
type CookieData struct {
	...
	xxx_hidden_SameSite    v2.CookieSameSite      `protobuf:"varint,8,opt,name=same_site,json=sameSite,enum=common.v2.CookieSameSite"`
...
func (x *CookieData) Reset() {
	*x = CookieData{}
	mi := &file_webpb_v2_cookie_data_proto_msgTypes[0]
...
func (x *CookieData) GetSameSite() v2.CookieSameSite {
	if x != nil {
...
func (x *CookieData) SetSameSite(v v2.CookieSameSite) {
...
var File_webpb_v2_cookie_data_proto protoreflect.FileDescriptor

const file_webpb_v2_cookie_data_proto_rawDesc = "" +
	"\n" +
	"\x1awebpb/v2/cookie_data.proto\x12\x06web.v2\x1a\"commonpb/v2/cookie_same_site.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x95\x02\n" +
	"\n" +
	"CookieData\x12\x1d\n" +
	...
	"\tsame_site\x18\b \x01(\x0e2\x19.common.v2.CookieSameSiteR\bsameSiteB\x86\x01\n" +
	"\n" +
	"com.web.v2B\x0fCookieDataProtoP\x01Z&github.com/jdfalk/gcommon/pkg/webpb/v2\xa2\x02\x03WXX\xaa\x02\x06Web.V2\xca\x02\x06Web\\V2\xe2\x02\x12Web\\V2\\GPBMetadata\xea\x02\aWeb::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_webpb_v2_cookie_data_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_webpb_v2_cookie_data_proto_goTypes = []any{
	(*CookieData)(nil),            // 0: web.v2.CookieData
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
	(v2.CookieSameSite)(0),        // 2: common.v2.CookieSameSite
}
var file_webpb_v2_cookie_data_proto_depIdxs = []int32{
	1, // 0: web.v2.CookieData.expires_at:type_name -> google.protobuf.Timestamp
	2, // 1: web.v2.CookieData.same_site:type_name -> common.v2.CookieSameSite
...
func init() { file_webpb_v2_cookie_data_proto_init() }
func file_webpb_v2_cookie_data_proto_init() {
	if File_webpb_v2_cookie_data_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_webpb_v2_cookie_data_proto_rawDesc), len(file_webpb_v2_cookie_data_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_webpb_v2_cookie_data_proto_goTypes,
		DependencyIndexes: file_webpb_v2_cookie_data_proto_depIdxs,
		MessageInfos:      file_webpb_v2_cookie_data_proto_msgTypes,
	}.Build()
	File_webpb_v2_cookie_data_proto = out.File
	file_webpb_v2_cookie_data_proto_goTypes = nil
	file_webpb_v2_cookie_data_proto_depIdxs = nil
}
