...
// 	protoc        (unknown)
// source: webpb/v2/template_data.proto
...
func (x *TemplateData) Reset() {
	*x = TemplateData{}
	mi := &file_webpb_v2_template_data_proto_msgTypes[0]
...
var File_webpb_v2_template_data_proto protoreflect.FileDescriptor

const file_webpb_v2_template_data_proto_rawDesc = "" +
	"\n" +
	"\x1cwebpb/v2/template_data.proto\x12\x06web.v2\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xbf\x01\n" +
	...
	"compiledAtB\x88\x01\n" +
	"\n" +
	"com.web.v2B\x11TemplateDataProtoP\x01Z&github.com/jdfalk/gcommon/pkg/webpb/v2\xa2\x02\x03WXX\xaa\x02\x06Web.V2\xca\x02\x06Web\\V2\xe2\x02\x12Web\\V2\\GPBMetadata\xea\x02\aWeb::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_webpb_v2_template_data_proto_goTypes = []any{
	(*TemplateData)(nil),          // 0: web.v2.TemplateData
	(*anypb.Any)(nil),             // 1: google.protobuf.Any
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_webpb_v2_template_data_proto_depIdxs = []int32{
	1, // 0: web.v2.TemplateData.context:type_name -> google.protobuf.Any
	2, // 1: web.v2.TemplateData.compiled_at:type_name -> google.protobuf.Timestamp
...
func init() { file_webpb_v2_template_data_proto_init() }
func file_webpb_v2_template_data_proto_init() {
	if File_webpb_v2_template_data_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_webpb_v2_template_data_proto_rawDesc), len(file_webpb_v2_template_data_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_webpb_v2_template_data_proto_goTypes,
		DependencyIndexes: file_webpb_v2_template_data_proto_depIdxs,
		MessageInfos:      file_webpb_v2_template_data_proto_msgTypes,
	}.Build()
	File_webpb_v2_template_data_proto = out.File
	file_webpb_v2_template_data_proto_goTypes = nil
	file_webpb_v2_template_data_proto_depIdxs = nil
}
