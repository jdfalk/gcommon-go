...
// 	protoc        (unknown)
// source: webpb/v2/http_request.proto
...
type HttpRequest struct {
	...
	xxx_hidden_Metadata        *v2.RequestMetadata    `protobuf:"bytes,11,opt,name=metadata"`
...
func (x *HttpRequest) Reset() {
	*x = HttpRequest{}
	mi := &file_webpb_v2_http_request_proto_msgTypes[0]
...
func (x *HttpRequest) GetMetadata() *v2.RequestMetadata {
	if x != nil {
...
func (x *HttpRequest) SetMetadata(v *v2.RequestMetadata) {
...
type HttpRequest_builder struct {
	...
	// Example: "https://api.example.com/v2/users?limit=10"
	Url *string
	// *
...
var File_webpb_v2_http_request_proto protoreflect.FileDescriptor

const file_webpb_v2_http_request_proto_rawDesc = "" +
	"\n" +
	"\x1bwebpb/v2/http_request.proto\x12\x06web.v2\x1a\"commonpb/v2/request_metadata.proto\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xdc\n" +
	"\n" +
	"\vHttpRequest\x12\x16\n" +
	"\x06method\x18\x01 \x01(\tR\x06method\x12\x10\n" +
	"\x03url\x18\x02 \x01(\tR\x03url\x12)\n" +
	"\x10protocol_version\x18\x03 \x01(\tR\x0fprotocolVersion\x126\n" +
	"\bmetadata\x18\v \x01(\v2\x1a.common.v2.RequestMetadataR\bmetadata\x12:\n" +
	"\aheaders\x18\f \x03(\v2 .web.v2.HttpRequest.HeadersEntryR\aheaders\x12(\n" +
	"\x04body\x18\r \x01(\v2\x14.google.protobuf.AnyR\x04body\x12G\n" +
	"\fquery_params\x18\x0e \x03(\v2$.web.v2.HttpRequest.QueryParamsEntryR\vqueryParams\x12D\n" +
	"\vpath_params\x18\x0f \x03(\v2#.web.v2.HttpRequest.PathParamsEntryR\n" +
	"pathParams\x12:\n" +
	"\acookies\x18\x10 \x03(\v2 .web.v2.HttpRequest.CookiesEntryR\acookies\x12\x1b\n" +
	...
	"receivedAt\x12A\n" +
	"\n" +
	"created_at\x184 \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\tcreatedAt\x1a:\n" +
	...
	"\n" +
	"com.web.v2B\x10HttpRequestProtoP\x01Z&github.com/jdfalk/gcommon/pkg/webpb/v2\xa2\x02\x03WXX\xaa\x02\x06Web.V2\xca\x02\x06Web\\V2\xe2\x02\x12Web\\V2\\GPBMetadata\xea\x02\aWeb::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_webpb_v2_http_request_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_webpb_v2_http_request_proto_goTypes = []any{
	(*HttpRequest)(nil),           // 0: web.v2.HttpRequest
	nil,                           // 1: web.v2.HttpRequest.HeadersEntry
	nil,                           // 2: web.v2.HttpRequest.QueryParamsEntry
	nil,                           // 3: web.v2.HttpRequest.PathParamsEntry
	nil,                           // 4: web.v2.HttpRequest.CookiesEntry
	(*v2.RequestMetadata)(nil),    // 5: common.v2.RequestMetadata
	(*anypb.Any)(nil),             // 6: google.protobuf.Any
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
}
var file_webpb_v2_http_request_proto_depIdxs = []int32{
	5, // 0: web.v2.HttpRequest.metadata:type_name -> common.v2.RequestMetadata
	1, // 1: web.v2.HttpRequest.headers:type_name -> web.v2.HttpRequest.HeadersEntry
	6, // 2: web.v2.HttpRequest.body:type_name -> google.protobuf.Any
	2, // 3: web.v2.HttpRequest.query_params:type_name -> web.v2.HttpRequest.QueryParamsEntry
	3, // 4: web.v2.HttpRequest.path_params:type_name -> web.v2.HttpRequest.PathParamsEntry
	4, // 5: web.v2.HttpRequest.cookies:type_name -> web.v2.HttpRequest.CookiesEntry
	7, // 6: web.v2.HttpRequest.received_at:type_name -> google.protobuf.Timestamp
	7, // 7: web.v2.HttpRequest.created_at:type_name -> google.protobuf.Timestamp
...
func init() { file_webpb_v2_http_request_proto_init() }
func file_webpb_v2_http_request_proto_init() {
	if File_webpb_v2_http_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_webpb_v2_http_request_proto_rawDesc), len(file_webpb_v2_http_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_webpb_v2_http_request_proto_goTypes,
		DependencyIndexes: file_webpb_v2_http_request_proto_depIdxs,
		MessageInfos:      file_webpb_v2_http_request_proto_msgTypes,
	}.Build()
	File_webpb_v2_http_request_proto = out.File
	file_webpb_v2_http_request_proto_goTypes = nil
	file_webpb_v2_http_request_proto_depIdxs = nil
}
