...
// 	protoc        (unknown)
// source: webpb/v2/rate_limit_config.proto
...
type WebRateLimitConfig struct {
	...
	xxx_hidden_Strategy          v2.RateLimitStrategy   `protobuf:"varint,4,opt,name=strategy,enum=common.v2.RateLimitStrategy"`
...
func (x *WebRateLimitConfig) Reset() {
	*x = WebRateLimitConfig{}
	mi := &file_webpb_v2_rate_limit_config_proto_msgTypes[0]
...
func (x *WebRateLimitConfig) GetStrategy() v2.RateLimitStrategy {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 3) {
			return x.xxx_hidden_Strategy
		}
	}
	return v2.RateLimitStrategy(0)
}
...
func (x *WebRateLimitConfig) SetStrategy(v v2.RateLimitStrategy) {
...
func (x *WebRateLimitConfig) ClearStrategy() {
	...
	x.xxx_hidden_Strategy = v2.RateLimitStrategy_RATE_LIMIT_STRATEGY_UNSPECIFIED
}
...
var File_webpb_v2_rate_limit_config_proto protoreflect.FileDescriptor

const file_webpb_v2_rate_limit_config_proto_rawDesc = "" +
	"\n" +
	" webpb/v2/rate_limit_config.proto\x12\x06web.v2\x1a%commonpb/v2/rate_limit_strategy.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xaa\x02\n" +
	...
	"\bstrategy\x18\x04 \x01(\x0e2\x1c.common.v2.RateLimitStrategyR\bstrategy\x12,\n" +
	"\rkey_extractor\x18\x05 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\fkeyExtractor\x121\n" +
	"\x0fskip_conditions\x18\x06 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x0eskipConditionsB\x8b\x01\n" +
	"\n" +
	"com.web.v2B\x14RateLimitConfigProtoP\x01Z&github.com/jdfalk/gcommon/pkg/webpb/v2\xa2\x02\x03WXX\xaa\x02\x06Web.V2\xca\x02\x06Web\\V2\xe2\x02\x12Web\\V2\\GPBMetadata\xea\x02\aWeb::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_webpb_v2_rate_limit_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_webpb_v2_rate_limit_config_proto_goTypes = []any{
	(*WebRateLimitConfig)(nil), // 0: web.v2.WebRateLimitConfig
	(v2.RateLimitStrategy)(0),  // 1: common.v2.RateLimitStrategy
}
var file_webpb_v2_rate_limit_config_proto_depIdxs = []int32{
	1, // 0: web.v2.WebRateLimitConfig.strategy:type_name -> common.v2.RateLimitStrategy
...
func init() { file_webpb_v2_rate_limit_config_proto_init() }
func file_webpb_v2_rate_limit_config_proto_init() {
	if File_webpb_v2_rate_limit_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_webpb_v2_rate_limit_config_proto_rawDesc), len(file_webpb_v2_rate_limit_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_webpb_v2_rate_limit_config_proto_goTypes,
		DependencyIndexes: file_webpb_v2_rate_limit_config_proto_depIdxs,
		MessageInfos:      file_webpb_v2_rate_limit_config_proto_msgTypes,
	}.Build()
	File_webpb_v2_rate_limit_config_proto = out.File
	file_webpb_v2_rate_limit_config_proto_goTypes = nil
	file_webpb_v2_rate_limit_config_proto_depIdxs = nil
}
