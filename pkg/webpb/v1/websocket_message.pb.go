...
// 	protoc        (unknown)
// source: webpb/v1/websocket_message.proto
...
func (x *WebsocketMessage) Reset() {
	*x = WebsocketMessage{}
	mi := &file_webpb_v1_websocket_message_proto_msgTypes[0]
...
var File_webpb_v1_websocket_message_proto protoreflect.FileDescriptor

const file_webpb_v1_websocket_message_proto_rawDesc = "" +
	"\n" +
	" webpb/v1/websocket_message.proto\x12\x06web.v1\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xb5\x01\n" +
	...
	"\asent_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x06sentAtB\x89\x01\n" +
	"\n" +
	"com.web.v1B\x15WebsocketMessageProtoP\x01Z#github.com/jdfalk/gcommon/pkg/webpb\xa2\x02\x03WXX\xaa\x02\x06Web.V1\xca\x02\x06Web\\V1\xe2\x02\x12Web\\V1\\GPBMetadata\xea\x02\aWeb::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_webpb_v1_websocket_message_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_webpb_v1_websocket_message_proto_goTypes = []any{
	(*WebsocketMessage)(nil),      // 0: web.v1.WebsocketMessage
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_webpb_v1_websocket_message_proto_depIdxs = []int32{
	1, // 0: web.v1.WebsocketMessage.sent_at:type_name -> google.protobuf.Timestamp
...
func init() { file_webpb_v1_websocket_message_proto_init() }
func file_webpb_v1_websocket_message_proto_init() {
	if File_webpb_v1_websocket_message_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_webpb_v1_websocket_message_proto_rawDesc), len(file_webpb_v1_websocket_message_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_webpb_v1_websocket_message_proto_goTypes,
		DependencyIndexes: file_webpb_v1_websocket_message_proto_depIdxs,
		MessageInfos:      file_webpb_v1_websocket_message_proto_msgTypes,
	}.Build()
	File_webpb_v1_websocket_message_proto = out.File
	file_webpb_v1_websocket_message_proto_goTypes = nil
	file_webpb_v1_websocket_message_proto_depIdxs = nil
}
