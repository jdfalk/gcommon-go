...
// 	protoc        (unknown)
// source: webpb/v1/http_response.proto
...
func (x *HttpResponse) Reset() {
	*x = HttpResponse{}
	mi := &file_webpb_v1_http_response_proto_msgTypes[0]
...
func (x *HttpResponse) GetRequestMetadata() *commonpb.RequestMetadata {
	if x != nil {
...
func (x *HttpResponse) GetError() *commonpb.Error {
	if x != nil {
...
func (x *HttpResponse) SetRequestMetadata(v *commonpb.RequestMetadata) {
...
func (x *HttpResponse) SetError(v *commonpb.Error) {
...
var File_webpb_v1_http_response_proto protoreflect.FileDescriptor

const file_webpb_v1_http_response_proto_rawDesc = "" +
	"\n" +
	"\x1cwebpb/v1/http_response.proto\x12\x06web.v1\x1a\x17commonpb/v1/error.proto\x1a\"commonpb/v1/request_metadata.proto\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xcd\v\n" +
	...
	"\aheaders\x18\f \x03(\v2!.web.v1.HttpResponse.HeadersEntryR\aheaders\x12(\n" +
	"\x04body\x18\r \x01(\v2\x14.google.protobuf.AnyR\x04body\x12;\n" +
	"\acookies\x18\x0e \x03(\v2!.web.v1.HttpResponse.CookiesEntryR\acookies\x12%\n" +
	...
	"\n" +
	"com.web.v1B\x11HttpResponseProtoP\x01Z#github.com/jdfalk/gcommon/pkg/webpb\xa2\x02\x03WXX\xaa\x02\x06Web.V1\xca\x02\x06Web\\V1\xe2\x02\x12Web\\V1\\GPBMetadata\xea\x02\aWeb::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_webpb_v1_http_response_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_webpb_v1_http_response_proto_goTypes = []any{
	...
	(*commonpb.Error)(nil),           // 5: common.v1.Error
	(*timestamppb.Timestamp)(nil),    // 6: google.protobuf.Timestamp
}
var file_webpb_v1_http_response_proto_depIdxs = []int32{
	3, // 0: web.v1.HttpResponse.request_metadata:type_name -> common.v1.RequestMetadata
	1, // 1: web.v1.HttpResponse.headers:type_name -> web.v1.HttpResponse.HeadersEntry
	4, // 2: web.v1.HttpResponse.body:type_name -> google.protobuf.Any
	2, // 3: web.v1.HttpResponse.cookies:type_name -> web.v1.HttpResponse.CookiesEntry
	5, // 4: web.v1.HttpResponse.error:type_name -> common.v1.Error
	6, // 5: web.v1.HttpResponse.processing_started_at:type_name -> google.protobuf.Timestamp
	6, // 6: web.v1.HttpResponse.generated_at:type_name -> google.protobuf.Timestamp
	6, // 7: web.v1.HttpResponse.sent_at:type_name -> google.protobuf.Timestamp
...
func init() { file_webpb_v1_http_response_proto_init() }
func file_webpb_v1_http_response_proto_init() {
	if File_webpb_v1_http_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_webpb_v1_http_response_proto_rawDesc), len(file_webpb_v1_http_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_webpb_v1_http_response_proto_goTypes,
		DependencyIndexes: file_webpb_v1_http_response_proto_depIdxs,
		MessageInfos:      file_webpb_v1_http_response_proto_msgTypes,
	}.Build()
	File_webpb_v1_http_response_proto = out.File
	file_webpb_v1_http_response_proto_goTypes = nil
	file_webpb_v1_http_response_proto_depIdxs = nil
}
