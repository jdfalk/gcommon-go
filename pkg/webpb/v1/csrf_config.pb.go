...
// 	protoc        (unknown)
// source: webpb/v1/csrf_config.proto
...
func (x *CsrfConfig) Reset() {
	*x = CsrfConfig{}
	mi := &file_webpb_v1_csrf_config_proto_msgTypes[0]
...
var File_webpb_v1_csrf_config_proto protoreflect.FileDescriptor

const file_webpb_v1_csrf_config_proto_rawDesc = "" +
	"\n" +
	"\x1awebpb/v1/csrf_config.proto\x12\x06web.v1\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd7\x01\n" +
	"\n" +
	"CsrfConfig\x12*\n" +
	...
	"\x06secure\x18\x05 \x01(\bR\x06secureB\x83\x01\n" +
	"\n" +
	"com.web.v1B\x0fCsrfConfigProtoP\x01Z#github.com/jdfalk/gcommon/pkg/webpb\xa2\x02\x03WXX\xaa\x02\x06Web.V1\xca\x02\x06Web\\V1\xe2\x02\x12Web\\V1\\GPBMetadata\xea\x02\aWeb::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_webpb_v1_csrf_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_webpb_v1_csrf_config_proto_goTypes = []any{
	(*CsrfConfig)(nil),          // 0: web.v1.CsrfConfig
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_webpb_v1_csrf_config_proto_depIdxs = []int32{
	1, // 0: web.v1.CsrfConfig.token_ttl:type_name -> google.protobuf.Duration
...
func init() { file_webpb_v1_csrf_config_proto_init() }
func file_webpb_v1_csrf_config_proto_init() {
	if File_webpb_v1_csrf_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_webpb_v1_csrf_config_proto_rawDesc), len(file_webpb_v1_csrf_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_webpb_v1_csrf_config_proto_goTypes,
		DependencyIndexes: file_webpb_v1_csrf_config_proto_depIdxs,
		MessageInfos:      file_webpb_v1_csrf_config_proto_msgTypes,
	}.Build()
	File_webpb_v1_csrf_config_proto = out.File
	file_webpb_v1_csrf_config_proto_goTypes = nil
	file_webpb_v1_csrf_config_proto_depIdxs = nil
}
