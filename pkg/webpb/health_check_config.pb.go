...
// 	protoc        (unknown)
// source: webpb/v1/health_check_config.proto
...
func (x *WebHealthCheckConfig) Reset() {
	*x = WebHealthCheckConfig{}
	mi := &file_webpb_v1_health_check_config_proto_msgTypes[0]
...
var File_webpb_v1_health_check_config_proto protoreflect.FileDescriptor

const file_webpb_v1_health_check_config_proto_rawDesc = "" +
	"\n" +
	"\"webpb/v1/health_check_config.proto\x12\x06web.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf4\x02\n" +
	...
	"\aheaders\x18\x05 \x03(\v2).web.v1.WebHealthCheckConfig.HeadersEntryR\aheaders\x12\x18\n" +
	"\aenabled\x18\x06 \x01(\bR\aenabled\x1a:\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x8a\x01\n" +
	"\n" +
	"com.web.v1B\x16HealthCheckConfigProtoP\x01Z#github.com/jdfalk/gcommon/pkg/webpb\xa2\x02\x03WXX\xaa\x02\x06Web.V1\xca\x02\x06Web\\V1\xe2\x02\x12Web\\V1\\GPBMetadata\xea\x02\aWeb::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_webpb_v1_health_check_config_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_webpb_v1_health_check_config_proto_goTypes = []any{
	(*WebHealthCheckConfig)(nil), // 0: web.v1.WebHealthCheckConfig
	nil,                          // 1: web.v1.WebHealthCheckConfig.HeadersEntry
}
var file_webpb_v1_health_check_config_proto_depIdxs = []int32{
	1, // 0: web.v1.WebHealthCheckConfig.headers:type_name -> web.v1.WebHealthCheckConfig.HeadersEntry
...
func init() { file_webpb_v1_health_check_config_proto_init() }
func file_webpb_v1_health_check_config_proto_init() {
	if File_webpb_v1_health_check_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_webpb_v1_health_check_config_proto_rawDesc), len(file_webpb_v1_health_check_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_webpb_v1_health_check_config_proto_goTypes,
		DependencyIndexes: file_webpb_v1_health_check_config_proto_depIdxs,
		MessageInfos:      file_webpb_v1_health_check_config_proto_msgTypes,
	}.Build()
	File_webpb_v1_health_check_config_proto = out.File
	file_webpb_v1_health_check_config_proto_goTypes = nil
	file_webpb_v1_health_check_config_proto_depIdxs = nil
}
