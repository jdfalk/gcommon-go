...
// 	protoc        (unknown)
// source: queue/v1/restore_queue_request.proto
...
func (x *RestoreQueueRequest) Reset() {
	*x = RestoreQueueRequest{}
	mi := &file_queue_v1_restore_queue_request_proto_msgTypes[0]
...
var File_queue_v1_restore_queue_request_proto protoreflect.FileDescriptor

const file_queue_v1_restore_queue_request_proto_rawDesc = "" +
	"\n" +
	"$queue/v1/restore_queue_request.proto\x12\bqueue.v1\x1a\x1cqueue/v1/backup_source.proto\x1a\x1dqueue/v1/restore_config.proto\x1a\x1equeue/v1/restore_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xc5\x04\n" +
...
var file_queue_v1_restore_queue_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queue_v1_restore_queue_request_proto_goTypes = []any{
...
var file_queue_v1_restore_queue_request_proto_depIdxs = []int32{
...
func init() { file_queue_v1_restore_queue_request_proto_init() }
func file_queue_v1_restore_queue_request_proto_init() {
	if File_queue_v1_restore_queue_request_proto != nil {
		return
	}
	file_queue_v1_backup_source_proto_init()
	file_queue_v1_restore_config_proto_init()
	file_queue_v1_restore_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_restore_queue_request_proto_rawDesc), len(file_queue_v1_restore_queue_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_restore_queue_request_proto_goTypes,
		DependencyIndexes: file_queue_v1_restore_queue_request_proto_depIdxs,
		MessageInfos:      file_queue_v1_restore_queue_request_proto_msgTypes,
	}.Build()
	File_queue_v1_restore_queue_request_proto = out.File
	file_queue_v1_restore_queue_request_proto_goTypes = nil
	file_queue_v1_restore_queue_request_proto_depIdxs = nil
}
