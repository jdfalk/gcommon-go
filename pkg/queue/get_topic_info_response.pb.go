...
func (x *GetTopicInfoResponse) Reset() {
	*x = GetTopicInfoResponse{}
	mi := &file_queue_v1_get_topic_info_response_proto_msgTypes[0]
...
var File_queue_v1_get_topic_info_response_proto protoreflect.FileDescriptor

const file_queue_v1_get_topic_info_response_proto_rawDesc = "" +
	"\n" +
	"&queue/v1/get_topic_info_response.proto\x12\bqueue.v1\x1a&common/v1/metrics_retention_info.proto\x1a\x19queue/v1/owner_info.proto\x1a\x1dqueue/v1/partition_info.proto\x1a\"queue/v1/topic_configuration.proto\x1a queue/v1/topic_permissions.proto\x1a\x1aqueue/v1/topic_stats.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xf9\x05\n" +
...
func init() { file_queue_v1_get_topic_info_response_proto_init() }
func file_queue_v1_get_topic_info_response_proto_init() {
	if File_queue_v1_get_topic_info_response_proto != nil {
		return
	}
	file_queue_v1_owner_info_proto_init()
	file_queue_v1_partition_info_proto_init()
	file_queue_v1_topic_configuration_proto_init()
	file_queue_v1_topic_permissions_proto_init()
	file_queue_v1_topic_stats_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_get_topic_info_response_proto_rawDesc), len(file_queue_v1_get_topic_info_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_get_topic_info_response_proto_goTypes,
		DependencyIndexes: file_queue_v1_get_topic_info_response_proto_depIdxs,
		MessageInfos:      file_queue_v1_get_topic_info_response_proto_msgTypes,
	}.Build()
	File_queue_v1_get_topic_info_response_proto = out.File
	file_queue_v1_get_topic_info_response_proto_goTypes = nil
	file_queue_v1_get_topic_info_response_proto_depIdxs = nil
}
