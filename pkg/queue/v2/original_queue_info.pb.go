...
// 	protoc        (unknown)
// source: queue/v2/original_queue_info.proto
...
func (x *OriginalQueueInfo) Reset() {
	*x = OriginalQueueInfo{}
	mi := &file_queue_v2_original_queue_info_proto_msgTypes[0]
...
var File_queue_v2_original_queue_info_proto protoreflect.FileDescriptor

const file_queue_v2_original_queue_info_proto_rawDesc = "" +
	"\n" +
	"\"queue/v2/original_queue_info.proto\x12\bqueue.v2\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xdd\x02\n" +
...
var file_queue_v2_original_queue_info_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queue_v2_original_queue_info_proto_goTypes = []any{
	(*OriginalQueueInfo)(nil),     // 0: queue.v2.OriginalQueueInfo
	nil,                           // 1: queue.v2.OriginalQueueInfo.ConfigSnapshotEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_queue_v2_original_queue_info_proto_depIdxs = []int32{
...
func init() { file_queue_v2_original_queue_info_proto_init() }
func file_queue_v2_original_queue_info_proto_init() {
	if File_queue_v2_original_queue_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_original_queue_info_proto_rawDesc), len(file_queue_v2_original_queue_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_original_queue_info_proto_goTypes,
		DependencyIndexes: file_queue_v2_original_queue_info_proto_depIdxs,
		MessageInfos:      file_queue_v2_original_queue_info_proto_msgTypes,
	}.Build()
	File_queue_v2_original_queue_info_proto = out.File
	file_queue_v2_original_queue_info_proto_goTypes = nil
	file_queue_v2_original_queue_info_proto_depIdxs = nil
}
