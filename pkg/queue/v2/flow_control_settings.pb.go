...
// 	protoc        (unknown)
// source: queue/v2/flow_control_settings.proto
...
func (x *FlowControlSettings) Reset() {
	*x = FlowControlSettings{}
	mi := &file_queue_v2_flow_control_settings_proto_msgTypes[0]
...
var File_queue_v2_flow_control_settings_proto protoreflect.FileDescriptor

const file_queue_v2_flow_control_settings_proto_rawDesc = "" +
	"\n" +
	"$queue/v2/flow_control_settings.proto\x12\bqueue.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbf\x01\n" +
	...
	"\talgorithm\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\talgorithmB0Z&github.com/jdfalk/gcommon/pkg/queue/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v2_flow_control_settings_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v2_flow_control_settings_proto_goTypes = []any{
	(*FlowControlSettings)(nil), // 0: queue.v2.FlowControlSettings
}
var file_queue_v2_flow_control_settings_proto_depIdxs = []int32{
...
func init() { file_queue_v2_flow_control_settings_proto_init() }
func file_queue_v2_flow_control_settings_proto_init() {
	if File_queue_v2_flow_control_settings_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_flow_control_settings_proto_rawDesc), len(file_queue_v2_flow_control_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_flow_control_settings_proto_goTypes,
		DependencyIndexes: file_queue_v2_flow_control_settings_proto_depIdxs,
		MessageInfos:      file_queue_v2_flow_control_settings_proto_msgTypes,
	}.Build()
	File_queue_v2_flow_control_settings_proto = out.File
	file_queue_v2_flow_control_settings_proto_goTypes = nil
	file_queue_v2_flow_control_settings_proto_depIdxs = nil
}
