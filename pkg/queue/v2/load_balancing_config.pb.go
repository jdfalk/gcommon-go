...
// 	protoc        (unknown)
// source: queue/v2/load_balancing_config.proto
...
type LoadBalancingConfig struct {
	...
	xxx_hidden_Strategy              v2.LoadBalancingStrategy `protobuf:"varint,1,opt,name=strategy,enum=common.v2.LoadBalancingStrategy"`
...
func (x *LoadBalancingConfig) Reset() {
	*x = LoadBalancingConfig{}
	mi := &file_queue_v2_load_balancing_config_proto_msgTypes[0]
...
func (x *LoadBalancingConfig) GetStrategy() v2.LoadBalancingStrategy {
	if x != nil {
...
func (x *LoadBalancingConfig) SetStrategy(v v2.LoadBalancingStrategy) {
...
func (x *LoadBalancingConfig) ClearStrategy() {
	...
	x.xxx_hidden_Strategy = v2.LoadBalancingStrategy_LOAD_BALANCING_STRATEGY_UNSPECIFIED
}
...
type LoadBalancingConfig_builder struct {
	...
	Strategy *v2.LoadBalancingStrategy
...
var File_queue_v2_load_balancing_config_proto protoreflect.FileDescriptor

const file_queue_v2_load_balancing_config_proto_rawDesc = "" +
	"\n" +
	"$queue/v2/load_balancing_config.proto\x12\bqueue.v2\x1a'common/v2/load_balancing_strategy.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe2\x02\n" +
	"\x13LoadBalancingConfig\x12<\n" +
	"\bstrategy\x18\x01 \x01(\x0e2 .common.v2.LoadBalancingStrategyR\bstrategy\x12\x1f\n" +
	...
	"\faffinity_key\x18\a \x01(\tB\a\xbaH\x04r\x02\x10\x01R\vaffinityKeyB0Z&github.com/jdfalk/gcommon/pkg/queue/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v2_load_balancing_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v2_load_balancing_config_proto_goTypes = []any{
	(*LoadBalancingConfig)(nil),   // 0: queue.v2.LoadBalancingConfig
	(v2.LoadBalancingStrategy)(0), // 1: common.v2.LoadBalancingStrategy
}
var file_queue_v2_load_balancing_config_proto_depIdxs = []int32{
	1, // 0: queue.v2.LoadBalancingConfig.strategy:type_name -> common.v2.LoadBalancingStrategy
...
func init() { file_queue_v2_load_balancing_config_proto_init() }
func file_queue_v2_load_balancing_config_proto_init() {
	if File_queue_v2_load_balancing_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_load_balancing_config_proto_rawDesc), len(file_queue_v2_load_balancing_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_load_balancing_config_proto_goTypes,
		DependencyIndexes: file_queue_v2_load_balancing_config_proto_depIdxs,
		MessageInfos:      file_queue_v2_load_balancing_config_proto_msgTypes,
	}.Build()
	File_queue_v2_load_balancing_config_proto = out.File
	file_queue_v2_load_balancing_config_proto_goTypes = nil
	file_queue_v2_load_balancing_config_proto_depIdxs = nil
}
