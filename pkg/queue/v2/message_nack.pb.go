...
// 	protoc        (unknown)
// source: queue/v2/message_nack.proto
...
func (x *MessageNack) Reset() {
	*x = MessageNack{}
	mi := &file_queue_v2_message_nack_proto_msgTypes[0]
...
var File_queue_v2_message_nack_proto protoreflect.FileDescriptor

const file_queue_v2_message_nack_proto_rawDesc = "" +
	"\n" +
	"\x1bqueue/v2/message_nack.proto\x12\bqueue.v2\x1a#common/v2/nack_error_category.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc3\x04\n" +
	"\vMessageNack\x12&\n" +
	"\n" +
...
var file_queue_v2_message_nack_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queue_v2_message_nack_proto_goTypes = []any{
...
var file_queue_v2_message_nack_proto_depIdxs = []int32{
...
func init() { file_queue_v2_message_nack_proto_init() }
func file_queue_v2_message_nack_proto_init() {
	if File_queue_v2_message_nack_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_message_nack_proto_rawDesc), len(file_queue_v2_message_nack_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_message_nack_proto_goTypes,
		DependencyIndexes: file_queue_v2_message_nack_proto_depIdxs,
		MessageInfos:      file_queue_v2_message_nack_proto_msgTypes,
	}.Build()
	File_queue_v2_message_nack_proto = out.File
	file_queue_v2_message_nack_proto_goTypes = nil
	file_queue_v2_message_nack_proto_depIdxs = nil
}
