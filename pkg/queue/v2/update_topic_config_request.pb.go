...
// 	protoc        (unknown)
// source: queue/v2/update_topic_config_request.proto
...
func (x *UpdateTopicConfigRequest) Reset() {
	*x = UpdateTopicConfigRequest{}
	mi := &file_queue_v2_update_topic_config_request_proto_msgTypes[0]
...
var File_queue_v2_update_topic_config_request_proto protoreflect.FileDescriptor

const file_queue_v2_update_topic_config_request_proto_rawDesc = "" +
	"\n" +
	"*queue/v2/update_topic_config_request.proto\x12\bqueue.v2\x1a\x1bqueue/v2/topic_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe6\x01\n" +
	...
	"\n" +
	"timeout_ms\x18\x05 \x01(\x05R\ttimeoutMsB0Z&github.com/jdfalk/gcommon/pkg/queue/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v2_update_topic_config_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v2_update_topic_config_request_proto_goTypes = []any{
	(*UpdateTopicConfigRequest)(nil), // 0: queue.v2.UpdateTopicConfigRequest
	(*TopicConfig)(nil),              // 1: queue.v2.TopicConfig
}
var file_queue_v2_update_topic_config_request_proto_depIdxs = []int32{
...
func init() { file_queue_v2_update_topic_config_request_proto_init() }
func file_queue_v2_update_topic_config_request_proto_init() {
	if File_queue_v2_update_topic_config_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_update_topic_config_request_proto_rawDesc), len(file_queue_v2_update_topic_config_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_update_topic_config_request_proto_goTypes,
		DependencyIndexes: file_queue_v2_update_topic_config_request_proto_depIdxs,
		MessageInfos:      file_queue_v2_update_topic_config_request_proto_msgTypes,
	}.Build()
	File_queue_v2_update_topic_config_request_proto = out.File
	file_queue_v2_update_topic_config_request_proto_goTypes = nil
	file_queue_v2_update_topic_config_request_proto_depIdxs = nil
}
