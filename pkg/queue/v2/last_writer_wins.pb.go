...
// 	protoc        (unknown)
// source: queue/v2/last_writer_wins.proto
...
func (x *LastWriterWins) Reset() {
	*x = LastWriterWins{}
	mi := &file_queue_v2_last_writer_wins_proto_msgTypes[0]
...
var File_queue_v2_last_writer_wins_proto protoreflect.FileDescriptor

const file_queue_v2_last_writer_wins_proto_rawDesc = "" +
	"\n" +
	"\x1fqueue/v2/last_writer_wins.proto\x12\bqueue.v2\x1a!google/protobuf/go_features.proto\"s\n" +
	"\x0eLastWriterWins\x120\n" +
	"\x14use_server_timestamp\x18\x01 \x01(\bR\x12useServerTimestamp\x12/\n" +
	"\x13timestamp_precision\x18\x02 \x01(\tR\x12timestampPrecisionB0Z&github.com/jdfalk/gcommon/pkg/queue/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v2_last_writer_wins_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v2_last_writer_wins_proto_goTypes = []any{
	(*LastWriterWins)(nil), // 0: queue.v2.LastWriterWins
}
var file_queue_v2_last_writer_wins_proto_depIdxs = []int32{
...
func init() { file_queue_v2_last_writer_wins_proto_init() }
func file_queue_v2_last_writer_wins_proto_init() {
	if File_queue_v2_last_writer_wins_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_last_writer_wins_proto_rawDesc), len(file_queue_v2_last_writer_wins_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_last_writer_wins_proto_goTypes,
		DependencyIndexes: file_queue_v2_last_writer_wins_proto_depIdxs,
		MessageInfos:      file_queue_v2_last_writer_wins_proto_msgTypes,
	}.Build()
	File_queue_v2_last_writer_wins_proto = out.File
	file_queue_v2_last_writer_wins_proto_goTypes = nil
	file_queue_v2_last_writer_wins_proto_depIdxs = nil
}
