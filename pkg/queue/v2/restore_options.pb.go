...
// 	protoc        (unknown)
// source: queue/v2/restore_options.proto
...
func (x *RestoreOptions) Reset() {
	*x = RestoreOptions{}
	mi := &file_queue_v2_restore_options_proto_msgTypes[0]
...
var File_queue_v2_restore_options_proto protoreflect.FileDescriptor

const file_queue_v2_restore_options_proto_rawDesc = "" +
	"\n" +
	"\x1equeue/v2/restore_options.proto\x12\bqueue.v2\x1a\"common/v2/time_range_metrics.proto\x1a\x1equeue/v2/filter_criteria.proto\x1a\x1bqueue/v2/offset_range.proto\x1a\"queue/v2/performance_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbf\x03\n" +
	...
	"\vperformance\x18\b \x01(\v2\x1c.queue.v2.PerformanceOptionsR\vperformanceB0Z&github.com/jdfalk/gcommon/pkg/queue/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v2_restore_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v2_restore_options_proto_goTypes = []any{
...
var file_queue_v2_restore_options_proto_depIdxs = []int32{
...
func init() { file_queue_v2_restore_options_proto_init() }
func file_queue_v2_restore_options_proto_init() {
	if File_queue_v2_restore_options_proto != nil {
		return
	}
	file_queue_v2_filter_criteria_proto_init()
	file_queue_v2_offset_range_proto_init()
	file_queue_v2_performance_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_restore_options_proto_rawDesc), len(file_queue_v2_restore_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_restore_options_proto_goTypes,
		DependencyIndexes: file_queue_v2_restore_options_proto_depIdxs,
		MessageInfos:      file_queue_v2_restore_options_proto_msgTypes,
	}.Build()
	File_queue_v2_restore_options_proto = out.File
	file_queue_v2_restore_options_proto_goTypes = nil
	file_queue_v2_restore_options_proto_depIdxs = nil
}
