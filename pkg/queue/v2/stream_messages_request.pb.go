...
// 	protoc        (unknown)
// source: queue/v2/stream_messages_request.proto
...
func (x *StreamMessagesRequest) Reset() {
	*x = StreamMessagesRequest{}
	mi := &file_queue_v2_stream_messages_request_proto_msgTypes[0]
...
var File_queue_v2_stream_messages_request_proto protoreflect.FileDescriptor

const file_queue_v2_stream_messages_request_proto_rawDesc = "" +
	"\n" +
	"&queue/v2/stream_messages_request.proto\x12\bqueue.v2\x1a\x19common/v2/ack_level.proto\x1a\x1dqueue/v2/message_filter.proto\x1a\x1cqueue/v2/offset_config.proto\x1a\x1cqueue/v2/stream_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa6\x05\n" +
	...
	"\rstream_config\x18\x0e \x01(\v2\x16.queue.v2.StreamConfigR\fstreamConfigB0Z&github.com/jdfalk/gcommon/pkg/queue/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v2_stream_messages_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v2_stream_messages_request_proto_goTypes = []any{
...
var file_queue_v2_stream_messages_request_proto_depIdxs = []int32{
...
func init() { file_queue_v2_stream_messages_request_proto_init() }
func file_queue_v2_stream_messages_request_proto_init() {
	if File_queue_v2_stream_messages_request_proto != nil {
		return
	}
	file_queue_v2_message_filter_proto_init()
	file_queue_v2_offset_config_proto_init()
	file_queue_v2_stream_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_stream_messages_request_proto_rawDesc), len(file_queue_v2_stream_messages_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_stream_messages_request_proto_goTypes,
		DependencyIndexes: file_queue_v2_stream_messages_request_proto_depIdxs,
		MessageInfos:      file_queue_v2_stream_messages_request_proto_msgTypes,
	}.Build()
	File_queue_v2_stream_messages_request_proto = out.File
	file_queue_v2_stream_messages_request_proto_goTypes = nil
	file_queue_v2_stream_messages_request_proto_depIdxs = nil
}
