...
// 	protoc        (unknown)
// source: queue/v2/stream_config.proto
...
func (x *StreamConfig) Reset() {
	*x = StreamConfig{}
	mi := &file_queue_v2_stream_config_proto_msgTypes[0]
...
var File_queue_v2_stream_config_proto protoreflect.FileDescriptor

const file_queue_v2_stream_config_proto_rawDesc = "" +
	"\n" +
	"\x1cqueue/v2/stream_config.proto\x12\bqueue.v2\x1a%common/v2/stream_restart_policy.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x83\x04\n" +
	"\fStreamConfig\x12(\n" +
	...
	"\x0erestart_policy\x18\t \x01(\x0e2\x1e.common.v2.StreamRestartPolicyR\rrestartPolicyB0Z&github.com/jdfalk/gcommon/pkg/queue/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v2_stream_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v2_stream_config_proto_goTypes = []any{
	(*StreamConfig)(nil),        // 0: queue.v2.StreamConfig
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
	(v2.StreamRestartPolicy)(0), // 2: common.v2.StreamRestartPolicy
}
var file_queue_v2_stream_config_proto_depIdxs = []int32{
...
func init() { file_queue_v2_stream_config_proto_init() }
func file_queue_v2_stream_config_proto_init() {
	if File_queue_v2_stream_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_stream_config_proto_rawDesc), len(file_queue_v2_stream_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_stream_config_proto_goTypes,
		DependencyIndexes: file_queue_v2_stream_config_proto_depIdxs,
		MessageInfos:      file_queue_v2_stream_config_proto_msgTypes,
	}.Build()
	File_queue_v2_stream_config_proto = out.File
	file_queue_v2_stream_config_proto_goTypes = nil
	file_queue_v2_stream_config_proto_depIdxs = nil
}
