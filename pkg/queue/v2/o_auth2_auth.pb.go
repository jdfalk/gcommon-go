...
// 	protoc        (unknown)
// source: queue/v2/o_auth2_auth.proto
...
func (x *OAuth2Auth) Reset() {
	*x = OAuth2Auth{}
	mi := &file_queue_v2_o_auth2_auth_proto_msgTypes[0]
...
var File_queue_v2_o_auth2_auth_proto protoreflect.FileDescriptor

const file_queue_v2_o_auth2_auth_proto_rawDesc = "" +
	"\n" +
	"\x1bqueue/v2/o_auth2_auth.proto\x12\bqueue.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb7\x02\n" +
	"\n" +
	"OAuth2Auth\x12.\n" +
...
var file_queue_v2_o_auth2_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queue_v2_o_auth2_auth_proto_goTypes = []any{
	(*OAuth2Auth)(nil), // 0: queue.v2.OAuth2Auth
	nil,                // 1: queue.v2.OAuth2Auth.ParametersEntry
}
var file_queue_v2_o_auth2_auth_proto_depIdxs = []int32{
...
func init() { file_queue_v2_o_auth2_auth_proto_init() }
func file_queue_v2_o_auth2_auth_proto_init() {
	if File_queue_v2_o_auth2_auth_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_o_auth2_auth_proto_rawDesc), len(file_queue_v2_o_auth2_auth_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_o_auth2_auth_proto_goTypes,
		DependencyIndexes: file_queue_v2_o_auth2_auth_proto_depIdxs,
		MessageInfos:      file_queue_v2_o_auth2_auth_proto_msgTypes,
	}.Build()
	File_queue_v2_o_auth2_auth_proto = out.File
	file_queue_v2_o_auth2_auth_proto_goTypes = nil
	file_queue_v2_o_auth2_auth_proto_depIdxs = nil
}
