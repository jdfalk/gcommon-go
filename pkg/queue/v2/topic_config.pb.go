...
// 	protoc        (unknown)
// source: queue/v2/topic_config.proto
...
func (x *TopicConfig) Reset() {
	*x = TopicConfig{}
	mi := &file_queue_v2_topic_config_proto_msgTypes[0]
...
var File_queue_v2_topic_config_proto protoreflect.FileDescriptor

const file_queue_v2_topic_config_proto_rawDesc = "" +
	"\n" +
	"\x1bqueue/v2/topic_config.proto\x12\bqueue.v2\x1a\x1fqueue/v2/partition_config.proto\x1a\x1fqueue/v2/retention_policy.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9e\x03\n" +
	"\vTopicConfig\x12*\n" +
	...
	"\x11enable_compaction\x18\b \x01(\bR\x10enableCompactionB0Z&github.com/jdfalk/gcommon/pkg/queue/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v2_topic_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v2_topic_config_proto_goTypes = []any{
...
var file_queue_v2_topic_config_proto_depIdxs = []int32{
...
func init() { file_queue_v2_topic_config_proto_init() }
func file_queue_v2_topic_config_proto_init() {
	if File_queue_v2_topic_config_proto != nil {
		return
	}
	file_queue_v2_partition_config_proto_init()
	file_queue_v2_retention_policy_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_topic_config_proto_rawDesc), len(file_queue_v2_topic_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_topic_config_proto_goTypes,
		DependencyIndexes: file_queue_v2_topic_config_proto_depIdxs,
		MessageInfos:      file_queue_v2_topic_config_proto_msgTypes,
	}.Build()
	File_queue_v2_topic_config_proto = out.File
	file_queue_v2_topic_config_proto_goTypes = nil
	file_queue_v2_topic_config_proto_depIdxs = nil
}
