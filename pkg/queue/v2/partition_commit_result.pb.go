...
// 	protoc        (unknown)
// source: queue/v2/partition_commit_result.proto
...
func (x *PartitionCommitResult) Reset() {
	*x = PartitionCommitResult{}
	mi := &file_queue_v2_partition_commit_result_proto_msgTypes[0]
...
var File_queue_v2_partition_commit_result_proto protoreflect.FileDescriptor

const file_queue_v2_partition_commit_result_proto_rawDesc = "" +
	"\n" +
	"&queue/v2/partition_commit_result.proto\x12\bqueue.v2\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x8d\x04\n" +
...
var file_queue_v2_partition_commit_result_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queue_v2_partition_commit_result_proto_goTypes = []any{
...
var file_queue_v2_partition_commit_result_proto_depIdxs = []int32{
...
func init() { file_queue_v2_partition_commit_result_proto_init() }
func file_queue_v2_partition_commit_result_proto_init() {
	if File_queue_v2_partition_commit_result_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_partition_commit_result_proto_rawDesc), len(file_queue_v2_partition_commit_result_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_partition_commit_result_proto_goTypes,
		DependencyIndexes: file_queue_v2_partition_commit_result_proto_depIdxs,
		MessageInfos:      file_queue_v2_partition_commit_result_proto_msgTypes,
	}.Build()
	File_queue_v2_partition_commit_result_proto = out.File
	file_queue_v2_partition_commit_result_proto_goTypes = nil
	file_queue_v2_partition_commit_result_proto_depIdxs = nil
}
