...
// 	protoc        (unknown)
// source: queue/v2/read_consistency.proto
...
func (x *ReadConsistency) Reset() {
	*x = ReadConsistency{}
	mi := &file_queue_v2_read_consistency_proto_msgTypes[0]
...
var File_queue_v2_read_consistency_proto protoreflect.FileDescriptor

const file_queue_v2_read_consistency_proto_rawDesc = "" +
	"\n" +
	"\x1fqueue/v2/read_consistency.proto\x12\bqueue.v2\x1a\x1acommon/v2/read_level.proto\x1a queue/v2/read_retry_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa9\x02\n" +
	...
	"\fretry_config\x18\x06 \x01(\v2\x19.queue.v2.ReadRetryConfigR\vretryConfigB0Z&github.com/jdfalk/gcommon/pkg/queue/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v2_read_consistency_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v2_read_consistency_proto_goTypes = []any{
...
var file_queue_v2_read_consistency_proto_depIdxs = []int32{
...
func init() { file_queue_v2_read_consistency_proto_init() }
func file_queue_v2_read_consistency_proto_init() {
	if File_queue_v2_read_consistency_proto != nil {
		return
	}
	file_queue_v2_read_retry_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_read_consistency_proto_rawDesc), len(file_queue_v2_read_consistency_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_read_consistency_proto_goTypes,
		DependencyIndexes: file_queue_v2_read_consistency_proto_depIdxs,
		MessageInfos:      file_queue_v2_read_consistency_proto_msgTypes,
	}.Build()
	File_queue_v2_read_consistency_proto = out.File
	file_queue_v2_read_consistency_proto_goTypes = nil
	file_queue_v2_read_consistency_proto_depIdxs = nil
}
