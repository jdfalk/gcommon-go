...
// 	protoc        (unknown)
// source: queue/v2/acknowledgment.proto
...
func (x *Acknowledgment) Reset() {
	*x = Acknowledgment{}
	mi := &file_queue_v2_acknowledgment_proto_msgTypes[0]
...
var File_queue_v2_acknowledgment_proto protoreflect.FileDescriptor

const file_queue_v2_acknowledgment_proto_rawDesc = "" +
	"\n" +
	"\x1dqueue/v2/acknowledgment.proto\x12\bqueue.v2\x1a\x18common/v2/ack_type.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa1\x03\n" +
	...
	"\vretry_count\x18\n" +
	" \x01(\x05R\n" +
	"retryCountB0Z&github.com/jdfalk/gcommon/pkg/queue/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v2_acknowledgment_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v2_acknowledgment_proto_goTypes = []any{
	(*Acknowledgment)(nil),        // 0: queue.v2.Acknowledgment
	(v2.AckType)(0),               // 1: common.v2.AckType
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_queue_v2_acknowledgment_proto_depIdxs = []int32{
...
func init() { file_queue_v2_acknowledgment_proto_init() }
func file_queue_v2_acknowledgment_proto_init() {
	if File_queue_v2_acknowledgment_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_acknowledgment_proto_rawDesc), len(file_queue_v2_acknowledgment_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_acknowledgment_proto_goTypes,
		DependencyIndexes: file_queue_v2_acknowledgment_proto_depIdxs,
		MessageInfos:      file_queue_v2_acknowledgment_proto_msgTypes,
	}.Build()
	File_queue_v2_acknowledgment_proto = out.File
	file_queue_v2_acknowledgment_proto_goTypes = nil
	file_queue_v2_acknowledgment_proto_depIdxs = nil
}
