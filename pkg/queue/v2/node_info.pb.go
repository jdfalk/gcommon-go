...
// 	protoc        (unknown)
// source: queue/v2/node_info.proto
...
func (x *NodeInfo) Reset() {
	*x = NodeInfo{}
	mi := &file_queue_v2_node_info_proto_msgTypes[0]
...
var File_queue_v2_node_info_proto protoreflect.FileDescriptor

const file_queue_v2_node_info_proto_rawDesc = "" +
	"\n" +
	"\x18queue/v2/node_info.proto\x12\bqueue.v2\x1a\x1acommon/v2/node_state.proto\x1a\x19queue/v2/node_stats.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xac\x02\n" +
	"\bNodeInfo\x12 \n" +
	...
	"\x05stats\x18\a \x01(\v2\x13.queue.v2.NodeStatsR\x05statsB0Z&github.com/jdfalk/gcommon/pkg/queue/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v2_node_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v2_node_info_proto_goTypes = []any{
	(*NodeInfo)(nil),              // 0: queue.v2.NodeInfo
	(v2.NodeState)(0),             // 1: common.v2.NodeState
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*NodeStats)(nil),             // 3: queue.v2.NodeStats
}
var file_queue_v2_node_info_proto_depIdxs = []int32{
...
func init() { file_queue_v2_node_info_proto_init() }
func file_queue_v2_node_info_proto_init() {
	if File_queue_v2_node_info_proto != nil {
		return
	}
	file_queue_v2_node_stats_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_node_info_proto_rawDesc), len(file_queue_v2_node_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_node_info_proto_goTypes,
		DependencyIndexes: file_queue_v2_node_info_proto_depIdxs,
		MessageInfos:      file_queue_v2_node_info_proto_msgTypes,
	}.Build()
	File_queue_v2_node_info_proto = out.File
	file_queue_v2_node_info_proto_goTypes = nil
	file_queue_v2_node_info_proto_depIdxs = nil
}
