...
// 	protoc        (unknown)
// source: queue/v2/authentication_config.proto
...
func (x *AuthenticationConfig) Reset() {
	*x = AuthenticationConfig{}
	mi := &file_queue_v2_authentication_config_proto_msgTypes[0]
...
func (x case_AuthenticationConfig_AuthType) String() string {
	md := file_queue_v2_authentication_config_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_queue_v2_authentication_config_proto protoreflect.FileDescriptor

const file_queue_v2_authentication_config_proto_rawDesc = "" +
	"\n" +
	"$queue/v2/authentication_config.proto\x12\bqueue.v2\x1a\x1bqueue/v2/api_key_auth.proto\x1a\x1bqueue/v2/o_auth2_auth.proto\x1a\x18queue/v2/sasl_auth.proto\x1a\x17queue/v2/tls_auth.proto\x1a%queue/v2/username_password_auth.proto\x1a!google/protobuf/go_features.proto\"\xba\x02\n" +
	...
	"\tauth_typeB0Z&github.com/jdfalk/gcommon/pkg/queue/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v2_authentication_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v2_authentication_config_proto_goTypes = []any{
...
var file_queue_v2_authentication_config_proto_depIdxs = []int32{
...
func init() { file_queue_v2_authentication_config_proto_init() }
func file_queue_v2_authentication_config_proto_init() {
	if File_queue_v2_authentication_config_proto != nil {
		return
	}
	file_queue_v2_api_key_auth_proto_init()
	file_queue_v2_o_auth2_auth_proto_init()
	file_queue_v2_sasl_auth_proto_init()
	file_queue_v2_tls_auth_proto_init()
	file_queue_v2_username_password_auth_proto_init()
	file_queue_v2_authentication_config_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_authentication_config_proto_rawDesc), len(file_queue_v2_authentication_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_authentication_config_proto_goTypes,
		DependencyIndexes: file_queue_v2_authentication_config_proto_depIdxs,
		MessageInfos:      file_queue_v2_authentication_config_proto_msgTypes,
	}.Build()
	File_queue_v2_authentication_config_proto = out.File
	file_queue_v2_authentication_config_proto_goTypes = nil
	file_queue_v2_authentication_config_proto_depIdxs = nil
}
