...
// 	protoc        (unknown)
// source: queue/v2/subscription_configuration.proto
...
func (x *SubscriptionConfiguration) Reset() {
	*x = SubscriptionConfiguration{}
	mi := &file_queue_v2_subscription_configuration_proto_msgTypes[0]
...
var File_queue_v2_subscription_configuration_proto protoreflect.FileDescriptor

const file_queue_v2_subscription_configuration_proto_rawDesc = "" +
	"\n" +
	")queue/v2/subscription_configuration.proto\x12\bqueue.v2\x1a\x19common/v2/ack_level.proto\x1a\x1dcommon/v2/delivery_mode.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa3\x04\n" +
...
var file_queue_v2_subscription_configuration_proto_depIdxs = []int32{
...
func init() { file_queue_v2_subscription_configuration_proto_init() }
func file_queue_v2_subscription_configuration_proto_init() {
	if File_queue_v2_subscription_configuration_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_subscription_configuration_proto_rawDesc), len(file_queue_v2_subscription_configuration_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_subscription_configuration_proto_goTypes,
		DependencyIndexes: file_queue_v2_subscription_configuration_proto_depIdxs,
		MessageInfos:      file_queue_v2_subscription_configuration_proto_msgTypes,
	}.Build()
	File_queue_v2_subscription_configuration_proto = out.File
	file_queue_v2_subscription_configuration_proto_goTypes = nil
	file_queue_v2_subscription_configuration_proto_depIdxs = nil
}
