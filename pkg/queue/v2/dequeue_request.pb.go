...
// 	protoc        (unknown)
// source: queue/v2/dequeue_request.proto
...
func (x *DequeueRequest) Reset() {
	*x = DequeueRequest{}
	mi := &file_queue_v2_dequeue_request_proto_msgTypes[0]
...
var File_queue_v2_dequeue_request_proto protoreflect.FileDescriptor

const file_queue_v2_dequeue_request_proto_rawDesc = "" +
	"\n" +
	"\x1equeue/v2/dequeue_request.proto\x12\bqueue.v2\x1a common/v2/request_metadata.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xcc\x05\n" +
...
var file_queue_v2_dequeue_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queue_v2_dequeue_request_proto_goTypes = []any{
...
var file_queue_v2_dequeue_request_proto_depIdxs = []int32{
...
func init() { file_queue_v2_dequeue_request_proto_init() }
func file_queue_v2_dequeue_request_proto_init() {
	if File_queue_v2_dequeue_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_dequeue_request_proto_rawDesc), len(file_queue_v2_dequeue_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_dequeue_request_proto_goTypes,
		DependencyIndexes: file_queue_v2_dequeue_request_proto_depIdxs,
		MessageInfos:      file_queue_v2_dequeue_request_proto_msgTypes,
	}.Build()
	File_queue_v2_dequeue_request_proto = out.File
	file_queue_v2_dequeue_request_proto_goTypes = nil
	file_queue_v2_dequeue_request_proto_depIdxs = nil
}
