...
// 	protoc        (unknown)
// source: queue/v2/sasl_auth.proto
...
func (x *SASLAuth) Reset() {
	*x = SASLAuth{}
	mi := &file_queue_v2_sasl_auth_proto_msgTypes[0]
...
var File_queue_v2_sasl_auth_proto protoreflect.FileDescriptor

const file_queue_v2_sasl_auth_proto_rawDesc = "" +
	"\n" +
	"\x18queue/v2/sasl_auth.proto\x12\bqueue.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xfe\x01\n" +
	"\bSASLAuth\x12%\n" +
...
var file_queue_v2_sasl_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queue_v2_sasl_auth_proto_goTypes = []any{
	(*SASLAuth)(nil), // 0: queue.v2.SASLAuth
	nil,              // 1: queue.v2.SASLAuth.PropertiesEntry
}
var file_queue_v2_sasl_auth_proto_depIdxs = []int32{
...
func init() { file_queue_v2_sasl_auth_proto_init() }
func file_queue_v2_sasl_auth_proto_init() {
	if File_queue_v2_sasl_auth_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_sasl_auth_proto_rawDesc), len(file_queue_v2_sasl_auth_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_sasl_auth_proto_goTypes,
		DependencyIndexes: file_queue_v2_sasl_auth_proto_depIdxs,
		MessageInfos:      file_queue_v2_sasl_auth_proto_msgTypes,
	}.Build()
	File_queue_v2_sasl_auth_proto = out.File
	file_queue_v2_sasl_auth_proto_goTypes = nil
	file_queue_v2_sasl_auth_proto_depIdxs = nil
}
