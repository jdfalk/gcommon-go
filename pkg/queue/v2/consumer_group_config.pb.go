...
// 	protoc        (unknown)
// source: queue/v2/consumer_group_config.proto
...
func (x *ConsumerGroupConfig) Reset() {
	*x = ConsumerGroupConfig{}
	mi := &file_queue_v2_consumer_group_config_proto_msgTypes[0]
...
var File_queue_v2_consumer_group_config_proto protoreflect.FileDescriptor

const file_queue_v2_consumer_group_config_proto_rawDesc = "" +
	"\n" +
	"$queue/v2/consumer_group_config.proto\x12\bqueue.v2\x1a'common/v2/load_balancing_strategy.proto\x1a%common/v2/offset_reset_strategy.proto\x1a\"common/v2/rebalance_strategy.proto\x1a!queue/v2/auto_commit_config.proto\x1a'queue/v2/dead_letter_queue_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9b\x05\n" +
	...
	"\n" +
	"dlq_config\x18\n" +
	" \x01(\v2\x1f.queue.v2.DeadLetterQueueConfigR\tdlqConfigB0Z&github.com/jdfalk/gcommon/pkg/queue/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v2_consumer_group_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v2_consumer_group_config_proto_goTypes = []any{
...
var file_queue_v2_consumer_group_config_proto_depIdxs = []int32{
...
func init() { file_queue_v2_consumer_group_config_proto_init() }
func file_queue_v2_consumer_group_config_proto_init() {
	if File_queue_v2_consumer_group_config_proto != nil {
		return
	}
	file_queue_v2_auto_commit_config_proto_init()
	file_queue_v2_dead_letter_queue_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_consumer_group_config_proto_rawDesc), len(file_queue_v2_consumer_group_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_consumer_group_config_proto_goTypes,
		DependencyIndexes: file_queue_v2_consumer_group_config_proto_depIdxs,
		MessageInfos:      file_queue_v2_consumer_group_config_proto_msgTypes,
	}.Build()
	File_queue_v2_consumer_group_config_proto = out.File
	file_queue_v2_consumer_group_config_proto_goTypes = nil
	file_queue_v2_consumer_group_config_proto_depIdxs = nil
}
