...
// 	protoc        (unknown)
// source: queue/v2/delivery_configuration.proto
...
func (x *DeliveryConfiguration) Reset() {
	*x = DeliveryConfiguration{}
	mi := &file_queue_v2_delivery_configuration_proto_msgTypes[0]
...
var File_queue_v2_delivery_configuration_proto protoreflect.FileDescriptor

const file_queue_v2_delivery_configuration_proto_rawDesc = "" +
	"\n" +
	"%queue/v2/delivery_configuration.proto\x12\bqueue.v2\x1a$queue/v2/batch_delivery_config.proto\x1a$queue/v2/delivery_retry_config.proto\x1a$queue/v2/flow_control_settings.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x88\x04\n" +
...
var file_queue_v2_delivery_configuration_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queue_v2_delivery_configuration_proto_goTypes = []any{
...
var file_queue_v2_delivery_configuration_proto_depIdxs = []int32{
...
func init() { file_queue_v2_delivery_configuration_proto_init() }
func file_queue_v2_delivery_configuration_proto_init() {
	if File_queue_v2_delivery_configuration_proto != nil {
		return
	}
	file_queue_v2_batch_delivery_config_proto_init()
	file_queue_v2_delivery_retry_config_proto_init()
	file_queue_v2_flow_control_settings_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_delivery_configuration_proto_rawDesc), len(file_queue_v2_delivery_configuration_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_delivery_configuration_proto_goTypes,
		DependencyIndexes: file_queue_v2_delivery_configuration_proto_depIdxs,
		MessageInfos:      file_queue_v2_delivery_configuration_proto_msgTypes,
	}.Build()
	File_queue_v2_delivery_configuration_proto = out.File
	file_queue_v2_delivery_configuration_proto_goTypes = nil
	file_queue_v2_delivery_configuration_proto_depIdxs = nil
}
