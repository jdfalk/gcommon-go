...
// 	protoc        (unknown)
// source: queue/v2/replication_consistency.proto
...
type ReplicationConsistency struct {
	...
	xxx_hidden_ReplicationLevel      v2.ReplicationLevel    `protobuf:"varint,4,opt,name=replication_level,json=replicationLevel,enum=common.v2.ReplicationLevel"`
...
func (x *ReplicationConsistency) Reset() {
	*x = ReplicationConsistency{}
	mi := &file_queue_v2_replication_consistency_proto_msgTypes[0]
...
func (x *ReplicationConsistency) GetReplicationLevel() v2.ReplicationLevel {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 3) {
			return x.xxx_hidden_ReplicationLevel
		}
	}
	return v2.ReplicationLevel(0)
}
...
func (x *ReplicationConsistency) SetReplicationLevel(v v2.ReplicationLevel) {
...
func (x *ReplicationConsistency) ClearReplicationLevel() {
	...
	x.xxx_hidden_ReplicationLevel = v2.ReplicationLevel_REPLICATION_LEVEL_UNSPECIFIED
}
...
type ReplicationConsistency_builder struct {
	...
	ReplicationLevel *v2.ReplicationLevel
...
var File_queue_v2_replication_consistency_proto protoreflect.FileDescriptor

const file_queue_v2_replication_consistency_proto_rawDesc = "" +
	"\n" +
	"&queue/v2/replication_consistency.proto\x12\bqueue.v2\x1a!common/v2/replication_level.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf9\x02\n" +
	...
	"\x17repair_interval_seconds\x18\x06 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x15repairIntervalSecondsB0Z&github.com/jdfalk/gcommon/pkg/queue/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v2_replication_consistency_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v2_replication_consistency_proto_goTypes = []any{
	(*ReplicationConsistency)(nil), // 0: queue.v2.ReplicationConsistency
	(v2.ReplicationLevel)(0),       // 1: common.v2.ReplicationLevel
}
var file_queue_v2_replication_consistency_proto_depIdxs = []int32{
	1, // 0: queue.v2.ReplicationConsistency.replication_level:type_name -> common.v2.ReplicationLevel
...
func init() { file_queue_v2_replication_consistency_proto_init() }
func file_queue_v2_replication_consistency_proto_init() {
	if File_queue_v2_replication_consistency_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v2_replication_consistency_proto_rawDesc), len(file_queue_v2_replication_consistency_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v2_replication_consistency_proto_goTypes,
		DependencyIndexes: file_queue_v2_replication_consistency_proto_depIdxs,
		MessageInfos:      file_queue_v2_replication_consistency_proto_msgTypes,
	}.Build()
	File_queue_v2_replication_consistency_proto = out.File
	file_queue_v2_replication_consistency_proto_goTypes = nil
	file_queue_v2_replication_consistency_proto_depIdxs = nil
}
