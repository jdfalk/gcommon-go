...
func (x *BackupSource) Reset() {
	*x = BackupSource{}
	mi := &file_queue_v1_backup_source_proto_msgTypes[0]
...
var File_queue_v1_backup_source_proto protoreflect.FileDescriptor

const file_queue_v1_backup_source_proto_rawDesc = "" +
	"\n" +
	"\x1cqueue/v1/backup_source.proto\x12\bqueue.v1\x1a\x1equeue/v1/encryption_info.proto\x1a\"queue/v1/original_queue_info.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xd2\x04\n" +
	"\fBackupSource\x12$\n" +
...
var file_queue_v1_backup_source_proto_depIdxs = []int32{
...
func init() { file_queue_v1_backup_source_proto_init() }
func file_queue_v1_backup_source_proto_init() {
	if File_queue_v1_backup_source_proto != nil {
		return
	}
	file_queue_v1_encryption_info_proto_init()
	file_queue_v1_original_queue_info_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_backup_source_proto_rawDesc), len(file_queue_v1_backup_source_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_backup_source_proto_goTypes,
		DependencyIndexes: file_queue_v1_backup_source_proto_depIdxs,
		MessageInfos:      file_queue_v1_backup_source_proto_msgTypes,
	}.Build()
	File_queue_v1_backup_source_proto = out.File
	file_queue_v1_backup_source_proto_goTypes = nil
	file_queue_v1_backup_source_proto_depIdxs = nil
}
