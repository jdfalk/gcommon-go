...
func (x *QueueDepthSample) Reset() {
	*x = QueueDepthSample{}
	mi := &file_queue_v1_queue_depth_sample_proto_msgTypes[0]
...
var File_queue_v1_queue_depth_sample_proto protoreflect.FileDescriptor

const file_queue_v1_queue_depth_sample_proto_rawDesc = "" +
	"\n" +
...
var file_queue_v1_queue_depth_sample_proto_depIdxs = []int32{
...
func init() { file_queue_v1_queue_depth_sample_proto_init() }
func file_queue_v1_queue_depth_sample_proto_init() {
	if File_queue_v1_queue_depth_sample_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_queue_depth_sample_proto_rawDesc), len(file_queue_v1_queue_depth_sample_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_queue_depth_sample_proto_goTypes,
		DependencyIndexes: file_queue_v1_queue_depth_sample_proto_depIdxs,
		MessageInfos:      file_queue_v1_queue_depth_sample_proto_msgTypes,
	}.Build()
	File_queue_v1_queue_depth_sample_proto = out.File
	file_queue_v1_queue_depth_sample_proto_goTypes = nil
	file_queue_v1_queue_depth_sample_proto_depIdxs = nil
}
