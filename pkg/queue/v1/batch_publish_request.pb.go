...
func (x *BatchPublishRequest) Reset() {
	*x = BatchPublishRequest{}
	mi := &file_queue_v1_batch_publish_request_proto_msgTypes[0]
...
var File_queue_v1_batch_publish_request_proto protoreflect.FileDescriptor

const file_queue_v1_batch_publish_request_proto_rawDesc = "" +
	"\n" +
	"$queue/v1/batch_publish_request.proto\x12\bqueue.v1\x1a common/v1/request_metadata.proto\x1a\x1cqueue/v1/queue_message.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd1\x02\n" +
...
func init() { file_queue_v1_batch_publish_request_proto_init() }
func file_queue_v1_batch_publish_request_proto_init() {
	if File_queue_v1_batch_publish_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_batch_publish_request_proto_rawDesc), len(file_queue_v1_batch_publish_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_batch_publish_request_proto_goTypes,
		DependencyIndexes: file_queue_v1_batch_publish_request_proto_depIdxs,
		MessageInfos:      file_queue_v1_batch_publish_request_proto_msgTypes,
	}.Build()
	File_queue_v1_batch_publish_request_proto = out.File
	file_queue_v1_batch_publish_request_proto_goTypes = nil
	file_queue_v1_batch_publish_request_proto_depIdxs = nil
}
