...
func (x *RoutingKey) Reset() {
	*x = RoutingKey{}
	mi := &file_queue_v1_routing_key_proto_msgTypes[0]
...
var File_queue_v1_routing_key_proto protoreflect.FileDescriptor

const file_queue_v1_routing_key_proto_rawDesc = "" +
	"\n" +
	"\x1aqueue/v1/routing_key.proto\x12\bqueue.v1\x1a\x1fcommon/v1/routing_pattern.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb6\x02\n" +
	"\n" +
	"RoutingKey\x12\x19\n" +
...
func init() { file_queue_v1_routing_key_proto_init() }
func file_queue_v1_routing_key_proto_init() {
	if File_queue_v1_routing_key_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_routing_key_proto_rawDesc), len(file_queue_v1_routing_key_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_routing_key_proto_goTypes,
		DependencyIndexes: file_queue_v1_routing_key_proto_depIdxs,
		MessageInfos:      file_queue_v1_routing_key_proto_msgTypes,
	}.Build()
	File_queue_v1_routing_key_proto = out.File
	file_queue_v1_routing_key_proto_goTypes = nil
	file_queue_v1_routing_key_proto_depIdxs = nil
}
