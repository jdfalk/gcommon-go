...
// 	protoc        (unknown)
// source: queue/v1/acknowledge_response.proto
...
func (x *AcknowledgeResponse) Reset() {
	*x = AcknowledgeResponse{}
	mi := &file_queue_v1_acknowledge_response_proto_msgTypes[0]
...
func (x *AcknowledgeResponse) GetRequestMetadata() *v1.RequestMetadata {
	if x != nil {
...
func (x *AcknowledgeResponse) GetError() *v1.Error {
	if x != nil {
...
func (x *AcknowledgeResponse) SetRequestMetadata(v *v1.RequestMetadata) {
...
func (x *AcknowledgeResponse) SetError(v *v1.Error) {
...
var File_queue_v1_acknowledge_response_proto protoreflect.FileDescriptor

const file_queue_v1_acknowledge_response_proto_rawDesc = "" +
	"\n" +
	"#queue/v1/acknowledge_response.proto\x12\bqueue.v1\x1a\x15common/v1/error.proto\x1a common/v1/request_metadata.proto\x1a!queue/v1/message_ack_result.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xd2\x05\n" +
...
var file_queue_v1_acknowledge_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v1_acknowledge_response_proto_goTypes = []any{
...
var file_queue_v1_acknowledge_response_proto_depIdxs = []int32{
...
func init() { file_queue_v1_acknowledge_response_proto_init() }
func file_queue_v1_acknowledge_response_proto_init() {
	if File_queue_v1_acknowledge_response_proto != nil {
		return
	}
	file_queue_v1_message_ack_result_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_acknowledge_response_proto_rawDesc), len(file_queue_v1_acknowledge_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_acknowledge_response_proto_goTypes,
		DependencyIndexes: file_queue_v1_acknowledge_response_proto_depIdxs,
		MessageInfos:      file_queue_v1_acknowledge_response_proto_msgTypes,
	}.Build()
	File_queue_v1_acknowledge_response_proto = out.File
	file_queue_v1_acknowledge_response_proto_goTypes = nil
	file_queue_v1_acknowledge_response_proto_depIdxs = nil
}
