...
func (x *DeleteCriteria) Reset() {
	*x = DeleteCriteria{}
	mi := &file_queue_v1_delete_criteria_proto_msgTypes[0]
...
var File_queue_v1_delete_criteria_proto protoreflect.FileDescriptor

const file_queue_v1_delete_criteria_proto_rawDesc = "" +
	"\n" +
	"\x1equeue/v1/delete_criteria.proto\x12\bqueue.v1\x1a\x1dcommon/v1/message_state.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x8b\x03\n" +
...
func init() { file_queue_v1_delete_criteria_proto_init() }
func file_queue_v1_delete_criteria_proto_init() {
	if File_queue_v1_delete_criteria_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_delete_criteria_proto_rawDesc), len(file_queue_v1_delete_criteria_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_delete_criteria_proto_goTypes,
		DependencyIndexes: file_queue_v1_delete_criteria_proto_depIdxs,
		MessageInfos:      file_queue_v1_delete_criteria_proto_msgTypes,
	}.Build()
	File_queue_v1_delete_criteria_proto = out.File
	file_queue_v1_delete_criteria_proto_goTypes = nil
	file_queue_v1_delete_criteria_proto_depIdxs = nil
}
