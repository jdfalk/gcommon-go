...
// 	protoc        (unknown)
// source: queue/v1/message_nack.proto
...
type MessageNack struct {
	...
	xxx_hidden_ErrorCategory   common.NackErrorCategory `protobuf:"varint,6,opt,name=error_category,json=errorCategory,enum=common.v1.NackErrorCategory"`
...
func (x *MessageNack) Reset() {
	*x = MessageNack{}
	mi := &file_queue_v1_message_nack_proto_msgTypes[0]
...
func (x *MessageNack) GetErrorCategory() common.NackErrorCategory {
	if x != nil {
...
func (x *MessageNack) SetErrorCategory(v common.NackErrorCategory) {
...
func (x *MessageNack) ClearErrorCategory() {
	...
	x.xxx_hidden_ErrorCategory = common.NackErrorCategory_NACK_ERROR_CATEGORY_UNSPECIFIED
}
...
type MessageNack_builder struct {
	...
	ErrorCategory *common.NackErrorCategory
	// Specific error code
	ErrorCode *string
...
var File_queue_v1_message_nack_proto protoreflect.FileDescriptor

const file_queue_v1_message_nack_proto_rawDesc = "" +
	"\n" +
	"\x1bqueue/v1/message_nack.proto\x12\bqueue.v1\x1a#common/v1/nack_error_category.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc3\x04\n" +
	"\vMessageNack\x12&\n" +
	"\n" +
...
var file_queue_v1_message_nack_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queue_v1_message_nack_proto_goTypes = []any{
	(*MessageNack)(nil),           // 0: queue.v1.MessageNack
	nil,                           // 1: queue.v1.MessageNack.MessageMetadataEntry
	(common.NackErrorCategory)(0), // 2: common.v1.NackErrorCategory
}
var file_queue_v1_message_nack_proto_depIdxs = []int32{
...
func init() { file_queue_v1_message_nack_proto_init() }
func file_queue_v1_message_nack_proto_init() {
	if File_queue_v1_message_nack_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_message_nack_proto_rawDesc), len(file_queue_v1_message_nack_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_message_nack_proto_goTypes,
		DependencyIndexes: file_queue_v1_message_nack_proto_depIdxs,
		MessageInfos:      file_queue_v1_message_nack_proto_msgTypes,
	}.Build()
	File_queue_v1_message_nack_proto = out.File
	file_queue_v1_message_nack_proto_goTypes = nil
	file_queue_v1_message_nack_proto_depIdxs = nil
}
