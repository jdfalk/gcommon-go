...
// 	protoc        (unknown)
// source: queue/v1/acknowledgment.proto
...
type Acknowledgment struct {
	...
	xxx_hidden_AckType              v1.AckType             `protobuf:"varint,6,opt,name=ack_type,json=ackType,enum=common.v1.AckType"`
...
func (x *Acknowledgment) Reset() {
	*x = Acknowledgment{}
	mi := &file_queue_v1_acknowledgment_proto_msgTypes[0]
...
func (x *Acknowledgment) GetAckType() v1.AckType {
	if x != nil {
...
func (x *Acknowledgment) SetAckType(v v1.AckType) {
...
func (x *Acknowledgment) ClearAckType() {
	...
	x.xxx_hidden_AckType = v1.AckType_ACK_TYPE_UNSPECIFIED
}
...
var File_queue_v1_acknowledgment_proto protoreflect.FileDescriptor

const file_queue_v1_acknowledgment_proto_rawDesc = "" +
	"\n" +
	"\x1dqueue/v1/acknowledgment.proto\x12\bqueue.v1\x1a\x18common/v1/ack_type.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa1\x03\n" +
	...
	"\vretry_count\x18\n" +
	" \x01(\x05R\n" +
	"retryCountB,Z\"github.com/jdfalk/gcommon/queue/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v1_acknowledgment_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v1_acknowledgment_proto_goTypes = []any{
	(*Acknowledgment)(nil),        // 0: queue.v1.Acknowledgment
	(v1.AckType)(0),               // 1: common.v1.AckType
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_queue_v1_acknowledgment_proto_depIdxs = []int32{
...
func init() { file_queue_v1_acknowledgment_proto_init() }
func file_queue_v1_acknowledgment_proto_init() {
	if File_queue_v1_acknowledgment_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_acknowledgment_proto_rawDesc), len(file_queue_v1_acknowledgment_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_acknowledgment_proto_goTypes,
		DependencyIndexes: file_queue_v1_acknowledgment_proto_depIdxs,
		MessageInfos:      file_queue_v1_acknowledgment_proto_msgTypes,
	}.Build()
	File_queue_v1_acknowledgment_proto = out.File
	file_queue_v1_acknowledgment_proto_goTypes = nil
	file_queue_v1_acknowledgment_proto_depIdxs = nil
}
