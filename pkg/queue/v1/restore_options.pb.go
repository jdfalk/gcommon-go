...
// 	protoc        (unknown)
// source: queue/v1/restore_options.proto
...
type RestoreOptions struct {
	...
	xxx_hidden_TimeRange          *common.TimeRangeMetrics `protobuf:"bytes,5,opt,name=time_range,json=timeRange"`
...
func (x *RestoreOptions) Reset() {
	*x = RestoreOptions{}
	mi := &file_queue_v1_restore_options_proto_msgTypes[0]
...
func (x *RestoreOptions) GetTimeRange() *common.TimeRangeMetrics {
	if x != nil {
...
func (x *RestoreOptions) SetTimeRange(v *common.TimeRangeMetrics) {
...
var File_queue_v1_restore_options_proto protoreflect.FileDescriptor

const file_queue_v1_restore_options_proto_rawDesc = "" +
	"\n" +
	"\x1equeue/v1/restore_options.proto\x12\bqueue.v1\x1a\"common/v1/time_range_metrics.proto\x1a\x1equeue/v1/filter_criteria.proto\x1a\x1bqueue/v1/offset_range.proto\x1a\"queue/v1/performance_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbf\x03\n" +
	...
	"\vperformance\x18\b \x01(\v2\x1c.queue.v1.PerformanceOptionsR\vperformanceB.Z$github.com/jdfalk/gcommon/pkg/queue/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v1_restore_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v1_restore_options_proto_goTypes = []any{
...
var file_queue_v1_restore_options_proto_depIdxs = []int32{
...
func init() { file_queue_v1_restore_options_proto_init() }
func file_queue_v1_restore_options_proto_init() {
	if File_queue_v1_restore_options_proto != nil {
		return
	}
	file_queue_v1_filter_criteria_proto_init()
	file_queue_v1_offset_range_proto_init()
	file_queue_v1_performance_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_restore_options_proto_rawDesc), len(file_queue_v1_restore_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_restore_options_proto_goTypes,
		DependencyIndexes: file_queue_v1_restore_options_proto_depIdxs,
		MessageInfos:      file_queue_v1_restore_options_proto_msgTypes,
	}.Build()
	File_queue_v1_restore_options_proto = out.File
	file_queue_v1_restore_options_proto_goTypes = nil
	file_queue_v1_restore_options_proto_depIdxs = nil
}
