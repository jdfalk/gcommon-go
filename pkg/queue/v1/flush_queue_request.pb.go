...
// 	protoc        (unknown)
// source: queue/v1/flush_queue_request.proto
...
func (x *FlushQueueRequest) Reset() {
	*x = FlushQueueRequest{}
	mi := &file_queue_v1_flush_queue_request_proto_msgTypes[0]
...
func (x *FlushQueueRequest) GetFlushPolicy() v1.FlushPolicy {
	if x != nil {
...
func (x *FlushQueueRequest) SetFlushPolicy(v v1.FlushPolicy) {
...
var File_queue_v1_flush_queue_request_proto protoreflect.FileDescriptor

const file_queue_v1_flush_queue_request_proto_rawDesc = "" +
	"\n" +
	"\"queue/v1/flush_queue_request.proto\x12\bqueue.v1\x1a\x1ccommon/v1/flush_policy.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xdb\x03\n" +
...
var file_queue_v1_flush_queue_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queue_v1_flush_queue_request_proto_goTypes = []any{
	(*FlushQueueRequest)(nil),     // 0: queue.v1.FlushQueueRequest
	nil,                           // 1: queue.v1.FlushQueueRequest.MetadataEntry
	(v1.FlushPolicy)(0),           // 2: common.v1.FlushPolicy
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_queue_v1_flush_queue_request_proto_depIdxs = []int32{
...
func init() { file_queue_v1_flush_queue_request_proto_init() }
func file_queue_v1_flush_queue_request_proto_init() {
	if File_queue_v1_flush_queue_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_flush_queue_request_proto_rawDesc), len(file_queue_v1_flush_queue_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_flush_queue_request_proto_goTypes,
		DependencyIndexes: file_queue_v1_flush_queue_request_proto_depIdxs,
		MessageInfos:      file_queue_v1_flush_queue_request_proto_msgTypes,
	}.Build()
	File_queue_v1_flush_queue_request_proto = out.File
	file_queue_v1_flush_queue_request_proto_goTypes = nil
	file_queue_v1_flush_queue_request_proto_depIdxs = nil
}
