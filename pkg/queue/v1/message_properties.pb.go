...
// 	protoc        (unknown)
// source: queue/v1/message_properties.proto
...
type MessageProperties struct {
	...
	xxx_hidden_Priority        v1.PriorityLevel       `protobuf:"varint,1,opt,name=priority,enum=common.v1.PriorityLevel"`
...
func (x *MessageProperties) Reset() {
	*x = MessageProperties{}
	mi := &file_queue_v1_message_properties_proto_msgTypes[0]
...
func (x *MessageProperties) GetPriority() v1.PriorityLevel {
	if x != nil {
...
func (x *MessageProperties) GetDeliveryMode() v1.DeliveryMode {
	if x != nil {
...
func (x *MessageProperties) SetPriority(v v1.PriorityLevel) {
	x.xxx_hidden_Priority = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 10)
}

func (x *MessageProperties) SetDeliveryMode(v v1.DeliveryMode) {
...
func (x *MessageProperties) ClearPriority() {
	...
	x.xxx_hidden_Priority = v1.PriorityLevel_QUEUE_PRIORITY_LEVEL_UNSPECIFIED
}
...
var File_queue_v1_message_properties_proto protoreflect.FileDescriptor

const file_queue_v1_message_properties_proto_rawDesc = "" +
	"\n" +
	"!queue/v1/message_properties.proto\x12\bqueue.v1\x1a\x1dcommon/v1/delivery_mode.proto\x1a\x1ecommon/v1/priority_level.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x94\x04\n" +
	...
	" \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x0fdeliveryDelayMsB,Z\"github.com/jdfalk/gcommon/queue/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_queue_v1_message_properties_proto_goTypes = []any{
	...
	(v1.PriorityLevel)(0),         // 1: common.v1.PriorityLevel
	(v1.DeliveryMode)(0),          // 2: common.v1.DeliveryMode
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_queue_v1_message_properties_proto_depIdxs = []int32{
...
func init() { file_queue_v1_message_properties_proto_init() }
func file_queue_v1_message_properties_proto_init() {
	if File_queue_v1_message_properties_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_message_properties_proto_rawDesc), len(file_queue_v1_message_properties_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_message_properties_proto_goTypes,
		DependencyIndexes: file_queue_v1_message_properties_proto_depIdxs,
		MessageInfos:      file_queue_v1_message_properties_proto_msgTypes,
	}.Build()
	File_queue_v1_message_properties_proto = out.File
	file_queue_v1_message_properties_proto_goTypes = nil
	file_queue_v1_message_properties_proto_depIdxs = nil
}
