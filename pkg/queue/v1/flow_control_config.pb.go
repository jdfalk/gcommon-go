...
// 	protoc        (unknown)
// source: queue/v1/flow_control_config.proto
...
func (x *FlowControlConfig) Reset() {
	*x = FlowControlConfig{}
	mi := &file_queue_v1_flow_control_config_proto_msgTypes[0]
...
var File_queue_v1_flow_control_config_proto protoreflect.FileDescriptor

const file_queue_v1_flow_control_config_proto_rawDesc = "" +
	"\n" +
	"\"queue/v1/flow_control_config.proto\x12\bqueue.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd7\x01\n" +
	...
	"\talgorithm\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\talgorithmB-Z#github.com/jdfalk/gcommon/pkg/queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v1_flow_control_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v1_flow_control_config_proto_goTypes = []any{
	(*FlowControlConfig)(nil), // 0: queue.v1.FlowControlConfig
}
var file_queue_v1_flow_control_config_proto_depIdxs = []int32{
...
func init() { file_queue_v1_flow_control_config_proto_init() }
func file_queue_v1_flow_control_config_proto_init() {
	if File_queue_v1_flow_control_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_flow_control_config_proto_rawDesc), len(file_queue_v1_flow_control_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_flow_control_config_proto_goTypes,
		DependencyIndexes: file_queue_v1_flow_control_config_proto_depIdxs,
		MessageInfos:      file_queue_v1_flow_control_config_proto_msgTypes,
	}.Build()
	File_queue_v1_flow_control_config_proto = out.File
	file_queue_v1_flow_control_config_proto_goTypes = nil
	file_queue_v1_flow_control_config_proto_depIdxs = nil
}
