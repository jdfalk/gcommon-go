...
func (x *WriteConsistency) Reset() {
	*x = WriteConsistency{}
	mi := &file_queue_v1_write_consistency_proto_msgTypes[0]
...
var File_queue_v1_write_consistency_proto protoreflect.FileDescriptor

const file_queue_v1_write_consistency_proto_rawDesc = "" +
	"\n" +
	" queue/v1/write_consistency.proto\x12\bqueue.v1\x1a\x1bcommon/v1/write_level.proto\x1a!queue/v1/conflict_detection.proto\x1a\x1fqueue/v1/sync_replication.proto\x1a!queue/v1/write_retry_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb8\x02\n" +
...
var file_queue_v1_write_consistency_proto_depIdxs = []int32{
...
func init() { file_queue_v1_write_consistency_proto_init() }
func file_queue_v1_write_consistency_proto_init() {
	if File_queue_v1_write_consistency_proto != nil {
		return
	}
	file_queue_v1_conflict_detection_proto_init()
	file_queue_v1_sync_replication_proto_init()
	file_queue_v1_write_retry_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_write_consistency_proto_rawDesc), len(file_queue_v1_write_consistency_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_write_consistency_proto_goTypes,
		DependencyIndexes: file_queue_v1_write_consistency_proto_depIdxs,
		MessageInfos:      file_queue_v1_write_consistency_proto_msgTypes,
	}.Build()
	File_queue_v1_write_consistency_proto = out.File
	file_queue_v1_write_consistency_proto_goTypes = nil
	file_queue_v1_write_consistency_proto_depIdxs = nil
}
