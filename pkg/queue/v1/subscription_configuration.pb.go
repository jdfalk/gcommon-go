...
// 	protoc        (unknown)
// source: queue/v1/subscription_configuration.proto
...
type SubscriptionConfiguration struct {
	...
	xxx_hidden_AckLevel             v1.AckLevel            `protobuf:"varint,1,opt,name=ack_level,json=ackLevel,enum=common.v1.AckLevel"`
	xxx_hidden_DeliveryMode         v1.DeliveryMode        `protobuf:"varint,2,opt,name=delivery_mode,json=deliveryMode,enum=common.v1.DeliveryMode"`
...
func (x *SubscriptionConfiguration) Reset() {
	*x = SubscriptionConfiguration{}
	mi := &file_queue_v1_subscription_configuration_proto_msgTypes[0]
...
func (x *SubscriptionConfiguration) GetAckLevel() v1.AckLevel {
	if x != nil {
...
func (x *SubscriptionConfiguration) GetDeliveryMode() v1.DeliveryMode {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			return x.xxx_hidden_DeliveryMode
		}
	}
	return v1.DeliveryMode(0)
}
...
func (x *SubscriptionConfiguration) SetAckLevel(v v1.AckLevel) {
	x.xxx_hidden_AckLevel = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 10)
}

func (x *SubscriptionConfiguration) SetDeliveryMode(v v1.DeliveryMode) {
...
func (x *SubscriptionConfiguration) ClearDeliveryMode() {
	...
	x.xxx_hidden_DeliveryMode = v1.DeliveryMode_DELIVERY_MODE_UNSPECIFIED
}
...
var File_queue_v1_subscription_configuration_proto protoreflect.FileDescriptor

const file_queue_v1_subscription_configuration_proto_rawDesc = "" +
	"\n" +
	")queue/v1/subscription_configuration.proto\x12\bqueue.v1\x1a\x19common/v1/ack_level.proto\x1a\x1dcommon/v1/delivery_mode.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa3\x04\n" +
	...
	" \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x14maxMessageAgeSecondsB,Z\"github.com/jdfalk/gcommon/queue/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v1_subscription_configuration_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v1_subscription_configuration_proto_goTypes = []any{
	(*SubscriptionConfiguration)(nil), // 0: queue.v1.SubscriptionConfiguration
	(v1.AckLevel)(0),                  // 1: common.v1.AckLevel
	(v1.DeliveryMode)(0),              // 2: common.v1.DeliveryMode
}
var file_queue_v1_subscription_configuration_proto_depIdxs = []int32{
...
func init() { file_queue_v1_subscription_configuration_proto_init() }
func file_queue_v1_subscription_configuration_proto_init() {
	if File_queue_v1_subscription_configuration_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_subscription_configuration_proto_rawDesc), len(file_queue_v1_subscription_configuration_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_subscription_configuration_proto_goTypes,
		DependencyIndexes: file_queue_v1_subscription_configuration_proto_depIdxs,
		MessageInfos:      file_queue_v1_subscription_configuration_proto_msgTypes,
	}.Build()
	File_queue_v1_subscription_configuration_proto = out.File
	file_queue_v1_subscription_configuration_proto_goTypes = nil
	file_queue_v1_subscription_configuration_proto_depIdxs = nil
}
