...
// 	protoc        (unknown)
// source: queue/v1/message_filter.proto
...
func (x *MessageFilter) Reset() {
	*x = MessageFilter{}
	mi := &file_queue_v1_message_filter_proto_msgTypes[0]
...
var File_queue_v1_message_filter_proto protoreflect.FileDescriptor

const file_queue_v1_message_filter_proto_rawDesc = "" +
	"\n" +
	"\x1dqueue/v1/message_filter.proto\x12\bqueue.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x83\x04\n" +
	"\rMessageFilter\x12Q\n" +
...
var file_queue_v1_message_filter_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_queue_v1_message_filter_proto_goTypes = []any{
...
var file_queue_v1_message_filter_proto_depIdxs = []int32{
...
func init() { file_queue_v1_message_filter_proto_init() }
func file_queue_v1_message_filter_proto_init() {
	if File_queue_v1_message_filter_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_message_filter_proto_rawDesc), len(file_queue_v1_message_filter_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_message_filter_proto_goTypes,
		DependencyIndexes: file_queue_v1_message_filter_proto_depIdxs,
		MessageInfos:      file_queue_v1_message_filter_proto_msgTypes,
	}.Build()
	File_queue_v1_message_filter_proto = out.File
	file_queue_v1_message_filter_proto_goTypes = nil
	file_queue_v1_message_filter_proto_depIdxs = nil
}
