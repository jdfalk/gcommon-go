...
// 	protoc        (unknown)
// source: queue/v1/custom_resolution.proto
...
func (x *CustomResolution) Reset() {
	*x = CustomResolution{}
	mi := &file_queue_v1_custom_resolution_proto_msgTypes[0]
...
var File_queue_v1_custom_resolution_proto protoreflect.FileDescriptor

const file_queue_v1_custom_resolution_proto_rawDesc = "" +
	"\n" +
	" queue/v1/custom_resolution.proto\x12\bqueue.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xec\x01\n" +
...
var file_queue_v1_custom_resolution_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queue_v1_custom_resolution_proto_goTypes = []any{
	(*CustomResolution)(nil), // 0: queue.v1.CustomResolution
	nil,                      // 1: queue.v1.CustomResolution.ParametersEntry
}
var file_queue_v1_custom_resolution_proto_depIdxs = []int32{
...
func init() { file_queue_v1_custom_resolution_proto_init() }
func file_queue_v1_custom_resolution_proto_init() {
	if File_queue_v1_custom_resolution_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_custom_resolution_proto_rawDesc), len(file_queue_v1_custom_resolution_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_custom_resolution_proto_goTypes,
		DependencyIndexes: file_queue_v1_custom_resolution_proto_depIdxs,
		MessageInfos:      file_queue_v1_custom_resolution_proto_msgTypes,
	}.Build()
	File_queue_v1_custom_resolution_proto = out.File
	file_queue_v1_custom_resolution_proto_goTypes = nil
	file_queue_v1_custom_resolution_proto_depIdxs = nil
}
