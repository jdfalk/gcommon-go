...
func (x *ConsistencyConfig) Reset() {
	*x = ConsistencyConfig{}
	mi := &file_queue_v1_consistency_config_proto_msgTypes[0]
...
var File_queue_v1_consistency_config_proto protoreflect.FileDescriptor

const file_queue_v1_consistency_config_proto_rawDesc = "" +
	"\n" +
	"!queue/v1/consistency_config.proto\x12\bqueue.v1\x1a\x19common/v1/ack_level.proto\x1a#common/v1/conflict_resolution.proto\x1a common/v1/durability_level.proto\x1a%queue/v1/consistency_validation.proto\x1a\x1equeue/v1/ordering_config.proto\x1a\x1fqueue/v1/read_consistency.proto\x1a&queue/v1/replication_consistency.proto\x1a queue/v1/write_consistency.proto\x1a!google/protobuf/go_features.proto\"\xa6\x04\n" +
...
func init() { file_queue_v1_consistency_config_proto_init() }
func file_queue_v1_consistency_config_proto_init() {
	if File_queue_v1_consistency_config_proto != nil {
		return
	}
	file_queue_v1_consistency_validation_proto_init()
	file_queue_v1_ordering_config_proto_init()
	file_queue_v1_read_consistency_proto_init()
	file_queue_v1_replication_consistency_proto_init()
	file_queue_v1_write_consistency_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_consistency_config_proto_rawDesc), len(file_queue_v1_consistency_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_consistency_config_proto_goTypes,
		DependencyIndexes: file_queue_v1_consistency_config_proto_depIdxs,
		MessageInfos:      file_queue_v1_consistency_config_proto_msgTypes,
	}.Build()
	File_queue_v1_consistency_config_proto = out.File
	file_queue_v1_consistency_config_proto_goTypes = nil
	file_queue_v1_consistency_config_proto_depIdxs = nil
}
