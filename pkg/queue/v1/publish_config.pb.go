...
func (x *PublishConfig) Reset() {
	*x = PublishConfig{}
	mi := &file_queue_v1_publish_config_proto_msgTypes[0]
...
var File_queue_v1_publish_config_proto protoreflect.FileDescriptor

const file_queue_v1_publish_config_proto_rawDesc = "" +
	"\n" +
	"\x1dqueue/v1/publish_config.proto\x12\bqueue.v1\x1a\x1ccommon/v1/retry_policy.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe0\x02\n" +
	"\rPublishConfig\x12 \n" +
...
func init() { file_queue_v1_publish_config_proto_init() }
func file_queue_v1_publish_config_proto_init() {
	if File_queue_v1_publish_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_publish_config_proto_rawDesc), len(file_queue_v1_publish_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_publish_config_proto_goTypes,
		DependencyIndexes: file_queue_v1_publish_config_proto_depIdxs,
		MessageInfos:      file_queue_v1_publish_config_proto_msgTypes,
	}.Build()
	File_queue_v1_publish_config_proto = out.File
	file_queue_v1_publish_config_proto_goTypes = nil
	file_queue_v1_publish_config_proto_depIdxs = nil
}
