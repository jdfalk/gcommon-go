...
func (x *HistoricalDataPoint) Reset() {
	*x = HistoricalDataPoint{}
	mi := &file_queue_v1_historical_data_point_proto_msgTypes[0]
...
var File_queue_v1_historical_data_point_proto protoreflect.FileDescriptor

const file_queue_v1_historical_data_point_proto_rawDesc = "" +
	"\n" +
	"$queue/v1/historical_data_point.proto\x12\bqueue.v1\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x9a\x02\n" +
...
var file_queue_v1_historical_data_point_proto_depIdxs = []int32{
...
func init() { file_queue_v1_historical_data_point_proto_init() }
func file_queue_v1_historical_data_point_proto_init() {
	if File_queue_v1_historical_data_point_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_historical_data_point_proto_rawDesc), len(file_queue_v1_historical_data_point_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_historical_data_point_proto_goTypes,
		DependencyIndexes: file_queue_v1_historical_data_point_proto_depIdxs,
		MessageInfos:      file_queue_v1_historical_data_point_proto_msgTypes,
	}.Build()
	File_queue_v1_historical_data_point_proto = out.File
	file_queue_v1_historical_data_point_proto_goTypes = nil
	file_queue_v1_historical_data_point_proto_depIdxs = nil
}
