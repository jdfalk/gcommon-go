...
// 	protoc        (unknown)
// source: queue/v1/retry_policy.proto
...
type QueueRetryPolicy struct {
	...
	xxx_hidden_DelayStrategy     v1.RetryDelayStrategy  `protobuf:"varint,5,opt,name=delay_strategy,json=delayStrategy,enum=common.v1.RetryDelayStrategy"`
...
func (x *QueueRetryPolicy) Reset() {
	*x = QueueRetryPolicy{}
	mi := &file_queue_v1_retry_policy_proto_msgTypes[0]
...
func (x *QueueRetryPolicy) GetDelayStrategy() v1.RetryDelayStrategy {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 4) {
			return x.xxx_hidden_DelayStrategy
		}
	}
	return v1.RetryDelayStrategy(0)
}
...
func (x *QueueRetryPolicy) SetDelayStrategy(v v1.RetryDelayStrategy) {
...
func (x *QueueRetryPolicy) ClearDelayStrategy() {
	...
	x.xxx_hidden_DelayStrategy = v1.RetryDelayStrategy_RETRY_DELAY_STRATEGY_UNSPECIFIED
}
...
type QueueRetryPolicy_builder struct {
	...
	DelayStrategy *v1.RetryDelayStrategy
...
var File_queue_v1_retry_policy_proto protoreflect.FileDescriptor

const file_queue_v1_retry_policy_proto_rawDesc = "" +
	"\n" +
	"\x1bqueue/v1/retry_policy.proto\x12\bqueue.v1\x1a$common/v1/retry_delay_strategy.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x95\x03\n" +
	...
	"\rjitter_factor\x18\a \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\fjitterFactorB,Z\"github.com/jdfalk/gcommon/queue/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v1_retry_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v1_retry_policy_proto_goTypes = []any{
	(*QueueRetryPolicy)(nil),    // 0: queue.v1.QueueRetryPolicy
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
	(v1.RetryDelayStrategy)(0),  // 2: common.v1.RetryDelayStrategy
}
var file_queue_v1_retry_policy_proto_depIdxs = []int32{
...
func init() { file_queue_v1_retry_policy_proto_init() }
func file_queue_v1_retry_policy_proto_init() {
	if File_queue_v1_retry_policy_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_retry_policy_proto_rawDesc), len(file_queue_v1_retry_policy_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_retry_policy_proto_goTypes,
		DependencyIndexes: file_queue_v1_retry_policy_proto_depIdxs,
		MessageInfos:      file_queue_v1_retry_policy_proto_msgTypes,
	}.Build()
	File_queue_v1_retry_policy_proto = out.File
	file_queue_v1_retry_policy_proto_goTypes = nil
	file_queue_v1_retry_policy_proto_depIdxs = nil
}
