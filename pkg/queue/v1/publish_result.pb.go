...
// 	protoc        (unknown)
// source: queue/v1/publish_result.proto
...
func (x *PublishResult) Reset() {
	*x = PublishResult{}
	mi := &file_queue_v1_publish_result_proto_msgTypes[0]
...
var File_queue_v1_publish_result_proto protoreflect.FileDescriptor

const file_queue_v1_publish_result_proto_rawDesc = "" +
	"\n" +
	"\x1dqueue/v1/publish_result.proto\x12\bqueue.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xdb\x01\n" +
	"\rPublishResult\x12&\n" +
	"\n" +
	...
	"\ttimestamp\x18\x06 \x01(\x03R\ttimestampB,Z\"github.com/jdfalk/gcommon/queue/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_queue_v1_publish_result_proto_depIdxs = []int32{
...
func init() { file_queue_v1_publish_result_proto_init() }
func file_queue_v1_publish_result_proto_init() {
	if File_queue_v1_publish_result_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_publish_result_proto_rawDesc), len(file_queue_v1_publish_result_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_publish_result_proto_goTypes,
		DependencyIndexes: file_queue_v1_publish_result_proto_depIdxs,
		MessageInfos:      file_queue_v1_publish_result_proto_msgTypes,
	}.Build()
	File_queue_v1_publish_result_proto = out.File
	file_queue_v1_publish_result_proto_goTypes = nil
	file_queue_v1_publish_result_proto_depIdxs = nil
}
