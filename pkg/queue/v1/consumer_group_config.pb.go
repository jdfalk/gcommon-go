...
func (x *ConsumerGroupConfig) Reset() {
	*x = ConsumerGroupConfig{}
	mi := &file_queue_v1_consumer_group_config_proto_msgTypes[0]
...
var File_queue_v1_consumer_group_config_proto protoreflect.FileDescriptor

const file_queue_v1_consumer_group_config_proto_rawDesc = "" +
	"\n" +
	"$queue/v1/consumer_group_config.proto\x12\bqueue.v1\x1a'common/v1/load_balancing_strategy.proto\x1a%common/v1/offset_reset_strategy.proto\x1a\"common/v1/rebalance_strategy.proto\x1a!queue/v1/auto_commit_config.proto\x1a'queue/v1/dead_letter_queue_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9b\x05\n" +
...
func init() { file_queue_v1_consumer_group_config_proto_init() }
func file_queue_v1_consumer_group_config_proto_init() {
	if File_queue_v1_consumer_group_config_proto != nil {
		return
	}
	file_queue_v1_auto_commit_config_proto_init()
	file_queue_v1_dead_letter_queue_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_consumer_group_config_proto_rawDesc), len(file_queue_v1_consumer_group_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_consumer_group_config_proto_goTypes,
		DependencyIndexes: file_queue_v1_consumer_group_config_proto_depIdxs,
		MessageInfos:      file_queue_v1_consumer_group_config_proto_msgTypes,
	}.Build()
	File_queue_v1_consumer_group_config_proto = out.File
	file_queue_v1_consumer_group_config_proto_goTypes = nil
	file_queue_v1_consumer_group_config_proto_depIdxs = nil
}
