...
// 	protoc        (unknown)
// source: queue/v1/ack_request.proto
...
func (x *AckRequest) Reset() {
	*x = AckRequest{}
	mi := &file_queue_v1_ack_request_proto_msgTypes[0]
...
func (x *AckRequest) GetMetadata() *v1.RequestMetadata {
	if x != nil {
...
func (x *AckRequest) SetMetadata(v *v1.RequestMetadata) {
...
var File_queue_v1_ack_request_proto protoreflect.FileDescriptor

const file_queue_v1_ack_request_proto_rawDesc = "" +
	"\n" +
	"\x1aqueue/v1/ack_request.proto\x12\bqueue.v1\x1a common/v1/request_metadata.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x95\x01\n" +
	"\n" +
	"AckRequest\x12(\n" +
	"\n" +
...
var file_queue_v1_ack_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v1_ack_request_proto_goTypes = []any{
	(*AckRequest)(nil),         // 0: queue.v1.AckRequest
	(*v1.RequestMetadata)(nil), // 1: common.v1.RequestMetadata
}
var file_queue_v1_ack_request_proto_depIdxs = []int32{
...
func init() { file_queue_v1_ack_request_proto_init() }
func file_queue_v1_ack_request_proto_init() {
	if File_queue_v1_ack_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_ack_request_proto_rawDesc), len(file_queue_v1_ack_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_ack_request_proto_goTypes,
		DependencyIndexes: file_queue_v1_ack_request_proto_depIdxs,
		MessageInfos:      file_queue_v1_ack_request_proto_msgTypes,
	}.Build()
	File_queue_v1_ack_request_proto = out.File
	file_queue_v1_ack_request_proto_goTypes = nil
	file_queue_v1_ack_request_proto_depIdxs = nil
}
