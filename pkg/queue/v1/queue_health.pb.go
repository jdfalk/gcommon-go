...
// 	protoc        (unknown)
// source: queue/v1/queue_health.proto
...
func (x *QueueHealth) Reset() {
	*x = QueueHealth{}
	mi := &file_queue_v1_queue_health_proto_msgTypes[0]
...
func (x *QueueHealth) GetStatus() v1.CommonHealthStatus {
	if x != nil {
...
func (x *QueueHealth) SetStatus(v v1.CommonHealthStatus) {
...
var File_queue_v1_queue_health_proto protoreflect.FileDescriptor

const file_queue_v1_queue_health_proto_rawDesc = "" +
	"\n" +
	"\x1bqueue/v1/queue_health.proto\x12\bqueue.v1\x1a\x1dcommon/v1/health_status.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xe4\x01\n" +
	"\vQueueHealth\x12(\n" +
	"\n" +
	...
	"\n" +
	"last_check\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tlastCheckB,Z\"github.com/jdfalk/gcommon/queue/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_queue_v1_queue_health_proto_depIdxs = []int32{
...
func init() { file_queue_v1_queue_health_proto_init() }
func file_queue_v1_queue_health_proto_init() {
	if File_queue_v1_queue_health_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_queue_health_proto_rawDesc), len(file_queue_v1_queue_health_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_queue_health_proto_goTypes,
		DependencyIndexes: file_queue_v1_queue_health_proto_depIdxs,
		MessageInfos:      file_queue_v1_queue_health_proto_msgTypes,
	}.Build()
	File_queue_v1_queue_health_proto = out.File
	file_queue_v1_queue_health_proto_goTypes = nil
	file_queue_v1_queue_health_proto_depIdxs = nil
}
