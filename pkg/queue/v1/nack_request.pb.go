...
// 	protoc        (unknown)
// source: queue/v1/nack_request.proto
...
func (x *NackRequest) Reset() {
	*x = NackRequest{}
	mi := &file_queue_v1_nack_request_proto_msgTypes[0]
...
func (x *NackRequest) GetMetadata() *v1.RequestMetadata {
	if x != nil {
...
func (x *NackRequest) SetMetadata(v *v1.RequestMetadata) {
...
var File_queue_v1_nack_request_proto protoreflect.FileDescriptor

const file_queue_v1_nack_request_proto_rawDesc = "" +
	"\n" +
	"\x1bqueue/v1/nack_request.proto\x12\bqueue.v1\x1a common/v1/request_metadata.proto\x1a\x19queue/v1/nack_error.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb8\x02\n" +
	"\vNackRequest\x12$\n" +
...
var file_queue_v1_nack_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v1_nack_request_proto_goTypes = []any{
...
var file_queue_v1_nack_request_proto_depIdxs = []int32{
...
func init() { file_queue_v1_nack_request_proto_init() }
func file_queue_v1_nack_request_proto_init() {
	if File_queue_v1_nack_request_proto != nil {
		return
	}
	file_queue_v1_nack_error_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_nack_request_proto_rawDesc), len(file_queue_v1_nack_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_nack_request_proto_goTypes,
		DependencyIndexes: file_queue_v1_nack_request_proto_depIdxs,
		MessageInfos:      file_queue_v1_nack_request_proto_msgTypes,
	}.Build()
	File_queue_v1_nack_request_proto = out.File
	file_queue_v1_nack_request_proto_goTypes = nil
	file_queue_v1_nack_request_proto_depIdxs = nil
}
