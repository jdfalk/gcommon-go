...
// 	protoc        (unknown)
// source: queue/v1/offset_info.proto
...
func (x *OffsetInfo) Reset() {
	*x = OffsetInfo{}
	mi := &file_queue_v1_offset_info_proto_msgTypes[0]
...
var File_queue_v1_offset_info_proto protoreflect.FileDescriptor

const file_queue_v1_offset_info_proto_rawDesc = "" +
	"\n" +
	"\x1aqueue/v1/offset_info.proto\x12\bqueue.v1\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xbe\x02\n" +
	"\n" +
	"OffsetInfo\x12\x1f\n" +
	...
	"\x10committed_offset\x18\a \x01(\x04B\a\xbaH\x042\x02(\x00R\x0fcommittedOffsetB-Z#github.com/jdfalk/gcommon/pkg/queue\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queue_v1_offset_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queue_v1_offset_info_proto_goTypes = []any{
	(*OffsetInfo)(nil),            // 0: queue.v1.OffsetInfo
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_queue_v1_offset_info_proto_depIdxs = []int32{
...
func init() { file_queue_v1_offset_info_proto_init() }
func file_queue_v1_offset_info_proto_init() {
	if File_queue_v1_offset_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_offset_info_proto_rawDesc), len(file_queue_v1_offset_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_offset_info_proto_goTypes,
		DependencyIndexes: file_queue_v1_offset_info_proto_depIdxs,
		MessageInfos:      file_queue_v1_offset_info_proto_msgTypes,
	}.Build()
	File_queue_v1_offset_info_proto = out.File
	file_queue_v1_offset_info_proto_goTypes = nil
	file_queue_v1_offset_info_proto_depIdxs = nil
}
