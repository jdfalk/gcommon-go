...
func (x *AuthenticationConfig) Reset() {
	*x = AuthenticationConfig{}
	mi := &file_queue_v1_authentication_config_proto_msgTypes[0]
...
func (x case_AuthenticationConfig_AuthType) String() string {
	md := file_queue_v1_authentication_config_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_queue_v1_authentication_config_proto protoreflect.FileDescriptor

const file_queue_v1_authentication_config_proto_rawDesc = "" +
	"\n" +
	"$queue/v1/authentication_config.proto\x12\bqueue.v1\x1a\x1bqueue/v1/api_key_auth.proto\x1a\x1bqueue/v1/o_auth2_auth.proto\x1a\x18queue/v1/sasl_auth.proto\x1a\x17queue/v1/tls_auth.proto\x1a%queue/v1/username_password_auth.proto\x1a!google/protobuf/go_features.proto\"\xba\x02\n" +
...
var file_queue_v1_authentication_config_proto_depIdxs = []int32{
...
func init() { file_queue_v1_authentication_config_proto_init() }
func file_queue_v1_authentication_config_proto_init() {
	if File_queue_v1_authentication_config_proto != nil {
		return
	}
	file_queue_v1_api_key_auth_proto_init()
	file_queue_v1_o_auth2_auth_proto_init()
	file_queue_v1_sasl_auth_proto_init()
	file_queue_v1_tls_auth_proto_init()
	file_queue_v1_username_password_auth_proto_init()
	file_queue_v1_authentication_config_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queue_v1_authentication_config_proto_rawDesc), len(file_queue_v1_authentication_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queue_v1_authentication_config_proto_goTypes,
		DependencyIndexes: file_queue_v1_authentication_config_proto_depIdxs,
		MessageInfos:      file_queue_v1_authentication_config_proto_msgTypes,
	}.Build()
	File_queue_v1_authentication_config_proto = out.File
	file_queue_v1_authentication_config_proto_goTypes = nil
	file_queue_v1_authentication_config_proto_depIdxs = nil
}
