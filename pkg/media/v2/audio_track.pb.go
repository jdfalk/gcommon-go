...
// 	protoc        (unknown)
// source: media/v2/audio_track.proto
...
func (x *AudioTrack) Reset() {
	*x = AudioTrack{}
	mi := &file_media_v2_audio_track_proto_msgTypes[0]
...
var File_media_v2_audio_track_proto protoreflect.FileDescriptor

const file_media_v2_audio_track_proto_rawDesc = "" +
	"\n" +
	"\x1amedia/v2/audio_track.proto\x12\bmedia.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x82\x02\n" +
	"\n" +
	"AudioTrack\x12\x1d\n" +
...
var file_media_v2_audio_track_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_media_v2_audio_track_proto_goTypes = []any{
	(*AudioTrack)(nil), // 0: media.v2.AudioTrack
}
var file_media_v2_audio_track_proto_depIdxs = []int32{
...
func init() { file_media_v2_audio_track_proto_init() }
func file_media_v2_audio_track_proto_init() {
	if File_media_v2_audio_track_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_media_v2_audio_track_proto_rawDesc), len(file_media_v2_audio_track_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_media_v2_audio_track_proto_goTypes,
		DependencyIndexes: file_media_v2_audio_track_proto_depIdxs,
		MessageInfos:      file_media_v2_audio_track_proto_msgTypes,
	}.Build()
	File_media_v2_audio_track_proto = out.File
	file_media_v2_audio_track_proto_goTypes = nil
	file_media_v2_audio_track_proto_depIdxs = nil
}
