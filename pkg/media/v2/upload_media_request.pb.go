...
// 	protoc        (unknown)
// source: media/v2/upload_media_request.proto
...
func (x *UploadMediaRequest) Reset() {
	*x = UploadMediaRequest{}
	mi := &file_media_v2_upload_media_request_proto_msgTypes[0]
...
func (x case_UploadMediaRequest_Data) String() string {
	md := file_media_v2_upload_media_request_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_media_v2_upload_media_request_proto protoreflect.FileDescriptor

const file_media_v2_upload_media_request_proto_rawDesc = "" +
	"\n" +
	"#media/v2/upload_media_request.proto\x12\bmedia.v2\x1a!google/protobuf/go_features.proto\x1a\x1emedia/v2/upload_metadata.proto\"l\n" +
...
var file_media_v2_upload_media_request_proto_depIdxs = []int32{
...
func init() { file_media_v2_upload_media_request_proto_init() }
func file_media_v2_upload_media_request_proto_init() {
	if File_media_v2_upload_media_request_proto != nil {
		return
	}
	file_media_v2_upload_metadata_proto_init()
	file_media_v2_upload_media_request_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_media_v2_upload_media_request_proto_rawDesc), len(file_media_v2_upload_media_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_media_v2_upload_media_request_proto_goTypes,
		DependencyIndexes: file_media_v2_upload_media_request_proto_depIdxs,
		MessageInfos:      file_media_v2_upload_media_request_proto_msgTypes,
	}.Build()
	File_media_v2_upload_media_request_proto = out.File
	file_media_v2_upload_media_request_proto_goTypes = nil
	file_media_v2_upload_media_request_proto_depIdxs = nil
}
