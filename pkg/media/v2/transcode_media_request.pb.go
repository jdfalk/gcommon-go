...
// 	protoc        (unknown)
// source: media/v2/transcode_media_request.proto
...
func (x *TranscodeMediaRequest) Reset() {
	*x = TranscodeMediaRequest{}
	mi := &file_media_v2_transcode_media_request_proto_msgTypes[0]
...
var File_media_v2_transcode_media_request_proto protoreflect.FileDescriptor

const file_media_v2_transcode_media_request_proto_rawDesc = "" +
	"\n" +
	"&media/v2/transcode_media_request.proto\x12\bmedia.v2\x1a media/v2/transcode_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc2\x01\n" +
	...
	"\aoptions\x18\x04 \x01(\v2\x1a.media.v2.TranscodeOptionsR\aoptionsB0Z&github.com/jdfalk/gcommon/pkg/media/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_media_v2_transcode_media_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_media_v2_transcode_media_request_proto_goTypes = []any{
	(*TranscodeMediaRequest)(nil), // 0: media.v2.TranscodeMediaRequest
	(*TranscodeOptions)(nil),      // 1: media.v2.TranscodeOptions
}
var file_media_v2_transcode_media_request_proto_depIdxs = []int32{
...
func init() { file_media_v2_transcode_media_request_proto_init() }
func file_media_v2_transcode_media_request_proto_init() {
	if File_media_v2_transcode_media_request_proto != nil {
		return
	}
	file_media_v2_transcode_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_media_v2_transcode_media_request_proto_rawDesc), len(file_media_v2_transcode_media_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_media_v2_transcode_media_request_proto_goTypes,
		DependencyIndexes: file_media_v2_transcode_media_request_proto_depIdxs,
		MessageInfos:      file_media_v2_transcode_media_request_proto_msgTypes,
	}.Build()
	File_media_v2_transcode_media_request_proto = out.File
	file_media_v2_transcode_media_request_proto_goTypes = nil
	file_media_v2_transcode_media_request_proto_depIdxs = nil
}
