...
// 	protoc        (unknown)
// source: media/v2/transcode_options.proto
...
func (x *TranscodeOptions) Reset() {
	*x = TranscodeOptions{}
	mi := &file_media_v2_transcode_options_proto_msgTypes[0]
...
var File_media_v2_transcode_options_proto protoreflect.FileDescriptor

const file_media_v2_transcode_options_proto_rawDesc = "" +
	"\n" +
	" media/v2/transcode_options.proto\x12\bmedia.v2\x1a!google/protobuf/go_features.proto\"\x8c\x02\n" +
	...
	"\x11preserve_chapters\x18\a \x01(\bR\x10preserveChaptersB0Z&github.com/jdfalk/gcommon/pkg/media/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_media_v2_transcode_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_media_v2_transcode_options_proto_goTypes = []any{
	(*TranscodeOptions)(nil), // 0: media.v2.TranscodeOptions
}
var file_media_v2_transcode_options_proto_depIdxs = []int32{
...
func init() { file_media_v2_transcode_options_proto_init() }
func file_media_v2_transcode_options_proto_init() {
	if File_media_v2_transcode_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_media_v2_transcode_options_proto_rawDesc), len(file_media_v2_transcode_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_media_v2_transcode_options_proto_goTypes,
		DependencyIndexes: file_media_v2_transcode_options_proto_depIdxs,
		MessageInfos:      file_media_v2_transcode_options_proto_msgTypes,
	}.Build()
	File_media_v2_transcode_options_proto = out.File
	file_media_v2_transcode_options_proto_goTypes = nil
	file_media_v2_transcode_options_proto_depIdxs = nil
}
