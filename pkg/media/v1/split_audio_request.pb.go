...
func (x *SplitAudioRequest) Reset() {
	*x = SplitAudioRequest{}
	mi := &file_media_v1_split_audio_request_proto_msgTypes[0]
...
var File_media_v1_split_audio_request_proto protoreflect.FileDescriptor

const file_media_v1_split_audio_request_proto_rawDesc = "" +
	"\n" +
...
var file_media_v1_split_audio_request_proto_depIdxs = []int32{
...
func init() { file_media_v1_split_audio_request_proto_init() }
func file_media_v1_split_audio_request_proto_init() {
	if File_media_v1_split_audio_request_proto != nil {
		return
	}
	file_media_v1_split_point_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_media_v1_split_audio_request_proto_rawDesc), len(file_media_v1_split_audio_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_media_v1_split_audio_request_proto_goTypes,
		DependencyIndexes: file_media_v1_split_audio_request_proto_depIdxs,
		MessageInfos:      file_media_v1_split_audio_request_proto_msgTypes,
	}.Build()
	File_media_v1_split_audio_request_proto = out.File
	file_media_v1_split_audio_request_proto_goTypes = nil
	file_media_v1_split_audio_request_proto_depIdxs = nil
}
