...
// 	protoc        (unknown)
// source: media/v1/upload_metadata.proto
...
func (x *UploadMetadata) Reset() {
	*x = UploadMetadata{}
	mi := &file_media_v1_upload_metadata_proto_msgTypes[0]
...
var File_media_v1_upload_metadata_proto protoreflect.FileDescriptor

const file_media_v1_upload_metadata_proto_rawDesc = "" +
	"\n" +
	"\x1emedia/v1/upload_metadata.proto\x12\bmedia.v1\x1a\x1dmedia/v1/media_metadata.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc9\x01\n" +
	...
	"\x0emedia_metadata\x18\x04 \x01(\v2\x17.media.v1.MediaMetadataR\rmediaMetadataB,Z\"github.com/jdfalk/gcommon/media/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_media_v1_upload_metadata_proto_goTypes = []any{
	(*UploadMetadata)(nil), // 0: media.v1.UploadMetadata
	(*MediaMetadata)(nil),  // 1: media.v1.MediaMetadata
}
var file_media_v1_upload_metadata_proto_depIdxs = []int32{
	1, // 0: media.v1.UploadMetadata.media_metadata:type_name -> media.v1.MediaMetadata
...
func init() { file_media_v1_upload_metadata_proto_init() }
func file_media_v1_upload_metadata_proto_init() {
	if File_media_v1_upload_metadata_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_media_v1_upload_metadata_proto_rawDesc), len(file_media_v1_upload_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_media_v1_upload_metadata_proto_goTypes,
		DependencyIndexes: file_media_v1_upload_metadata_proto_depIdxs,
		MessageInfos:      file_media_v1_upload_metadata_proto_msgTypes,
	}.Build()
	File_media_v1_upload_metadata_proto = out.File
	file_media_v1_upload_metadata_proto_goTypes = nil
	file_media_v1_upload_metadata_proto_depIdxs = nil
}
