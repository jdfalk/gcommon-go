...
func (x *MergeOptions) Reset() {
	*x = MergeOptions{}
	mi := &file_media_v1_merge_options_proto_msgTypes[0]
...
var File_media_v1_merge_options_proto protoreflect.FileDescriptor

const file_media_v1_merge_options_proto_rawDesc = "" +
	"\n" +
	"\x1cmedia/v1/merge_options.proto\x12\bmedia.v1\x1a#common/v1/conflict_resolution.proto\x1a!google/protobuf/go_features.proto\"\xe0\x01\n" +
	"\fMergeOptions\x12#\n" +
...
func init() { file_media_v1_merge_options_proto_init() }
func file_media_v1_merge_options_proto_init() {
	if File_media_v1_merge_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_media_v1_merge_options_proto_rawDesc), len(file_media_v1_merge_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_media_v1_merge_options_proto_goTypes,
		DependencyIndexes: file_media_v1_merge_options_proto_depIdxs,
		MessageInfos:      file_media_v1_merge_options_proto_msgTypes,
	}.Build()
	File_media_v1_merge_options_proto = out.File
	file_media_v1_merge_options_proto_goTypes = nil
	file_media_v1_merge_options_proto_depIdxs = nil
}
