...
// 	protoc        (unknown)
// source: organizationpb/v1/update_team_request.proto
...
func (x *UpdateTeamRequest) Reset() {
	*x = UpdateTeamRequest{}
	mi := &file_organizationpb_v1_update_team_request_proto_msgTypes[0]
...
func (x *UpdateTeamRequest) GetMetadata() *commonpb.RequestMetadata {
	if x != nil {
...
func (x *UpdateTeamRequest) SetMetadata(v *commonpb.RequestMetadata) {
...
var File_organizationpb_v1_update_team_request_proto protoreflect.FileDescriptor

const file_organizationpb_v1_update_team_request_proto_rawDesc = "" +
	"\n" +
	"+organizationpb/v1/update_team_request.proto\x12\x0forganization.v1\x1a\"commonpb/v1/request_metadata.proto\x1a\x1corganizationpb/v1/team.proto\x1a google/protobuf/field_mask.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xfa\x01\n" +
	"\x11UpdateTeamRequest\x126\n" +
	...
	"updateMask\x12#\n" +
	"\rvalidate_only\x18\x05 \x01(\bR\fvalidateOnlyB\xc0\x01\n" +
	"\x13com.organization.v1B\x16UpdateTeamRequestProtoP\x01Z,github.com/jdfalk/gcommon/pkg/organizationpb\xa2\x02\x03OXX\xaa\x02\x0fOrganization.V1\xca\x02\x0fOrganization\\V1\xe2\x02\x1bOrganization\\V1\\GPBMetadata\xea\x02\x10Organization::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organizationpb_v1_update_team_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organizationpb_v1_update_team_request_proto_goTypes = []any{
...
var file_organizationpb_v1_update_team_request_proto_depIdxs = []int32{
	1, // 0: organization.v1.UpdateTeamRequest.metadata:type_name -> common.v1.RequestMetadata
	2, // 1: organization.v1.UpdateTeamRequest.team:type_name -> organization.v1.Team
	3, // 2: organization.v1.UpdateTeamRequest.update_mask:type_name -> google.protobuf.FieldMask
...
func init() { file_organizationpb_v1_update_team_request_proto_init() }
func file_organizationpb_v1_update_team_request_proto_init() {
	if File_organizationpb_v1_update_team_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v1_update_team_request_proto_rawDesc), len(file_organizationpb_v1_update_team_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v1_update_team_request_proto_goTypes,
		DependencyIndexes: file_organizationpb_v1_update_team_request_proto_depIdxs,
		MessageInfos:      file_organizationpb_v1_update_team_request_proto_msgTypes,
	}.Build()
	File_organizationpb_v1_update_team_request_proto = out.File
	file_organizationpb_v1_update_team_request_proto_goTypes = nil
	file_organizationpb_v1_update_team_request_proto_depIdxs = nil
}
