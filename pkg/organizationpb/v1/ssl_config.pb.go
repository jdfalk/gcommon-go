...
// 	protoc        (unknown)
// source: organizationpb/v1/ssl_config.proto
...
func (x *SSLConfig) Reset() {
	*x = SSLConfig{}
	mi := &file_organizationpb_v1_ssl_config_proto_msgTypes[0]
...
var File_organizationpb_v1_ssl_config_proto protoreflect.FileDescriptor

const file_organizationpb_v1_ssl_config_proto_rawDesc = "" +
	"\n" +
	"\"organizationpb/v1/ssl_config.proto\x12\x0forganization.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc9\x01\n" +
	"\tSSLConfig\x12.\n" +
	...
	"\x0fmin_tls_version\x18\x04 \x01(\tB\x17\xbaH\x14r\x122\x10^v?\\d+\\.\\d+\\.\\d+R\rminTlsVersionB\xb8\x01\n" +
	"\x13com.organization.v1B\x0eSslConfigProtoP\x01Z,github.com/jdfalk/gcommon/pkg/organizationpb\xa2\x02\x03OXX\xaa\x02\x0fOrganization.V1\xca\x02\x0fOrganization\\V1\xe2\x02\x1bOrganization\\V1\\GPBMetadata\xea\x02\x10Organization::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organizationpb_v1_ssl_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organizationpb_v1_ssl_config_proto_goTypes = []any{
	(*SSLConfig)(nil), // 0: organization.v1.SSLConfig
}
var file_organizationpb_v1_ssl_config_proto_depIdxs = []int32{
...
func init() { file_organizationpb_v1_ssl_config_proto_init() }
func file_organizationpb_v1_ssl_config_proto_init() {
	if File_organizationpb_v1_ssl_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v1_ssl_config_proto_rawDesc), len(file_organizationpb_v1_ssl_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v1_ssl_config_proto_goTypes,
		DependencyIndexes: file_organizationpb_v1_ssl_config_proto_depIdxs,
		MessageInfos:      file_organizationpb_v1_ssl_config_proto_msgTypes,
	}.Build()
	File_organizationpb_v1_ssl_config_proto = out.File
	file_organizationpb_v1_ssl_config_proto_goTypes = nil
	file_organizationpb_v1_ssl_config_proto_depIdxs = nil
}
