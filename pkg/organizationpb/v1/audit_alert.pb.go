...
// 	protoc        (unknown)
// source: organizationpb/v1/audit_alert.proto
...
func (x *AuditAlert) Reset() {
	*x = AuditAlert{}
	mi := &file_organizationpb_v1_audit_alert_proto_msgTypes[0]
...
var File_organizationpb_v1_audit_alert_proto protoreflect.FileDescriptor

const file_organizationpb_v1_audit_alert_proto_rawDesc = "" +
	"\n" +
	"#organizationpb/v1/audit_alert.proto\x12\x0forganization.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf1\x01\n" +
	"\n" +
	"AuditAlert\x12\x1d\n" +
...
var file_organizationpb_v1_audit_alert_proto_depIdxs = []int32{
...
func init() { file_organizationpb_v1_audit_alert_proto_init() }
func file_organizationpb_v1_audit_alert_proto_init() {
	if File_organizationpb_v1_audit_alert_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v1_audit_alert_proto_rawDesc), len(file_organizationpb_v1_audit_alert_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v1_audit_alert_proto_goTypes,
		DependencyIndexes: file_organizationpb_v1_audit_alert_proto_depIdxs,
		MessageInfos:      file_organizationpb_v1_audit_alert_proto_msgTypes,
	}.Build()
	File_organizationpb_v1_audit_alert_proto = out.File
	file_organizationpb_v1_audit_alert_proto_goTypes = nil
	file_organizationpb_v1_audit_alert_proto_depIdxs = nil
}
