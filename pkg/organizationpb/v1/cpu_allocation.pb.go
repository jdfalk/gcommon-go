...
// 	protoc        (unknown)
// source: organizationpb/v1/cpu_allocation.proto
...
func (x *CPUAllocation) Reset() {
	*x = CPUAllocation{}
	mi := &file_organizationpb_v1_cpu_allocation_proto_msgTypes[0]
...
var File_organizationpb_v1_cpu_allocation_proto protoreflect.FileDescriptor

const file_organizationpb_v1_cpu_allocation_proto_rawDesc = "" +
	"\n" +
	"&organizationpb/v1/cpu_allocation.proto\x12\x0forganization.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbd\x01\n" +
	"\rCPUAllocation\x12\x1d\n" +
	"\x05cores\x18\x01 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x05cores\x12,\n" +
	"\rfrequency_mhz\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\ffrequencyMhz\x12:\n" +
	"\x13usage_limit_percent\x18\x03 \x01(\x05B\n" +
	"\xbaH\a\x1a\x05\x18\x96\x01(\x00R\x11usageLimitPercent\x12#\n" +
	"\bpriority\x18\x04 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\bpriorityB\xbc\x01\n" +
	"\x13com.organization.v1B\x12CpuAllocationProtoP\x01Z,github.com/jdfalk/gcommon/pkg/organizationpb\xa2\x02\x03OXX\xaa\x02\x0fOrganization.V1\xca\x02\x0fOrganization\\V1\xe2\x02\x1bOrganization\\V1\\GPBMetadata\xea\x02\x10Organization::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organizationpb_v1_cpu_allocation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organizationpb_v1_cpu_allocation_proto_goTypes = []any{
	(*CPUAllocation)(nil), // 0: organization.v1.CPUAllocation
}
var file_organizationpb_v1_cpu_allocation_proto_depIdxs = []int32{
...
func init() { file_organizationpb_v1_cpu_allocation_proto_init() }
func file_organizationpb_v1_cpu_allocation_proto_init() {
	if File_organizationpb_v1_cpu_allocation_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v1_cpu_allocation_proto_rawDesc), len(file_organizationpb_v1_cpu_allocation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v1_cpu_allocation_proto_goTypes,
		DependencyIndexes: file_organizationpb_v1_cpu_allocation_proto_depIdxs,
		MessageInfos:      file_organizationpb_v1_cpu_allocation_proto_msgTypes,
	}.Build()
	File_organizationpb_v1_cpu_allocation_proto = out.File
	file_organizationpb_v1_cpu_allocation_proto_goTypes = nil
	file_organizationpb_v1_cpu_allocation_proto_depIdxs = nil
}
