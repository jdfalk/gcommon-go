...
// 	protoc        (unknown)
// source: organizationpb/v1/tenant_isolation.proto
...
type TenantIsolation struct {
	...
	xxx_hidden_Level         commonpb.OrganizationIsolationLevel `protobuf:"varint,2,opt,name=level,enum=common.v1.OrganizationIsolationLevel"`
	...
	xxx_hidden_AccessControl *commonpb.OrganizationAccessControl `protobuf:"bytes,8,opt,name=access_control,json=accessControl"`
	xxx_hidden_Audit         *AuditConfig                        `protobuf:"bytes,9,opt,name=audit"`
	xxx_hidden_Metadata      *[]*commonpb.KeyValue               `protobuf:"bytes,10,rep,name=metadata"`
...
func (x *TenantIsolation) Reset() {
	*x = TenantIsolation{}
	mi := &file_organizationpb_v1_tenant_isolation_proto_msgTypes[0]
...
func (x *TenantIsolation) GetLevel() commonpb.OrganizationIsolationLevel {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			return x.xxx_hidden_Level
		}
	}
	return commonpb.OrganizationIsolationLevel(0)
}
...
func (x *TenantIsolation) GetAccessControl() *commonpb.OrganizationAccessControl {
	if x != nil {
...
func (x *TenantIsolation) GetMetadata() []*commonpb.KeyValue {
	if x != nil {
...
func (x *TenantIsolation) SetLevel(v commonpb.OrganizationIsolationLevel) {
...
func (x *TenantIsolation) SetAccessControl(v *commonpb.OrganizationAccessControl) {
...
func (x *TenantIsolation) SetMetadata(v []*commonpb.KeyValue) {
...
func (x *TenantIsolation) ClearLevel() {
	...
	x.xxx_hidden_Level = commonpb.OrganizationIsolationLevel_ISOLATION_LEVEL_UNSPECIFIED
}
...
type TenantIsolation_builder struct {
	...
	Level *commonpb.OrganizationIsolationLevel
	...
	AccessControl *commonpb.OrganizationAccessControl
...
var File_organizationpb_v1_tenant_isolation_proto protoreflect.FileDescriptor

const file_organizationpb_v1_tenant_isolation_proto_rawDesc = "" +
	"\n" +
	"(organizationpb/v1/tenant_isolation.proto\x12\x0forganization.v1\x1a!commonpb/v1/isolation_level.proto\x1a\x1bcommonpb/v1/key_value.proto\x1a-commonpb/v1/organization_access_control.proto\x1a$organizationpb/v1/audit_config.proto\x1a)organizationpb/v1/compute_isolation.proto\x1a*organizationpb/v1/database_isolation.proto\x1a)organizationpb/v1/encryption_config.proto\x1a)organizationpb/v1/network_isolation.proto\x1a)organizationpb/v1/storage_isolation.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x90\x06\n" +
	"\x0fTenantIsolation\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12;\n" +
	"\x05level\x18\x02 \x01(\x0e2%.common.v1.OrganizationIsolationLevelR\x05level\x12>\n" +
	"\bdatabase\x18\x03 \x01(\v2\".organization.v1.DatabaseIsolationR\bdatabase\x12;\n" +
	"\anetwork\x18\x04 \x01(\v2!.organization.v1.NetworkIsolationR\anetwork\x12;\n" +
	"\astorage\x18\x05 \x01(\v2!.organization.v1.StorageIsolationR\astorage\x12;\n" +
	"\acompute\x18\x06 \x01(\v2!.organization.v1.ComputeIsolationR\acompute\x12M\n" +
	"\n" +
	"encryption\x18\a \x01(\v2-.organization.v1.OrganizationEncryptionConfigR\n" +
	"encryption\x12K\n" +
	"\x0eaccess_control\x18\b \x01(\v2$.common.v1.OrganizationAccessControlR\raccessControl\x122\n" +
	"\x05audit\x18\t \x01(\v2\x1c.organization.v1.AuditConfigR\x05audit\x123\n" +
	"\bmetadata\x18\n" +
	" \x03(\v2\x13.common.v1.KeyValueB\x02(\x01R\bmetadata\x12C\n" +
	"\n" +
	"created_at\x18\v \x01(\v2\x1a.google.protobuf.TimestampB\b\xbaH\x03\xc8\x01\x01(\x01R\tcreatedAt\x12=\n" +
	"\n" +
	"updated_at\x18\f \x01(\v2\x1a.google.protobuf.TimestampB\x02(\x01R\tupdatedAt\x12#\n" +
	"\rconfigured_by\x18\r \x01(\tR\fconfiguredByB\xbe\x01\n" +
	"\x13com.organization.v1B\x14TenantIsolationProtoP\x01Z,github.com/jdfalk/gcommon/pkg/organizationpb\xa2\x02\x03OXX\xaa\x02\x0fOrganization.V1\xca\x02\x0fOrganization\\V1\xe2\x02\x1bOrganization\\V1\\GPBMetadata\xea\x02\x10Organization::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organizationpb_v1_tenant_isolation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organizationpb_v1_tenant_isolation_proto_goTypes = []any{
	(*TenantIsolation)(nil),                    // 0: organization.v1.TenantIsolation
	(commonpb.OrganizationIsolationLevel)(0),   // 1: common.v1.OrganizationIsolationLevel
	(*DatabaseIsolation)(nil),                  // 2: organization.v1.DatabaseIsolation
	(*NetworkIsolation)(nil),                   // 3: organization.v1.NetworkIsolation
	(*StorageIsolation)(nil),                   // 4: organization.v1.StorageIsolation
	(*ComputeIsolation)(nil),                   // 5: organization.v1.ComputeIsolation
	(*OrganizationEncryptionConfig)(nil),       // 6: organization.v1.OrganizationEncryptionConfig
	(*commonpb.OrganizationAccessControl)(nil), // 7: common.v1.OrganizationAccessControl
	(*AuditConfig)(nil),                        // 8: organization.v1.AuditConfig
	(*commonpb.KeyValue)(nil),                  // 9: common.v1.KeyValue
	(*timestamppb.Timestamp)(nil),              // 10: google.protobuf.Timestamp
}
var file_organizationpb_v1_tenant_isolation_proto_depIdxs = []int32{
	1,  // 0: organization.v1.TenantIsolation.level:type_name -> common.v1.OrganizationIsolationLevel
	2,  // 1: organization.v1.TenantIsolation.database:type_name -> organization.v1.DatabaseIsolation
	3,  // 2: organization.v1.TenantIsolation.network:type_name -> organization.v1.NetworkIsolation
	4,  // 3: organization.v1.TenantIsolation.storage:type_name -> organization.v1.StorageIsolation
	5,  // 4: organization.v1.TenantIsolation.compute:type_name -> organization.v1.ComputeIsolation
	6,  // 5: organization.v1.TenantIsolation.encryption:type_name -> organization.v1.OrganizationEncryptionConfig
	7,  // 6: organization.v1.TenantIsolation.access_control:type_name -> common.v1.OrganizationAccessControl
	8,  // 7: organization.v1.TenantIsolation.audit:type_name -> organization.v1.AuditConfig
	9,  // 8: organization.v1.TenantIsolation.metadata:type_name -> common.v1.KeyValue
	10, // 9: organization.v1.TenantIsolation.created_at:type_name -> google.protobuf.Timestamp
	10, // 10: organization.v1.TenantIsolation.updated_at:type_name -> google.protobuf.Timestamp
...
func init() { file_organizationpb_v1_tenant_isolation_proto_init() }
func file_organizationpb_v1_tenant_isolation_proto_init() {
	if File_organizationpb_v1_tenant_isolation_proto != nil {
		return
	}
	file_organizationpb_v1_audit_config_proto_init()
	file_organizationpb_v1_compute_isolation_proto_init()
	file_organizationpb_v1_database_isolation_proto_init()
	file_organizationpb_v1_encryption_config_proto_init()
	file_organizationpb_v1_network_isolation_proto_init()
	file_organizationpb_v1_storage_isolation_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v1_tenant_isolation_proto_rawDesc), len(file_organizationpb_v1_tenant_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v1_tenant_isolation_proto_goTypes,
		DependencyIndexes: file_organizationpb_v1_tenant_isolation_proto_depIdxs,
		MessageInfos:      file_organizationpb_v1_tenant_isolation_proto_msgTypes,
	}.Build()
	File_organizationpb_v1_tenant_isolation_proto = out.File
	file_organizationpb_v1_tenant_isolation_proto_goTypes = nil
	file_organizationpb_v1_tenant_isolation_proto_depIdxs = nil
}
