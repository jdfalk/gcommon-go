...
// 	protoc        (unknown)
// source: organizationpb/v1/hierarchy_path.proto
...
func (x *HierarchyPath) Reset() {
	*x = HierarchyPath{}
	mi := &file_organizationpb_v1_hierarchy_path_proto_msgTypes[0]
...
var File_organizationpb_v1_hierarchy_path_proto protoreflect.FileDescriptor

const file_organizationpb_v1_hierarchy_path_proto_rawDesc = "" +
	"\n" +
	"&organizationpb/v1/hierarchy_path.proto\x12\x0forganization.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb5\x01\n" +
	"\rHierarchyPath\x12,\n" +
	"\rdescendant_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\fdescendantId\x12(\n" +
	"\vancestor_id\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\n" +
	"ancestorId\x12#\n" +
	"\bdistance\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\bdistance\x12'\n" +
	"\n" +
	"path_nodes\x18\x04 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\tpathNodesB\xbc\x01\n" +
	"\x13com.organization.v1B\x12HierarchyPathProtoP\x01Z,github.com/jdfalk/gcommon/pkg/organizationpb\xa2\x02\x03OXX\xaa\x02\x0fOrganization.V1\xca\x02\x0fOrganization\\V1\xe2\x02\x1bOrganization\\V1\\GPBMetadata\xea\x02\x10Organization::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organizationpb_v1_hierarchy_path_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organizationpb_v1_hierarchy_path_proto_goTypes = []any{
	(*HierarchyPath)(nil), // 0: organization.v1.HierarchyPath
}
var file_organizationpb_v1_hierarchy_path_proto_depIdxs = []int32{
...
func init() { file_organizationpb_v1_hierarchy_path_proto_init() }
func file_organizationpb_v1_hierarchy_path_proto_init() {
	if File_organizationpb_v1_hierarchy_path_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v1_hierarchy_path_proto_rawDesc), len(file_organizationpb_v1_hierarchy_path_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v1_hierarchy_path_proto_goTypes,
		DependencyIndexes: file_organizationpb_v1_hierarchy_path_proto_depIdxs,
		MessageInfos:      file_organizationpb_v1_hierarchy_path_proto_msgTypes,
	}.Build()
	File_organizationpb_v1_hierarchy_path_proto = out.File
	file_organizationpb_v1_hierarchy_path_proto_goTypes = nil
	file_organizationpb_v1_hierarchy_path_proto_depIdxs = nil
}
