...
// 	protoc        (unknown)
// source: organizationpb/v1/compute_isolation.proto
...
type ComputeIsolation struct {
	...
	xxx_hidden_Limits           *commonpb.OrganizationResourceLimits `protobuf:"bytes,6,opt,name=limits"`
...
func (x *ComputeIsolation) Reset() {
	*x = ComputeIsolation{}
	mi := &file_organizationpb_v1_compute_isolation_proto_msgTypes[0]
...
func (x *ComputeIsolation) GetLimits() *commonpb.OrganizationResourceLimits {
	if x != nil {
...
func (x *ComputeIsolation) SetLimits(v *commonpb.OrganizationResourceLimits) {
...
type ComputeIsolation_builder struct {
	...
	Limits *commonpb.OrganizationResourceLimits
...
var File_organizationpb_v1_compute_isolation_proto protoreflect.FileDescriptor

const file_organizationpb_v1_compute_isolation_proto_rawDesc = "" +
	"\n" +
	")organizationpb/v1/compute_isolation.proto\x12\x0forganization.v1\x1a.commonpb/v1/organization_resource_limits.proto\x1a+organizationpb/v1/auto_scaling_config.proto\x1a&organizationpb/v1/cpu_allocation.proto\x1a)organizationpb/v1/memory_allocation.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x8d\x03\n" +
	...
	"\x03cpu\x18\x03 \x01(\v2\x1e.organization.v1.CPUAllocationR\x03cpu\x129\n" +
...
var file_organizationpb_v1_compute_isolation_proto_goTypes = []any{
	...
	(*commonpb.OrganizationResourceLimits)(nil), // 3: common.v1.OrganizationResourceLimits
	(*AutoScalingConfig)(nil),                   // 4: organization.v1.AutoScalingConfig
}
var file_organizationpb_v1_compute_isolation_proto_depIdxs = []int32{
	1, // 0: organization.v1.ComputeIsolation.cpu:type_name -> organization.v1.CPUAllocation
	2, // 1: organization.v1.ComputeIsolation.memory:type_name -> organization.v1.MemoryAllocation
	3, // 2: organization.v1.ComputeIsolation.limits:type_name -> common.v1.OrganizationResourceLimits
	4, // 3: organization.v1.ComputeIsolation.auto_scaling:type_name -> organization.v1.AutoScalingConfig
...
func init() { file_organizationpb_v1_compute_isolation_proto_init() }
func file_organizationpb_v1_compute_isolation_proto_init() {
	if File_organizationpb_v1_compute_isolation_proto != nil {
		return
	}
	file_organizationpb_v1_auto_scaling_config_proto_init()
	file_organizationpb_v1_cpu_allocation_proto_init()
	file_organizationpb_v1_memory_allocation_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v1_compute_isolation_proto_rawDesc), len(file_organizationpb_v1_compute_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v1_compute_isolation_proto_goTypes,
		DependencyIndexes: file_organizationpb_v1_compute_isolation_proto_depIdxs,
		MessageInfos:      file_organizationpb_v1_compute_isolation_proto_msgTypes,
	}.Build()
	File_organizationpb_v1_compute_isolation_proto = out.File
	file_organizationpb_v1_compute_isolation_proto_goTypes = nil
	file_organizationpb_v1_compute_isolation_proto_depIdxs = nil
}
