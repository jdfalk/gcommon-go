...
// 	protoc        (unknown)
// source: organizationpb/v1/database_isolation.proto
...
type DatabaseIsolation struct {
	...
	xxx_hidden_ConnectionParams    *[]*commonpb.KeyValue     `protobuf:"bytes,3,rep,name=connection_params,json=connectionParams"`
...
func (x *DatabaseIsolation) Reset() {
	*x = DatabaseIsolation{}
	mi := &file_organizationpb_v1_database_isolation_proto_msgTypes[0]
...
func (x *DatabaseIsolation) GetConnectionParams() []*commonpb.KeyValue {
	if x != nil {
...
func (x *DatabaseIsolation) SetConnectionParams(v []*commonpb.KeyValue) {
...
type DatabaseIsolation_builder struct {
	...
	ConnectionParams []*commonpb.KeyValue
...
var File_organizationpb_v1_database_isolation_proto protoreflect.FileDescriptor

const file_organizationpb_v1_database_isolation_proto_rawDesc = "" +
	"\n" +
	"*organizationpb/v1/database_isolation.proto\x12\x0forganization.v1\x1a\x1bcommonpb/v1/key_value.proto\x1a%organizationpb/v1/backup_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb0\x03\n" +
	...
	"schemaName\x12D\n" +
	"\x11connection_params\x18\x03 \x03(\v2\x13.common.v1.KeyValueB\x02(\x01R\x10connectionParams\x12-\n" +
...
var file_organizationpb_v1_database_isolation_proto_depIdxs = []int32{
	1, // 0: organization.v1.DatabaseIsolation.connection_params:type_name -> common.v1.KeyValue
	2, // 1: organization.v1.DatabaseIsolation.backup:type_name -> organization.v1.OrganizationBackupConfig
...
func init() { file_organizationpb_v1_database_isolation_proto_init() }
func file_organizationpb_v1_database_isolation_proto_init() {
	if File_organizationpb_v1_database_isolation_proto != nil {
		return
	}
	file_organizationpb_v1_backup_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v1_database_isolation_proto_rawDesc), len(file_organizationpb_v1_database_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v1_database_isolation_proto_goTypes,
		DependencyIndexes: file_organizationpb_v1_database_isolation_proto_depIdxs,
		MessageInfos:      file_organizationpb_v1_database_isolation_proto_msgTypes,
	}.Build()
	File_organizationpb_v1_database_isolation_proto = out.File
	file_organizationpb_v1_database_isolation_proto_goTypes = nil
	file_organizationpb_v1_database_isolation_proto_depIdxs = nil
}
