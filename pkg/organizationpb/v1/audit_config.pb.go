...
// 	protoc        (unknown)
// source: organizationpb/v1/audit_config.proto
...
func (x *AuditConfig) Reset() {
	*x = AuditConfig{}
	mi := &file_organizationpb_v1_audit_config_proto_msgTypes[0]
...
var File_organizationpb_v1_audit_config_proto protoreflect.FileDescriptor

const file_organizationpb_v1_audit_config_proto_rawDesc = "" +
	"\n" +
	"$organizationpb/v1/audit_config.proto\x12\x0forganization.v1\x1a#organizationpb/v1/audit_alert.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb8\x02\n" +
	"\vAuditConfig\x12#\n" +
	"\raudit_enabled\x18\x01 \x01(\bR\fauditEnabled\x12.\n" +
	"\x0eretention_days\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\rretentionDays\x122\n" +
	...
	"\x06alerts\x18\x06 \x03(\v2\x1b.organization.v1.AuditAlertB\b\xbaH\x05\x92\x01\x02\b\x01R\x06alertsB\xba\x01\n" +
	"\x13com.organization.v1B\x10AuditConfigProtoP\x01Z,github.com/jdfalk/gcommon/pkg/organizationpb\xa2\x02\x03OXX\xaa\x02\x0fOrganization.V1\xca\x02\x0fOrganization\\V1\xe2\x02\x1bOrganization\\V1\\GPBMetadata\xea\x02\x10Organization::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organizationpb_v1_audit_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organizationpb_v1_audit_config_proto_goTypes = []any{
	(*AuditConfig)(nil), // 0: organization.v1.AuditConfig
	(*AuditAlert)(nil),  // 1: organization.v1.AuditAlert
}
var file_organizationpb_v1_audit_config_proto_depIdxs = []int32{
	1, // 0: organization.v1.AuditConfig.alerts:type_name -> organization.v1.AuditAlert
...
func init() { file_organizationpb_v1_audit_config_proto_init() }
func file_organizationpb_v1_audit_config_proto_init() {
	if File_organizationpb_v1_audit_config_proto != nil {
		return
	}
	file_organizationpb_v1_audit_alert_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v1_audit_config_proto_rawDesc), len(file_organizationpb_v1_audit_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v1_audit_config_proto_goTypes,
		DependencyIndexes: file_organizationpb_v1_audit_config_proto_depIdxs,
		MessageInfos:      file_organizationpb_v1_audit_config_proto_msgTypes,
	}.Build()
	File_organizationpb_v1_audit_config_proto = out.File
	file_organizationpb_v1_audit_config_proto_goTypes = nil
	file_organizationpb_v1_audit_config_proto_depIdxs = nil
}
