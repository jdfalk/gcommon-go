...
// 	protoc        (unknown)
// source: organizationpb/v2/auto_scaling_config.proto
...
func (x *AutoScalingConfig) Reset() {
	*x = AutoScalingConfig{}
	mi := &file_organizationpb_v2_auto_scaling_config_proto_msgTypes[0]
...
var File_organizationpb_v2_auto_scaling_config_proto protoreflect.FileDescriptor

const file_organizationpb_v2_auto_scaling_config_proto_rawDesc = "" +
	"\n" +
	"+organizationpb/v2/auto_scaling_config.proto\x12\x0forganization.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xeb\x02\n" +
	"\x11AutoScalingConfig\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12,\n" +
	"\rmin_instances\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\fminInstances\x12,\n" +
	"\rmax_instances\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\fmaxInstances\x125\n" +
	"\x12target_cpu_percent\x18\x04 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x10targetCpuPercent\x12;\n" +
	"\x15target_memory_percent\x18\x05 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x13targetMemoryPercent\x123\n" +
	"\x11scale_up_cooldown\x18\x06 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x0fscaleUpCooldown\x127\n" +
	"\x13scale_down_cooldown\x18\a \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x11scaleDownCooldownB\xc3\x01\n" +
	"\x13com.organization.v2B\x16AutoScalingConfigProtoP\x01Z/github.com/jdfalk/gcommon/pkg/organizationpb/v2\xa2\x02\x03OXX\xaa\x02\x0fOrganization.V2\xca\x02\x0fOrganization\\V2\xe2\x02\x1bOrganization\\V2\\GPBMetadata\xea\x02\x10Organization::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organizationpb_v2_auto_scaling_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organizationpb_v2_auto_scaling_config_proto_goTypes = []any{
	(*AutoScalingConfig)(nil), // 0: organization.v2.AutoScalingConfig
}
var file_organizationpb_v2_auto_scaling_config_proto_depIdxs = []int32{
...
func init() { file_organizationpb_v2_auto_scaling_config_proto_init() }
func file_organizationpb_v2_auto_scaling_config_proto_init() {
	if File_organizationpb_v2_auto_scaling_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v2_auto_scaling_config_proto_rawDesc), len(file_organizationpb_v2_auto_scaling_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v2_auto_scaling_config_proto_goTypes,
		DependencyIndexes: file_organizationpb_v2_auto_scaling_config_proto_depIdxs,
		MessageInfos:      file_organizationpb_v2_auto_scaling_config_proto_msgTypes,
	}.Build()
	File_organizationpb_v2_auto_scaling_config_proto = out.File
	file_organizationpb_v2_auto_scaling_config_proto_goTypes = nil
	file_organizationpb_v2_auto_scaling_config_proto_depIdxs = nil
}
