...
// 	protoc        (unknown)
// source: organizationpb/v2/network_isolation.proto
...
func (x *NetworkIsolation) Reset() {
	*x = NetworkIsolation{}
	mi := &file_organizationpb_v2_network_isolation_proto_msgTypes[0]
...
var File_organizationpb_v2_network_isolation_proto protoreflect.FileDescriptor

const file_organizationpb_v2_network_isolation_proto_rawDesc = "" +
	"\n" +
	")organizationpb/v2/network_isolation.proto\x12\x0forganization.v2\x1a\"organizationpb/v2/cdn_config.proto\x1a%organizationpb/v2/domain_config.proto\x1a,organizationpb/v2/load_balancer_config.proto\x1a(organizationpb/v2/network_acl_rule.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc0\x03\n" +
	...
	"\tacl_rules\x18\x04 \x03(\v2\x1f.organization.v2.NetworkACLRuleB\b\xbaH\x05\x92\x01\x02\b\x01R\baclRules\x12+\n" +
	...
	"\x06domain\x18\b \x01(\v2\x1d.organization.v2.DomainConfigR\x06domainB\xc2\x01\n" +
	"\x13com.organization.v2B\x15NetworkIsolationProtoP\x01Z/github.com/jdfalk/gcommon/pkg/organizationpb/v2\xa2\x02\x03OXX\xaa\x02\x0fOrganization.V2\xca\x02\x0fOrganization\\V2\xe2\x02\x1bOrganization\\V2\\GPBMetadata\xea\x02\x10Organization::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_organizationpb_v2_network_isolation_proto_goTypes = []any{
	(*NetworkIsolation)(nil),               // 0: organization.v2.NetworkIsolation
	(*NetworkACLRule)(nil),                 // 1: organization.v2.NetworkACLRule
	(*OrganizationLoadBalancerConfig)(nil), // 2: organization.v2.OrganizationLoadBalancerConfig
	(*CDNConfig)(nil),                      // 3: organization.v2.CDNConfig
	(*DomainConfig)(nil),                   // 4: organization.v2.DomainConfig
}
var file_organizationpb_v2_network_isolation_proto_depIdxs = []int32{
	1, // 0: organization.v2.NetworkIsolation.acl_rules:type_name -> organization.v2.NetworkACLRule
	2, // 1: organization.v2.NetworkIsolation.load_balancer:type_name -> organization.v2.OrganizationLoadBalancerConfig
	3, // 2: organization.v2.NetworkIsolation.cdn:type_name -> organization.v2.CDNConfig
	4, // 3: organization.v2.NetworkIsolation.domain:type_name -> organization.v2.DomainConfig
...
func init() { file_organizationpb_v2_network_isolation_proto_init() }
func file_organizationpb_v2_network_isolation_proto_init() {
	if File_organizationpb_v2_network_isolation_proto != nil {
		return
	}
	file_organizationpb_v2_cdn_config_proto_init()
	file_organizationpb_v2_domain_config_proto_init()
	file_organizationpb_v2_load_balancer_config_proto_init()
	file_organizationpb_v2_network_acl_rule_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v2_network_isolation_proto_rawDesc), len(file_organizationpb_v2_network_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v2_network_isolation_proto_goTypes,
		DependencyIndexes: file_organizationpb_v2_network_isolation_proto_depIdxs,
		MessageInfos:      file_organizationpb_v2_network_isolation_proto_msgTypes,
	}.Build()
	File_organizationpb_v2_network_isolation_proto = out.File
	file_organizationpb_v2_network_isolation_proto_goTypes = nil
	file_organizationpb_v2_network_isolation_proto_depIdxs = nil
}
