...
// 	protoc        (unknown)
// source: organizationpb/v2/cache_key_policy.proto
...
func (x *CacheKeyPolicy) Reset() {
	*x = CacheKeyPolicy{}
	mi := &file_organizationpb_v2_cache_key_policy_proto_msgTypes[0]
...
var File_organizationpb_v2_cache_key_policy_proto protoreflect.FileDescriptor

const file_organizationpb_v2_cache_key_policy_proto_rawDesc = "" +
	"\n" +
	"(organizationpb/v2/cache_key_policy.proto\x12\x0forganization.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc0\x02\n" +
	"\x0eCacheKeyPolicy\x122\n" +
	"\x15include_query_strings\x18\x01 \x01(\bR\x13includeQueryStrings\x12>\n" +
	"\x16query_string_whitelist\x18\x02 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x14queryStringWhitelist\x12'\n" +
	...
	"\x10cookie_whitelist\x18\x06 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x0fcookieWhitelistB\xc0\x01\n" +
	"\x13com.organization.v2B\x13CacheKeyPolicyProtoP\x01Z/github.com/jdfalk/gcommon/pkg/organizationpb/v2\xa2\x02\x03OXX\xaa\x02\x0fOrganization.V2\xca\x02\x0fOrganization\\V2\xe2\x02\x1bOrganization\\V2\\GPBMetadata\xea\x02\x10Organization::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organizationpb_v2_cache_key_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organizationpb_v2_cache_key_policy_proto_goTypes = []any{
	(*CacheKeyPolicy)(nil), // 0: organization.v2.CacheKeyPolicy
}
var file_organizationpb_v2_cache_key_policy_proto_depIdxs = []int32{
...
func init() { file_organizationpb_v2_cache_key_policy_proto_init() }
func file_organizationpb_v2_cache_key_policy_proto_init() {
	if File_organizationpb_v2_cache_key_policy_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v2_cache_key_policy_proto_rawDesc), len(file_organizationpb_v2_cache_key_policy_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v2_cache_key_policy_proto_goTypes,
		DependencyIndexes: file_organizationpb_v2_cache_key_policy_proto_depIdxs,
		MessageInfos:      file_organizationpb_v2_cache_key_policy_proto_msgTypes,
	}.Build()
	File_organizationpb_v2_cache_key_policy_proto = out.File
	file_organizationpb_v2_cache_key_policy_proto_goTypes = nil
	file_organizationpb_v2_cache_key_policy_proto_depIdxs = nil
}
