...
// 	protoc        (unknown)
// source: organizationpb/v2/tenant_isolation.proto
...
type TenantIsolation struct {
	...
	xxx_hidden_Level         v2.OrganizationIsolationLevel `protobuf:"varint,2,opt,name=level,enum=common.v2.OrganizationIsolationLevel"`
	...
	xxx_hidden_AccessControl *v2.OrganizationAccessControl `protobuf:"bytes,8,opt,name=access_control,json=accessControl"`
	xxx_hidden_Audit         *AuditConfig                  `protobuf:"bytes,9,opt,name=audit"`
	xxx_hidden_Metadata      *[]*v2.KeyValue               `protobuf:"bytes,10,rep,name=metadata"`
...
func (x *TenantIsolation) Reset() {
	*x = TenantIsolation{}
	mi := &file_organizationpb_v2_tenant_isolation_proto_msgTypes[0]
...
func (x *TenantIsolation) GetLevel() v2.OrganizationIsolationLevel {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			return x.xxx_hidden_Level
		}
	}
	return v2.OrganizationIsolationLevel(0)
}
...
func (x *TenantIsolation) GetAccessControl() *v2.OrganizationAccessControl {
	if x != nil {
...
func (x *TenantIsolation) GetMetadata() []*v2.KeyValue {
	if x != nil {
...
func (x *TenantIsolation) SetLevel(v v2.OrganizationIsolationLevel) {
...
func (x *TenantIsolation) SetAccessControl(v *v2.OrganizationAccessControl) {
...
func (x *TenantIsolation) SetMetadata(v []*v2.KeyValue) {
	var sv *[]*v2.KeyValue
...
func (x *TenantIsolation) ClearLevel() {
	...
	x.xxx_hidden_Level = v2.OrganizationIsolationLevel_ISOLATION_LEVEL_UNSPECIFIED
}
...
type TenantIsolation_builder struct {
	...
	Level *v2.OrganizationIsolationLevel
...
var File_organizationpb_v2_tenant_isolation_proto protoreflect.FileDescriptor

const file_organizationpb_v2_tenant_isolation_proto_rawDesc = "" +
	"\n" +
	"(organizationpb/v2/tenant_isolation.proto\x12\x0forganization.v2\x1a!commonpb/v2/isolation_level.proto\x1a\x1bcommonpb/v2/key_value.proto\x1a-commonpb/v2/organization_access_control.proto\x1a$organizationpb/v2/audit_config.proto\x1a)organizationpb/v2/compute_isolation.proto\x1a*organizationpb/v2/database_isolation.proto\x1a)organizationpb/v2/encryption_config.proto\x1a)organizationpb/v2/network_isolation.proto\x1a)organizationpb/v2/storage_isolation.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x90\x06\n" +
	"\x0fTenantIsolation\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12;\n" +
	"\x05level\x18\x02 \x01(\x0e2%.common.v2.OrganizationIsolationLevelR\x05level\x12>\n" +
	"\bdatabase\x18\x03 \x01(\v2\".organization.v2.DatabaseIsolationR\bdatabase\x12;\n" +
	"\anetwork\x18\x04 \x01(\v2!.organization.v2.NetworkIsolationR\anetwork\x12;\n" +
	"\astorage\x18\x05 \x01(\v2!.organization.v2.StorageIsolationR\astorage\x12;\n" +
	"\acompute\x18\x06 \x01(\v2!.organization.v2.ComputeIsolationR\acompute\x12M\n" +
	"\n" +
	"encryption\x18\a \x01(\v2-.organization.v2.OrganizationEncryptionConfigR\n" +
	"encryption\x12K\n" +
	"\x0eaccess_control\x18\b \x01(\v2$.common.v2.OrganizationAccessControlR\raccessControl\x122\n" +
	"\x05audit\x18\t \x01(\v2\x1c.organization.v2.AuditConfigR\x05audit\x123\n" +
	"\bmetadata\x18\n" +
	" \x03(\v2\x13.common.v2.KeyValueB\x02(\x01R\bmetadata\x12C\n" +
	"\n" +
	...
	"\rconfigured_by\x18\r \x01(\tR\fconfiguredByB\xc1\x01\n" +
	"\x13com.organization.v2B\x14TenantIsolationProtoP\x01Z/github.com/jdfalk/gcommon/pkg/organizationpb/v2\xa2\x02\x03OXX\xaa\x02\x0fOrganization.V2\xca\x02\x0fOrganization\\V2\xe2\x02\x1bOrganization\\V2\\GPBMetadata\xea\x02\x10Organization::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organizationpb_v2_tenant_isolation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organizationpb_v2_tenant_isolation_proto_goTypes = []any{
	(*TenantIsolation)(nil),              // 0: organization.v2.TenantIsolation
	(v2.OrganizationIsolationLevel)(0),   // 1: common.v2.OrganizationIsolationLevel
	(*DatabaseIsolation)(nil),            // 2: organization.v2.DatabaseIsolation
	(*NetworkIsolation)(nil),             // 3: organization.v2.NetworkIsolation
	(*StorageIsolation)(nil),             // 4: organization.v2.StorageIsolation
	(*ComputeIsolation)(nil),             // 5: organization.v2.ComputeIsolation
	(*OrganizationEncryptionConfig)(nil), // 6: organization.v2.OrganizationEncryptionConfig
	(*v2.OrganizationAccessControl)(nil), // 7: common.v2.OrganizationAccessControl
	(*AuditConfig)(nil),                  // 8: organization.v2.AuditConfig
	(*v2.KeyValue)(nil),                  // 9: common.v2.KeyValue
	(*timestamppb.Timestamp)(nil),        // 10: google.protobuf.Timestamp
}
var file_organizationpb_v2_tenant_isolation_proto_depIdxs = []int32{
	1,  // 0: organization.v2.TenantIsolation.level:type_name -> common.v2.OrganizationIsolationLevel
	2,  // 1: organization.v2.TenantIsolation.database:type_name -> organization.v2.DatabaseIsolation
	3,  // 2: organization.v2.TenantIsolation.network:type_name -> organization.v2.NetworkIsolation
	4,  // 3: organization.v2.TenantIsolation.storage:type_name -> organization.v2.StorageIsolation
	5,  // 4: organization.v2.TenantIsolation.compute:type_name -> organization.v2.ComputeIsolation
	6,  // 5: organization.v2.TenantIsolation.encryption:type_name -> organization.v2.OrganizationEncryptionConfig
	7,  // 6: organization.v2.TenantIsolation.access_control:type_name -> common.v2.OrganizationAccessControl
	8,  // 7: organization.v2.TenantIsolation.audit:type_name -> organization.v2.AuditConfig
	9,  // 8: organization.v2.TenantIsolation.metadata:type_name -> common.v2.KeyValue
	10, // 9: organization.v2.TenantIsolation.created_at:type_name -> google.protobuf.Timestamp
	10, // 10: organization.v2.TenantIsolation.updated_at:type_name -> google.protobuf.Timestamp
...
func init() { file_organizationpb_v2_tenant_isolation_proto_init() }
func file_organizationpb_v2_tenant_isolation_proto_init() {
	if File_organizationpb_v2_tenant_isolation_proto != nil {
		return
	}
	file_organizationpb_v2_audit_config_proto_init()
	file_organizationpb_v2_compute_isolation_proto_init()
	file_organizationpb_v2_database_isolation_proto_init()
	file_organizationpb_v2_encryption_config_proto_init()
	file_organizationpb_v2_network_isolation_proto_init()
	file_organizationpb_v2_storage_isolation_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v2_tenant_isolation_proto_rawDesc), len(file_organizationpb_v2_tenant_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v2_tenant_isolation_proto_goTypes,
		DependencyIndexes: file_organizationpb_v2_tenant_isolation_proto_depIdxs,
		MessageInfos:      file_organizationpb_v2_tenant_isolation_proto_msgTypes,
	}.Build()
	File_organizationpb_v2_tenant_isolation_proto = out.File
	file_organizationpb_v2_tenant_isolation_proto_goTypes = nil
	file_organizationpb_v2_tenant_isolation_proto_depIdxs = nil
}
