...
// 	protoc        (unknown)
// source: organizationpb/v2/cache_behavior.proto
...
func (x *CacheBehavior) Reset() {
	*x = CacheBehavior{}
	mi := &file_organizationpb_v2_cache_behavior_proto_msgTypes[0]
...
var File_organizationpb_v2_cache_behavior_proto protoreflect.FileDescriptor

const file_organizationpb_v2_cache_behavior_proto_rawDesc = "" +
	"\n" +
	"&organizationpb/v2/cache_behavior.proto\x12\x0forganization.v2\x1a(organizationpb/v2/cache_key_policy.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf2\x01\n" +
	"\rCacheBehavior\x12*\n" +
	...
	"\x0fallowed_methods\x18\x04 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x0eallowedMethods\x12<\n" +
	"\tcache_key\x18\x05 \x01(\v2\x1f.organization.v2.CacheKeyPolicyR\bcacheKeyB\xbf\x01\n" +
	"\x13com.organization.v2B\x12CacheBehaviorProtoP\x01Z/github.com/jdfalk/gcommon/pkg/organizationpb/v2\xa2\x02\x03OXX\xaa\x02\x0fOrganization.V2\xca\x02\x0fOrganization\\V2\xe2\x02\x1bOrganization\\V2\\GPBMetadata\xea\x02\x10Organization::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organizationpb_v2_cache_behavior_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organizationpb_v2_cache_behavior_proto_goTypes = []any{
	(*CacheBehavior)(nil),  // 0: organization.v2.CacheBehavior
	(*CacheKeyPolicy)(nil), // 1: organization.v2.CacheKeyPolicy
}
var file_organizationpb_v2_cache_behavior_proto_depIdxs = []int32{
	1, // 0: organization.v2.CacheBehavior.cache_key:type_name -> organization.v2.CacheKeyPolicy
...
func init() { file_organizationpb_v2_cache_behavior_proto_init() }
func file_organizationpb_v2_cache_behavior_proto_init() {
	if File_organizationpb_v2_cache_behavior_proto != nil {
		return
	}
	file_organizationpb_v2_cache_key_policy_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v2_cache_behavior_proto_rawDesc), len(file_organizationpb_v2_cache_behavior_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v2_cache_behavior_proto_goTypes,
		DependencyIndexes: file_organizationpb_v2_cache_behavior_proto_depIdxs,
		MessageInfos:      file_organizationpb_v2_cache_behavior_proto_msgTypes,
	}.Build()
	File_organizationpb_v2_cache_behavior_proto = out.File
	file_organizationpb_v2_cache_behavior_proto_goTypes = nil
	file_organizationpb_v2_cache_behavior_proto_depIdxs = nil
}
