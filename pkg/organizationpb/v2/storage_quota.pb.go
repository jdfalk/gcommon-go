...
// 	protoc        (unknown)
// source: organizationpb/v2/storage_quota.proto
...
func (x *StorageQuota) Reset() {
	*x = StorageQuota{}
	mi := &file_organizationpb_v2_storage_quota_proto_msgTypes[0]
...
var File_organizationpb_v2_storage_quota_proto protoreflect.FileDescriptor

const file_organizationpb_v2_storage_quota_proto_rawDesc = "" +
	"\n" +
	"%organizationpb/v2/storage_quota.proto\x12\x0forganization.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe2\x01\n" +
	"\fStorageQuota\x12-\n" +
	"\x0emax_size_bytes\x18\x01 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\fmaxSizeBytes\x12(\n" +
	...
	"\x14transfer_quota_bytes\x18\x04 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x12transferQuotaBytesB\xbe\x01\n" +
	"\x13com.organization.v2B\x11StorageQuotaProtoP\x01Z/github.com/jdfalk/gcommon/pkg/organizationpb/v2\xa2\x02\x03OXX\xaa\x02\x0fOrganization.V2\xca\x02\x0fOrganization\\V2\xe2\x02\x1bOrganization\\V2\\GPBMetadata\xea\x02\x10Organization::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organizationpb_v2_storage_quota_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organizationpb_v2_storage_quota_proto_goTypes = []any{
	(*StorageQuota)(nil), // 0: organization.v2.StorageQuota
}
var file_organizationpb_v2_storage_quota_proto_depIdxs = []int32{
...
func init() { file_organizationpb_v2_storage_quota_proto_init() }
func file_organizationpb_v2_storage_quota_proto_init() {
	if File_organizationpb_v2_storage_quota_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v2_storage_quota_proto_rawDesc), len(file_organizationpb_v2_storage_quota_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v2_storage_quota_proto_goTypes,
		DependencyIndexes: file_organizationpb_v2_storage_quota_proto_depIdxs,
		MessageInfos:      file_organizationpb_v2_storage_quota_proto_msgTypes,
	}.Build()
	File_organizationpb_v2_storage_quota_proto = out.File
	file_organizationpb_v2_storage_quota_proto_goTypes = nil
	file_organizationpb_v2_storage_quota_proto_depIdxs = nil
}
