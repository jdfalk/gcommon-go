...
// 	protoc        (unknown)
// source: organizationpb/v2/hierarchy_path.proto
...
func (x *HierarchyPath) Reset() {
	*x = HierarchyPath{}
	mi := &file_organizationpb_v2_hierarchy_path_proto_msgTypes[0]
...
var File_organizationpb_v2_hierarchy_path_proto protoreflect.FileDescriptor

const file_organizationpb_v2_hierarchy_path_proto_rawDesc = "" +
	"\n" +
	"&organizationpb/v2/hierarchy_path.proto\x12\x0forganization.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb5\x01\n" +
	"\rHierarchyPath\x12,\n" +
...
var file_organizationpb_v2_hierarchy_path_proto_goTypes = []any{
	(*HierarchyPath)(nil), // 0: organization.v2.HierarchyPath
}
var file_organizationpb_v2_hierarchy_path_proto_depIdxs = []int32{
...
func init() { file_organizationpb_v2_hierarchy_path_proto_init() }
func file_organizationpb_v2_hierarchy_path_proto_init() {
	if File_organizationpb_v2_hierarchy_path_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v2_hierarchy_path_proto_rawDesc), len(file_organizationpb_v2_hierarchy_path_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v2_hierarchy_path_proto_goTypes,
		DependencyIndexes: file_organizationpb_v2_hierarchy_path_proto_depIdxs,
		MessageInfos:      file_organizationpb_v2_hierarchy_path_proto_msgTypes,
	}.Build()
	File_organizationpb_v2_hierarchy_path_proto = out.File
	file_organizationpb_v2_hierarchy_path_proto_goTypes = nil
	file_organizationpb_v2_hierarchy_path_proto_depIdxs = nil
}
