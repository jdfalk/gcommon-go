...
// 	protoc        (unknown)
// source: organizationpb/v2/database_isolation.proto
...
type DatabaseIsolation struct {
	...
	xxx_hidden_ConnectionParams    *[]*v2.KeyValue           `protobuf:"bytes,3,rep,name=connection_params,json=connectionParams"`
...
func (x *DatabaseIsolation) Reset() {
	*x = DatabaseIsolation{}
	mi := &file_organizationpb_v2_database_isolation_proto_msgTypes[0]
...
func (x *DatabaseIsolation) GetConnectionParams() []*v2.KeyValue {
	if x != nil {
...
func (x *DatabaseIsolation) SetConnectionParams(v []*v2.KeyValue) {
	var sv *[]*v2.KeyValue
...
var File_organizationpb_v2_database_isolation_proto protoreflect.FileDescriptor

const file_organizationpb_v2_database_isolation_proto_rawDesc = "" +
	"\n" +
	"*organizationpb/v2/database_isolation.proto\x12\x0forganization.v2\x1a\x1bcommonpb/v2/key_value.proto\x1a%organizationpb/v2/backup_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb0\x03\n" +
	...
	"schemaName\x12D\n" +
	"\x11connection_params\x18\x03 \x03(\v2\x13.common.v2.KeyValueB\x02(\x01R\x10connectionParams\x12-\n" +
	"\x12dedicated_database\x18\x04 \x01(\bR\x11dedicatedDatabase\x12A\n" +
	...
	"\x15query_timeout_seconds\x18\b \x01(\x05R\x13queryTimeoutSecondsB\xc3\x01\n" +
	"\x13com.organization.v2B\x16DatabaseIsolationProtoP\x01Z/github.com/jdfalk/gcommon/pkg/organizationpb/v2\xa2\x02\x03OXX\xaa\x02\x0fOrganization.V2\xca\x02\x0fOrganization\\V2\xe2\x02\x1bOrganization\\V2\\GPBMetadata\xea\x02\x10Organization::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_organizationpb_v2_database_isolation_proto_goTypes = []any{
	(*DatabaseIsolation)(nil),        // 0: organization.v2.DatabaseIsolation
	(*v2.KeyValue)(nil),              // 1: common.v2.KeyValue
	(*OrganizationBackupConfig)(nil), // 2: organization.v2.OrganizationBackupConfig
}
var file_organizationpb_v2_database_isolation_proto_depIdxs = []int32{
	1, // 0: organization.v2.DatabaseIsolation.connection_params:type_name -> common.v2.KeyValue
	2, // 1: organization.v2.DatabaseIsolation.backup:type_name -> organization.v2.OrganizationBackupConfig
...
func init() { file_organizationpb_v2_database_isolation_proto_init() }
func file_organizationpb_v2_database_isolation_proto_init() {
	if File_organizationpb_v2_database_isolation_proto != nil {
		return
	}
	file_organizationpb_v2_backup_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v2_database_isolation_proto_rawDesc), len(file_organizationpb_v2_database_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v2_database_isolation_proto_goTypes,
		DependencyIndexes: file_organizationpb_v2_database_isolation_proto_depIdxs,
		MessageInfos:      file_organizationpb_v2_database_isolation_proto_msgTypes,
	}.Build()
	File_organizationpb_v2_database_isolation_proto = out.File
	file_organizationpb_v2_database_isolation_proto_goTypes = nil
	file_organizationpb_v2_database_isolation_proto_depIdxs = nil
}
