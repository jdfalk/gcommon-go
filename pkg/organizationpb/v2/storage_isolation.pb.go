...
// 	protoc        (unknown)
// source: organizationpb/v2/storage_isolation.proto
...
func (x *StorageIsolation) Reset() {
	*x = StorageIsolation{}
	mi := &file_organizationpb_v2_storage_isolation_proto_msgTypes[0]
...
var File_organizationpb_v2_storage_isolation_proto protoreflect.FileDescriptor

const file_organizationpb_v2_storage_isolation_proto_rawDesc = "" +
	"\n" +
	")organizationpb/v2/storage_isolation.proto\x12\x0forganization.v2\x1a-organizationpb/v2/storage_backup_config.proto\x1a*organizationpb/v2/storage_encryption.proto\x1a&organizationpb/v2/storage_policy.proto\x1a%organizationpb/v2/storage_quota.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x96\x03\n" +
	...
	"\n" +
	"encryption\x18\x04 \x01(\v2\".organization.v2.StorageEncryptionR\n" +
	"encryption\x12D\n" +
	...
	"\x05quota\x18\a \x01(\v2\x1d.organization.v2.StorageQuotaR\x05quotaB\xc2\x01\n" +
	"\x13com.organization.v2B\x15StorageIsolationProtoP\x01Z/github.com/jdfalk/gcommon/pkg/organizationpb/v2\xa2\x02\x03OXX\xaa\x02\x0fOrganization.V2\xca\x02\x0fOrganization\\V2\xe2\x02\x1bOrganization\\V2\\GPBMetadata\xea\x02\x10Organization::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organizationpb_v2_storage_isolation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organizationpb_v2_storage_isolation_proto_goTypes = []any{
	(*StorageIsolation)(nil),    // 0: organization.v2.StorageIsolation
	(*StorageEncryption)(nil),   // 1: organization.v2.StorageEncryption
	(*StoragePolicy)(nil),       // 2: organization.v2.StoragePolicy
	(*StorageBackupConfig)(nil), // 3: organization.v2.StorageBackupConfig
	(*StorageQuota)(nil),        // 4: organization.v2.StorageQuota
}
var file_organizationpb_v2_storage_isolation_proto_depIdxs = []int32{
	1, // 0: organization.v2.StorageIsolation.encryption:type_name -> organization.v2.StorageEncryption
	2, // 1: organization.v2.StorageIsolation.policies:type_name -> organization.v2.StoragePolicy
	3, // 2: organization.v2.StorageIsolation.backup:type_name -> organization.v2.StorageBackupConfig
	4, // 3: organization.v2.StorageIsolation.quota:type_name -> organization.v2.StorageQuota
...
func init() { file_organizationpb_v2_storage_isolation_proto_init() }
func file_organizationpb_v2_storage_isolation_proto_init() {
	if File_organizationpb_v2_storage_isolation_proto != nil {
		return
	}
	file_organizationpb_v2_storage_backup_config_proto_init()
	file_organizationpb_v2_storage_encryption_proto_init()
	file_organizationpb_v2_storage_policy_proto_init()
	file_organizationpb_v2_storage_quota_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v2_storage_isolation_proto_rawDesc), len(file_organizationpb_v2_storage_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v2_storage_isolation_proto_goTypes,
		DependencyIndexes: file_organizationpb_v2_storage_isolation_proto_depIdxs,
		MessageInfos:      file_organizationpb_v2_storage_isolation_proto_msgTypes,
	}.Build()
	File_organizationpb_v2_storage_isolation_proto = out.File
	file_organizationpb_v2_storage_isolation_proto_goTypes = nil
	file_organizationpb_v2_storage_isolation_proto_depIdxs = nil
}
