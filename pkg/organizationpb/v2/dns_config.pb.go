...
// 	protoc        (unknown)
// source: organizationpb/v2/dns_config.proto
...
func (x *DNSConfig) Reset() {
	*x = DNSConfig{}
	mi := &file_organizationpb_v2_dns_config_proto_msgTypes[0]
...
var File_organizationpb_v2_dns_config_proto protoreflect.FileDescriptor

const file_organizationpb_v2_dns_config_proto_rawDesc = "" +
	"\n" +
	"\"organizationpb/v2/dns_config.proto\x12\x0forganization.v2\x1a\"organizationpb/v2/dns_record.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xad\x01\n" +
	"\tDNSConfig\x12#\n" +
...
var file_organizationpb_v2_dns_config_proto_goTypes = []any{
	(*DNSConfig)(nil), // 0: organization.v2.DNSConfig
	(*DNSRecord)(nil), // 1: organization.v2.DNSRecord
}
var file_organizationpb_v2_dns_config_proto_depIdxs = []int32{
	1, // 0: organization.v2.DNSConfig.records:type_name -> organization.v2.DNSRecord
...
func init() { file_organizationpb_v2_dns_config_proto_init() }
func file_organizationpb_v2_dns_config_proto_init() {
	if File_organizationpb_v2_dns_config_proto != nil {
		return
	}
	file_organizationpb_v2_dns_record_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v2_dns_config_proto_rawDesc), len(file_organizationpb_v2_dns_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v2_dns_config_proto_goTypes,
		DependencyIndexes: file_organizationpb_v2_dns_config_proto_depIdxs,
		MessageInfos:      file_organizationpb_v2_dns_config_proto_msgTypes,
	}.Build()
	File_organizationpb_v2_dns_config_proto = out.File
	file_organizationpb_v2_dns_config_proto_goTypes = nil
	file_organizationpb_v2_dns_config_proto_depIdxs = nil
}
