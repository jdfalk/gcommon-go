...
// 	protoc        (unknown)
// source: organizationpb/v2/audit_config.proto
...
func (x *AuditConfig) Reset() {
	*x = AuditConfig{}
	mi := &file_organizationpb_v2_audit_config_proto_msgTypes[0]
...
var File_organizationpb_v2_audit_config_proto protoreflect.FileDescriptor

const file_organizationpb_v2_audit_config_proto_rawDesc = "" +
	"\n" +
	"$organizationpb/v2/audit_config.proto\x12\x0forganization.v2\x1a#organizationpb/v2/audit_alert.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb8\x02\n" +
	"\vAuditConfig\x12#\n" +
...
var file_organizationpb_v2_audit_config_proto_depIdxs = []int32{
...
func init() { file_organizationpb_v2_audit_config_proto_init() }
func file_organizationpb_v2_audit_config_proto_init() {
	if File_organizationpb_v2_audit_config_proto != nil {
		return
	}
	file_organizationpb_v2_audit_alert_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v2_audit_config_proto_rawDesc), len(file_organizationpb_v2_audit_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v2_audit_config_proto_goTypes,
		DependencyIndexes: file_organizationpb_v2_audit_config_proto_depIdxs,
		MessageInfos:      file_organizationpb_v2_audit_config_proto_msgTypes,
	}.Build()
	File_organizationpb_v2_audit_config_proto = out.File
	file_organizationpb_v2_audit_config_proto_goTypes = nil
	file_organizationpb_v2_audit_config_proto_depIdxs = nil
}
