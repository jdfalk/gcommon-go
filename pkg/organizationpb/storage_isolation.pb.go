...
// 	protoc        (unknown)
// source: organizationpb/v1/storage_isolation.proto
...
func (x *StorageIsolation) Reset() {
	*x = StorageIsolation{}
	mi := &file_organizationpb_v1_storage_isolation_proto_msgTypes[0]
...
var File_organizationpb_v1_storage_isolation_proto protoreflect.FileDescriptor

const file_organizationpb_v1_storage_isolation_proto_rawDesc = "" +
	"\n" +
	")organizationpb/v1/storage_isolation.proto\x12\x0forganization.v1\x1a-organizationpb/v1/storage_backup_config.proto\x1a*organizationpb/v1/storage_encryption.proto\x1a&organizationpb/v1/storage_policy.proto\x1a%organizationpb/v1/storage_quota.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x96\x03\n" +
	"\x10StorageIsolation\x12.\n" +
	"\x0estorage_bucket\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\rstorageBucket\x12(\n" +
	"\vpath_prefix\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\n" +
	"pathPrefix\x12+\n" +
	"\x11dedicated_storage\x18\x03 \x01(\bR\x10dedicatedStorage\x12B\n" +
	"\n" +
	"encryption\x18\x04 \x01(\v2\".organization.v1.StorageEncryptionR\n" +
	"encryption\x12D\n" +
	"\bpolicies\x18\x05 \x03(\v2\x1e.organization.v1.StoragePolicyB\b\xbaH\x05\x92\x01\x02\b\x01R\bpolicies\x12<\n" +
	"\x06backup\x18\x06 \x01(\v2$.organization.v1.StorageBackupConfigR\x06backup\x123\n" +
	"\x05quota\x18\a \x01(\v2\x1d.organization.v1.StorageQuotaR\x05quotaB\xbf\x01\n" +
	"\x13com.organization.v1B\x15StorageIsolationProtoP\x01Z,github.com/jdfalk/gcommon/pkg/organizationpb\xa2\x02\x03OXX\xaa\x02\x0fOrganization.V1\xca\x02\x0fOrganization\\V1\xe2\x02\x1bOrganization\\V1\\GPBMetadata\xea\x02\x10Organization::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organizationpb_v1_storage_isolation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organizationpb_v1_storage_isolation_proto_goTypes = []any{
	(*StorageIsolation)(nil),    // 0: organization.v1.StorageIsolation
	(*StorageEncryption)(nil),   // 1: organization.v1.StorageEncryption
	(*StoragePolicy)(nil),       // 2: organization.v1.StoragePolicy
	(*StorageBackupConfig)(nil), // 3: organization.v1.StorageBackupConfig
	(*StorageQuota)(nil),        // 4: organization.v1.StorageQuota
}
var file_organizationpb_v1_storage_isolation_proto_depIdxs = []int32{
	1, // 0: organization.v1.StorageIsolation.encryption:type_name -> organization.v1.StorageEncryption
	2, // 1: organization.v1.StorageIsolation.policies:type_name -> organization.v1.StoragePolicy
	3, // 2: organization.v1.StorageIsolation.backup:type_name -> organization.v1.StorageBackupConfig
	4, // 3: organization.v1.StorageIsolation.quota:type_name -> organization.v1.StorageQuota
...
func init() { file_organizationpb_v1_storage_isolation_proto_init() }
func file_organizationpb_v1_storage_isolation_proto_init() {
	if File_organizationpb_v1_storage_isolation_proto != nil {
		return
	}
	file_organizationpb_v1_storage_backup_config_proto_init()
	file_organizationpb_v1_storage_encryption_proto_init()
	file_organizationpb_v1_storage_policy_proto_init()
	file_organizationpb_v1_storage_quota_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organizationpb_v1_storage_isolation_proto_rawDesc), len(file_organizationpb_v1_storage_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organizationpb_v1_storage_isolation_proto_goTypes,
		DependencyIndexes: file_organizationpb_v1_storage_isolation_proto_depIdxs,
		MessageInfos:      file_organizationpb_v1_storage_isolation_proto_msgTypes,
	}.Build()
	File_organizationpb_v1_storage_isolation_proto = out.File
	file_organizationpb_v1_storage_isolation_proto_goTypes = nil
	file_organizationpb_v1_storage_isolation_proto_depIdxs = nil
}
