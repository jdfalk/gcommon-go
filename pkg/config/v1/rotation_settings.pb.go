...
func (x *RotationSettings) Reset() {
	*x = RotationSettings{}
	mi := &file_config_v1_rotation_settings_proto_msgTypes[0]
...
var File_config_v1_rotation_settings_proto protoreflect.FileDescriptor

const file_config_v1_rotation_settings_proto_rawDesc = "" +
	"\n" +
	"!config/v1/rotation_settings.proto\x12\tconfig.v1\x1a\"common/v1/rotation_frequency.proto\x1a\x1econfig/v1/rotation_event.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa4\x04\n" +
...
var file_config_v1_rotation_settings_proto_depIdxs = []int32{
...
func init() { file_config_v1_rotation_settings_proto_init() }
func file_config_v1_rotation_settings_proto_init() {
	if File_config_v1_rotation_settings_proto != nil {
		return
	}
	file_config_v1_rotation_event_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_v1_rotation_settings_proto_rawDesc), len(file_config_v1_rotation_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_v1_rotation_settings_proto_goTypes,
		DependencyIndexes: file_config_v1_rotation_settings_proto_depIdxs,
		MessageInfos:      file_config_v1_rotation_settings_proto_msgTypes,
	}.Build()
	File_config_v1_rotation_settings_proto = out.File
	file_config_v1_rotation_settings_proto_goTypes = nil
	file_config_v1_rotation_settings_proto_depIdxs = nil
}
