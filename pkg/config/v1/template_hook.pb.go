...
func (x *TemplateHook) Reset() {
	*x = TemplateHook{}
	mi := &file_config_v1_template_hook_proto_msgTypes[0]
...
var File_config_v1_template_hook_proto protoreflect.FileDescriptor

const file_config_v1_template_hook_proto_rawDesc = "" +
	"\n" +
	"\x1dconfig/v1/template_hook.proto\x12\tconfig.v1\x1a#common/v1/hook_error_handling.proto\x1a\x19common/v1/hook_type.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9f\x04\n" +
...
func init() { file_config_v1_template_hook_proto_init() }
func file_config_v1_template_hook_proto_init() {
	if File_config_v1_template_hook_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_v1_template_hook_proto_rawDesc), len(file_config_v1_template_hook_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_v1_template_hook_proto_goTypes,
		DependencyIndexes: file_config_v1_template_hook_proto_depIdxs,
		MessageInfos:      file_config_v1_template_hook_proto_msgTypes,
	}.Build()
	File_config_v1_template_hook_proto = out.File
	file_config_v1_template_hook_proto_goTypes = nil
	file_config_v1_template_hook_proto_depIdxs = nil
}
