...
// 	protoc        (unknown)
// source: config/v1/batching_settings.proto
...
func (x *BatchingSettings) Reset() {
	*x = BatchingSettings{}
	mi := &file_config_v1_batching_settings_proto_msgTypes[0]
...
var File_config_v1_batching_settings_proto protoreflect.FileDescriptor

const file_config_v1_batching_settings_proto_rawDesc = "" +
	"\n" +
	"!config/v1/batching_settings.proto\x12\tconfig.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb2\x01\n" +
	...
	"\fgrouping_key\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\vgroupingKeyB/Z%github.com/jdfalk/gcommon/pkg/config/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_config_v1_batching_settings_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_config_v1_batching_settings_proto_goTypes = []any{
	(*BatchingSettings)(nil), // 0: config.v1.BatchingSettings
}
var file_config_v1_batching_settings_proto_depIdxs = []int32{
...
func init() { file_config_v1_batching_settings_proto_init() }
func file_config_v1_batching_settings_proto_init() {
	if File_config_v1_batching_settings_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_v1_batching_settings_proto_rawDesc), len(file_config_v1_batching_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_v1_batching_settings_proto_goTypes,
		DependencyIndexes: file_config_v1_batching_settings_proto_depIdxs,
		MessageInfos:      file_config_v1_batching_settings_proto_msgTypes,
	}.Build()
	File_config_v1_batching_settings_proto = out.File
	file_config_v1_batching_settings_proto_goTypes = nil
	file_config_v1_batching_settings_proto_depIdxs = nil
}
