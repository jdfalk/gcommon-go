...
func (x *GetConfigResponse) Reset() {
	*x = GetConfigResponse{}
	mi := &file_config_v1_get_config_response_proto_msgTypes[0]
...
var File_config_v1_get_config_response_proto protoreflect.FileDescriptor

const file_config_v1_get_config_response_proto_rawDesc = "" +
	"\n" +
	"#config/v1/get_config_response.proto\x12\tconfig.v1\x1a\x15common/v1/error.proto\x1a\x1cconfig/v1/config_entry.proto\x1a!google/protobuf/go_features.proto\"\x7f\n" +
...
func init() { file_config_v1_get_config_response_proto_init() }
func file_config_v1_get_config_response_proto_init() {
	if File_config_v1_get_config_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_v1_get_config_response_proto_rawDesc), len(file_config_v1_get_config_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_v1_get_config_response_proto_goTypes,
		DependencyIndexes: file_config_v1_get_config_response_proto_depIdxs,
		MessageInfos:      file_config_v1_get_config_response_proto_msgTypes,
	}.Build()
	File_config_v1_get_config_response_proto = out.File
	file_config_v1_get_config_response_proto_goTypes = nil
	file_config_v1_get_config_response_proto_depIdxs = nil
}
