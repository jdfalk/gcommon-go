...
func (x *BackupSettings) Reset() {
	*x = BackupSettings{}
	mi := &file_config_v1_backup_settings_proto_msgTypes[0]
...
var File_config_v1_backup_settings_proto protoreflect.FileDescriptor

const file_config_v1_backup_settings_proto_rawDesc = "" +
	"\n" +
	"\x1fconfig/v1/backup_settings.proto\x12\tconfig.v1\x1a common/v1/backup_frequency.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x88\x03\n" +
...
func init() { file_config_v1_backup_settings_proto_init() }
func file_config_v1_backup_settings_proto_init() {
	if File_config_v1_backup_settings_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_v1_backup_settings_proto_rawDesc), len(file_config_v1_backup_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_v1_backup_settings_proto_goTypes,
		DependencyIndexes: file_config_v1_backup_settings_proto_depIdxs,
		MessageInfos:      file_config_v1_backup_settings_proto_msgTypes,
	}.Build()
	File_config_v1_backup_settings_proto = out.File
	file_config_v1_backup_settings_proto_goTypes = nil
	file_config_v1_backup_settings_proto_depIdxs = nil
}
