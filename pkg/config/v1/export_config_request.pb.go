...
func (x *ExportConfigRequest) Reset() {
	*x = ExportConfigRequest{}
	mi := &file_config_v1_export_config_request_proto_msgTypes[0]
...
var File_config_v1_export_config_request_proto protoreflect.FileDescriptor

const file_config_v1_export_config_request_proto_rawDesc = "" +
	"\n" +
	"%config/v1/export_config_request.proto\x12\tconfig.v1\x1a common/v1/request_metadata.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x95\x01\n" +
...
func init() { file_config_v1_export_config_request_proto_init() }
func file_config_v1_export_config_request_proto_init() {
	if File_config_v1_export_config_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_v1_export_config_request_proto_rawDesc), len(file_config_v1_export_config_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_v1_export_config_request_proto_goTypes,
		DependencyIndexes: file_config_v1_export_config_request_proto_depIdxs,
		MessageInfos:      file_config_v1_export_config_request_proto_msgTypes,
	}.Build()
	File_config_v1_export_config_request_proto = out.File
	file_config_v1_export_config_request_proto_goTypes = nil
	file_config_v1_export_config_request_proto_depIdxs = nil
}
