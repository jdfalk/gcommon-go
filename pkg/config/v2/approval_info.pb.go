...
// 	protoc        (unknown)
// source: config/v2/approval_info.proto
...
func (x *ApprovalInfo) Reset() {
	*x = ApprovalInfo{}
	mi := &file_config_v2_approval_info_proto_msgTypes[0]
...
var File_config_v2_approval_info_proto protoreflect.FileDescriptor

const file_config_v2_approval_info_proto_rawDesc = "" +
	"\n" +
	"\x1dconfig/v2/approval_info.proto\x12\tconfig.v2\x1a\x1fcommon/v2/approval_status.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa4\x02\n" +
	...
	"policyNameB1Z'github.com/jdfalk/gcommon/pkg/config/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_config_v2_approval_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_config_v2_approval_info_proto_goTypes = []any{
	(*ApprovalInfo)(nil),          // 0: config.v2.ApprovalInfo
	(v2.ApprovalStatus)(0),        // 1: common.v2.ApprovalStatus
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_config_v2_approval_info_proto_depIdxs = []int32{
...
func init() { file_config_v2_approval_info_proto_init() }
func file_config_v2_approval_info_proto_init() {
	if File_config_v2_approval_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_v2_approval_info_proto_rawDesc), len(file_config_v2_approval_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_v2_approval_info_proto_goTypes,
		DependencyIndexes: file_config_v2_approval_info_proto_depIdxs,
		MessageInfos:      file_config_v2_approval_info_proto_msgTypes,
	}.Build()
	File_config_v2_approval_info_proto = out.File
	file_config_v2_approval_info_proto_goTypes = nil
	file_config_v2_approval_info_proto_depIdxs = nil
}
