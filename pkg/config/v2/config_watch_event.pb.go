...
// 	protoc        (unknown)
// source: config/v2/config_watch_event.proto
...
func (x *ConfigWatchEvent) Reset() {
	*x = ConfigWatchEvent{}
	mi := &file_config_v2_config_watch_event_proto_msgTypes[0]
...
var File_config_v2_config_watch_event_proto protoreflect.FileDescriptor

const file_config_v2_config_watch_event_proto_rawDesc = "" +
	"\n" +
	"\"config/v2/config_watch_event.proto\x12\tconfig.v2\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xc6\x03\n" +
...
var file_config_v2_config_watch_event_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_config_v2_config_watch_event_proto_goTypes = []any{
	(*ConfigWatchEvent)(nil),      // 0: config.v2.ConfigWatchEvent
	nil,                           // 1: config.v2.ConfigWatchEvent.MetadataEntry
	(*anypb.Any)(nil),             // 2: google.protobuf.Any
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_config_v2_config_watch_event_proto_depIdxs = []int32{
...
func init() { file_config_v2_config_watch_event_proto_init() }
func file_config_v2_config_watch_event_proto_init() {
	if File_config_v2_config_watch_event_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_v2_config_watch_event_proto_rawDesc), len(file_config_v2_config_watch_event_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_v2_config_watch_event_proto_goTypes,
		DependencyIndexes: file_config_v2_config_watch_event_proto_depIdxs,
		MessageInfos:      file_config_v2_config_watch_event_proto_msgTypes,
	}.Build()
	File_config_v2_config_watch_event_proto = out.File
	file_config_v2_config_watch_event_proto_goTypes = nil
	file_config_v2_config_watch_event_proto_depIdxs = nil
}
