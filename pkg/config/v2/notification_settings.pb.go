...
// 	protoc        (unknown)
// source: config/v2/notification_settings.proto
...
func (x *ConfigNotificationSettings) Reset() {
	*x = ConfigNotificationSettings{}
	mi := &file_config_v2_notification_settings_proto_msgTypes[0]
...
var File_config_v2_notification_settings_proto protoreflect.FileDescriptor

const file_config_v2_notification_settings_proto_rawDesc = "" +
	"\n" +
	"%config/v2/notification_settings.proto\x12\tconfig.v2\x1a$common/v2/notification_trigger.proto\x1a!config/v2/batching_settings.proto\x1a$config/v2/notification_channel.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xfe\x02\n" +
	...
	"\bbatching\x18\a \x01(\v2\x1b.config.v2.BatchingSettingsR\bbatchingB1Z'github.com/jdfalk/gcommon/pkg/config/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_config_v2_notification_settings_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_config_v2_notification_settings_proto_goTypes = []any{
...
var file_config_v2_notification_settings_proto_depIdxs = []int32{
...
func init() { file_config_v2_notification_settings_proto_init() }
func file_config_v2_notification_settings_proto_init() {
	if File_config_v2_notification_settings_proto != nil {
		return
	}
	file_config_v2_batching_settings_proto_init()
	file_config_v2_notification_channel_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_v2_notification_settings_proto_rawDesc), len(file_config_v2_notification_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_v2_notification_settings_proto_goTypes,
		DependencyIndexes: file_config_v2_notification_settings_proto_depIdxs,
		MessageInfos:      file_config_v2_notification_settings_proto_msgTypes,
	}.Build()
	File_config_v2_notification_settings_proto = out.File
	file_config_v2_notification_settings_proto_goTypes = nil
	file_config_v2_notification_settings_proto_depIdxs = nil
}
