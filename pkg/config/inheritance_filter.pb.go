...
func (x *InheritanceFilter) Reset() {
	*x = InheritanceFilter{}
	mi := &file_config_v1_inheritance_filter_proto_msgTypes[0]
...
var File_config_v1_inheritance_filter_proto protoreflect.FileDescriptor

const file_config_v1_inheritance_filter_proto_rawDesc = "" +
	"\n" +
	"\"config/v1/inheritance_filter.proto\x12\tconfig.v1\x1a\x1dcommon/v1/filter_action.proto\x1a\x1bcommon/v1/filter_type.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa0\x02\n" +
...
func init() { file_config_v1_inheritance_filter_proto_init() }
func file_config_v1_inheritance_filter_proto_init() {
	if File_config_v1_inheritance_filter_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_v1_inheritance_filter_proto_rawDesc), len(file_config_v1_inheritance_filter_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_v1_inheritance_filter_proto_goTypes,
		DependencyIndexes: file_config_v1_inheritance_filter_proto_depIdxs,
		MessageInfos:      file_config_v1_inheritance_filter_proto_msgTypes,
	}.Build()
	File_config_v1_inheritance_filter_proto = out.File
	file_config_v1_inheritance_filter_proto_goTypes = nil
	file_config_v1_inheritance_filter_proto_depIdxs = nil
}
