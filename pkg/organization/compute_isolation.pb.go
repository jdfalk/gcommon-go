...
func (x *ComputeIsolation) Reset() {
	*x = ComputeIsolation{}
	mi := &file_organization_v1_compute_isolation_proto_msgTypes[0]
...
var File_organization_v1_compute_isolation_proto protoreflect.FileDescriptor

const file_organization_v1_compute_isolation_proto_rawDesc = "" +
	"\n" +
	"'organization/v1/compute_isolation.proto\x12\x0forganization.v1\x1a,common/v1/organization_resource_limits.proto\x1a)organization/v1/auto_scaling_config.proto\x1a$organization/v1/cpu_allocation.proto\x1a'organization/v1/memory_allocation.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x8d\x03\n" +
	...
	"\fauto_scaling\x18\a \x01(\v2\".organization.v1.AutoScalingConfigR\vautoScalingB4Z*github.com/jdfalk/gcommon/pkg/organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_organization_v1_compute_isolation_proto_init() }
func file_organization_v1_compute_isolation_proto_init() {
	if File_organization_v1_compute_isolation_proto != nil {
		return
	}
	file_organization_v1_auto_scaling_config_proto_init()
	file_organization_v1_cpu_allocation_proto_init()
	file_organization_v1_memory_allocation_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v1_compute_isolation_proto_rawDesc), len(file_organization_v1_compute_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v1_compute_isolation_proto_goTypes,
		DependencyIndexes: file_organization_v1_compute_isolation_proto_depIdxs,
		MessageInfos:      file_organization_v1_compute_isolation_proto_msgTypes,
	}.Build()
	File_organization_v1_compute_isolation_proto = out.File
	file_organization_v1_compute_isolation_proto_goTypes = nil
	file_organization_v1_compute_isolation_proto_depIdxs = nil
}
