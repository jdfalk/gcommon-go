...
// 	protoc        (unknown)
// source: organization/v2/cpu_allocation.proto
...
func (x *CPUAllocation) Reset() {
	*x = CPUAllocation{}
	mi := &file_organization_v2_cpu_allocation_proto_msgTypes[0]
...
var File_organization_v2_cpu_allocation_proto protoreflect.FileDescriptor

const file_organization_v2_cpu_allocation_proto_rawDesc = "" +
	"\n" +
	"$organization/v2/cpu_allocation.proto\x12\x0forganization.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbd\x01\n" +
	...
	"\bpriority\x18\x04 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\bpriorityB7Z-github.com/jdfalk/gcommon/pkg/organization/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organization_v2_cpu_allocation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organization_v2_cpu_allocation_proto_goTypes = []any{
	(*CPUAllocation)(nil), // 0: organization.v2.CPUAllocation
}
var file_organization_v2_cpu_allocation_proto_depIdxs = []int32{
...
func init() { file_organization_v2_cpu_allocation_proto_init() }
func file_organization_v2_cpu_allocation_proto_init() {
	if File_organization_v2_cpu_allocation_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v2_cpu_allocation_proto_rawDesc), len(file_organization_v2_cpu_allocation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v2_cpu_allocation_proto_goTypes,
		DependencyIndexes: file_organization_v2_cpu_allocation_proto_depIdxs,
		MessageInfos:      file_organization_v2_cpu_allocation_proto_msgTypes,
	}.Build()
	File_organization_v2_cpu_allocation_proto = out.File
	file_organization_v2_cpu_allocation_proto_goTypes = nil
	file_organization_v2_cpu_allocation_proto_depIdxs = nil
}
