...
// 	protoc        (unknown)
// source: organization/v2/memory_allocation.proto
...
func (x *MemoryAllocation) Reset() {
	*x = MemoryAllocation{}
	mi := &file_organization_v2_memory_allocation_proto_msgTypes[0]
...
var File_organization_v2_memory_allocation_proto protoreflect.FileDescriptor

const file_organization_v2_memory_allocation_proto_rawDesc = "" +
	"\n" +
	"'organization/v2/memory_allocation.proto\x12\x0forganization.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x92\x01\n" +
...
var file_organization_v2_memory_allocation_proto_depIdxs = []int32{
...
func init() { file_organization_v2_memory_allocation_proto_init() }
func file_organization_v2_memory_allocation_proto_init() {
	if File_organization_v2_memory_allocation_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v2_memory_allocation_proto_rawDesc), len(file_organization_v2_memory_allocation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v2_memory_allocation_proto_goTypes,
		DependencyIndexes: file_organization_v2_memory_allocation_proto_depIdxs,
		MessageInfos:      file_organization_v2_memory_allocation_proto_msgTypes,
	}.Build()
	File_organization_v2_memory_allocation_proto = out.File
	file_organization_v2_memory_allocation_proto_goTypes = nil
	file_organization_v2_memory_allocation_proto_depIdxs = nil
}
