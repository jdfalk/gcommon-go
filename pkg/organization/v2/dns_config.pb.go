...
// 	protoc        (unknown)
// source: organization/v2/dns_config.proto
...
func (x *DNSConfig) Reset() {
	*x = DNSConfig{}
	mi := &file_organization_v2_dns_config_proto_msgTypes[0]
...
var File_organization_v2_dns_config_proto protoreflect.FileDescriptor

const file_organization_v2_dns_config_proto_rawDesc = "" +
	"\n" +
	" organization/v2/dns_config.proto\x12\x0forganization.v2\x1a organization/v2/dns_record.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xad\x01\n" +
	"\tDNSConfig\x12#\n" +
...
var file_organization_v2_dns_config_proto_depIdxs = []int32{
...
func init() { file_organization_v2_dns_config_proto_init() }
func file_organization_v2_dns_config_proto_init() {
	if File_organization_v2_dns_config_proto != nil {
		return
	}
	file_organization_v2_dns_record_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v2_dns_config_proto_rawDesc), len(file_organization_v2_dns_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v2_dns_config_proto_goTypes,
		DependencyIndexes: file_organization_v2_dns_config_proto_depIdxs,
		MessageInfos:      file_organization_v2_dns_config_proto_msgTypes,
	}.Build()
	File_organization_v2_dns_config_proto = out.File
	file_organization_v2_dns_config_proto_goTypes = nil
	file_organization_v2_dns_config_proto_depIdxs = nil
}
