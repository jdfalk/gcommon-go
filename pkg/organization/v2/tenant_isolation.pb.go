...
// 	protoc        (unknown)
// source: organization/v2/tenant_isolation.proto
...
func (x *TenantIsolation) Reset() {
	*x = TenantIsolation{}
	mi := &file_organization_v2_tenant_isolation_proto_msgTypes[0]
...
var File_organization_v2_tenant_isolation_proto protoreflect.FileDescriptor

const file_organization_v2_tenant_isolation_proto_rawDesc = "" +
	"\n" +
	"&organization/v2/tenant_isolation.proto\x12\x0forganization.v2\x1a\x1fcommon/v2/isolation_level.proto\x1a\x19common/v2/key_value.proto\x1a+common/v2/organization_access_control.proto\x1a\"organization/v2/audit_config.proto\x1a'organization/v2/compute_isolation.proto\x1a(organization/v2/database_isolation.proto\x1a'organization/v2/encryption_config.proto\x1a'organization/v2/network_isolation.proto\x1a'organization/v2/storage_isolation.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x90\x06\n" +
	...
	"\rconfigured_by\x18\r \x01(\tR\fconfiguredByB7Z-github.com/jdfalk/gcommon/pkg/organization/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organization_v2_tenant_isolation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organization_v2_tenant_isolation_proto_goTypes = []any{
...
var file_organization_v2_tenant_isolation_proto_depIdxs = []int32{
...
func init() { file_organization_v2_tenant_isolation_proto_init() }
func file_organization_v2_tenant_isolation_proto_init() {
	if File_organization_v2_tenant_isolation_proto != nil {
		return
	}
	file_organization_v2_audit_config_proto_init()
	file_organization_v2_compute_isolation_proto_init()
	file_organization_v2_database_isolation_proto_init()
	file_organization_v2_encryption_config_proto_init()
	file_organization_v2_network_isolation_proto_init()
	file_organization_v2_storage_isolation_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v2_tenant_isolation_proto_rawDesc), len(file_organization_v2_tenant_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v2_tenant_isolation_proto_goTypes,
		DependencyIndexes: file_organization_v2_tenant_isolation_proto_depIdxs,
		MessageInfos:      file_organization_v2_tenant_isolation_proto_msgTypes,
	}.Build()
	File_organization_v2_tenant_isolation_proto = out.File
	file_organization_v2_tenant_isolation_proto_goTypes = nil
	file_organization_v2_tenant_isolation_proto_depIdxs = nil
}
