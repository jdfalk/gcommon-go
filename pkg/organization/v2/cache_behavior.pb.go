...
// 	protoc        (unknown)
// source: organization/v2/cache_behavior.proto
...
func (x *CacheBehavior) Reset() {
	*x = CacheBehavior{}
	mi := &file_organization_v2_cache_behavior_proto_msgTypes[0]
...
var File_organization_v2_cache_behavior_proto protoreflect.FileDescriptor

const file_organization_v2_cache_behavior_proto_rawDesc = "" +
	"\n" +
	"$organization/v2/cache_behavior.proto\x12\x0forganization.v2\x1a&organization/v2/cache_key_policy.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf2\x01\n" +
	"\rCacheBehavior\x12*\n" +
	...
	"\tcache_key\x18\x05 \x01(\v2\x1f.organization.v2.CacheKeyPolicyR\bcacheKeyB7Z-github.com/jdfalk/gcommon/pkg/organization/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organization_v2_cache_behavior_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organization_v2_cache_behavior_proto_goTypes = []any{
	(*CacheBehavior)(nil),  // 0: organization.v2.CacheBehavior
	(*CacheKeyPolicy)(nil), // 1: organization.v2.CacheKeyPolicy
}
var file_organization_v2_cache_behavior_proto_depIdxs = []int32{
...
func init() { file_organization_v2_cache_behavior_proto_init() }
func file_organization_v2_cache_behavior_proto_init() {
	if File_organization_v2_cache_behavior_proto != nil {
		return
	}
	file_organization_v2_cache_key_policy_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v2_cache_behavior_proto_rawDesc), len(file_organization_v2_cache_behavior_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v2_cache_behavior_proto_goTypes,
		DependencyIndexes: file_organization_v2_cache_behavior_proto_depIdxs,
		MessageInfos:      file_organization_v2_cache_behavior_proto_msgTypes,
	}.Build()
	File_organization_v2_cache_behavior_proto = out.File
	file_organization_v2_cache_behavior_proto_goTypes = nil
	file_organization_v2_cache_behavior_proto_depIdxs = nil
}
