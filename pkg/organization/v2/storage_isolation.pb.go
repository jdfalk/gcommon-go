...
// 	protoc        (unknown)
// source: organization/v2/storage_isolation.proto
...
func (x *StorageIsolation) Reset() {
	*x = StorageIsolation{}
	mi := &file_organization_v2_storage_isolation_proto_msgTypes[0]
...
var File_organization_v2_storage_isolation_proto protoreflect.FileDescriptor

const file_organization_v2_storage_isolation_proto_rawDesc = "" +
	"\n" +
	"'organization/v2/storage_isolation.proto\x12\x0forganization.v2\x1a+organization/v2/storage_backup_config.proto\x1a(organization/v2/storage_encryption.proto\x1a$organization/v2/storage_policy.proto\x1a#organization/v2/storage_quota.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x96\x03\n" +
...
var file_organization_v2_storage_isolation_proto_depIdxs = []int32{
...
func init() { file_organization_v2_storage_isolation_proto_init() }
func file_organization_v2_storage_isolation_proto_init() {
	if File_organization_v2_storage_isolation_proto != nil {
		return
	}
	file_organization_v2_storage_backup_config_proto_init()
	file_organization_v2_storage_encryption_proto_init()
	file_organization_v2_storage_policy_proto_init()
	file_organization_v2_storage_quota_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v2_storage_isolation_proto_rawDesc), len(file_organization_v2_storage_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v2_storage_isolation_proto_goTypes,
		DependencyIndexes: file_organization_v2_storage_isolation_proto_depIdxs,
		MessageInfos:      file_organization_v2_storage_isolation_proto_msgTypes,
	}.Build()
	File_organization_v2_storage_isolation_proto = out.File
	file_organization_v2_storage_isolation_proto_goTypes = nil
	file_organization_v2_storage_isolation_proto_depIdxs = nil
}
