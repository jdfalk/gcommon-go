...
// 	protoc        (unknown)
// source: organization/v1/hierarchy_path.proto
...
func (x *HierarchyPath) Reset() {
	*x = HierarchyPath{}
	mi := &file_organization_v1_hierarchy_path_proto_msgTypes[0]
...
var File_organization_v1_hierarchy_path_proto protoreflect.FileDescriptor

const file_organization_v1_hierarchy_path_proto_rawDesc = "" +
	"\n" +
	"$organization/v1/hierarchy_path.proto\x12\x0forganization.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb5\x01\n" +
	"\rHierarchyPath\x12,\n" +
	...
	"\n" +
	"path_nodes\x18\x04 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\tpathNodesB4Z*github.com/jdfalk/gcommon/pkg/organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organization_v1_hierarchy_path_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organization_v1_hierarchy_path_proto_goTypes = []any{
	(*HierarchyPath)(nil), // 0: organization.v1.HierarchyPath
}
var file_organization_v1_hierarchy_path_proto_depIdxs = []int32{
...
func init() { file_organization_v1_hierarchy_path_proto_init() }
func file_organization_v1_hierarchy_path_proto_init() {
	if File_organization_v1_hierarchy_path_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v1_hierarchy_path_proto_rawDesc), len(file_organization_v1_hierarchy_path_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v1_hierarchy_path_proto_goTypes,
		DependencyIndexes: file_organization_v1_hierarchy_path_proto_depIdxs,
		MessageInfos:      file_organization_v1_hierarchy_path_proto_msgTypes,
	}.Build()
	File_organization_v1_hierarchy_path_proto = out.File
	file_organization_v1_hierarchy_path_proto_goTypes = nil
	file_organization_v1_hierarchy_path_proto_depIdxs = nil
}
