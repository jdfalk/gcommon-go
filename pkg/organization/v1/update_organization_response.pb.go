...
func (x *UpdateOrganizationResponse) Reset() {
	*x = UpdateOrganizationResponse{}
	mi := &file_organization_v1_update_organization_response_proto_msgTypes[0]
...
var File_organization_v1_update_organization_response_proto protoreflect.FileDescriptor

const file_organization_v1_update_organization_response_proto_rawDesc = "" +
	"\n" +
	"2organization/v1/update_organization_response.proto\x12\x0forganization.v1\x1a\x15common/v1/error.proto\x1a\"organization/v1/organization.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xad\x01\n" +
	...
	"\asuccess\x18\x03 \x01(\bR\asuccessB4Z*github.com/jdfalk/gcommon/pkg/organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_organization_v1_update_organization_response_proto_init() }
func file_organization_v1_update_organization_response_proto_init() {
	if File_organization_v1_update_organization_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v1_update_organization_response_proto_rawDesc), len(file_organization_v1_update_organization_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v1_update_organization_response_proto_goTypes,
		DependencyIndexes: file_organization_v1_update_organization_response_proto_depIdxs,
		MessageInfos:      file_organization_v1_update_organization_response_proto_msgTypes,
	}.Build()
	File_organization_v1_update_organization_response_proto = out.File
	file_organization_v1_update_organization_response_proto_goTypes = nil
	file_organization_v1_update_organization_response_proto_depIdxs = nil
}
