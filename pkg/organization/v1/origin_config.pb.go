...
func (x *OriginConfig) Reset() {
	*x = OriginConfig{}
	mi := &file_organization_v1_origin_config_proto_msgTypes[0]
...
var File_organization_v1_origin_config_proto protoreflect.FileDescriptor

const file_organization_v1_origin_config_proto_rawDesc = "" +
	"\n" +
	"#organization/v1/origin_config.proto\x12\x0forganization.v1\x1a\x19common/v1/key_value.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc0\x01\n" +
	"\fOriginConfig\x12*\n" +
...
func init() { file_organization_v1_origin_config_proto_init() }
func file_organization_v1_origin_config_proto_init() {
	if File_organization_v1_origin_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v1_origin_config_proto_rawDesc), len(file_organization_v1_origin_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v1_origin_config_proto_goTypes,
		DependencyIndexes: file_organization_v1_origin_config_proto_depIdxs,
		MessageInfos:      file_organization_v1_origin_config_proto_msgTypes,
	}.Build()
	File_organization_v1_origin_config_proto = out.File
	file_organization_v1_origin_config_proto_goTypes = nil
	file_organization_v1_origin_config_proto_depIdxs = nil
}
