...
// 	protoc        (unknown)
// source: organization/v1/audit_config.proto
...
func (x *AuditConfig) Reset() {
	*x = AuditConfig{}
	mi := &file_organization_v1_audit_config_proto_msgTypes[0]
...
var File_organization_v1_audit_config_proto protoreflect.FileDescriptor

const file_organization_v1_audit_config_proto_rawDesc = "" +
	"\n" +
	"\"organization/v1/audit_config.proto\x12\x0forganization.v1\x1a!organization/v1/audit_alert.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb8\x02\n" +
	"\vAuditConfig\x12#\n" +
	...
	"\x06alerts\x18\x06 \x03(\v2\x1b.organization.v1.AuditAlertB\b\xbaH\x05\x92\x01\x02\b\x01R\x06alertsB3Z)github.com/jdfalk/gcommon/organization/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_organization_v1_audit_config_proto_depIdxs = []int32{
...
func init() { file_organization_v1_audit_config_proto_init() }
func file_organization_v1_audit_config_proto_init() {
	if File_organization_v1_audit_config_proto != nil {
		return
	}
	file_organization_v1_audit_alert_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v1_audit_config_proto_rawDesc), len(file_organization_v1_audit_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v1_audit_config_proto_goTypes,
		DependencyIndexes: file_organization_v1_audit_config_proto_depIdxs,
		MessageInfos:      file_organization_v1_audit_config_proto_msgTypes,
	}.Build()
	File_organization_v1_audit_config_proto = out.File
	file_organization_v1_audit_config_proto_goTypes = nil
	file_organization_v1_audit_config_proto_depIdxs = nil
}
