...
// 	protoc        (unknown)
// source: organization/v1/network_isolation.proto
...
func (x *NetworkIsolation) Reset() {
	*x = NetworkIsolation{}
	mi := &file_organization_v1_network_isolation_proto_msgTypes[0]
...
var File_organization_v1_network_isolation_proto protoreflect.FileDescriptor

const file_organization_v1_network_isolation_proto_rawDesc = "" +
	"\n" +
	"'organization/v1/network_isolation.proto\x12\x0forganization.v1\x1a organization/v1/cdn_config.proto\x1a#organization/v1/domain_config.proto\x1a*organization/v1/load_balancer_config.proto\x1a&organization/v1/network_acl_rule.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc0\x03\n" +
	...
	"\x06domain\x18\b \x01(\v2\x1d.organization.v1.DomainConfigR\x06domainB4Z*github.com/jdfalk/gcommon/pkg/organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organization_v1_network_isolation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organization_v1_network_isolation_proto_goTypes = []any{
...
var file_organization_v1_network_isolation_proto_depIdxs = []int32{
...
func init() { file_organization_v1_network_isolation_proto_init() }
func file_organization_v1_network_isolation_proto_init() {
	if File_organization_v1_network_isolation_proto != nil {
		return
	}
	file_organization_v1_cdn_config_proto_init()
	file_organization_v1_domain_config_proto_init()
	file_organization_v1_load_balancer_config_proto_init()
	file_organization_v1_network_acl_rule_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v1_network_isolation_proto_rawDesc), len(file_organization_v1_network_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v1_network_isolation_proto_goTypes,
		DependencyIndexes: file_organization_v1_network_isolation_proto_depIdxs,
		MessageInfos:      file_organization_v1_network_isolation_proto_msgTypes,
	}.Build()
	File_organization_v1_network_isolation_proto = out.File
	file_organization_v1_network_isolation_proto_goTypes = nil
	file_organization_v1_network_isolation_proto_depIdxs = nil
}
