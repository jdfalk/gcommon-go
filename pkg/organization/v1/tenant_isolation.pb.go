...
// 	protoc        (unknown)
// source: organization/v1/tenant_isolation.proto
...
type TenantIsolation struct {
	...
	xxx_hidden_Level         v1.OrganizationIsolationLevel `protobuf:"varint,2,opt,name=level,enum=common.v1.OrganizationIsolationLevel"`
	...
	xxx_hidden_AccessControl *v1.OrganizationAccessControl `protobuf:"bytes,8,opt,name=access_control,json=accessControl"`
...
func (x *TenantIsolation) Reset() {
	*x = TenantIsolation{}
	mi := &file_organization_v1_tenant_isolation_proto_msgTypes[0]
...
func (x *TenantIsolation) GetLevel() v1.OrganizationIsolationLevel {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			return x.xxx_hidden_Level
		}
	}
	return v1.OrganizationIsolationLevel(0)
}
...
func (x *TenantIsolation) GetAccessControl() *v1.OrganizationAccessControl {
	if x != nil {
...
func (x *TenantIsolation) GetMetadata() []*v1.KeyValue {
	if x != nil {
...
func (x *TenantIsolation) SetLevel(v v1.OrganizationIsolationLevel) {
...
func (x *TenantIsolation) SetAccessControl(v *v1.OrganizationAccessControl) {
...
func (x *TenantIsolation) SetMetadata(v []*v1.KeyValue) {
	var sv *[]*v1.KeyValue
...
func (x *TenantIsolation) ClearLevel() {
	...
	x.xxx_hidden_Level = v1.OrganizationIsolationLevel_ISOLATION_LEVEL_UNSPECIFIED
}
...
type TenantIsolation_builder struct {
	...
	Level *v1.OrganizationIsolationLevel
	...
	AccessControl *v1.OrganizationAccessControl
...
var File_organization_v1_tenant_isolation_proto protoreflect.FileDescriptor

const file_organization_v1_tenant_isolation_proto_rawDesc = "" +
	"\n" +
	"&organization/v1/tenant_isolation.proto\x12\x0forganization.v1\x1a\x1fcommon/v1/isolation_level.proto\x1a\x19common/v1/key_value.proto\x1a+common/v1/organization_access_control.proto\x1a\"organization/v1/audit_config.proto\x1a'organization/v1/compute_isolation.proto\x1a(organization/v1/database_isolation.proto\x1a'organization/v1/encryption_config.proto\x1a'organization/v1/network_isolation.proto\x1a'organization/v1/storage_isolation.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x90\x06\n" +
	...
	"\rconfigured_by\x18\r \x01(\tR\fconfiguredByB3Z)github.com/jdfalk/gcommon/organization/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organization_v1_tenant_isolation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organization_v1_tenant_isolation_proto_goTypes = []any{
	(*TenantIsolation)(nil),              // 0: organization.v1.TenantIsolation
	(v1.OrganizationIsolationLevel)(0),   // 1: common.v1.OrganizationIsolationLevel
	...
	(*v1.OrganizationAccessControl)(nil), // 7: common.v1.OrganizationAccessControl
	(*AuditConfig)(nil),                  // 8: organization.v1.AuditConfig
	(*v1.KeyValue)(nil),                  // 9: common.v1.KeyValue
	(*timestamppb.Timestamp)(nil),        // 10: google.protobuf.Timestamp
}
var file_organization_v1_tenant_isolation_proto_depIdxs = []int32{
...
func init() { file_organization_v1_tenant_isolation_proto_init() }
func file_organization_v1_tenant_isolation_proto_init() {
	if File_organization_v1_tenant_isolation_proto != nil {
		return
	}
	file_organization_v1_audit_config_proto_init()
	file_organization_v1_compute_isolation_proto_init()
	file_organization_v1_database_isolation_proto_init()
	file_organization_v1_encryption_config_proto_init()
	file_organization_v1_network_isolation_proto_init()
	file_organization_v1_storage_isolation_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v1_tenant_isolation_proto_rawDesc), len(file_organization_v1_tenant_isolation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v1_tenant_isolation_proto_goTypes,
		DependencyIndexes: file_organization_v1_tenant_isolation_proto_depIdxs,
		MessageInfos:      file_organization_v1_tenant_isolation_proto_msgTypes,
	}.Build()
	File_organization_v1_tenant_isolation_proto = out.File
	file_organization_v1_tenant_isolation_proto_goTypes = nil
	file_organization_v1_tenant_isolation_proto_depIdxs = nil
}
