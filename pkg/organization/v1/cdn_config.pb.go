...
// 	protoc        (unknown)
// source: organization/v1/cdn_config.proto
...
func (x *CDNConfig) Reset() {
	*x = CDNConfig{}
	mi := &file_organization_v1_cdn_config_proto_msgTypes[0]
...
var File_organization_v1_cdn_config_proto protoreflect.FileDescriptor

const file_organization_v1_cdn_config_proto_rawDesc = "" +
	"\n" +
	" organization/v1/cdn_config.proto\x12\x0forganization.v1\x1a$organization/v1/cache_behavior.proto\x1a#organization/v1/origin_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xec\x01\n" +
	"\tCDNConfig\x12#\n" +
	...
	"\x06origin\x18\x04 \x01(\v2\x1d.organization.v1.OriginConfigR\x06originB4Z*github.com/jdfalk/gcommon/pkg/organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organization_v1_cdn_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organization_v1_cdn_config_proto_goTypes = []any{
	(*CDNConfig)(nil),     // 0: organization.v1.CDNConfig
	(*CacheBehavior)(nil), // 1: organization.v1.CacheBehavior
	(*OriginConfig)(nil),  // 2: organization.v1.OriginConfig
}
var file_organization_v1_cdn_config_proto_depIdxs = []int32{
	1, // 0: organization.v1.CDNConfig.cache_behaviors:type_name -> organization.v1.CacheBehavior
	2, // 1: organization.v1.CDNConfig.origin:type_name -> organization.v1.OriginConfig
...
func init() { file_organization_v1_cdn_config_proto_init() }
func file_organization_v1_cdn_config_proto_init() {
	if File_organization_v1_cdn_config_proto != nil {
		return
	}
	file_organization_v1_cache_behavior_proto_init()
	file_organization_v1_origin_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v1_cdn_config_proto_rawDesc), len(file_organization_v1_cdn_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v1_cdn_config_proto_goTypes,
		DependencyIndexes: file_organization_v1_cdn_config_proto_depIdxs,
		MessageInfos:      file_organization_v1_cdn_config_proto_msgTypes,
	}.Build()
	File_organization_v1_cdn_config_proto = out.File
	file_organization_v1_cdn_config_proto_goTypes = nil
	file_organization_v1_cdn_config_proto_depIdxs = nil
}
