...
// 	protoc        (unknown)
// source: organization/v1/update_department_request.proto
...
func (x *UpdateDepartmentRequest) Reset() {
	*x = UpdateDepartmentRequest{}
	mi := &file_organization_v1_update_department_request_proto_msgTypes[0]
...
func (x *UpdateDepartmentRequest) GetMetadata() *v1.RequestMetadata {
	if x != nil {
...
func (x *UpdateDepartmentRequest) SetMetadata(v *v1.RequestMetadata) {
...
var File_organization_v1_update_department_request_proto protoreflect.FileDescriptor

const file_organization_v1_update_department_request_proto_rawDesc = "" +
	"\n" +
	"/organization/v1/update_department_request.proto\x12\x0forganization.v1\x1a common/v1/request_metadata.proto\x1a organization/v1/department.proto\x1a google/protobuf/field_mask.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9e\x02\n" +
...
var file_organization_v1_update_department_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organization_v1_update_department_request_proto_goTypes = []any{
...
var file_organization_v1_update_department_request_proto_depIdxs = []int32{
...
func init() { file_organization_v1_update_department_request_proto_init() }
func file_organization_v1_update_department_request_proto_init() {
	if File_organization_v1_update_department_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v1_update_department_request_proto_rawDesc), len(file_organization_v1_update_department_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v1_update_department_request_proto_goTypes,
		DependencyIndexes: file_organization_v1_update_department_request_proto_depIdxs,
		MessageInfos:      file_organization_v1_update_department_request_proto_msgTypes,
	}.Build()
	File_organization_v1_update_department_request_proto = out.File
	file_organization_v1_update_department_request_proto_goTypes = nil
	file_organization_v1_update_department_request_proto_depIdxs = nil
}
