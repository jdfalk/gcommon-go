...
// 	protoc        (unknown)
// source: organization/v1/domain_config.proto
...
func (x *DomainConfig) Reset() {
	*x = DomainConfig{}
	mi := &file_organization_v1_domain_config_proto_msgTypes[0]
...
var File_organization_v1_domain_config_proto protoreflect.FileDescriptor

const file_organization_v1_domain_config_proto_rawDesc = "" +
	"\n" +
	"#organization/v1/domain_config.proto\x12\x0forganization.v1\x1a organization/v1/dns_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbe\x01\n" +
	"\fDomainConfig\x12*\n" +
	...
	"\x11validation_status\x18\x04 \x01(\tR\x10validationStatusB5Z+github.com/jdfalk/gcommon/pkg/organization/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organization_v1_domain_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organization_v1_domain_config_proto_goTypes = []any{
	(*DomainConfig)(nil), // 0: organization.v1.DomainConfig
	(*DNSConfig)(nil),    // 1: organization.v1.DNSConfig
}
var file_organization_v1_domain_config_proto_depIdxs = []int32{
	1, // 0: organization.v1.DomainConfig.dns:type_name -> organization.v1.DNSConfig
...
func init() { file_organization_v1_domain_config_proto_init() }
func file_organization_v1_domain_config_proto_init() {
	if File_organization_v1_domain_config_proto != nil {
		return
	}
	file_organization_v1_dns_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v1_domain_config_proto_rawDesc), len(file_organization_v1_domain_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v1_domain_config_proto_goTypes,
		DependencyIndexes: file_organization_v1_domain_config_proto_depIdxs,
		MessageInfos:      file_organization_v1_domain_config_proto_msgTypes,
	}.Build()
	File_organization_v1_domain_config_proto = out.File
	file_organization_v1_domain_config_proto_goTypes = nil
	file_organization_v1_domain_config_proto_depIdxs = nil
}
