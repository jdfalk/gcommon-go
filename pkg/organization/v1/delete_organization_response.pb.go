...
func (x *DeleteOrganizationResponse) Reset() {
	*x = DeleteOrganizationResponse{}
	mi := &file_organization_v1_delete_organization_response_proto_msgTypes[0]
...
var File_organization_v1_delete_organization_response_proto protoreflect.FileDescriptor

const file_organization_v1_delete_organization_response_proto_rawDesc = "" +
	"\n" +
...
func init() { file_organization_v1_delete_organization_response_proto_init() }
func file_organization_v1_delete_organization_response_proto_init() {
	if File_organization_v1_delete_organization_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v1_delete_organization_response_proto_rawDesc), len(file_organization_v1_delete_organization_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v1_delete_organization_response_proto_goTypes,
		DependencyIndexes: file_organization_v1_delete_organization_response_proto_depIdxs,
		MessageInfos:      file_organization_v1_delete_organization_response_proto_msgTypes,
	}.Build()
	File_organization_v1_delete_organization_response_proto = out.File
	file_organization_v1_delete_organization_response_proto_goTypes = nil
	file_organization_v1_delete_organization_response_proto_depIdxs = nil
}
