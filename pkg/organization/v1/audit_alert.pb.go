...
// 	protoc        (unknown)
// source: organization/v1/audit_alert.proto
...
func (x *AuditAlert) Reset() {
	*x = AuditAlert{}
	mi := &file_organization_v1_audit_alert_proto_msgTypes[0]
...
var File_organization_v1_audit_alert_proto protoreflect.FileDescriptor

const file_organization_v1_audit_alert_proto_rawDesc = "" +
	"\n" +
	"!organization/v1/audit_alert.proto\x12\x0forganization.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf1\x01\n" +
	"\n" +
	"AuditAlert\x12\x1d\n" +
	...
	"\x13time_window_minutes\x18\x06 \x01(\x05R\x11timeWindowMinutesB4Z*github.com/jdfalk/gcommon/pkg/organization\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_organization_v1_audit_alert_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_organization_v1_audit_alert_proto_goTypes = []any{
	(*AuditAlert)(nil), // 0: organization.v1.AuditAlert
}
var file_organization_v1_audit_alert_proto_depIdxs = []int32{
...
func init() { file_organization_v1_audit_alert_proto_init() }
func file_organization_v1_audit_alert_proto_init() {
	if File_organization_v1_audit_alert_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_organization_v1_audit_alert_proto_rawDesc), len(file_organization_v1_audit_alert_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_organization_v1_audit_alert_proto_goTypes,
		DependencyIndexes: file_organization_v1_audit_alert_proto_depIdxs,
		MessageInfos:      file_organization_v1_audit_alert_proto_msgTypes,
	}.Build()
	File_organization_v1_audit_alert_proto = out.File
	file_organization_v1_audit_alert_proto_goTypes = nil
	file_organization_v1_audit_alert_proto_depIdxs = nil
}
