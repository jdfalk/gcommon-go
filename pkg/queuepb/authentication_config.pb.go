...
// 	protoc        (unknown)
// source: queuepb/v1/authentication_config.proto
...
func (x *AuthenticationConfig) Reset() {
	*x = AuthenticationConfig{}
	mi := &file_queuepb_v1_authentication_config_proto_msgTypes[0]
...
func (x case_AuthenticationConfig_AuthType) String() string {
	md := file_queuepb_v1_authentication_config_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_queuepb_v1_authentication_config_proto protoreflect.FileDescriptor

const file_queuepb_v1_authentication_config_proto_rawDesc = "" +
	"\n" +
	"&queuepb/v1/authentication_config.proto\x12\bqueue.v1\x1a\x1dqueuepb/v1/api_key_auth.proto\x1a\x1dqueuepb/v1/o_auth2_auth.proto\x1a\x1aqueuepb/v1/sasl_auth.proto\x1a\x19queuepb/v1/tls_auth.proto\x1a'queuepb/v1/username_password_auth.proto\x1a!google/protobuf/go_features.proto\"\xba\x02\n" +
	"\x14AuthenticationConfig\x12\x14\n" +
	"\x04none\x18\x01 \x01(\bH\x00R\x04none\x12M\n" +
	"\x11username_password\x18\x02 \x01(\v2\x1e.queue.v1.UsernamePasswordAuthH\x00R\x10usernamePassword\x12/\n" +
	"\aapi_key\x18\x03 \x01(\v2\x14.queue.v1.APIKeyAuthH\x00R\x06apiKey\x12%\n" +
	...
	"\tauth_typeB\x99\x01\n" +
	"\fcom.queue.v1B\x19AuthenticationConfigProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_authentication_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_authentication_config_proto_goTypes = []any{
	(*AuthenticationConfig)(nil), // 0: queue.v1.AuthenticationConfig
	(*UsernamePasswordAuth)(nil), // 1: queue.v1.UsernamePasswordAuth
	(*APIKeyAuth)(nil),           // 2: queue.v1.APIKeyAuth
	(*TLSAuth)(nil),              // 3: queue.v1.TLSAuth
	(*SASLAuth)(nil),             // 4: queue.v1.SASLAuth
	(*OAuth2Auth)(nil),           // 5: queue.v1.OAuth2Auth
}
var file_queuepb_v1_authentication_config_proto_depIdxs = []int32{
	1, // 0: queue.v1.AuthenticationConfig.username_password:type_name -> queue.v1.UsernamePasswordAuth
	2, // 1: queue.v1.AuthenticationConfig.api_key:type_name -> queue.v1.APIKeyAuth
	3, // 2: queue.v1.AuthenticationConfig.tls:type_name -> queue.v1.TLSAuth
	4, // 3: queue.v1.AuthenticationConfig.sasl:type_name -> queue.v1.SASLAuth
	5, // 4: queue.v1.AuthenticationConfig.oauth2:type_name -> queue.v1.OAuth2Auth
...
func init() { file_queuepb_v1_authentication_config_proto_init() }
func file_queuepb_v1_authentication_config_proto_init() {
	if File_queuepb_v1_authentication_config_proto != nil {
		return
	}
	file_queuepb_v1_api_key_auth_proto_init()
	file_queuepb_v1_o_auth2_auth_proto_init()
	file_queuepb_v1_sasl_auth_proto_init()
	file_queuepb_v1_tls_auth_proto_init()
	file_queuepb_v1_username_password_auth_proto_init()
	file_queuepb_v1_authentication_config_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_authentication_config_proto_rawDesc), len(file_queuepb_v1_authentication_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_authentication_config_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_authentication_config_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_authentication_config_proto_msgTypes,
	}.Build()
	File_queuepb_v1_authentication_config_proto = out.File
	file_queuepb_v1_authentication_config_proto_goTypes = nil
	file_queuepb_v1_authentication_config_proto_depIdxs = nil
}
