...
// 	protoc        (unknown)
// source: queuepb/v1/sasl_auth.proto
...
func (x *SASLAuth) Reset() {
	*x = SASLAuth{}
	mi := &file_queuepb_v1_sasl_auth_proto_msgTypes[0]
...
var File_queuepb_v1_sasl_auth_proto protoreflect.FileDescriptor

const file_queuepb_v1_sasl_auth_proto_rawDesc = "" +
	"\n" +
	"\x1aqueuepb/v1/sasl_auth.proto\x12\bqueue.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xfe\x01\n" +
	"\bSASLAuth\x12%\n" +
	...
	"\n" +
	"properties\x18\x04 \x03(\v2\".queue.v1.SASLAuth.PropertiesEntryR\n" +
	"properties\x1a=\n" +
	"\x0fPropertiesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x8d\x01\n" +
	"\fcom.queue.v1B\rSaslAuthProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_sasl_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queuepb_v1_sasl_auth_proto_goTypes = []any{
	(*SASLAuth)(nil), // 0: queue.v1.SASLAuth
	nil,              // 1: queue.v1.SASLAuth.PropertiesEntry
}
var file_queuepb_v1_sasl_auth_proto_depIdxs = []int32{
	1, // 0: queue.v1.SASLAuth.properties:type_name -> queue.v1.SASLAuth.PropertiesEntry
...
func init() { file_queuepb_v1_sasl_auth_proto_init() }
func file_queuepb_v1_sasl_auth_proto_init() {
	if File_queuepb_v1_sasl_auth_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_sasl_auth_proto_rawDesc), len(file_queuepb_v1_sasl_auth_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_sasl_auth_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_sasl_auth_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_sasl_auth_proto_msgTypes,
	}.Build()
	File_queuepb_v1_sasl_auth_proto = out.File
	file_queuepb_v1_sasl_auth_proto_goTypes = nil
	file_queuepb_v1_sasl_auth_proto_depIdxs = nil
}
