...
// 	protoc        (unknown)
// source: queuepb/v1/consumer_group_config.proto
...
type ConsumerGroupConfig struct {
	...
	xxx_hidden_LoadBalancingStrategy commonpb.LoadBalancingStrategy `protobuf:"varint,1,opt,name=load_balancing_strategy,json=loadBalancingStrategy,enum=common.v1.LoadBalancingStrategy"`
	xxx_hidden_RebalanceStrategy     commonpb.RebalanceStrategy     `protobuf:"varint,2,opt,name=rebalance_strategy,json=rebalanceStrategy,enum=common.v1.RebalanceStrategy"`
	...
	xxx_hidden_OffsetResetStrategy   commonpb.OffsetResetStrategy   `protobuf:"varint,7,opt,name=offset_reset_strategy,json=offsetResetStrategy,enum=common.v1.OffsetResetStrategy"`
...
func (x *ConsumerGroupConfig) Reset() {
	*x = ConsumerGroupConfig{}
	mi := &file_queuepb_v1_consumer_group_config_proto_msgTypes[0]
...
func (x *ConsumerGroupConfig) GetLoadBalancingStrategy() commonpb.LoadBalancingStrategy {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 0) {
			return x.xxx_hidden_LoadBalancingStrategy
		}
	}
	return commonpb.LoadBalancingStrategy(0)
}

func (x *ConsumerGroupConfig) GetRebalanceStrategy() commonpb.RebalanceStrategy {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			return x.xxx_hidden_RebalanceStrategy
		}
	}
	return commonpb.RebalanceStrategy(0)
}
...
func (x *ConsumerGroupConfig) GetOffsetResetStrategy() commonpb.OffsetResetStrategy {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 6) {
			return x.xxx_hidden_OffsetResetStrategy
		}
	}
	return commonpb.OffsetResetStrategy(0)
}
...
func (x *ConsumerGroupConfig) SetLoadBalancingStrategy(v commonpb.LoadBalancingStrategy) {
	x.xxx_hidden_LoadBalancingStrategy = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 10)
}

func (x *ConsumerGroupConfig) SetRebalanceStrategy(v commonpb.RebalanceStrategy) {
...
func (x *ConsumerGroupConfig) SetOffsetResetStrategy(v commonpb.OffsetResetStrategy) {
...
func (x *ConsumerGroupConfig) ClearLoadBalancingStrategy() {
	...
	x.xxx_hidden_LoadBalancingStrategy = commonpb.LoadBalancingStrategy_LOAD_BALANCING_STRATEGY_UNSPECIFIED
}

func (x *ConsumerGroupConfig) ClearRebalanceStrategy() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_RebalanceStrategy = commonpb.RebalanceStrategy_REBALANCE_STRATEGY_UNSPECIFIED
}
...
func (x *ConsumerGroupConfig) ClearOffsetResetStrategy() {
	...
	x.xxx_hidden_OffsetResetStrategy = commonpb.OffsetResetStrategy_OFFSET_RESET_STRATEGY_UNSPECIFIED
}
...
type ConsumerGroupConfig_builder struct {
	...
	LoadBalancingStrategy *commonpb.LoadBalancingStrategy
	// Rebalance strategy when consumers join/leave
	RebalanceStrategy *commonpb.RebalanceStrategy
	...
	OffsetResetStrategy *commonpb.OffsetResetStrategy
...
var File_queuepb_v1_consumer_group_config_proto protoreflect.FileDescriptor

const file_queuepb_v1_consumer_group_config_proto_rawDesc = "" +
	"\n" +
	"&queuepb/v1/consumer_group_config.proto\x12\bqueue.v1\x1a)commonpb/v1/load_balancing_strategy.proto\x1a'commonpb/v1/offset_reset_strategy.proto\x1a$commonpb/v1/rebalance_strategy.proto\x1a#queuepb/v1/auto_commit_config.proto\x1a)queuepb/v1/dead_letter_queue_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9b\x05\n" +
	"\x13ConsumerGroupConfig\x12X\n" +
	"\x17load_balancing_strategy\x18\x01 \x01(\x0e2 .common.v1.LoadBalancingStrategyR\x15loadBalancingStrategy\x12K\n" +
	"\x12rebalance_strategy\x18\x02 \x01(\x0e2\x1c.common.v1.RebalanceStrategyR\x11rebalanceStrategy\x125\n" +
	...
	"\vauto_commit\x18\x06 \x01(\v2\x1a.queue.v1.AutoCommitConfigR\n" +
	"autoCommit\x12R\n" +
	"\x15offset_reset_strategy\x18\a \x01(\x0e2\x1e.common.v1.OffsetResetStrategyR\x13offsetResetStrategy\x12,\n" +
	...
	"\n" +
	"dlq_config\x18\n" +
	" \x01(\v2\x1f.queue.v1.DeadLetterQueueConfigR\tdlqConfigB\x98\x01\n" +
	"\fcom.queue.v1B\x18ConsumerGroupConfigProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_consumer_group_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_consumer_group_config_proto_goTypes = []any{
	(*ConsumerGroupConfig)(nil),         // 0: queue.v1.ConsumerGroupConfig
	(commonpb.LoadBalancingStrategy)(0), // 1: common.v1.LoadBalancingStrategy
	(commonpb.RebalanceStrategy)(0),     // 2: common.v1.RebalanceStrategy
	(*AutoCommitConfig)(nil),            // 3: queue.v1.AutoCommitConfig
	(commonpb.OffsetResetStrategy)(0),   // 4: common.v1.OffsetResetStrategy
	(*DeadLetterQueueConfig)(nil),       // 5: queue.v1.DeadLetterQueueConfig
}
var file_queuepb_v1_consumer_group_config_proto_depIdxs = []int32{
	1, // 0: queue.v1.ConsumerGroupConfig.load_balancing_strategy:type_name -> common.v1.LoadBalancingStrategy
	2, // 1: queue.v1.ConsumerGroupConfig.rebalance_strategy:type_name -> common.v1.RebalanceStrategy
	3, // 2: queue.v1.ConsumerGroupConfig.auto_commit:type_name -> queue.v1.AutoCommitConfig
	4, // 3: queue.v1.ConsumerGroupConfig.offset_reset_strategy:type_name -> common.v1.OffsetResetStrategy
	5, // 4: queue.v1.ConsumerGroupConfig.dlq_config:type_name -> queue.v1.DeadLetterQueueConfig
...
func init() { file_queuepb_v1_consumer_group_config_proto_init() }
func file_queuepb_v1_consumer_group_config_proto_init() {
	if File_queuepb_v1_consumer_group_config_proto != nil {
		return
	}
	file_queuepb_v1_auto_commit_config_proto_init()
	file_queuepb_v1_dead_letter_queue_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_consumer_group_config_proto_rawDesc), len(file_queuepb_v1_consumer_group_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_consumer_group_config_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_consumer_group_config_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_consumer_group_config_proto_msgTypes,
	}.Build()
	File_queuepb_v1_consumer_group_config_proto = out.File
	file_queuepb_v1_consumer_group_config_proto_goTypes = nil
	file_queuepb_v1_consumer_group_config_proto_depIdxs = nil
}
