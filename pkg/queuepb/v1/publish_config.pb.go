...
// 	protoc        (unknown)
// source: queuepb/v1/publish_config.proto
...
type PublishConfig struct {
	...
	xxx_hidden_RetryConfig        *commonpb.CommonRetryPolicy `protobuf:"bytes,6,opt,name=retry_config,json=retryConfig"`
...
func (x *PublishConfig) Reset() {
	*x = PublishConfig{}
	mi := &file_queuepb_v1_publish_config_proto_msgTypes[0]
...
func (x *PublishConfig) GetRetryConfig() *commonpb.CommonRetryPolicy {
	if x != nil {
...
func (x *PublishConfig) SetRetryConfig(v *commonpb.CommonRetryPolicy) {
...
type PublishConfig_builder struct {
	...
	RetryConfig *commonpb.CommonRetryPolicy
...
var File_queuepb_v1_publish_config_proto protoreflect.FileDescriptor

const file_queuepb_v1_publish_config_proto_rawDesc = "" +
	"\n" +
	"\x1fqueuepb/v1/publish_config.proto\x12\bqueue.v1\x1a\x1ecommonpb/v1/retry_policy.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe0\x02\n" +
	"\rPublishConfig\x12 \n" +
	...
	"\x11persistence_level\x18\a \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x10persistenceLevelB\x92\x01\n" +
	"\fcom.queue.v1B\x12PublishConfigProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_publish_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_publish_config_proto_goTypes = []any{
	(*PublishConfig)(nil),              // 0: queue.v1.PublishConfig
	(*commonpb.CommonRetryPolicy)(nil), // 1: common.v1.CommonRetryPolicy
}
var file_queuepb_v1_publish_config_proto_depIdxs = []int32{
...
func init() { file_queuepb_v1_publish_config_proto_init() }
func file_queuepb_v1_publish_config_proto_init() {
	if File_queuepb_v1_publish_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_publish_config_proto_rawDesc), len(file_queuepb_v1_publish_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_publish_config_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_publish_config_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_publish_config_proto_msgTypes,
	}.Build()
	File_queuepb_v1_publish_config_proto = out.File
	file_queuepb_v1_publish_config_proto_goTypes = nil
	file_queuepb_v1_publish_config_proto_depIdxs = nil
}
