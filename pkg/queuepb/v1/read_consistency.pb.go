...
// 	protoc        (unknown)
// source: queuepb/v1/read_consistency.proto
...
type ReadConsistency struct {
	...
	xxx_hidden_Level          commonpb.ReadLevel     `protobuf:"varint,1,opt,name=level,enum=common.v1.ReadLevel"`
...
func (x *ReadConsistency) Reset() {
	*x = ReadConsistency{}
	mi := &file_queuepb_v1_read_consistency_proto_msgTypes[0]
...
func (x *ReadConsistency) GetLevel() commonpb.ReadLevel {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 0) {
			return x.xxx_hidden_Level
		}
	}
	return commonpb.ReadLevel(0)
}
...
func (x *ReadConsistency) SetLevel(v commonpb.ReadLevel) {
...
func (x *ReadConsistency) ClearLevel() {
	...
	x.xxx_hidden_Level = commonpb.ReadLevel_READ_LEVEL_UNSPECIFIED
}
...
var File_queuepb_v1_read_consistency_proto protoreflect.FileDescriptor

const file_queuepb_v1_read_consistency_proto_rawDesc = "" +
	"\n" +
	"!queuepb/v1/read_consistency.proto\x12\bqueue.v1\x1a\x1ccommonpb/v1/read_level.proto\x1a\"queuepb/v1/read_retry_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa9\x02\n" +
	"\x0fReadConsistency\x12*\n" +
	"\x05level\x18\x01 \x01(\x0e2\x14.common.v1.ReadLevelR\x05level\x121\n" +
	...
	"\fretry_config\x18\x06 \x01(\v2\x19.queue.v1.ReadRetryConfigR\vretryConfigB\x94\x01\n" +
	"\fcom.queue.v1B\x14ReadConsistencyProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_read_consistency_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_read_consistency_proto_goTypes = []any{
	(*ReadConsistency)(nil), // 0: queue.v1.ReadConsistency
	(commonpb.ReadLevel)(0), // 1: common.v1.ReadLevel
	(*ReadRetryConfig)(nil), // 2: queue.v1.ReadRetryConfig
}
var file_queuepb_v1_read_consistency_proto_depIdxs = []int32{
	1, // 0: queue.v1.ReadConsistency.level:type_name -> common.v1.ReadLevel
	2, // 1: queue.v1.ReadConsistency.retry_config:type_name -> queue.v1.ReadRetryConfig
...
func init() { file_queuepb_v1_read_consistency_proto_init() }
func file_queuepb_v1_read_consistency_proto_init() {
	if File_queuepb_v1_read_consistency_proto != nil {
		return
	}
	file_queuepb_v1_read_retry_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_read_consistency_proto_rawDesc), len(file_queuepb_v1_read_consistency_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_read_consistency_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_read_consistency_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_read_consistency_proto_msgTypes,
	}.Build()
	File_queuepb_v1_read_consistency_proto = out.File
	file_queuepb_v1_read_consistency_proto_goTypes = nil
	file_queuepb_v1_read_consistency_proto_depIdxs = nil
}
