...
// 	protoc        (unknown)
// source: queuepb/v1/enqueue_request.proto
...
func (x *EnqueueRequest) Reset() {
	*x = EnqueueRequest{}
	mi := &file_queuepb_v1_enqueue_request_proto_msgTypes[0]
...
func (x *EnqueueRequest) GetMetadata() *commonpb.RequestMetadata {
	if x != nil {
...
func (x *EnqueueRequest) SetMetadata(v *commonpb.RequestMetadata) {
...
var File_queuepb_v1_enqueue_request_proto protoreflect.FileDescriptor

const file_queuepb_v1_enqueue_request_proto_rawDesc = "" +
	"\n" +
	" queuepb/v1/enqueue_request.proto\x12\bqueue.v1\x1a\"commonpb/v1/request_metadata.proto\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xcd\x05\n" +
	...
	"\bmetadata\x18\v \x01(\v2\x1a.common.v1.RequestMetadataR\bmetadata\x12\x1a\n" +
	...
	"\n" +
	"attributes\x18\x12 \x03(\v2(.queue.v1.EnqueueRequest.AttributesEntryR\n" +
	"attributes\x12!\n" +
	...
	"\fcom.queue.v1B\x13EnqueueRequestProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_enqueue_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queuepb_v1_enqueue_request_proto_goTypes = []any{
...
var file_queuepb_v1_enqueue_request_proto_depIdxs = []int32{
	2, // 0: queue.v1.EnqueueRequest.payload:type_name -> google.protobuf.Any
	3, // 1: queue.v1.EnqueueRequest.metadata:type_name -> common.v1.RequestMetadata
	4, // 2: queue.v1.EnqueueRequest.delay:type_name -> google.protobuf.Duration
	5, // 3: queue.v1.EnqueueRequest.expires_at:type_name -> google.protobuf.Timestamp
	1, // 4: queue.v1.EnqueueRequest.attributes:type_name -> queue.v1.EnqueueRequest.AttributesEntry
...
func init() { file_queuepb_v1_enqueue_request_proto_init() }
func file_queuepb_v1_enqueue_request_proto_init() {
	if File_queuepb_v1_enqueue_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_enqueue_request_proto_rawDesc), len(file_queuepb_v1_enqueue_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_enqueue_request_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_enqueue_request_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_enqueue_request_proto_msgTypes,
	}.Build()
	File_queuepb_v1_enqueue_request_proto = out.File
	file_queuepb_v1_enqueue_request_proto_goTypes = nil
	file_queuepb_v1_enqueue_request_proto_depIdxs = nil
}
