...
// 	protoc        (unknown)
// source: queuepb/v1/tls_auth.proto
...
func (x *TLSAuth) Reset() {
	*x = TLSAuth{}
	mi := &file_queuepb_v1_tls_auth_proto_msgTypes[0]
...
var File_queuepb_v1_tls_auth_proto protoreflect.FileDescriptor

const file_queuepb_v1_tls_auth_proto_rawDesc = "" +
	"\n" +
	"\x19queuepb/v1/tls_auth.proto\x12\bqueue.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x94\x01\n" +
	"\aTLSAuth\x12\"\n" +
	"\bcert_pem\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\acertPem\x12 \n" +
	...
	"\rverify_server\x18\x04 \x01(\bR\fverifyServerB\x8c\x01\n" +
	"\fcom.queue.v1B\fTlsAuthProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_tls_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_tls_auth_proto_goTypes = []any{
	(*TLSAuth)(nil), // 0: queue.v1.TLSAuth
}
var file_queuepb_v1_tls_auth_proto_depIdxs = []int32{
...
func init() { file_queuepb_v1_tls_auth_proto_init() }
func file_queuepb_v1_tls_auth_proto_init() {
	if File_queuepb_v1_tls_auth_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_tls_auth_proto_rawDesc), len(file_queuepb_v1_tls_auth_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_tls_auth_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_tls_auth_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_tls_auth_proto_msgTypes,
	}.Build()
	File_queuepb_v1_tls_auth_proto = out.File
	file_queuepb_v1_tls_auth_proto_goTypes = nil
	file_queuepb_v1_tls_auth_proto_depIdxs = nil
}
