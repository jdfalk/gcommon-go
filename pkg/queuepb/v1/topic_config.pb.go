...
// 	protoc        (unknown)
// source: queuepb/v1/topic_config.proto
...
func (x *TopicConfig) Reset() {
	*x = TopicConfig{}
	mi := &file_queuepb_v1_topic_config_proto_msgTypes[0]
...
var File_queuepb_v1_topic_config_proto protoreflect.FileDescriptor

const file_queuepb_v1_topic_config_proto_rawDesc = "" +
	"\n" +
	"\x1dqueuepb/v1/topic_config.proto\x12\bqueue.v1\x1a!queuepb/v1/partition_config.proto\x1a!queuepb/v1/retention_policy.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9e\x03\n" +
	"\vTopicConfig\x12*\n" +
	"\fmax_messages\x18\x01 \x01(\x04B\a\xbaH\x042\x02(\x00R\vmaxMessages\x12-\n" +
	"\x0emax_size_bytes\x18\x02 \x01(\x04B\a\xbaH\x042\x02(\x00R\fmaxSizeBytes\x12I\n" +
	"\x10retention_policy\x18\x03 \x01(\v2\x1e.queue.v1.QueueRetentionPolicyR\x0fretentionPolicy\x12D\n" +
	"\x10partition_config\x18\x04 \x01(\v2\x19.queue.v1.PartitionConfigR\x0fpartitionConfig\x12\x1e\n" +
	"\n" +
	...
	"\x11enable_compaction\x18\b \x01(\bR\x10enableCompactionB\x90\x01\n" +
	"\fcom.queue.v1B\x10TopicConfigProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_topic_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_topic_config_proto_goTypes = []any{
	(*TopicConfig)(nil),          // 0: queue.v1.TopicConfig
	(*QueueRetentionPolicy)(nil), // 1: queue.v1.QueueRetentionPolicy
	(*PartitionConfig)(nil),      // 2: queue.v1.PartitionConfig
}
var file_queuepb_v1_topic_config_proto_depIdxs = []int32{
	1, // 0: queue.v1.TopicConfig.retention_policy:type_name -> queue.v1.QueueRetentionPolicy
	2, // 1: queue.v1.TopicConfig.partition_config:type_name -> queue.v1.PartitionConfig
...
func init() { file_queuepb_v1_topic_config_proto_init() }
func file_queuepb_v1_topic_config_proto_init() {
	if File_queuepb_v1_topic_config_proto != nil {
		return
	}
	file_queuepb_v1_partition_config_proto_init()
	file_queuepb_v1_retention_policy_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_topic_config_proto_rawDesc), len(file_queuepb_v1_topic_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_topic_config_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_topic_config_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_topic_config_proto_msgTypes,
	}.Build()
	File_queuepb_v1_topic_config_proto = out.File
	file_queuepb_v1_topic_config_proto_goTypes = nil
	file_queuepb_v1_topic_config_proto_depIdxs = nil
}
