...
// 	protoc        (unknown)
// source: queuepb/v1/replication_consistency.proto
...
type ReplicationConsistency struct {
	...
	xxx_hidden_ReplicationLevel      commonpb.ReplicationLevel `protobuf:"varint,4,opt,name=replication_level,json=replicationLevel,enum=common.v1.ReplicationLevel"`
...
func (x *ReplicationConsistency) Reset() {
	*x = ReplicationConsistency{}
	mi := &file_queuepb_v1_replication_consistency_proto_msgTypes[0]
...
func (x *ReplicationConsistency) GetReplicationLevel() commonpb.ReplicationLevel {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 3) {
			return x.xxx_hidden_ReplicationLevel
		}
	}
	return commonpb.ReplicationLevel(0)
}
...
func (x *ReplicationConsistency) SetReplicationLevel(v commonpb.ReplicationLevel) {
...
func (x *ReplicationConsistency) ClearReplicationLevel() {
	...
	x.xxx_hidden_ReplicationLevel = commonpb.ReplicationLevel_REPLICATION_LEVEL_UNSPECIFIED
}
...
type ReplicationConsistency_builder struct {
	...
	ReplicationLevel *commonpb.ReplicationLevel
...
var File_queuepb_v1_replication_consistency_proto protoreflect.FileDescriptor

const file_queuepb_v1_replication_consistency_proto_rawDesc = "" +
	"\n" +
	"(queuepb/v1/replication_consistency.proto\x12\bqueue.v1\x1a#commonpb/v1/replication_level.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf9\x02\n" +
	"\x16ReplicationConsistency\x125\n" +
	"\x12min_write_replicas\x18\x01 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x10minWriteReplicas\x123\n" +
	"\x11min_read_replicas\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x0fminReadReplicas\x126\n" +
	"\x12replication_factor\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x11replicationFactor\x12H\n" +
	"\x11replication_level\x18\x04 \x01(\x0e2\x1b.common.v1.ReplicationLevelR\x10replicationLevel\x120\n" +
	"\x14anti_entropy_enabled\x18\x05 \x01(\bR\x12antiEntropyEnabled\x12?\n" +
	"\x17repair_interval_seconds\x18\x06 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x15repairIntervalSecondsB\x9b\x01\n" +
	"\fcom.queue.v1B\x1bReplicationConsistencyProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_replication_consistency_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_replication_consistency_proto_goTypes = []any{
	(*ReplicationConsistency)(nil), // 0: queue.v1.ReplicationConsistency
	(commonpb.ReplicationLevel)(0), // 1: common.v1.ReplicationLevel
}
var file_queuepb_v1_replication_consistency_proto_depIdxs = []int32{
	1, // 0: queue.v1.ReplicationConsistency.replication_level:type_name -> common.v1.ReplicationLevel
...
func init() { file_queuepb_v1_replication_consistency_proto_init() }
func file_queuepb_v1_replication_consistency_proto_init() {
	if File_queuepb_v1_replication_consistency_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_replication_consistency_proto_rawDesc), len(file_queuepb_v1_replication_consistency_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_replication_consistency_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_replication_consistency_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_replication_consistency_proto_msgTypes,
	}.Build()
	File_queuepb_v1_replication_consistency_proto = out.File
	file_queuepb_v1_replication_consistency_proto_goTypes = nil
	file_queuepb_v1_replication_consistency_proto_depIdxs = nil
}
