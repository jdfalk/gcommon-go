...
// 	protoc        (unknown)
// source: queuepb/v1/node_info.proto
...
type NodeInfo struct {
	...
	xxx_hidden_State         commonpb.NodeState     `protobuf:"varint,4,opt,name=state,enum=common.v1.NodeState"`
...
func (x *NodeInfo) Reset() {
	*x = NodeInfo{}
	mi := &file_queuepb_v1_node_info_proto_msgTypes[0]
...
func (x *NodeInfo) GetState() commonpb.NodeState {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 3) {
			return x.xxx_hidden_State
		}
	}
	return commonpb.NodeState(0)
}
...
func (x *NodeInfo) SetState(v commonpb.NodeState) {
...
func (x *NodeInfo) ClearState() {
	...
	x.xxx_hidden_State = commonpb.NodeState_NODE_STATE_UNSPECIFIED
}
...
var File_queuepb_v1_node_info_proto protoreflect.FileDescriptor

const file_queuepb_v1_node_info_proto_rawDesc = "" +
	"\n" +
	"\x1aqueuepb/v1/node_info.proto\x12\bqueue.v1\x1a\x1ccommonpb/v1/node_state.proto\x1a\x1bqueuepb/v1/node_stats.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xac\x02\n" +
	"\bNodeInfo\x12 \n" +
	...
	"\x05stats\x18\a \x01(\v2\x13.queue.v1.NodeStatsR\x05statsB\x8d\x01\n" +
	"\fcom.queue.v1B\rNodeInfoProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_node_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_node_info_proto_goTypes = []any{
	(*NodeInfo)(nil),              // 0: queue.v1.NodeInfo
	(commonpb.NodeState)(0),       // 1: common.v1.NodeState
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*NodeStats)(nil),             // 3: queue.v1.NodeStats
}
var file_queuepb_v1_node_info_proto_depIdxs = []int32{
...
func init() { file_queuepb_v1_node_info_proto_init() }
func file_queuepb_v1_node_info_proto_init() {
	if File_queuepb_v1_node_info_proto != nil {
		return
	}
	file_queuepb_v1_node_stats_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_node_info_proto_rawDesc), len(file_queuepb_v1_node_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_node_info_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_node_info_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_node_info_proto_msgTypes,
	}.Build()
	File_queuepb_v1_node_info_proto = out.File
	file_queuepb_v1_node_info_proto_goTypes = nil
	file_queuepb_v1_node_info_proto_depIdxs = nil
}
