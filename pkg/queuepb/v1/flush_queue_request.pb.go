...
// 	protoc        (unknown)
// source: queuepb/v1/flush_queue_request.proto
...
func (x *FlushQueueRequest) Reset() {
	*x = FlushQueueRequest{}
	mi := &file_queuepb_v1_flush_queue_request_proto_msgTypes[0]
...
func (x *FlushQueueRequest) GetFlushPolicy() commonpb.FlushPolicy {
	if x != nil {
...
func (x *FlushQueueRequest) SetFlushPolicy(v commonpb.FlushPolicy) {
...
var File_queuepb_v1_flush_queue_request_proto protoreflect.FileDescriptor

const file_queuepb_v1_flush_queue_request_proto_rawDesc = "" +
	"\n" +
	"$queuepb/v1/flush_queue_request.proto\x12\bqueue.v1\x1a\x1ecommonpb/v1/flush_policy.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xdb\x03\n" +
	"\x11FlushQueueRequest\x12\"\n" +
	"\bqueue_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\aqueueId\x129\n" +
	"\fflush_policy\x18\x02 \x01(\x0e2\x16.common.v1.FlushPolicyR\vflushPolicy\x12.\n" +
	...
	"forceFlush\x12E\n" +
	"\bmetadata\x18\b \x03(\v2).queue.v1.FlushQueueRequest.MetadataEntryR\bmetadata\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x96\x01\n" +
	"\fcom.queue.v1B\x16FlushQueueRequestProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_flush_queue_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queuepb_v1_flush_queue_request_proto_goTypes = []any{
	(*FlushQueueRequest)(nil),     // 0: queue.v1.FlushQueueRequest
	nil,                           // 1: queue.v1.FlushQueueRequest.MetadataEntry
	(commonpb.FlushPolicy)(0),     // 2: common.v1.FlushPolicy
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_queuepb_v1_flush_queue_request_proto_depIdxs = []int32{
	2, // 0: queue.v1.FlushQueueRequest.flush_policy:type_name -> common.v1.FlushPolicy
	3, // 1: queue.v1.FlushQueueRequest.flush_until:type_name -> google.protobuf.Timestamp
	1, // 2: queue.v1.FlushQueueRequest.metadata:type_name -> queue.v1.FlushQueueRequest.MetadataEntry
...
func init() { file_queuepb_v1_flush_queue_request_proto_init() }
func file_queuepb_v1_flush_queue_request_proto_init() {
	if File_queuepb_v1_flush_queue_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_flush_queue_request_proto_rawDesc), len(file_queuepb_v1_flush_queue_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_flush_queue_request_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_flush_queue_request_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_flush_queue_request_proto_msgTypes,
	}.Build()
	File_queuepb_v1_flush_queue_request_proto = out.File
	file_queuepb_v1_flush_queue_request_proto_goTypes = nil
	file_queuepb_v1_flush_queue_request_proto_depIdxs = nil
}
