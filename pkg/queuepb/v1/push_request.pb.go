...
// 	protoc        (unknown)
// source: queuepb/v1/push_request.proto
...
func (x *PushRequest) Reset() {
	*x = PushRequest{}
	mi := &file_queuepb_v1_push_request_proto_msgTypes[0]
...
var File_queuepb_v1_push_request_proto protoreflect.FileDescriptor

const file_queuepb_v1_push_request_proto_rawDesc = "" +
	"\n" +
	"\x1dqueuepb/v1/push_request.proto\x12\bqueue.v1\x1a\x1fqueuepb/v1/batch_settings.proto\x1a\x1fqueuepb/v1/publish_config.proto\x1a\x1equeuepb/v1/queue_message.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc2\x03\n" +
	"\vPushRequest\x12\x1d\n" +
	"\x05topic\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x05topic\x12<\n" +
	"\bmessages\x18\x02 \x03(\v2\x16.queue.v1.QueueMessageB\b\xbaH\x05\x92\x01\x02\b\x01R\bmessages\x12>\n" +
	"\x0epublish_config\x18\x03 \x01(\v2\x17.queue.v1.PublishConfigR\rpublishConfig\x12>\n" +
	"\x0ebatch_settings\x18\x04 \x01(\v2\x17.queue.v1.BatchSettingsR\rbatchSettings\x12.\n" +
	"\x0etransaction_id\x18\x05 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\rtransactionId\x12(\n" +
	"\vproducer_id\x18\x06 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\n" +
	"producerId\x12?\n" +
	"\bmetadata\x18\a \x03(\v2#.queue.v1.PushRequest.MetadataEntryR\bmetadata\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x90\x01\n" +
	"\fcom.queue.v1B\x10PushRequestProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_push_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queuepb_v1_push_request_proto_goTypes = []any{
	(*PushRequest)(nil),   // 0: queue.v1.PushRequest
	nil,                   // 1: queue.v1.PushRequest.MetadataEntry
	(*QueueMessage)(nil),  // 2: queue.v1.QueueMessage
	(*PublishConfig)(nil), // 3: queue.v1.PublishConfig
	(*BatchSettings)(nil), // 4: queue.v1.BatchSettings
}
var file_queuepb_v1_push_request_proto_depIdxs = []int32{
	2, // 0: queue.v1.PushRequest.messages:type_name -> queue.v1.QueueMessage
	3, // 1: queue.v1.PushRequest.publish_config:type_name -> queue.v1.PublishConfig
	4, // 2: queue.v1.PushRequest.batch_settings:type_name -> queue.v1.BatchSettings
	1, // 3: queue.v1.PushRequest.metadata:type_name -> queue.v1.PushRequest.MetadataEntry
...
func init() { file_queuepb_v1_push_request_proto_init() }
func file_queuepb_v1_push_request_proto_init() {
	if File_queuepb_v1_push_request_proto != nil {
		return
	}
	file_queuepb_v1_batch_settings_proto_init()
	file_queuepb_v1_publish_config_proto_init()
	file_queuepb_v1_queue_message_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_push_request_proto_rawDesc), len(file_queuepb_v1_push_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_push_request_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_push_request_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_push_request_proto_msgTypes,
	}.Build()
	File_queuepb_v1_push_request_proto = out.File
	file_queuepb_v1_push_request_proto_goTypes = nil
	file_queuepb_v1_push_request_proto_depIdxs = nil
}
