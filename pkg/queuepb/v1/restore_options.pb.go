...
// 	protoc        (unknown)
// source: queuepb/v1/restore_options.proto
...
func (x *RestoreOptions) Reset() {
	*x = RestoreOptions{}
	mi := &file_queuepb_v1_restore_options_proto_msgTypes[0]
...
func (x *RestoreOptions) GetTimeRange() *commonpb.TimeRangeMetrics {
	if x != nil {
...
func (x *RestoreOptions) SetTimeRange(v *commonpb.TimeRangeMetrics) {
...
var File_queuepb_v1_restore_options_proto protoreflect.FileDescriptor

const file_queuepb_v1_restore_options_proto_rawDesc = "" +
	"\n" +
	" queuepb/v1/restore_options.proto\x12\bqueue.v1\x1a$commonpb/v1/time_range_metrics.proto\x1a queuepb/v1/filter_criteria.proto\x1a\x1dqueuepb/v1/offset_range.proto\x1a$queuepb/v1/performance_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbf\x03\n" +
	...
	"\fmax_messages\x18\x03 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\vmaxMessages\x128\n" +
	"\foffset_range\x18\x04 \x01(\v2\x15.queue.v1.OffsetRangeR\voffsetRange\x12:\n" +
	"\n" +
	"time_range\x18\x05 \x01(\v2\x1b.common.v1.TimeRangeMetricsR\ttimeRange\x121\n" +
	"\x0fpriority_levels\x18\x06 \x03(\x05B\b\xbaH\x05\x92\x01\x02\b\x01R\x0epriorityLevels\x12A\n" +
	"\x0ffilter_criteria\x18\a \x01(\v2\x18.queue.v1.FilterCriteriaR\x0efilterCriteria\x12>\n" +
	"\vperformance\x18\b \x01(\v2\x1c.queue.v1.PerformanceOptionsR\vperformanceB\x93\x01\n" +
	"\fcom.queue.v1B\x13RestoreOptionsProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_restore_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_restore_options_proto_goTypes = []any{
	(*RestoreOptions)(nil),            // 0: queue.v1.RestoreOptions
	(*OffsetRange)(nil),               // 1: queue.v1.OffsetRange
	(*commonpb.TimeRangeMetrics)(nil), // 2: common.v1.TimeRangeMetrics
	(*FilterCriteria)(nil),            // 3: queue.v1.FilterCriteria
	(*PerformanceOptions)(nil),        // 4: queue.v1.PerformanceOptions
}
var file_queuepb_v1_restore_options_proto_depIdxs = []int32{
	1, // 0: queue.v1.RestoreOptions.offset_range:type_name -> queue.v1.OffsetRange
	2, // 1: queue.v1.RestoreOptions.time_range:type_name -> common.v1.TimeRangeMetrics
	3, // 2: queue.v1.RestoreOptions.filter_criteria:type_name -> queue.v1.FilterCriteria
	4, // 3: queue.v1.RestoreOptions.performance:type_name -> queue.v1.PerformanceOptions
...
func init() { file_queuepb_v1_restore_options_proto_init() }
func file_queuepb_v1_restore_options_proto_init() {
	if File_queuepb_v1_restore_options_proto != nil {
		return
	}
	file_queuepb_v1_filter_criteria_proto_init()
	file_queuepb_v1_offset_range_proto_init()
	file_queuepb_v1_performance_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_restore_options_proto_rawDesc), len(file_queuepb_v1_restore_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_restore_options_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_restore_options_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_restore_options_proto_msgTypes,
	}.Build()
	File_queuepb_v1_restore_options_proto = out.File
	file_queuepb_v1_restore_options_proto_goTypes = nil
	file_queuepb_v1_restore_options_proto_depIdxs = nil
}
