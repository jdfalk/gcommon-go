...
// 	protoc        (unknown)
// source: queuepb/v1/subscription_configuration.proto
...
type SubscriptionConfiguration struct {
	...
	xxx_hidden_AckLevel             commonpb.AckLevel      `protobuf:"varint,1,opt,name=ack_level,json=ackLevel,enum=common.v1.AckLevel"`
	xxx_hidden_DeliveryMode         commonpb.DeliveryMode  `protobuf:"varint,2,opt,name=delivery_mode,json=deliveryMode,enum=common.v1.DeliveryMode"`
...
func (x *SubscriptionConfiguration) Reset() {
	*x = SubscriptionConfiguration{}
	mi := &file_queuepb_v1_subscription_configuration_proto_msgTypes[0]
...
func (x *SubscriptionConfiguration) GetAckLevel() commonpb.AckLevel {
	if x != nil {
...
func (x *SubscriptionConfiguration) GetDeliveryMode() commonpb.DeliveryMode {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			return x.xxx_hidden_DeliveryMode
		}
	}
	return commonpb.DeliveryMode(0)
}
...
func (x *SubscriptionConfiguration) SetAckLevel(v commonpb.AckLevel) {
	x.xxx_hidden_AckLevel = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 10)
}

func (x *SubscriptionConfiguration) SetDeliveryMode(v commonpb.DeliveryMode) {
...
func (x *SubscriptionConfiguration) ClearDeliveryMode() {
	...
	x.xxx_hidden_DeliveryMode = commonpb.DeliveryMode_DELIVERY_MODE_UNSPECIFIED
}
...
type SubscriptionConfiguration_builder struct {
	...
	DeliveryMode *commonpb.DeliveryMode
...
var File_queuepb_v1_subscription_configuration_proto protoreflect.FileDescriptor

const file_queuepb_v1_subscription_configuration_proto_rawDesc = "" +
	"\n" +
	"+queuepb/v1/subscription_configuration.proto\x12\bqueue.v1\x1a\x1bcommonpb/v1/ack_level.proto\x1a\x1fcommonpb/v1/delivery_mode.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa3\x04\n" +
	"\x19SubscriptionConfiguration\x120\n" +
	"\tack_level\x18\x01 \x01(\x0e2\x13.common.v1.AckLevelR\backLevel\x12<\n" +
	"\rdelivery_mode\x18\x02 \x01(\x0e2\x17.common.v1.DeliveryModeR\fdeliveryMode\x12<\n" +
	"\x14max_unacked_messages\x18\x03 \x01(\x05B\n" +
	"\xbaH\a\x1a\x05\x18\x96\x01(\x00R\x12maxUnackedMessages\x12-\n" +
	"\x0eack_timeout_ms\x18\x04 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00R\fackTimeoutMs\x12*\n" +
	"\fmin_priority\x18\x05 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\vminPriority\x12)\n" +
	"\x10ordered_delivery\x18\x06 \x01(\bR\x0forderedDelivery\x12)\n" +
	"\x10auto_acknowledge\x18\a \x01(\bR\x0fautoAcknowledge\x126\n" +
	...
	" \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x14maxMessageAgeSecondsB\x9e\x01\n" +
	"\fcom.queue.v1B\x1eSubscriptionConfigurationProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_subscription_configuration_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_subscription_configuration_proto_goTypes = []any{
	(*SubscriptionConfiguration)(nil), // 0: queue.v1.SubscriptionConfiguration
	(commonpb.AckLevel)(0),            // 1: common.v1.AckLevel
	(commonpb.DeliveryMode)(0),        // 2: common.v1.DeliveryMode
}
var file_queuepb_v1_subscription_configuration_proto_depIdxs = []int32{
	1, // 0: queue.v1.SubscriptionConfiguration.ack_level:type_name -> common.v1.AckLevel
	2, // 1: queue.v1.SubscriptionConfiguration.delivery_mode:type_name -> common.v1.DeliveryMode
...
func init() { file_queuepb_v1_subscription_configuration_proto_init() }
func file_queuepb_v1_subscription_configuration_proto_init() {
	if File_queuepb_v1_subscription_configuration_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_subscription_configuration_proto_rawDesc), len(file_queuepb_v1_subscription_configuration_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_subscription_configuration_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_subscription_configuration_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_subscription_configuration_proto_msgTypes,
	}.Build()
	File_queuepb_v1_subscription_configuration_proto = out.File
	file_queuepb_v1_subscription_configuration_proto_goTypes = nil
	file_queuepb_v1_subscription_configuration_proto_depIdxs = nil
}
