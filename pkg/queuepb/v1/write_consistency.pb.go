...
// 	protoc        (unknown)
// source: queuepb/v1/write_consistency.proto
...
type WriteConsistency struct {
	...
	xxx_hidden_Level             commonpb.WriteLevel    `protobuf:"varint,1,opt,name=level,enum=common.v1.WriteLevel"`
...
func (x *WriteConsistency) Reset() {
	*x = WriteConsistency{}
	mi := &file_queuepb_v1_write_consistency_proto_msgTypes[0]
...
func (x *WriteConsistency) GetLevel() commonpb.WriteLevel {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 0) {
			return x.xxx_hidden_Level
		}
	}
	return commonpb.WriteLevel(0)
}
...
func (x *WriteConsistency) SetLevel(v commonpb.WriteLevel) {
...
func (x *WriteConsistency) ClearLevel() {
	...
	x.xxx_hidden_Level = commonpb.WriteLevel_WRITE_LEVEL_UNSPECIFIED
}
...
var File_queuepb_v1_write_consistency_proto protoreflect.FileDescriptor

const file_queuepb_v1_write_consistency_proto_rawDesc = "" +
	"\n" +
	"\"queuepb/v1/write_consistency.proto\x12\bqueue.v1\x1a\x1dcommonpb/v1/write_level.proto\x1a#queuepb/v1/conflict_detection.proto\x1a!queuepb/v1/sync_replication.proto\x1a#queuepb/v1/write_retry_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb8\x02\n" +
	"\x10WriteConsistency\x12+\n" +
	"\x05level\x18\x01 \x01(\x0e2\x15.common.v1.WriteLevelR\x05level\x12D\n" +
	"\x10sync_replication\x18\x02 \x01(\v2\x19.queue.v1.SyncReplicationR\x0fsyncReplication\x12J\n" +
	...
	"\fretry_config\x18\x05 \x01(\v2\x1a.queue.v1.WriteRetryConfigR\vretryConfigB\x95\x01\n" +
	"\fcom.queue.v1B\x15WriteConsistencyProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_write_consistency_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_write_consistency_proto_goTypes = []any{
	(*WriteConsistency)(nil),  // 0: queue.v1.WriteConsistency
	(commonpb.WriteLevel)(0),  // 1: common.v1.WriteLevel
...
var file_queuepb_v1_write_consistency_proto_depIdxs = []int32{
	1, // 0: queue.v1.WriteConsistency.level:type_name -> common.v1.WriteLevel
	2, // 1: queue.v1.WriteConsistency.sync_replication:type_name -> queue.v1.SyncReplication
	3, // 2: queue.v1.WriteConsistency.conflict_detection:type_name -> queue.v1.ConflictDetection
	4, // 3: queue.v1.WriteConsistency.retry_config:type_name -> queue.v1.WriteRetryConfig
...
func init() { file_queuepb_v1_write_consistency_proto_init() }
func file_queuepb_v1_write_consistency_proto_init() {
	if File_queuepb_v1_write_consistency_proto != nil {
		return
	}
	file_queuepb_v1_conflict_detection_proto_init()
	file_queuepb_v1_sync_replication_proto_init()
	file_queuepb_v1_write_retry_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_write_consistency_proto_rawDesc), len(file_queuepb_v1_write_consistency_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_write_consistency_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_write_consistency_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_write_consistency_proto_msgTypes,
	}.Build()
	File_queuepb_v1_write_consistency_proto = out.File
	file_queuepb_v1_write_consistency_proto_goTypes = nil
	file_queuepb_v1_write_consistency_proto_depIdxs = nil
}
