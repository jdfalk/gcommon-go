...
// 	protoc        (unknown)
// source: queuepb/v1/restore_queue_request.proto
...
func (x *RestoreQueueRequest) Reset() {
	*x = RestoreQueueRequest{}
	mi := &file_queuepb_v1_restore_queue_request_proto_msgTypes[0]
...
var File_queuepb_v1_restore_queue_request_proto protoreflect.FileDescriptor

const file_queuepb_v1_restore_queue_request_proto_rawDesc = "" +
	"\n" +
	"&queuepb/v1/restore_queue_request.proto\x12\bqueue.v1\x1a\x1equeuepb/v1/backup_source.proto\x1a\x1fqueuepb/v1/restore_config.proto\x1a queuepb/v1/restore_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xc5\x04\n" +
	"\x13RestoreQueueRequest\x12/\n" +
	"\x0ftarget_queue_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\rtargetQueueId\x12;\n" +
	"\rbackup_source\x18\x02 \x01(\v2\x16.queue.v1.BackupSourceR\fbackupSource\x12>\n" +
	"\x0erestore_config\x18\x03 \x01(\v2\x17.queue.v1.RestoreConfigR\rrestoreConfig\x12?\n" +
	...
	"\aoptions\x18\b \x01(\v2\x18.queue.v1.RestoreOptionsR\aoptions\x12G\n" +
	"\bmetadata\x18\t \x03(\v2+.queue.v1.RestoreQueueRequest.MetadataEntryR\bmetadata\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x98\x01\n" +
	"\fcom.queue.v1B\x18RestoreQueueRequestProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_restore_queue_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queuepb_v1_restore_queue_request_proto_goTypes = []any{
	(*RestoreQueueRequest)(nil),   // 0: queue.v1.RestoreQueueRequest
	nil,                           // 1: queue.v1.RestoreQueueRequest.MetadataEntry
	(*BackupSource)(nil),          // 2: queue.v1.BackupSource
	(*RestoreConfig)(nil),         // 3: queue.v1.RestoreConfig
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
	(*RestoreOptions)(nil),        // 5: queue.v1.RestoreOptions
}
var file_queuepb_v1_restore_queue_request_proto_depIdxs = []int32{
	2, // 0: queue.v1.RestoreQueueRequest.backup_source:type_name -> queue.v1.BackupSource
	3, // 1: queue.v1.RestoreQueueRequest.restore_config:type_name -> queue.v1.RestoreConfig
	4, // 2: queue.v1.RestoreQueueRequest.restore_point:type_name -> google.protobuf.Timestamp
	5, // 3: queue.v1.RestoreQueueRequest.options:type_name -> queue.v1.RestoreOptions
	1, // 4: queue.v1.RestoreQueueRequest.metadata:type_name -> queue.v1.RestoreQueueRequest.MetadataEntry
...
func init() { file_queuepb_v1_restore_queue_request_proto_init() }
func file_queuepb_v1_restore_queue_request_proto_init() {
	if File_queuepb_v1_restore_queue_request_proto != nil {
		return
	}
	file_queuepb_v1_backup_source_proto_init()
	file_queuepb_v1_restore_config_proto_init()
	file_queuepb_v1_restore_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_restore_queue_request_proto_rawDesc), len(file_queuepb_v1_restore_queue_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_restore_queue_request_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_restore_queue_request_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_restore_queue_request_proto_msgTypes,
	}.Build()
	File_queuepb_v1_restore_queue_request_proto = out.File
	file_queuepb_v1_restore_queue_request_proto_goTypes = nil
	file_queuepb_v1_restore_queue_request_proto_depIdxs = nil
}
