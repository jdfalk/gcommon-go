...
// 	protoc        (unknown)
// source: queuepb/v1/routing_rule.proto
...
func (x *RoutingRule) Reset() {
	*x = RoutingRule{}
	mi := &file_queuepb_v1_routing_rule_proto_msgTypes[0]
...
var File_queuepb_v1_routing_rule_proto protoreflect.FileDescriptor

const file_queuepb_v1_routing_rule_proto_rawDesc = "" +
	"\n" +
	"\x1dqueuepb/v1/routing_rule.proto\x12\bqueue.v1\x1a\"queuepb/v1/routing_condition.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbc\x02\n" +
	"\vRoutingRule\x12\x1d\n" +
	"\x04name\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x04name\x12\x1a\n" +
	"\bpriority\x18\x02 \x01(\x05R\bpriority\x128\n" +
	"\tcondition\x18\x03 \x01(\v2\x1a.queue.v1.RoutingConditionR\tcondition\x12 \n" +
	"\vdestination\x18\x04 \x01(\tR\vdestination\x12\x18\n" +
	"\aenabled\x18\x05 \x01(\bR\aenabled\x12?\n" +
	"\bmetadata\x18\x06 \x03(\v2#.queue.v1.RoutingRule.MetadataEntryR\bmetadata\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x90\x01\n" +
	"\fcom.queue.v1B\x10RoutingRuleProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_routing_rule_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queuepb_v1_routing_rule_proto_goTypes = []any{
	(*RoutingRule)(nil),      // 0: queue.v1.RoutingRule
	nil,                      // 1: queue.v1.RoutingRule.MetadataEntry
	(*RoutingCondition)(nil), // 2: queue.v1.RoutingCondition
}
var file_queuepb_v1_routing_rule_proto_depIdxs = []int32{
	2, // 0: queue.v1.RoutingRule.condition:type_name -> queue.v1.RoutingCondition
	1, // 1: queue.v1.RoutingRule.metadata:type_name -> queue.v1.RoutingRule.MetadataEntry
...
func init() { file_queuepb_v1_routing_rule_proto_init() }
func file_queuepb_v1_routing_rule_proto_init() {
	if File_queuepb_v1_routing_rule_proto != nil {
		return
	}
	file_queuepb_v1_routing_condition_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_routing_rule_proto_rawDesc), len(file_queuepb_v1_routing_rule_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_routing_rule_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_routing_rule_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_routing_rule_proto_msgTypes,
	}.Build()
	File_queuepb_v1_routing_rule_proto = out.File
	file_queuepb_v1_routing_rule_proto_goTypes = nil
	file_queuepb_v1_routing_rule_proto_depIdxs = nil
}
