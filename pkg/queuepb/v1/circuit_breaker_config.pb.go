...
// 	protoc        (unknown)
// source: queuepb/v1/circuit_breaker_config.proto
...
func (x *QueueCircuitBreakerConfig) Reset() {
	*x = QueueCircuitBreakerConfig{}
	mi := &file_queuepb_v1_circuit_breaker_config_proto_msgTypes[0]
...
var File_queuepb_v1_circuit_breaker_config_proto protoreflect.FileDescriptor

const file_queuepb_v1_circuit_breaker_config_proto_rawDesc = "" +
	"\n" +
	"'queuepb/v1/circuit_breaker_config.proto\x12\bqueue.v1\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb9\x02\n" +
	"\x19QueueCircuitBreakerConfig\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x124\n" +
	"\x11failure_threshold\x18\x02 \x01(\rB\a\xbaH\x04*\x02(\x00R\x10failureThreshold\x124\n" +
	...
	"\binterval\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\bintervalB\x99\x01\n" +
	"\fcom.queue.v1B\x19CircuitBreakerConfigProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_circuit_breaker_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_circuit_breaker_config_proto_goTypes = []any{
	(*QueueCircuitBreakerConfig)(nil), // 0: queue.v1.QueueCircuitBreakerConfig
	(*durationpb.Duration)(nil),       // 1: google.protobuf.Duration
}
var file_queuepb_v1_circuit_breaker_config_proto_depIdxs = []int32{
	1, // 0: queue.v1.QueueCircuitBreakerConfig.timeout:type_name -> google.protobuf.Duration
	1, // 1: queue.v1.QueueCircuitBreakerConfig.interval:type_name -> google.protobuf.Duration
...
func init() { file_queuepb_v1_circuit_breaker_config_proto_init() }
func file_queuepb_v1_circuit_breaker_config_proto_init() {
	if File_queuepb_v1_circuit_breaker_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_circuit_breaker_config_proto_rawDesc), len(file_queuepb_v1_circuit_breaker_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_circuit_breaker_config_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_circuit_breaker_config_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_circuit_breaker_config_proto_msgTypes,
	}.Build()
	File_queuepb_v1_circuit_breaker_config_proto = out.File
	file_queuepb_v1_circuit_breaker_config_proto_goTypes = nil
	file_queuepb_v1_circuit_breaker_config_proto_depIdxs = nil
}
