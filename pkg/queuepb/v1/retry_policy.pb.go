...
// 	protoc        (unknown)
// source: queuepb/v1/retry_policy.proto
...
type QueueRetryPolicy struct {
	...
	xxx_hidden_DelayStrategy     commonpb.RetryDelayStrategy `protobuf:"varint,5,opt,name=delay_strategy,json=delayStrategy,enum=common.v1.RetryDelayStrategy"`
...
func (x *QueueRetryPolicy) Reset() {
	*x = QueueRetryPolicy{}
	mi := &file_queuepb_v1_retry_policy_proto_msgTypes[0]
...
func (x *QueueRetryPolicy) GetDelayStrategy() commonpb.RetryDelayStrategy {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 4) {
			return x.xxx_hidden_DelayStrategy
		}
	}
	return commonpb.RetryDelayStrategy(0)
}
...
func (x *QueueRetryPolicy) SetDelayStrategy(v commonpb.RetryDelayStrategy) {
...
func (x *QueueRetryPolicy) ClearDelayStrategy() {
	...
	x.xxx_hidden_DelayStrategy = commonpb.RetryDelayStrategy_RETRY_DELAY_STRATEGY_UNSPECIFIED
}
...
type QueueRetryPolicy_builder struct {
	...
	DelayStrategy *commonpb.RetryDelayStrategy
...
var File_queuepb_v1_retry_policy_proto protoreflect.FileDescriptor

const file_queuepb_v1_retry_policy_proto_rawDesc = "" +
	"\n" +
	"\x1dqueuepb/v1/retry_policy.proto\x12\bqueue.v1\x1a&commonpb/v1/retry_delay_strategy.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x95\x03\n" +
	...
	"\x12backoff_multiplier\x18\x04 \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\x11backoffMultiplier\x12D\n" +
	"\x0edelay_strategy\x18\x05 \x01(\x0e2\x1d.common.v1.RetryDelayStrategyR\rdelayStrategy\x12#\n" +
	"\renable_jitter\x18\x06 \x01(\bR\fenableJitter\x123\n" +
	"\rjitter_factor\x18\a \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\fjitterFactorB\x90\x01\n" +
	"\fcom.queue.v1B\x10RetryPolicyProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_retry_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_retry_policy_proto_goTypes = []any{
	(*QueueRetryPolicy)(nil),         // 0: queue.v1.QueueRetryPolicy
	(*durationpb.Duration)(nil),      // 1: google.protobuf.Duration
	(commonpb.RetryDelayStrategy)(0), // 2: common.v1.RetryDelayStrategy
}
var file_queuepb_v1_retry_policy_proto_depIdxs = []int32{
	1, // 0: queue.v1.QueueRetryPolicy.initial_delay:type_name -> google.protobuf.Duration
	1, // 1: queue.v1.QueueRetryPolicy.max_delay:type_name -> google.protobuf.Duration
	2, // 2: queue.v1.QueueRetryPolicy.delay_strategy:type_name -> common.v1.RetryDelayStrategy
...
func init() { file_queuepb_v1_retry_policy_proto_init() }
func file_queuepb_v1_retry_policy_proto_init() {
	if File_queuepb_v1_retry_policy_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_retry_policy_proto_rawDesc), len(file_queuepb_v1_retry_policy_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_retry_policy_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_retry_policy_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_retry_policy_proto_msgTypes,
	}.Build()
	File_queuepb_v1_retry_policy_proto = out.File
	file_queuepb_v1_retry_policy_proto_goTypes = nil
	file_queuepb_v1_retry_policy_proto_depIdxs = nil
}
