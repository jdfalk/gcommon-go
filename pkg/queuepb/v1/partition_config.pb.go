...
// 	protoc        (unknown)
// source: queuepb/v1/partition_config.proto
...
func (x *PartitionConfig) Reset() {
	*x = PartitionConfig{}
	mi := &file_queuepb_v1_partition_config_proto_msgTypes[0]
...
var File_queuepb_v1_partition_config_proto protoreflect.FileDescriptor

const file_queuepb_v1_partition_config_proto_rawDesc = "" +
	"\n" +
	"!queuepb/v1/partition_config.proto\x12\bqueue.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa4\x03\n" +
	"\x0fPartitionConfig\x120\n" +
	"\x0fpartition_count\x18\x01 \x01(\rB\a\xbaH\x04*\x02(\x00R\x0epartitionCount\x126\n" +
	"\x12partition_strategy\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x11partitionStrategy\x12,\n" +
	"\rpartition_key\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\fpartitionKey\x12C\n" +
	"\x19custom_partition_function\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x17customPartitionFunction\x12\x1d\n" +
	"\n" +
	...
	"\x12scale_threshold_mb\x18\b \x01(\x04B\a\xbaH\x042\x02(\x00R\x10scaleThresholdMbB\x94\x01\n" +
	"\fcom.queue.v1B\x14PartitionConfigProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_partition_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_partition_config_proto_goTypes = []any{
	(*PartitionConfig)(nil), // 0: queue.v1.PartitionConfig
}
var file_queuepb_v1_partition_config_proto_depIdxs = []int32{
...
func init() { file_queuepb_v1_partition_config_proto_init() }
func file_queuepb_v1_partition_config_proto_init() {
	if File_queuepb_v1_partition_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_partition_config_proto_rawDesc), len(file_queuepb_v1_partition_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_partition_config_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_partition_config_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_partition_config_proto_msgTypes,
	}.Build()
	File_queuepb_v1_partition_config_proto = out.File
	file_queuepb_v1_partition_config_proto_goTypes = nil
	file_queuepb_v1_partition_config_proto_depIdxs = nil
}
