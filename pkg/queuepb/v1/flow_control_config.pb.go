...
// 	protoc        (unknown)
// source: queuepb/v1/flow_control_config.proto
...
func (x *FlowControlConfig) Reset() {
	*x = FlowControlConfig{}
	mi := &file_queuepb_v1_flow_control_config_proto_msgTypes[0]
...
var File_queuepb_v1_flow_control_config_proto protoreflect.FileDescriptor

const file_queuepb_v1_flow_control_config_proto_rawDesc = "" +
	"\n" +
	"$queuepb/v1/flow_control_config.proto\x12\bqueue.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd7\x01\n" +
...
var file_queuepb_v1_flow_control_config_proto_depIdxs = []int32{
...
func init() { file_queuepb_v1_flow_control_config_proto_init() }
func file_queuepb_v1_flow_control_config_proto_init() {
	if File_queuepb_v1_flow_control_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_flow_control_config_proto_rawDesc), len(file_queuepb_v1_flow_control_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_flow_control_config_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_flow_control_config_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_flow_control_config_proto_msgTypes,
	}.Build()
	File_queuepb_v1_flow_control_config_proto = out.File
	file_queuepb_v1_flow_control_config_proto_goTypes = nil
	file_queuepb_v1_flow_control_config_proto_depIdxs = nil
}
