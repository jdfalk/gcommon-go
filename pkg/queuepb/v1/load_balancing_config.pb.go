...
// 	protoc        (unknown)
// source: queuepb/v1/load_balancing_config.proto
...
type LoadBalancingConfig struct {
	...
	xxx_hidden_Strategy              commonpb.LoadBalancingStrategy `protobuf:"varint,1,opt,name=strategy,enum=common.v1.LoadBalancingStrategy"`
...
func (x *LoadBalancingConfig) Reset() {
	*x = LoadBalancingConfig{}
	mi := &file_queuepb_v1_load_balancing_config_proto_msgTypes[0]
...
func (x *LoadBalancingConfig) GetStrategy() commonpb.LoadBalancingStrategy {
	if x != nil {
...
func (x *LoadBalancingConfig) SetStrategy(v commonpb.LoadBalancingStrategy) {
...
func (x *LoadBalancingConfig) ClearStrategy() {
	...
	x.xxx_hidden_Strategy = commonpb.LoadBalancingStrategy_LOAD_BALANCING_STRATEGY_UNSPECIFIED
}
...
type LoadBalancingConfig_builder struct {
	...
	Strategy *commonpb.LoadBalancingStrategy
...
var File_queuepb_v1_load_balancing_config_proto protoreflect.FileDescriptor

const file_queuepb_v1_load_balancing_config_proto_rawDesc = "" +
	"\n" +
	"&queuepb/v1/load_balancing_config.proto\x12\bqueue.v1\x1a)commonpb/v1/load_balancing_strategy.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe2\x02\n" +
	"\x13LoadBalancingConfig\x12<\n" +
	"\bstrategy\x18\x01 \x01(\x0e2 .common.v1.LoadBalancingStrategyR\bstrategy\x12\x1f\n" +
	"\x06weight\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x06weight\x12B\n" +
	"\x17max_concurrent_messages\x18\x03 \x01(\x05B\n" +
	"\xbaH\a\x1a\x05\x18\x96\x01(\x00R\x15maxConcurrentMessages\x12.\n" +
	...
	"\faffinity_key\x18\a \x01(\tB\a\xbaH\x04r\x02\x10\x01R\vaffinityKeyB\x98\x01\n" +
	"\fcom.queue.v1B\x18LoadBalancingConfigProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_load_balancing_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_load_balancing_config_proto_goTypes = []any{
	(*LoadBalancingConfig)(nil),         // 0: queue.v1.LoadBalancingConfig
	(commonpb.LoadBalancingStrategy)(0), // 1: common.v1.LoadBalancingStrategy
}
var file_queuepb_v1_load_balancing_config_proto_depIdxs = []int32{
...
func init() { file_queuepb_v1_load_balancing_config_proto_init() }
func file_queuepb_v1_load_balancing_config_proto_init() {
	if File_queuepb_v1_load_balancing_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_load_balancing_config_proto_rawDesc), len(file_queuepb_v1_load_balancing_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_load_balancing_config_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_load_balancing_config_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_load_balancing_config_proto_msgTypes,
	}.Build()
	File_queuepb_v1_load_balancing_config_proto = out.File
	file_queuepb_v1_load_balancing_config_proto_goTypes = nil
	file_queuepb_v1_load_balancing_config_proto_depIdxs = nil
}
