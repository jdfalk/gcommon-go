...
// 	protoc        (unknown)
// source: queuepb/v1/message_filter.proto
...
func (x *MessageFilter) Reset() {
	*x = MessageFilter{}
	mi := &file_queuepb_v1_message_filter_proto_msgTypes[0]
...
var File_queuepb_v1_message_filter_proto protoreflect.FileDescriptor

const file_queuepb_v1_message_filter_proto_rawDesc = "" +
	"\n" +
	"\x1fqueuepb/v1/message_filter.proto\x12\bqueue.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x83\x04\n" +
	"\rMessageFilter\x12Q\n" +
	"\x0eheader_filters\x18\x01 \x03(\v2*.queue.v1.MessageFilter.HeaderFiltersEntryR\rheaderFilters\x12W\n" +
	"\x10property_filters\x18\x02 \x03(\v2,.queue.v1.MessageFilter.PropertyFiltersEntryR\x0fpropertyFilters\x12*\n" +
	"\fmin_priority\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\vminPriority\x122\n" +
	"\x0fmax_age_seconds\x18\x04 \x01(\x05B\n" +
	"\xbaH\a\x1a\x05\x18\x96\x01(\x00R\rmaxAgeSeconds\x12*\n" +
	"\fcontent_type\x18\x05 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\vcontentType\x124\n" +
	"\x11filter_expression\x18\x06 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x10filterExpression\x1a@\n" +
	...
	"\fcom.queue.v1B\x12MessageFilterProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_message_filter_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_queuepb_v1_message_filter_proto_goTypes = []any{
	(*MessageFilter)(nil), // 0: queue.v1.MessageFilter
	nil,                   // 1: queue.v1.MessageFilter.HeaderFiltersEntry
	nil,                   // 2: queue.v1.MessageFilter.PropertyFiltersEntry
}
var file_queuepb_v1_message_filter_proto_depIdxs = []int32{
	1, // 0: queue.v1.MessageFilter.header_filters:type_name -> queue.v1.MessageFilter.HeaderFiltersEntry
	2, // 1: queue.v1.MessageFilter.property_filters:type_name -> queue.v1.MessageFilter.PropertyFiltersEntry
...
func init() { file_queuepb_v1_message_filter_proto_init() }
func file_queuepb_v1_message_filter_proto_init() {
	if File_queuepb_v1_message_filter_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_message_filter_proto_rawDesc), len(file_queuepb_v1_message_filter_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_message_filter_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_message_filter_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_message_filter_proto_msgTypes,
	}.Build()
	File_queuepb_v1_message_filter_proto = out.File
	file_queuepb_v1_message_filter_proto_goTypes = nil
	file_queuepb_v1_message_filter_proto_depIdxs = nil
}
