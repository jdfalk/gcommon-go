...
// 	protoc        (unknown)
// source: queuepb/v1/format_options.proto
...
type FormatOptions struct {
	...
	xxx_hidden_Format               commonpb.SerializationFormat  `protobuf:"varint,1,opt,name=format,enum=common.v1.SerializationFormat"`
	...
	xxx_hidden_CompressionAlgorithm commonpb.CompressionAlgorithm `protobuf:"varint,4,opt,name=compression_algorithm,json=compressionAlgorithm,enum=common.v1.CompressionAlgorithm"`
...
func (x *FormatOptions) Reset() {
	*x = FormatOptions{}
	mi := &file_queuepb_v1_format_options_proto_msgTypes[0]
...
func (x *FormatOptions) GetFormat() commonpb.SerializationFormat {
	if x != nil {
...
func (x *FormatOptions) GetCompressionAlgorithm() commonpb.CompressionAlgorithm {
	if x != nil {
...
func (x *FormatOptions) SetFormat(v commonpb.SerializationFormat) {
...
func (x *FormatOptions) SetCompressionAlgorithm(v commonpb.CompressionAlgorithm) {
...
func (x *FormatOptions) ClearFormat() {
	...
	x.xxx_hidden_Format = commonpb.SerializationFormat_SERIALIZATION_FORMAT_UNSPECIFIED
}
...
func (x *FormatOptions) ClearCompressionAlgorithm() {
	...
	x.xxx_hidden_CompressionAlgorithm = commonpb.CompressionAlgorithm_COMPRESSION_ALGORITHM_UNSPECIFIED
}
...
type FormatOptions_builder struct {
	...
	Format *commonpb.SerializationFormat
	// Format-specific configuration
	Options map[string]string
	// Whether to enable compression for this format
	EnableCompression *bool
	// Compression algorithm
	CompressionAlgorithm *commonpb.CompressionAlgorithm
...
var File_queuepb_v1_format_options_proto protoreflect.FileDescriptor

const file_queuepb_v1_format_options_proto_rawDesc = "" +
	"\n" +
	"\x1fqueuepb/v1/format_options.proto\x12\bqueue.v1\x1a'commonpb/v1/compression_algorithm.proto\x1a&commonpb/v1/serialization_format.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xfb\x02\n" +
	"\rFormatOptions\x126\n" +
	...
	"\fcom.queue.v1B\x12FormatOptionsProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_format_options_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queuepb_v1_format_options_proto_goTypes = []any{
...
var file_queuepb_v1_format_options_proto_depIdxs = []int32{
...
func init() { file_queuepb_v1_format_options_proto_init() }
func file_queuepb_v1_format_options_proto_init() {
	if File_queuepb_v1_format_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_format_options_proto_rawDesc), len(file_queuepb_v1_format_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_format_options_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_format_options_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_format_options_proto_msgTypes,
	}.Build()
	File_queuepb_v1_format_options_proto = out.File
	file_queuepb_v1_format_options_proto_goTypes = nil
	file_queuepb_v1_format_options_proto_depIdxs = nil
}
