...
// 	protoc        (unknown)
// source: queuepb/v1/update_topic_config_request.proto
...
func (x *UpdateTopicConfigRequest) Reset() {
	*x = UpdateTopicConfigRequest{}
	mi := &file_queuepb_v1_update_topic_config_request_proto_msgTypes[0]
...
var File_queuepb_v1_update_topic_config_request_proto protoreflect.FileDescriptor

const file_queuepb_v1_update_topic_config_request_proto_rawDesc = "" +
	"\n" +
	",queuepb/v1/update_topic_config_request.proto\x12\bqueue.v1\x1a\x1dqueuepb/v1/topic_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe6\x01\n" +
	"\x18UpdateTopicConfigRequest\x12(\n" +
	"\n" +
	"topic_name\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\ttopicName\x12-\n" +
	"\x06config\x18\x02 \x01(\v2\x15.queue.v1.TopicConfigR\x06config\x12#\n" +
	"\rvalidate_only\x18\x03 \x01(\bR\fvalidateOnly\x12-\n" +
	"\x12incremental_update\x18\x04 \x01(\bR\x11incrementalUpdate\x12\x1d\n" +
	"\n" +
	"timeout_ms\x18\x05 \x01(\x05R\ttimeoutMsB\x9d\x01\n" +
	"\fcom.queue.v1B\x1dUpdateTopicConfigRequestProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_update_topic_config_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_update_topic_config_request_proto_goTypes = []any{
	(*UpdateTopicConfigRequest)(nil), // 0: queue.v1.UpdateTopicConfigRequest
	(*TopicConfig)(nil),              // 1: queue.v1.TopicConfig
}
var file_queuepb_v1_update_topic_config_request_proto_depIdxs = []int32{
	1, // 0: queue.v1.UpdateTopicConfigRequest.config:type_name -> queue.v1.TopicConfig
...
func init() { file_queuepb_v1_update_topic_config_request_proto_init() }
func file_queuepb_v1_update_topic_config_request_proto_init() {
	if File_queuepb_v1_update_topic_config_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_update_topic_config_request_proto_rawDesc), len(file_queuepb_v1_update_topic_config_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_update_topic_config_request_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_update_topic_config_request_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_update_topic_config_request_proto_msgTypes,
	}.Build()
	File_queuepb_v1_update_topic_config_request_proto = out.File
	file_queuepb_v1_update_topic_config_request_proto_goTypes = nil
	file_queuepb_v1_update_topic_config_request_proto_depIdxs = nil
}
