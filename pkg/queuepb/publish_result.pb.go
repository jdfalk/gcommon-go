...
// 	protoc        (unknown)
// source: queuepb/v1/publish_result.proto
...
func (x *PublishResult) Reset() {
	*x = PublishResult{}
	mi := &file_queuepb_v1_publish_result_proto_msgTypes[0]
...
var File_queuepb_v1_publish_result_proto protoreflect.FileDescriptor

const file_queuepb_v1_publish_result_proto_rawDesc = "" +
	"\n" +
	"\x1fqueuepb/v1/publish_result.proto\x12\bqueue.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xdb\x01\n" +
	"\rPublishResult\x12&\n" +
	"\n" +
	...
	"\ttimestamp\x18\x06 \x01(\x03R\ttimestampB\x92\x01\n" +
	"\fcom.queue.v1B\x12PublishResultProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_publish_result_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_publish_result_proto_goTypes = []any{
	(*PublishResult)(nil), // 0: queue.v1.PublishResult
}
var file_queuepb_v1_publish_result_proto_depIdxs = []int32{
...
func init() { file_queuepb_v1_publish_result_proto_init() }
func file_queuepb_v1_publish_result_proto_init() {
	if File_queuepb_v1_publish_result_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_publish_result_proto_rawDesc), len(file_queuepb_v1_publish_result_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_publish_result_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_publish_result_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_publish_result_proto_msgTypes,
	}.Build()
	File_queuepb_v1_publish_result_proto = out.File
	file_queuepb_v1_publish_result_proto_goTypes = nil
	file_queuepb_v1_publish_result_proto_depIdxs = nil
}
