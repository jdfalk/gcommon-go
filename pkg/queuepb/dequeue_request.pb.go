...
// 	protoc        (unknown)
// source: queuepb/v1/dequeue_request.proto
...
func (x *DequeueRequest) Reset() {
	*x = DequeueRequest{}
	mi := &file_queuepb_v1_dequeue_request_proto_msgTypes[0]
...
func (x *DequeueRequest) GetMetadata() *commonpb.RequestMetadata {
	if x != nil {
...
func (x *DequeueRequest) SetMetadata(v *commonpb.RequestMetadata) {
...
var File_queuepb_v1_dequeue_request_proto protoreflect.FileDescriptor

const file_queuepb_v1_dequeue_request_proto_rawDesc = "" +
	"\n" +
	" queuepb/v1/dequeue_request.proto\x12\bqueue.v1\x1a\"commonpb/v1/request_metadata.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xcc\x05\n" +
	...
	"\x11attribute_filters\x18\x10 \x03(\v2..queue.v1.DequeueRequest.AttributeFiltersEntryR\x10attributeFilters\x12.\n" +
	...
	"\fcom.queue.v1B\x13DequeueRequestProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_dequeue_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queuepb_v1_dequeue_request_proto_goTypes = []any{
	(*DequeueRequest)(nil),           // 0: queue.v1.DequeueRequest
	nil,                              // 1: queue.v1.DequeueRequest.AttributeFiltersEntry
	(*commonpb.RequestMetadata)(nil), // 2: common.v1.RequestMetadata
	(*durationpb.Duration)(nil),      // 3: google.protobuf.Duration
}
var file_queuepb_v1_dequeue_request_proto_depIdxs = []int32{
	2, // 0: queue.v1.DequeueRequest.metadata:type_name -> common.v1.RequestMetadata
	3, // 1: queue.v1.DequeueRequest.visibility_timeout:type_name -> google.protobuf.Duration
	3, // 2: queue.v1.DequeueRequest.wait_time:type_name -> google.protobuf.Duration
	1, // 3: queue.v1.DequeueRequest.attribute_filters:type_name -> queue.v1.DequeueRequest.AttributeFiltersEntry
...
func init() { file_queuepb_v1_dequeue_request_proto_init() }
func file_queuepb_v1_dequeue_request_proto_init() {
	if File_queuepb_v1_dequeue_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_dequeue_request_proto_rawDesc), len(file_queuepb_v1_dequeue_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_dequeue_request_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_dequeue_request_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_dequeue_request_proto_msgTypes,
	}.Build()
	File_queuepb_v1_dequeue_request_proto = out.File
	file_queuepb_v1_dequeue_request_proto_goTypes = nil
	file_queuepb_v1_dequeue_request_proto_depIdxs = nil
}
