...
// 	protoc        (unknown)
// source: queuepb/v1/batch_config.proto
...
func (x *BatchConfig) Reset() {
	*x = BatchConfig{}
	mi := &file_queuepb_v1_batch_config_proto_msgTypes[0]
...
var File_queuepb_v1_batch_config_proto protoreflect.FileDescriptor

const file_queuepb_v1_batch_config_proto_rawDesc = "" +
	"\n" +
	"\x1dqueuepb/v1/batch_config.proto\x12\bqueue.v1\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb1\x02\n" +
	"\vBatchConfig\x12-\n" +
	...
	"bufferSizeB\x90\x01\n" +
	"\fcom.queue.v1B\x10BatchConfigProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_batch_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_batch_config_proto_goTypes = []any{
	(*BatchConfig)(nil),         // 0: queue.v1.BatchConfig
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_queuepb_v1_batch_config_proto_depIdxs = []int32{
	1, // 0: queue.v1.BatchConfig.max_wait_time:type_name -> google.protobuf.Duration
...
func init() { file_queuepb_v1_batch_config_proto_init() }
func file_queuepb_v1_batch_config_proto_init() {
	if File_queuepb_v1_batch_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_batch_config_proto_rawDesc), len(file_queuepb_v1_batch_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_batch_config_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_batch_config_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_batch_config_proto_msgTypes,
	}.Build()
	File_queuepb_v1_batch_config_proto = out.File
	file_queuepb_v1_batch_config_proto_goTypes = nil
	file_queuepb_v1_batch_config_proto_depIdxs = nil
}
