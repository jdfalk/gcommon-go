...
// 	protoc        (unknown)
// source: queuepb/v2/o_auth2_auth.proto
...
func (x *OAuth2Auth) Reset() {
	*x = OAuth2Auth{}
	mi := &file_queuepb_v2_o_auth2_auth_proto_msgTypes[0]
...
var File_queuepb_v2_o_auth2_auth_proto protoreflect.FileDescriptor

const file_queuepb_v2_o_auth2_auth_proto_rawDesc = "" +
	"\n" +
	"\x1dqueuepb/v2/o_auth2_auth.proto\x12\bqueue.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb7\x02\n" +
	"\n" +
	"OAuth2Auth\x12.\n" +
	"\x0etoken_endpoint\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\rtokenEndpoint\x12$\n" +
	...
	"\x06scopes\x18\x04 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x06scopes\x12D\n" +
	"\n" +
	"parameters\x18\x05 \x03(\v2$.queue.v2.OAuth2Auth.ParametersEntryR\n" +
	"parameters\x1a=\n" +
	"\x0fParametersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x92\x01\n" +
	"\fcom.queue.v2B\x0fOAuth2AuthProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_o_auth2_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queuepb_v2_o_auth2_auth_proto_goTypes = []any{
	(*OAuth2Auth)(nil), // 0: queue.v2.OAuth2Auth
	nil,                // 1: queue.v2.OAuth2Auth.ParametersEntry
}
var file_queuepb_v2_o_auth2_auth_proto_depIdxs = []int32{
	1, // 0: queue.v2.OAuth2Auth.parameters:type_name -> queue.v2.OAuth2Auth.ParametersEntry
...
func init() { file_queuepb_v2_o_auth2_auth_proto_init() }
func file_queuepb_v2_o_auth2_auth_proto_init() {
	if File_queuepb_v2_o_auth2_auth_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_o_auth2_auth_proto_rawDesc), len(file_queuepb_v2_o_auth2_auth_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_o_auth2_auth_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_o_auth2_auth_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_o_auth2_auth_proto_msgTypes,
	}.Build()
	File_queuepb_v2_o_auth2_auth_proto = out.File
	file_queuepb_v2_o_auth2_auth_proto_goTypes = nil
	file_queuepb_v2_o_auth2_auth_proto_depIdxs = nil
}
