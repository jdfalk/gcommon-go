...
// 	protoc        (unknown)
// source: queuepb/v2/batch_nack_request.proto
...
func (x *BatchNackRequest) Reset() {
	*x = BatchNackRequest{}
	mi := &file_queuepb_v2_batch_nack_request_proto_msgTypes[0]
...
var File_queuepb_v2_batch_nack_request_proto protoreflect.FileDescriptor

const file_queuepb_v2_batch_nack_request_proto_rawDesc = "" +
	"\n" +
	"#queuepb/v2/batch_nack_request.proto\x12\bqueue.v2\x1a\x1dqueuepb/v2/message_nack.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9d\x04\n" +
	"\x10BatchNackRequest\x123\n" +
	"\x11consumer_group_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x0fconsumerGroupId\x12(\n" +
	"\vconsumer_id\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\n" +
	"consumerId\x12D\n" +
	"\rmessage_nacks\x18\x03 \x03(\v2\x15.queue.v2.MessageNackB\b\xbaH\x05\x92\x01\x02\b\x01R\fmessageNacks\x12)\n" +
	"\x10requeue_messages\x18\x04 \x01(\bR\x0frequeueMessages\x121\n" +
	"\x10requeue_delay_ms\x18\x05 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x0erequeueDelayMs\x129\n" +
	"\x14max_requeue_attempts\x18\x06 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x12maxRequeueAttempts\x12\x1e\n" +
	"\vsend_to_dlq\x18\a \x01(\bR\tsendToDlq\x12(\n" +
	"\vnack_reason\x18\b \x01(\tB\a\xbaH\x04r\x02\x10\x01R\n" +
	"nackReason\x12D\n" +
	"\bmetadata\x18\t \x03(\v2(.queue.v2.BatchNackRequest.MetadataEntryR\bmetadata\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x98\x01\n" +
	"\fcom.queue.v2B\x15BatchNackRequestProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_batch_nack_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queuepb_v2_batch_nack_request_proto_goTypes = []any{
	(*BatchNackRequest)(nil), // 0: queue.v2.BatchNackRequest
	nil,                      // 1: queue.v2.BatchNackRequest.MetadataEntry
	(*MessageNack)(nil),      // 2: queue.v2.MessageNack
}
var file_queuepb_v2_batch_nack_request_proto_depIdxs = []int32{
	2, // 0: queue.v2.BatchNackRequest.message_nacks:type_name -> queue.v2.MessageNack
	1, // 1: queue.v2.BatchNackRequest.metadata:type_name -> queue.v2.BatchNackRequest.MetadataEntry
...
func init() { file_queuepb_v2_batch_nack_request_proto_init() }
func file_queuepb_v2_batch_nack_request_proto_init() {
	if File_queuepb_v2_batch_nack_request_proto != nil {
		return
	}
	file_queuepb_v2_message_nack_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_batch_nack_request_proto_rawDesc), len(file_queuepb_v2_batch_nack_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_batch_nack_request_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_batch_nack_request_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_batch_nack_request_proto_msgTypes,
	}.Build()
	File_queuepb_v2_batch_nack_request_proto = out.File
	file_queuepb_v2_batch_nack_request_proto_goTypes = nil
	file_queuepb_v2_batch_nack_request_proto_depIdxs = nil
}
