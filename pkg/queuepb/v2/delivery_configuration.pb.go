...
// 	protoc        (unknown)
// source: queuepb/v2/delivery_configuration.proto
...
func (x *DeliveryConfiguration) Reset() {
	*x = DeliveryConfiguration{}
	mi := &file_queuepb_v2_delivery_configuration_proto_msgTypes[0]
...
var File_queuepb_v2_delivery_configuration_proto protoreflect.FileDescriptor

const file_queuepb_v2_delivery_configuration_proto_rawDesc = "" +
	"\n" +
	"'queuepb/v2/delivery_configuration.proto\x12\bqueue.v2\x1a&queuepb/v2/batch_delivery_config.proto\x1a&queuepb/v2/delivery_retry_config.proto\x1a&queuepb/v2/flow_control_settings.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x88\x04\n" +
	"\x15DeliveryConfiguration\x12,\n" +
	"\rpush_endpoint\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\fpushEndpoint\x127\n" +
	"\x13delivery_timeout_ms\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00R\x11deliveryTimeoutMs\x12@\n" +
	"\fretry_config\x18\x03 \x01(\v2\x1d.queue.v2.DeliveryRetryConfigR\vretryConfig\x12@\n" +
	"\fbatch_config\x18\x04 \x01(\v2\x1d.queue.v2.BatchDeliveryConfigR\vbatchConfig\x12@\n" +
	"\fflow_control\x18\x05 \x01(\v2\x1d.queue.v2.FlowControlSettingsR\vflowControl\x12-\n" +
	"\x12enable_compression\x18\x06 \x01(\bR\x11enableCompression\x12S\n" +
	"\fauth_headers\x18\a \x03(\v20.queue.v2.DeliveryConfiguration.AuthHeadersEntryR\vauthHeaders\x1a>\n" +
	"\x10AuthHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x9d\x01\n" +
	"\fcom.queue.v2B\x1aDeliveryConfigurationProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_delivery_configuration_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queuepb_v2_delivery_configuration_proto_goTypes = []any{
	(*DeliveryConfiguration)(nil), // 0: queue.v2.DeliveryConfiguration
	nil,                           // 1: queue.v2.DeliveryConfiguration.AuthHeadersEntry
	(*DeliveryRetryConfig)(nil),   // 2: queue.v2.DeliveryRetryConfig
	(*BatchDeliveryConfig)(nil),   // 3: queue.v2.BatchDeliveryConfig
	(*FlowControlSettings)(nil),   // 4: queue.v2.FlowControlSettings
}
var file_queuepb_v2_delivery_configuration_proto_depIdxs = []int32{
	2, // 0: queue.v2.DeliveryConfiguration.retry_config:type_name -> queue.v2.DeliveryRetryConfig
	3, // 1: queue.v2.DeliveryConfiguration.batch_config:type_name -> queue.v2.BatchDeliveryConfig
	4, // 2: queue.v2.DeliveryConfiguration.flow_control:type_name -> queue.v2.FlowControlSettings
	1, // 3: queue.v2.DeliveryConfiguration.auth_headers:type_name -> queue.v2.DeliveryConfiguration.AuthHeadersEntry
...
func init() { file_queuepb_v2_delivery_configuration_proto_init() }
func file_queuepb_v2_delivery_configuration_proto_init() {
	if File_queuepb_v2_delivery_configuration_proto != nil {
		return
	}
	file_queuepb_v2_batch_delivery_config_proto_init()
	file_queuepb_v2_delivery_retry_config_proto_init()
	file_queuepb_v2_flow_control_settings_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_delivery_configuration_proto_rawDesc), len(file_queuepb_v2_delivery_configuration_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_delivery_configuration_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_delivery_configuration_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_delivery_configuration_proto_msgTypes,
	}.Build()
	File_queuepb_v2_delivery_configuration_proto = out.File
	file_queuepb_v2_delivery_configuration_proto_goTypes = nil
	file_queuepb_v2_delivery_configuration_proto_depIdxs = nil
}
