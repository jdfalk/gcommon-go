...
// 	protoc        (unknown)
// source: queuepb/v2/tls_auth.proto
...
func (x *TLSAuth) Reset() {
	*x = TLSAuth{}
	mi := &file_queuepb_v2_tls_auth_proto_msgTypes[0]
...
var File_queuepb_v2_tls_auth_proto protoreflect.FileDescriptor

const file_queuepb_v2_tls_auth_proto_rawDesc = "" +
	"\n" +
	"\x19queuepb/v2/tls_auth.proto\x12\bqueue.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x94\x01\n" +
	"\aTLSAuth\x12\"\n" +
...
var file_queuepb_v2_tls_auth_proto_depIdxs = []int32{
...
func init() { file_queuepb_v2_tls_auth_proto_init() }
func file_queuepb_v2_tls_auth_proto_init() {
	if File_queuepb_v2_tls_auth_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_tls_auth_proto_rawDesc), len(file_queuepb_v2_tls_auth_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_tls_auth_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_tls_auth_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_tls_auth_proto_msgTypes,
	}.Build()
	File_queuepb_v2_tls_auth_proto = out.File
	file_queuepb_v2_tls_auth_proto_goTypes = nil
	file_queuepb_v2_tls_auth_proto_depIdxs = nil
}
