...
// 	protoc        (unknown)
// source: queuepb/v2/partition_offset.proto
...
func (x *PartitionOffset) Reset() {
	*x = PartitionOffset{}
	mi := &file_queuepb_v2_partition_offset_proto_msgTypes[0]
...
var File_queuepb_v2_partition_offset_proto protoreflect.FileDescriptor

const file_queuepb_v2_partition_offset_proto_rawDesc = "" +
	"\n" +
	"!queuepb/v2/partition_offset.proto\x12\bqueue.v2\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xd6\x01\n" +
	"\x0fPartitionOffset\x12*\n" +
	"\fpartition_id\x18\x01 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\vpartitionId\x12\x1f\n" +
	"\x06offset\x18\x02 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x06offset\x12E\n" +
	"\x10offset_timestamp\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x0foffsetTimestamp\x12/\n" +
	"\x0fhigh_water_mark\x18\x04 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\rhighWaterMarkB\x97\x01\n" +
	"\fcom.queue.v2B\x14PartitionOffsetProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_partition_offset_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_partition_offset_proto_goTypes = []any{
	(*PartitionOffset)(nil),       // 0: queue.v2.PartitionOffset
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_queuepb_v2_partition_offset_proto_depIdxs = []int32{
	1, // 0: queue.v2.PartitionOffset.offset_timestamp:type_name -> google.protobuf.Timestamp
...
func init() { file_queuepb_v2_partition_offset_proto_init() }
func file_queuepb_v2_partition_offset_proto_init() {
	if File_queuepb_v2_partition_offset_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_partition_offset_proto_rawDesc), len(file_queuepb_v2_partition_offset_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_partition_offset_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_partition_offset_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_partition_offset_proto_msgTypes,
	}.Build()
	File_queuepb_v2_partition_offset_proto = out.File
	file_queuepb_v2_partition_offset_proto_goTypes = nil
	file_queuepb_v2_partition_offset_proto_depIdxs = nil
}
