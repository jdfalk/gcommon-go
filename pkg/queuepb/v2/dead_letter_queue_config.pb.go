...
// 	protoc        (unknown)
// source: queuepb/v2/dead_letter_queue_config.proto
...
func (x *DeadLetterQueueConfig) Reset() {
	*x = DeadLetterQueueConfig{}
	mi := &file_queuepb_v2_dead_letter_queue_config_proto_msgTypes[0]
...
var File_queuepb_v2_dead_letter_queue_config_proto protoreflect.FileDescriptor

const file_queuepb_v2_dead_letter_queue_config_proto_rawDesc = "" +
	"\n" +
	")queuepb/v2/dead_letter_queue_config.proto\x12\bqueue.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbd\x01\n" +
	...
	"\x12include_error_info\x18\x04 \x01(\bR\x10includeErrorInfoB\x9d\x01\n" +
	"\fcom.queue.v2B\x1aDeadLetterQueueConfigProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_dead_letter_queue_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_dead_letter_queue_config_proto_goTypes = []any{
	(*DeadLetterQueueConfig)(nil), // 0: queue.v2.DeadLetterQueueConfig
}
var file_queuepb_v2_dead_letter_queue_config_proto_depIdxs = []int32{
...
func init() { file_queuepb_v2_dead_letter_queue_config_proto_init() }
func file_queuepb_v2_dead_letter_queue_config_proto_init() {
	if File_queuepb_v2_dead_letter_queue_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_dead_letter_queue_config_proto_rawDesc), len(file_queuepb_v2_dead_letter_queue_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_dead_letter_queue_config_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_dead_letter_queue_config_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_dead_letter_queue_config_proto_msgTypes,
	}.Build()
	File_queuepb_v2_dead_letter_queue_config_proto = out.File
	file_queuepb_v2_dead_letter_queue_config_proto_goTypes = nil
	file_queuepb_v2_dead_letter_queue_config_proto_depIdxs = nil
}
