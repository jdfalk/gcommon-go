...
// 	protoc        (unknown)
// source: queuepb/v2/batch_config.proto
...
func (x *BatchConfig) Reset() {
	*x = BatchConfig{}
	mi := &file_queuepb_v2_batch_config_proto_msgTypes[0]
...
var File_queuepb_v2_batch_config_proto protoreflect.FileDescriptor

const file_queuepb_v2_batch_config_proto_rawDesc = "" +
	"\n" +
	"\x1dqueuepb/v2/batch_config.proto\x12\bqueue.v2\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb1\x02\n" +
	"\vBatchConfig\x12-\n" +
	"\x0emax_batch_size\x18\x01 \x01(\rB\a\xbaH\x04*\x02(\x00R\fmaxBatchSize\x12=\n" +
	"\rmax_wait_time\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\vmaxWaitTime\x12/\n" +
	"\x0fmax_batch_bytes\x18\x03 \x01(\x04B\a\xbaH\x042\x02(\x00R\rmaxBatchBytes\x12-\n" +
	"\x12enable_compression\x18\x04 \x01(\bR\x11enableCompression\x12*\n" +
	"\fworker_count\x18\x05 \x01(\rB\a\xbaH\x04*\x02(\x00R\vworkerCount\x12(\n" +
	"\vbuffer_size\x18\x06 \x01(\rB\a\xbaH\x04*\x02(\x00R\n" +
	"bufferSizeB\x93\x01\n" +
	"\fcom.queue.v2B\x10BatchConfigProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_batch_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_batch_config_proto_goTypes = []any{
	(*BatchConfig)(nil),         // 0: queue.v2.BatchConfig
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_queuepb_v2_batch_config_proto_depIdxs = []int32{
	1, // 0: queue.v2.BatchConfig.max_wait_time:type_name -> google.protobuf.Duration
...
func init() { file_queuepb_v2_batch_config_proto_init() }
func file_queuepb_v2_batch_config_proto_init() {
	if File_queuepb_v2_batch_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_batch_config_proto_rawDesc), len(file_queuepb_v2_batch_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_batch_config_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_batch_config_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_batch_config_proto_msgTypes,
	}.Build()
	File_queuepb_v2_batch_config_proto = out.File
	file_queuepb_v2_batch_config_proto_goTypes = nil
	file_queuepb_v2_batch_config_proto_depIdxs = nil
}
