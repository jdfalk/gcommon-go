...
// 	protoc        (unknown)
// source: queuepb/v2/original_queue_info.proto
...
func (x *OriginalQueueInfo) Reset() {
	*x = OriginalQueueInfo{}
	mi := &file_queuepb_v2_original_queue_info_proto_msgTypes[0]
...
var File_queuepb_v2_original_queue_info_proto protoreflect.FileDescriptor

const file_queuepb_v2_original_queue_info_proto_rawDesc = "" +
	"\n" +
	"$queuepb/v2/original_queue_info.proto\x12\bqueue.v2\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xdd\x02\n" +
	...
	"\x0fpartition_count\x18\x03 \x01(\x05R\x0epartitionCount\x12X\n" +
	"\x0fconfig_snapshot\x18\x04 \x03(\v2/.queue.v2.OriginalQueueInfo.ConfigSnapshotEntryR\x0econfigSnapshot\x12=\n" +
	...
	"\fcom.queue.v2B\x16OriginalQueueInfoProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_original_queue_info_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queuepb_v2_original_queue_info_proto_goTypes = []any{
	(*OriginalQueueInfo)(nil),     // 0: queue.v2.OriginalQueueInfo
	nil,                           // 1: queue.v2.OriginalQueueInfo.ConfigSnapshotEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_queuepb_v2_original_queue_info_proto_depIdxs = []int32{
	1, // 0: queue.v2.OriginalQueueInfo.config_snapshot:type_name -> queue.v2.OriginalQueueInfo.ConfigSnapshotEntry
	2, // 1: queue.v2.OriginalQueueInfo.backup_point:type_name -> google.protobuf.Timestamp
...
func init() { file_queuepb_v2_original_queue_info_proto_init() }
func file_queuepb_v2_original_queue_info_proto_init() {
	if File_queuepb_v2_original_queue_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_original_queue_info_proto_rawDesc), len(file_queuepb_v2_original_queue_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_original_queue_info_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_original_queue_info_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_original_queue_info_proto_msgTypes,
	}.Build()
	File_queuepb_v2_original_queue_info_proto = out.File
	file_queuepb_v2_original_queue_info_proto_goTypes = nil
	file_queuepb_v2_original_queue_info_proto_depIdxs = nil
}
