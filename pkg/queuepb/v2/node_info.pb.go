...
// 	protoc        (unknown)
// source: queuepb/v2/node_info.proto
...
type NodeInfo struct {
	...
	xxx_hidden_State         v2.NodeState           `protobuf:"varint,4,opt,name=state,enum=common.v2.NodeState"`
...
func (x *NodeInfo) Reset() {
	*x = NodeInfo{}
	mi := &file_queuepb_v2_node_info_proto_msgTypes[0]
...
func (x *NodeInfo) GetState() v2.NodeState {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 3) {
			return x.xxx_hidden_State
		}
	}
	return v2.NodeState(0)
}
...
func (x *NodeInfo) SetState(v v2.NodeState) {
...
func (x *NodeInfo) ClearState() {
	...
	x.xxx_hidden_State = v2.NodeState_NODE_STATE_UNSPECIFIED
}
...
var File_queuepb_v2_node_info_proto protoreflect.FileDescriptor

const file_queuepb_v2_node_info_proto_rawDesc = "" +
	"\n" +
	"\x1aqueuepb/v2/node_info.proto\x12\bqueue.v2\x1a\x1ccommonpb/v2/node_state.proto\x1a\x1bqueuepb/v2/node_stats.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xac\x02\n" +
	"\bNodeInfo\x12 \n" +
	...
	"\x05state\x18\x04 \x01(\x0e2\x14.common.v2.NodeStateR\x05state\x12\x1e\n" +
	...
	"\x05stats\x18\a \x01(\v2\x13.queue.v2.NodeStatsR\x05statsB\x90\x01\n" +
	"\fcom.queue.v2B\rNodeInfoProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_node_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_node_info_proto_goTypes = []any{
	(*NodeInfo)(nil),              // 0: queue.v2.NodeInfo
	(v2.NodeState)(0),             // 1: common.v2.NodeState
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*NodeStats)(nil),             // 3: queue.v2.NodeStats
}
var file_queuepb_v2_node_info_proto_depIdxs = []int32{
	1, // 0: queue.v2.NodeInfo.state:type_name -> common.v2.NodeState
	2, // 1: queue.v2.NodeInfo.last_heartbeat:type_name -> google.protobuf.Timestamp
	3, // 2: queue.v2.NodeInfo.stats:type_name -> queue.v2.NodeStats
...
func init() { file_queuepb_v2_node_info_proto_init() }
func file_queuepb_v2_node_info_proto_init() {
	if File_queuepb_v2_node_info_proto != nil {
		return
	}
	file_queuepb_v2_node_stats_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_node_info_proto_rawDesc), len(file_queuepb_v2_node_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_node_info_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_node_info_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_node_info_proto_msgTypes,
	}.Build()
	File_queuepb_v2_node_info_proto = out.File
	file_queuepb_v2_node_info_proto_goTypes = nil
	file_queuepb_v2_node_info_proto_depIdxs = nil
}
