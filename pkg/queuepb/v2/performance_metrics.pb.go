...
// 	protoc        (unknown)
// source: queuepb/v2/performance_metrics.proto
...
func (x *PerformanceMetrics) Reset() {
	*x = PerformanceMetrics{}
	mi := &file_queuepb_v2_performance_metrics_proto_msgTypes[0]
...
var File_queuepb_v2_performance_metrics_proto protoreflect.FileDescriptor

const file_queuepb_v2_performance_metrics_proto_rawDesc = "" +
	"\n" +
	"$queuepb/v2/performance_metrics.proto\x12\bqueue.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xec\x03\n" +
	"\x12PerformanceMetrics\x123\n" +
	"\x11memory_used_bytes\x18\x01 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x0fmemoryUsedBytes\x12=\n" +
	"\x16memory_available_bytes\x18\x02 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x14memoryAvailableBytes\x12C\n" +
	"\x11cpu_usage_percent\x18\x03 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00Y@)\x00\x00\x00\x00\x00\x00\x00\x00R\x0fcpuUsagePercent\x12/\n" +
	"\x0fdisk_used_bytes\x18\x04 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\rdiskUsedBytes\x129\n" +
	...
	"\x0fmax_connections\x18\b \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x0emaxConnectionsB\x9a\x01\n" +
	"\fcom.queue.v2B\x17PerformanceMetricsProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_performance_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_performance_metrics_proto_goTypes = []any{
	(*PerformanceMetrics)(nil), // 0: queue.v2.PerformanceMetrics
}
var file_queuepb_v2_performance_metrics_proto_depIdxs = []int32{
...
func init() { file_queuepb_v2_performance_metrics_proto_init() }
func file_queuepb_v2_performance_metrics_proto_init() {
	if File_queuepb_v2_performance_metrics_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_performance_metrics_proto_rawDesc), len(file_queuepb_v2_performance_metrics_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_performance_metrics_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_performance_metrics_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_performance_metrics_proto_msgTypes,
	}.Build()
	File_queuepb_v2_performance_metrics_proto = out.File
	file_queuepb_v2_performance_metrics_proto_goTypes = nil
	file_queuepb_v2_performance_metrics_proto_depIdxs = nil
}
