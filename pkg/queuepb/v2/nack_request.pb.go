...
// 	protoc        (unknown)
// source: queuepb/v2/nack_request.proto
...
type NackRequest struct {
	...
	xxx_hidden_Metadata            *v2.RequestMetadata    `protobuf:"bytes,100,opt,name=metadata"`
...
func (x *NackRequest) Reset() {
	*x = NackRequest{}
	mi := &file_queuepb_v2_nack_request_proto_msgTypes[0]
...
func (x *NackRequest) GetMetadata() *v2.RequestMetadata {
	if x != nil {
...
func (x *NackRequest) SetMetadata(v *v2.RequestMetadata) {
...
var File_queuepb_v2_nack_request_proto protoreflect.FileDescriptor

const file_queuepb_v2_nack_request_proto_rawDesc = "" +
	"\n" +
	"\x1dqueuepb/v2/nack_request.proto\x12\bqueue.v2\x1a\"commonpb/v2/request_metadata.proto\x1a\x1bqueuepb/v2/nack_error.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb8\x02\n" +
	"\vNackRequest\x12$\n" +
	...
	"\x05error\x18\x04 \x01(\v2\x13.queue.v2.NackErrorR\x05error\x12;\n" +
	...
	"maxRetries\x126\n" +
	"\bmetadata\x18d \x01(\v2\x1a.common.v2.RequestMetadataR\bmetadataB\x93\x01\n" +
	"\fcom.queue.v2B\x10NackRequestProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_nack_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_nack_request_proto_goTypes = []any{
	(*NackRequest)(nil),        // 0: queue.v2.NackRequest
	(*NackError)(nil),          // 1: queue.v2.NackError
	(*v2.RequestMetadata)(nil), // 2: common.v2.RequestMetadata
}
var file_queuepb_v2_nack_request_proto_depIdxs = []int32{
	1, // 0: queue.v2.NackRequest.error:type_name -> queue.v2.NackError
	2, // 1: queue.v2.NackRequest.metadata:type_name -> common.v2.RequestMetadata
...
func init() { file_queuepb_v2_nack_request_proto_init() }
func file_queuepb_v2_nack_request_proto_init() {
	if File_queuepb_v2_nack_request_proto != nil {
		return
	}
	file_queuepb_v2_nack_error_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_nack_request_proto_rawDesc), len(file_queuepb_v2_nack_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_nack_request_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_nack_request_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_nack_request_proto_msgTypes,
	}.Build()
	File_queuepb_v2_nack_request_proto = out.File
	file_queuepb_v2_nack_request_proto_goTypes = nil
	file_queuepb_v2_nack_request_proto_depIdxs = nil
}
