...
// 	protoc        (unknown)
// source: queuepb/v2/commit_offset_response.proto
...
func (x *CommitOffsetResponse) Reset() {
	*x = CommitOffsetResponse{}
	mi := &file_queuepb_v2_commit_offset_response_proto_msgTypes[0]
...
var File_queuepb_v2_commit_offset_response_proto protoreflect.FileDescriptor

const file_queuepb_v2_commit_offset_response_proto_rawDesc = "" +
	"\n" +
	"'queuepb/v2/commit_offset_response.proto\x12\bqueue.v2\x1a(queuepb/v2/partition_commit_result.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xc4\x04\n" +
	"\x14CommitOffsetResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12,\n" +
	"\rerror_message\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\ferrorMessage\x12&\n" +
	"\n" +
	"error_code\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\terrorCode\x12V\n" +
	"\x11partition_results\x18\x04 \x03(\v2\x1f.queue.v2.PartitionCommitResultB\b\xbaH\x05\x92\x01\x02\b\x01R\x10partitionResults\x120\n" +
	"\x0fcommitted_count\x18\x05 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x0ecommittedCount\x12*\n" +
	"\ffailed_count\x18\x06 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\vfailedCount\x12E\n" +
	"\x10commit_timestamp\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x0fcommitTimestamp\x128\n" +
	"\x13consumer_generation\x18\b \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x12consumerGeneration\x12H\n" +
	"\bmetadata\x18\t \x03(\v2,.queue.v2.CommitOffsetResponse.MetadataEntryR\bmetadata\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x9c\x01\n" +
	"\fcom.queue.v2B\x19CommitOffsetResponseProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_commit_offset_response_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queuepb_v2_commit_offset_response_proto_goTypes = []any{
	(*CommitOffsetResponse)(nil),  // 0: queue.v2.CommitOffsetResponse
	nil,                           // 1: queue.v2.CommitOffsetResponse.MetadataEntry
	(*PartitionCommitResult)(nil), // 2: queue.v2.PartitionCommitResult
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_queuepb_v2_commit_offset_response_proto_depIdxs = []int32{
	2, // 0: queue.v2.CommitOffsetResponse.partition_results:type_name -> queue.v2.PartitionCommitResult
	3, // 1: queue.v2.CommitOffsetResponse.commit_timestamp:type_name -> google.protobuf.Timestamp
	1, // 2: queue.v2.CommitOffsetResponse.metadata:type_name -> queue.v2.CommitOffsetResponse.MetadataEntry
...
func init() { file_queuepb_v2_commit_offset_response_proto_init() }
func file_queuepb_v2_commit_offset_response_proto_init() {
	if File_queuepb_v2_commit_offset_response_proto != nil {
		return
	}
	file_queuepb_v2_partition_commit_result_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_commit_offset_response_proto_rawDesc), len(file_queuepb_v2_commit_offset_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_commit_offset_response_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_commit_offset_response_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_commit_offset_response_proto_msgTypes,
	}.Build()
	File_queuepb_v2_commit_offset_response_proto = out.File
	file_queuepb_v2_commit_offset_response_proto_goTypes = nil
	file_queuepb_v2_commit_offset_response_proto_depIdxs = nil
}
