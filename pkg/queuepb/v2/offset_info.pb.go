...
// 	protoc        (unknown)
// source: queuepb/v2/offset_info.proto
...
func (x *OffsetInfo) Reset() {
	*x = OffsetInfo{}
	mi := &file_queuepb_v2_offset_info_proto_msgTypes[0]
...
var File_queuepb_v2_offset_info_proto protoreflect.FileDescriptor

const file_queuepb_v2_offset_info_proto_rawDesc = "" +
	"\n" +
	"\x1cqueuepb/v2/offset_info.proto\x12\bqueue.v2\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xbe\x02\n" +
	"\n" +
	"OffsetInfo\x12\x1f\n" +
	"\x06offset\x18\x01 \x01(\x04B\a\xbaH\x042\x02(\x00R\x06offset\x12*\n" +
	"\fpartition_id\x18\x02 \x01(\rB\a\xbaH\x04*\x02(\x00R\vpartitionId\x128\n" +
	"\ttimestamp\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12*\n" +
	"\fmessage_size\x18\x04 \x01(\x04B\a\xbaH\x042\x02(\x00R\vmessageSize\x12\x19\n" +
	"\bis_valid\x18\x05 \x01(\bR\aisValid\x12.\n" +
	"\x0econsumer_group\x18\x06 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\rconsumerGroup\x122\n" +
	"\x10committed_offset\x18\a \x01(\x04B\a\xbaH\x042\x02(\x00R\x0fcommittedOffsetB\x92\x01\n" +
	"\fcom.queue.v2B\x0fOffsetInfoProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_offset_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_offset_info_proto_goTypes = []any{
	(*OffsetInfo)(nil),            // 0: queue.v2.OffsetInfo
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_queuepb_v2_offset_info_proto_depIdxs = []int32{
	1, // 0: queue.v2.OffsetInfo.timestamp:type_name -> google.protobuf.Timestamp
...
func init() { file_queuepb_v2_offset_info_proto_init() }
func file_queuepb_v2_offset_info_proto_init() {
	if File_queuepb_v2_offset_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_offset_info_proto_rawDesc), len(file_queuepb_v2_offset_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_offset_info_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_offset_info_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_offset_info_proto_msgTypes,
	}.Build()
	File_queuepb_v2_offset_info_proto = out.File
	file_queuepb_v2_offset_info_proto_goTypes = nil
	file_queuepb_v2_offset_info_proto_depIdxs = nil
}
