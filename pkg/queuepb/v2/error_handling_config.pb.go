...
// 	protoc        (unknown)
// source: queuepb/v2/error_handling_config.proto
...
func (x *ErrorHandlingConfig) Reset() {
	*x = ErrorHandlingConfig{}
	mi := &file_queuepb_v2_error_handling_config_proto_msgTypes[0]
...
var File_queuepb_v2_error_handling_config_proto protoreflect.FileDescriptor

const file_queuepb_v2_error_handling_config_proto_rawDesc = "" +
	"\n" +
	"&queuepb/v2/error_handling_config.proto\x12\bqueue.v2\x1a)queuepb/v2/dead_letter_queue_config.proto\x1a$queuepb/v2/error_action_config.proto\x1a*queuepb/v2/error_notification_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe4\x02\n" +
	"\x13ErrorHandlingConfig\x12>\n" +
	"\n" +
	"dlq_config\x18\x01 \x01(\v2\x1f.queue.v2.DeadLetterQueueConfigR\tdlqConfig\x12;\n" +
	...
	"\x13notification_config\x18\x05 \x01(\v2!.queue.v2.ErrorNotificationConfigR\x12notificationConfigB\x9b\x01\n" +
	"\fcom.queue.v2B\x18ErrorHandlingConfigProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_queuepb_v2_error_handling_config_proto_goTypes = []any{
	(*ErrorHandlingConfig)(nil),     // 0: queue.v2.ErrorHandlingConfig
	(*DeadLetterQueueConfig)(nil),   // 1: queue.v2.DeadLetterQueueConfig
	(*ErrorActionConfig)(nil),       // 2: queue.v2.ErrorActionConfig
	(*ErrorNotificationConfig)(nil), // 3: queue.v2.ErrorNotificationConfig
}
var file_queuepb_v2_error_handling_config_proto_depIdxs = []int32{
	1, // 0: queue.v2.ErrorHandlingConfig.dlq_config:type_name -> queue.v2.DeadLetterQueueConfig
	2, // 1: queue.v2.ErrorHandlingConfig.error_actions:type_name -> queue.v2.ErrorActionConfig
	3, // 2: queue.v2.ErrorHandlingConfig.notification_config:type_name -> queue.v2.ErrorNotificationConfig
...
func init() { file_queuepb_v2_error_handling_config_proto_init() }
func file_queuepb_v2_error_handling_config_proto_init() {
	if File_queuepb_v2_error_handling_config_proto != nil {
		return
	}
	file_queuepb_v2_dead_letter_queue_config_proto_init()
	file_queuepb_v2_error_action_config_proto_init()
	file_queuepb_v2_error_notification_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_error_handling_config_proto_rawDesc), len(file_queuepb_v2_error_handling_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_error_handling_config_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_error_handling_config_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_error_handling_config_proto_msgTypes,
	}.Build()
	File_queuepb_v2_error_handling_config_proto = out.File
	file_queuepb_v2_error_handling_config_proto_goTypes = nil
	file_queuepb_v2_error_handling_config_proto_depIdxs = nil
}
