...
// 	protoc        (unknown)
// source: queuepb/v2/message_properties.proto
...
type MessageProperties struct {
	...
	xxx_hidden_Priority        v2.PriorityLevel       `protobuf:"varint,1,opt,name=priority,enum=common.v2.PriorityLevel"`
...
func (x *MessageProperties) Reset() {
	*x = MessageProperties{}
	mi := &file_queuepb_v2_message_properties_proto_msgTypes[0]
...
func (x *MessageProperties) GetPriority() v2.PriorityLevel {
	if x != nil {
...
func (x *MessageProperties) GetDeliveryMode() v2.DeliveryMode {
	if x != nil {
...
func (x *MessageProperties) SetPriority(v v2.PriorityLevel) {
	x.xxx_hidden_Priority = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 10)
}

func (x *MessageProperties) SetDeliveryMode(v v2.DeliveryMode) {
...
func (x *MessageProperties) ClearPriority() {
	...
	x.xxx_hidden_Priority = v2.PriorityLevel_QUEUE_PRIORITY_LEVEL_UNSPECIFIED
}
...
var File_queuepb_v2_message_properties_proto protoreflect.FileDescriptor

const file_queuepb_v2_message_properties_proto_rawDesc = "" +
	"\n" +
	"#queuepb/v2/message_properties.proto\x12\bqueue.v2\x1a\x1fcommonpb/v2/delivery_mode.proto\x1a commonpb/v2/priority_level.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x94\x04\n" +
	"\x11MessageProperties\x124\n" +
	"\bpriority\x18\x01 \x01(\x0e2\x18.common.v2.PriorityLevelR\bpriority\x12<\n" +
	"\rdelivery_mode\x18\x02 \x01(\x0e2\x17.common.v2.DeliveryModeR\fdeliveryMode\x12C\n" +
	...
	" \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x0fdeliveryDelayMsB\x99\x01\n" +
	"\fcom.queue.v2B\x16MessagePropertiesProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_message_properties_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_message_properties_proto_goTypes = []any{
	(*MessageProperties)(nil),     // 0: queue.v2.MessageProperties
	(v2.PriorityLevel)(0),         // 1: common.v2.PriorityLevel
	(v2.DeliveryMode)(0),          // 2: common.v2.DeliveryMode
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_queuepb_v2_message_properties_proto_depIdxs = []int32{
	1, // 0: queue.v2.MessageProperties.priority:type_name -> common.v2.PriorityLevel
	2, // 1: queue.v2.MessageProperties.delivery_mode:type_name -> common.v2.DeliveryMode
	3, // 2: queue.v2.MessageProperties.expiration_time:type_name -> google.protobuf.Timestamp
...
func init() { file_queuepb_v2_message_properties_proto_init() }
func file_queuepb_v2_message_properties_proto_init() {
	if File_queuepb_v2_message_properties_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_message_properties_proto_rawDesc), len(file_queuepb_v2_message_properties_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_message_properties_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_message_properties_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_message_properties_proto_msgTypes,
	}.Build()
	File_queuepb_v2_message_properties_proto = out.File
	file_queuepb_v2_message_properties_proto_goTypes = nil
	file_queuepb_v2_message_properties_proto_depIdxs = nil
}
