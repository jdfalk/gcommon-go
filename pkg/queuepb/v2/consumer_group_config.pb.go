...
// 	protoc        (unknown)
// source: queuepb/v2/consumer_group_config.proto
...
type ConsumerGroupConfig struct {
	...
	xxx_hidden_LoadBalancingStrategy v2.LoadBalancingStrategy `protobuf:"varint,1,opt,name=load_balancing_strategy,json=loadBalancingStrategy,enum=common.v2.LoadBalancingStrategy"`
	xxx_hidden_RebalanceStrategy     v2.RebalanceStrategy     `protobuf:"varint,2,opt,name=rebalance_strategy,json=rebalanceStrategy,enum=common.v2.RebalanceStrategy"`
	...
	xxx_hidden_OffsetResetStrategy   v2.OffsetResetStrategy   `protobuf:"varint,7,opt,name=offset_reset_strategy,json=offsetResetStrategy,enum=common.v2.OffsetResetStrategy"`
...
func (x *ConsumerGroupConfig) Reset() {
	*x = ConsumerGroupConfig{}
	mi := &file_queuepb_v2_consumer_group_config_proto_msgTypes[0]
...
func (x *ConsumerGroupConfig) GetLoadBalancingStrategy() v2.LoadBalancingStrategy {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 0) {
			return x.xxx_hidden_LoadBalancingStrategy
		}
	}
	return v2.LoadBalancingStrategy(0)
}

func (x *ConsumerGroupConfig) GetRebalanceStrategy() v2.RebalanceStrategy {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			return x.xxx_hidden_RebalanceStrategy
		}
	}
	return v2.RebalanceStrategy(0)
}
...
func (x *ConsumerGroupConfig) GetOffsetResetStrategy() v2.OffsetResetStrategy {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 6) {
			return x.xxx_hidden_OffsetResetStrategy
		}
	}
	return v2.OffsetResetStrategy(0)
}
...
func (x *ConsumerGroupConfig) SetLoadBalancingStrategy(v v2.LoadBalancingStrategy) {
	x.xxx_hidden_LoadBalancingStrategy = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 10)
}

func (x *ConsumerGroupConfig) SetRebalanceStrategy(v v2.RebalanceStrategy) {
...
func (x *ConsumerGroupConfig) SetOffsetResetStrategy(v v2.OffsetResetStrategy) {
...
func (x *ConsumerGroupConfig) ClearLoadBalancingStrategy() {
	...
	x.xxx_hidden_LoadBalancingStrategy = v2.LoadBalancingStrategy_LOAD_BALANCING_STRATEGY_UNSPECIFIED
}

func (x *ConsumerGroupConfig) ClearRebalanceStrategy() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_RebalanceStrategy = v2.RebalanceStrategy_REBALANCE_STRATEGY_UNSPECIFIED
}
...
func (x *ConsumerGroupConfig) ClearOffsetResetStrategy() {
	...
	x.xxx_hidden_OffsetResetStrategy = v2.OffsetResetStrategy_OFFSET_RESET_STRATEGY_UNSPECIFIED
}
...
type ConsumerGroupConfig_builder struct {
	...
	LoadBalancingStrategy *v2.LoadBalancingStrategy
	// Rebalance strategy when consumers join/leave
	RebalanceStrategy *v2.RebalanceStrategy
	...
	OffsetResetStrategy *v2.OffsetResetStrategy
...
var File_queuepb_v2_consumer_group_config_proto protoreflect.FileDescriptor

const file_queuepb_v2_consumer_group_config_proto_rawDesc = "" +
	"\n" +
	"&queuepb/v2/consumer_group_config.proto\x12\bqueue.v2\x1a)commonpb/v2/load_balancing_strategy.proto\x1a'commonpb/v2/offset_reset_strategy.proto\x1a$commonpb/v2/rebalance_strategy.proto\x1a#queuepb/v2/auto_commit_config.proto\x1a)queuepb/v2/dead_letter_queue_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9b\x05\n" +
	"\x13ConsumerGroupConfig\x12X\n" +
	"\x17load_balancing_strategy\x18\x01 \x01(\x0e2 .common.v2.LoadBalancingStrategyR\x15loadBalancingStrategy\x12K\n" +
	"\x12rebalance_strategy\x18\x02 \x01(\x0e2\x1c.common.v2.RebalanceStrategyR\x11rebalanceStrategy\x125\n" +
	...
	"\x14max_poll_interval_ms\x18\x05 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x11maxPollIntervalMs\x12;\n" +
	"\vauto_commit\x18\x06 \x01(\v2\x1a.queue.v2.AutoCommitConfigR\n" +
	"autoCommit\x12R\n" +
	"\x15offset_reset_strategy\x18\a \x01(\x0e2\x1e.common.v2.OffsetResetStrategyR\x13offsetResetStrategy\x12,\n" +
	...
	"\n" +
	"dlq_config\x18\n" +
	" \x01(\v2\x1f.queue.v2.DeadLetterQueueConfigR\tdlqConfigB\x9b\x01\n" +
	"\fcom.queue.v2B\x18ConsumerGroupConfigProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_consumer_group_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_consumer_group_config_proto_goTypes = []any{
	(*ConsumerGroupConfig)(nil),   // 0: queue.v2.ConsumerGroupConfig
	(v2.LoadBalancingStrategy)(0), // 1: common.v2.LoadBalancingStrategy
	(v2.RebalanceStrategy)(0),     // 2: common.v2.RebalanceStrategy
	(*AutoCommitConfig)(nil),      // 3: queue.v2.AutoCommitConfig
	(v2.OffsetResetStrategy)(0),   // 4: common.v2.OffsetResetStrategy
	(*DeadLetterQueueConfig)(nil), // 5: queue.v2.DeadLetterQueueConfig
}
var file_queuepb_v2_consumer_group_config_proto_depIdxs = []int32{
	1, // 0: queue.v2.ConsumerGroupConfig.load_balancing_strategy:type_name -> common.v2.LoadBalancingStrategy
	2, // 1: queue.v2.ConsumerGroupConfig.rebalance_strategy:type_name -> common.v2.RebalanceStrategy
	3, // 2: queue.v2.ConsumerGroupConfig.auto_commit:type_name -> queue.v2.AutoCommitConfig
	4, // 3: queue.v2.ConsumerGroupConfig.offset_reset_strategy:type_name -> common.v2.OffsetResetStrategy
	5, // 4: queue.v2.ConsumerGroupConfig.dlq_config:type_name -> queue.v2.DeadLetterQueueConfig
...
func init() { file_queuepb_v2_consumer_group_config_proto_init() }
func file_queuepb_v2_consumer_group_config_proto_init() {
	if File_queuepb_v2_consumer_group_config_proto != nil {
		return
	}
	file_queuepb_v2_auto_commit_config_proto_init()
	file_queuepb_v2_dead_letter_queue_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_consumer_group_config_proto_rawDesc), len(file_queuepb_v2_consumer_group_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_consumer_group_config_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_consumer_group_config_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_consumer_group_config_proto_msgTypes,
	}.Build()
	File_queuepb_v2_consumer_group_config_proto = out.File
	file_queuepb_v2_consumer_group_config_proto_goTypes = nil
	file_queuepb_v2_consumer_group_config_proto_depIdxs = nil
}
