...
// 	protoc        (unknown)
// source: queuepb/v2/backup_source.proto
...
func (x *BackupSource) Reset() {
	*x = BackupSource{}
	mi := &file_queuepb_v2_backup_source_proto_msgTypes[0]
...
var File_queuepb_v2_backup_source_proto protoreflect.FileDescriptor

const file_queuepb_v2_backup_source_proto_rawDesc = "" +
	"\n" +
	"\x1equeuepb/v2/backup_source.proto\x12\bqueue.v2\x1a queuepb/v2/encryption_info.proto\x1a$queuepb/v2/original_queue_info.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xd2\x04\n" +
	"\fBackupSource\x12$\n" +
	"\tbackup_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\bbackupId\x12(\n" +
	"\vbackup_path\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\n" +
	"backupPath\x12*\n" +
	"\fstorage_type\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\vstorageType\x12I\n" +
	"\vcredentials\x18\x04 \x03(\v2'.queue.v2.BackupSource.CredentialsEntryR\vcredentials\x12E\n" +
	"\x10backup_timestamp\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x0fbackupTimestamp\x12B\n" +
	"\x0eoriginal_queue\x18\x06 \x01(\v2\x1b.queue.v2.OriginalQueueInfoR\roriginalQueue\x12>\n" +
	"\x0ebackup_version\x18\a \x01(\tB\x17\xbaH\x14r\x122\x10^v?\\d+\\.\\d+\\.\\d+R\rbackupVersion\x126\n" +
	"\x12compression_format\x18\b \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x11compressionFormat\x128\n" +
	"\n" +
	"encryption\x18\t \x01(\v2\x18.queue.v2.EncryptionInfoR\n" +
	"encryption\x1a>\n" +
	"\x10CredentialsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x94\x01\n" +
	"\fcom.queue.v2B\x11BackupSourceProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_backup_source_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queuepb_v2_backup_source_proto_goTypes = []any{
	(*BackupSource)(nil),          // 0: queue.v2.BackupSource
	nil,                           // 1: queue.v2.BackupSource.CredentialsEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*OriginalQueueInfo)(nil),     // 3: queue.v2.OriginalQueueInfo
	(*EncryptionInfo)(nil),        // 4: queue.v2.EncryptionInfo
}
var file_queuepb_v2_backup_source_proto_depIdxs = []int32{
	1, // 0: queue.v2.BackupSource.credentials:type_name -> queue.v2.BackupSource.CredentialsEntry
	2, // 1: queue.v2.BackupSource.backup_timestamp:type_name -> google.protobuf.Timestamp
	3, // 2: queue.v2.BackupSource.original_queue:type_name -> queue.v2.OriginalQueueInfo
	4, // 3: queue.v2.BackupSource.encryption:type_name -> queue.v2.EncryptionInfo
...
func init() { file_queuepb_v2_backup_source_proto_init() }
func file_queuepb_v2_backup_source_proto_init() {
	if File_queuepb_v2_backup_source_proto != nil {
		return
	}
	file_queuepb_v2_encryption_info_proto_init()
	file_queuepb_v2_original_queue_info_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_backup_source_proto_rawDesc), len(file_queuepb_v2_backup_source_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_backup_source_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_backup_source_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_backup_source_proto_msgTypes,
	}.Build()
	File_queuepb_v2_backup_source_proto = out.File
	file_queuepb_v2_backup_source_proto_goTypes = nil
	file_queuepb_v2_backup_source_proto_depIdxs = nil
}
