...
// 	protoc        (unknown)
// source: queuepb/v2/performance_options.proto
...
func (x *PerformanceOptions) Reset() {
	*x = PerformanceOptions{}
	mi := &file_queuepb_v2_performance_options_proto_msgTypes[0]
...
var File_queuepb_v2_performance_options_proto protoreflect.FileDescriptor

const file_queuepb_v2_performance_options_proto_rawDesc = "" +
	"\n" +
	"$queuepb/v2/performance_options.proto\x12\bqueue.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf4\x01\n" +
	"\x12PerformanceOptions\x12*\n" +
	"\fworker_count\x18\x01 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\vworkerCount\x12&\n" +
	"\n" +
	"batch_size\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\tbatchSize\x12-\n" +
	"\x0ebuffer_size_mb\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\fbufferSizeMb\x12-\n" +
	"\x12enable_compression\x18\x04 \x01(\bR\x11enableCompression\x12,\n" +
	"\rthrottle_rate\x18\x05 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\fthrottleRateB\x9a\x01\n" +
	"\fcom.queue.v2B\x17PerformanceOptionsProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_performance_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_performance_options_proto_goTypes = []any{
	(*PerformanceOptions)(nil), // 0: queue.v2.PerformanceOptions
}
var file_queuepb_v2_performance_options_proto_depIdxs = []int32{
...
func init() { file_queuepb_v2_performance_options_proto_init() }
func file_queuepb_v2_performance_options_proto_init() {
	if File_queuepb_v2_performance_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_performance_options_proto_rawDesc), len(file_queuepb_v2_performance_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_performance_options_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_performance_options_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_performance_options_proto_msgTypes,
	}.Build()
	File_queuepb_v2_performance_options_proto = out.File
	file_queuepb_v2_performance_options_proto_goTypes = nil
	file_queuepb_v2_performance_options_proto_depIdxs = nil
}
