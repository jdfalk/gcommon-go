...
// 	protoc        (unknown)
// source: queuepb/v2/message_nack.proto
...
type MessageNack struct {
	...
	xxx_hidden_ErrorCategory   v2.NackErrorCategory   `protobuf:"varint,6,opt,name=error_category,json=errorCategory,enum=common.v2.NackErrorCategory"`
...
func (x *MessageNack) Reset() {
	*x = MessageNack{}
	mi := &file_queuepb_v2_message_nack_proto_msgTypes[0]
...
func (x *MessageNack) GetErrorCategory() v2.NackErrorCategory {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 5) {
			return x.xxx_hidden_ErrorCategory
		}
	}
	return v2.NackErrorCategory(0)
}
...
func (x *MessageNack) SetErrorCategory(v v2.NackErrorCategory) {
...
func (x *MessageNack) ClearErrorCategory() {
	...
	x.xxx_hidden_ErrorCategory = v2.NackErrorCategory_NACK_ERROR_CATEGORY_UNSPECIFIED
}
...
type MessageNack_builder struct {
	...
	ErrorCategory *v2.NackErrorCategory
	// Specific error code
	ErrorCode *string
...
var File_queuepb_v2_message_nack_proto protoreflect.FileDescriptor

const file_queuepb_v2_message_nack_proto_rawDesc = "" +
	"\n" +
	"\x1dqueuepb/v2/message_nack.proto\x12\bqueue.v2\x1a%commonpb/v2/nack_error_category.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc3\x04\n" +
	"\vMessageNack\x12&\n" +
	"\n" +
	...
	"nackReason\x12C\n" +
	"\x0eerror_category\x18\x06 \x01(\x0e2\x1c.common.v2.NackErrorCategoryR\rerrorCategory\x12&\n" +
	"\n" +
	...
	" \x03(\v2*.queue.v2.MessageNack.MessageMetadataEntryR\x0fmessageMetadata\x1aB\n" +
	"\x14MessageMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x93\x01\n" +
	"\fcom.queue.v2B\x10MessageNackProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_message_nack_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queuepb_v2_message_nack_proto_goTypes = []any{
	(*MessageNack)(nil),       // 0: queue.v2.MessageNack
	nil,                       // 1: queue.v2.MessageNack.MessageMetadataEntry
	(v2.NackErrorCategory)(0), // 2: common.v2.NackErrorCategory
}
var file_queuepb_v2_message_nack_proto_depIdxs = []int32{
	2, // 0: queue.v2.MessageNack.error_category:type_name -> common.v2.NackErrorCategory
	1, // 1: queue.v2.MessageNack.message_metadata:type_name -> queue.v2.MessageNack.MessageMetadataEntry
...
func init() { file_queuepb_v2_message_nack_proto_init() }
func file_queuepb_v2_message_nack_proto_init() {
	if File_queuepb_v2_message_nack_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_message_nack_proto_rawDesc), len(file_queuepb_v2_message_nack_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_message_nack_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_message_nack_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_message_nack_proto_msgTypes,
	}.Build()
	File_queuepb_v2_message_nack_proto = out.File
	file_queuepb_v2_message_nack_proto_goTypes = nil
	file_queuepb_v2_message_nack_proto_depIdxs = nil
}
