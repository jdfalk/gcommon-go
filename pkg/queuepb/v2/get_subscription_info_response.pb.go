...
// 	protoc        (unknown)
// source: queuepb/v2/get_subscription_info_response.proto
...
func (x *GetSubscriptionInfoResponse) Reset() {
	*x = GetSubscriptionInfoResponse{}
	mi := &file_queuepb_v2_get_subscription_info_response_proto_msgTypes[0]
...
var File_queuepb_v2_get_subscription_info_response_proto protoreflect.FileDescriptor

const file_queuepb_v2_get_subscription_info_response_proto_rawDesc = "" +
	"\n" +
	"/queuepb/v2/get_subscription_info_response.proto\x12\bqueue.v2\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xd7\x04\n" +
	...
	"\x10consumption_rate\x18\r \x01(\x01R\x0fconsumptionRateB\xa3\x01\n" +
	"\fcom.queue.v2B GetSubscriptionInfoResponseProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_queuepb_v2_get_subscription_info_response_proto_goTypes = []any{
	(*GetSubscriptionInfoResponse)(nil), // 0: queue.v2.GetSubscriptionInfoResponse
	(*timestamppb.Timestamp)(nil),       // 1: google.protobuf.Timestamp
}
var file_queuepb_v2_get_subscription_info_response_proto_depIdxs = []int32{
	1, // 0: queue.v2.GetSubscriptionInfoResponse.created_at:type_name -> google.protobuf.Timestamp
	1, // 1: queue.v2.GetSubscriptionInfoResponse.last_activity:type_name -> google.protobuf.Timestamp
...
func init() { file_queuepb_v2_get_subscription_info_response_proto_init() }
func file_queuepb_v2_get_subscription_info_response_proto_init() {
	if File_queuepb_v2_get_subscription_info_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_get_subscription_info_response_proto_rawDesc), len(file_queuepb_v2_get_subscription_info_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_get_subscription_info_response_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_get_subscription_info_response_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_get_subscription_info_response_proto_msgTypes,
	}.Build()
	File_queuepb_v2_get_subscription_info_response_proto = out.File
	file_queuepb_v2_get_subscription_info_response_proto_goTypes = nil
	file_queuepb_v2_get_subscription_info_response_proto_depIdxs = nil
}
