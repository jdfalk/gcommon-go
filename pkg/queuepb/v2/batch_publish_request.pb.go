...
// 	protoc        (unknown)
// source: queuepb/v2/batch_publish_request.proto
...
func (x *BatchPublishRequest) Reset() {
	*x = BatchPublishRequest{}
	mi := &file_queuepb_v2_batch_publish_request_proto_msgTypes[0]
...
func (x *BatchPublishRequest) GetMetadata() *v2.RequestMetadata {
	if x != nil {
...
func (x *BatchPublishRequest) SetMetadata(v *v2.RequestMetadata) {
...
var File_queuepb_v2_batch_publish_request_proto protoreflect.FileDescriptor

const file_queuepb_v2_batch_publish_request_proto_rawDesc = "" +
	"\n" +
	"&queuepb/v2/batch_publish_request.proto\x12\bqueue.v2\x1a\"commonpb/v2/request_metadata.proto\x1a\x1equeuepb/v2/queue_message.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd1\x02\n" +
	"\x13BatchPublishRequest\x12(\n" +
	"\n" +
	"queue_name\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\tqueueName\x122\n" +
	"\bmessages\x18\x02 \x03(\v2\x16.queue.v2.QueueMessageR\bmessages\x12'\n" +
	...
	"maxRetries\x12\x19\n" +
	"\bbatch_id\x18\b \x01(\tR\abatchIdB\x9b\x01\n" +
	"\fcom.queue.v2B\x18BatchPublishRequestProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_batch_publish_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_batch_publish_request_proto_goTypes = []any{
	(*BatchPublishRequest)(nil), // 0: queue.v2.BatchPublishRequest
	(*QueueMessage)(nil),        // 1: queue.v2.QueueMessage
	(*v2.RequestMetadata)(nil),  // 2: common.v2.RequestMetadata
}
var file_queuepb_v2_batch_publish_request_proto_depIdxs = []int32{
	1, // 0: queue.v2.BatchPublishRequest.messages:type_name -> queue.v2.QueueMessage
	2, // 1: queue.v2.BatchPublishRequest.metadata:type_name -> common.v2.RequestMetadata
...
func init() { file_queuepb_v2_batch_publish_request_proto_init() }
func file_queuepb_v2_batch_publish_request_proto_init() {
	if File_queuepb_v2_batch_publish_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_batch_publish_request_proto_rawDesc), len(file_queuepb_v2_batch_publish_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_batch_publish_request_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_batch_publish_request_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_batch_publish_request_proto_msgTypes,
	}.Build()
	File_queuepb_v2_batch_publish_request_proto = out.File
	file_queuepb_v2_batch_publish_request_proto_goTypes = nil
	file_queuepb_v2_batch_publish_request_proto_depIdxs = nil
}
