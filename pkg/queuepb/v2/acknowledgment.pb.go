...
// 	protoc        (unknown)
// source: queuepb/v2/acknowledgment.proto
...
type Acknowledgment struct {
	...
	xxx_hidden_AckType              v2.AckType             `protobuf:"varint,6,opt,name=ack_type,json=ackType,enum=common.v2.AckType"`
...
func (x *Acknowledgment) Reset() {
	*x = Acknowledgment{}
	mi := &file_queuepb_v2_acknowledgment_proto_msgTypes[0]
...
func (x *Acknowledgment) GetAckType() v2.AckType {
	if x != nil {
...
func (x *Acknowledgment) SetAckType(v v2.AckType) {
...
func (x *Acknowledgment) ClearAckType() {
	...
	x.xxx_hidden_AckType = v2.AckType_ACK_TYPE_UNSPECIFIED
}
...
var File_queuepb_v2_acknowledgment_proto protoreflect.FileDescriptor

const file_queuepb_v2_acknowledgment_proto_rawDesc = "" +
	"\n" +
	"\x1fqueuepb/v2/acknowledgment.proto\x12\bqueue.v2\x1a\x1acommonpb/v2/ack_type.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa1\x03\n" +
	...
	"\back_type\x18\x06 \x01(\x0e2\x12.common.v2.AckTypeR\aackType\x12?\n" +
	...
	" \x01(\x05R\n" +
	"retryCountB\x96\x01\n" +
	"\fcom.queue.v2B\x13AcknowledgmentProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_acknowledgment_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_acknowledgment_proto_goTypes = []any{
	(*Acknowledgment)(nil),        // 0: queue.v2.Acknowledgment
	(v2.AckType)(0),               // 1: common.v2.AckType
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_queuepb_v2_acknowledgment_proto_depIdxs = []int32{
	1, // 0: queue.v2.Acknowledgment.ack_type:type_name -> common.v2.AckType
	2, // 1: queue.v2.Acknowledgment.ack_timestamp:type_name -> google.protobuf.Timestamp
...
func init() { file_queuepb_v2_acknowledgment_proto_init() }
func file_queuepb_v2_acknowledgment_proto_init() {
	if File_queuepb_v2_acknowledgment_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_acknowledgment_proto_rawDesc), len(file_queuepb_v2_acknowledgment_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_acknowledgment_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_acknowledgment_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_acknowledgment_proto_msgTypes,
	}.Build()
	File_queuepb_v2_acknowledgment_proto = out.File
	file_queuepb_v2_acknowledgment_proto_goTypes = nil
	file_queuepb_v2_acknowledgment_proto_depIdxs = nil
}
