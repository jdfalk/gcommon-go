...
// 	protoc        (unknown)
// source: queuepb/v2/stream_messages_request.proto
...
type StreamMessagesRequest struct {
	...
	xxx_hidden_AckLevel        v2.AckLevel            `protobuf:"varint,7,opt,name=ack_level,json=ackLevel,enum=common.v2.AckLevel"`
...
func (x *StreamMessagesRequest) Reset() {
	*x = StreamMessagesRequest{}
	mi := &file_queuepb_v2_stream_messages_request_proto_msgTypes[0]
...
func (x *StreamMessagesRequest) GetAckLevel() v2.AckLevel {
	if x != nil {
...
func (x *StreamMessagesRequest) SetAckLevel(v v2.AckLevel) {
...
var File_queuepb_v2_stream_messages_request_proto protoreflect.FileDescriptor

const file_queuepb_v2_stream_messages_request_proto_rawDesc = "" +
	"\n" +
	"(queuepb/v2/stream_messages_request.proto\x12\bqueue.v2\x1a\x1bcommonpb/v2/ack_level.proto\x1a\x1fqueuepb/v2/message_filter.proto\x1a\x1equeuepb/v2/offset_config.proto\x1a\x1equeuepb/v2/stream_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa6\x05\n" +
	"\x15StreamMessagesRequest\x12\x1d\n" +
	"\x05topic\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x05topic\x123\n" +
	"\x11consumer_group_id\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x0fconsumerGroupId\x12(\n" +
	"\vconsumer_id\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\n" +
	"consumerId\x12;\n" +
	"\roffset_config\x18\x04 \x01(\v2\x16.queue.v2.OffsetConfigR\foffsetConfig\x12*\n" +
	"\fmax_messages\x18\x05 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\vmaxMessages\x123\n" +
	"\x11stream_timeout_ms\x18\x06 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00R\x0fstreamTimeoutMs\x120\n" +
	"\tack_level\x18\a \x01(\x0e2\x13.common.v2.AckLevelR\backLevel\x12&\n" +
	"\n" +
	"batch_size\x18\b \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\tbatchSize\x12/\n" +
	"\x06filter\x18\t \x01(\v2\x17.queue.v2.MessageFilterR\x06filter\x12)\n" +
	...
	"\rstream_config\x18\x0e \x01(\v2\x16.queue.v2.StreamConfigR\fstreamConfigB\x9d\x01\n" +
	"\fcom.queue.v2B\x1aStreamMessagesRequestProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_stream_messages_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_stream_messages_request_proto_goTypes = []any{
	(*StreamMessagesRequest)(nil), // 0: queue.v2.StreamMessagesRequest
	(*OffsetConfig)(nil),          // 1: queue.v2.OffsetConfig
	(v2.AckLevel)(0),              // 2: common.v2.AckLevel
	(*MessageFilter)(nil),         // 3: queue.v2.MessageFilter
	(*StreamConfig)(nil),          // 4: queue.v2.StreamConfig
}
var file_queuepb_v2_stream_messages_request_proto_depIdxs = []int32{
	1, // 0: queue.v2.StreamMessagesRequest.offset_config:type_name -> queue.v2.OffsetConfig
	2, // 1: queue.v2.StreamMessagesRequest.ack_level:type_name -> common.v2.AckLevel
	3, // 2: queue.v2.StreamMessagesRequest.filter:type_name -> queue.v2.MessageFilter
	4, // 3: queue.v2.StreamMessagesRequest.stream_config:type_name -> queue.v2.StreamConfig
...
func init() { file_queuepb_v2_stream_messages_request_proto_init() }
func file_queuepb_v2_stream_messages_request_proto_init() {
	if File_queuepb_v2_stream_messages_request_proto != nil {
		return
	}
	file_queuepb_v2_message_filter_proto_init()
	file_queuepb_v2_offset_config_proto_init()
	file_queuepb_v2_stream_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_stream_messages_request_proto_rawDesc), len(file_queuepb_v2_stream_messages_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_stream_messages_request_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_stream_messages_request_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_stream_messages_request_proto_msgTypes,
	}.Build()
	File_queuepb_v2_stream_messages_request_proto = out.File
	file_queuepb_v2_stream_messages_request_proto_goTypes = nil
	file_queuepb_v2_stream_messages_request_proto_depIdxs = nil
}
