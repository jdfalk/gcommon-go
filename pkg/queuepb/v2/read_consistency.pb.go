...
// 	protoc        (unknown)
// source: queuepb/v2/read_consistency.proto
...
type ReadConsistency struct {
	...
	xxx_hidden_Level          v2.ReadLevel           `protobuf:"varint,1,opt,name=level,enum=common.v2.ReadLevel"`
...
func (x *ReadConsistency) Reset() {
	*x = ReadConsistency{}
	mi := &file_queuepb_v2_read_consistency_proto_msgTypes[0]
...
func (x *ReadConsistency) GetLevel() v2.ReadLevel {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 0) {
			return x.xxx_hidden_Level
		}
	}
	return v2.ReadLevel(0)
}
...
func (x *ReadConsistency) SetLevel(v v2.ReadLevel) {
...
func (x *ReadConsistency) ClearLevel() {
	...
	x.xxx_hidden_Level = v2.ReadLevel_READ_LEVEL_UNSPECIFIED
}
...
var File_queuepb_v2_read_consistency_proto protoreflect.FileDescriptor

const file_queuepb_v2_read_consistency_proto_rawDesc = "" +
	"\n" +
	"!queuepb/v2/read_consistency.proto\x12\bqueue.v2\x1a\x1ccommonpb/v2/read_level.proto\x1a\"queuepb/v2/read_retry_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa9\x02\n" +
	"\x0fReadConsistency\x12*\n" +
	"\x05level\x18\x01 \x01(\x0e2\x14.common.v2.ReadLevelR\x05level\x121\n" +
	"\x10max_staleness_ms\x18\x02 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x0emaxStalenessMs\x12(\n" +
	...
	"\fretry_config\x18\x06 \x01(\v2\x19.queue.v2.ReadRetryConfigR\vretryConfigB\x97\x01\n" +
	"\fcom.queue.v2B\x14ReadConsistencyProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_read_consistency_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_read_consistency_proto_goTypes = []any{
	(*ReadConsistency)(nil), // 0: queue.v2.ReadConsistency
	(v2.ReadLevel)(0),       // 1: common.v2.ReadLevel
	(*ReadRetryConfig)(nil), // 2: queue.v2.ReadRetryConfig
}
var file_queuepb_v2_read_consistency_proto_depIdxs = []int32{
	1, // 0: queue.v2.ReadConsistency.level:type_name -> common.v2.ReadLevel
	2, // 1: queue.v2.ReadConsistency.retry_config:type_name -> queue.v2.ReadRetryConfig
...
func init() { file_queuepb_v2_read_consistency_proto_init() }
func file_queuepb_v2_read_consistency_proto_init() {
	if File_queuepb_v2_read_consistency_proto != nil {
		return
	}
	file_queuepb_v2_read_retry_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_read_consistency_proto_rawDesc), len(file_queuepb_v2_read_consistency_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_read_consistency_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_read_consistency_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_read_consistency_proto_msgTypes,
	}.Build()
	File_queuepb_v2_read_consistency_proto = out.File
	file_queuepb_v2_read_consistency_proto_goTypes = nil
	file_queuepb_v2_read_consistency_proto_depIdxs = nil
}
