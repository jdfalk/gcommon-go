...
// 	protoc        (unknown)
// source: queuepb/v2/publish_config.proto
...
type PublishConfig struct {
	...
	xxx_hidden_RetryConfig        *v2.CommonRetryPolicy  `protobuf:"bytes,6,opt,name=retry_config,json=retryConfig"`
...
func (x *PublishConfig) Reset() {
	*x = PublishConfig{}
	mi := &file_queuepb_v2_publish_config_proto_msgTypes[0]
...
func (x *PublishConfig) GetRetryConfig() *v2.CommonRetryPolicy {
	if x != nil {
...
func (x *PublishConfig) SetRetryConfig(v *v2.CommonRetryPolicy) {
...
type PublishConfig_builder struct {
	...
	RetryConfig *v2.CommonRetryPolicy
...
var File_queuepb_v2_publish_config_proto protoreflect.FileDescriptor

const file_queuepb_v2_publish_config_proto_rawDesc = "" +
	"\n" +
	"\x1fqueuepb/v2/publish_config.proto\x12\bqueue.v2\x1a\x1ecommonpb/v2/retry_policy.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe0\x02\n" +
	"\rPublishConfig\x12 \n" +
	"\fwait_for_ack\x18\x01 \x01(\bR\n" +
	"waitForAck\x12-\n" +
	"\x0eack_timeout_ms\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00R\fackTimeoutMs\x12/\n" +
	...
	"\fretry_config\x18\x06 \x01(\v2\x1c.common.v2.CommonRetryPolicyR\vretryConfig\x124\n" +
	"\x11persistence_level\x18\a \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x10persistenceLevelB\x95\x01\n" +
	"\fcom.queue.v2B\x12PublishConfigProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_publish_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_publish_config_proto_goTypes = []any{
	(*PublishConfig)(nil),        // 0: queue.v2.PublishConfig
	(*v2.CommonRetryPolicy)(nil), // 1: common.v2.CommonRetryPolicy
}
var file_queuepb_v2_publish_config_proto_depIdxs = []int32{
	1, // 0: queue.v2.PublishConfig.retry_config:type_name -> common.v2.CommonRetryPolicy
...
func init() { file_queuepb_v2_publish_config_proto_init() }
func file_queuepb_v2_publish_config_proto_init() {
	if File_queuepb_v2_publish_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_publish_config_proto_rawDesc), len(file_queuepb_v2_publish_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_publish_config_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_publish_config_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_publish_config_proto_msgTypes,
	}.Build()
	File_queuepb_v2_publish_config_proto = out.File
	file_queuepb_v2_publish_config_proto_goTypes = nil
	file_queuepb_v2_publish_config_proto_depIdxs = nil
}
