...
// 	protoc        (unknown)
// source: queuepb/v2/stream_config.proto
...
type StreamConfig struct {
	...
	xxx_hidden_RestartPolicy          v2.StreamRestartPolicy `protobuf:"varint,9,opt,name=restart_policy,json=restartPolicy,enum=common.v2.StreamRestartPolicy"`
...
func (x *StreamConfig) Reset() {
	*x = StreamConfig{}
	mi := &file_queuepb_v2_stream_config_proto_msgTypes[0]
...
func (x *StreamConfig) GetRestartPolicy() v2.StreamRestartPolicy {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 8) {
			return x.xxx_hidden_RestartPolicy
		}
	}
	return v2.StreamRestartPolicy(0)
}
...
func (x *StreamConfig) SetRestartPolicy(v v2.StreamRestartPolicy) {
...
func (x *StreamConfig) ClearRestartPolicy() {
	...
	x.xxx_hidden_RestartPolicy = v2.StreamRestartPolicy_STREAM_RESTART_POLICY_UNSPECIFIED
}
...
type StreamConfig_builder struct {
	...
	RestartPolicy *v2.StreamRestartPolicy
}
...
var File_queuepb_v2_stream_config_proto protoreflect.FileDescriptor

const file_queuepb_v2_stream_config_proto_rawDesc = "" +
	"\n" +
	"\x1equeuepb/v2/stream_config.proto\x12\bqueue.v2\x1a'commonpb/v2/stream_restart_policy.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x83\x04\n" +
	"\fStreamConfig\x12(\n" +
	...
	"\x0erestart_policy\x18\t \x01(\x0e2\x1e.common.v2.StreamRestartPolicyR\rrestartPolicyB\x94\x01\n" +
	"\fcom.queue.v2B\x11StreamConfigProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_stream_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_stream_config_proto_goTypes = []any{
	(*StreamConfig)(nil),        // 0: queue.v2.StreamConfig
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
	(v2.StreamRestartPolicy)(0), // 2: common.v2.StreamRestartPolicy
}
var file_queuepb_v2_stream_config_proto_depIdxs = []int32{
	1, // 0: queue.v2.StreamConfig.read_timeout:type_name -> google.protobuf.Duration
	1, // 1: queue.v2.StreamConfig.ack_deadline:type_name -> google.protobuf.Duration
	2, // 2: queue.v2.StreamConfig.restart_policy:type_name -> common.v2.StreamRestartPolicy
...
func init() { file_queuepb_v2_stream_config_proto_init() }
func file_queuepb_v2_stream_config_proto_init() {
	if File_queuepb_v2_stream_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_stream_config_proto_rawDesc), len(file_queuepb_v2_stream_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_stream_config_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_stream_config_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_stream_config_proto_msgTypes,
	}.Build()
	File_queuepb_v2_stream_config_proto = out.File
	file_queuepb_v2_stream_config_proto_goTypes = nil
	file_queuepb_v2_stream_config_proto_depIdxs = nil
}
