...
// 	protoc        (unknown)
// source: queuepb/v2/subscription_configuration.proto
...
type SubscriptionConfiguration struct {
	...
	xxx_hidden_AckLevel             v2.AckLevel            `protobuf:"varint,1,opt,name=ack_level,json=ackLevel,enum=common.v2.AckLevel"`
	xxx_hidden_DeliveryMode         v2.DeliveryMode        `protobuf:"varint,2,opt,name=delivery_mode,json=deliveryMode,enum=common.v2.DeliveryMode"`
...
func (x *SubscriptionConfiguration) Reset() {
	*x = SubscriptionConfiguration{}
	mi := &file_queuepb_v2_subscription_configuration_proto_msgTypes[0]
...
func (x *SubscriptionConfiguration) GetAckLevel() v2.AckLevel {
	if x != nil {
...
func (x *SubscriptionConfiguration) GetDeliveryMode() v2.DeliveryMode {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			return x.xxx_hidden_DeliveryMode
		}
	}
	return v2.DeliveryMode(0)
}
...
func (x *SubscriptionConfiguration) SetAckLevel(v v2.AckLevel) {
	x.xxx_hidden_AckLevel = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 10)
}

func (x *SubscriptionConfiguration) SetDeliveryMode(v v2.DeliveryMode) {
...
func (x *SubscriptionConfiguration) ClearDeliveryMode() {
	...
	x.xxx_hidden_DeliveryMode = v2.DeliveryMode_DELIVERY_MODE_UNSPECIFIED
}
...
var File_queuepb_v2_subscription_configuration_proto protoreflect.FileDescriptor

const file_queuepb_v2_subscription_configuration_proto_rawDesc = "" +
	"\n" +
	"+queuepb/v2/subscription_configuration.proto\x12\bqueue.v2\x1a\x1bcommonpb/v2/ack_level.proto\x1a\x1fcommonpb/v2/delivery_mode.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa3\x04\n" +
	"\x19SubscriptionConfiguration\x120\n" +
	"\tack_level\x18\x01 \x01(\x0e2\x13.common.v2.AckLevelR\backLevel\x12<\n" +
	"\rdelivery_mode\x18\x02 \x01(\x0e2\x17.common.v2.DeliveryModeR\fdeliveryMode\x12<\n" +
	...
	" \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x14maxMessageAgeSecondsB\xa1\x01\n" +
	"\fcom.queue.v2B\x1eSubscriptionConfigurationProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_subscription_configuration_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_subscription_configuration_proto_goTypes = []any{
	(*SubscriptionConfiguration)(nil), // 0: queue.v2.SubscriptionConfiguration
	(v2.AckLevel)(0),                  // 1: common.v2.AckLevel
	(v2.DeliveryMode)(0),              // 2: common.v2.DeliveryMode
}
var file_queuepb_v2_subscription_configuration_proto_depIdxs = []int32{
	1, // 0: queue.v2.SubscriptionConfiguration.ack_level:type_name -> common.v2.AckLevel
	2, // 1: queue.v2.SubscriptionConfiguration.delivery_mode:type_name -> common.v2.DeliveryMode
...
func init() { file_queuepb_v2_subscription_configuration_proto_init() }
func file_queuepb_v2_subscription_configuration_proto_init() {
	if File_queuepb_v2_subscription_configuration_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_subscription_configuration_proto_rawDesc), len(file_queuepb_v2_subscription_configuration_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_subscription_configuration_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_subscription_configuration_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_subscription_configuration_proto_msgTypes,
	}.Build()
	File_queuepb_v2_subscription_configuration_proto = out.File
	file_queuepb_v2_subscription_configuration_proto_goTypes = nil
	file_queuepb_v2_subscription_configuration_proto_depIdxs = nil
}
