...
// 	protoc        (unknown)
// source: queuepb/v2/offset_config.proto
...
type OffsetConfig struct {
	...
	xxx_hidden_OffsetType      v2.OffsetType          `protobuf:"varint,1,opt,name=offset_type,json=offsetType,enum=common.v2.OffsetType"`
...
func (x *OffsetConfig) Reset() {
	*x = OffsetConfig{}
	mi := &file_queuepb_v2_offset_config_proto_msgTypes[0]
...
func (x *OffsetConfig) GetOffsetType() v2.OffsetType {
	if x != nil {
...
func (x *OffsetConfig) SetOffsetType(v v2.OffsetType) {
...
var File_queuepb_v2_offset_config_proto protoreflect.FileDescriptor

const file_queuepb_v2_offset_config_proto_rawDesc = "" +
	"\n" +
	"\x1equeuepb/v2/offset_config.proto\x12\bqueue.v2\x1a\x1dcommonpb/v2/offset_type.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xe4\x01\n" +
	"\fOffsetConfig\x126\n" +
	"\voffset_type\x18\x01 \x01(\x0e2\x15.common.v2.OffsetTypeR\n" +
	"offsetType\x12*\n" +
	...
	"\x12reset_on_not_found\x18\x04 \x01(\bR\x0fresetOnNotFoundB\x94\x01\n" +
	"\fcom.queue.v2B\x11OffsetConfigProtoP\x01Z(github.com/jdfalk/gcommon/pkg/queuepb/v2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v2_offset_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v2_offset_config_proto_goTypes = []any{
	(*OffsetConfig)(nil),          // 0: queue.v2.OffsetConfig
	(v2.OffsetType)(0),            // 1: common.v2.OffsetType
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_queuepb_v2_offset_config_proto_depIdxs = []int32{
	1, // 0: queue.v2.OffsetConfig.offset_type:type_name -> common.v2.OffsetType
	2, // 1: queue.v2.OffsetConfig.start_timestamp:type_name -> google.protobuf.Timestamp
...
func init() { file_queuepb_v2_offset_config_proto_init() }
func file_queuepb_v2_offset_config_proto_init() {
	if File_queuepb_v2_offset_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v2_offset_config_proto_rawDesc), len(file_queuepb_v2_offset_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v2_offset_config_proto_goTypes,
		DependencyIndexes: file_queuepb_v2_offset_config_proto_depIdxs,
		MessageInfos:      file_queuepb_v2_offset_config_proto_msgTypes,
	}.Build()
	File_queuepb_v2_offset_config_proto = out.File
	file_queuepb_v2_offset_config_proto_goTypes = nil
	file_queuepb_v2_offset_config_proto_depIdxs = nil
}
