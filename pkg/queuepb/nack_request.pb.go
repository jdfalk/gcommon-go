...
// 	protoc        (unknown)
// source: queuepb/v1/nack_request.proto
...
type NackRequest struct {
	...
	xxx_hidden_Metadata            *commonpb.RequestMetadata `protobuf:"bytes,100,opt,name=metadata"`
...
func (x *NackRequest) Reset() {
	*x = NackRequest{}
	mi := &file_queuepb_v1_nack_request_proto_msgTypes[0]
...
func (x *NackRequest) GetMetadata() *commonpb.RequestMetadata {
	if x != nil {
...
func (x *NackRequest) SetMetadata(v *commonpb.RequestMetadata) {
...
var File_queuepb_v1_nack_request_proto protoreflect.FileDescriptor

const file_queuepb_v1_nack_request_proto_rawDesc = "" +
	"\n" +
	"\x1dqueuepb/v1/nack_request.proto\x12\bqueue.v1\x1a\"commonpb/v1/request_metadata.proto\x1a\x1bqueuepb/v1/nack_error.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb8\x02\n" +
	"\vNackRequest\x12$\n" +
	"\tack_token\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\backToken\x12\x18\n" +
	"\arequeue\x18\x02 \x01(\bR\arequeue\x12\x1f\n" +
	"\x06reason\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06reason\x12)\n" +
	"\x05error\x18\x04 \x01(\v2\x13.queue.v1.NackErrorR\x05error\x12;\n" +
	"\x15requeue_delay_seconds\x18\x05 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x13requeueDelaySeconds\x12(\n" +
	"\vmax_retries\x18\x06 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\n" +
	"maxRetries\x126\n" +
	"\bmetadata\x18d \x01(\v2\x1a.common.v1.RequestMetadataR\bmetadataB\x90\x01\n" +
	"\fcom.queue.v1B\x10NackRequestProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_nack_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_nack_request_proto_goTypes = []any{
	(*NackRequest)(nil),              // 0: queue.v1.NackRequest
	(*NackError)(nil),                // 1: queue.v1.NackError
	(*commonpb.RequestMetadata)(nil), // 2: common.v1.RequestMetadata
}
var file_queuepb_v1_nack_request_proto_depIdxs = []int32{
	1, // 0: queue.v1.NackRequest.error:type_name -> queue.v1.NackError
	2, // 1: queue.v1.NackRequest.metadata:type_name -> common.v1.RequestMetadata
...
func init() { file_queuepb_v1_nack_request_proto_init() }
func file_queuepb_v1_nack_request_proto_init() {
	if File_queuepb_v1_nack_request_proto != nil {
		return
	}
	file_queuepb_v1_nack_error_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_nack_request_proto_rawDesc), len(file_queuepb_v1_nack_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_nack_request_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_nack_request_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_nack_request_proto_msgTypes,
	}.Build()
	File_queuepb_v1_nack_request_proto = out.File
	file_queuepb_v1_nack_request_proto_goTypes = nil
	file_queuepb_v1_nack_request_proto_depIdxs = nil
}
