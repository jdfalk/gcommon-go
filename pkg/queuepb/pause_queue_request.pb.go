...
// 	protoc        (unknown)
// source: queuepb/v1/pause_queue_request.proto
...
func (x *PauseQueueRequest) Reset() {
	*x = PauseQueueRequest{}
	mi := &file_queuepb_v1_pause_queue_request_proto_msgTypes[0]
...
func (x *PauseQueueRequest) GetMetadata() *commonpb.RequestMetadata {
	if x != nil {
...
func (x *PauseQueueRequest) SetMetadata(v *commonpb.RequestMetadata) {
...
var File_queuepb_v1_pause_queue_request_proto protoreflect.FileDescriptor

const file_queuepb_v1_pause_queue_request_proto_rawDesc = "" +
	"\n" +
	"$queuepb/v1/pause_queue_request.proto\x12\bqueue.v1\x1a\"commonpb/v1/request_metadata.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xed\x01\n" +
	...
	"\rpartition_ids\x18\x06 \x03(\x05R\fpartitionIdsB\x96\x01\n" +
	"\fcom.queue.v1B\x16PauseQueueRequestProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_pause_queue_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_pause_queue_request_proto_goTypes = []any{
	(*PauseQueueRequest)(nil),        // 0: queue.v1.PauseQueueRequest
	(*commonpb.RequestMetadata)(nil), // 1: common.v1.RequestMetadata
}
var file_queuepb_v1_pause_queue_request_proto_depIdxs = []int32{
...
func init() { file_queuepb_v1_pause_queue_request_proto_init() }
func file_queuepb_v1_pause_queue_request_proto_init() {
	if File_queuepb_v1_pause_queue_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_pause_queue_request_proto_rawDesc), len(file_queuepb_v1_pause_queue_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_pause_queue_request_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_pause_queue_request_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_pause_queue_request_proto_msgTypes,
	}.Build()
	File_queuepb_v1_pause_queue_request_proto = out.File
	file_queuepb_v1_pause_queue_request_proto_goTypes = nil
	file_queuepb_v1_pause_queue_request_proto_depIdxs = nil
}
