...
// 	protoc        (unknown)
// source: queuepb/v1/get_offset_request.proto
...
type GetOffsetRequest struct {
	...
	xxx_hidden_OffsetType    commonpb.OffsetType       `protobuf:"varint,5,opt,name=offset_type,json=offsetType,enum=common.v1.OffsetType"`
...
func (x *GetOffsetRequest) Reset() {
	*x = GetOffsetRequest{}
	mi := &file_queuepb_v1_get_offset_request_proto_msgTypes[0]
...
func (x *GetOffsetRequest) GetOffsetType() commonpb.OffsetType {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 4) {
			return x.xxx_hidden_OffsetType
		}
	}
	return commonpb.OffsetType(0)
}

func (x *GetOffsetRequest) GetMetadata() *commonpb.RequestMetadata {
	if x != nil {
...
func (x *GetOffsetRequest) SetOffsetType(v commonpb.OffsetType) {
	x.xxx_hidden_OffsetType = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 4, 6)
}

func (x *GetOffsetRequest) SetMetadata(v *commonpb.RequestMetadata) {
...
func (x *GetOffsetRequest) ClearOffsetType() {
	...
	x.xxx_hidden_OffsetType = commonpb.OffsetType_OFFSET_TYPE_UNSPECIFIED
}
...
type GetOffsetRequest_builder struct {
	...
	OffsetType *commonpb.OffsetType
...
var File_queuepb_v1_get_offset_request_proto protoreflect.FileDescriptor

const file_queuepb_v1_get_offset_request_proto_rawDesc = "" +
	"\n" +
	"#queuepb/v1/get_offset_request.proto\x12\bqueue.v1\x1a\x1dcommonpb/v1/offset_type.proto\x1a\"commonpb/v1/request_metadata.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x97\x02\n" +
	...
	"offsetType\x126\n" +
	"\bmetadata\x18\x06 \x01(\v2\x1a.common.v1.RequestMetadataR\bmetadataB\x95\x01\n" +
	"\fcom.queue.v1B\x15GetOffsetRequestProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_get_offset_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_queuepb_v1_get_offset_request_proto_goTypes = []any{
	(*GetOffsetRequest)(nil),         // 0: queue.v1.GetOffsetRequest
	(commonpb.OffsetType)(0),         // 1: common.v1.OffsetType
	(*commonpb.RequestMetadata)(nil), // 2: common.v1.RequestMetadata
}
var file_queuepb_v1_get_offset_request_proto_depIdxs = []int32{
	1, // 0: queue.v1.GetOffsetRequest.offset_type:type_name -> common.v1.OffsetType
	2, // 1: queue.v1.GetOffsetRequest.metadata:type_name -> common.v1.RequestMetadata
...
func init() { file_queuepb_v1_get_offset_request_proto_init() }
func file_queuepb_v1_get_offset_request_proto_init() {
	if File_queuepb_v1_get_offset_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_get_offset_request_proto_rawDesc), len(file_queuepb_v1_get_offset_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_get_offset_request_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_get_offset_request_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_get_offset_request_proto_msgTypes,
	}.Build()
	File_queuepb_v1_get_offset_request_proto = out.File
	file_queuepb_v1_get_offset_request_proto_goTypes = nil
	file_queuepb_v1_get_offset_request_proto_depIdxs = nil
}
