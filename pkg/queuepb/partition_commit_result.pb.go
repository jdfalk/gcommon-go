...
// 	protoc        (unknown)
// source: queuepb/v1/partition_commit_result.proto
...
func (x *PartitionCommitResult) Reset() {
	*x = PartitionCommitResult{}
	mi := &file_queuepb_v1_partition_commit_result_proto_msgTypes[0]
...
var File_queuepb_v1_partition_commit_result_proto protoreflect.FileDescriptor

const file_queuepb_v1_partition_commit_result_proto_rawDesc = "" +
	"\n" +
	"(queuepb/v1/partition_commit_result.proto\x12\bqueue.v1\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x8d\x04\n" +
	...
	"\x12partition_metadata\x18\b \x03(\v26.queue.v1.PartitionCommitResult.PartitionMetadataEntryR\x11partitionMetadata\x1aD\n" +
	"\x16PartitionMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x9a\x01\n" +
	"\fcom.queue.v1B\x1aPartitionCommitResultProtoP\x01Z%github.com/jdfalk/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_queuepb_v1_partition_commit_result_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_queuepb_v1_partition_commit_result_proto_goTypes = []any{
	(*PartitionCommitResult)(nil), // 0: queue.v1.PartitionCommitResult
	nil,                           // 1: queue.v1.PartitionCommitResult.PartitionMetadataEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_queuepb_v1_partition_commit_result_proto_depIdxs = []int32{
	2, // 0: queue.v1.PartitionCommitResult.commit_timestamp:type_name -> google.protobuf.Timestamp
	1, // 1: queue.v1.PartitionCommitResult.partition_metadata:type_name -> queue.v1.PartitionCommitResult.PartitionMetadataEntry
...
func init() { file_queuepb_v1_partition_commit_result_proto_init() }
func file_queuepb_v1_partition_commit_result_proto_init() {
	if File_queuepb_v1_partition_commit_result_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_partition_commit_result_proto_rawDesc), len(file_queuepb_v1_partition_commit_result_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_partition_commit_result_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_partition_commit_result_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_partition_commit_result_proto_msgTypes,
	}.Build()
	File_queuepb_v1_partition_commit_result_proto = out.File
	file_queuepb_v1_partition_commit_result_proto_goTypes = nil
	file_queuepb_v1_partition_commit_result_proto_depIdxs = nil
}
