...
// 	protoc        (unknown)
// source: queuepb/v1/stream_messages_request.proto
...
type StreamMessagesRequest struct {
	...
	xxx_hidden_AckLevel        commonpb.AckLevel      `protobuf:"varint,7,opt,name=ack_level,json=ackLevel,enum=common.v1.AckLevel"`
...
func (x *StreamMessagesRequest) Reset() {
	*x = StreamMessagesRequest{}
	mi := &file_queuepb_v1_stream_messages_request_proto_msgTypes[0]
...
func (x *StreamMessagesRequest) GetAckLevel() commonpb.AckLevel {
	if x != nil {
...
func (x *StreamMessagesRequest) SetAckLevel(v commonpb.AckLevel) {
...
var File_queuepb_v1_stream_messages_request_proto protoreflect.FileDescriptor

const file_queuepb_v1_stream_messages_request_proto_rawDesc = "" +
	"\n" +
	"(queuepb/v1/stream_messages_request.proto\x12\bqueue.v1\x1a\x1bcommonpb/v1/ack_level.proto\x1a\x1fqueuepb/v1/message_filter.proto\x1a\x1equeuepb/v1/offset_config.proto\x1a\x1equeuepb/v1/stream_config.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa6\x05\n" +
	...
	"consumerId\x12;\n" +
	"\roffset_config\x18\x04 \x01(\v2\x16.queue.v1.OffsetConfigR\foffsetConfig\x12*\n" +
	...
	"\tack_level\x18\a \x01(\x0e2\x13.common.v1.AckLevelR\backLevel\x12&\n" +
	"\n" +
	"batch_size\x18\b \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\tbatchSize\x12/\n" +
	"\x06filter\x18\t \x01(\v2\x17.queue.v1.MessageFilterR\x06filter\x12)\n" +
...
var file_queuepb_v1_stream_messages_request_proto_depIdxs = []int32{
	1, // 0: queue.v1.StreamMessagesRequest.offset_config:type_name -> queue.v1.OffsetConfig
	2, // 1: queue.v1.StreamMessagesRequest.ack_level:type_name -> common.v1.AckLevel
	3, // 2: queue.v1.StreamMessagesRequest.filter:type_name -> queue.v1.MessageFilter
	4, // 3: queue.v1.StreamMessagesRequest.stream_config:type_name -> queue.v1.StreamConfig
...
func init() { file_queuepb_v1_stream_messages_request_proto_init() }
func file_queuepb_v1_stream_messages_request_proto_init() {
	if File_queuepb_v1_stream_messages_request_proto != nil {
		return
	}
	file_queuepb_v1_message_filter_proto_init()
	file_queuepb_v1_offset_config_proto_init()
	file_queuepb_v1_stream_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_queuepb_v1_stream_messages_request_proto_rawDesc), len(file_queuepb_v1_stream_messages_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_queuepb_v1_stream_messages_request_proto_goTypes,
		DependencyIndexes: file_queuepb_v1_stream_messages_request_proto_depIdxs,
		MessageInfos:      file_queuepb_v1_stream_messages_request_proto_msgTypes,
	}.Build()
	File_queuepb_v1_stream_messages_request_proto = out.File
	file_queuepb_v1_stream_messages_request_proto_goTypes = nil
	file_queuepb_v1_stream_messages_request_proto_depIdxs = nil
}
