...
// 	protoc        (unknown)
// source: metricspb/v1/create_provider_request.proto
...
func (x *CreateProviderRequest) Reset() {
	*x = CreateProviderRequest{}
	mi := &file_metricspb_v1_create_provider_request_proto_msgTypes[0]
...
func (x *CreateProviderRequest) GetMetadata() *commonpb.RequestMetadata {
	if x != nil {
...
func (x *CreateProviderRequest) SetMetadata(v *commonpb.RequestMetadata) {
...
var File_metricspb_v1_create_provider_request_proto protoreflect.FileDescriptor

const file_metricspb_v1_create_provider_request_proto_rawDesc = "" +
	"\n" +
	"*metricspb/v1/create_provider_request.proto\x12\n" +
	"metrics.v1\x1a\"commonpb/v1/request_metadata.proto\x1a\"metricspb/v1/provider_config.proto\x1a!google/protobuf/go_features.proto\"\xe4\x01\n" +
	"\x15CreateProviderRequest\x126\n" +
	"\bmetadata\x18\x01 \x01(\v2\x1a.common.v1.RequestMetadataR\bmetadata\x122\n" +
	"\x06config\x18\x02 \x01(\v2\x1a.metrics.v1.ProviderConfigR\x06config\x12'\n" +
...
var file_metricspb_v1_create_provider_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_create_provider_request_proto_goTypes = []any{
	(*CreateProviderRequest)(nil),    // 0: metrics.v1.CreateProviderRequest
	(*commonpb.RequestMetadata)(nil), // 1: common.v1.RequestMetadata
	(*ProviderConfig)(nil),           // 2: metrics.v1.ProviderConfig
}
var file_metricspb_v1_create_provider_request_proto_depIdxs = []int32{
	1, // 0: metrics.v1.CreateProviderRequest.metadata:type_name -> common.v1.RequestMetadata
	2, // 1: metrics.v1.CreateProviderRequest.config:type_name -> metrics.v1.ProviderConfig
...
func init() { file_metricspb_v1_create_provider_request_proto_init() }
func file_metricspb_v1_create_provider_request_proto_init() {
	if File_metricspb_v1_create_provider_request_proto != nil {
		return
	}
	file_metricspb_v1_provider_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_create_provider_request_proto_rawDesc), len(file_metricspb_v1_create_provider_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_create_provider_request_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_create_provider_request_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_create_provider_request_proto_msgTypes,
	}.Build()
	File_metricspb_v1_create_provider_request_proto = out.File
	file_metricspb_v1_create_provider_request_proto_goTypes = nil
	file_metricspb_v1_create_provider_request_proto_depIdxs = nil
}
