...
// 	protoc        (unknown)
// source: metricspb/v1/error_type_stats.proto
...
func (x *ErrorTypeStats) Reset() {
	*x = ErrorTypeStats{}
	mi := &file_metricspb_v1_error_type_stats_proto_msgTypes[0]
...
var File_metricspb_v1_error_type_stats_proto protoreflect.FileDescriptor

const file_metricspb_v1_error_type_stats_proto_rawDesc = "" +
	"\n" +
	"#metricspb/v1/error_type_stats.proto\x12\n" +
...
var file_metricspb_v1_error_type_stats_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_error_type_stats_proto_goTypes = []any{
	(*ErrorTypeStats)(nil), // 0: metrics.v1.ErrorTypeStats
}
var file_metricspb_v1_error_type_stats_proto_depIdxs = []int32{
...
func init() { file_metricspb_v1_error_type_stats_proto_init() }
func file_metricspb_v1_error_type_stats_proto_init() {
	if File_metricspb_v1_error_type_stats_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_error_type_stats_proto_rawDesc), len(file_metricspb_v1_error_type_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_error_type_stats_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_error_type_stats_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_error_type_stats_proto_msgTypes,
	}.Build()
	File_metricspb_v1_error_type_stats_proto = out.File
	file_metricspb_v1_error_type_stats_proto_goTypes = nil
	file_metricspb_v1_error_type_stats_proto_depIdxs = nil
}
