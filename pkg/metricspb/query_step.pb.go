...
// 	protoc        (unknown)
// source: metricspb/v1/query_step.proto
...
type QueryStep struct {
	...
	xxx_hidden_Operation         commonpb.QueryOperation `protobuf:"varint,2,opt,name=operation,enum=common.v1.QueryOperation"`
...
func (x *QueryStep) Reset() {
	*x = QueryStep{}
	mi := &file_metricspb_v1_query_step_proto_msgTypes[0]
...
func (x *QueryStep) GetOperation() commonpb.QueryOperation {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			return x.xxx_hidden_Operation
		}
	}
	return commonpb.QueryOperation(0)
}
...
func (x *QueryStep) SetOperation(v commonpb.QueryOperation) {
...
func (x *QueryStep) ClearOperation() {
	...
	x.xxx_hidden_Operation = commonpb.QueryOperation_QUERY_OPERATION_UNSPECIFIED
}
...
type QueryStep_builder struct {
	...
	Operation *commonpb.QueryOperation
...
var File_metricspb_v1_query_step_proto protoreflect.FileDescriptor

const file_metricspb_v1_query_step_proto_rawDesc = "" +
	"\n" +
	"\x1dmetricspb/v1/query_step.proto\x12\n" +
	"metrics.v1\x1a!commonpb/v1/query_operation.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf9\x01\n" +
	"\tQueryStep\x12\x17\n" +
	...
	"\x0einput_step_ids\x18\x05 \x03(\tR\finputStepIdsB\x9a\x01\n" +
	"\x0ecom.metrics.v1B\x0eQueryStepProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_query_step_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_query_step_proto_goTypes = []any{
	(*QueryStep)(nil),            // 0: metrics.v1.QueryStep
	(commonpb.QueryOperation)(0), // 1: common.v1.QueryOperation
	(*durationpb.Duration)(nil),  // 2: google.protobuf.Duration
}
var file_metricspb_v1_query_step_proto_depIdxs = []int32{
...
func init() { file_metricspb_v1_query_step_proto_init() }
func file_metricspb_v1_query_step_proto_init() {
	if File_metricspb_v1_query_step_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_query_step_proto_rawDesc), len(file_metricspb_v1_query_step_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_query_step_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_query_step_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_query_step_proto_msgTypes,
	}.Build()
	File_metricspb_v1_query_step_proto = out.File
	file_metricspb_v1_query_step_proto_goTypes = nil
	file_metricspb_v1_query_step_proto_depIdxs = nil
}
