...
// 	protoc        (unknown)
// source: metricspb/v1/metric_summary.proto
...
func (x *MetricSummary) Reset() {
	*x = MetricSummary{}
	mi := &file_metricspb_v1_metric_summary_proto_msgTypes[0]
...
var File_metricspb_v1_metric_summary_proto protoreflect.FileDescriptor

const file_metricspb_v1_metric_summary_proto_rawDesc = "" +
	"\n" +
	"!metricspb/v1/metric_summary.proto\x12\n" +
	"metrics.v1\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xed\x01\n" +
	...
	"\flast_updated\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\vlastUpdatedB\x9e\x01\n" +
	"\x0ecom.metrics.v1B\x12MetricSummaryProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_metric_summary_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_metric_summary_proto_goTypes = []any{
	(*MetricSummary)(nil),         // 0: metrics.v1.MetricSummary
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_metricspb_v1_metric_summary_proto_depIdxs = []int32{
	1, // 0: metrics.v1.MetricSummary.last_updated:type_name -> google.protobuf.Timestamp
...
func init() { file_metricspb_v1_metric_summary_proto_init() }
func file_metricspb_v1_metric_summary_proto_init() {
	if File_metricspb_v1_metric_summary_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_metric_summary_proto_rawDesc), len(file_metricspb_v1_metric_summary_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_metric_summary_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_metric_summary_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_metric_summary_proto_msgTypes,
	}.Build()
	File_metricspb_v1_metric_summary_proto = out.File
	file_metricspb_v1_metric_summary_proto_goTypes = nil
	file_metricspb_v1_metric_summary_proto_depIdxs = nil
}
