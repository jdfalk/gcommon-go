...
// 	protoc        (unknown)
// source: metricspb/v2/query_metrics_request.proto
...
func (x *QueryMetricsRequest) Reset() {
	*x = QueryMetricsRequest{}
	mi := &file_metricspb_v2_query_metrics_request_proto_msgTypes[0]
...
var File_metricspb_v2_query_metrics_request_proto protoreflect.FileDescriptor

const file_metricspb_v2_query_metrics_request_proto_rawDesc = "" +
	"\n" +
	"(metricspb/v2/query_metrics_request.proto\x12\n" +
	"metrics.v2\x1a\"commonpb/v2/request_metadata.proto\x1a\x1fmetricspb/v2/metric_query.proto\x1a'metricspb/v2/query_output_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc8\x02\n" +
...
var file_metricspb_v2_query_metrics_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_query_metrics_request_proto_goTypes = []any{
...
var file_metricspb_v2_query_metrics_request_proto_depIdxs = []int32{
...
func init() { file_metricspb_v2_query_metrics_request_proto_init() }
func file_metricspb_v2_query_metrics_request_proto_init() {
	if File_metricspb_v2_query_metrics_request_proto != nil {
		return
	}
	file_metricspb_v2_metric_query_proto_init()
	file_metricspb_v2_query_output_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_query_metrics_request_proto_rawDesc), len(file_metricspb_v2_query_metrics_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_query_metrics_request_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_query_metrics_request_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_query_metrics_request_proto_msgTypes,
	}.Build()
	File_metricspb_v2_query_metrics_request_proto = out.File
	file_metricspb_v2_query_metrics_request_proto_goTypes = nil
	file_metricspb_v2_query_metrics_request_proto_depIdxs = nil
}
