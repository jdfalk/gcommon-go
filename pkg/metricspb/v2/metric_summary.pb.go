...
// 	protoc        (unknown)
// source: metricspb/v2/metric_summary.proto
...
func (x *MetricSummary) Reset() {
	*x = MetricSummary{}
	mi := &file_metricspb_v2_metric_summary_proto_msgTypes[0]
...
var File_metricspb_v2_metric_summary_proto protoreflect.FileDescriptor

const file_metricspb_v2_metric_summary_proto_rawDesc = "" +
	"\n" +
	"!metricspb/v2/metric_summary.proto\x12\n" +
	"metrics.v2\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xed\x01\n" +
	"\rMetricSummary\x12\x1d\n" +
	...
	"\flast_updated\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\vlastUpdatedB\xa1\x01\n" +
	"\x0ecom.metrics.v2B\x12MetricSummaryProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_metric_summary_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_metric_summary_proto_goTypes = []any{
	(*MetricSummary)(nil),         // 0: metrics.v2.MetricSummary
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_metricspb_v2_metric_summary_proto_depIdxs = []int32{
	1, // 0: metrics.v2.MetricSummary.last_updated:type_name -> google.protobuf.Timestamp
...
func init() { file_metricspb_v2_metric_summary_proto_init() }
func file_metricspb_v2_metric_summary_proto_init() {
	if File_metricspb_v2_metric_summary_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_metric_summary_proto_rawDesc), len(file_metricspb_v2_metric_summary_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_metric_summary_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_metric_summary_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_metric_summary_proto_msgTypes,
	}.Build()
	File_metricspb_v2_metric_summary_proto = out.File
	file_metricspb_v2_metric_summary_proto_goTypes = nil
	file_metricspb_v2_metric_summary_proto_depIdxs = nil
}
