...
// 	protoc        (unknown)
// source: metricspb/v2/deletion_options.proto
...
type DeletionOptions struct {
	...
	xxx_hidden_CleanupStrategy   v2.CleanupStrategy     `protobuf:"varint,9,opt,name=cleanup_strategy,json=cleanupStrategy,enum=common.v2.CleanupStrategy"`
...
func (x *DeletionOptions) Reset() {
	*x = DeletionOptions{}
	mi := &file_metricspb_v2_deletion_options_proto_msgTypes[0]
...
func (x *DeletionOptions) GetCleanupStrategy() v2.CleanupStrategy {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 8) {
			return x.xxx_hidden_CleanupStrategy
		}
	}
	return v2.CleanupStrategy(0)
}
...
func (x *DeletionOptions) SetCleanupStrategy(v v2.CleanupStrategy) {
...
func (x *DeletionOptions) ClearCleanupStrategy() {
	...
	x.xxx_hidden_CleanupStrategy = v2.CleanupStrategy_CLEANUP_STRATEGY_UNSPECIFIED
}
...
type DeletionOptions_builder struct {
	...
	CleanupStrategy *v2.CleanupStrategy
...
var File_metricspb_v2_deletion_options_proto protoreflect.FileDescriptor

const file_metricspb_v2_deletion_options_proto_rawDesc = "" +
	"\n" +
	"#metricspb/v2/deletion_options.proto\x12\n" +
	"metrics.v2\x1a\"commonpb/v2/cleanup_strategy.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd2\x03\n" +
	...
	"\x10cleanup_strategy\x18\t \x01(\x0e2\x1a.common.v2.CleanupStrategyR\x0fcleanupStrategy\x12.\n" +
	"\x13wait_for_completion\x18\n" +
	" \x01(\bR\x11waitForCompletion\x126\n" +
	"\x12completion_timeout\x18\v \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x11completionTimeoutB\xa3\x01\n" +
	"\x0ecom.metrics.v2B\x14DeletionOptionsProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_deletion_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_deletion_options_proto_goTypes = []any{
	(*DeletionOptions)(nil), // 0: metrics.v2.DeletionOptions
	(v2.CleanupStrategy)(0), // 1: common.v2.CleanupStrategy
}
var file_metricspb_v2_deletion_options_proto_depIdxs = []int32{
	1, // 0: metrics.v2.DeletionOptions.cleanup_strategy:type_name -> common.v2.CleanupStrategy
...
func init() { file_metricspb_v2_deletion_options_proto_init() }
func file_metricspb_v2_deletion_options_proto_init() {
	if File_metricspb_v2_deletion_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_deletion_options_proto_rawDesc), len(file_metricspb_v2_deletion_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_deletion_options_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_deletion_options_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_deletion_options_proto_msgTypes,
	}.Build()
	File_metricspb_v2_deletion_options_proto = out.File
	file_metricspb_v2_deletion_options_proto_goTypes = nil
	file_metricspb_v2_deletion_options_proto_depIdxs = nil
}
