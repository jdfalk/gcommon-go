...
// 	protoc        (unknown)
// source: metricspb/v2/trend_analysis.proto
...
func (x *TrendAnalysis) Reset() {
	*x = TrendAnalysis{}
	mi := &file_metricspb_v2_trend_analysis_proto_msgTypes[0]
...
var File_metricspb_v2_trend_analysis_proto protoreflect.FileDescriptor

const file_metricspb_v2_trend_analysis_proto_rawDesc = "" +
	"\n" +
	"!metricspb/v2/trend_analysis.proto\x12\n" +
	"metrics.v2\x1a$metricspb/v2/data_volume_trend.proto\x1a\x1emetricspb/v2/error_trend.proto\x1a$metricspb/v2/performance_trend.proto\x1a'metricspb/v2/resource_usage_trend.proto\x1a!google/protobuf/go_features.proto\"\x84\x02\n" +
	"\rTrendAnalysis\x12>\n" +
	"\vperformance\x18\x01 \x01(\v2\x1c.metrics.v2.PerformanceTrendR\vperformance\x12E\n" +
	...
	"dataVolumeB\xa1\x01\n" +
	"\x0ecom.metrics.v2B\x12TrendAnalysisProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_trend_analysis_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_trend_analysis_proto_goTypes = []any{
	(*TrendAnalysis)(nil),      // 0: metrics.v2.TrendAnalysis
	(*PerformanceTrend)(nil),   // 1: metrics.v2.PerformanceTrend
	(*ResourceUsageTrend)(nil), // 2: metrics.v2.ResourceUsageTrend
	(*ErrorTrend)(nil),         // 3: metrics.v2.ErrorTrend
	(*DataVolumeTrend)(nil),    // 4: metrics.v2.DataVolumeTrend
}
var file_metricspb_v2_trend_analysis_proto_depIdxs = []int32{
	1, // 0: metrics.v2.TrendAnalysis.performance:type_name -> metrics.v2.PerformanceTrend
	2, // 1: metrics.v2.TrendAnalysis.resource_usage:type_name -> metrics.v2.ResourceUsageTrend
	3, // 2: metrics.v2.TrendAnalysis.errors:type_name -> metrics.v2.ErrorTrend
	4, // 3: metrics.v2.TrendAnalysis.data_volume:type_name -> metrics.v2.DataVolumeTrend
...
func init() { file_metricspb_v2_trend_analysis_proto_init() }
func file_metricspb_v2_trend_analysis_proto_init() {
	if File_metricspb_v2_trend_analysis_proto != nil {
		return
	}
	file_metricspb_v2_data_volume_trend_proto_init()
	file_metricspb_v2_error_trend_proto_init()
	file_metricspb_v2_performance_trend_proto_init()
	file_metricspb_v2_resource_usage_trend_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_trend_analysis_proto_rawDesc), len(file_metricspb_v2_trend_analysis_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_trend_analysis_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_trend_analysis_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_trend_analysis_proto_msgTypes,
	}.Build()
	File_metricspb_v2_trend_analysis_proto = out.File
	file_metricspb_v2_trend_analysis_proto_goTypes = nil
	file_metricspb_v2_trend_analysis_proto_depIdxs = nil
}
