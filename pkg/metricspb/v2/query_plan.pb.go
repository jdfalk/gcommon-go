...
// 	protoc        (unknown)
// source: metricspb/v2/query_plan.proto
...
func (x *QueryPlan) Reset() {
	*x = QueryPlan{}
	mi := &file_metricspb_v2_query_plan_proto_msgTypes[0]
...
var File_metricspb_v2_query_plan_proto protoreflect.FileDescriptor

const file_metricspb_v2_query_plan_proto_rawDesc = "" +
	"\n" +
	"\x1dmetricspb/v2/query_plan.proto\x12\n" +
	"metrics.v2\x1a\x1dmetricspb/v2/query_step.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa2\x02\n" +
	"\tQueryPlan\x12\"\n" +
	...
	"\x05steps\x18\x04 \x03(\v2\x15.metrics.v2.QueryStepB\b\xbaH\x05\x92\x01\x02\b\x01R\x05steps\x123\n" +
	"\x10storage_backends\x18\x05 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x0fstorageBackendsB\x9d\x01\n" +
	"\x0ecom.metrics.v2B\x0eQueryPlanProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_query_plan_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_query_plan_proto_goTypes = []any{
	(*QueryPlan)(nil),           // 0: metrics.v2.QueryPlan
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
	(*QueryStep)(nil),           // 2: metrics.v2.QueryStep
}
var file_metricspb_v2_query_plan_proto_depIdxs = []int32{
	1, // 0: metrics.v2.QueryPlan.estimated_duration:type_name -> google.protobuf.Duration
	2, // 1: metrics.v2.QueryPlan.steps:type_name -> metrics.v2.QueryStep
...
func init() { file_metricspb_v2_query_plan_proto_init() }
func file_metricspb_v2_query_plan_proto_init() {
	if File_metricspb_v2_query_plan_proto != nil {
		return
	}
	file_metricspb_v2_query_step_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_query_plan_proto_rawDesc), len(file_metricspb_v2_query_plan_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_query_plan_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_query_plan_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_query_plan_proto_msgTypes,
	}.Build()
	File_metricspb_v2_query_plan_proto = out.File
	file_metricspb_v2_query_plan_proto_goTypes = nil
	file_metricspb_v2_query_plan_proto_depIdxs = nil
}
