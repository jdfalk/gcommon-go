...
// 	protoc        (unknown)
// source: metricspb/v2/timer_metric.proto
...
func (x *TimerMetric) Reset() {
	*x = TimerMetric{}
	mi := &file_metricspb_v2_timer_metric_proto_msgTypes[0]
...
var File_metricspb_v2_timer_metric_proto protoreflect.FileDescriptor

const file_metricspb_v2_timer_metric_proto_rawDesc = "" +
	"\n" +
	"\x1fmetricspb/v2/timer_metric.proto\x12\n" +
	"metrics.v2\x1a)metricspb/v2/percentile_measurement.proto\x1a#metricspb/v2/timer_statistics.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x96\x05\n" +
	...
	"\x04tags\x18\x06 \x03(\v2!.metrics.v2.TimerMetric.TagsEntryR\x04tags\x12;\n" +
	"\n" +
	"statistics\x18\a \x01(\v2\x1b.metrics.v2.TimerStatisticsR\n" +
	"statistics\x12\x1d\n" +
	"\n" +
	...
	"\vpercentiles\x18\v \x03(\v2!.metrics.v2.PercentileMeasurementR\vpercentiles\x12;\n" +
	"\vrecorded_at\x18\f \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"recordedAt\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x9f\x01\n" +
	"\x0ecom.metrics.v2B\x10TimerMetricProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_timer_metric_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_metricspb_v2_timer_metric_proto_goTypes = []any{
	(*TimerMetric)(nil),           // 0: metrics.v2.TimerMetric
	nil,                           // 1: metrics.v2.TimerMetric.TagsEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 3: google.protobuf.Duration
	(*TimerStatistics)(nil),       // 4: metrics.v2.TimerStatistics
	(*PercentileMeasurement)(nil), // 5: metrics.v2.PercentileMeasurement
}
var file_metricspb_v2_timer_metric_proto_depIdxs = []int32{
	2, // 0: metrics.v2.TimerMetric.start_time:type_name -> google.protobuf.Timestamp
	2, // 1: metrics.v2.TimerMetric.end_time:type_name -> google.protobuf.Timestamp
	3, // 2: metrics.v2.TimerMetric.duration:type_name -> google.protobuf.Duration
	1, // 3: metrics.v2.TimerMetric.tags:type_name -> metrics.v2.TimerMetric.TagsEntry
	4, // 4: metrics.v2.TimerMetric.statistics:type_name -> metrics.v2.TimerStatistics
	3, // 5: metrics.v2.TimerMetric.total_duration:type_name -> google.protobuf.Duration
	5, // 6: metrics.v2.TimerMetric.percentiles:type_name -> metrics.v2.PercentileMeasurement
	2, // 7: metrics.v2.TimerMetric.recorded_at:type_name -> google.protobuf.Timestamp
...
func init() { file_metricspb_v2_timer_metric_proto_init() }
func file_metricspb_v2_timer_metric_proto_init() {
	if File_metricspb_v2_timer_metric_proto != nil {
		return
	}
	file_metricspb_v2_percentile_measurement_proto_init()
	file_metricspb_v2_timer_statistics_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_timer_metric_proto_rawDesc), len(file_metricspb_v2_timer_metric_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_timer_metric_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_timer_metric_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_timer_metric_proto_msgTypes,
	}.Build()
	File_metricspb_v2_timer_metric_proto = out.File
	file_metricspb_v2_timer_metric_proto_goTypes = nil
	file_metricspb_v2_timer_metric_proto_depIdxs = nil
}
