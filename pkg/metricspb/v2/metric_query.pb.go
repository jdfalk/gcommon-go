...
// 	protoc        (unknown)
// source: metricspb/v2/metric_query.proto
...
type MetricQuery struct {
	...
	xxx_hidden_TimeFilter   *v2.TimeRangeMetrics   `protobuf:"bytes,5,opt,name=time_filter,json=timeFilter"`
	...
	xxx_hidden_SortCriteria *[]*v2.SortOptions     `protobuf:"bytes,8,rep,name=sort_criteria,json=sortCriteria"`
...
func (x *MetricQuery) Reset() {
	*x = MetricQuery{}
	mi := &file_metricspb_v2_metric_query_proto_msgTypes[0]
...
func (x *MetricQuery) GetTimeFilter() *v2.TimeRangeMetrics {
	if x != nil {
...
func (x *MetricQuery) GetSortCriteria() []*v2.SortOptions {
	if x != nil {
...
func (x *MetricQuery) SetTimeFilter(v *v2.TimeRangeMetrics) {
...
func (x *MetricQuery) SetSortCriteria(v []*v2.SortOptions) {
...
var File_metricspb_v2_metric_query_proto protoreflect.FileDescriptor

const file_metricspb_v2_metric_query_proto_rawDesc = "" +
	"\n" +
	"\x1fmetricspb/v2/metric_query.proto\x12\n" +
	"metrics.v2\x1a\x1ecommonpb/v2/sort_options.proto\x1a$commonpb/v2/time_range_metrics.proto\x1a#metricspb/v2/aggregation_spec.proto\x1a metricspb/v2/group_by_spec.proto\x1a metricspb/v2/metric_filter.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xba\x03\n" +
	...
	"\fquery_string\x18\x03 \x01(\tR\vqueryString\x120\n" +
	"\x06filter\x18\x04 \x01(\v2\x18.metrics.v2.MetricFilterR\x06filter\x12<\n" +
	"\vtime_filter\x18\x05 \x01(\v2\x1b.common.v2.TimeRangeMetricsR\n" +
	"timeFilter\x12?\n" +
	"\faggregations\x18\x06 \x03(\v2\x1b.metrics.v2.AggregationSpecR\faggregations\x122\n" +
	"\bgroup_by\x18\a \x03(\v2\x17.metrics.v2.GroupBySpecR\agroupBy\x12;\n" +
	"\rsort_criteria\x18\b \x03(\v2\x16.common.v2.SortOptionsR\fsortCriteria\x12\x14\n" +
	"\x05limit\x18\t \x01(\x05R\x05limit\x12\x16\n" +
	"\x06offset\x18\n" +
	" \x01(\x05R\x06offsetB\x9f\x01\n" +
	"\x0ecom.metrics.v2B\x10MetricQueryProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_metric_query_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_metric_query_proto_goTypes = []any{
	(*MetricQuery)(nil),         // 0: metrics.v2.MetricQuery
	(*MetricFilter)(nil),        // 1: metrics.v2.MetricFilter
	(*v2.TimeRangeMetrics)(nil), // 2: common.v2.TimeRangeMetrics
	(*AggregationSpec)(nil),     // 3: metrics.v2.AggregationSpec
	(*GroupBySpec)(nil),         // 4: metrics.v2.GroupBySpec
	(*v2.SortOptions)(nil),      // 5: common.v2.SortOptions
}
var file_metricspb_v2_metric_query_proto_depIdxs = []int32{
	1, // 0: metrics.v2.MetricQuery.filter:type_name -> metrics.v2.MetricFilter
	2, // 1: metrics.v2.MetricQuery.time_filter:type_name -> common.v2.TimeRangeMetrics
	3, // 2: metrics.v2.MetricQuery.aggregations:type_name -> metrics.v2.AggregationSpec
	4, // 3: metrics.v2.MetricQuery.group_by:type_name -> metrics.v2.GroupBySpec
	5, // 4: metrics.v2.MetricQuery.sort_criteria:type_name -> common.v2.SortOptions
...
func init() { file_metricspb_v2_metric_query_proto_init() }
func file_metricspb_v2_metric_query_proto_init() {
	if File_metricspb_v2_metric_query_proto != nil {
		return
	}
	file_metricspb_v2_aggregation_spec_proto_init()
	file_metricspb_v2_group_by_spec_proto_init()
	file_metricspb_v2_metric_filter_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_metric_query_proto_rawDesc), len(file_metricspb_v2_metric_query_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_metric_query_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_metric_query_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_metric_query_proto_msgTypes,
	}.Build()
	File_metricspb_v2_metric_query_proto = out.File
	file_metricspb_v2_metric_query_proto_goTypes = nil
	file_metricspb_v2_metric_query_proto_depIdxs = nil
}
