...
// 	protoc        (unknown)
// source: metricspb/v2/performance_data_point.proto
...
func (x *PerformanceDataPoint) Reset() {
	*x = PerformanceDataPoint{}
	mi := &file_metricspb_v2_performance_data_point_proto_msgTypes[0]
...
var File_metricspb_v2_performance_data_point_proto protoreflect.FileDescriptor

const file_metricspb_v2_performance_data_point_proto_rawDesc = "" +
	"\n" +
	")metricspb/v2/performance_data_point.proto\x12\n" +
...
var file_metricspb_v2_performance_data_point_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_performance_data_point_proto_goTypes = []any{
	(*PerformanceDataPoint)(nil),  // 0: metrics.v2.PerformanceDataPoint
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_metricspb_v2_performance_data_point_proto_depIdxs = []int32{
...
func init() { file_metricspb_v2_performance_data_point_proto_init() }
func file_metricspb_v2_performance_data_point_proto_init() {
	if File_metricspb_v2_performance_data_point_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_performance_data_point_proto_rawDesc), len(file_metricspb_v2_performance_data_point_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_performance_data_point_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_performance_data_point_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_performance_data_point_proto_msgTypes,
	}.Build()
	File_metricspb_v2_performance_data_point_proto = out.File
	file_metricspb_v2_performance_data_point_proto_goTypes = nil
	file_metricspb_v2_performance_data_point_proto_depIdxs = nil
}
