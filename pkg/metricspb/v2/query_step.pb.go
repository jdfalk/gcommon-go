...
// 	protoc        (unknown)
// source: metricspb/v2/query_step.proto
...
func (x *QueryStep) Reset() {
	*x = QueryStep{}
	mi := &file_metricspb_v2_query_step_proto_msgTypes[0]
...
var File_metricspb_v2_query_step_proto protoreflect.FileDescriptor

const file_metricspb_v2_query_step_proto_rawDesc = "" +
	"\n" +
	"\x1dmetricspb/v2/query_step.proto\x12\n" +
	"metrics.v2\x1a!commonpb/v2/query_operation.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf9\x01\n" +
	"\tQueryStep\x12\x17\n" +
...
var file_metricspb_v2_query_step_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_query_step_proto_goTypes = []any{
	(*QueryStep)(nil),           // 0: metrics.v2.QueryStep
	(v2.QueryOperation)(0),      // 1: common.v2.QueryOperation
	(*durationpb.Duration)(nil), // 2: google.protobuf.Duration
}
var file_metricspb_v2_query_step_proto_depIdxs = []int32{
...
func init() { file_metricspb_v2_query_step_proto_init() }
func file_metricspb_v2_query_step_proto_init() {
	if File_metricspb_v2_query_step_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_query_step_proto_rawDesc), len(file_metricspb_v2_query_step_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_query_step_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_query_step_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_query_step_proto_msgTypes,
	}.Build()
	File_metricspb_v2_query_step_proto = out.File
	file_metricspb_v2_query_step_proto_goTypes = nil
	file_metricspb_v2_query_step_proto_depIdxs = nil
}
