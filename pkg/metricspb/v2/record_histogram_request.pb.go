...
// 	protoc        (unknown)
// source: metricspb/v2/record_histogram_request.proto
...
func (x *RecordHistogramRequest) Reset() {
	*x = RecordHistogramRequest{}
	mi := &file_metricspb_v2_record_histogram_request_proto_msgTypes[0]
...
func (x *RecordHistogramRequest) GetMetadata() *v2.RequestMetadata {
	if x != nil {
...
func (x *RecordHistogramRequest) SetMetadata(v *v2.RequestMetadata) {
...
var File_metricspb_v2_record_histogram_request_proto protoreflect.FileDescriptor

const file_metricspb_v2_record_histogram_request_proto_rawDesc = "" +
	"\n" +
	"+metricspb/v2/record_histogram_request.proto\x12\n" +
	"metrics.v2\x1a\"commonpb/v2/request_metadata.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xd5\x03\n" +
	...
	"\x06labels\x18\x03 \x03(\v2..metrics.v2.RecordHistogramRequest.LabelsEntryR\x06labels\x12\x12\n" +
	...
	"\bmetadata\x18\b \x01(\v2\x1a.common.v2.RequestMetadataR\bmetadata\x12#\n" +
	...
	"\x0ecom.metrics.v2B\x1bRecordHistogramRequestProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_record_histogram_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_metricspb_v2_record_histogram_request_proto_goTypes = []any{
	(*RecordHistogramRequest)(nil), // 0: metrics.v2.RecordHistogramRequest
	nil,                            // 1: metrics.v2.RecordHistogramRequest.LabelsEntry
	(*timestamppb.Timestamp)(nil),  // 2: google.protobuf.Timestamp
	(*v2.RequestMetadata)(nil),     // 3: common.v2.RequestMetadata
}
var file_metricspb_v2_record_histogram_request_proto_depIdxs = []int32{
	1, // 0: metrics.v2.RecordHistogramRequest.labels:type_name -> metrics.v2.RecordHistogramRequest.LabelsEntry
	2, // 1: metrics.v2.RecordHistogramRequest.timestamp:type_name -> google.protobuf.Timestamp
	3, // 2: metrics.v2.RecordHistogramRequest.metadata:type_name -> common.v2.RequestMetadata
...
func init() { file_metricspb_v2_record_histogram_request_proto_init() }
func file_metricspb_v2_record_histogram_request_proto_init() {
	if File_metricspb_v2_record_histogram_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_record_histogram_request_proto_rawDesc), len(file_metricspb_v2_record_histogram_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_record_histogram_request_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_record_histogram_request_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_record_histogram_request_proto_msgTypes,
	}.Build()
	File_metricspb_v2_record_histogram_request_proto = out.File
	file_metricspb_v2_record_histogram_request_proto_goTypes = nil
	file_metricspb_v2_record_histogram_request_proto_depIdxs = nil
}
