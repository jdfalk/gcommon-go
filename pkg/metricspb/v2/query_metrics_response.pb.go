...
// 	protoc        (unknown)
// source: metricspb/v2/query_metrics_response.proto
...
func (x *QueryMetricsResponse) Reset() {
	*x = QueryMetricsResponse{}
	mi := &file_metricspb_v2_query_metrics_response_proto_msgTypes[0]
...
func (x *QueryMetricsResponse) GetError() *v2.Error {
	if x != nil {
...
func (x *QueryMetricsResponse) SetError(v *v2.Error) {
...
var File_metricspb_v2_query_metrics_response_proto protoreflect.FileDescriptor

const file_metricspb_v2_query_metrics_response_proto_rawDesc = "" +
	"\n" +
	")metricspb/v2/query_metrics_response.proto\x12\n" +
	"metrics.v2\x1a\x17commonpb/v2/error.proto\x1a metricspb/v2/metric_series.proto\x1a\x1dmetricspb/v2/query_plan.proto\x1a#metricspb/v2/query_statistics.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x8c\x03\n" +
	"\x14QueryMetricsResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12&\n" +
	"\x05error\x18\x02 \x01(\v2\x10.common.v2.ErrorR\x05error\x12:\n" +
	"\x06series\x18\x03 \x03(\v2\x18.metrics.v2.MetricSeriesB\b\xbaH\x05\x92\x01\x02\b\x01R\x06series\x12;\n" +
	"\n" +
	"statistics\x18\x04 \x01(\v2\x1b.metrics.v2.QueryStatisticsR\n" +
	"statistics\x124\n" +
	"\n" +
	"query_plan\x18\x05 \x01(\v2\x15.metrics.v2.QueryPlanR\tqueryPlan\x12$\n" +
	...
	"\rtotal_results\x18\b \x01(\x03B\a\xbaH\x04\"\x02(\x00R\ftotalResultsB\xa8\x01\n" +
	"\x0ecom.metrics.v2B\x19QueryMetricsResponseProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_query_metrics_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_query_metrics_response_proto_goTypes = []any{
	(*QueryMetricsResponse)(nil), // 0: metrics.v2.QueryMetricsResponse
	(*v2.Error)(nil),             // 1: common.v2.Error
	(*MetricSeries)(nil),         // 2: metrics.v2.MetricSeries
	(*QueryStatistics)(nil),      // 3: metrics.v2.QueryStatistics
	(*QueryPlan)(nil),            // 4: metrics.v2.QueryPlan
}
var file_metricspb_v2_query_metrics_response_proto_depIdxs = []int32{
	1, // 0: metrics.v2.QueryMetricsResponse.error:type_name -> common.v2.Error
	2, // 1: metrics.v2.QueryMetricsResponse.series:type_name -> metrics.v2.MetricSeries
	3, // 2: metrics.v2.QueryMetricsResponse.statistics:type_name -> metrics.v2.QueryStatistics
	4, // 3: metrics.v2.QueryMetricsResponse.query_plan:type_name -> metrics.v2.QueryPlan
...
func init() { file_metricspb_v2_query_metrics_response_proto_init() }
func file_metricspb_v2_query_metrics_response_proto_init() {
	if File_metricspb_v2_query_metrics_response_proto != nil {
		return
	}
	file_metricspb_v2_metric_series_proto_init()
	file_metricspb_v2_query_plan_proto_init()
	file_metricspb_v2_query_statistics_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_query_metrics_response_proto_rawDesc), len(file_metricspb_v2_query_metrics_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_query_metrics_response_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_query_metrics_response_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_query_metrics_response_proto_msgTypes,
	}.Build()
	File_metricspb_v2_query_metrics_response_proto = out.File
	file_metricspb_v2_query_metrics_response_proto_goTypes = nil
	file_metricspb_v2_query_metrics_response_proto_depIdxs = nil
}
