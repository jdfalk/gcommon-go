...
// 	protoc        (unknown)
// source: metricspb/v2/disk_usage.proto
...
func (x *DiskUsage) Reset() {
	*x = DiskUsage{}
	mi := &file_metricspb_v2_disk_usage_proto_msgTypes[0]
...
var File_metricspb_v2_disk_usage_proto protoreflect.FileDescriptor

const file_metricspb_v2_disk_usage_proto_rawDesc = "" +
	"\n" +
	"\x1dmetricspb/v2/disk_usage.proto\x12\n" +
	...
	"\x04iops\x18\x04 \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\x04iopsB\x9d\x01\n" +
	"\x0ecom.metrics.v2B\x0eDiskUsageProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_disk_usage_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_disk_usage_proto_goTypes = []any{
	(*DiskUsage)(nil), // 0: metrics.v2.DiskUsage
}
var file_metricspb_v2_disk_usage_proto_depIdxs = []int32{
...
func init() { file_metricspb_v2_disk_usage_proto_init() }
func file_metricspb_v2_disk_usage_proto_init() {
	if File_metricspb_v2_disk_usage_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_disk_usage_proto_rawDesc), len(file_metricspb_v2_disk_usage_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_disk_usage_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_disk_usage_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_disk_usage_proto_msgTypes,
	}.Build()
	File_metricspb_v2_disk_usage_proto = out.File
	file_metricspb_v2_disk_usage_proto_goTypes = nil
	file_metricspb_v2_disk_usage_proto_depIdxs = nil
}
