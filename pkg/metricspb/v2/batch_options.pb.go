...
// 	protoc        (unknown)
// source: metricspb/v2/batch_options.proto
...
type MetricsBatchOptions struct {
	...
	xxx_hidden_Priority              v2.BatchPriority       `protobuf:"varint,7,opt,name=priority,enum=common.v2.BatchPriority"`
...
func (x *MetricsBatchOptions) Reset() {
	*x = MetricsBatchOptions{}
	mi := &file_metricspb_v2_batch_options_proto_msgTypes[0]
...
func (x *MetricsBatchOptions) GetPriority() v2.BatchPriority {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 6) {
			return x.xxx_hidden_Priority
		}
	}
	return v2.BatchPriority(0)
}
...
func (x *MetricsBatchOptions) SetPriority(v v2.BatchPriority) {
...
func (x *MetricsBatchOptions) ClearPriority() {
	...
	x.xxx_hidden_Priority = v2.BatchPriority_BATCH_PRIORITY_UNSPECIFIED
}
...
var File_metricspb_v2_batch_options_proto protoreflect.FileDescriptor

const file_metricspb_v2_batch_options_proto_rawDesc = "" +
	"\n" +
	" metricspb/v2/batch_options.proto\x12\n" +
	"metrics.v2\x1a commonpb/v2/batch_priority.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe0\x02\n" +
	"\x13MetricsBatchOptions\x12/\n" +
	"\x13parallel_processing\x18\x01 \x01(\bR\x12parallelProcessing\x120\n" +
	"\x0fmax_concurrency\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x0emaxConcurrency\x12 \n" +
	...
	"\bpriority\x18\a \x01(\x0e2\x18.common.v2.BatchPriorityR\bpriorityB\xa0\x01\n" +
	"\x0ecom.metrics.v2B\x11BatchOptionsProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_batch_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_batch_options_proto_goTypes = []any{
	(*MetricsBatchOptions)(nil), // 0: metrics.v2.MetricsBatchOptions
	(v2.BatchPriority)(0),       // 1: common.v2.BatchPriority
}
var file_metricspb_v2_batch_options_proto_depIdxs = []int32{
	1, // 0: metrics.v2.MetricsBatchOptions.priority:type_name -> common.v2.BatchPriority
...
func init() { file_metricspb_v2_batch_options_proto_init() }
func file_metricspb_v2_batch_options_proto_init() {
	if File_metricspb_v2_batch_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_batch_options_proto_rawDesc), len(file_metricspb_v2_batch_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_batch_options_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_batch_options_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_batch_options_proto_msgTypes,
	}.Build()
	File_metricspb_v2_batch_options_proto = out.File
	file_metricspb_v2_batch_options_proto_goTypes = nil
	file_metricspb_v2_batch_options_proto_depIdxs = nil
}
