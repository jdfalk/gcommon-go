...
// 	protoc        (unknown)
// source: metricspb/v2/metric_value.proto
...
func (x *MetricValue) Reset() {
	*x = MetricValue{}
	mi := &file_metricspb_v2_metric_value_proto_msgTypes[0]
...
func (x case_MetricValue_Value) String() string {
	md := file_metricspb_v2_metric_value_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_metricspb_v2_metric_value_proto protoreflect.FileDescriptor

const file_metricspb_v2_metric_value_proto_rawDesc = "" +
	"\n" +
	"\x1fmetricspb/v2/metric_value.proto\x12\n" +
	"metrics.v2\x1a\"metricspb/v2/histogram_value.proto\x1a metricspb/v2/summary_value.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x9f\x04\n" +
	"\vMetricValue\x128\n" +
	"\ttimestamp\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x123\n" +
	"\fdouble_value\x18\x02 \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00H\x00R\vdoubleValue\x12&\n" +
	"\tint_value\x18\x03 \x01(\x03B\a\xbaH\x04\"\x02(\x00H\x00R\bintValue\x12,\n" +
	"\fstring_value\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x10\x01H\x00R\vstringValue\x12\x1f\n" +
	"\n" +
	"bool_value\x18\x05 \x01(\bH\x00R\tboolValue\x12E\n" +
	"\x0fhistogram_value\x18\x06 \x01(\v2\x1a.metrics.v2.HistogramValueH\x00R\x0ehistogramValue\x12?\n" +
	"\rsummary_value\x18\a \x01(\v2\x18.metrics.v2.SummaryValueH\x00R\fsummaryValue\x12;\n" +
	"\x06labels\x18\b \x03(\v2#.metrics.v2.MetricValue.LabelsEntryR\x06labels\x12!\n" +
	"\fsample_count\x18\t \x01(\x04R\vsampleCount\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\a\n" +
	"\x05valueB\x9f\x01\n" +
	"\x0ecom.metrics.v2B\x10MetricValueProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_metric_value_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_metricspb_v2_metric_value_proto_goTypes = []any{
	(*MetricValue)(nil),           // 0: metrics.v2.MetricValue
	nil,                           // 1: metrics.v2.MetricValue.LabelsEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*HistogramValue)(nil),        // 3: metrics.v2.HistogramValue
	(*SummaryValue)(nil),          // 4: metrics.v2.SummaryValue
}
var file_metricspb_v2_metric_value_proto_depIdxs = []int32{
	2, // 0: metrics.v2.MetricValue.timestamp:type_name -> google.protobuf.Timestamp
	3, // 1: metrics.v2.MetricValue.histogram_value:type_name -> metrics.v2.HistogramValue
	4, // 2: metrics.v2.MetricValue.summary_value:type_name -> metrics.v2.SummaryValue
	1, // 3: metrics.v2.MetricValue.labels:type_name -> metrics.v2.MetricValue.LabelsEntry
...
func init() { file_metricspb_v2_metric_value_proto_init() }
func file_metricspb_v2_metric_value_proto_init() {
	if File_metricspb_v2_metric_value_proto != nil {
		return
	}
	file_metricspb_v2_histogram_value_proto_init()
	file_metricspb_v2_summary_value_proto_init()
	file_metricspb_v2_metric_value_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_metric_value_proto_rawDesc), len(file_metricspb_v2_metric_value_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_metric_value_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_metric_value_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_metric_value_proto_msgTypes,
	}.Build()
	File_metricspb_v2_metric_value_proto = out.File
	file_metricspb_v2_metric_value_proto_goTypes = nil
	file_metricspb_v2_metric_value_proto_depIdxs = nil
}
