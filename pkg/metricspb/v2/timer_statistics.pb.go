...
// 	protoc        (unknown)
// source: metricspb/v2/timer_statistics.proto
...
func (x *TimerStatistics) Reset() {
	*x = TimerStatistics{}
	mi := &file_metricspb_v2_timer_statistics_proto_msgTypes[0]
...
var File_metricspb_v2_timer_statistics_proto protoreflect.FileDescriptor

const file_metricspb_v2_timer_statistics_proto_rawDesc = "" +
	"\n" +
	"#metricspb/v2/timer_statistics.proto\x12\n" +
	"metrics.v2\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe6\x03\n" +
	...
	"\rmean_duration\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\fmeanDuration\x12B\n" +
	"\x15standard_deviation_ms\x18\x04 \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\x13standardDeviationMs\x12/\n" +
	"\vvariance_ms\x18\x05 \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\n" +
	"varianceMs\x12*\n" +
	...
	"\rlast_duration\x18\b \x01(\v2\x19.google.protobuf.DurationR\flastDurationB\xa3\x01\n" +
	"\x0ecom.metrics.v2B\x14TimerStatisticsProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_timer_statistics_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_timer_statistics_proto_goTypes = []any{
	(*TimerStatistics)(nil),     // 0: metrics.v2.TimerStatistics
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_metricspb_v2_timer_statistics_proto_depIdxs = []int32{
	1, // 0: metrics.v2.TimerStatistics.min_duration:type_name -> google.protobuf.Duration
	1, // 1: metrics.v2.TimerStatistics.max_duration:type_name -> google.protobuf.Duration
	1, // 2: metrics.v2.TimerStatistics.mean_duration:type_name -> google.protobuf.Duration
	1, // 3: metrics.v2.TimerStatistics.last_duration:type_name -> google.protobuf.Duration
...
func init() { file_metricspb_v2_timer_statistics_proto_init() }
func file_metricspb_v2_timer_statistics_proto_init() {
	if File_metricspb_v2_timer_statistics_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_timer_statistics_proto_rawDesc), len(file_metricspb_v2_timer_statistics_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_timer_statistics_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_timer_statistics_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_timer_statistics_proto_msgTypes,
	}.Build()
	File_metricspb_v2_timer_statistics_proto = out.File
	file_metricspb_v2_timer_statistics_proto_goTypes = nil
	file_metricspb_v2_timer_statistics_proto_depIdxs = nil
}
