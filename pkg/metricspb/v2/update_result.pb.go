...
// 	protoc        (unknown)
// source: metricspb/v2/update_result.proto
...
type UpdateResult struct {
	...
	xxx_hidden_Action          v2.UpdateAction            `protobuf:"varint,1,opt,name=action,enum=common.v2.UpdateAction"`
	xxx_hidden_ConfigChanges   *[]*v2.MetricsConfigChange `protobuf:"bytes,2,rep,name=config_changes,json=configChanges"`
...
func (x *UpdateResult) Reset() {
	*x = UpdateResult{}
	mi := &file_metricspb_v2_update_result_proto_msgTypes[0]
...
func (x *UpdateResult) GetAction() v2.UpdateAction {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 0) {
			return x.xxx_hidden_Action
		}
	}
	return v2.UpdateAction(0)
}

func (x *UpdateResult) GetConfigChanges() []*v2.MetricsConfigChange {
	if x != nil {
...
func (x *UpdateResult) SetAction(v v2.UpdateAction) {
	x.xxx_hidden_Action = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 7)
}

func (x *UpdateResult) SetConfigChanges(v []*v2.MetricsConfigChange) {
...
func (x *UpdateResult) ClearAction() {
	...
	x.xxx_hidden_Action = v2.UpdateAction_UPDATE_ACTION_UNSPECIFIED
}
...
type UpdateResult_builder struct {
	...
	Action *v2.UpdateAction
	// Configuration changes that were applied
	ConfigChanges []*v2.MetricsConfigChange
...
var File_metricspb_v2_update_result_proto protoreflect.FileDescriptor

const file_metricspb_v2_update_result_proto_rawDesc = "" +
	"\n" +
	" metricspb/v2/update_result.proto\x12\n" +
	"metrics.v2\x1a'commonpb/v2/metrics_config_change.proto\x1a\x1fcommonpb/v2/update_action.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf8\x02\n" +
	"\fUpdateResult\x12/\n" +
	"\x06action\x18\x01 \x01(\x0e2\x17.common.v2.UpdateActionR\x06action\x12O\n" +
	"\x0econfig_changes\x18\x02 \x03(\v2\x1e.common.v2.MetricsConfigChangeB\b\xbaH\x05\x92\x01\x02\b\x01R\rconfigChanges\x123\n" +
	"\x10updated_settings\x18\x03 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x0fupdatedSettings\x123\n" +
	...
	"\x0fupdate_duration\x18\a \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x0eupdateDurationB\xa0\x01\n" +
	"\x0ecom.metrics.v2B\x11UpdateResultProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_update_result_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_update_result_proto_goTypes = []any{
	(*UpdateResult)(nil),           // 0: metrics.v2.UpdateResult
	(v2.UpdateAction)(0),           // 1: common.v2.UpdateAction
	(*v2.MetricsConfigChange)(nil), // 2: common.v2.MetricsConfigChange
}
var file_metricspb_v2_update_result_proto_depIdxs = []int32{
	1, // 0: metrics.v2.UpdateResult.action:type_name -> common.v2.UpdateAction
	2, // 1: metrics.v2.UpdateResult.config_changes:type_name -> common.v2.MetricsConfigChange
...
func init() { file_metricspb_v2_update_result_proto_init() }
func file_metricspb_v2_update_result_proto_init() {
	if File_metricspb_v2_update_result_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_update_result_proto_rawDesc), len(file_metricspb_v2_update_result_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_update_result_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_update_result_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_update_result_proto_msgTypes,
	}.Build()
	File_metricspb_v2_update_result_proto = out.File
	file_metricspb_v2_update_result_proto_goTypes = nil
	file_metricspb_v2_update_result_proto_depIdxs = nil
}
