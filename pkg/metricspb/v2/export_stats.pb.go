...
// 	protoc        (unknown)
// source: metricspb/v2/export_stats.proto
...
func (x *ExportStats) Reset() {
	*x = ExportStats{}
	mi := &file_metricspb_v2_export_stats_proto_msgTypes[0]
...
var File_metricspb_v2_export_stats_proto protoreflect.FileDescriptor

const file_metricspb_v2_export_stats_proto_rawDesc = "" +
	"\n" +
	"\x1fmetricspb/v2/export_stats.proto\x12\n" +
	"metrics.v2\x1a+metricspb/v2/export_destination_stats.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x87\x04\n" +
	"\vExportStats\x12=\n" +
...
var file_metricspb_v2_export_stats_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_export_stats_proto_goTypes = []any{
	(*ExportStats)(nil),            // 0: metrics.v2.ExportStats
	(*ExportDestinationStats)(nil), // 1: metrics.v2.ExportDestinationStats
	(*timestamppb.Timestamp)(nil),  // 2: google.protobuf.Timestamp
}
var file_metricspb_v2_export_stats_proto_depIdxs = []int32{
...
func init() { file_metricspb_v2_export_stats_proto_init() }
func file_metricspb_v2_export_stats_proto_init() {
	if File_metricspb_v2_export_stats_proto != nil {
		return
	}
	file_metricspb_v2_export_destination_stats_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_export_stats_proto_rawDesc), len(file_metricspb_v2_export_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_export_stats_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_export_stats_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_export_stats_proto_msgTypes,
	}.Build()
	File_metricspb_v2_export_stats_proto = out.File
	file_metricspb_v2_export_stats_proto_goTypes = nil
	file_metricspb_v2_export_stats_proto_depIdxs = nil
}
