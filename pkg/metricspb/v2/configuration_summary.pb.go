...
// 	protoc        (unknown)
// source: metricspb/v2/configuration_summary.proto
...
func (x *ConfigurationSummary) Reset() {
	*x = ConfigurationSummary{}
	mi := &file_metricspb_v2_configuration_summary_proto_msgTypes[0]
...
var File_metricspb_v2_configuration_summary_proto protoreflect.FileDescriptor

const file_metricspb_v2_configuration_summary_proto_rawDesc = "" +
	"\n" +
	"(metricspb/v2/configuration_summary.proto\x12\n" +
	"metrics.v2\x1a*metricspb/v2/resource_limits_summary.proto\x1a#metricspb/v2/security_summary.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x8f\x02\n" +
	...
	"\x0econfig_version\x18\x04 \x01(\tB\x17\xbaH\x14r\x122\x10^v?\\d+\\.\\d+\\.\\d+R\rconfigVersionB\xa8\x01\n" +
	"\x0ecom.metrics.v2B\x19ConfigurationSummaryProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_configuration_summary_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_configuration_summary_proto_goTypes = []any{
	(*ConfigurationSummary)(nil),  // 0: metrics.v2.ConfigurationSummary
	(*SecuritySummary)(nil),       // 1: metrics.v2.SecuritySummary
	(*ResourceLimitsSummary)(nil), // 2: metrics.v2.ResourceLimitsSummary
}
var file_metricspb_v2_configuration_summary_proto_depIdxs = []int32{
	1, // 0: metrics.v2.ConfigurationSummary.security:type_name -> metrics.v2.SecuritySummary
	2, // 1: metrics.v2.ConfigurationSummary.resource_limits:type_name -> metrics.v2.ResourceLimitsSummary
...
func init() { file_metricspb_v2_configuration_summary_proto_init() }
func file_metricspb_v2_configuration_summary_proto_init() {
	if File_metricspb_v2_configuration_summary_proto != nil {
		return
	}
	file_metricspb_v2_resource_limits_summary_proto_init()
	file_metricspb_v2_security_summary_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_configuration_summary_proto_rawDesc), len(file_metricspb_v2_configuration_summary_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_configuration_summary_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_configuration_summary_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_configuration_summary_proto_msgTypes,
	}.Build()
	File_metricspb_v2_configuration_summary_proto = out.File
	file_metricspb_v2_configuration_summary_proto_goTypes = nil
	file_metricspb_v2_configuration_summary_proto_depIdxs = nil
}
