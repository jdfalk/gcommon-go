...
// 	protoc        (unknown)
// source: metricspb/v2/summary_metric.proto
...
func (x *SummaryMetric) Reset() {
	*x = SummaryMetric{}
	mi := &file_metricspb_v2_summary_metric_proto_msgTypes[0]
...
func (x *SummaryMetric) GetMetadata() *v2.RequestMetadata {
	if x != nil {
...
func (x *SummaryMetric) SetMetadata(v *v2.RequestMetadata) {
...
var File_metricspb_v2_summary_metric_proto protoreflect.FileDescriptor

const file_metricspb_v2_summary_metric_proto_rawDesc = "" +
	"\n" +
	"!metricspb/v2/summary_metric.proto\x12\n" +
	"metrics.v2\x1a\"commonpb/v2/request_metadata.proto\x1a#metricspb/v2/summary_quantile.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xf3\x03\n" +
	...
	"\n" +
	"sample_sum\x18\x03 \x01(\x01R\tsampleSum\x129\n" +
	"\tquantiles\x18\x04 \x03(\v2\x1b.metrics.v2.SummaryQuantileR\tquantiles\x12=\n" +
	"\x06labels\x18\x05 \x03(\v2%.metrics.v2.SummaryMetric.LabelsEntryR\x06labels\x128\n" +
	...
	"\amax_age\x18\t \x01(\v2\x19.google.protobuf.DurationR\x06maxAge\x126\n" +
	"\bmetadata\x18\n" +
	" \x01(\v2\x1a.common.v2.RequestMetadataR\bmetadata\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xa1\x01\n" +
	"\x0ecom.metrics.v2B\x12SummaryMetricProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_summary_metric_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_metricspb_v2_summary_metric_proto_goTypes = []any{
	(*SummaryMetric)(nil),         // 0: metrics.v2.SummaryMetric
	nil,                           // 1: metrics.v2.SummaryMetric.LabelsEntry
	(*SummaryQuantile)(nil),       // 2: metrics.v2.SummaryQuantile
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 4: google.protobuf.Duration
	(*v2.RequestMetadata)(nil),    // 5: common.v2.RequestMetadata
}
var file_metricspb_v2_summary_metric_proto_depIdxs = []int32{
	2, // 0: metrics.v2.SummaryMetric.quantiles:type_name -> metrics.v2.SummaryQuantile
	1, // 1: metrics.v2.SummaryMetric.labels:type_name -> metrics.v2.SummaryMetric.LabelsEntry
	3, // 2: metrics.v2.SummaryMetric.timestamp:type_name -> google.protobuf.Timestamp
	4, // 3: metrics.v2.SummaryMetric.max_age:type_name -> google.protobuf.Duration
	5, // 4: metrics.v2.SummaryMetric.metadata:type_name -> common.v2.RequestMetadata
...
func init() { file_metricspb_v2_summary_metric_proto_init() }
func file_metricspb_v2_summary_metric_proto_init() {
	if File_metricspb_v2_summary_metric_proto != nil {
		return
	}
	file_metricspb_v2_summary_quantile_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_summary_metric_proto_rawDesc), len(file_metricspb_v2_summary_metric_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_summary_metric_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_summary_metric_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_summary_metric_proto_msgTypes,
	}.Build()
	File_metricspb_v2_summary_metric_proto = out.File
	file_metricspb_v2_summary_metric_proto_goTypes = nil
	file_metricspb_v2_summary_metric_proto_depIdxs = nil
}
