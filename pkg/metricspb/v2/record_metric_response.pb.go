...
// 	protoc        (unknown)
// source: metricspb/v2/record_metric_response.proto
...
func (x *RecordMetricResponse) Reset() {
	*x = RecordMetricResponse{}
	mi := &file_metricspb_v2_record_metric_response_proto_msgTypes[0]
...
func (x *RecordMetricResponse) GetError() *v2.Error {
	if x != nil {
...
func (x *RecordMetricResponse) GetValidation() *v2.MetricsValidationResult {
	if x != nil {
...
func (x *RecordMetricResponse) SetError(v *v2.Error) {
...
func (x *RecordMetricResponse) SetValidation(v *v2.MetricsValidationResult) {
...
var File_metricspb_v2_record_metric_response_proto protoreflect.FileDescriptor

const file_metricspb_v2_record_metric_response_proto_rawDesc = "" +
	"\n" +
	")metricspb/v2/record_metric_response.proto\x12\n" +
	"metrics.v2\x1a\x17commonpb/v2/error.proto\x1a+commonpb/v2/metrics_validation_result.proto\x1a\"metricspb/v2/recording_stats.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x81\x03\n" +
	"\x14RecordMetricResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12&\n" +
	"\x05error\x18\x02 \x01(\v2\x10.common.v2.ErrorR\x05error\x12$\n" +
	"\tmetric_id\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\bmetricId\x12;\n" +
	...
	"validation\x120\n" +
	"\x05stats\x18\a \x01(\v2\x1a.metrics.v2.RecordingStatsR\x05stats\x12$\n" +
	"\bwarnings\x18\b \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\bwarningsB\xa8\x01\n" +
	"\x0ecom.metrics.v2B\x19RecordMetricResponseProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_record_metric_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_record_metric_response_proto_goTypes = []any{
	(*RecordMetricResponse)(nil),       // 0: metrics.v2.RecordMetricResponse
	(*v2.Error)(nil),                   // 1: common.v2.Error
	(*timestamppb.Timestamp)(nil),      // 2: google.protobuf.Timestamp
	(*v2.MetricsValidationResult)(nil), // 3: common.v2.MetricsValidationResult
	(*RecordingStats)(nil),             // 4: metrics.v2.RecordingStats
}
var file_metricspb_v2_record_metric_response_proto_depIdxs = []int32{
	1, // 0: metrics.v2.RecordMetricResponse.error:type_name -> common.v2.Error
	2, // 1: metrics.v2.RecordMetricResponse.recorded_at:type_name -> google.protobuf.Timestamp
	3, // 2: metrics.v2.RecordMetricResponse.validation:type_name -> common.v2.MetricsValidationResult
	4, // 3: metrics.v2.RecordMetricResponse.stats:type_name -> metrics.v2.RecordingStats
...
func init() { file_metricspb_v2_record_metric_response_proto_init() }
func file_metricspb_v2_record_metric_response_proto_init() {
	if File_metricspb_v2_record_metric_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_record_metric_response_proto_rawDesc), len(file_metricspb_v2_record_metric_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_record_metric_response_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_record_metric_response_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_record_metric_response_proto_msgTypes,
	}.Build()
	File_metricspb_v2_record_metric_response_proto = out.File
	file_metricspb_v2_record_metric_response_proto_goTypes = nil
	file_metricspb_v2_record_metric_response_proto_depIdxs = nil
}
