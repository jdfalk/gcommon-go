...
// 	protoc        (unknown)
// source: metricspb/v2/validation_rules.proto
...
func (x *ValidationRules) Reset() {
	*x = ValidationRules{}
	mi := &file_metricspb_v2_validation_rules_proto_msgTypes[0]
...
var File_metricspb_v2_validation_rules_proto protoreflect.FileDescriptor

const file_metricspb_v2_validation_rules_proto_rawDesc = "" +
	"\n" +
	"#metricspb/v2/validation_rules.proto\x12\n" +
	"metrics.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xcb\x01\n" +
	...
	"\x16validation_expressions\x18\x04 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x15validationExpressionsB\xa3\x01\n" +
	"\x0ecom.metrics.v2B\x14ValidationRulesProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_validation_rules_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_validation_rules_proto_goTypes = []any{
	(*ValidationRules)(nil), // 0: metrics.v2.ValidationRules
}
var file_metricspb_v2_validation_rules_proto_depIdxs = []int32{
...
func init() { file_metricspb_v2_validation_rules_proto_init() }
func file_metricspb_v2_validation_rules_proto_init() {
	if File_metricspb_v2_validation_rules_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_validation_rules_proto_rawDesc), len(file_metricspb_v2_validation_rules_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_validation_rules_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_validation_rules_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_validation_rules_proto_msgTypes,
	}.Build()
	File_metricspb_v2_validation_rules_proto = out.File
	file_metricspb_v2_validation_rules_proto_goTypes = nil
	file_metricspb_v2_validation_rules_proto_depIdxs = nil
}
