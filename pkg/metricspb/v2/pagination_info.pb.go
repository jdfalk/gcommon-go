...
// 	protoc        (unknown)
// source: metricspb/v2/pagination_info.proto
...
func (x *MetricsPaginationInfo) Reset() {
	*x = MetricsPaginationInfo{}
	mi := &file_metricspb_v2_pagination_info_proto_msgTypes[0]
...
var File_metricspb_v2_pagination_info_proto protoreflect.FileDescriptor

const file_metricspb_v2_pagination_info_proto_rawDesc = "" +
	"\n" +
	"\"metricspb/v2/pagination_info.proto\x12\n" +
	"metrics.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc8\x02\n" +
	"\x15MetricsPaginationInfo\x12\x1b\n" +
	"\x04page\x18\x01 \x01(\rB\a\xbaH\x04*\x02(\x00R\x04page\x12$\n" +
	"\tpage_size\x18\x02 \x01(\rB\a\xbaH\x04*\x02(\x00R\bpageSize\x12(\n" +
	"\vtotal_items\x18\x03 \x01(\x04B\a\xbaH\x042\x02(\x00R\n" +
	"totalItems\x12(\n" +
	"\vtotal_pages\x18\x04 \x01(\rB\a\xbaH\x04*\x02(\x00R\n" +
	"totalPages\x12\x19\n" +
	...
	"nextCursor\x120\n" +
	"\x0fprevious_cursor\x18\b \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x0epreviousCursorB\xa2\x01\n" +
	"\x0ecom.metrics.v2B\x13PaginationInfoProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_pagination_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_pagination_info_proto_goTypes = []any{
	(*MetricsPaginationInfo)(nil), // 0: metrics.v2.MetricsPaginationInfo
}
var file_metricspb_v2_pagination_info_proto_depIdxs = []int32{
...
func init() { file_metricspb_v2_pagination_info_proto_init() }
func file_metricspb_v2_pagination_info_proto_init() {
	if File_metricspb_v2_pagination_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_pagination_info_proto_rawDesc), len(file_metricspb_v2_pagination_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_pagination_info_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_pagination_info_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_pagination_info_proto_msgTypes,
	}.Build()
	File_metricspb_v2_pagination_info_proto = out.File
	file_metricspb_v2_pagination_info_proto_goTypes = nil
	file_metricspb_v2_pagination_info_proto_depIdxs = nil
}
