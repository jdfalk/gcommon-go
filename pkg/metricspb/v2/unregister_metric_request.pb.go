...
// 	protoc        (unknown)
// source: metricspb/v2/unregister_metric_request.proto
...
func (x *UnregisterMetricRequest) Reset() {
	*x = UnregisterMetricRequest{}
	mi := &file_metricspb_v2_unregister_metric_request_proto_msgTypes[0]
...
func (x *UnregisterMetricRequest) GetMetadata() *v2.RequestMetadata {
	if x != nil {
...
func (x *UnregisterMetricRequest) SetMetadata(v *v2.RequestMetadata) {
...
func (x case_UnregisterMetricRequest_MetricIdentifier) String() string {
	md := file_metricspb_v2_unregister_metric_request_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_metricspb_v2_unregister_metric_request_proto protoreflect.FileDescriptor

const file_metricspb_v2_unregister_metric_request_proto_rawDesc = "" +
	"\n" +
	",metricspb/v2/unregister_metric_request.proto\x12\n" +
	"metrics.v2\x1a\"commonpb/v2/request_metadata.proto\x1a)metricspb/v2/unregistration_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x91\x02\n" +
	"\x17UnregisterMetricRequest\x126\n" +
	"\bmetadata\x18\x01 \x01(\v2\x1a.common.v2.RequestMetadataR\bmetadata\x12,\n" +
	"\vmetric_name\x18\x02 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dH\x00R\n" +
	"metricName\x12\x1d\n" +
	"\tmetric_id\x18\x03 \x01(\tH\x00R\bmetricId\x12\x1f\n" +
	"\vprovider_id\x18\x04 \x01(\tR\n" +
	"providerId\x12;\n" +
	"\aoptions\x18\x05 \x01(\v2!.metrics.v2.UnregistrationOptionsR\aoptionsB\x13\n" +
	"\x11metric_identifierB\xab\x01\n" +
	"\x0ecom.metrics.v2B\x1cUnregisterMetricRequestProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_unregister_metric_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_unregister_metric_request_proto_goTypes = []any{
	(*UnregisterMetricRequest)(nil), // 0: metrics.v2.UnregisterMetricRequest
	(*v2.RequestMetadata)(nil),      // 1: common.v2.RequestMetadata
	(*UnregistrationOptions)(nil),   // 2: metrics.v2.UnregistrationOptions
}
var file_metricspb_v2_unregister_metric_request_proto_depIdxs = []int32{
	1, // 0: metrics.v2.UnregisterMetricRequest.metadata:type_name -> common.v2.RequestMetadata
	2, // 1: metrics.v2.UnregisterMetricRequest.options:type_name -> metrics.v2.UnregistrationOptions
...
func init() { file_metricspb_v2_unregister_metric_request_proto_init() }
func file_metricspb_v2_unregister_metric_request_proto_init() {
	if File_metricspb_v2_unregister_metric_request_proto != nil {
		return
	}
	file_metricspb_v2_unregistration_options_proto_init()
	file_metricspb_v2_unregister_metric_request_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_unregister_metric_request_proto_rawDesc), len(file_metricspb_v2_unregister_metric_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_unregister_metric_request_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_unregister_metric_request_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_unregister_metric_request_proto_msgTypes,
	}.Build()
	File_metricspb_v2_unregister_metric_request_proto = out.File
	file_metricspb_v2_unregister_metric_request_proto_goTypes = nil
	file_metricspb_v2_unregister_metric_request_proto_depIdxs = nil
}
