...
// 	protoc        (unknown)
// source: metricspb/v2/register_metric_request.proto
...
func (x *RegisterMetricRequest) Reset() {
	*x = RegisterMetricRequest{}
	mi := &file_metricspb_v2_register_metric_request_proto_msgTypes[0]
...
func (x *RegisterMetricRequest) GetMetadata() *v2.RequestMetadata {
	if x != nil {
...
func (x *RegisterMetricRequest) SetMetadata(v *v2.RequestMetadata) {
...
var File_metricspb_v2_register_metric_request_proto protoreflect.FileDescriptor

const file_metricspb_v2_register_metric_request_proto_rawDesc = "" +
	"\n" +
	"*metricspb/v2/register_metric_request.proto\x12\n" +
	"metrics.v2\x1a\"commonpb/v2/request_metadata.proto\x1a$metricspb/v2/metric_definition.proto\x1a'metricspb/v2/registration_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9d\x02\n" +
	"\x15RegisterMetricRequest\x126\n" +
	"\bmetadata\x18\x01 \x01(\v2\x1a.common.v2.RequestMetadataR\bmetadata\x12<\n" +
	"\n" +
	"definition\x18\x02 \x01(\v2\x1c.metrics.v2.MetricDefinitionR\n" +
	"definition\x12(\n" +
	"\vprovider_id\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\n" +
	"providerId\x12)\n" +
	"\x10replace_existing\x18\x04 \x01(\bR\x0freplaceExisting\x129\n" +
	"\aoptions\x18\x05 \x01(\v2\x1f.metrics.v2.RegistrationOptionsR\aoptionsB\xa9\x01\n" +
	"\x0ecom.metrics.v2B\x1aRegisterMetricRequestProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_register_metric_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_register_metric_request_proto_goTypes = []any{
	(*RegisterMetricRequest)(nil), // 0: metrics.v2.RegisterMetricRequest
	(*v2.RequestMetadata)(nil),    // 1: common.v2.RequestMetadata
	(*MetricDefinition)(nil),      // 2: metrics.v2.MetricDefinition
	(*RegistrationOptions)(nil),   // 3: metrics.v2.RegistrationOptions
}
var file_metricspb_v2_register_metric_request_proto_depIdxs = []int32{
	1, // 0: metrics.v2.RegisterMetricRequest.metadata:type_name -> common.v2.RequestMetadata
	2, // 1: metrics.v2.RegisterMetricRequest.definition:type_name -> metrics.v2.MetricDefinition
	3, // 2: metrics.v2.RegisterMetricRequest.options:type_name -> metrics.v2.RegistrationOptions
...
func init() { file_metricspb_v2_register_metric_request_proto_init() }
func file_metricspb_v2_register_metric_request_proto_init() {
	if File_metricspb_v2_register_metric_request_proto != nil {
		return
	}
	file_metricspb_v2_metric_definition_proto_init()
	file_metricspb_v2_registration_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_register_metric_request_proto_rawDesc), len(file_metricspb_v2_register_metric_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_register_metric_request_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_register_metric_request_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_register_metric_request_proto_msgTypes,
	}.Build()
	File_metricspb_v2_register_metric_request_proto = out.File
	file_metricspb_v2_register_metric_request_proto_goTypes = nil
	file_metricspb_v2_register_metric_request_proto_depIdxs = nil
}
