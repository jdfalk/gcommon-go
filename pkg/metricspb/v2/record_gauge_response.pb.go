...
// 	protoc        (unknown)
// source: metricspb/v2/record_gauge_response.proto
...
func (x *RecordGaugeResponse) Reset() {
	*x = RecordGaugeResponse{}
	mi := &file_metricspb_v2_record_gauge_response_proto_msgTypes[0]
...
func (x *RecordGaugeResponse) GetError() *v2.Error {
	if x != nil {
...
func (x *RecordGaugeResponse) SetError(v *v2.Error) {
...
var File_metricspb_v2_record_gauge_response_proto protoreflect.FileDescriptor

const file_metricspb_v2_record_gauge_response_proto_rawDesc = "" +
	"\n" +
	"(metricspb/v2/record_gauge_response.proto\x12\n" +
	"metrics.v2\x1a\x17commonpb/v2/error.proto\x1a\x1fmetricspb/v2/gauge_metric.proto\x1a\"metricspb/v2/recording_stats.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xd2\x02\n" +
	"\x13RecordGaugeResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12&\n" +
	"\x05error\x18\x02 \x01(\v2\x10.common.v2.ErrorR\x05error\x12/\n" +
	"\x06metric\x18\x03 \x01(\v2\x17.metrics.v2.GaugeMetricR\x06metric\x125\n" +
	...
	"\x05stats\x18\a \x01(\v2\x1a.metrics.v2.RecordingStatsR\x05statsB\xa7\x01\n" +
	"\x0ecom.metrics.v2B\x18RecordGaugeResponseProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_record_gauge_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_record_gauge_response_proto_goTypes = []any{
	(*RecordGaugeResponse)(nil),   // 0: metrics.v2.RecordGaugeResponse
	(*v2.Error)(nil),              // 1: common.v2.Error
	(*GaugeMetric)(nil),           // 2: metrics.v2.GaugeMetric
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
	(*RecordingStats)(nil),        // 4: metrics.v2.RecordingStats
}
var file_metricspb_v2_record_gauge_response_proto_depIdxs = []int32{
	1, // 0: metrics.v2.RecordGaugeResponse.error:type_name -> common.v2.Error
	2, // 1: metrics.v2.RecordGaugeResponse.metric:type_name -> metrics.v2.GaugeMetric
	3, // 2: metrics.v2.RecordGaugeResponse.recorded_at:type_name -> google.protobuf.Timestamp
	4, // 3: metrics.v2.RecordGaugeResponse.stats:type_name -> metrics.v2.RecordingStats
...
func init() { file_metricspb_v2_record_gauge_response_proto_init() }
func file_metricspb_v2_record_gauge_response_proto_init() {
	if File_metricspb_v2_record_gauge_response_proto != nil {
		return
	}
	file_metricspb_v2_gauge_metric_proto_init()
	file_metricspb_v2_recording_stats_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_record_gauge_response_proto_rawDesc), len(file_metricspb_v2_record_gauge_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_record_gauge_response_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_record_gauge_response_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_record_gauge_response_proto_msgTypes,
	}.Build()
	File_metricspb_v2_record_gauge_response_proto = out.File
	file_metricspb_v2_record_gauge_response_proto_goTypes = nil
	file_metricspb_v2_record_gauge_response_proto_depIdxs = nil
}
