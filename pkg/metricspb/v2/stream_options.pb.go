...
// 	protoc        (unknown)
// source: metricspb/v2/stream_options.proto
...
type StreamOptions struct {
	...
	xxx_hidden_Compression              v2.StreamCompression   `protobuf:"varint,5,opt,name=compression,enum=common.v2.StreamCompression"`
	...
	xxx_hidden_Qos                      v2.StreamQOS           `protobuf:"varint,9,opt,name=qos,enum=common.v2.StreamQOS"`
...
func (x *StreamOptions) Reset() {
	*x = StreamOptions{}
	mi := &file_metricspb_v2_stream_options_proto_msgTypes[0]
...
func (x *StreamOptions) GetCompression() v2.StreamCompression {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 4) {
			return x.xxx_hidden_Compression
		}
	}
	return v2.StreamCompression(0)
}
...
func (x *StreamOptions) GetQos() v2.StreamQOS {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 8) {
			return x.xxx_hidden_Qos
		}
	}
	return v2.StreamQOS(0)
}
...
func (x *StreamOptions) SetCompression(v v2.StreamCompression) {
...
func (x *StreamOptions) SetQos(v v2.StreamQOS) {
	x.xxx_hidden_Qos = v
...
func (x *StreamOptions) ClearCompression() {
	...
	x.xxx_hidden_Compression = v2.StreamCompression_STREAM_COMPRESSION_UNSPECIFIED
}
...
func (x *StreamOptions) ClearQos() {
	...
	x.xxx_hidden_Qos = v2.StreamQOS_STREAM_QOS_UNSPECIFIED
}
...
type StreamOptions_builder struct {
	...
	Compression *v2.StreamCompression
...
var File_metricspb_v2_stream_options_proto protoreflect.FileDescriptor

const file_metricspb_v2_stream_options_proto_rawDesc = "" +
	"\n" +
	"!metricspb/v2/stream_options.proto\x12\n" +
	"metrics.v2\x1a$commonpb/v2/stream_compression.proto\x1a\x1ccommonpb/v2/stream_qos.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbb\x03\n" +
	"\rStreamOptions\x12-\n" +
	...
	"\vcompression\x18\x05 \x01(\x0e2\x1c.common.v2.StreamCompressionR\vcompression\x12'\n" +
	...
	"\x03qos\x18\t \x01(\x0e2\x14.common.v2.StreamQOSR\x03qosB\xa1\x01\n" +
	"\x0ecom.metrics.v2B\x12StreamOptionsProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_stream_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_stream_options_proto_goTypes = []any{
	(*StreamOptions)(nil),     // 0: metrics.v2.StreamOptions
	(v2.StreamCompression)(0), // 1: common.v2.StreamCompression
	(v2.StreamQOS)(0),         // 2: common.v2.StreamQOS
}
var file_metricspb_v2_stream_options_proto_depIdxs = []int32{
	1, // 0: metrics.v2.StreamOptions.compression:type_name -> common.v2.StreamCompression
	2, // 1: metrics.v2.StreamOptions.qos:type_name -> common.v2.StreamQOS
...
func init() { file_metricspb_v2_stream_options_proto_init() }
func file_metricspb_v2_stream_options_proto_init() {
	if File_metricspb_v2_stream_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_stream_options_proto_rawDesc), len(file_metricspb_v2_stream_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_stream_options_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_stream_options_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_stream_options_proto_msgTypes,
	}.Build()
	File_metricspb_v2_stream_options_proto = out.File
	file_metricspb_v2_stream_options_proto_goTypes = nil
	file_metricspb_v2_stream_options_proto_depIdxs = nil
}
