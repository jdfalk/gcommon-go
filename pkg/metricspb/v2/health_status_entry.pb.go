...
// 	protoc        (unknown)
// source: metricspb/v2/health_status_entry.proto
...
func (x *HealthStatusEntry) Reset() {
	*x = HealthStatusEntry{}
	mi := &file_metricspb_v2_health_status_entry_proto_msgTypes[0]
...
var File_metricspb_v2_health_status_entry_proto protoreflect.FileDescriptor

const file_metricspb_v2_health_status_entry_proto_rawDesc = "" +
	"\n" +
	"&metricspb/v2/health_status_entry.proto\x12\n" +
	"metrics.v2\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xab\x01\n" +
	"\x11HealthStatusEntry\x128\n" +
	"\ttimestamp\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12,\n" +
	"\rhealth_status\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\fhealthStatus\x12.\n" +
	"\x0estatus_message\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\rstatusMessageB\xa5\x01\n" +
	"\x0ecom.metrics.v2B\x16HealthStatusEntryProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_health_status_entry_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_health_status_entry_proto_goTypes = []any{
	(*HealthStatusEntry)(nil),     // 0: metrics.v2.HealthStatusEntry
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_metricspb_v2_health_status_entry_proto_depIdxs = []int32{
	1, // 0: metrics.v2.HealthStatusEntry.timestamp:type_name -> google.protobuf.Timestamp
...
func init() { file_metricspb_v2_health_status_entry_proto_init() }
func file_metricspb_v2_health_status_entry_proto_init() {
	if File_metricspb_v2_health_status_entry_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_health_status_entry_proto_rawDesc), len(file_metricspb_v2_health_status_entry_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_health_status_entry_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_health_status_entry_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_health_status_entry_proto_msgTypes,
	}.Build()
	File_metricspb_v2_health_status_entry_proto = out.File
	file_metricspb_v2_health_status_entry_proto_goTypes = nil
	file_metricspb_v2_health_status_entry_proto_depIdxs = nil
}
