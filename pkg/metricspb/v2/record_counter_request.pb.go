...
// 	protoc        (unknown)
// source: metricspb/v2/record_counter_request.proto
...
func (x *RecordCounterRequest) Reset() {
	*x = RecordCounterRequest{}
	mi := &file_metricspb_v2_record_counter_request_proto_msgTypes[0]
...
func (x *RecordCounterRequest) GetMetadata() *v2.RequestMetadata {
	if x != nil {
...
func (x *RecordCounterRequest) SetMetadata(v *v2.RequestMetadata) {
...
var File_metricspb_v2_record_counter_request_proto protoreflect.FileDescriptor

const file_metricspb_v2_record_counter_request_proto_rawDesc = "" +
	"\n" +
	")metricspb/v2/record_counter_request.proto\x12\n" +
	"metrics.v2\x1a\"commonpb/v2/request_metadata.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xcd\x02\n" +
	...
	"\x06labels\x18\x03 \x03(\v2,.metrics.v2.RecordCounterRequest.LabelsEntryR\x06labels\x12\x12\n" +
	"\x04help\x18\x04 \x01(\tR\x04help\x12\x12\n" +
	"\x04unit\x18\x05 \x01(\tR\x04unit\x12\x1f\n" +
	"\vsample_rate\x18\x06 \x01(\x01R\n" +
	"sampleRate\x126\n" +
	"\bmetadata\x18\a \x01(\v2\x1a.common.v2.RequestMetadataR\bmetadata\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xa8\x01\n" +
	"\x0ecom.metrics.v2B\x19RecordCounterRequestProtoP\x01Z*github.com/jdfalk/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_record_counter_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_metricspb_v2_record_counter_request_proto_goTypes = []any{
	(*RecordCounterRequest)(nil), // 0: metrics.v2.RecordCounterRequest
	nil,                          // 1: metrics.v2.RecordCounterRequest.LabelsEntry
	(*v2.RequestMetadata)(nil),   // 2: common.v2.RequestMetadata
}
var file_metricspb_v2_record_counter_request_proto_depIdxs = []int32{
	1, // 0: metrics.v2.RecordCounterRequest.labels:type_name -> metrics.v2.RecordCounterRequest.LabelsEntry
	2, // 1: metrics.v2.RecordCounterRequest.metadata:type_name -> common.v2.RequestMetadata
...
func init() { file_metricspb_v2_record_counter_request_proto_init() }
func file_metricspb_v2_record_counter_request_proto_init() {
	if File_metricspb_v2_record_counter_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_record_counter_request_proto_rawDesc), len(file_metricspb_v2_record_counter_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_record_counter_request_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_record_counter_request_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_record_counter_request_proto_msgTypes,
	}.Build()
	File_metricspb_v2_record_counter_request_proto = out.File
	file_metricspb_v2_record_counter_request_proto_goTypes = nil
	file_metricspb_v2_record_counter_request_proto_depIdxs = nil
}
