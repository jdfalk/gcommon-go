...
// 	protoc        (unknown)
// source: metricspb/v2/record_histogram_response.proto
...
func (x *RecordHistogramResponse) Reset() {
	*x = RecordHistogramResponse{}
	mi := &file_metricspb_v2_record_histogram_response_proto_msgTypes[0]
...
var File_metricspb_v2_record_histogram_response_proto protoreflect.FileDescriptor

const file_metricspb_v2_record_histogram_response_proto_rawDesc = "" +
	"\n" +
	",metricspb/v2/record_histogram_response.proto\x12\n" +
	"metrics.v2\x1a\x17commonpb/v2/error.proto\x1a\x1emetricspb/v2/bucket_info.proto\x1a#metricspb/v2/histogram_metric.proto\x1a\"metricspb/v2/histogram_stats.proto\x1a\"metricspb/v2/recording_stats.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb8\x03\n" +
...
var file_metricspb_v2_record_histogram_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_record_histogram_response_proto_goTypes = []any{
...
var file_metricspb_v2_record_histogram_response_proto_depIdxs = []int32{
...
func init() { file_metricspb_v2_record_histogram_response_proto_init() }
func file_metricspb_v2_record_histogram_response_proto_init() {
	if File_metricspb_v2_record_histogram_response_proto != nil {
		return
	}
	file_metricspb_v2_bucket_info_proto_init()
	file_metricspb_v2_histogram_metric_proto_init()
	file_metricspb_v2_histogram_stats_proto_init()
	file_metricspb_v2_recording_stats_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_record_histogram_response_proto_rawDesc), len(file_metricspb_v2_record_histogram_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_record_histogram_response_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_record_histogram_response_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_record_histogram_response_proto_msgTypes,
	}.Build()
	File_metricspb_v2_record_histogram_response_proto = out.File
	file_metricspb_v2_record_histogram_response_proto_goTypes = nil
	file_metricspb_v2_record_histogram_response_proto_depIdxs = nil
}
