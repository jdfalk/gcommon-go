...
// 	protoc        (unknown)
// source: metricspb/v1/security_summary.proto
...
func (x *SecuritySummary) Reset() {
	*x = SecuritySummary{}
	mi := &file_metricspb_v1_security_summary_proto_msgTypes[0]
...
var File_metricspb_v1_security_summary_proto protoreflect.FileDescriptor

const file_metricspb_v1_security_summary_proto_rawDesc = "" +
	"\n" +
	"#metricspb/v1/security_summary.proto\x12\n" +
	"metrics.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x82\x01\n" +
	"\x0fSecuritySummary\x12!\n" +
	"\fauth_enabled\x18\x01 \x01(\bR\vauthEnabled\x12\x1f\n" +
	"\vtls_enabled\x18\x02 \x01(\bR\n" +
	"tlsEnabled\x12+\n" +
	"\fauth_methods\x18\x03 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\vauthMethodsB\xa0\x01\n" +
	"\x0ecom.metrics.v1B\x14SecuritySummaryProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_security_summary_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_security_summary_proto_goTypes = []any{
	(*SecuritySummary)(nil), // 0: metrics.v1.SecuritySummary
}
var file_metricspb_v1_security_summary_proto_depIdxs = []int32{
...
func init() { file_metricspb_v1_security_summary_proto_init() }
func file_metricspb_v1_security_summary_proto_init() {
	if File_metricspb_v1_security_summary_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_security_summary_proto_rawDesc), len(file_metricspb_v1_security_summary_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_security_summary_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_security_summary_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_security_summary_proto_msgTypes,
	}.Build()
	File_metricspb_v1_security_summary_proto = out.File
	file_metricspb_v1_security_summary_proto_goTypes = nil
	file_metricspb_v1_security_summary_proto_depIdxs = nil
}
