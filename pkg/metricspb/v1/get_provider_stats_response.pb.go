...
// 	protoc        (unknown)
// source: metricspb/v1/get_provider_stats_response.proto
...
type GetProviderStatsResponse struct {
	...
	xxx_hidden_TimeRange   *commonpb.TimeRangeMetrics `protobuf:"bytes,6,opt,name=time_range,json=timeRange"`
...
func (x *GetProviderStatsResponse) Reset() {
	*x = GetProviderStatsResponse{}
	mi := &file_metricspb_v1_get_provider_stats_response_proto_msgTypes[0]
...
func (x *GetProviderStatsResponse) GetError() *commonpb.Error {
	if x != nil {
...
func (x *GetProviderStatsResponse) GetTimeRange() *commonpb.TimeRangeMetrics {
	if x != nil {
...
func (x *GetProviderStatsResponse) SetError(v *commonpb.Error) {
...
func (x *GetProviderStatsResponse) SetTimeRange(v *commonpb.TimeRangeMetrics) {
...
var File_metricspb_v1_get_provider_stats_response_proto protoreflect.FileDescriptor

const file_metricspb_v1_get_provider_stats_response_proto_rawDesc = "" +
	"\n" +
	".metricspb/v1/get_provider_stats_response.proto\x12\n" +
	"metrics.v1\x1a\x17commonpb/v1/error.proto\x1a$commonpb/v1/time_range_metrics.proto\x1a&metricspb/v1/provider_statistics.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xe7\x02\n" +
	...
	"providerId\x12>\n" +
	"\n" +
	"statistics\x18\x04 \x01(\v2\x1e.metrics.v1.ProviderStatisticsR\n" +
	"statistics\x12=\n" +
	"\fgenerated_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\vgeneratedAt\x12:\n" +
	"\n" +
	"time_range\x18\x06 \x01(\v2\x1b.common.v1.TimeRangeMetricsR\ttimeRange\x12$\n" +
	"\bwarnings\x18\a \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\bwarningsB\xa9\x01\n" +
	"\x0ecom.metrics.v1B\x1dGetProviderStatsResponseProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_get_provider_stats_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_get_provider_stats_response_proto_goTypes = []any{
	(*GetProviderStatsResponse)(nil),  // 0: metrics.v1.GetProviderStatsResponse
	(*commonpb.Error)(nil),            // 1: common.v1.Error
	(*ProviderStatistics)(nil),        // 2: metrics.v1.ProviderStatistics
	(*timestamppb.Timestamp)(nil),     // 3: google.protobuf.Timestamp
	(*commonpb.TimeRangeMetrics)(nil), // 4: common.v1.TimeRangeMetrics
}
var file_metricspb_v1_get_provider_stats_response_proto_depIdxs = []int32{
	1, // 0: metrics.v1.GetProviderStatsResponse.error:type_name -> common.v1.Error
	2, // 1: metrics.v1.GetProviderStatsResponse.statistics:type_name -> metrics.v1.ProviderStatistics
	3, // 2: metrics.v1.GetProviderStatsResponse.generated_at:type_name -> google.protobuf.Timestamp
	4, // 3: metrics.v1.GetProviderStatsResponse.time_range:type_name -> common.v1.TimeRangeMetrics
...
func init() { file_metricspb_v1_get_provider_stats_response_proto_init() }
func file_metricspb_v1_get_provider_stats_response_proto_init() {
	if File_metricspb_v1_get_provider_stats_response_proto != nil {
		return
	}
	file_metricspb_v1_provider_statistics_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_get_provider_stats_response_proto_rawDesc), len(file_metricspb_v1_get_provider_stats_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_get_provider_stats_response_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_get_provider_stats_response_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_get_provider_stats_response_proto_msgTypes,
	}.Build()
	File_metricspb_v1_get_provider_stats_response_proto = out.File
	file_metricspb_v1_get_provider_stats_response_proto_goTypes = nil
	file_metricspb_v1_get_provider_stats_response_proto_depIdxs = nil
}
