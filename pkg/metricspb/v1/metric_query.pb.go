...
// 	protoc        (unknown)
// source: metricspb/v1/metric_query.proto
...
type MetricQuery struct {
	...
	xxx_hidden_TimeFilter   *commonpb.TimeRangeMetrics `protobuf:"bytes,5,opt,name=time_filter,json=timeFilter"`
	...
	xxx_hidden_SortCriteria *[]*commonpb.SortOptions   `protobuf:"bytes,8,rep,name=sort_criteria,json=sortCriteria"`
...
func (x *MetricQuery) Reset() {
	*x = MetricQuery{}
	mi := &file_metricspb_v1_metric_query_proto_msgTypes[0]
...
func (x *MetricQuery) GetTimeFilter() *commonpb.TimeRangeMetrics {
	if x != nil {
...
func (x *MetricQuery) GetSortCriteria() []*commonpb.SortOptions {
	if x != nil {
...
func (x *MetricQuery) SetTimeFilter(v *commonpb.TimeRangeMetrics) {
...
func (x *MetricQuery) SetSortCriteria(v []*commonpb.SortOptions) {
...
type MetricQuery_builder struct {
	...
	TimeFilter *commonpb.TimeRangeMetrics
	// Aggregation operations to apply
	Aggregations []*AggregationSpec
	// Group by specifications
	GroupBy []*GroupBySpec
	// Sort criteria
	SortCriteria []*commonpb.SortOptions
...
var File_metricspb_v1_metric_query_proto protoreflect.FileDescriptor

const file_metricspb_v1_metric_query_proto_rawDesc = "" +
	"\n" +
	"\x1fmetricspb/v1/metric_query.proto\x12\n" +
	"metrics.v1\x1a\x1ecommonpb/v1/sort_options.proto\x1a$commonpb/v1/time_range_metrics.proto\x1a#metricspb/v1/aggregation_spec.proto\x1a metricspb/v1/group_by_spec.proto\x1a metricspb/v1/metric_filter.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xba\x03\n" +
	...
	"\x06filter\x18\x04 \x01(\v2\x18.metrics.v1.MetricFilterR\x06filter\x12<\n" +
	"\vtime_filter\x18\x05 \x01(\v2\x1b.common.v1.TimeRangeMetricsR\n" +
	"timeFilter\x12?\n" +
	"\faggregations\x18\x06 \x03(\v2\x1b.metrics.v1.AggregationSpecR\faggregations\x122\n" +
	"\bgroup_by\x18\a \x03(\v2\x17.metrics.v1.GroupBySpecR\agroupBy\x12;\n" +
	"\rsort_criteria\x18\b \x03(\v2\x16.common.v1.SortOptionsR\fsortCriteria\x12\x14\n" +
	"\x05limit\x18\t \x01(\x05R\x05limit\x12\x16\n" +
	"\x06offset\x18\n" +
	" \x01(\x05R\x06offsetB\x9c\x01\n" +
	"\x0ecom.metrics.v1B\x10MetricQueryProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_metric_query_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_metric_query_proto_goTypes = []any{
	...
	(*commonpb.SortOptions)(nil),      // 5: common.v1.SortOptions
}
var file_metricspb_v1_metric_query_proto_depIdxs = []int32{
	1, // 0: metrics.v1.MetricQuery.filter:type_name -> metrics.v1.MetricFilter
	2, // 1: metrics.v1.MetricQuery.time_filter:type_name -> common.v1.TimeRangeMetrics
	3, // 2: metrics.v1.MetricQuery.aggregations:type_name -> metrics.v1.AggregationSpec
	4, // 3: metrics.v1.MetricQuery.group_by:type_name -> metrics.v1.GroupBySpec
	5, // 4: metrics.v1.MetricQuery.sort_criteria:type_name -> common.v1.SortOptions
...
func init() { file_metricspb_v1_metric_query_proto_init() }
func file_metricspb_v1_metric_query_proto_init() {
	if File_metricspb_v1_metric_query_proto != nil {
		return
	}
	file_metricspb_v1_aggregation_spec_proto_init()
	file_metricspb_v1_group_by_spec_proto_init()
	file_metricspb_v1_metric_filter_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_metric_query_proto_rawDesc), len(file_metricspb_v1_metric_query_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_metric_query_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_metric_query_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_metric_query_proto_msgTypes,
	}.Build()
	File_metricspb_v1_metric_query_proto = out.File
	file_metricspb_v1_metric_query_proto_goTypes = nil
	file_metricspb_v1_metric_query_proto_depIdxs = nil
}
