...
// 	protoc        (unknown)
// source: metricspb/v1/record_metric_request.proto
...
func (x *RecordMetricRequest) Reset() {
	*x = RecordMetricRequest{}
	mi := &file_metricspb_v1_record_metric_request_proto_msgTypes[0]
...
func (x *RecordMetricRequest) GetMetadata() *commonpb.RequestMetadata {
	if x != nil {
...
func (x *RecordMetricRequest) SetMetadata(v *commonpb.RequestMetadata) {
...
var File_metricspb_v1_record_metric_request_proto protoreflect.FileDescriptor

const file_metricspb_v1_record_metric_request_proto_rawDesc = "" +
	"\n" +
	"(metricspb/v1/record_metric_request.proto\x12\n" +
	"metrics.v1\x1a\"commonpb/v1/request_metadata.proto\x1a metricspb/v1/batch_context.proto\x1a\x1emetricspb/v1/metric_data.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xbc\x02\n" +
	"\x13RecordMetricRequest\x126\n" +
	"\bmetadata\x18\x01 \x01(\v2\x1a.common.v1.RequestMetadataR\bmetadata\x12.\n" +
	"\x06metric\x18\x02 \x01(\v2\x16.metrics.v1.MetricDataR\x06metric\x12(\n" +
	...
	"\rbatch_context\x18\x06 \x01(\v2\x18.metrics.v1.BatchContextR\fbatchContextB\xa4\x01\n" +
	"\x0ecom.metrics.v1B\x18RecordMetricRequestProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_record_metric_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_record_metric_request_proto_goTypes = []any{
...
var file_metricspb_v1_record_metric_request_proto_depIdxs = []int32{
	1, // 0: metrics.v1.RecordMetricRequest.metadata:type_name -> common.v1.RequestMetadata
	2, // 1: metrics.v1.RecordMetricRequest.metric:type_name -> metrics.v1.MetricData
	3, // 2: metrics.v1.RecordMetricRequest.timestamp:type_name -> google.protobuf.Timestamp
	4, // 3: metrics.v1.RecordMetricRequest.batch_context:type_name -> metrics.v1.BatchContext
...
func init() { file_metricspb_v1_record_metric_request_proto_init() }
func file_metricspb_v1_record_metric_request_proto_init() {
	if File_metricspb_v1_record_metric_request_proto != nil {
		return
	}
	file_metricspb_v1_batch_context_proto_init()
	file_metricspb_v1_metric_data_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_record_metric_request_proto_rawDesc), len(file_metricspb_v1_record_metric_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_record_metric_request_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_record_metric_request_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_record_metric_request_proto_msgTypes,
	}.Build()
	File_metricspb_v1_record_metric_request_proto = out.File
	file_metricspb_v1_record_metric_request_proto_goTypes = nil
	file_metricspb_v1_record_metric_request_proto_depIdxs = nil
}
