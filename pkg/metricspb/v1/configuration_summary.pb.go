...
// 	protoc        (unknown)
// source: metricspb/v1/configuration_summary.proto
...
func (x *ConfigurationSummary) Reset() {
	*x = ConfigurationSummary{}
	mi := &file_metricspb_v1_configuration_summary_proto_msgTypes[0]
...
var File_metricspb_v1_configuration_summary_proto protoreflect.FileDescriptor

const file_metricspb_v1_configuration_summary_proto_rawDesc = "" +
	"\n" +
	"(metricspb/v1/configuration_summary.proto\x12\n" +
	"metrics.v1\x1a*metricspb/v1/resource_limits_summary.proto\x1a#metricspb/v1/security_summary.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x8f\x02\n" +
	"\x14ConfigurationSummary\x122\n" +
	"\x0eexporter_count\x18\x01 \x01(\x05B\v\xbaH\b\x1a\x06\x18\xff\xff\x03(\x01R\rexporterCount\x127\n" +
	"\bsecurity\x18\x02 \x01(\v2\x1b.metrics.v1.SecuritySummaryR\bsecurity\x12J\n" +
	"\x0fresource_limits\x18\x03 \x01(\v2!.metrics.v1.ResourceLimitsSummaryR\x0eresourceLimits\x12>\n" +
	"\x0econfig_version\x18\x04 \x01(\tB\x17\xbaH\x14r\x122\x10^v?\\d+\\.\\d+\\.\\d+R\rconfigVersionB\xa5\x01\n" +
	"\x0ecom.metrics.v1B\x19ConfigurationSummaryProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_configuration_summary_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_configuration_summary_proto_goTypes = []any{
	(*ConfigurationSummary)(nil),  // 0: metrics.v1.ConfigurationSummary
	(*SecuritySummary)(nil),       // 1: metrics.v1.SecuritySummary
	(*ResourceLimitsSummary)(nil), // 2: metrics.v1.ResourceLimitsSummary
}
var file_metricspb_v1_configuration_summary_proto_depIdxs = []int32{
	1, // 0: metrics.v1.ConfigurationSummary.security:type_name -> metrics.v1.SecuritySummary
	2, // 1: metrics.v1.ConfigurationSummary.resource_limits:type_name -> metrics.v1.ResourceLimitsSummary
...
func init() { file_metricspb_v1_configuration_summary_proto_init() }
func file_metricspb_v1_configuration_summary_proto_init() {
	if File_metricspb_v1_configuration_summary_proto != nil {
		return
	}
	file_metricspb_v1_resource_limits_summary_proto_init()
	file_metricspb_v1_security_summary_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_configuration_summary_proto_rawDesc), len(file_metricspb_v1_configuration_summary_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_configuration_summary_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_configuration_summary_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_configuration_summary_proto_msgTypes,
	}.Build()
	File_metricspb_v1_configuration_summary_proto = out.File
	file_metricspb_v1_configuration_summary_proto_goTypes = nil
	file_metricspb_v1_configuration_summary_proto_depIdxs = nil
}
