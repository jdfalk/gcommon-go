...
// 	protoc        (unknown)
// source: metricspb/v1/summary_metric.proto
...
func (x *SummaryMetric) Reset() {
	*x = SummaryMetric{}
	mi := &file_metricspb_v1_summary_metric_proto_msgTypes[0]
...
func (x *SummaryMetric) GetMetadata() *commonpb.RequestMetadata {
	if x != nil {
...
func (x *SummaryMetric) SetMetadata(v *commonpb.RequestMetadata) {
...
var File_metricspb_v1_summary_metric_proto protoreflect.FileDescriptor

const file_metricspb_v1_summary_metric_proto_rawDesc = "" +
	"\n" +
	"!metricspb/v1/summary_metric.proto\x12\n" +
	"metrics.v1\x1a\"commonpb/v1/request_metadata.proto\x1a#metricspb/v1/summary_quantile.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xf3\x03\n" +
	...
	"\tquantiles\x18\x04 \x03(\v2\x1b.metrics.v1.SummaryQuantileR\tquantiles\x12=\n" +
	"\x06labels\x18\x05 \x03(\v2%.metrics.v1.SummaryMetric.LabelsEntryR\x06labels\x128\n" +
	...
	"\x0ecom.metrics.v1B\x12SummaryMetricProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_summary_metric_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_metricspb_v1_summary_metric_proto_goTypes = []any{
...
var file_metricspb_v1_summary_metric_proto_depIdxs = []int32{
	2, // 0: metrics.v1.SummaryMetric.quantiles:type_name -> metrics.v1.SummaryQuantile
	1, // 1: metrics.v1.SummaryMetric.labels:type_name -> metrics.v1.SummaryMetric.LabelsEntry
	3, // 2: metrics.v1.SummaryMetric.timestamp:type_name -> google.protobuf.Timestamp
	4, // 3: metrics.v1.SummaryMetric.max_age:type_name -> google.protobuf.Duration
	5, // 4: metrics.v1.SummaryMetric.metadata:type_name -> common.v1.RequestMetadata
...
func init() { file_metricspb_v1_summary_metric_proto_init() }
func file_metricspb_v1_summary_metric_proto_init() {
	if File_metricspb_v1_summary_metric_proto != nil {
		return
	}
	file_metricspb_v1_summary_quantile_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_summary_metric_proto_rawDesc), len(file_metricspb_v1_summary_metric_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_summary_metric_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_summary_metric_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_summary_metric_proto_msgTypes,
	}.Build()
	File_metricspb_v1_summary_metric_proto = out.File
	file_metricspb_v1_summary_metric_proto_goTypes = nil
	file_metricspb_v1_summary_metric_proto_depIdxs = nil
}
