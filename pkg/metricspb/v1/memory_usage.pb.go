...
// 	protoc        (unknown)
// source: metricspb/v1/memory_usage.proto
...
func (x *MemoryUsage) Reset() {
	*x = MemoryUsage{}
	mi := &file_metricspb_v1_memory_usage_proto_msgTypes[0]
...
var File_metricspb_v1_memory_usage_proto protoreflect.FileDescriptor

const file_metricspb_v1_memory_usage_proto_rawDesc = "" +
	"\n" +
	"\x1fmetricspb/v1/memory_usage.proto\x12\n" +
	"metrics.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc5\x01\n" +
	"\vMemoryUsage\x12&\n" +
	"\n" +
...
var file_metricspb_v1_memory_usage_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_memory_usage_proto_goTypes = []any{
	(*MemoryUsage)(nil), // 0: metrics.v1.MemoryUsage
}
var file_metricspb_v1_memory_usage_proto_depIdxs = []int32{
...
func init() { file_metricspb_v1_memory_usage_proto_init() }
func file_metricspb_v1_memory_usage_proto_init() {
	if File_metricspb_v1_memory_usage_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_memory_usage_proto_rawDesc), len(file_metricspb_v1_memory_usage_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_memory_usage_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_memory_usage_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_memory_usage_proto_msgTypes,
	}.Build()
	File_metricspb_v1_memory_usage_proto = out.File
	file_metricspb_v1_memory_usage_proto_goTypes = nil
	file_metricspb_v1_memory_usage_proto_depIdxs = nil
}
