...
// 	protoc        (unknown)
// source: metricspb/v1/health_status_entry.proto
...
func (x *HealthStatusEntry) Reset() {
	*x = HealthStatusEntry{}
	mi := &file_metricspb_v1_health_status_entry_proto_msgTypes[0]
...
var File_metricspb_v1_health_status_entry_proto protoreflect.FileDescriptor

const file_metricspb_v1_health_status_entry_proto_rawDesc = "" +
	"\n" +
	"&metricspb/v1/health_status_entry.proto\x12\n" +
	"metrics.v1\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xab\x01\n" +
...
var file_metricspb_v1_health_status_entry_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_health_status_entry_proto_goTypes = []any{
	(*HealthStatusEntry)(nil),     // 0: metrics.v1.HealthStatusEntry
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_metricspb_v1_health_status_entry_proto_depIdxs = []int32{
	1, // 0: metrics.v1.HealthStatusEntry.timestamp:type_name -> google.protobuf.Timestamp
...
func init() { file_metricspb_v1_health_status_entry_proto_init() }
func file_metricspb_v1_health_status_entry_proto_init() {
	if File_metricspb_v1_health_status_entry_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_health_status_entry_proto_rawDesc), len(file_metricspb_v1_health_status_entry_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_health_status_entry_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_health_status_entry_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_health_status_entry_proto_msgTypes,
	}.Build()
	File_metricspb_v1_health_status_entry_proto = out.File
	file_metricspb_v1_health_status_entry_proto_goTypes = nil
	file_metricspb_v1_health_status_entry_proto_depIdxs = nil
}
