...
// 	protoc        (unknown)
// source: metricspb/v1/get_provider_stats_request.proto
...
func (x *GetProviderStatsRequest) Reset() {
	*x = GetProviderStatsRequest{}
	mi := &file_metricspb_v1_get_provider_stats_request_proto_msgTypes[0]
...
func (x *GetProviderStatsRequest) GetMetadata() *commonpb.RequestMetadata {
	if x != nil {
...
func (x *GetProviderStatsRequest) GetTimeRange() *commonpb.TimeRangeMetrics {
	if x != nil {
...
func (x *GetProviderStatsRequest) SetMetadata(v *commonpb.RequestMetadata) {
...
func (x *GetProviderStatsRequest) SetTimeRange(v *commonpb.TimeRangeMetrics) {
...
var File_metricspb_v1_get_provider_stats_request_proto protoreflect.FileDescriptor

const file_metricspb_v1_get_provider_stats_request_proto_rawDesc = "" +
	"\n" +
	"-metricspb/v1/get_provider_stats_request.proto\x12\n" +
	"metrics.v1\x1a\"commonpb/v1/request_metadata.proto\x1a$commonpb/v1/time_range_metrics.proto\x1a metricspb/v1/stats_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb8\x02\n" +
	...
	"\x10include_realtime\x18\x06 \x01(\bR\x0fincludeRealtimeB\xa8\x01\n" +
	"\x0ecom.metrics.v1B\x1cGetProviderStatsRequestProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_get_provider_stats_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_get_provider_stats_request_proto_goTypes = []any{
...
var file_metricspb_v1_get_provider_stats_request_proto_depIdxs = []int32{
	1, // 0: metrics.v1.GetProviderStatsRequest.metadata:type_name -> common.v1.RequestMetadata
	2, // 1: metrics.v1.GetProviderStatsRequest.time_range:type_name -> common.v1.TimeRangeMetrics
	3, // 2: metrics.v1.GetProviderStatsRequest.options:type_name -> metrics.v1.StatsOptions
...
func init() { file_metricspb_v1_get_provider_stats_request_proto_init() }
func file_metricspb_v1_get_provider_stats_request_proto_init() {
	if File_metricspb_v1_get_provider_stats_request_proto != nil {
		return
	}
	file_metricspb_v1_stats_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_get_provider_stats_request_proto_rawDesc), len(file_metricspb_v1_get_provider_stats_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_get_provider_stats_request_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_get_provider_stats_request_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_get_provider_stats_request_proto_msgTypes,
	}.Build()
	File_metricspb_v1_get_provider_stats_request_proto = out.File
	file_metricspb_v1_get_provider_stats_request_proto_goTypes = nil
	file_metricspb_v1_get_provider_stats_request_proto_depIdxs = nil
}
