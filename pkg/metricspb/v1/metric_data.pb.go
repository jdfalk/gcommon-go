...
// 	protoc        (unknown)
// source: metricspb/v1/metric_data.proto
...
type MetricData struct {
	...
	xxx_hidden_Type          commonpb.MetricsMetricType `protobuf:"varint,3,opt,name=type,enum=common.v1.MetricsMetricType"`
...
func (x *MetricData) Reset() {
	*x = MetricData{}
	mi := &file_metricspb_v1_metric_data_proto_msgTypes[0]
...
func (x *MetricData) GetType() commonpb.MetricsMetricType {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 2) {
			return x.xxx_hidden_Type
		}
	}
	return commonpb.MetricsMetricType(0)
}
...
func (x *MetricData) SetType(v commonpb.MetricsMetricType) {
	x.xxx_hidden_Type = v
...
func (x *MetricData) ClearType() {
	...
	x.xxx_hidden_Type = commonpb.MetricsMetricType_METRIC_TYPE_UNSPECIFIED
}
...
type MetricData_builder struct {
	...
	Type *commonpb.MetricsMetricType
...
var File_metricspb_v1_metric_data_proto protoreflect.FileDescriptor

const file_metricspb_v1_metric_data_proto_rawDesc = "" +
	"\n" +
	"\x1emetricspb/v1/metric_data.proto\x12\n" +
	"metrics.v1\x1a\x1dcommonpb/v1/metric_type.proto\x1a\x1fmetricspb/v1/metric_value.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x82\x04\n" +
	"\n" +
	"MetricData\x12\x1b\n" +
	"\tmetric_id\x18\x01 \x01(\tR\bmetricId\x12\x1d\n" +
	"\x04name\x18\x02 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x04name\x120\n" +
	"\x04type\x18\x03 \x01(\x0e2\x1c.common.v1.MetricsMetricTypeR\x04type\x12*\n" +
	"\vdescription\x18\x04 \x01(\tB\b\xbaH\x05r\x03\x18\xe8\aR\vdescription\x12\x12\n" +
	"\x04unit\x18\x05 \x01(\tR\x04unit\x12:\n" +
	"\x06labels\x18\x06 \x03(\v2\".metrics.v1.MetricData.LabelsEntryR\x06labels\x12/\n" +
	"\x06values\x18\a \x03(\v2\x17.metrics.v1.MetricValueR\x06values\x12A\n" +
	"\n" +
	...
	"\x0ecom.metrics.v1B\x0fMetricDataProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_metric_data_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_metricspb_v1_metric_data_proto_goTypes = []any{
	(*MetricData)(nil),              // 0: metrics.v1.MetricData
	nil,                             // 1: metrics.v1.MetricData.LabelsEntry
	(commonpb.MetricsMetricType)(0), // 2: common.v1.MetricsMetricType
	(*MetricValue)(nil),             // 3: metrics.v1.MetricValue
	(*timestamppb.Timestamp)(nil),   // 4: google.protobuf.Timestamp
}
var file_metricspb_v1_metric_data_proto_depIdxs = []int32{
	2, // 0: metrics.v1.MetricData.type:type_name -> common.v1.MetricsMetricType
	1, // 1: metrics.v1.MetricData.labels:type_name -> metrics.v1.MetricData.LabelsEntry
	3, // 2: metrics.v1.MetricData.values:type_name -> metrics.v1.MetricValue
	4, // 3: metrics.v1.MetricData.created_at:type_name -> google.protobuf.Timestamp
...
func init() { file_metricspb_v1_metric_data_proto_init() }
func file_metricspb_v1_metric_data_proto_init() {
	if File_metricspb_v1_metric_data_proto != nil {
		return
	}
	file_metricspb_v1_metric_value_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_metric_data_proto_rawDesc), len(file_metricspb_v1_metric_data_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_metric_data_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_metric_data_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_metric_data_proto_msgTypes,
	}.Build()
	File_metricspb_v1_metric_data_proto = out.File
	file_metricspb_v1_metric_data_proto_goTypes = nil
	file_metricspb_v1_metric_data_proto_depIdxs = nil
}
