...
// 	protoc        (unknown)
// source: metricspb/v1/register_metric_response.proto
...
func (x *RegisterMetricResponse) Reset() {
	*x = RegisterMetricResponse{}
	mi := &file_metricspb_v1_register_metric_response_proto_msgTypes[0]
...
func (x *RegisterMetricResponse) GetError() *commonpb.Error {
	if x != nil {
...
func (x *RegisterMetricResponse) SetError(v *commonpb.Error) {
...
var File_metricspb_v1_register_metric_response_proto protoreflect.FileDescriptor

const file_metricspb_v1_register_metric_response_proto_rawDesc = "" +
	"\n" +
	"+metricspb/v1/register_metric_response.proto\x12\n" +
	"metrics.v1\x1a\x17commonpb/v1/error.proto\x1a&metricspb/v1/registration_result.proto\x1a*metricspb/v1/registration_validation.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xca\x03\n" +
	"\x16RegisterMetricResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12&\n" +
	"\x05error\x18\x02 \x01(\v2\x10.common.v1.ErrorR\x05error\x12\x1b\n" +
	"\tmetric_id\x18\x03 \x01(\tR\bmetricId\x12*\n" +
	"\vmetric_name\x18\x04 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\n" +
	"metricName\x12?\n" +
	"\rregistered_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\fregisteredAt\x12\x1f\n" +
	"\vprovider_id\x18\x06 \x01(\tR\n" +
	"providerId\x12B\n" +
	"\n" +
	"validation\x18\a \x01(\v2\".metrics.v1.RegistrationValidationR\n" +
	"validation\x126\n" +
	"\x06result\x18\b \x01(\v2\x1e.metrics.v1.RegistrationResultR\x06result\x12\x1a\n" +
	"\bwarnings\x18\t \x03(\tR\bwarnings\x12+\n" +
	"\x11replaced_existing\x18\n" +
	" \x01(\bR\x10replacedExistingB\xa7\x01\n" +
	"\x0ecom.metrics.v1B\x1bRegisterMetricResponseProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_register_metric_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_register_metric_response_proto_goTypes = []any{
	(*RegisterMetricResponse)(nil), // 0: metrics.v1.RegisterMetricResponse
	(*commonpb.Error)(nil),         // 1: common.v1.Error
	(*timestamppb.Timestamp)(nil),  // 2: google.protobuf.Timestamp
	(*RegistrationValidation)(nil), // 3: metrics.v1.RegistrationValidation
	(*RegistrationResult)(nil),     // 4: metrics.v1.RegistrationResult
}
var file_metricspb_v1_register_metric_response_proto_depIdxs = []int32{
	1, // 0: metrics.v1.RegisterMetricResponse.error:type_name -> common.v1.Error
	2, // 1: metrics.v1.RegisterMetricResponse.registered_at:type_name -> google.protobuf.Timestamp
	3, // 2: metrics.v1.RegisterMetricResponse.validation:type_name -> metrics.v1.RegistrationValidation
	4, // 3: metrics.v1.RegisterMetricResponse.result:type_name -> metrics.v1.RegistrationResult
...
func init() { file_metricspb_v1_register_metric_response_proto_init() }
func file_metricspb_v1_register_metric_response_proto_init() {
	if File_metricspb_v1_register_metric_response_proto != nil {
		return
	}
	file_metricspb_v1_registration_result_proto_init()
	file_metricspb_v1_registration_validation_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_register_metric_response_proto_rawDesc), len(file_metricspb_v1_register_metric_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_register_metric_response_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_register_metric_response_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_register_metric_response_proto_msgTypes,
	}.Build()
	File_metricspb_v1_register_metric_response_proto = out.File
	file_metricspb_v1_register_metric_response_proto_goTypes = nil
	file_metricspb_v1_register_metric_response_proto_depIdxs = nil
}
