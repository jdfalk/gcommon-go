...
// 	protoc        (unknown)
// source: metricspb/v1/metric_definition.proto
...
type MetricDefinition struct {
	...
	xxx_hidden_Type         commonpb.MetricsMetricType             `protobuf:"varint,2,opt,name=type,enum=common.v1.MetricsMetricType"`
	...
	xxx_hidden_Retention    *commonpb.MetricsRetentionPolicyConfig `protobuf:"bytes,7,opt,name=retention"`
...
func (x *MetricDefinition) Reset() {
	*x = MetricDefinition{}
	mi := &file_metricspb_v1_metric_definition_proto_msgTypes[0]
...
func (x *MetricDefinition) GetType() commonpb.MetricsMetricType {
	if x != nil {
...
func (x *MetricDefinition) GetRetention() *commonpb.MetricsRetentionPolicyConfig {
	if x != nil {
...
func (x *MetricDefinition) SetType(v commonpb.MetricsMetricType) {
	x.xxx_hidden_Type = v
...
func (x *MetricDefinition) SetRetention(v *commonpb.MetricsRetentionPolicyConfig) {
...
type MetricDefinition_builder struct {
	...
	Retention *commonpb.MetricsRetentionPolicyConfig
...
var File_metricspb_v1_metric_definition_proto protoreflect.FileDescriptor

const file_metricspb_v1_metric_definition_proto_rawDesc = "" +
	"\n" +
	"$metricspb/v1/metric_definition.proto\x12\n" +
	"metrics.v1\x1a\x1dcommonpb/v1/metric_type.proto\x1a1commonpb/v1/metrics_retention_policy_config.proto\x1a metricspb/v1/export_config.proto\x1a#metricspb/v1/label_definition.proto\x1a%metricspb/v1/metric_type_config.proto\x1a#metricspb/v1/validation_rules.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc6\x04\n" +
	...
	"\x0ecom.metrics.v1B\x15MetricDefinitionProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_metric_definition_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_metricspb_v1_metric_definition_proto_goTypes = []any{
	...
	(*commonpb.MetricsRetentionPolicyConfig)(nil), // 5: common.v1.MetricsRetentionPolicyConfig
	(*ExportConfig)(nil),                          // 6: metrics.v1.ExportConfig
	(*ValidationRules)(nil),                       // 7: metrics.v1.ValidationRules
}
var file_metricspb_v1_metric_definition_proto_depIdxs = []int32{
...
func init() { file_metricspb_v1_metric_definition_proto_init() }
func file_metricspb_v1_metric_definition_proto_init() {
	if File_metricspb_v1_metric_definition_proto != nil {
		return
	}
	file_metricspb_v1_export_config_proto_init()
	file_metricspb_v1_label_definition_proto_init()
	file_metricspb_v1_metric_type_config_proto_init()
	file_metricspb_v1_validation_rules_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_metric_definition_proto_rawDesc), len(file_metricspb_v1_metric_definition_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_metric_definition_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_metric_definition_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_metric_definition_proto_msgTypes,
	}.Build()
	File_metricspb_v1_metric_definition_proto = out.File
	file_metricspb_v1_metric_definition_proto_goTypes = nil
	file_metricspb_v1_metric_definition_proto_depIdxs = nil
}
