...
// 	protoc        (unknown)
// source: metricspb/v1/stream_options.proto
...
type StreamOptions struct {
	...
	xxx_hidden_Compression              commonpb.StreamCompression `protobuf:"varint,5,opt,name=compression,enum=common.v1.StreamCompression"`
	...
	xxx_hidden_Qos                      commonpb.StreamQOS         `protobuf:"varint,9,opt,name=qos,enum=common.v1.StreamQOS"`
...
func (x *StreamOptions) Reset() {
	*x = StreamOptions{}
	mi := &file_metricspb_v1_stream_options_proto_msgTypes[0]
...
func (x *StreamOptions) GetCompression() commonpb.StreamCompression {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 4) {
			return x.xxx_hidden_Compression
		}
	}
	return commonpb.StreamCompression(0)
}
...
func (x *StreamOptions) GetQos() commonpb.StreamQOS {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 8) {
			return x.xxx_hidden_Qos
		}
	}
	return commonpb.StreamQOS(0)
}
...
func (x *StreamOptions) SetCompression(v commonpb.StreamCompression) {
...
func (x *StreamOptions) SetQos(v commonpb.StreamQOS) {
	x.xxx_hidden_Qos = v
...
func (x *StreamOptions) ClearCompression() {
	...
	x.xxx_hidden_Compression = commonpb.StreamCompression_STREAM_COMPRESSION_UNSPECIFIED
}
...
func (x *StreamOptions) ClearQos() {
	...
	x.xxx_hidden_Qos = commonpb.StreamQOS_STREAM_QOS_UNSPECIFIED
}
...
type StreamOptions_builder struct {
	...
	Compression *commonpb.StreamCompression
...
var File_metricspb_v1_stream_options_proto protoreflect.FileDescriptor

const file_metricspb_v1_stream_options_proto_rawDesc = "" +
	"\n" +
	"!metricspb/v1/stream_options.proto\x12\n" +
	"metrics.v1\x1a$commonpb/v1/stream_compression.proto\x1a\x1ccommonpb/v1/stream_qos.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbb\x03\n" +
	"\rStreamOptions\x12-\n" +
	...
	"\vcompression\x18\x05 \x01(\x0e2\x1c.common.v1.StreamCompressionR\vcompression\x12'\n" +
	...
	"\x03qos\x18\t \x01(\x0e2\x14.common.v1.StreamQOSR\x03qosB\x9e\x01\n" +
	"\x0ecom.metrics.v1B\x12StreamOptionsProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_stream_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_stream_options_proto_goTypes = []any{
	(*StreamOptions)(nil),           // 0: metrics.v1.StreamOptions
	(commonpb.StreamCompression)(0), // 1: common.v1.StreamCompression
	(commonpb.StreamQOS)(0),         // 2: common.v1.StreamQOS
}
var file_metricspb_v1_stream_options_proto_depIdxs = []int32{
	1, // 0: metrics.v1.StreamOptions.compression:type_name -> common.v1.StreamCompression
	2, // 1: metrics.v1.StreamOptions.qos:type_name -> common.v1.StreamQOS
...
func init() { file_metricspb_v1_stream_options_proto_init() }
func file_metricspb_v1_stream_options_proto_init() {
	if File_metricspb_v1_stream_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_stream_options_proto_rawDesc), len(file_metricspb_v1_stream_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_stream_options_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_stream_options_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_stream_options_proto_msgTypes,
	}.Build()
	File_metricspb_v1_stream_options_proto = out.File
	file_metricspb_v1_stream_options_proto_goTypes = nil
	file_metricspb_v1_stream_options_proto_depIdxs = nil
}
