...
// 	protoc        (unknown)
// source: metricspb/v1/record_gauge_response.proto
...
func (x *RecordGaugeResponse) Reset() {
	*x = RecordGaugeResponse{}
	mi := &file_metricspb_v1_record_gauge_response_proto_msgTypes[0]
...
func (x *RecordGaugeResponse) GetError() *commonpb.Error {
	if x != nil {
...
func (x *RecordGaugeResponse) SetError(v *commonpb.Error) {
...
var File_metricspb_v1_record_gauge_response_proto protoreflect.FileDescriptor

const file_metricspb_v1_record_gauge_response_proto_rawDesc = "" +
	"\n" +
	"(metricspb/v1/record_gauge_response.proto\x12\n" +
	"metrics.v1\x1a\x17commonpb/v1/error.proto\x1a\x1fmetricspb/v1/gauge_metric.proto\x1a\"metricspb/v1/recording_stats.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xd2\x02\n" +
	...
	"\x05stats\x18\a \x01(\v2\x1a.metrics.v1.RecordingStatsR\x05statsB\xa4\x01\n" +
	"\x0ecom.metrics.v1B\x18RecordGaugeResponseProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_record_gauge_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_record_gauge_response_proto_goTypes = []any{
...
var file_metricspb_v1_record_gauge_response_proto_depIdxs = []int32{
...
func init() { file_metricspb_v1_record_gauge_response_proto_init() }
func file_metricspb_v1_record_gauge_response_proto_init() {
	if File_metricspb_v1_record_gauge_response_proto != nil {
		return
	}
	file_metricspb_v1_gauge_metric_proto_init()
	file_metricspb_v1_recording_stats_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_record_gauge_response_proto_rawDesc), len(file_metricspb_v1_record_gauge_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_record_gauge_response_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_record_gauge_response_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_record_gauge_response_proto_msgTypes,
	}.Build()
	File_metricspb_v1_record_gauge_response_proto = out.File
	file_metricspb_v1_record_gauge_response_proto_goTypes = nil
	file_metricspb_v1_record_gauge_response_proto_depIdxs = nil
}
