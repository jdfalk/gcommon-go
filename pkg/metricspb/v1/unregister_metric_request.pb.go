...
// 	protoc        (unknown)
// source: metricspb/v1/unregister_metric_request.proto
...
func (x *UnregisterMetricRequest) Reset() {
	*x = UnregisterMetricRequest{}
	mi := &file_metricspb_v1_unregister_metric_request_proto_msgTypes[0]
...
func (x *UnregisterMetricRequest) GetMetadata() *commonpb.RequestMetadata {
	if x != nil {
...
func (x *UnregisterMetricRequest) SetMetadata(v *commonpb.RequestMetadata) {
...
func (x case_UnregisterMetricRequest_MetricIdentifier) String() string {
	md := file_metricspb_v1_unregister_metric_request_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_metricspb_v1_unregister_metric_request_proto protoreflect.FileDescriptor

const file_metricspb_v1_unregister_metric_request_proto_rawDesc = "" +
	"\n" +
	",metricspb/v1/unregister_metric_request.proto\x12\n" +
	"metrics.v1\x1a\"commonpb/v1/request_metadata.proto\x1a)metricspb/v1/unregistration_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x91\x02\n" +
	...
	"\x11metric_identifierB\xa8\x01\n" +
	"\x0ecom.metrics.v1B\x1cUnregisterMetricRequestProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_unregister_metric_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_unregister_metric_request_proto_goTypes = []any{
...
var file_metricspb_v1_unregister_metric_request_proto_depIdxs = []int32{
	1, // 0: metrics.v1.UnregisterMetricRequest.metadata:type_name -> common.v1.RequestMetadata
	2, // 1: metrics.v1.UnregisterMetricRequest.options:type_name -> metrics.v1.UnregistrationOptions
...
func init() { file_metricspb_v1_unregister_metric_request_proto_init() }
func file_metricspb_v1_unregister_metric_request_proto_init() {
	if File_metricspb_v1_unregister_metric_request_proto != nil {
		return
	}
	file_metricspb_v1_unregistration_options_proto_init()
	file_metricspb_v1_unregister_metric_request_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_unregister_metric_request_proto_rawDesc), len(file_metricspb_v1_unregister_metric_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_unregister_metric_request_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_unregister_metric_request_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_unregister_metric_request_proto_msgTypes,
	}.Build()
	File_metricspb_v1_unregister_metric_request_proto = out.File
	file_metricspb_v1_unregister_metric_request_proto_goTypes = nil
	file_metricspb_v1_unregister_metric_request_proto_depIdxs = nil
}
