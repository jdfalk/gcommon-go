...
// 	protoc        (unknown)
// source: metricspb/v1/record_metrics_response.proto
...
type RecordMetricsResponse struct {
	...
	xxx_hidden_Error             *commonpb.Error        `protobuf:"bytes,5,opt,name=error"`
...
func (x *RecordMetricsResponse) Reset() {
	*x = RecordMetricsResponse{}
	mi := &file_metricspb_v1_record_metrics_response_proto_msgTypes[0]
...
func (x *RecordMetricsResponse) GetError() *commonpb.Error {
	if x != nil {
...
func (x *RecordMetricsResponse) SetError(v *commonpb.Error) {
...
var File_metricspb_v1_record_metrics_response_proto protoreflect.FileDescriptor

const file_metricspb_v1_record_metrics_response_proto_rawDesc = "" +
	"\n" +
	"*metricspb/v1/record_metrics_response.proto\x12\n" +
	"metrics.v1\x1a\x17commonpb/v1/error.proto\x1a\x1emetricspb/v1/batch_stats.proto\x1a metricspb/v1/metric_result.proto\x1a%metricspb/v1/validation_summary.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xaf\x04\n" +
	...
	"totalCount\x12&\n" +
	"\x05error\x18\x05 \x01(\v2\x10.common.v1.ErrorR\x05error\x12<\n" +
	"\aresults\x18\x06 \x03(\v2\x18.metrics.v1.MetricResultB\b\xbaH\x05\x92\x01\x02\b\x01R\aresults\x12=\n" +
	...
	"providerId\x123\n" +
	"\x05stats\x18\t \x01(\v2\x1d.metrics.v1.MetricsBatchStatsR\x05stats\x12$\n" +
	"\bwarnings\x18\n" +
	" \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\bwarnings\x12L\n" +
	"\x12validation_summary\x18\v \x01(\v2\x1d.metrics.v1.ValidationSummaryR\x11validationSummaryB\xa6\x01\n" +
	"\x0ecom.metrics.v1B\x1aRecordMetricsResponseProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_record_metrics_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_record_metrics_response_proto_goTypes = []any{
	(*RecordMetricsResponse)(nil), // 0: metrics.v1.RecordMetricsResponse
	(*commonpb.Error)(nil),        // 1: common.v1.Error
	(*MetricResult)(nil),          // 2: metrics.v1.MetricResult
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
	(*MetricsBatchStats)(nil),     // 4: metrics.v1.MetricsBatchStats
	(*ValidationSummary)(nil),     // 5: metrics.v1.ValidationSummary
}
var file_metricspb_v1_record_metrics_response_proto_depIdxs = []int32{
	1, // 0: metrics.v1.RecordMetricsResponse.error:type_name -> common.v1.Error
	2, // 1: metrics.v1.RecordMetricsResponse.results:type_name -> metrics.v1.MetricResult
	3, // 2: metrics.v1.RecordMetricsResponse.completed_at:type_name -> google.protobuf.Timestamp
	4, // 3: metrics.v1.RecordMetricsResponse.stats:type_name -> metrics.v1.MetricsBatchStats
	5, // 4: metrics.v1.RecordMetricsResponse.validation_summary:type_name -> metrics.v1.ValidationSummary
...
func init() { file_metricspb_v1_record_metrics_response_proto_init() }
func file_metricspb_v1_record_metrics_response_proto_init() {
	if File_metricspb_v1_record_metrics_response_proto != nil {
		return
	}
	file_metricspb_v1_batch_stats_proto_init()
	file_metricspb_v1_metric_result_proto_init()
	file_metricspb_v1_validation_summary_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_record_metrics_response_proto_rawDesc), len(file_metricspb_v1_record_metrics_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_record_metrics_response_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_record_metrics_response_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_record_metrics_response_proto_msgTypes,
	}.Build()
	File_metricspb_v1_record_metrics_response_proto = out.File
	file_metricspb_v1_record_metrics_response_proto_goTypes = nil
	file_metricspb_v1_record_metrics_response_proto_depIdxs = nil
}
