...
// 	protoc        (unknown)
// source: metricspb/v1/scrape_config.proto
...
func (x *ScrapeConfig) Reset() {
	*x = ScrapeConfig{}
	mi := &file_metricspb_v1_scrape_config_proto_msgTypes[0]
...
var File_metricspb_v1_scrape_config_proto protoreflect.FileDescriptor

const file_metricspb_v1_scrape_config_proto_rawDesc = "" +
	"\n" +
	" metricspb/v1/scrape_config.proto\x12\n" +
	"metrics.v1\x1a metricspb/v1/scrape_target.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa0\x01\n" +
	"\fScrapeConfig\x12$\n" +
...
var file_metricspb_v1_scrape_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_scrape_config_proto_goTypes = []any{
	(*ScrapeConfig)(nil), // 0: metrics.v1.ScrapeConfig
	(*ScrapeTarget)(nil), // 1: metrics.v1.ScrapeTarget
}
var file_metricspb_v1_scrape_config_proto_depIdxs = []int32{
	1, // 0: metrics.v1.ScrapeConfig.targets:type_name -> metrics.v1.ScrapeTarget
...
func init() { file_metricspb_v1_scrape_config_proto_init() }
func file_metricspb_v1_scrape_config_proto_init() {
	if File_metricspb_v1_scrape_config_proto != nil {
		return
	}
	file_metricspb_v1_scrape_target_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_scrape_config_proto_rawDesc), len(file_metricspb_v1_scrape_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_scrape_config_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_scrape_config_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_scrape_config_proto_msgTypes,
	}.Build()
	File_metricspb_v1_scrape_config_proto = out.File
	file_metricspb_v1_scrape_config_proto_goTypes = nil
	file_metricspb_v1_scrape_config_proto_depIdxs = nil
}
