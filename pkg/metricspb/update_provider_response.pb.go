...
// 	protoc        (unknown)
// source: metricspb/v1/update_provider_response.proto
...
type UpdateProviderResponse struct {
	...
	xxx_hidden_ValidationResults *[]*commonpb.MetricsValidationResult `protobuf:"bytes,4,rep,name=validation_results,json=validationResults"`
...
func (x *UpdateProviderResponse) Reset() {
	*x = UpdateProviderResponse{}
	mi := &file_metricspb_v1_update_provider_response_proto_msgTypes[0]
...
func (x *UpdateProviderResponse) GetValidationResults() []*commonpb.MetricsValidationResult {
	if x != nil {
...
func (x *UpdateProviderResponse) GetError() *commonpb.Error {
	if x != nil {
...
func (x *UpdateProviderResponse) SetValidationResults(v []*commonpb.MetricsValidationResult) {
	x.xxx_hidden_ValidationResults = &v
}

func (x *UpdateProviderResponse) SetError(v *commonpb.Error) {
...
type UpdateProviderResponse_builder struct {
	...
	ValidationResults []*commonpb.MetricsValidationResult
...
var File_metricspb_v1_update_provider_response_proto protoreflect.FileDescriptor

const file_metricspb_v1_update_provider_response_proto_rawDesc = "" +
	"\n" +
	"+metricspb/v1/update_provider_response.proto\x12\n" +
	"metrics.v1\x1a\x17commonpb/v1/error.proto\x1a+commonpb/v1/metrics_validation_result.proto\x1a\"metricspb/v1/provider_status.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa9\x03\n" +
	"\x16UpdateProviderResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12(\n" +
	"\vprovider_id\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\n" +
	"providerId\x122\n" +
	"\x06status\x18\x03 \x01(\v2\x1a.metrics.v1.ProviderStatusR\x06status\x12[\n" +
	"\x12validation_results\x18\x04 \x03(\v2\".common.v1.MetricsValidationResultB\b\xbaH\x05\x92\x01\x02\b\x01R\x11validationResults\x12&\n" +
	"\x05error\x18\x05 \x01(\v2\x10.common.v1.ErrorR\x05error\x129\n" +
	"\n" +
	...
	"\bwarnings\x18\b \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\bwarningsB\xa7\x01\n" +
	"\x0ecom.metrics.v1B\x1bUpdateProviderResponseProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_update_provider_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_update_provider_response_proto_goTypes = []any{
	(*UpdateProviderResponse)(nil),           // 0: metrics.v1.UpdateProviderResponse
	(*ProviderStatus)(nil),                   // 1: metrics.v1.ProviderStatus
	(*commonpb.MetricsValidationResult)(nil), // 2: common.v1.MetricsValidationResult
	(*commonpb.Error)(nil),                   // 3: common.v1.Error
	(*timestamppb.Timestamp)(nil),            // 4: google.protobuf.Timestamp
}
var file_metricspb_v1_update_provider_response_proto_depIdxs = []int32{
	1, // 0: metrics.v1.UpdateProviderResponse.status:type_name -> metrics.v1.ProviderStatus
	2, // 1: metrics.v1.UpdateProviderResponse.validation_results:type_name -> common.v1.MetricsValidationResult
	3, // 2: metrics.v1.UpdateProviderResponse.error:type_name -> common.v1.Error
	4, // 3: metrics.v1.UpdateProviderResponse.updated_at:type_name -> google.protobuf.Timestamp
...
func init() { file_metricspb_v1_update_provider_response_proto_init() }
func file_metricspb_v1_update_provider_response_proto_init() {
	if File_metricspb_v1_update_provider_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_update_provider_response_proto_rawDesc), len(file_metricspb_v1_update_provider_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_update_provider_response_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_update_provider_response_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_update_provider_response_proto_msgTypes,
	}.Build()
	File_metricspb_v1_update_provider_response_proto = out.File
	file_metricspb_v1_update_provider_response_proto_goTypes = nil
	file_metricspb_v1_update_provider_response_proto_depIdxs = nil
}
