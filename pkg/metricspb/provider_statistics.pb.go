...
// 	protoc        (unknown)
// source: metricspb/v1/provider_statistics.proto
...
type ProviderStatistics struct {
	...
	xxx_hidden_Errors        *commonpb.MetricsErrorStats `protobuf:"bytes,4,opt,name=errors"`
...
func (x *ProviderStatistics) Reset() {
	*x = ProviderStatistics{}
	mi := &file_metricspb_v1_provider_statistics_proto_msgTypes[0]
...
func (x *ProviderStatistics) GetErrors() *commonpb.MetricsErrorStats {
	if x != nil {
...
func (x *ProviderStatistics) SetErrors(v *commonpb.MetricsErrorStats) {
...
type ProviderStatistics_builder struct {
	...
	// Error statistics
	Errors *commonpb.MetricsErrorStats
...
var File_metricspb_v1_provider_statistics_proto protoreflect.FileDescriptor

const file_metricspb_v1_provider_statistics_proto_rawDesc = "" +
	"\n" +
	"&metricspb/v1/provider_statistics.proto\x12\n" +
	"metrics.v1\x1a%commonpb/v1/metrics_error_stats.proto\x1a(metricspb/v1/configuration_summary.proto\x1a$metricspb/v1/data_volume_stats.proto\x1a\x1fmetricspb/v1/export_stats.proto\x1a&metricspb/v1/health_status_entry.proto\x1a$metricspb/v1/performance_stats.proto\x1a metricspb/v1/provider_info.proto\x1a'metricspb/v1/resource_usage_stats.proto\x1a\x1emetricspb/v1/top_metrics.proto\x1a!metricspb/v1/trend_analysis.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xfe\x04\n" +
	"\x12ProviderStatistics\x12=\n" +
	"\rprovider_info\x18\x01 \x01(\v2\x18.metrics.v1.ProviderInfoR\fproviderInfo\x12E\n" +
	"\vperformance\x18\x02 \x01(\v2#.metrics.v1.MetricsPerformanceStatsR\vperformance\x12E\n" +
	"\x0eresource_usage\x18\x03 \x01(\v2\x1e.metrics.v1.ResourceUsageStatsR\rresourceUsage\x124\n" +
	"\x06errors\x18\x04 \x01(\v2\x1c.common.v1.MetricsErrorStatsR\x06errors\x12<\n" +
	"\vdata_volume\x18\x05 \x01(\v2\x1b.metrics.v1.DataVolumeStatsR\n" +
	"dataVolume\x121\n" +
	"\aexports\x18\x06 \x01(\v2\x17.metrics.v1.ExportStatsR\aexports\x12N\n" +
	"\x0ehealth_history\x18\a \x03(\v2\x1d.metrics.v1.HealthStatusEntryB\b\xbaH\x05\x92\x01\x02\b\x01R\rhealthHistory\x128\n" +
	"\x06config\x18\b \x01(\v2 .metrics.v1.ConfigurationSummaryR\x06config\x127\n" +
	"\vtop_metrics\x18\t \x01(\v2\x16.metrics.v1.TopMetricsR\n" +
	"topMetrics\x121\n" +
	"\x06trends\x18\n" +
	" \x01(\v2\x19.metrics.v1.TrendAnalysisR\x06trendsB\xa3\x01\n" +
	"\x0ecom.metrics.v1B\x17ProviderStatisticsProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_provider_statistics_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_provider_statistics_proto_goTypes = []any{
	...
	(*commonpb.MetricsErrorStats)(nil), // 4: common.v1.MetricsErrorStats
...
var file_metricspb_v1_provider_statistics_proto_depIdxs = []int32{
	1,  // 0: metrics.v1.ProviderStatistics.provider_info:type_name -> metrics.v1.ProviderInfo
	2,  // 1: metrics.v1.ProviderStatistics.performance:type_name -> metrics.v1.MetricsPerformanceStats
	3,  // 2: metrics.v1.ProviderStatistics.resource_usage:type_name -> metrics.v1.ResourceUsageStats
	4,  // 3: metrics.v1.ProviderStatistics.errors:type_name -> common.v1.MetricsErrorStats
	5,  // 4: metrics.v1.ProviderStatistics.data_volume:type_name -> metrics.v1.DataVolumeStats
	6,  // 5: metrics.v1.ProviderStatistics.exports:type_name -> metrics.v1.ExportStats
	7,  // 6: metrics.v1.ProviderStatistics.health_history:type_name -> metrics.v1.HealthStatusEntry
	8,  // 7: metrics.v1.ProviderStatistics.config:type_name -> metrics.v1.ConfigurationSummary
	9,  // 8: metrics.v1.ProviderStatistics.top_metrics:type_name -> metrics.v1.TopMetrics
	10, // 9: metrics.v1.ProviderStatistics.trends:type_name -> metrics.v1.TrendAnalysis
...
func init() { file_metricspb_v1_provider_statistics_proto_init() }
func file_metricspb_v1_provider_statistics_proto_init() {
	if File_metricspb_v1_provider_statistics_proto != nil {
		return
	}
	file_metricspb_v1_configuration_summary_proto_init()
	file_metricspb_v1_data_volume_stats_proto_init()
	file_metricspb_v1_export_stats_proto_init()
	file_metricspb_v1_health_status_entry_proto_init()
	file_metricspb_v1_performance_stats_proto_init()
	file_metricspb_v1_provider_info_proto_init()
	file_metricspb_v1_resource_usage_stats_proto_init()
	file_metricspb_v1_top_metrics_proto_init()
	file_metricspb_v1_trend_analysis_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_provider_statistics_proto_rawDesc), len(file_metricspb_v1_provider_statistics_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_provider_statistics_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_provider_statistics_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_provider_statistics_proto_msgTypes,
	}.Build()
	File_metricspb_v1_provider_statistics_proto = out.File
	file_metricspb_v1_provider_statistics_proto_goTypes = nil
	file_metricspb_v1_provider_statistics_proto_depIdxs = nil
}
