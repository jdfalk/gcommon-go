...
// 	protoc        (unknown)
// source: metricspb/v1/record_metric_response.proto
...
func (x *RecordMetricResponse) Reset() {
	*x = RecordMetricResponse{}
	mi := &file_metricspb_v1_record_metric_response_proto_msgTypes[0]
...
func (x *RecordMetricResponse) GetError() *commonpb.Error {
	if x != nil {
...
func (x *RecordMetricResponse) GetValidation() *commonpb.MetricsValidationResult {
	if x != nil {
...
func (x *RecordMetricResponse) SetError(v *commonpb.Error) {
...
func (x *RecordMetricResponse) SetValidation(v *commonpb.MetricsValidationResult) {
...
var File_metricspb_v1_record_metric_response_proto protoreflect.FileDescriptor

const file_metricspb_v1_record_metric_response_proto_rawDesc = "" +
	"\n" +
	")metricspb/v1/record_metric_response.proto\x12\n" +
	"metrics.v1\x1a\x17commonpb/v1/error.proto\x1a+commonpb/v1/metrics_validation_result.proto\x1a\"metricspb/v1/recording_stats.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x81\x03\n" +
	...
	"\bwarnings\x18\b \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\bwarningsB\xa5\x01\n" +
	"\x0ecom.metrics.v1B\x19RecordMetricResponseProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_record_metric_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_record_metric_response_proto_goTypes = []any{
	(*RecordMetricResponse)(nil),             // 0: metrics.v1.RecordMetricResponse
	(*commonpb.Error)(nil),                   // 1: common.v1.Error
	(*timestamppb.Timestamp)(nil),            // 2: google.protobuf.Timestamp
	(*commonpb.MetricsValidationResult)(nil), // 3: common.v1.MetricsValidationResult
	(*RecordingStats)(nil),                   // 4: metrics.v1.RecordingStats
}
var file_metricspb_v1_record_metric_response_proto_depIdxs = []int32{
	1, // 0: metrics.v1.RecordMetricResponse.error:type_name -> common.v1.Error
	2, // 1: metrics.v1.RecordMetricResponse.recorded_at:type_name -> google.protobuf.Timestamp
	3, // 2: metrics.v1.RecordMetricResponse.validation:type_name -> common.v1.MetricsValidationResult
	4, // 3: metrics.v1.RecordMetricResponse.stats:type_name -> metrics.v1.RecordingStats
...
func init() { file_metricspb_v1_record_metric_response_proto_init() }
func file_metricspb_v1_record_metric_response_proto_init() {
	if File_metricspb_v1_record_metric_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_record_metric_response_proto_rawDesc), len(file_metricspb_v1_record_metric_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_record_metric_response_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_record_metric_response_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_record_metric_response_proto_msgTypes,
	}.Build()
	File_metricspb_v1_record_metric_response_proto = out.File
	file_metricspb_v1_record_metric_response_proto_goTypes = nil
	file_metricspb_v1_record_metric_response_proto_depIdxs = nil
}
