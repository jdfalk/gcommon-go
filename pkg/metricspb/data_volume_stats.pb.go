...
// 	protoc        (unknown)
// source: metricspb/v1/data_volume_stats.proto
...
func (x *DataVolumeStats) Reset() {
	*x = DataVolumeStats{}
	mi := &file_metricspb_v1_data_volume_stats_proto_msgTypes[0]
...
var File_metricspb_v1_data_volume_stats_proto protoreflect.FileDescriptor

const file_metricspb_v1_data_volume_stats_proto_rawDesc = "" +
	"\n" +
	"$metricspb/v1/data_volume_stats.proto\x12\n" +
	"metrics.v1\x1a)metricspb/v1/data_volume_data_point.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe1\x03\n" +
	...
	"\x11volume_timeseries\x18\a \x03(\v2\x1f.metrics.v1.DataVolumeDataPointB\b\xbaH\x05\x92\x01\x02\b\x01R\x10volumeTimeseriesB\xa0\x01\n" +
	"\x0ecom.metrics.v1B\x14DataVolumeStatsProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_data_volume_stats_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_data_volume_stats_proto_goTypes = []any{
	(*DataVolumeStats)(nil),     // 0: metrics.v1.DataVolumeStats
	(*DataVolumeDataPoint)(nil), // 1: metrics.v1.DataVolumeDataPoint
}
var file_metricspb_v1_data_volume_stats_proto_depIdxs = []int32{
	1, // 0: metrics.v1.DataVolumeStats.volume_timeseries:type_name -> metrics.v1.DataVolumeDataPoint
...
func init() { file_metricspb_v1_data_volume_stats_proto_init() }
func file_metricspb_v1_data_volume_stats_proto_init() {
	if File_metricspb_v1_data_volume_stats_proto != nil {
		return
	}
	file_metricspb_v1_data_volume_data_point_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_data_volume_stats_proto_rawDesc), len(file_metricspb_v1_data_volume_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_data_volume_stats_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_data_volume_stats_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_data_volume_stats_proto_msgTypes,
	}.Build()
	File_metricspb_v1_data_volume_stats_proto = out.File
	file_metricspb_v1_data_volume_stats_proto_goTypes = nil
	file_metricspb_v1_data_volume_stats_proto_depIdxs = nil
}
