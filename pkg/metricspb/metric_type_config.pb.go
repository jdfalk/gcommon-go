...
// 	protoc        (unknown)
// source: metricspb/v1/metric_type_config.proto
...
func (x *MetricTypeConfig) Reset() {
	*x = MetricTypeConfig{}
	mi := &file_metricspb_v1_metric_type_config_proto_msgTypes[0]
...
var File_metricspb_v1_metric_type_config_proto protoreflect.FileDescriptor

const file_metricspb_v1_metric_type_config_proto_rawDesc = "" +
	"\n" +
	"%metricspb/v1/metric_type_config.proto\x12\n" +
	"metrics.v1\x1a!metricspb/v1/counter_config.proto\x1a\x1fmetricspb/v1/gauge_config.proto\x1a#metricspb/v1/histogram_config.proto\x1a!metricspb/v1/summary_config.proto\x1a!google/protobuf/go_features.proto\"\xe6\x01\n" +
...
var file_metricspb_v1_metric_type_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_metric_type_config_proto_goTypes = []any{
...
var file_metricspb_v1_metric_type_config_proto_depIdxs = []int32{
...
func init() { file_metricspb_v1_metric_type_config_proto_init() }
func file_metricspb_v1_metric_type_config_proto_init() {
	if File_metricspb_v1_metric_type_config_proto != nil {
		return
	}
	file_metricspb_v1_counter_config_proto_init()
	file_metricspb_v1_gauge_config_proto_init()
	file_metricspb_v1_histogram_config_proto_init()
	file_metricspb_v1_summary_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_metric_type_config_proto_rawDesc), len(file_metricspb_v1_metric_type_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_metric_type_config_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_metric_type_config_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_metric_type_config_proto_msgTypes,
	}.Build()
	File_metricspb_v1_metric_type_config_proto = out.File
	file_metricspb_v1_metric_type_config_proto_goTypes = nil
	file_metricspb_v1_metric_type_config_proto_depIdxs = nil
}
