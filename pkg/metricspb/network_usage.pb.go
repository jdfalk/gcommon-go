...
// 	protoc        (unknown)
// source: metricspb/v1/network_usage.proto
...
func (x *NetworkUsage) Reset() {
	*x = NetworkUsage{}
	mi := &file_metricspb_v1_network_usage_proto_msgTypes[0]
...
var File_metricspb_v1_network_usage_proto protoreflect.FileDescriptor

const file_metricspb_v1_network_usage_proto_rawDesc = "" +
	"\n" +
	" metricspb/v1/network_usage.proto\x12\n" +
	"metrics.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xfa\x01\n" +
	"\fNetworkUsage\x126\n" +
	...
	"\x16packets_out_per_second\x18\x04 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x13packetsOutPerSecondB\x9d\x01\n" +
	"\x0ecom.metrics.v1B\x11NetworkUsageProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_network_usage_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_network_usage_proto_goTypes = []any{
	(*NetworkUsage)(nil), // 0: metrics.v1.NetworkUsage
}
var file_metricspb_v1_network_usage_proto_depIdxs = []int32{
...
func init() { file_metricspb_v1_network_usage_proto_init() }
func file_metricspb_v1_network_usage_proto_init() {
	if File_metricspb_v1_network_usage_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_network_usage_proto_rawDesc), len(file_metricspb_v1_network_usage_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_network_usage_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_network_usage_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_network_usage_proto_msgTypes,
	}.Build()
	File_metricspb_v1_network_usage_proto = out.File
	file_metricspb_v1_network_usage_proto_goTypes = nil
	file_metricspb_v1_network_usage_proto_depIdxs = nil
}
