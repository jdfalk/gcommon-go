...
// 	protoc        (unknown)
// source: metricspb/v1/batch_context.proto
...
func (x *BatchContext) Reset() {
	*x = BatchContext{}
	mi := &file_metricspb_v1_batch_context_proto_msgTypes[0]
...
var File_metricspb_v1_batch_context_proto protoreflect.FileDescriptor

const file_metricspb_v1_batch_context_proto_rawDesc = "" +
	"\n" +
	" metricspb/v1/batch_context.proto\x12\n" +
...
var file_metricspb_v1_batch_context_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_batch_context_proto_goTypes = []any{
	(*BatchContext)(nil), // 0: metrics.v1.BatchContext
}
var file_metricspb_v1_batch_context_proto_depIdxs = []int32{
...
func init() { file_metricspb_v1_batch_context_proto_init() }
func file_metricspb_v1_batch_context_proto_init() {
	if File_metricspb_v1_batch_context_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_batch_context_proto_rawDesc), len(file_metricspb_v1_batch_context_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_batch_context_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_batch_context_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_batch_context_proto_msgTypes,
	}.Build()
	File_metricspb_v1_batch_context_proto = out.File
	file_metricspb_v1_batch_context_proto_goTypes = nil
	file_metricspb_v1_batch_context_proto_depIdxs = nil
}
