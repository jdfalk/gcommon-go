...
// 	protoc        (unknown)
// source: metricspb/v1/group_by_spec.proto
...
func (x *GroupBySpec) Reset() {
	*x = GroupBySpec{}
	mi := &file_metricspb_v1_group_by_spec_proto_msgTypes[0]
...
var File_metricspb_v1_group_by_spec_proto protoreflect.FileDescriptor

const file_metricspb_v1_group_by_spec_proto_rawDesc = "" +
	"\n" +
	" metricspb/v1/group_by_spec.proto\x12\n" +
	"metrics.v1\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x98\x01\n" +
	"\vGroupBySpec\x12'\n" +
	"\n" +
	...
	"\n" +
	"max_groups\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\tmaxGroupsB\x9c\x01\n" +
	"\x0ecom.metrics.v1B\x10GroupBySpecProtoP\x01Z'github.com/jdfalk/gcommon/pkg/metricspb\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V1\xca\x02\n" +
	"Metrics\\V1\xe2\x02\x16Metrics\\V1\\GPBMetadata\xea\x02\vMetrics::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v1_group_by_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v1_group_by_spec_proto_goTypes = []any{
	(*GroupBySpec)(nil),         // 0: metrics.v1.GroupBySpec
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_metricspb_v1_group_by_spec_proto_depIdxs = []int32{
	1, // 0: metrics.v1.GroupBySpec.time_group:type_name -> google.protobuf.Duration
...
func init() { file_metricspb_v1_group_by_spec_proto_init() }
func file_metricspb_v1_group_by_spec_proto_init() {
	if File_metricspb_v1_group_by_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v1_group_by_spec_proto_rawDesc), len(file_metricspb_v1_group_by_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v1_group_by_spec_proto_goTypes,
		DependencyIndexes: file_metricspb_v1_group_by_spec_proto_depIdxs,
		MessageInfos:      file_metricspb_v1_group_by_spec_proto_msgTypes,
	}.Build()
	File_metricspb_v1_group_by_spec_proto = out.File
	file_metricspb_v1_group_by_spec_proto_goTypes = nil
	file_metricspb_v1_group_by_spec_proto_depIdxs = nil
}
