...
// 	protoc        (unknown)
// source: healthpb/v1/service_info.proto
...
func (x *ServiceInfo) Reset() {
	*x = ServiceInfo{}
	mi := &file_healthpb_v1_service_info_proto_msgTypes[0]
...
var File_healthpb_v1_service_info_proto protoreflect.FileDescriptor

const file_healthpb_v1_service_info_proto_rawDesc = "" +
	"\n" +
	"\x1ehealthpb/v1/service_info.proto\x12\thealth.v1\x1a\x1fhealthpb/v1/health_status.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa1\x04\n" +
	"\vServiceInfo\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\x12/\n" +
	"\x06status\x18\x03 \x01(\x0e2\x17.health.v1.HealthStatusR\x06status\x12 \n" +
	...
	"\bmetadata\x18\t \x03(\v2$.health.v1.ServiceInfo.MetadataEntryR\bmetadata\x12\x1b\n" +
	"\tcheck_ids\x18\n" +
	" \x03(\tR\bcheckIds\x12-\n" +
	...
	"\rcom.health.v1B\x10ServiceInfoProtoP\x01Z&github.com/jdfalk/gcommon/pkg/healthpb\xa2\x02\x03HXX\xaa\x02\tHealth.V1\xca\x02\tHealth\\V1\xe2\x02\x15Health\\V1\\GPBMetadata\xea\x02\n" +
	"Health::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_healthpb_v1_service_info_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_healthpb_v1_service_info_proto_goTypes = []any{
	(*ServiceInfo)(nil),           // 0: health.v1.ServiceInfo
	nil,                           // 1: health.v1.ServiceInfo.MetadataEntry
	(HealthStatus)(0),             // 2: health.v1.HealthStatus
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_healthpb_v1_service_info_proto_depIdxs = []int32{
	2, // 0: health.v1.ServiceInfo.status:type_name -> health.v1.HealthStatus
	3, // 1: health.v1.ServiceInfo.registered_at:type_name -> google.protobuf.Timestamp
	3, // 2: health.v1.ServiceInfo.last_updated:type_name -> google.protobuf.Timestamp
	1, // 3: health.v1.ServiceInfo.metadata:type_name -> health.v1.ServiceInfo.MetadataEntry
...
func init() { file_healthpb_v1_service_info_proto_init() }
func file_healthpb_v1_service_info_proto_init() {
	if File_healthpb_v1_service_info_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_healthpb_v1_service_info_proto_rawDesc), len(file_healthpb_v1_service_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_healthpb_v1_service_info_proto_goTypes,
		DependencyIndexes: file_healthpb_v1_service_info_proto_depIdxs,
		MessageInfos:      file_healthpb_v1_service_info_proto_msgTypes,
	}.Build()
	File_healthpb_v1_service_info_proto = out.File
	file_healthpb_v1_service_info_proto_goTypes = nil
	file_healthpb_v1_service_info_proto_depIdxs = nil
}
