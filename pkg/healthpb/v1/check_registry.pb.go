...
// 	protoc        (unknown)
// source: healthpb/v1/check_registry.proto
...
func (x *CheckRegistry) Reset() {
	*x = CheckRegistry{}
	mi := &file_healthpb_v1_check_registry_proto_msgTypes[0]
...
var File_healthpb_v1_check_registry_proto protoreflect.FileDescriptor

const file_healthpb_v1_check_registry_proto_rawDesc = "" +
	"\n" +
	" healthpb/v1/check_registry.proto\x12\thealth.v1\x1a\x1ehealthpb/v1/health_check.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf2\x02\n" +
	"\rCheckRegistry\x12<\n" +
...
var file_healthpb_v1_check_registry_proto_goTypes = []any{
...
var file_healthpb_v1_check_registry_proto_depIdxs = []int32{
...
func init() { file_healthpb_v1_check_registry_proto_init() }
func file_healthpb_v1_check_registry_proto_init() {
	if File_healthpb_v1_check_registry_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_healthpb_v1_check_registry_proto_rawDesc), len(file_healthpb_v1_check_registry_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_healthpb_v1_check_registry_proto_goTypes,
		DependencyIndexes: file_healthpb_v1_check_registry_proto_depIdxs,
		MessageInfos:      file_healthpb_v1_check_registry_proto_msgTypes,
	}.Build()
	File_healthpb_v1_check_registry_proto = out.File
	file_healthpb_v1_check_registry_proto_goTypes = nil
	file_healthpb_v1_check_registry_proto_depIdxs = nil
}
