...
// 	protoc        (unknown)
// source: healthpb/v1/health_metrics.proto
...
func (x *HealthMetrics) Reset() {
	*x = HealthMetrics{}
	mi := &file_healthpb_v1_health_metrics_proto_msgTypes[0]
...
func (x *ServiceHealthMetrics) Reset() {
	*x = ServiceHealthMetrics{}
	mi := &file_healthpb_v1_health_metrics_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_healthpb_v1_health_metrics_proto protoreflect.FileDescriptor

const file_healthpb_v1_health_metrics_proto_rawDesc = "" +
	"\n" +
	" healthpb/v1/health_metrics.proto\x12\thealth.v1\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa9\x05\n" +
	"\rHealthMetrics\x12=\n" +
	...
	" \x01(\x01R\ruptimePercent\x12U\n" +
	"\x0fservice_metrics\x18\v \x03(\v2,.health.v1.HealthMetrics.ServiceMetricsEntryR\x0eserviceMetrics\x1ab\n" +
	"\x13ServiceMetricsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x125\n" +
	"\x05value\x18\x02 \x01(\v2\x1f.health.v1.ServiceHealthMetricsR\x05value:\x028\x01\"\xd5\x01\n" +
	...
	"\x14avg_response_time_ms\x18\x05 \x01(\x01R\x11avgResponseTimeMsB\x98\x01\n" +
	"\rcom.health.v1B\x12HealthMetricsProtoP\x01Z&github.com/jdfalk/gcommon/pkg/healthpb\xa2\x02\x03HXX\xaa\x02\tHealth.V1\xca\x02\tHealth\\V1\xe2\x02\x15Health\\V1\\GPBMetadata\xea\x02\n" +
	"Health::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_healthpb_v1_health_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_healthpb_v1_health_metrics_proto_goTypes = []any{
	(*HealthMetrics)(nil),         // 0: health.v1.HealthMetrics
	(*ServiceHealthMetrics)(nil),  // 1: health.v1.ServiceHealthMetrics
	nil,                           // 2: health.v1.HealthMetrics.ServiceMetricsEntry
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_healthpb_v1_health_metrics_proto_depIdxs = []int32{
	3, // 0: health.v1.HealthMetrics.collected_at:type_name -> google.protobuf.Timestamp
	3, // 1: health.v1.HealthMetrics.last_failure:type_name -> google.protobuf.Timestamp
	2, // 2: health.v1.HealthMetrics.service_metrics:type_name -> health.v1.HealthMetrics.ServiceMetricsEntry
	1, // 3: health.v1.HealthMetrics.ServiceMetricsEntry.value:type_name -> health.v1.ServiceHealthMetrics
...
func init() { file_healthpb_v1_health_metrics_proto_init() }
func file_healthpb_v1_health_metrics_proto_init() {
	if File_healthpb_v1_health_metrics_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_healthpb_v1_health_metrics_proto_rawDesc), len(file_healthpb_v1_health_metrics_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_healthpb_v1_health_metrics_proto_goTypes,
		DependencyIndexes: file_healthpb_v1_health_metrics_proto_depIdxs,
		MessageInfos:      file_healthpb_v1_health_metrics_proto_msgTypes,
	}.Build()
	File_healthpb_v1_health_metrics_proto = out.File
	file_healthpb_v1_health_metrics_proto_goTypes = nil
	file_healthpb_v1_health_metrics_proto_depIdxs = nil
}
