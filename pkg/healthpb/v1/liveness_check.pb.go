...
// 	protoc        (unknown)
// source: healthpb/v1/liveness_check.proto
...
func (x *LivenessCheck) Reset() {
	*x = LivenessCheck{}
	mi := &file_healthpb_v1_liveness_check_proto_msgTypes[0]
...
var File_healthpb_v1_liveness_check_proto protoreflect.FileDescriptor

const file_healthpb_v1_liveness_check_proto_rawDesc = "" +
	"\n" +
	" healthpb/v1/liveness_check.proto\x12\thealth.v1\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x95\x03\n" +
...
var file_healthpb_v1_liveness_check_proto_goTypes = []any{
	(*LivenessCheck)(nil),         // 0: health.v1.LivenessCheck
	(*durationpb.Duration)(nil),   // 1: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_healthpb_v1_liveness_check_proto_depIdxs = []int32{
...
func init() { file_healthpb_v1_liveness_check_proto_init() }
func file_healthpb_v1_liveness_check_proto_init() {
	if File_healthpb_v1_liveness_check_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_healthpb_v1_liveness_check_proto_rawDesc), len(file_healthpb_v1_liveness_check_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_healthpb_v1_liveness_check_proto_goTypes,
		DependencyIndexes: file_healthpb_v1_liveness_check_proto_depIdxs,
		MessageInfos:      file_healthpb_v1_liveness_check_proto_msgTypes,
	}.Build()
	File_healthpb_v1_liveness_check_proto = out.File
	file_healthpb_v1_liveness_check_proto_goTypes = nil
	file_healthpb_v1_liveness_check_proto_depIdxs = nil
}
