...
// 	protoc        (unknown)
// source: healthpb/v1/health_check_request.proto
...
func (x *HealthCheckRequest) Reset() {
	*x = HealthCheckRequest{}
	mi := &file_healthpb_v1_health_check_request_proto_msgTypes[0]
...
func (x *HealthCheckRequest) SetMetadata(v *commonpb.RequestMetadata) {
...
var File_healthpb_v1_health_check_request_proto protoreflect.FileDescriptor

const file_healthpb_v1_health_check_request_proto_rawDesc = "" +
	"\n" +
	"&healthpb/v1/health_check_request.proto\x12\thealth.v1\x1a\"commonpb/v1/request_metadata.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\"\xc8\x02\n" +
	...
	"\bmetadata\x18\x04 \x01(\v2\x1a.common.v1.RequestMetadataR\bmetadata\x123\n" +
...
func init() { file_healthpb_v1_health_check_request_proto_init() }
func file_healthpb_v1_health_check_request_proto_init() {
	if File_healthpb_v1_health_check_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_healthpb_v1_health_check_request_proto_rawDesc), len(file_healthpb_v1_health_check_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_healthpb_v1_health_check_request_proto_goTypes,
		DependencyIndexes: file_healthpb_v1_health_check_request_proto_depIdxs,
		MessageInfos:      file_healthpb_v1_health_check_request_proto_msgTypes,
	}.Build()
	File_healthpb_v1_health_check_request_proto = out.File
	file_healthpb_v1_health_check_request_proto_goTypes = nil
	file_healthpb_v1_health_check_request_proto_depIdxs = nil
}
