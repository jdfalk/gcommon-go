...
// 	protoc        (unknown)
// source: healthpb/v1/resource_usage.proto
...
func (x *ResourceUsage) Reset() {
	*x = ResourceUsage{}
	mi := &file_healthpb_v1_resource_usage_proto_msgTypes[0]
...
func (x *CpuUsage) Reset() {
	*x = CpuUsage{}
	mi := &file_healthpb_v1_resource_usage_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *MemoryUsage) Reset() {
	*x = MemoryUsage{}
	mi := &file_healthpb_v1_resource_usage_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *DiskUsage) Reset() {
	*x = DiskUsage{}
	mi := &file_healthpb_v1_resource_usage_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *NetworkUsage) Reset() {
	*x = NetworkUsage{}
	mi := &file_healthpb_v1_resource_usage_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_healthpb_v1_resource_usage_proto protoreflect.FileDescriptor

const file_healthpb_v1_resource_usage_proto_rawDesc = "" +
	"\n" +
	" healthpb/v1/resource_usage.proto\x12\thealth.v1\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa9\x02\n" +
	"\rResourceUsage\x12=\n" +
	...
	"\x03cpu\x18\x03 \x01(\v2\x13.health.v1.CpuUsageR\x03cpu\x12.\n" +
	"\x06memory\x18\x04 \x01(\v2\x16.health.v1.MemoryUsageR\x06memory\x12(\n" +
	"\x04disk\x18\x05 \x01(\v2\x14.health.v1.DiskUsageR\x04disk\x121\n" +
	"\anetwork\x18\x06 \x01(\v2\x17.health.v1.NetworkUsageR\anetwork\"h\n" +
	"\bCpuUsage\x12#\n" +
	...
	"\x12active_connections\x18\x03 \x01(\x05R\x11activeConnectionsB\x98\x01\n" +
	"\rcom.health.v1B\x12ResourceUsageProtoP\x01Z&github.com/jdfalk/gcommon/pkg/healthpb\xa2\x02\x03HXX\xaa\x02\tHealth.V1\xca\x02\tHealth\\V1\xe2\x02\x15Health\\V1\\GPBMetadata\xea\x02\n" +
	"Health::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_healthpb_v1_resource_usage_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_healthpb_v1_resource_usage_proto_goTypes = []any{
	(*ResourceUsage)(nil),         // 0: health.v1.ResourceUsage
	(*CpuUsage)(nil),              // 1: health.v1.CpuUsage
	(*MemoryUsage)(nil),           // 2: health.v1.MemoryUsage
	(*DiskUsage)(nil),             // 3: health.v1.DiskUsage
	(*NetworkUsage)(nil),          // 4: health.v1.NetworkUsage
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
}
var file_healthpb_v1_resource_usage_proto_depIdxs = []int32{
	5, // 0: health.v1.ResourceUsage.collected_at:type_name -> google.protobuf.Timestamp
	1, // 1: health.v1.ResourceUsage.cpu:type_name -> health.v1.CpuUsage
	2, // 2: health.v1.ResourceUsage.memory:type_name -> health.v1.MemoryUsage
	3, // 3: health.v1.ResourceUsage.disk:type_name -> health.v1.DiskUsage
	4, // 4: health.v1.ResourceUsage.network:type_name -> health.v1.NetworkUsage
...
func init() { file_healthpb_v1_resource_usage_proto_init() }
func file_healthpb_v1_resource_usage_proto_init() {
	if File_healthpb_v1_resource_usage_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_healthpb_v1_resource_usage_proto_rawDesc), len(file_healthpb_v1_resource_usage_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_healthpb_v1_resource_usage_proto_goTypes,
		DependencyIndexes: file_healthpb_v1_resource_usage_proto_depIdxs,
		MessageInfos:      file_healthpb_v1_resource_usage_proto_msgTypes,
	}.Build()
	File_healthpb_v1_resource_usage_proto = out.File
	file_healthpb_v1_resource_usage_proto_goTypes = nil
	file_healthpb_v1_resource_usage_proto_depIdxs = nil
}
