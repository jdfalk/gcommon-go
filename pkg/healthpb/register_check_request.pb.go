...
// 	protoc        (unknown)
// source: healthpb/v1/register_check_request.proto
...
func (x *RegisterCheckRequest) Reset() {
	*x = RegisterCheckRequest{}
	mi := &file_healthpb_v1_register_check_request_proto_msgTypes[0]
...
func (x *RegisterCheckRequest) GetMetadata() *commonpb.RequestMetadata {
	if x != nil {
...
func (x *RegisterCheckRequest) SetMetadata(v *commonpb.RequestMetadata) {
...
var File_healthpb_v1_register_check_request_proto protoreflect.FileDescriptor

const file_healthpb_v1_register_check_request_proto_rawDesc = "" +
	"\n" +
	"(healthpb/v1/register_check_request.proto\x12\thealth.v1\x1a\x1ehealthpb/v1/health_check.proto\x1a\"commonpb/v1/request_metadata.proto\x1a!google/protobuf/go_features.proto\"\xb4\x01\n" +
	...
	"\x10replace_existing\x18\x03 \x01(\bR\x0freplaceExistingB\x9f\x01\n" +
	"\rcom.health.v1B\x19RegisterCheckRequestProtoP\x01Z&github.com/jdfalk/gcommon/pkg/healthpb\xa2\x02\x03HXX\xaa\x02\tHealth.V1\xca\x02\tHealth\\V1\xe2\x02\x15Health\\V1\\GPBMetadata\xea\x02\n" +
	"Health::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_healthpb_v1_register_check_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_healthpb_v1_register_check_request_proto_goTypes = []any{
...
var file_healthpb_v1_register_check_request_proto_depIdxs = []int32{
	1, // 0: health.v1.RegisterCheckRequest.health_check:type_name -> health.v1.HealthCheck
	2, // 1: health.v1.RegisterCheckRequest.metadata:type_name -> common.v1.RequestMetadata
...
func init() { file_healthpb_v1_register_check_request_proto_init() }
func file_healthpb_v1_register_check_request_proto_init() {
	if File_healthpb_v1_register_check_request_proto != nil {
		return
	}
	file_healthpb_v1_health_check_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_healthpb_v1_register_check_request_proto_rawDesc), len(file_healthpb_v1_register_check_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_healthpb_v1_register_check_request_proto_goTypes,
		DependencyIndexes: file_healthpb_v1_register_check_request_proto_depIdxs,
		MessageInfos:      file_healthpb_v1_register_check_request_proto_msgTypes,
	}.Build()
	File_healthpb_v1_register_check_request_proto = out.File
	file_healthpb_v1_register_check_request_proto_goTypes = nil
	file_healthpb_v1_register_check_request_proto_depIdxs = nil
}
