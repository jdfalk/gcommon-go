...
// 	protoc        (unknown)
// source: healthpb/v2/health_status.proto
...
func (HealthStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_healthpb_v2_health_status_proto_enumTypes[0].Descriptor()
}

func (HealthStatus) Type() protoreflect.EnumType {
	return &file_healthpb_v2_health_status_proto_enumTypes[0]
}
...
var File_healthpb_v2_health_status_proto protoreflect.FileDescriptor

const file_healthpb_v2_health_status_proto_rawDesc = "" +
	"\n" +
	"\x1fhealthpb/v2/health_status.proto\x12\thealth.v2\x1a!google/protobuf/go_features.proto*\xf3\x01\n" +
...
var file_healthpb_v2_health_status_proto_goTypes = []any{
	(HealthStatus)(0), // 0: health.v2.HealthStatus
}
var file_healthpb_v2_health_status_proto_depIdxs = []int32{
...
func init() { file_healthpb_v2_health_status_proto_init() }
func file_healthpb_v2_health_status_proto_init() {
	if File_healthpb_v2_health_status_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_healthpb_v2_health_status_proto_rawDesc), len(file_healthpb_v2_health_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_healthpb_v2_health_status_proto_goTypes,
		DependencyIndexes: file_healthpb_v2_health_status_proto_depIdxs,
		EnumInfos:         file_healthpb_v2_health_status_proto_enumTypes,
	}.Build()
	File_healthpb_v2_health_status_proto = out.File
	file_healthpb_v2_health_status_proto_goTypes = nil
	file_healthpb_v2_health_status_proto_depIdxs = nil
}
