...
// 	protoc        (unknown)
// source: healthpb/v2/check_registry.proto
...
func (x *CheckRegistry) Reset() {
	*x = CheckRegistry{}
	mi := &file_healthpb_v2_check_registry_proto_msgTypes[0]
...
var File_healthpb_v2_check_registry_proto protoreflect.FileDescriptor

const file_healthpb_v2_check_registry_proto_rawDesc = "" +
	"\n" +
	" healthpb/v2/check_registry.proto\x12\thealth.v2\x1a\x1ehealthpb/v2/health_check.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf2\x02\n" +
	"\rCheckRegistry\x12<\n" +
	"\x06checks\x18\x01 \x03(\v2$.health.v2.CheckRegistry.ChecksEntryR\x06checks\x12!\n" +
	...
	"\x12monitored_services\x18\x06 \x03(\tR\x11monitoredServices\x1aQ\n" +
	"\vChecksEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.health.v2.HealthCheckR\x05value:\x028\x01B\x9b\x01\n" +
	"\rcom.health.v2B\x12CheckRegistryProtoP\x01Z)github.com/jdfalk/gcommon/pkg/healthpb/v2\xa2\x02\x03HXX\xaa\x02\tHealth.V2\xca\x02\tHealth\\V2\xe2\x02\x15Health\\V2\\GPBMetadata\xea\x02\n" +
	"Health::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_healthpb_v2_check_registry_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_healthpb_v2_check_registry_proto_goTypes = []any{
	(*CheckRegistry)(nil),         // 0: health.v2.CheckRegistry
	nil,                           // 1: health.v2.CheckRegistry.ChecksEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*HealthCheck)(nil),           // 3: health.v2.HealthCheck
}
var file_healthpb_v2_check_registry_proto_depIdxs = []int32{
	1, // 0: health.v2.CheckRegistry.checks:type_name -> health.v2.CheckRegistry.ChecksEntry
	2, // 1: health.v2.CheckRegistry.last_updated:type_name -> google.protobuf.Timestamp
	3, // 2: health.v2.CheckRegistry.ChecksEntry.value:type_name -> health.v2.HealthCheck
...
func init() { file_healthpb_v2_check_registry_proto_init() }
func file_healthpb_v2_check_registry_proto_init() {
	if File_healthpb_v2_check_registry_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_healthpb_v2_check_registry_proto_rawDesc), len(file_healthpb_v2_check_registry_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_healthpb_v2_check_registry_proto_goTypes,
		DependencyIndexes: file_healthpb_v2_check_registry_proto_depIdxs,
		MessageInfos:      file_healthpb_v2_check_registry_proto_msgTypes,
	}.Build()
	File_healthpb_v2_check_registry_proto = out.File
	file_healthpb_v2_check_registry_proto_goTypes = nil
	file_healthpb_v2_check_registry_proto_depIdxs = nil
}
