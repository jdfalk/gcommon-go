...
// 	protoc        (unknown)
// source: healthpb/v2/register_check_request.proto
...
func (x *RegisterCheckRequest) Reset() {
	*x = RegisterCheckRequest{}
	mi := &file_healthpb_v2_register_check_request_proto_msgTypes[0]
...
func (x *RegisterCheckRequest) GetMetadata() *v2.RequestMetadata {
	if x != nil {
...
func (x *RegisterCheckRequest) SetMetadata(v *v2.RequestMetadata) {
...
var File_healthpb_v2_register_check_request_proto protoreflect.FileDescriptor

const file_healthpb_v2_register_check_request_proto_rawDesc = "" +
	"\n" +
	"(healthpb/v2/register_check_request.proto\x12\thealth.v2\x1a\x1ehealthpb/v2/health_check.proto\x1a\"commonpb/v2/request_metadata.proto\x1a!google/protobuf/go_features.proto\"\xb4\x01\n" +
...
var file_healthpb_v2_register_check_request_proto_goTypes = []any{
...
var file_healthpb_v2_register_check_request_proto_depIdxs = []int32{
	1, // 0: health.v2.RegisterCheckRequest.health_check:type_name -> health.v2.HealthCheck
	2, // 1: health.v2.RegisterCheckRequest.metadata:type_name -> common.v2.RequestMetadata
...
func init() { file_healthpb_v2_register_check_request_proto_init() }
func file_healthpb_v2_register_check_request_proto_init() {
	if File_healthpb_v2_register_check_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_healthpb_v2_register_check_request_proto_rawDesc), len(file_healthpb_v2_register_check_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_healthpb_v2_register_check_request_proto_goTypes,
		DependencyIndexes: file_healthpb_v2_register_check_request_proto_depIdxs,
		MessageInfos:      file_healthpb_v2_register_check_request_proto_msgTypes,
	}.Build()
	File_healthpb_v2_register_check_request_proto = out.File
	file_healthpb_v2_register_check_request_proto_goTypes = nil
	file_healthpb_v2_register_check_request_proto_depIdxs = nil
}
