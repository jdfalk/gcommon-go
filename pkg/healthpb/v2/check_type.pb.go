...
// 	protoc        (unknown)
// source: healthpb/v2/check_type.proto
...
func (CheckType) Descriptor() protoreflect.EnumDescriptor {
	return file_healthpb_v2_check_type_proto_enumTypes[0].Descriptor()
}

func (CheckType) Type() protoreflect.EnumType {
	return &file_healthpb_v2_check_type_proto_enumTypes[0]
}
...
var File_healthpb_v2_check_type_proto protoreflect.FileDescriptor

const file_healthpb_v2_check_type_proto_rawDesc = "" +
	"\n" +
	"\x1chealthpb/v2/check_type.proto\x12\thealth.v2\x1a!google/protobuf/go_features.proto*\xed\x01\n" +
	"\tCheckType\x12\x1a\n" +
	...
	"\x11CHECK_TYPE_CUSTOM\x10\bB\x97\x01\n" +
	"\rcom.health.v2B\x0eCheckTypeProtoP\x01Z)github.com/jdfalk/gcommon/pkg/healthpb/v2\xa2\x02\x03HXX\xaa\x02\tHealth.V2\xca\x02\tHealth\\V2\xe2\x02\x15Health\\V2\\GPBMetadata\xea\x02\n" +
...
var file_healthpb_v2_check_type_proto_goTypes = []any{
	(CheckType)(0), // 0: health.v2.CheckType
}
var file_healthpb_v2_check_type_proto_depIdxs = []int32{
...
func init() { file_healthpb_v2_check_type_proto_init() }
func file_healthpb_v2_check_type_proto_init() {
	if File_healthpb_v2_check_type_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_healthpb_v2_check_type_proto_rawDesc), len(file_healthpb_v2_check_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_healthpb_v2_check_type_proto_goTypes,
		DependencyIndexes: file_healthpb_v2_check_type_proto_depIdxs,
		EnumInfos:         file_healthpb_v2_check_type_proto_enumTypes,
	}.Build()
	File_healthpb_v2_check_type_proto = out.File
	file_healthpb_v2_check_type_proto_goTypes = nil
	file_healthpb_v2_check_type_proto_depIdxs = nil
}
