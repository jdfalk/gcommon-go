...
// 	protoc        (unknown)
// source: healthpb/v2/resource_usage.proto
...
func (x *ResourceUsage) Reset() {
	*x = ResourceUsage{}
	mi := &file_healthpb_v2_resource_usage_proto_msgTypes[0]
...
func (x *CpuUsage) Reset() {
	*x = CpuUsage{}
	mi := &file_healthpb_v2_resource_usage_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *MemoryUsage) Reset() {
	*x = MemoryUsage{}
	mi := &file_healthpb_v2_resource_usage_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *DiskUsage) Reset() {
	*x = DiskUsage{}
	mi := &file_healthpb_v2_resource_usage_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *NetworkUsage) Reset() {
	*x = NetworkUsage{}
	mi := &file_healthpb_v2_resource_usage_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_healthpb_v2_resource_usage_proto protoreflect.FileDescriptor

const file_healthpb_v2_resource_usage_proto_rawDesc = "" +
	"\n" +
	" healthpb/v2/resource_usage.proto\x12\thealth.v2\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa9\x02\n" +
	"\rResourceUsage\x12=\n" +
	...
	"\x03cpu\x18\x03 \x01(\v2\x13.health.v2.CpuUsageR\x03cpu\x12.\n" +
	"\x06memory\x18\x04 \x01(\v2\x16.health.v2.MemoryUsageR\x06memory\x12(\n" +
	"\x04disk\x18\x05 \x01(\v2\x14.health.v2.DiskUsageR\x04disk\x121\n" +
	"\anetwork\x18\x06 \x01(\v2\x17.health.v2.NetworkUsageR\anetwork\"h\n" +
	"\bCpuUsage\x12#\n" +
...
var file_healthpb_v2_resource_usage_proto_goTypes = []any{
	(*ResourceUsage)(nil),         // 0: health.v2.ResourceUsage
	(*CpuUsage)(nil),              // 1: health.v2.CpuUsage
	(*MemoryUsage)(nil),           // 2: health.v2.MemoryUsage
	(*DiskUsage)(nil),             // 3: health.v2.DiskUsage
	(*NetworkUsage)(nil),          // 4: health.v2.NetworkUsage
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
}
var file_healthpb_v2_resource_usage_proto_depIdxs = []int32{
	5, // 0: health.v2.ResourceUsage.collected_at:type_name -> google.protobuf.Timestamp
	1, // 1: health.v2.ResourceUsage.cpu:type_name -> health.v2.CpuUsage
	2, // 2: health.v2.ResourceUsage.memory:type_name -> health.v2.MemoryUsage
	3, // 3: health.v2.ResourceUsage.disk:type_name -> health.v2.DiskUsage
	4, // 4: health.v2.ResourceUsage.network:type_name -> health.v2.NetworkUsage
...
func init() { file_healthpb_v2_resource_usage_proto_init() }
func file_healthpb_v2_resource_usage_proto_init() {
	if File_healthpb_v2_resource_usage_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_healthpb_v2_resource_usage_proto_rawDesc), len(file_healthpb_v2_resource_usage_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_healthpb_v2_resource_usage_proto_goTypes,
		DependencyIndexes: file_healthpb_v2_resource_usage_proto_depIdxs,
		MessageInfos:      file_healthpb_v2_resource_usage_proto_msgTypes,
	}.Build()
	File_healthpb_v2_resource_usage_proto = out.File
	file_healthpb_v2_resource_usage_proto_goTypes = nil
	file_healthpb_v2_resource_usage_proto_depIdxs = nil
}
