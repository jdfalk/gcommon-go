...
func (x *MetricQuery) Reset() {
	*x = MetricQuery{}
	mi := &file_metrics_v1_metric_query_proto_msgTypes[0]
...
var File_metrics_v1_metric_query_proto protoreflect.FileDescriptor

const file_metrics_v1_metric_query_proto_rawDesc = "" +
	"\n" +
	"\x1dmetrics/v1/metric_query.proto\x12\n" +
	"metrics.v1\x1a\x1ccommon/v1/sort_options.proto\x1a\"common/v1/time_range_metrics.proto\x1a!metrics/v1/aggregation_spec.proto\x1a\x1emetrics/v1/group_by_spec.proto\x1a\x1emetrics/v1/metric_filter.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xba\x03\n" +
...
func init() { file_metrics_v1_metric_query_proto_init() }
func file_metrics_v1_metric_query_proto_init() {
	if File_metrics_v1_metric_query_proto != nil {
		return
	}
	file_metrics_v1_aggregation_spec_proto_init()
	file_metrics_v1_group_by_spec_proto_init()
	file_metrics_v1_metric_filter_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_metric_query_proto_rawDesc), len(file_metrics_v1_metric_query_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_metric_query_proto_goTypes,
		DependencyIndexes: file_metrics_v1_metric_query_proto_depIdxs,
		MessageInfos:      file_metrics_v1_metric_query_proto_msgTypes,
	}.Build()
	File_metrics_v1_metric_query_proto = out.File
	file_metrics_v1_metric_query_proto_goTypes = nil
	file_metrics_v1_metric_query_proto_depIdxs = nil
}
