...
// 	protoc        (unknown)
// source: metrics/v2/stats_d_settings.proto
...
func (x *StatsDSettings) Reset() {
	*x = StatsDSettings{}
	mi := &file_metrics_v2_stats_d_settings_proto_msgTypes[0]
...
var File_metrics_v2_stats_d_settings_proto protoreflect.FileDescriptor

const file_metrics_v2_stats_d_settings_proto_rawDesc = "" +
	"\n" +
	"!metrics/v2/stats_d_settings.proto\x12\n" +
...
var file_metrics_v2_stats_d_settings_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v2_stats_d_settings_proto_goTypes = []any{
	(*StatsDSettings)(nil), // 0: metrics.v2.StatsDSettings
}
var file_metrics_v2_stats_d_settings_proto_depIdxs = []int32{
...
func init() { file_metrics_v2_stats_d_settings_proto_init() }
func file_metrics_v2_stats_d_settings_proto_init() {
	if File_metrics_v2_stats_d_settings_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_stats_d_settings_proto_rawDesc), len(file_metrics_v2_stats_d_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_stats_d_settings_proto_goTypes,
		DependencyIndexes: file_metrics_v2_stats_d_settings_proto_depIdxs,
		MessageInfos:      file_metrics_v2_stats_d_settings_proto_msgTypes,
	}.Build()
	File_metrics_v2_stats_d_settings_proto = out.File
	file_metrics_v2_stats_d_settings_proto_goTypes = nil
	file_metrics_v2_stats_d_settings_proto_depIdxs = nil
}
