...
// 	protoc        (unknown)
// source: metrics/v2/schema_change.proto
...
func (x *SchemaChange) Reset() {
	*x = SchemaChange{}
	mi := &file_metrics_v2_schema_change_proto_msgTypes[0]
...
var File_metrics_v2_schema_change_proto protoreflect.FileDescriptor

const file_metrics_v2_schema_change_proto_rawDesc = "" +
	"\n" +
	"\x1emetrics/v2/schema_change.proto\x12\n" +
	...
	"\x0fmigration_steps\x18\x04 \x03(\tR\x0emigrationStepsB2Z(github.com/jdfalk/gcommon/pkg/metrics/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v2_schema_change_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v2_schema_change_proto_goTypes = []any{
	(*SchemaChange)(nil), // 0: metrics.v2.SchemaChange
}
var file_metrics_v2_schema_change_proto_depIdxs = []int32{
...
func init() { file_metrics_v2_schema_change_proto_init() }
func file_metrics_v2_schema_change_proto_init() {
	if File_metrics_v2_schema_change_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_schema_change_proto_rawDesc), len(file_metrics_v2_schema_change_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_schema_change_proto_goTypes,
		DependencyIndexes: file_metrics_v2_schema_change_proto_depIdxs,
		MessageInfos:      file_metrics_v2_schema_change_proto_msgTypes,
	}.Build()
	File_metrics_v2_schema_change_proto = out.File
	file_metrics_v2_schema_change_proto_goTypes = nil
	file_metrics_v2_schema_change_proto_depIdxs = nil
}
