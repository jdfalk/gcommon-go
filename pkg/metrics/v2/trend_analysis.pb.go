...
// 	protoc        (unknown)
// source: metrics/v2/trend_analysis.proto
...
func (x *TrendAnalysis) Reset() {
	*x = TrendAnalysis{}
	mi := &file_metrics_v2_trend_analysis_proto_msgTypes[0]
...
var File_metrics_v2_trend_analysis_proto protoreflect.FileDescriptor

const file_metrics_v2_trend_analysis_proto_rawDesc = "" +
	"\n" +
	"\x1fmetrics/v2/trend_analysis.proto\x12\n" +
	"metrics.v2\x1a\"metrics/v2/data_volume_trend.proto\x1a\x1cmetrics/v2/error_trend.proto\x1a\"metrics/v2/performance_trend.proto\x1a%metrics/v2/resource_usage_trend.proto\x1a!google/protobuf/go_features.proto\"\x84\x02\n" +
	"\rTrendAnalysis\x12>\n" +
...
var file_metrics_v2_trend_analysis_proto_depIdxs = []int32{
...
func init() { file_metrics_v2_trend_analysis_proto_init() }
func file_metrics_v2_trend_analysis_proto_init() {
	if File_metrics_v2_trend_analysis_proto != nil {
		return
	}
	file_metrics_v2_data_volume_trend_proto_init()
	file_metrics_v2_error_trend_proto_init()
	file_metrics_v2_performance_trend_proto_init()
	file_metrics_v2_resource_usage_trend_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_trend_analysis_proto_rawDesc), len(file_metrics_v2_trend_analysis_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_trend_analysis_proto_goTypes,
		DependencyIndexes: file_metrics_v2_trend_analysis_proto_depIdxs,
		MessageInfos:      file_metrics_v2_trend_analysis_proto_msgTypes,
	}.Build()
	File_metrics_v2_trend_analysis_proto = out.File
	file_metrics_v2_trend_analysis_proto_goTypes = nil
	file_metrics_v2_trend_analysis_proto_depIdxs = nil
}
