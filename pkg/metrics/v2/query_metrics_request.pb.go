...
// 	protoc        (unknown)
// source: metrics/v2/query_metrics_request.proto
...
func (x *QueryMetricsRequest) Reset() {
	*x = QueryMetricsRequest{}
	mi := &file_metrics_v2_query_metrics_request_proto_msgTypes[0]
...
func (x *QueryMetricsRequest) GetMetadata() *v2.RequestMetadata {
	if x != nil {
...
func (x *QueryMetricsRequest) SetMetadata(v *v2.RequestMetadata) {
...
var File_metrics_v2_query_metrics_request_proto protoreflect.FileDescriptor

const file_metrics_v2_query_metrics_request_proto_rawDesc = "" +
	"\n" +
	"&metrics/v2/query_metrics_request.proto\x12\n" +
	"metrics.v2\x1a common/v2/request_metadata.proto\x1a\x1dmetrics/v2/metric_query.proto\x1a%metrics/v2/query_output_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc8\x02\n" +
	"\x13QueryMetricsRequest\x126\n" +
	"\bmetadata\x18\x01 \x01(\v2\x1a.common.v2.RequestMetadataR\bmetadata\x12-\n" +
	"\x05query\x18\x02 \x01(\v2\x17.metrics.v2.MetricQueryR\x05query\x120\n" +
	...
	"\x0eoutput_options\x18\x06 \x01(\v2\x1e.metrics.v2.QueryOutputOptionsR\routputOptionsB2Z(github.com/jdfalk/gcommon/pkg/metrics/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v2_query_metrics_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v2_query_metrics_request_proto_goTypes = []any{
	(*QueryMetricsRequest)(nil), // 0: metrics.v2.QueryMetricsRequest
	(*v2.RequestMetadata)(nil),  // 1: common.v2.RequestMetadata
	(*MetricQuery)(nil),         // 2: metrics.v2.MetricQuery
	(*QueryOutputOptions)(nil),  // 3: metrics.v2.QueryOutputOptions
}
var file_metrics_v2_query_metrics_request_proto_depIdxs = []int32{
	1, // 0: metrics.v2.QueryMetricsRequest.metadata:type_name -> common.v2.RequestMetadata
	2, // 1: metrics.v2.QueryMetricsRequest.query:type_name -> metrics.v2.MetricQuery
	3, // 2: metrics.v2.QueryMetricsRequest.output_options:type_name -> metrics.v2.QueryOutputOptions
...
func init() { file_metrics_v2_query_metrics_request_proto_init() }
func file_metrics_v2_query_metrics_request_proto_init() {
	if File_metrics_v2_query_metrics_request_proto != nil {
		return
	}
	file_metrics_v2_metric_query_proto_init()
	file_metrics_v2_query_output_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_query_metrics_request_proto_rawDesc), len(file_metrics_v2_query_metrics_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_query_metrics_request_proto_goTypes,
		DependencyIndexes: file_metrics_v2_query_metrics_request_proto_depIdxs,
		MessageInfos:      file_metrics_v2_query_metrics_request_proto_msgTypes,
	}.Build()
	File_metrics_v2_query_metrics_request_proto = out.File
	file_metrics_v2_query_metrics_request_proto_goTypes = nil
	file_metrics_v2_query_metrics_request_proto_depIdxs = nil
}
