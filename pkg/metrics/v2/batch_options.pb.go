...
// 	protoc        (unknown)
// source: metrics/v2/batch_options.proto
...
func (x *MetricsBatchOptions) Reset() {
	*x = MetricsBatchOptions{}
	mi := &file_metrics_v2_batch_options_proto_msgTypes[0]
...
var File_metrics_v2_batch_options_proto protoreflect.FileDescriptor

const file_metrics_v2_batch_options_proto_rawDesc = "" +
	"\n" +
	"\x1emetrics/v2/batch_options.proto\x12\n" +
	"metrics.v2\x1a\x1ecommon/v2/batch_priority.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe0\x02\n" +
	...
	"\bpriority\x18\a \x01(\x0e2\x18.common.v2.BatchPriorityR\bpriorityB2Z(github.com/jdfalk/gcommon/pkg/metrics/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v2_batch_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v2_batch_options_proto_goTypes = []any{
	(*MetricsBatchOptions)(nil), // 0: metrics.v2.MetricsBatchOptions
	(v2.BatchPriority)(0),       // 1: common.v2.BatchPriority
}
var file_metrics_v2_batch_options_proto_depIdxs = []int32{
...
func init() { file_metrics_v2_batch_options_proto_init() }
func file_metrics_v2_batch_options_proto_init() {
	if File_metrics_v2_batch_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_batch_options_proto_rawDesc), len(file_metrics_v2_batch_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_batch_options_proto_goTypes,
		DependencyIndexes: file_metrics_v2_batch_options_proto_depIdxs,
		MessageInfos:      file_metrics_v2_batch_options_proto_msgTypes,
	}.Build()
	File_metrics_v2_batch_options_proto = out.File
	file_metrics_v2_batch_options_proto_goTypes = nil
	file_metrics_v2_batch_options_proto_depIdxs = nil
}
