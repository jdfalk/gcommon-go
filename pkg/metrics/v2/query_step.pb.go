...
// 	protoc        (unknown)
// source: metrics/v2/query_step.proto
...
type QueryStep struct {
	...
	xxx_hidden_Operation         v2.QueryOperation      `protobuf:"varint,2,opt,name=operation,enum=common.v2.QueryOperation"`
...
func (x *QueryStep) Reset() {
	*x = QueryStep{}
	mi := &file_metrics_v2_query_step_proto_msgTypes[0]
...
func (x *QueryStep) GetOperation() v2.QueryOperation {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			return x.xxx_hidden_Operation
		}
	}
	return v2.QueryOperation(0)
}
...
func (x *QueryStep) SetOperation(v v2.QueryOperation) {
...
func (x *QueryStep) ClearOperation() {
	...
	x.xxx_hidden_Operation = v2.QueryOperation_QUERY_OPERATION_UNSPECIFIED
}
...
var File_metrics_v2_query_step_proto protoreflect.FileDescriptor

const file_metrics_v2_query_step_proto_rawDesc = "" +
	"\n" +
	"\x1bmetrics/v2/query_step.proto\x12\n" +
	"metrics.v2\x1a\x1fcommon/v2/query_operation.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf9\x01\n" +
	"\tQueryStep\x12\x17\n" +
	"\astep_id\x18\x01 \x01(\tR\x06stepId\x127\n" +
	"\toperation\x18\x02 \x01(\x0e2\x19.common.v2.QueryOperationR\toperation\x12*\n" +
	...
	"\x0einput_step_ids\x18\x05 \x03(\tR\finputStepIdsB2Z(github.com/jdfalk/gcommon/pkg/metrics/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v2_query_step_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v2_query_step_proto_goTypes = []any{
	(*QueryStep)(nil),           // 0: metrics.v2.QueryStep
	(v2.QueryOperation)(0),      // 1: common.v2.QueryOperation
	(*durationpb.Duration)(nil), // 2: google.protobuf.Duration
}
var file_metrics_v2_query_step_proto_depIdxs = []int32{
	1, // 0: metrics.v2.QueryStep.operation:type_name -> common.v2.QueryOperation
	2, // 1: metrics.v2.QueryStep.estimated_duration:type_name -> google.protobuf.Duration
...
func init() { file_metrics_v2_query_step_proto_init() }
func file_metrics_v2_query_step_proto_init() {
	if File_metrics_v2_query_step_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_query_step_proto_rawDesc), len(file_metrics_v2_query_step_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_query_step_proto_goTypes,
		DependencyIndexes: file_metrics_v2_query_step_proto_depIdxs,
		MessageInfos:      file_metrics_v2_query_step_proto_msgTypes,
	}.Build()
	File_metrics_v2_query_step_proto = out.File
	file_metrics_v2_query_step_proto_goTypes = nil
	file_metrics_v2_query_step_proto_depIdxs = nil
}
