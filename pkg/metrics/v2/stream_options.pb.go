...
// 	protoc        (unknown)
// source: metrics/v2/stream_options.proto
...
func (x *StreamOptions) Reset() {
	*x = StreamOptions{}
	mi := &file_metrics_v2_stream_options_proto_msgTypes[0]
...
var File_metrics_v2_stream_options_proto protoreflect.FileDescriptor

const file_metrics_v2_stream_options_proto_rawDesc = "" +
	"\n" +
	"\x1fmetrics/v2/stream_options.proto\x12\n" +
	"metrics.v2\x1a\"common/v2/stream_compression.proto\x1a\x1acommon/v2/stream_qos.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbb\x03\n" +
	"\rStreamOptions\x12-\n" +
	...
	"\x03qos\x18\t \x01(\x0e2\x14.common.v2.StreamQOSR\x03qosB2Z(github.com/jdfalk/gcommon/pkg/metrics/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v2_stream_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v2_stream_options_proto_goTypes = []any{
...
var file_metrics_v2_stream_options_proto_depIdxs = []int32{
...
func init() { file_metrics_v2_stream_options_proto_init() }
func file_metrics_v2_stream_options_proto_init() {
	if File_metrics_v2_stream_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_stream_options_proto_rawDesc), len(file_metrics_v2_stream_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_stream_options_proto_goTypes,
		DependencyIndexes: file_metrics_v2_stream_options_proto_depIdxs,
		MessageInfos:      file_metrics_v2_stream_options_proto_msgTypes,
	}.Build()
	File_metrics_v2_stream_options_proto = out.File
	file_metrics_v2_stream_options_proto_goTypes = nil
	file_metrics_v2_stream_options_proto_depIdxs = nil
}
