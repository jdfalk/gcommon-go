...
// 	protoc        (unknown)
// source: metrics/v2/metric_type_counts.proto
...
func (x *MetricTypeCounts) Reset() {
	*x = MetricTypeCounts{}
	mi := &file_metrics_v2_metric_type_counts_proto_msgTypes[0]
...
var File_metrics_v2_metric_type_counts_proto protoreflect.FileDescriptor

const file_metrics_v2_metric_type_counts_proto_rawDesc = "" +
	"\n" +
	"#metrics/v2/metric_type_counts.proto\x12\n" +
	...
	"timerCount\x12*\n" +
	"\fcustom_count\x18\x06 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\vcustomCountB2Z(github.com/jdfalk/gcommon/pkg/metrics/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v2_metric_type_counts_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v2_metric_type_counts_proto_goTypes = []any{
	(*MetricTypeCounts)(nil), // 0: metrics.v2.MetricTypeCounts
}
var file_metrics_v2_metric_type_counts_proto_depIdxs = []int32{
...
func init() { file_metrics_v2_metric_type_counts_proto_init() }
func file_metrics_v2_metric_type_counts_proto_init() {
	if File_metrics_v2_metric_type_counts_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_metric_type_counts_proto_rawDesc), len(file_metrics_v2_metric_type_counts_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_metric_type_counts_proto_goTypes,
		DependencyIndexes: file_metrics_v2_metric_type_counts_proto_depIdxs,
		MessageInfos:      file_metrics_v2_metric_type_counts_proto_msgTypes,
	}.Build()
	File_metrics_v2_metric_type_counts_proto = out.File
	file_metrics_v2_metric_type_counts_proto_goTypes = nil
	file_metrics_v2_metric_type_counts_proto_depIdxs = nil
}
