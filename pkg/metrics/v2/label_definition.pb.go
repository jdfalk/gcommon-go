...
// 	protoc        (unknown)
// source: metrics/v2/label_definition.proto
...
func (x *LabelDefinition) Reset() {
	*x = LabelDefinition{}
	mi := &file_metrics_v2_label_definition_proto_msgTypes[0]
...
var File_metrics_v2_label_definition_proto protoreflect.FileDescriptor

const file_metrics_v2_label_definition_proto_rawDesc = "" +
	"\n" +
	"!metrics/v2/label_definition.proto\x12\n" +
...
var file_metrics_v2_label_definition_proto_depIdxs = []int32{
...
func init() { file_metrics_v2_label_definition_proto_init() }
func file_metrics_v2_label_definition_proto_init() {
	if File_metrics_v2_label_definition_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_label_definition_proto_rawDesc), len(file_metrics_v2_label_definition_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_label_definition_proto_goTypes,
		DependencyIndexes: file_metrics_v2_label_definition_proto_depIdxs,
		MessageInfos:      file_metrics_v2_label_definition_proto_msgTypes,
	}.Build()
	File_metrics_v2_label_definition_proto = out.File
	file_metrics_v2_label_definition_proto_goTypes = nil
	file_metrics_v2_label_definition_proto_depIdxs = nil
}
