...
// 	protoc        (unknown)
// source: metrics/v2/metric_type_config.proto
...
func (x *MetricTypeConfig) Reset() {
	*x = MetricTypeConfig{}
	mi := &file_metrics_v2_metric_type_config_proto_msgTypes[0]
...
var File_metrics_v2_metric_type_config_proto protoreflect.FileDescriptor

const file_metrics_v2_metric_type_config_proto_rawDesc = "" +
	"\n" +
	"#metrics/v2/metric_type_config.proto\x12\n" +
	"metrics.v2\x1a\x1fmetrics/v2/counter_config.proto\x1a\x1dmetrics/v2/gauge_config.proto\x1a!metrics/v2/histogram_config.proto\x1a\x1fmetrics/v2/summary_config.proto\x1a!google/protobuf/go_features.proto\"\xe6\x01\n" +
...
var file_metrics_v2_metric_type_config_proto_depIdxs = []int32{
...
func init() { file_metrics_v2_metric_type_config_proto_init() }
func file_metrics_v2_metric_type_config_proto_init() {
	if File_metrics_v2_metric_type_config_proto != nil {
		return
	}
	file_metrics_v2_counter_config_proto_init()
	file_metrics_v2_gauge_config_proto_init()
	file_metrics_v2_histogram_config_proto_init()
	file_metrics_v2_summary_config_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_metric_type_config_proto_rawDesc), len(file_metrics_v2_metric_type_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_metric_type_config_proto_goTypes,
		DependencyIndexes: file_metrics_v2_metric_type_config_proto_depIdxs,
		MessageInfos:      file_metrics_v2_metric_type_config_proto_msgTypes,
	}.Build()
	File_metrics_v2_metric_type_config_proto = out.File
	file_metrics_v2_metric_type_config_proto_goTypes = nil
	file_metrics_v2_metric_type_config_proto_depIdxs = nil
}
