...
// 	protoc        (unknown)
// source: metrics/v2/deletion_options.proto
...
func (x *DeletionOptions) Reset() {
	*x = DeletionOptions{}
	mi := &file_metrics_v2_deletion_options_proto_msgTypes[0]
...
var File_metrics_v2_deletion_options_proto protoreflect.FileDescriptor

const file_metrics_v2_deletion_options_proto_rawDesc = "" +
	"\n" +
	"!metrics/v2/deletion_options.proto\x12\n" +
	"metrics.v2\x1a common/v2/cleanup_strategy.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd2\x03\n" +
	...
	"\x12completion_timeout\x18\v \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x11completionTimeoutB2Z(github.com/jdfalk/gcommon/pkg/metrics/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v2_deletion_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v2_deletion_options_proto_goTypes = []any{
	(*DeletionOptions)(nil), // 0: metrics.v2.DeletionOptions
	(v2.CleanupStrategy)(0), // 1: common.v2.CleanupStrategy
}
var file_metrics_v2_deletion_options_proto_depIdxs = []int32{
...
func init() { file_metrics_v2_deletion_options_proto_init() }
func file_metrics_v2_deletion_options_proto_init() {
	if File_metrics_v2_deletion_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_deletion_options_proto_rawDesc), len(file_metrics_v2_deletion_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_deletion_options_proto_goTypes,
		DependencyIndexes: file_metrics_v2_deletion_options_proto_depIdxs,
		MessageInfos:      file_metrics_v2_deletion_options_proto_msgTypes,
	}.Build()
	File_metrics_v2_deletion_options_proto = out.File
	file_metrics_v2_deletion_options_proto_goTypes = nil
	file_metrics_v2_deletion_options_proto_depIdxs = nil
}
