...
// 	protoc        (unknown)
// source: metrics/v2/data_volume_stats.proto
...
func (x *DataVolumeStats) Reset() {
	*x = DataVolumeStats{}
	mi := &file_metrics_v2_data_volume_stats_proto_msgTypes[0]
...
var File_metrics_v2_data_volume_stats_proto protoreflect.FileDescriptor

const file_metrics_v2_data_volume_stats_proto_rawDesc = "" +
	"\n" +
	"\"metrics/v2/data_volume_stats.proto\x12\n" +
	"metrics.v2\x1a'metrics/v2/data_volume_data_point.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe1\x03\n" +
	...
	"\x11volume_timeseries\x18\a \x03(\v2\x1f.metrics.v2.DataVolumeDataPointB\b\xbaH\x05\x92\x01\x02\b\x01R\x10volumeTimeseriesB2Z(github.com/jdfalk/gcommon/pkg/metrics/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v2_data_volume_stats_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v2_data_volume_stats_proto_goTypes = []any{
	(*DataVolumeStats)(nil),     // 0: metrics.v2.DataVolumeStats
	(*DataVolumeDataPoint)(nil), // 1: metrics.v2.DataVolumeDataPoint
}
var file_metrics_v2_data_volume_stats_proto_depIdxs = []int32{
...
func init() { file_metrics_v2_data_volume_stats_proto_init() }
func file_metrics_v2_data_volume_stats_proto_init() {
	if File_metrics_v2_data_volume_stats_proto != nil {
		return
	}
	file_metrics_v2_data_volume_data_point_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_data_volume_stats_proto_rawDesc), len(file_metrics_v2_data_volume_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_data_volume_stats_proto_goTypes,
		DependencyIndexes: file_metrics_v2_data_volume_stats_proto_depIdxs,
		MessageInfos:      file_metrics_v2_data_volume_stats_proto_msgTypes,
	}.Build()
	File_metrics_v2_data_volume_stats_proto = out.File
	file_metrics_v2_data_volume_stats_proto_goTypes = nil
	file_metrics_v2_data_volume_stats_proto_depIdxs = nil
}
