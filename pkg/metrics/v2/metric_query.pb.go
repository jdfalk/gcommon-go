...
// 	protoc        (unknown)
// source: metrics/v2/metric_query.proto
...
func (x *MetricQuery) Reset() {
	*x = MetricQuery{}
	mi := &file_metrics_v2_metric_query_proto_msgTypes[0]
...
var File_metrics_v2_metric_query_proto protoreflect.FileDescriptor

const file_metrics_v2_metric_query_proto_rawDesc = "" +
	"\n" +
	"\x1dmetrics/v2/metric_query.proto\x12\n" +
	"metrics.v2\x1a\x1ccommon/v2/sort_options.proto\x1a\"common/v2/time_range_metrics.proto\x1a!metrics/v2/aggregation_spec.proto\x1a\x1emetrics/v2/group_by_spec.proto\x1a\x1emetrics/v2/metric_filter.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xba\x03\n" +
	...
	"\x06offset\x18\n" +
	" \x01(\x05R\x06offsetB2Z(github.com/jdfalk/gcommon/pkg/metrics/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v2_metric_query_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v2_metric_query_proto_goTypes = []any{
...
var file_metrics_v2_metric_query_proto_depIdxs = []int32{
...
func init() { file_metrics_v2_metric_query_proto_init() }
func file_metrics_v2_metric_query_proto_init() {
	if File_metrics_v2_metric_query_proto != nil {
		return
	}
	file_metrics_v2_aggregation_spec_proto_init()
	file_metrics_v2_group_by_spec_proto_init()
	file_metrics_v2_metric_filter_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_metric_query_proto_rawDesc), len(file_metrics_v2_metric_query_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_metric_query_proto_goTypes,
		DependencyIndexes: file_metrics_v2_metric_query_proto_depIdxs,
		MessageInfos:      file_metrics_v2_metric_query_proto_msgTypes,
	}.Build()
	File_metrics_v2_metric_query_proto = out.File
	file_metrics_v2_metric_query_proto_goTypes = nil
	file_metrics_v2_metric_query_proto_depIdxs = nil
}
