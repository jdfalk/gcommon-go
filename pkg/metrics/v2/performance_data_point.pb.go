...
// 	protoc        (unknown)
// source: metrics/v2/performance_data_point.proto
...
func (x *PerformanceDataPoint) Reset() {
	*x = PerformanceDataPoint{}
	mi := &file_metrics_v2_performance_data_point_proto_msgTypes[0]
...
var File_metrics_v2_performance_data_point_proto protoreflect.FileDescriptor

const file_metrics_v2_performance_data_point_proto_rawDesc = "" +
	"\n" +
	"'metrics/v2/performance_data_point.proto\x12\n" +
	"metrics.v2\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x84\x02\n" +
	...
	"\x1bthroughput_bytes_per_second\x18\x04 \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\x18throughputBytesPerSecondB2Z(github.com/jdfalk/gcommon/pkg/metrics/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v2_performance_data_point_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v2_performance_data_point_proto_goTypes = []any{
	(*PerformanceDataPoint)(nil),  // 0: metrics.v2.PerformanceDataPoint
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_metrics_v2_performance_data_point_proto_depIdxs = []int32{
	1, // 0: metrics.v2.PerformanceDataPoint.timestamp:type_name -> google.protobuf.Timestamp
...
func init() { file_metrics_v2_performance_data_point_proto_init() }
func file_metrics_v2_performance_data_point_proto_init() {
	if File_metrics_v2_performance_data_point_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_performance_data_point_proto_rawDesc), len(file_metrics_v2_performance_data_point_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_performance_data_point_proto_goTypes,
		DependencyIndexes: file_metrics_v2_performance_data_point_proto_depIdxs,
		MessageInfos:      file_metrics_v2_performance_data_point_proto_msgTypes,
	}.Build()
	File_metrics_v2_performance_data_point_proto = out.File
	file_metrics_v2_performance_data_point_proto_goTypes = nil
	file_metrics_v2_performance_data_point_proto_depIdxs = nil
}
