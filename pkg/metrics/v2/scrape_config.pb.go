...
// 	protoc        (unknown)
// source: metrics/v2/scrape_config.proto
...
func (x *ScrapeConfig) Reset() {
	*x = ScrapeConfig{}
	mi := &file_metrics_v2_scrape_config_proto_msgTypes[0]
...
var File_metrics_v2_scrape_config_proto protoreflect.FileDescriptor

const file_metrics_v2_scrape_config_proto_rawDesc = "" +
	"\n" +
	"\x1emetrics/v2/scrape_config.proto\x12\n" +
	"metrics.v2\x1a\x1emetrics/v2/scrape_target.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa0\x01\n" +
	"\fScrapeConfig\x12$\n" +
	...
	"\x17scrape_interval_seconds\x18\x03 \x01(\x05R\x15scrapeIntervalSecondsB2Z(github.com/jdfalk/gcommon/pkg/metrics/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v2_scrape_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v2_scrape_config_proto_goTypes = []any{
	(*ScrapeConfig)(nil), // 0: metrics.v2.ScrapeConfig
	(*ScrapeTarget)(nil), // 1: metrics.v2.ScrapeTarget
}
var file_metrics_v2_scrape_config_proto_depIdxs = []int32{
...
func init() { file_metrics_v2_scrape_config_proto_init() }
func file_metrics_v2_scrape_config_proto_init() {
	if File_metrics_v2_scrape_config_proto != nil {
		return
	}
	file_metrics_v2_scrape_target_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_scrape_config_proto_rawDesc), len(file_metrics_v2_scrape_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_scrape_config_proto_goTypes,
		DependencyIndexes: file_metrics_v2_scrape_config_proto_depIdxs,
		MessageInfos:      file_metrics_v2_scrape_config_proto_msgTypes,
	}.Build()
	File_metrics_v2_scrape_config_proto = out.File
	file_metrics_v2_scrape_config_proto_goTypes = nil
	file_metrics_v2_scrape_config_proto_depIdxs = nil
}
