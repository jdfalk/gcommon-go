...
// 	protoc        (unknown)
// source: metrics/v2/metric_value.proto
...
func (x *MetricValue) Reset() {
	*x = MetricValue{}
	mi := &file_metrics_v2_metric_value_proto_msgTypes[0]
...
func (x case_MetricValue_Value) String() string {
	md := file_metrics_v2_metric_value_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_metrics_v2_metric_value_proto protoreflect.FileDescriptor

const file_metrics_v2_metric_value_proto_rawDesc = "" +
	"\n" +
	"\x1dmetrics/v2/metric_value.proto\x12\n" +
	"metrics.v2\x1a metrics/v2/histogram_value.proto\x1a\x1emetrics/v2/summary_value.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x9f\x04\n" +
	"\vMetricValue\x128\n" +
	...
	"\x05valueB2Z(github.com/jdfalk/gcommon/pkg/metrics/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v2_metric_value_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_metrics_v2_metric_value_proto_goTypes = []any{
...
var file_metrics_v2_metric_value_proto_depIdxs = []int32{
...
func init() { file_metrics_v2_metric_value_proto_init() }
func file_metrics_v2_metric_value_proto_init() {
	if File_metrics_v2_metric_value_proto != nil {
		return
	}
	file_metrics_v2_histogram_value_proto_init()
	file_metrics_v2_summary_value_proto_init()
	file_metrics_v2_metric_value_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_metric_value_proto_rawDesc), len(file_metrics_v2_metric_value_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_metric_value_proto_goTypes,
		DependencyIndexes: file_metrics_v2_metric_value_proto_depIdxs,
		MessageInfos:      file_metrics_v2_metric_value_proto_msgTypes,
	}.Build()
	File_metrics_v2_metric_value_proto = out.File
	file_metrics_v2_metric_value_proto_goTypes = nil
	file_metrics_v2_metric_value_proto_depIdxs = nil
}
