...
// 	protoc        (unknown)
// source: metrics/v2/record_metric_request.proto
...
func (x *RecordMetricRequest) Reset() {
	*x = RecordMetricRequest{}
	mi := &file_metrics_v2_record_metric_request_proto_msgTypes[0]
...
var File_metrics_v2_record_metric_request_proto protoreflect.FileDescriptor

const file_metrics_v2_record_metric_request_proto_rawDesc = "" +
	"\n" +
	"&metrics/v2/record_metric_request.proto\x12\n" +
	"metrics.v2\x1a common/v2/request_metadata.proto\x1a\x1emetrics/v2/batch_context.proto\x1a\x1cmetrics/v2/metric_data.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xbc\x02\n" +
...
var file_metrics_v2_record_metric_request_proto_depIdxs = []int32{
...
func init() { file_metrics_v2_record_metric_request_proto_init() }
func file_metrics_v2_record_metric_request_proto_init() {
	if File_metrics_v2_record_metric_request_proto != nil {
		return
	}
	file_metrics_v2_batch_context_proto_init()
	file_metrics_v2_metric_data_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_record_metric_request_proto_rawDesc), len(file_metrics_v2_record_metric_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_record_metric_request_proto_goTypes,
		DependencyIndexes: file_metrics_v2_record_metric_request_proto_depIdxs,
		MessageInfos:      file_metrics_v2_record_metric_request_proto_msgTypes,
	}.Build()
	File_metrics_v2_record_metric_request_proto = out.File
	file_metrics_v2_record_metric_request_proto_goTypes = nil
	file_metrics_v2_record_metric_request_proto_depIdxs = nil
}
