...
// 	protoc        (unknown)
// source: metrics/v2/register_metric_request.proto
...
func (x *RegisterMetricRequest) Reset() {
	*x = RegisterMetricRequest{}
	mi := &file_metrics_v2_register_metric_request_proto_msgTypes[0]
...
var File_metrics_v2_register_metric_request_proto protoreflect.FileDescriptor

const file_metrics_v2_register_metric_request_proto_rawDesc = "" +
	"\n" +
	"(metrics/v2/register_metric_request.proto\x12\n" +
	"metrics.v2\x1a common/v2/request_metadata.proto\x1a\"metrics/v2/metric_definition.proto\x1a%metrics/v2/registration_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9d\x02\n" +
	...
	"\aoptions\x18\x05 \x01(\v2\x1f.metrics.v2.RegistrationOptionsR\aoptionsB2Z(github.com/jdfalk/gcommon/pkg/metrics/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v2_register_metric_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v2_register_metric_request_proto_goTypes = []any{
...
var file_metrics_v2_register_metric_request_proto_depIdxs = []int32{
...
func init() { file_metrics_v2_register_metric_request_proto_init() }
func file_metrics_v2_register_metric_request_proto_init() {
	if File_metrics_v2_register_metric_request_proto != nil {
		return
	}
	file_metrics_v2_metric_definition_proto_init()
	file_metrics_v2_registration_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v2_register_metric_request_proto_rawDesc), len(file_metrics_v2_register_metric_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v2_register_metric_request_proto_goTypes,
		DependencyIndexes: file_metrics_v2_register_metric_request_proto_depIdxs,
		MessageInfos:      file_metrics_v2_register_metric_request_proto_msgTypes,
	}.Build()
	File_metrics_v2_register_metric_request_proto = out.File
	file_metrics_v2_register_metric_request_proto_goTypes = nil
	file_metrics_v2_register_metric_request_proto_depIdxs = nil
}
