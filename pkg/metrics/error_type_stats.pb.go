...
// 	protoc        (unknown)
// source: metrics/v1/error_type_stats.proto
...
func (x *ErrorTypeStats) Reset() {
	*x = ErrorTypeStats{}
	mi := &file_metrics_v1_error_type_stats_proto_msgTypes[0]
...
var File_metrics_v1_error_type_stats_proto protoreflect.FileDescriptor

const file_metrics_v1_error_type_stats_proto_rawDesc = "" +
	"\n" +
	"!metrics/v1/error_type_stats.proto\x12\n" +
	"metrics.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb4\x01\n" +
	...
	"percentageB/Z%github.com/jdfalk/gcommon/pkg/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v1_error_type_stats_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v1_error_type_stats_proto_goTypes = []any{
	(*ErrorTypeStats)(nil), // 0: metrics.v1.ErrorTypeStats
}
var file_metrics_v1_error_type_stats_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_error_type_stats_proto_init() }
func file_metrics_v1_error_type_stats_proto_init() {
	if File_metrics_v1_error_type_stats_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_error_type_stats_proto_rawDesc), len(file_metrics_v1_error_type_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_error_type_stats_proto_goTypes,
		DependencyIndexes: file_metrics_v1_error_type_stats_proto_depIdxs,
		MessageInfos:      file_metrics_v1_error_type_stats_proto_msgTypes,
	}.Build()
	File_metrics_v1_error_type_stats_proto = out.File
	file_metrics_v1_error_type_stats_proto_goTypes = nil
	file_metrics_v1_error_type_stats_proto_depIdxs = nil
}
