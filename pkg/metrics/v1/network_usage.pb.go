...
// 	protoc        (unknown)
// source: metrics/v1/network_usage.proto
...
func (x *NetworkUsage) Reset() {
	*x = NetworkUsage{}
	mi := &file_metrics_v1_network_usage_proto_msgTypes[0]
...
var File_metrics_v1_network_usage_proto protoreflect.FileDescriptor

const file_metrics_v1_network_usage_proto_rawDesc = "" +
	"\n" +
	"\x1emetrics/v1/network_usage.proto\x12\n" +
	...
	"\x16packets_out_per_second\x18\x04 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x13packetsOutPerSecondB.Z$github.com/jdfalk/gcommon/metrics/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_metrics_v1_network_usage_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_network_usage_proto_init() }
func file_metrics_v1_network_usage_proto_init() {
	if File_metrics_v1_network_usage_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_network_usage_proto_rawDesc), len(file_metrics_v1_network_usage_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_network_usage_proto_goTypes,
		DependencyIndexes: file_metrics_v1_network_usage_proto_depIdxs,
		MessageInfos:      file_metrics_v1_network_usage_proto_msgTypes,
	}.Build()
	File_metrics_v1_network_usage_proto = out.File
	file_metrics_v1_network_usage_proto_goTypes = nil
	file_metrics_v1_network_usage_proto_depIdxs = nil
}
