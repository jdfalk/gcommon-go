...
// 	protoc        (unknown)
// source: metrics/v1/get_provider_stats_response.proto
...
type GetProviderStatsResponse struct {
	...
	xxx_hidden_TimeRange   *v1.TimeRangeMetrics   `protobuf:"bytes,6,opt,name=time_range,json=timeRange"`
...
func (x *GetProviderStatsResponse) Reset() {
	*x = GetProviderStatsResponse{}
	mi := &file_metrics_v1_get_provider_stats_response_proto_msgTypes[0]
...
func (x *GetProviderStatsResponse) GetError() *v1.Error {
	if x != nil {
...
func (x *GetProviderStatsResponse) GetTimeRange() *v1.TimeRangeMetrics {
	if x != nil {
...
func (x *GetProviderStatsResponse) SetError(v *v1.Error) {
...
func (x *GetProviderStatsResponse) SetTimeRange(v *v1.TimeRangeMetrics) {
...
var File_metrics_v1_get_provider_stats_response_proto protoreflect.FileDescriptor

const file_metrics_v1_get_provider_stats_response_proto_rawDesc = "" +
	"\n" +
	",metrics/v1/get_provider_stats_response.proto\x12\n" +
	"metrics.v1\x1a\x15common/v1/error.proto\x1a\"common/v1/time_range_metrics.proto\x1a$metrics/v1/provider_statistics.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xe7\x02\n" +
	...
	"\bwarnings\x18\a \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\bwarningsB.Z$github.com/jdfalk/gcommon/metrics/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v1_get_provider_stats_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v1_get_provider_stats_response_proto_goTypes = []any{
	...
	(*v1.TimeRangeMetrics)(nil),      // 4: common.v1.TimeRangeMetrics
}
var file_metrics_v1_get_provider_stats_response_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_get_provider_stats_response_proto_init() }
func file_metrics_v1_get_provider_stats_response_proto_init() {
	if File_metrics_v1_get_provider_stats_response_proto != nil {
		return
	}
	file_metrics_v1_provider_statistics_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_get_provider_stats_response_proto_rawDesc), len(file_metrics_v1_get_provider_stats_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_get_provider_stats_response_proto_goTypes,
		DependencyIndexes: file_metrics_v1_get_provider_stats_response_proto_depIdxs,
		MessageInfos:      file_metrics_v1_get_provider_stats_response_proto_msgTypes,
	}.Build()
	File_metrics_v1_get_provider_stats_response_proto = out.File
	file_metrics_v1_get_provider_stats_response_proto_goTypes = nil
	file_metrics_v1_get_provider_stats_response_proto_depIdxs = nil
}
