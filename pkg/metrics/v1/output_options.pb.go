...
func (x *OutputOptions) Reset() {
	*x = OutputOptions{}
	mi := &file_metrics_v1_output_options_proto_msgTypes[0]
...
var File_metrics_v1_output_options_proto protoreflect.FileDescriptor

const file_metrics_v1_output_options_proto_rawDesc = "" +
	"\n" +
	"\x1fmetrics/v1/output_options.proto\x12\n" +
	"metrics.v1\x1a\x1ecommon/v1/numeric_format.proto\x1a$common/v1/response_compression.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb8\x02\n" +
	"\rOutputOptions\x12?\n" +
...
func init() { file_metrics_v1_output_options_proto_init() }
func file_metrics_v1_output_options_proto_init() {
	if File_metrics_v1_output_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_output_options_proto_rawDesc), len(file_metrics_v1_output_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_output_options_proto_goTypes,
		DependencyIndexes: file_metrics_v1_output_options_proto_depIdxs,
		MessageInfos:      file_metrics_v1_output_options_proto_msgTypes,
	}.Build()
	File_metrics_v1_output_options_proto = out.File
	file_metrics_v1_output_options_proto_goTypes = nil
	file_metrics_v1_output_options_proto_depIdxs = nil
}
