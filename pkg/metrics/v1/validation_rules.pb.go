...
// 	protoc        (unknown)
// source: metrics/v1/validation_rules.proto
...
func (x *ValidationRules) Reset() {
	*x = ValidationRules{}
	mi := &file_metrics_v1_validation_rules_proto_msgTypes[0]
...
var File_metrics_v1_validation_rules_proto protoreflect.FileDescriptor

const file_metrics_v1_validation_rules_proto_rawDesc = "" +
	"\n" +
	"!metrics/v1/validation_rules.proto\x12\n" +
	...
	"\x16validation_expressions\x18\x04 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x15validationExpressionsB0Z&github.com/jdfalk/gcommon/pkg/metrics/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v1_validation_rules_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v1_validation_rules_proto_goTypes = []any{
	(*ValidationRules)(nil), // 0: metrics.v1.ValidationRules
}
var file_metrics_v1_validation_rules_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_validation_rules_proto_init() }
func file_metrics_v1_validation_rules_proto_init() {
	if File_metrics_v1_validation_rules_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_validation_rules_proto_rawDesc), len(file_metrics_v1_validation_rules_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_validation_rules_proto_goTypes,
		DependencyIndexes: file_metrics_v1_validation_rules_proto_depIdxs,
		MessageInfos:      file_metrics_v1_validation_rules_proto_msgTypes,
	}.Build()
	File_metrics_v1_validation_rules_proto = out.File
	file_metrics_v1_validation_rules_proto_goTypes = nil
	file_metrics_v1_validation_rules_proto_depIdxs = nil
}
