...
// 	protoc        (unknown)
// source: metrics/v1/register_metric_response.proto
...
func (x *RegisterMetricResponse) Reset() {
	*x = RegisterMetricResponse{}
	mi := &file_metrics_v1_register_metric_response_proto_msgTypes[0]
...
func (x *RegisterMetricResponse) GetError() *common.Error {
	if x != nil {
...
func (x *RegisterMetricResponse) SetError(v *common.Error) {
...
var File_metrics_v1_register_metric_response_proto protoreflect.FileDescriptor

const file_metrics_v1_register_metric_response_proto_rawDesc = "" +
	"\n" +
	")metrics/v1/register_metric_response.proto\x12\n" +
	"metrics.v1\x1a\x15common/v1/error.proto\x1a$metrics/v1/registration_result.proto\x1a(metrics/v1/registration_validation.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xca\x03\n" +
	...
	" \x01(\bR\x10replacedExistingB0Z&github.com/jdfalk/gcommon/pkg/metrics/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v1_register_metric_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v1_register_metric_response_proto_goTypes = []any{
...
var file_metrics_v1_register_metric_response_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_register_metric_response_proto_init() }
func file_metrics_v1_register_metric_response_proto_init() {
	if File_metrics_v1_register_metric_response_proto != nil {
		return
	}
	file_metrics_v1_registration_result_proto_init()
	file_metrics_v1_registration_validation_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_register_metric_response_proto_rawDesc), len(file_metrics_v1_register_metric_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_register_metric_response_proto_goTypes,
		DependencyIndexes: file_metrics_v1_register_metric_response_proto_depIdxs,
		MessageInfos:      file_metrics_v1_register_metric_response_proto_msgTypes,
	}.Build()
	File_metrics_v1_register_metric_response_proto = out.File
	file_metrics_v1_register_metric_response_proto_goTypes = nil
	file_metrics_v1_register_metric_response_proto_depIdxs = nil
}
