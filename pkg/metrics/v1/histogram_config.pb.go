...
func (x *HistogramConfig) Reset() {
	*x = HistogramConfig{}
	mi := &file_metrics_v1_histogram_config_proto_msgTypes[0]
...
var File_metrics_v1_histogram_config_proto protoreflect.FileDescriptor

const file_metrics_v1_histogram_config_proto_rawDesc = "" +
	"\n" +
	"!metrics/v1/histogram_config.proto\x12\n" +
...
var file_metrics_v1_histogram_config_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_histogram_config_proto_init() }
func file_metrics_v1_histogram_config_proto_init() {
	if File_metrics_v1_histogram_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_histogram_config_proto_rawDesc), len(file_metrics_v1_histogram_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_histogram_config_proto_goTypes,
		DependencyIndexes: file_metrics_v1_histogram_config_proto_depIdxs,
		MessageInfos:      file_metrics_v1_histogram_config_proto_msgTypes,
	}.Build()
	File_metrics_v1_histogram_config_proto = out.File
	file_metrics_v1_histogram_config_proto_goTypes = nil
	file_metrics_v1_histogram_config_proto_depIdxs = nil
}
