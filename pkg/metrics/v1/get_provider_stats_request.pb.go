...
func (x *GetProviderStatsRequest) Reset() {
	*x = GetProviderStatsRequest{}
	mi := &file_metrics_v1_get_provider_stats_request_proto_msgTypes[0]
...
var File_metrics_v1_get_provider_stats_request_proto protoreflect.FileDescriptor

const file_metrics_v1_get_provider_stats_request_proto_rawDesc = "" +
	"\n" +
	"+metrics/v1/get_provider_stats_request.proto\x12\n" +
	"metrics.v1\x1a common/v1/request_metadata.proto\x1a\"common/v1/time_range_metrics.proto\x1a\x1emetrics/v1/stats_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xb8\x02\n" +
...
func init() { file_metrics_v1_get_provider_stats_request_proto_init() }
func file_metrics_v1_get_provider_stats_request_proto_init() {
	if File_metrics_v1_get_provider_stats_request_proto != nil {
		return
	}
	file_metrics_v1_stats_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_get_provider_stats_request_proto_rawDesc), len(file_metrics_v1_get_provider_stats_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_get_provider_stats_request_proto_goTypes,
		DependencyIndexes: file_metrics_v1_get_provider_stats_request_proto_depIdxs,
		MessageInfos:      file_metrics_v1_get_provider_stats_request_proto_msgTypes,
	}.Build()
	File_metrics_v1_get_provider_stats_request_proto = out.File
	file_metrics_v1_get_provider_stats_request_proto_goTypes = nil
	file_metrics_v1_get_provider_stats_request_proto_depIdxs = nil
}
