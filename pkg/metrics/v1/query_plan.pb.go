...
// 	protoc        (unknown)
// source: metrics/v1/query_plan.proto
...
func (x *QueryPlan) Reset() {
	*x = QueryPlan{}
	mi := &file_metrics_v1_query_plan_proto_msgTypes[0]
...
var File_metrics_v1_query_plan_proto protoreflect.FileDescriptor

const file_metrics_v1_query_plan_proto_rawDesc = "" +
	"\n" +
	"\x1bmetrics/v1/query_plan.proto\x12\n" +
	"metrics.v1\x1a\x1bmetrics/v1/query_step.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa2\x02\n" +
	"\tQueryPlan\x12\"\n" +
	...
	"\x10storage_backends\x18\x05 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x0fstorageBackendsB.Z$github.com/jdfalk/gcommon/metrics/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_metrics_v1_query_plan_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_query_plan_proto_init() }
func file_metrics_v1_query_plan_proto_init() {
	if File_metrics_v1_query_plan_proto != nil {
		return
	}
	file_metrics_v1_query_step_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_query_plan_proto_rawDesc), len(file_metrics_v1_query_plan_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_query_plan_proto_goTypes,
		DependencyIndexes: file_metrics_v1_query_plan_proto_depIdxs,
		MessageInfos:      file_metrics_v1_query_plan_proto_msgTypes,
	}.Build()
	File_metrics_v1_query_plan_proto = out.File
	file_metrics_v1_query_plan_proto_goTypes = nil
	file_metrics_v1_query_plan_proto_depIdxs = nil
}
