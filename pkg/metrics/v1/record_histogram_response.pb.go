...
// 	protoc        (unknown)
// source: metrics/v1/record_histogram_response.proto
...
func (x *RecordHistogramResponse) Reset() {
	*x = RecordHistogramResponse{}
	mi := &file_metrics_v1_record_histogram_response_proto_msgTypes[0]
...
func (x *RecordHistogramResponse) GetError() *v1.Error {
	if x != nil {
...
func (x *RecordHistogramResponse) SetError(v *v1.Error) {
...
var File_metrics_v1_record_histogram_response_proto protoreflect.FileDescriptor

const file_metrics_v1_record_histogram_response_proto_rawDesc = "" +
	"\n" +
	"*metrics/v1/record_histogram_response.proto\x12\n" +
	"metrics.v1\x1a\x15common/v1/error.proto\x1a\x1cmetrics/v1/bucket_info.proto\x1a!metrics/v1/histogram_metric.proto\x1a metrics/v1/histogram_stats.proto\x1a metrics/v1/recording_stats.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb8\x03\n" +
	...
	"\x0frecording_stats\x18\b \x01(\v2\x1a.metrics.v1.RecordingStatsR\x0erecordingStatsB.Z$github.com/jdfalk/gcommon/metrics/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_metrics_v1_record_histogram_response_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_record_histogram_response_proto_init() }
func file_metrics_v1_record_histogram_response_proto_init() {
	if File_metrics_v1_record_histogram_response_proto != nil {
		return
	}
	file_metrics_v1_bucket_info_proto_init()
	file_metrics_v1_histogram_metric_proto_init()
	file_metrics_v1_histogram_stats_proto_init()
	file_metrics_v1_recording_stats_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_record_histogram_response_proto_rawDesc), len(file_metrics_v1_record_histogram_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_record_histogram_response_proto_goTypes,
		DependencyIndexes: file_metrics_v1_record_histogram_response_proto_depIdxs,
		MessageInfos:      file_metrics_v1_record_histogram_response_proto_msgTypes,
	}.Build()
	File_metrics_v1_record_histogram_response_proto = out.File
	file_metrics_v1_record_histogram_response_proto_goTypes = nil
	file_metrics_v1_record_histogram_response_proto_depIdxs = nil
}
