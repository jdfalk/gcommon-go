...
// 	protoc        (unknown)
// source: metrics/v1/resource_data_point.proto
...
func (x *ResourceDataPoint) Reset() {
	*x = ResourceDataPoint{}
	mi := &file_metrics_v1_resource_data_point_proto_msgTypes[0]
...
var File_metrics_v1_resource_data_point_proto protoreflect.FileDescriptor

const file_metrics_v1_resource_data_point_proto_rawDesc = "" +
	"\n" +
	"$metrics/v1/resource_data_point.proto\x12\n" +
	...
	"\x18network_bytes_per_second\x18\x05 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x15networkBytesPerSecondB0Z&github.com/jdfalk/gcommon/pkg/metrics/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v1_resource_data_point_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v1_resource_data_point_proto_goTypes = []any{
	(*ResourceDataPoint)(nil),     // 0: metrics.v1.ResourceDataPoint
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_metrics_v1_resource_data_point_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_resource_data_point_proto_init() }
func file_metrics_v1_resource_data_point_proto_init() {
	if File_metrics_v1_resource_data_point_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_resource_data_point_proto_rawDesc), len(file_metrics_v1_resource_data_point_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_resource_data_point_proto_goTypes,
		DependencyIndexes: file_metrics_v1_resource_data_point_proto_depIdxs,
		MessageInfos:      file_metrics_v1_resource_data_point_proto_msgTypes,
	}.Build()
	File_metrics_v1_resource_data_point_proto = out.File
	file_metrics_v1_resource_data_point_proto_goTypes = nil
	file_metrics_v1_resource_data_point_proto_depIdxs = nil
}
