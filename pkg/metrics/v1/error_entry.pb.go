...
// 	protoc        (unknown)
// source: metrics/v1/error_entry.proto
...
func (x *ErrorEntry) Reset() {
	*x = ErrorEntry{}
	mi := &file_metrics_v1_error_entry_proto_msgTypes[0]
...
var File_metrics_v1_error_entry_proto protoreflect.FileDescriptor

const file_metrics_v1_error_entry_proto_rawDesc = "" +
	"\n" +
	"\x1cmetrics/v1/error_entry.proto\x12\n" +
	...
	"\x05count\x18\x04 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x05countB0Z&github.com/jdfalk/gcommon/pkg/metrics/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v1_error_entry_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v1_error_entry_proto_goTypes = []any{
	(*ErrorEntry)(nil),            // 0: metrics.v1.ErrorEntry
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_metrics_v1_error_entry_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_error_entry_proto_init() }
func file_metrics_v1_error_entry_proto_init() {
	if File_metrics_v1_error_entry_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_error_entry_proto_rawDesc), len(file_metrics_v1_error_entry_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_error_entry_proto_goTypes,
		DependencyIndexes: file_metrics_v1_error_entry_proto_depIdxs,
		MessageInfos:      file_metrics_v1_error_entry_proto_msgTypes,
	}.Build()
	File_metrics_v1_error_entry_proto = out.File
	file_metrics_v1_error_entry_proto_goTypes = nil
	file_metrics_v1_error_entry_proto_depIdxs = nil
}
