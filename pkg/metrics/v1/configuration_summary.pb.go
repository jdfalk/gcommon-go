...
// 	protoc        (unknown)
// source: metrics/v1/configuration_summary.proto
...
func (x *ConfigurationSummary) Reset() {
	*x = ConfigurationSummary{}
	mi := &file_metrics_v1_configuration_summary_proto_msgTypes[0]
...
var File_metrics_v1_configuration_summary_proto protoreflect.FileDescriptor

const file_metrics_v1_configuration_summary_proto_rawDesc = "" +
	"\n" +
	"&metrics/v1/configuration_summary.proto\x12\n" +
	"metrics.v1\x1a(metrics/v1/resource_limits_summary.proto\x1a!metrics/v1/security_summary.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x8f\x02\n" +
	...
	"\x0econfig_version\x18\x04 \x01(\tB\x17\xbaH\x14r\x122\x10^v?\\d+\\.\\d+\\.\\d+R\rconfigVersionB0Z&github.com/jdfalk/gcommon/pkg/metrics/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v1_configuration_summary_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v1_configuration_summary_proto_goTypes = []any{
...
var file_metrics_v1_configuration_summary_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_configuration_summary_proto_init() }
func file_metrics_v1_configuration_summary_proto_init() {
	if File_metrics_v1_configuration_summary_proto != nil {
		return
	}
	file_metrics_v1_resource_limits_summary_proto_init()
	file_metrics_v1_security_summary_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_configuration_summary_proto_rawDesc), len(file_metrics_v1_configuration_summary_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_configuration_summary_proto_goTypes,
		DependencyIndexes: file_metrics_v1_configuration_summary_proto_depIdxs,
		MessageInfos:      file_metrics_v1_configuration_summary_proto_msgTypes,
	}.Build()
	File_metrics_v1_configuration_summary_proto = out.File
	file_metrics_v1_configuration_summary_proto_goTypes = nil
	file_metrics_v1_configuration_summary_proto_depIdxs = nil
}
