...
// 	protoc        (unknown)
// source: metrics/v1/timer_metric.proto
...
func (x *TimerMetric) Reset() {
	*x = TimerMetric{}
	mi := &file_metrics_v1_timer_metric_proto_msgTypes[0]
...
var File_metrics_v1_timer_metric_proto protoreflect.FileDescriptor

const file_metrics_v1_timer_metric_proto_rawDesc = "" +
	"\n" +
	"\x1dmetrics/v1/timer_metric.proto\x12\n" +
	"metrics.v1\x1a'metrics/v1/percentile_measurement.proto\x1a!metrics/v1/timer_statistics.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x96\x05\n" +
...
var file_metrics_v1_timer_metric_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_metrics_v1_timer_metric_proto_goTypes = []any{
...
var file_metrics_v1_timer_metric_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_timer_metric_proto_init() }
func file_metrics_v1_timer_metric_proto_init() {
	if File_metrics_v1_timer_metric_proto != nil {
		return
	}
	file_metrics_v1_percentile_measurement_proto_init()
	file_metrics_v1_timer_statistics_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_timer_metric_proto_rawDesc), len(file_metrics_v1_timer_metric_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_timer_metric_proto_goTypes,
		DependencyIndexes: file_metrics_v1_timer_metric_proto_depIdxs,
		MessageInfos:      file_metrics_v1_timer_metric_proto_msgTypes,
	}.Build()
	File_metrics_v1_timer_metric_proto = out.File
	file_metrics_v1_timer_metric_proto_goTypes = nil
	file_metrics_v1_timer_metric_proto_depIdxs = nil
}
