...
func (x *UpdateResult) Reset() {
	*x = UpdateResult{}
	mi := &file_metrics_v1_update_result_proto_msgTypes[0]
...
var File_metrics_v1_update_result_proto protoreflect.FileDescriptor

const file_metrics_v1_update_result_proto_rawDesc = "" +
	"\n" +
	"\x1emetrics/v1/update_result.proto\x12\n" +
	"metrics.v1\x1a%common/v1/metrics_config_change.proto\x1a\x1dcommon/v1/update_action.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf8\x02\n" +
	"\fUpdateResult\x12/\n" +
	...
	"\x0fupdate_duration\x18\a \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x0eupdateDurationB/Z%github.com/jdfalk/gcommon/pkg/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_metrics_v1_update_result_proto_init() }
func file_metrics_v1_update_result_proto_init() {
	if File_metrics_v1_update_result_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_update_result_proto_rawDesc), len(file_metrics_v1_update_result_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_update_result_proto_goTypes,
		DependencyIndexes: file_metrics_v1_update_result_proto_depIdxs,
		MessageInfos:      file_metrics_v1_update_result_proto_msgTypes,
	}.Build()
	File_metrics_v1_update_result_proto = out.File
	file_metrics_v1_update_result_proto_goTypes = nil
	file_metrics_v1_update_result_proto_depIdxs = nil
}
