...
// 	protoc        (unknown)
// source: metrics/v1/deletion_options.proto
...
type DeletionOptions struct {
	...
	xxx_hidden_CleanupStrategy   common.CleanupStrategy `protobuf:"varint,9,opt,name=cleanup_strategy,json=cleanupStrategy,enum=common.v1.CleanupStrategy"`
...
func (x *DeletionOptions) Reset() {
	*x = DeletionOptions{}
	mi := &file_metrics_v1_deletion_options_proto_msgTypes[0]
...
func (x *DeletionOptions) GetCleanupStrategy() common.CleanupStrategy {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 8) {
			return x.xxx_hidden_CleanupStrategy
		}
	}
	return common.CleanupStrategy(0)
}
...
func (x *DeletionOptions) SetCleanupStrategy(v common.CleanupStrategy) {
...
func (x *DeletionOptions) ClearCleanupStrategy() {
	...
	x.xxx_hidden_CleanupStrategy = common.CleanupStrategy_CLEANUP_STRATEGY_UNSPECIFIED
}
...
type DeletionOptions_builder struct {
	...
	CleanupStrategy *common.CleanupStrategy
...
var File_metrics_v1_deletion_options_proto protoreflect.FileDescriptor

const file_metrics_v1_deletion_options_proto_rawDesc = "" +
	"\n" +
	"!metrics/v1/deletion_options.proto\x12\n" +
	"metrics.v1\x1a common/v1/cleanup_strategy.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd2\x03\n" +
	...
	"\x12completion_timeout\x18\v \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x11completionTimeoutB0Z&github.com/jdfalk/gcommon/pkg/metrics/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v1_deletion_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v1_deletion_options_proto_goTypes = []any{
	(*DeletionOptions)(nil),     // 0: metrics.v1.DeletionOptions
	(common.CleanupStrategy)(0), // 1: common.v1.CleanupStrategy
}
var file_metrics_v1_deletion_options_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_deletion_options_proto_init() }
func file_metrics_v1_deletion_options_proto_init() {
	if File_metrics_v1_deletion_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_deletion_options_proto_rawDesc), len(file_metrics_v1_deletion_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_deletion_options_proto_goTypes,
		DependencyIndexes: file_metrics_v1_deletion_options_proto_depIdxs,
		MessageInfos:      file_metrics_v1_deletion_options_proto_msgTypes,
	}.Build()
	File_metrics_v1_deletion_options_proto = out.File
	file_metrics_v1_deletion_options_proto_goTypes = nil
	file_metrics_v1_deletion_options_proto_depIdxs = nil
}
