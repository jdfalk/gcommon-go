...
func (x *ProviderStatistics) Reset() {
	*x = ProviderStatistics{}
	mi := &file_metrics_v1_provider_statistics_proto_msgTypes[0]
...
var File_metrics_v1_provider_statistics_proto protoreflect.FileDescriptor

const file_metrics_v1_provider_statistics_proto_rawDesc = "" +
	"\n" +
	"$metrics/v1/provider_statistics.proto\x12\n" +
	"metrics.v1\x1a#common/v1/metrics_error_stats.proto\x1a&metrics/v1/configuration_summary.proto\x1a\"metrics/v1/data_volume_stats.proto\x1a\x1dmetrics/v1/export_stats.proto\x1a$metrics/v1/health_status_entry.proto\x1a\"metrics/v1/performance_stats.proto\x1a\x1emetrics/v1/provider_info.proto\x1a%metrics/v1/resource_usage_stats.proto\x1a\x1cmetrics/v1/top_metrics.proto\x1a\x1fmetrics/v1/trend_analysis.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xfe\x04\n" +
...
func init() { file_metrics_v1_provider_statistics_proto_init() }
func file_metrics_v1_provider_statistics_proto_init() {
	if File_metrics_v1_provider_statistics_proto != nil {
		return
	}
	file_metrics_v1_configuration_summary_proto_init()
	file_metrics_v1_data_volume_stats_proto_init()
	file_metrics_v1_export_stats_proto_init()
	file_metrics_v1_health_status_entry_proto_init()
	file_metrics_v1_performance_stats_proto_init()
	file_metrics_v1_provider_info_proto_init()
	file_metrics_v1_resource_usage_stats_proto_init()
	file_metrics_v1_top_metrics_proto_init()
	file_metrics_v1_trend_analysis_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_provider_statistics_proto_rawDesc), len(file_metrics_v1_provider_statistics_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_provider_statistics_proto_goTypes,
		DependencyIndexes: file_metrics_v1_provider_statistics_proto_depIdxs,
		MessageInfos:      file_metrics_v1_provider_statistics_proto_msgTypes,
	}.Build()
	File_metrics_v1_provider_statistics_proto = out.File
	file_metrics_v1_provider_statistics_proto_goTypes = nil
	file_metrics_v1_provider_statistics_proto_depIdxs = nil
}
