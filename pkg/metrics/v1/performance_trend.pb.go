...
// 	protoc        (unknown)
// source: metrics/v1/performance_trend.proto
...
func (x *PerformanceTrend) Reset() {
	*x = PerformanceTrend{}
	mi := &file_metrics_v1_performance_trend_proto_msgTypes[0]
...
var File_metrics_v1_performance_trend_proto protoreflect.FileDescriptor

const file_metrics_v1_performance_trend_proto_rawDesc = "" +
	"\n" +
	"\"metrics/v1/performance_trend.proto\x12\n" +
	"metrics.v1\x1a!google/protobuf/go_features.proto\"\x8d\x01\n" +
	...
	"\x10trend_confidence\x18\x03 \x01(\x01R\x0ftrendConfidenceB0Z&github.com/jdfalk/gcommon/pkg/metrics/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v1_performance_trend_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v1_performance_trend_proto_goTypes = []any{
	(*PerformanceTrend)(nil), // 0: metrics.v1.PerformanceTrend
}
var file_metrics_v1_performance_trend_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_performance_trend_proto_init() }
func file_metrics_v1_performance_trend_proto_init() {
	if File_metrics_v1_performance_trend_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_performance_trend_proto_rawDesc), len(file_metrics_v1_performance_trend_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_performance_trend_proto_goTypes,
		DependencyIndexes: file_metrics_v1_performance_trend_proto_depIdxs,
		MessageInfos:      file_metrics_v1_performance_trend_proto_msgTypes,
	}.Build()
	File_metrics_v1_performance_trend_proto = out.File
	file_metrics_v1_performance_trend_proto_goTypes = nil
	file_metrics_v1_performance_trend_proto_depIdxs = nil
}
