...
// 	protoc        (unknown)
// source: metrics/v1/pagination_info.proto
...
func (x *MetricsPaginationInfo) Reset() {
	*x = MetricsPaginationInfo{}
	mi := &file_metrics_v1_pagination_info_proto_msgTypes[0]
...
var File_metrics_v1_pagination_info_proto protoreflect.FileDescriptor

const file_metrics_v1_pagination_info_proto_rawDesc = "" +
	"\n" +
	" metrics/v1/pagination_info.proto\x12\n" +
	...
	"nextCursor\x120\n" +
	"\x0fprevious_cursor\x18\b \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x0epreviousCursorB0Z&github.com/jdfalk/gcommon/pkg/metrics/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v1_pagination_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v1_pagination_info_proto_goTypes = []any{
	(*MetricsPaginationInfo)(nil), // 0: metrics.v1.MetricsPaginationInfo
}
var file_metrics_v1_pagination_info_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_pagination_info_proto_init() }
func file_metrics_v1_pagination_info_proto_init() {
	if File_metrics_v1_pagination_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_pagination_info_proto_rawDesc), len(file_metrics_v1_pagination_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_pagination_info_proto_goTypes,
		DependencyIndexes: file_metrics_v1_pagination_info_proto_depIdxs,
		MessageInfos:      file_metrics_v1_pagination_info_proto_msgTypes,
	}.Build()
	File_metrics_v1_pagination_info_proto = out.File
	file_metrics_v1_pagination_info_proto_goTypes = nil
	file_metrics_v1_pagination_info_proto_depIdxs = nil
}
