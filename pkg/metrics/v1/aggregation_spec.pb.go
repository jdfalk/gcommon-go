...
func (x *AggregationSpec) Reset() {
	*x = AggregationSpec{}
	mi := &file_metrics_v1_aggregation_spec_proto_msgTypes[0]
...
var File_metrics_v1_aggregation_spec_proto protoreflect.FileDescriptor

const file_metrics_v1_aggregation_spec_proto_rawDesc = "" +
	"\n" +
	"!metrics/v1/aggregation_spec.proto\x12\n" +
	"metrics.v1\x1a common/v1/aggregation_type.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xe5\x02\n" +
...
func init() { file_metrics_v1_aggregation_spec_proto_init() }
func file_metrics_v1_aggregation_spec_proto_init() {
	if File_metrics_v1_aggregation_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_aggregation_spec_proto_rawDesc), len(file_metrics_v1_aggregation_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_aggregation_spec_proto_goTypes,
		DependencyIndexes: file_metrics_v1_aggregation_spec_proto_depIdxs,
		MessageInfos:      file_metrics_v1_aggregation_spec_proto_msgTypes,
	}.Build()
	File_metrics_v1_aggregation_spec_proto = out.File
	file_metrics_v1_aggregation_spec_proto_goTypes = nil
	file_metrics_v1_aggregation_spec_proto_depIdxs = nil
}
