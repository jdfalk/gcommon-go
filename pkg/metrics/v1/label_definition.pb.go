...
// 	protoc        (unknown)
// source: metrics/v1/label_definition.proto
...
func (x *LabelDefinition) Reset() {
	*x = LabelDefinition{}
	mi := &file_metrics_v1_label_definition_proto_msgTypes[0]
...
var File_metrics_v1_label_definition_proto protoreflect.FileDescriptor

const file_metrics_v1_label_definition_proto_rawDesc = "" +
	"\n" +
	"!metrics/v1/label_definition.proto\x12\n" +
	"metrics.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf3\x01\n" +
	...
	"\rdefault_value\x18\x06 \x01(\tR\fdefaultValueB0Z&github.com/jdfalk/gcommon/pkg/metrics/\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v1_label_definition_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v1_label_definition_proto_goTypes = []any{
	(*LabelDefinition)(nil), // 0: metrics.v1.LabelDefinition
}
var file_metrics_v1_label_definition_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_label_definition_proto_init() }
func file_metrics_v1_label_definition_proto_init() {
	if File_metrics_v1_label_definition_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_label_definition_proto_rawDesc), len(file_metrics_v1_label_definition_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_label_definition_proto_goTypes,
		DependencyIndexes: file_metrics_v1_label_definition_proto_depIdxs,
		MessageInfos:      file_metrics_v1_label_definition_proto_msgTypes,
	}.Build()
	File_metrics_v1_label_definition_proto = out.File
	file_metrics_v1_label_definition_proto_goTypes = nil
	file_metrics_v1_label_definition_proto_depIdxs = nil
}
