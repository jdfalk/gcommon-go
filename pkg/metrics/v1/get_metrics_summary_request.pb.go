...
// 	protoc        (unknown)
// source: metrics/v1/get_metrics_summary_request.proto
...
func (x *GetMetricsSummaryRequest) Reset() {
	*x = GetMetricsSummaryRequest{}
	mi := &file_metrics_v1_get_metrics_summary_request_proto_msgTypes[0]
...
func (x *GetMetricsSummaryRequest) GetMetadata() *v1.RequestMetadata {
	if x != nil {
...
func (x *GetMetricsSummaryRequest) GetTimeRange() *v1.TimeRangeMetrics {
	if x != nil {
...
func (x *GetMetricsSummaryRequest) SetMetadata(v *v1.RequestMetadata) {
...
func (x *GetMetricsSummaryRequest) SetTimeRange(v *v1.TimeRangeMetrics) {
...
var File_metrics_v1_get_metrics_summary_request_proto protoreflect.FileDescriptor

const file_metrics_v1_get_metrics_summary_request_proto_rawDesc = "" +
	"\n" +
	",metrics/v1/get_metrics_summary_request.proto\x12\n" +
	"metrics.v1\x1a common/v1/request_metadata.proto\x1a\"common/v1/time_range_metrics.proto\x1a\x1emetrics/v1/metric_filter.proto\x1a metrics/v1/summary_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x8a\x03\n" +
	...
	"\x15include_health_status\x18\a \x01(\bR\x13includeHealthStatusB.Z$github.com/jdfalk/gcommon/metrics/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v1_get_metrics_summary_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v1_get_metrics_summary_request_proto_goTypes = []any{
...
var file_metrics_v1_get_metrics_summary_request_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_get_metrics_summary_request_proto_init() }
func file_metrics_v1_get_metrics_summary_request_proto_init() {
	if File_metrics_v1_get_metrics_summary_request_proto != nil {
		return
	}
	file_metrics_v1_metric_filter_proto_init()
	file_metrics_v1_summary_options_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_get_metrics_summary_request_proto_rawDesc), len(file_metrics_v1_get_metrics_summary_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_get_metrics_summary_request_proto_goTypes,
		DependencyIndexes: file_metrics_v1_get_metrics_summary_request_proto_depIdxs,
		MessageInfos:      file_metrics_v1_get_metrics_summary_request_proto_msgTypes,
	}.Build()
	File_metrics_v1_get_metrics_summary_request_proto = out.File
	file_metrics_v1_get_metrics_summary_request_proto_goTypes = nil
	file_metrics_v1_get_metrics_summary_request_proto_depIdxs = nil
}
