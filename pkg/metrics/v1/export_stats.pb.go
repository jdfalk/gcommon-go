...
func (x *ExportStats) Reset() {
	*x = ExportStats{}
	mi := &file_metrics_v1_export_stats_proto_msgTypes[0]
...
var File_metrics_v1_export_stats_proto protoreflect.FileDescriptor

const file_metrics_v1_export_stats_proto_rawDesc = "" +
	"\n" +
	"\x1dmetrics/v1/export_stats.proto\x12\n" +
	"metrics.v1\x1a)metrics/v1/export_destination_stats.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x87\x04\n" +
	"\vExportStats\x12=\n" +
...
var file_metrics_v1_export_stats_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_export_stats_proto_init() }
func file_metrics_v1_export_stats_proto_init() {
	if File_metrics_v1_export_stats_proto != nil {
		return
	}
	file_metrics_v1_export_destination_stats_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_export_stats_proto_rawDesc), len(file_metrics_v1_export_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_export_stats_proto_goTypes,
		DependencyIndexes: file_metrics_v1_export_stats_proto_depIdxs,
		MessageInfos:      file_metrics_v1_export_stats_proto_msgTypes,
	}.Build()
	File_metrics_v1_export_stats_proto = out.File
	file_metrics_v1_export_stats_proto_goTypes = nil
	file_metrics_v1_export_stats_proto_depIdxs = nil
}
