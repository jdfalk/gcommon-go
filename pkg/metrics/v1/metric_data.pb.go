...
func (x *MetricData) Reset() {
	*x = MetricData{}
	mi := &file_metrics_v1_metric_data_proto_msgTypes[0]
...
var File_metrics_v1_metric_data_proto protoreflect.FileDescriptor

const file_metrics_v1_metric_data_proto_rawDesc = "" +
	"\n" +
	"\x1cmetrics/v1/metric_data.proto\x12\n" +
	"metrics.v1\x1a\x1bcommon/v1/metric_type.proto\x1a\x1dmetrics/v1/metric_value.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x82\x04\n" +
	"\n" +
	"MetricData\x12\x1b\n" +
...
var file_metrics_v1_metric_data_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_metric_data_proto_init() }
func file_metrics_v1_metric_data_proto_init() {
	if File_metrics_v1_metric_data_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_metric_data_proto_rawDesc), len(file_metrics_v1_metric_data_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_metric_data_proto_goTypes,
		DependencyIndexes: file_metrics_v1_metric_data_proto_depIdxs,
		MessageInfos:      file_metrics_v1_metric_data_proto_msgTypes,
	}.Build()
	File_metrics_v1_metric_data_proto = out.File
	file_metrics_v1_metric_data_proto_goTypes = nil
	file_metrics_v1_metric_data_proto_depIdxs = nil
}
