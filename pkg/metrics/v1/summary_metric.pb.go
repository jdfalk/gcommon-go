...
func (x *SummaryMetric) Reset() {
	*x = SummaryMetric{}
	mi := &file_metrics_v1_summary_metric_proto_msgTypes[0]
...
var File_metrics_v1_summary_metric_proto protoreflect.FileDescriptor

const file_metrics_v1_summary_metric_proto_rawDesc = "" +
	"\n" +
	"\x1fmetrics/v1/summary_metric.proto\x12\n" +
	"metrics.v1\x1a common/v1/request_metadata.proto\x1a!metrics/v1/summary_quantile.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xf3\x03\n" +
...
func init() { file_metrics_v1_summary_metric_proto_init() }
func file_metrics_v1_summary_metric_proto_init() {
	if File_metrics_v1_summary_metric_proto != nil {
		return
	}
	file_metrics_v1_summary_quantile_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_summary_metric_proto_rawDesc), len(file_metrics_v1_summary_metric_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_summary_metric_proto_goTypes,
		DependencyIndexes: file_metrics_v1_summary_metric_proto_depIdxs,
		MessageInfos:      file_metrics_v1_summary_metric_proto_msgTypes,
	}.Build()
	File_metrics_v1_summary_metric_proto = out.File
	file_metrics_v1_summary_metric_proto_goTypes = nil
	file_metrics_v1_summary_metric_proto_depIdxs = nil
}
