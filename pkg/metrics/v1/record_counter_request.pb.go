...
// 	protoc        (unknown)
// source: metrics/v1/record_counter_request.proto
...
func (x *RecordCounterRequest) Reset() {
	*x = RecordCounterRequest{}
	mi := &file_metrics_v1_record_counter_request_proto_msgTypes[0]
...
func (x *RecordCounterRequest) GetMetadata() *v1.RequestMetadata {
	if x != nil {
...
func (x *RecordCounterRequest) SetMetadata(v *v1.RequestMetadata) {
...
var File_metrics_v1_record_counter_request_proto protoreflect.FileDescriptor

const file_metrics_v1_record_counter_request_proto_rawDesc = "" +
	"\n" +
	"'metrics/v1/record_counter_request.proto\x12\n" +
	"metrics.v1\x1a common/v1/request_metadata.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xcd\x02\n" +
...
var file_metrics_v1_record_counter_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_metrics_v1_record_counter_request_proto_goTypes = []any{
...
var file_metrics_v1_record_counter_request_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_record_counter_request_proto_init() }
func file_metrics_v1_record_counter_request_proto_init() {
	if File_metrics_v1_record_counter_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_record_counter_request_proto_rawDesc), len(file_metrics_v1_record_counter_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_record_counter_request_proto_goTypes,
		DependencyIndexes: file_metrics_v1_record_counter_request_proto_depIdxs,
		MessageInfos:      file_metrics_v1_record_counter_request_proto_msgTypes,
	}.Build()
	File_metrics_v1_record_counter_request_proto = out.File
	file_metrics_v1_record_counter_request_proto_goTypes = nil
	file_metrics_v1_record_counter_request_proto_depIdxs = nil
}
