...
// 	protoc        (unknown)
// source: metrics/v1/metric_summary.proto
...
func (x *MetricSummary) Reset() {
	*x = MetricSummary{}
	mi := &file_metrics_v1_metric_summary_proto_msgTypes[0]
...
var File_metrics_v1_metric_summary_proto protoreflect.FileDescriptor

const file_metrics_v1_metric_summary_proto_rawDesc = "" +
	"\n" +
	"\x1fmetrics/v1/metric_summary.proto\x12\n" +
...
var file_metrics_v1_metric_summary_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v1_metric_summary_proto_goTypes = []any{
	(*MetricSummary)(nil),         // 0: metrics.v1.MetricSummary
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_metrics_v1_metric_summary_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_metric_summary_proto_init() }
func file_metrics_v1_metric_summary_proto_init() {
	if File_metrics_v1_metric_summary_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_metric_summary_proto_rawDesc), len(file_metrics_v1_metric_summary_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_metric_summary_proto_goTypes,
		DependencyIndexes: file_metrics_v1_metric_summary_proto_depIdxs,
		MessageInfos:      file_metrics_v1_metric_summary_proto_msgTypes,
	}.Build()
	File_metrics_v1_metric_summary_proto = out.File
	file_metrics_v1_metric_summary_proto_goTypes = nil
	file_metrics_v1_metric_summary_proto_depIdxs = nil
}
