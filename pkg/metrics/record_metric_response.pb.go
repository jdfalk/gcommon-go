...
func (x *RecordMetricResponse) Reset() {
	*x = RecordMetricResponse{}
	mi := &file_metrics_v1_record_metric_response_proto_msgTypes[0]
...
var File_metrics_v1_record_metric_response_proto protoreflect.FileDescriptor

const file_metrics_v1_record_metric_response_proto_rawDesc = "" +
	"\n" +
	"'metrics/v1/record_metric_response.proto\x12\n" +
	"metrics.v1\x1a\x15common/v1/error.proto\x1a)common/v1/metrics_validation_result.proto\x1a metrics/v1/recording_stats.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x81\x03\n" +
...
func init() { file_metrics_v1_record_metric_response_proto_init() }
func file_metrics_v1_record_metric_response_proto_init() {
	if File_metrics_v1_record_metric_response_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_record_metric_response_proto_rawDesc), len(file_metrics_v1_record_metric_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_record_metric_response_proto_goTypes,
		DependencyIndexes: file_metrics_v1_record_metric_response_proto_depIdxs,
		MessageInfos:      file_metrics_v1_record_metric_response_proto_msgTypes,
	}.Build()
	File_metrics_v1_record_metric_response_proto = out.File
	file_metrics_v1_record_metric_response_proto_goTypes = nil
	file_metrics_v1_record_metric_response_proto_depIdxs = nil
}
