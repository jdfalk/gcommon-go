...
// 	protoc        (unknown)
// source: metrics/v1/data_volume_data_point.proto
...
func (x *DataVolumeDataPoint) Reset() {
	*x = DataVolumeDataPoint{}
	mi := &file_metrics_v1_data_volume_data_point_proto_msgTypes[0]
...
var File_metrics_v1_data_volume_data_point_proto protoreflect.FileDescriptor

const file_metrics_v1_data_volume_data_point_proto_rawDesc = "" +
	"\n" +
	"'metrics/v1/data_volume_data_point.proto\x12\n" +
	...
	"\x0eingestion_rate\x18\x05 \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\ringestionRateB/Z%github.com/jdfalk/gcommon/pkg/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metrics_v1_data_volume_data_point_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metrics_v1_data_volume_data_point_proto_goTypes = []any{
	(*DataVolumeDataPoint)(nil),   // 0: metrics.v1.DataVolumeDataPoint
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_metrics_v1_data_volume_data_point_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_data_volume_data_point_proto_init() }
func file_metrics_v1_data_volume_data_point_proto_init() {
	if File_metrics_v1_data_volume_data_point_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_data_volume_data_point_proto_rawDesc), len(file_metrics_v1_data_volume_data_point_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_data_volume_data_point_proto_goTypes,
		DependencyIndexes: file_metrics_v1_data_volume_data_point_proto_depIdxs,
		MessageInfos:      file_metrics_v1_data_volume_data_point_proto_msgTypes,
	}.Build()
	File_metrics_v1_data_volume_data_point_proto = out.File
	file_metrics_v1_data_volume_data_point_proto_goTypes = nil
	file_metrics_v1_data_volume_data_point_proto_depIdxs = nil
}
