...
func (x *ResourceUsageStats) Reset() {
	*x = ResourceUsageStats{}
	mi := &file_metrics_v1_resource_usage_stats_proto_msgTypes[0]
...
var File_metrics_v1_resource_usage_stats_proto protoreflect.FileDescriptor

const file_metrics_v1_resource_usage_stats_proto_rawDesc = "" +
	"\n" +
	"%metrics/v1/resource_usage_stats.proto\x12\n" +
	"metrics.v1\x1a\x1ametrics/v1/cpu_usage.proto\x1a\x1bmetrics/v1/disk_usage.proto\x1a\x1dmetrics/v1/memory_usage.proto\x1a\x1emetrics/v1/network_usage.proto\x1a$metrics/v1/resource_data_point.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa6\x02\n" +
	...
	"\x13resource_timeseries\x18\x05 \x03(\v2\x1d.metrics.v1.ResourceDataPointB\b\xbaH\x05\x92\x01\x02\b\x01R\x12resourceTimeseriesB/Z%github.com/jdfalk/gcommon/pkg/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
var file_metrics_v1_resource_usage_stats_proto_depIdxs = []int32{
...
func init() { file_metrics_v1_resource_usage_stats_proto_init() }
func file_metrics_v1_resource_usage_stats_proto_init() {
	if File_metrics_v1_resource_usage_stats_proto != nil {
		return
	}
	file_metrics_v1_cpu_usage_proto_init()
	file_metrics_v1_disk_usage_proto_init()
	file_metrics_v1_memory_usage_proto_init()
	file_metrics_v1_network_usage_proto_init()
	file_metrics_v1_resource_data_point_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_resource_usage_stats_proto_rawDesc), len(file_metrics_v1_resource_usage_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_resource_usage_stats_proto_goTypes,
		DependencyIndexes: file_metrics_v1_resource_usage_stats_proto_depIdxs,
		MessageInfos:      file_metrics_v1_resource_usage_stats_proto_msgTypes,
	}.Build()
	File_metrics_v1_resource_usage_stats_proto = out.File
	file_metrics_v1_resource_usage_stats_proto_goTypes = nil
	file_metrics_v1_resource_usage_stats_proto_depIdxs = nil
}
