...
func (x *UnregisterMetricRequest) Reset() {
	*x = UnregisterMetricRequest{}
	mi := &file_metrics_v1_unregister_metric_request_proto_msgTypes[0]
...
func (x case_UnregisterMetricRequest_MetricIdentifier) String() string {
	md := file_metrics_v1_unregister_metric_request_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_metrics_v1_unregister_metric_request_proto protoreflect.FileDescriptor

const file_metrics_v1_unregister_metric_request_proto_rawDesc = "" +
	"\n" +
	"*metrics/v1/unregister_metric_request.proto\x12\n" +
	"metrics.v1\x1a common/v1/request_metadata.proto\x1a'metrics/v1/unregistration_options.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x91\x02\n" +
	...
	"\x11metric_identifierB/Z%github.com/jdfalk/gcommon/pkg/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_metrics_v1_unregister_metric_request_proto_init() }
func file_metrics_v1_unregister_metric_request_proto_init() {
	if File_metrics_v1_unregister_metric_request_proto != nil {
		return
	}
	file_metrics_v1_unregistration_options_proto_init()
	file_metrics_v1_unregister_metric_request_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_unregister_metric_request_proto_rawDesc), len(file_metrics_v1_unregister_metric_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_unregister_metric_request_proto_goTypes,
		DependencyIndexes: file_metrics_v1_unregister_metric_request_proto_depIdxs,
		MessageInfos:      file_metrics_v1_unregister_metric_request_proto_msgTypes,
	}.Build()
	File_metrics_v1_unregister_metric_request_proto = out.File
	file_metrics_v1_unregister_metric_request_proto_goTypes = nil
	file_metrics_v1_unregister_metric_request_proto_depIdxs = nil
}
