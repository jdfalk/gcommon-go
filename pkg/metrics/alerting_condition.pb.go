...
func (x *AlertingCondition) Reset() {
	*x = AlertingCondition{}
	mi := &file_metrics_v1_alerting_condition_proto_msgTypes[0]
...
var File_metrics_v1_alerting_condition_proto protoreflect.FileDescriptor

const file_metrics_v1_alerting_condition_proto_rawDesc = "" +
	"\n" +
	"#metrics/v1/alerting_condition.proto\x12\n" +
	"metrics.v1\x1a#common/v1/comparison_operator.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd1\x01\n" +
	...
	"\x10duration_seconds\x18\x04 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00R\x0fdurationSecondsB/Z%github.com/jdfalk/gcommon/pkg/metrics\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
...
func init() { file_metrics_v1_alerting_condition_proto_init() }
func file_metrics_v1_alerting_condition_proto_init() {
	if File_metrics_v1_alerting_condition_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metrics_v1_alerting_condition_proto_rawDesc), len(file_metrics_v1_alerting_condition_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metrics_v1_alerting_condition_proto_goTypes,
		DependencyIndexes: file_metrics_v1_alerting_condition_proto_depIdxs,
		MessageInfos:      file_metrics_v1_alerting_condition_proto_msgTypes,
	}.Build()
	File_metrics_v1_alerting_condition_proto = out.File
	file_metrics_v1_alerting_condition_proto_goTypes = nil
	file_metrics_v1_alerting_condition_proto_depIdxs = nil
}
