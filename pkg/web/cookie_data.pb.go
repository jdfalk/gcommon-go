...
func (x *CookieData) Reset() {
	*x = CookieData{}
	mi := &file_web_v1_cookie_data_proto_msgTypes[0]
...
var File_web_v1_cookie_data_proto protoreflect.FileDescriptor

const file_web_v1_cookie_data_proto_rawDesc = "" +
	"\n" +
	"\x18web/v1/cookie_data.proto\x12\x06web.v1\x1a common/v1/cookie_same_site.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x95\x02\n" +
	"\n" +
	"CookieData\x12\x1d\n" +
...
func init() { file_web_v1_cookie_data_proto_init() }
func file_web_v1_cookie_data_proto_init() {
	if File_web_v1_cookie_data_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_web_v1_cookie_data_proto_rawDesc), len(file_web_v1_cookie_data_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_web_v1_cookie_data_proto_goTypes,
		DependencyIndexes: file_web_v1_cookie_data_proto_depIdxs,
		MessageInfos:      file_web_v1_cookie_data_proto_msgTypes,
	}.Build()
	File_web_v1_cookie_data_proto = out.File
	file_web_v1_cookie_data_proto_goTypes = nil
	file_web_v1_cookie_data_proto_depIdxs = nil
}
