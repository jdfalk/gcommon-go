...
// 	protoc        (unknown)
// source: web/v2/template_data.proto
...
func (x *TemplateData) Reset() {
	*x = TemplateData{}
	mi := &file_web_v2_template_data_proto_msgTypes[0]
...
var File_web_v2_template_data_proto protoreflect.FileDescriptor

const file_web_v2_template_data_proto_rawDesc = "" +
	"\n" +
	"\x1aweb/v2/template_data.proto\x12\x06web.v2\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xbf\x01\n" +
	...
	"compiledAtB.Z$github.com/jdfalk/gcommon/pkg/web/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_web_v2_template_data_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_web_v2_template_data_proto_goTypes = []any{
	(*TemplateData)(nil),          // 0: web.v2.TemplateData
	(*anypb.Any)(nil),             // 1: google.protobuf.Any
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_web_v2_template_data_proto_depIdxs = []int32{
...
func init() { file_web_v2_template_data_proto_init() }
func file_web_v2_template_data_proto_init() {
	if File_web_v2_template_data_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_web_v2_template_data_proto_rawDesc), len(file_web_v2_template_data_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_web_v2_template_data_proto_goTypes,
		DependencyIndexes: file_web_v2_template_data_proto_depIdxs,
		MessageInfos:      file_web_v2_template_data_proto_msgTypes,
	}.Build()
	File_web_v2_template_data_proto = out.File
	file_web_v2_template_data_proto_goTypes = nil
	file_web_v2_template_data_proto_depIdxs = nil
}
