...
// 	protoc        (unknown)
// source: web/v2/http_response.proto
...
func (x *HttpResponse) Reset() {
	*x = HttpResponse{}
	mi := &file_web_v2_http_response_proto_msgTypes[0]
...
var File_web_v2_http_response_proto protoreflect.FileDescriptor

const file_web_v2_http_response_proto_rawDesc = "" +
	"\n" +
	"\x1aweb/v2/http_response.proto\x12\x06web.v2\x1a\x15common/v2/error.proto\x1a common/v2/request_metadata.proto\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xcd\v\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B.Z$github.com/jdfalk/gcommon/pkg/web/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_web_v2_http_response_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_web_v2_http_response_proto_goTypes = []any{
...
var file_web_v2_http_response_proto_depIdxs = []int32{
...
func init() { file_web_v2_http_response_proto_init() }
func file_web_v2_http_response_proto_init() {
	if File_web_v2_http_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_web_v2_http_response_proto_rawDesc), len(file_web_v2_http_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_web_v2_http_response_proto_goTypes,
		DependencyIndexes: file_web_v2_http_response_proto_depIdxs,
		MessageInfos:      file_web_v2_http_response_proto_msgTypes,
	}.Build()
	File_web_v2_http_response_proto = out.File
	file_web_v2_http_response_proto_goTypes = nil
	file_web_v2_http_response_proto_depIdxs = nil
}
