...
// 	protoc        (unknown)
// source: web/v2/rate_limit_config.proto
...
func (x *WebRateLimitConfig) Reset() {
	*x = WebRateLimitConfig{}
	mi := &file_web_v2_rate_limit_config_proto_msgTypes[0]
...
var File_web_v2_rate_limit_config_proto protoreflect.FileDescriptor

const file_web_v2_rate_limit_config_proto_rawDesc = "" +
	"\n" +
	"\x1eweb/v2/rate_limit_config.proto\x12\x06web.v2\x1a#common/v2/rate_limit_strategy.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xaa\x02\n" +
	...
	"\x0fskip_conditions\x18\x06 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x0eskipConditionsB.Z$github.com/jdfalk/gcommon/pkg/web/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_web_v2_rate_limit_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_web_v2_rate_limit_config_proto_goTypes = []any{
	(*WebRateLimitConfig)(nil), // 0: web.v2.WebRateLimitConfig
	(v2.RateLimitStrategy)(0),  // 1: common.v2.RateLimitStrategy
}
var file_web_v2_rate_limit_config_proto_depIdxs = []int32{
...
func init() { file_web_v2_rate_limit_config_proto_init() }
func file_web_v2_rate_limit_config_proto_init() {
	if File_web_v2_rate_limit_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_web_v2_rate_limit_config_proto_rawDesc), len(file_web_v2_rate_limit_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_web_v2_rate_limit_config_proto_goTypes,
		DependencyIndexes: file_web_v2_rate_limit_config_proto_depIdxs,
		MessageInfos:      file_web_v2_rate_limit_config_proto_msgTypes,
	}.Build()
	File_web_v2_rate_limit_config_proto = out.File
	file_web_v2_rate_limit_config_proto_goTypes = nil
	file_web_v2_rate_limit_config_proto_depIdxs = nil
}
