...
// 	protoc        (unknown)
// source: web/v2/cookie_data.proto
...
func (x *CookieData) Reset() {
	*x = CookieData{}
	mi := &file_web_v2_cookie_data_proto_msgTypes[0]
...
var File_web_v2_cookie_data_proto protoreflect.FileDescriptor

const file_web_v2_cookie_data_proto_rawDesc = "" +
	"\n" +
	"\x18web/v2/cookie_data.proto\x12\x06web.v2\x1a common/v2/cookie_same_site.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x95\x02\n" +
	"\n" +
	"CookieData\x12\x1d\n" +
	...
	"\tsame_site\x18\b \x01(\x0e2\x19.common.v2.CookieSameSiteR\bsameSiteB.Z$github.com/jdfalk/gcommon/pkg/web/v2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_web_v2_cookie_data_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_web_v2_cookie_data_proto_goTypes = []any{
	(*CookieData)(nil),            // 0: web.v2.CookieData
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
	(v2.CookieSameSite)(0),        // 2: common.v2.CookieSameSite
}
var file_web_v2_cookie_data_proto_depIdxs = []int32{
...
func init() { file_web_v2_cookie_data_proto_init() }
func file_web_v2_cookie_data_proto_init() {
	if File_web_v2_cookie_data_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_web_v2_cookie_data_proto_rawDesc), len(file_web_v2_cookie_data_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_web_v2_cookie_data_proto_goTypes,
		DependencyIndexes: file_web_v2_cookie_data_proto_depIdxs,
		MessageInfos:      file_web_v2_cookie_data_proto_msgTypes,
	}.Build()
	File_web_v2_cookie_data_proto = out.File
	file_web_v2_cookie_data_proto_goTypes = nil
	file_web_v2_cookie_data_proto_depIdxs = nil
}
