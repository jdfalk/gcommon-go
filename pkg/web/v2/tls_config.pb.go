...
// 	protoc        (unknown)
// source: web/v2/tls_config.proto
...
func (x *WebTLSConfig) Reset() {
	*x = WebTLSConfig{}
	mi := &file_web_v2_tls_config_proto_msgTypes[0]
...
var File_web_v2_tls_config_proto protoreflect.FileDescriptor

const file_web_v2_tls_config_proto_rawDesc = "" +
	"\n" +
	"\x17web/v2/tls_config.proto\x12\x06web.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd0\x02\n" +
...
var file_web_v2_tls_config_proto_depIdxs = []int32{
...
func init() { file_web_v2_tls_config_proto_init() }
func file_web_v2_tls_config_proto_init() {
	if File_web_v2_tls_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_web_v2_tls_config_proto_rawDesc), len(file_web_v2_tls_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_web_v2_tls_config_proto_goTypes,
		DependencyIndexes: file_web_v2_tls_config_proto_depIdxs,
		MessageInfos:      file_web_v2_tls_config_proto_msgTypes,
	}.Build()
	File_web_v2_tls_config_proto = out.File
	file_web_v2_tls_config_proto_goTypes = nil
	file_web_v2_tls_config_proto_depIdxs = nil
}
