...
func (x *WebHealthCheckResponse) Reset() {
	*x = WebHealthCheckResponse{}
	mi := &file_web_v1_health_check_response_proto_msgTypes[0]
...
var File_web_v1_health_check_response_proto protoreflect.FileDescriptor

const file_web_v1_health_check_response_proto_rawDesc = "" +
	"\n" +
	"\"web/v1/health_check_response.proto\x12\x06web.v1\x1a\x15common/v1/error.proto\x1a\x1dcommon/v1/health_status.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\"\xbf\x01\n" +
...
func init() { file_web_v1_health_check_response_proto_init() }
func file_web_v1_health_check_response_proto_init() {
	if File_web_v1_health_check_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_web_v1_health_check_response_proto_rawDesc), len(file_web_v1_health_check_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_web_v1_health_check_response_proto_goTypes,
		DependencyIndexes: file_web_v1_health_check_response_proto_depIdxs,
		MessageInfos:      file_web_v1_health_check_response_proto_msgTypes,
	}.Build()
	File_web_v1_health_check_response_proto = out.File
	file_web_v1_health_check_response_proto_goTypes = nil
	file_web_v1_health_check_response_proto_depIdxs = nil
}
