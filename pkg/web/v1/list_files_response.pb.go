...
func (x *ListFilesResponse) Reset() {
	*x = ListFilesResponse{}
	mi := &file_web_v1_list_files_response_proto_msgTypes[0]
...
var File_web_v1_list_files_response_proto protoreflect.FileDescriptor

const file_web_v1_list_files_response_proto_rawDesc = "" +
	"\n" +
	" web/v1/list_files_response.proto\x12\x06web.v1\x1a!common/v1/response_metadata.proto\x1a\x16web/v1/file_info.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xf4\x01\n" +
...
func init() { file_web_v1_list_files_response_proto_init() }
func file_web_v1_list_files_response_proto_init() {
	if File_web_v1_list_files_response_proto != nil {
		return
	}
	file_web_v1_file_info_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_web_v1_list_files_response_proto_rawDesc), len(file_web_v1_list_files_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_web_v1_list_files_response_proto_goTypes,
		DependencyIndexes: file_web_v1_list_files_response_proto_depIdxs,
		MessageInfos:      file_web_v1_list_files_response_proto_msgTypes,
	}.Build()
	File_web_v1_list_files_response_proto = out.File
	file_web_v1_list_files_response_proto_goTypes = nil
	file_web_v1_list_files_response_proto_depIdxs = nil
}
