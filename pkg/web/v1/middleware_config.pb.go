...
func (x *MiddlewareConfig) Reset() {
	*x = MiddlewareConfig{}
	mi := &file_web_v1_middleware_config_proto_msgTypes[0]
...
var File_web_v1_middleware_config_proto protoreflect.FileDescriptor

const file_web_v1_middleware_config_proto_rawDesc = "" +
	"\n" +
	"\x1eweb/v1/middleware_config.proto\x12\x06web.v1\x1a\x1fcommon/v1/middleware_type.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xfd\x01\n" +
...
func init() { file_web_v1_middleware_config_proto_init() }
func file_web_v1_middleware_config_proto_init() {
	if File_web_v1_middleware_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_web_v1_middleware_config_proto_rawDesc), len(file_web_v1_middleware_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_web_v1_middleware_config_proto_goTypes,
		DependencyIndexes: file_web_v1_middleware_config_proto_depIdxs,
		MessageInfos:      file_web_v1_middleware_config_proto_msgTypes,
	}.Build()
	File_web_v1_middleware_config_proto = out.File
	file_web_v1_middleware_config_proto_goTypes = nil
	file_web_v1_middleware_config_proto_depIdxs = nil
}
