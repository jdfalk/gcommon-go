...
// 	protoc        (unknown)
// source: web/v1/http_request.proto
...
func (x *HttpRequest) Reset() {
	*x = HttpRequest{}
	mi := &file_web_v1_http_request_proto_msgTypes[0]
...
func (x *HttpRequest) GetMetadata() *v1.RequestMetadata {
	if x != nil {
...
func (x *HttpRequest) SetMetadata(v *v1.RequestMetadata) {
...
var File_web_v1_http_request_proto protoreflect.FileDescriptor

const file_web_v1_http_request_proto_rawDesc = "" +
	"\n" +
	"\x19web/v1/http_request.proto\x12\x06web.v1\x1a common/v1/request_metadata.proto\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xdc\n" +
	"\n" +
...
var file_web_v1_http_request_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_web_v1_http_request_proto_goTypes = []any{
...
var file_web_v1_http_request_proto_depIdxs = []int32{
...
func init() { file_web_v1_http_request_proto_init() }
func file_web_v1_http_request_proto_init() {
	if File_web_v1_http_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_web_v1_http_request_proto_rawDesc), len(file_web_v1_http_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_web_v1_http_request_proto_goTypes,
		DependencyIndexes: file_web_v1_http_request_proto_depIdxs,
		MessageInfos:      file_web_v1_http_request_proto_msgTypes,
	}.Build()
	File_web_v1_http_request_proto = out.File
	file_web_v1_http_request_proto_goTypes = nil
	file_web_v1_http_request_proto_depIdxs = nil
}
