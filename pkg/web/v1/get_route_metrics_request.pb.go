...
func (x *GetRouteMetricsRequest) Reset() {
	*x = GetRouteMetricsRequest{}
	mi := &file_web_v1_get_route_metrics_request_proto_msgTypes[0]
...
var File_web_v1_get_route_metrics_request_proto protoreflect.FileDescriptor

const file_web_v1_get_route_metrics_request_proto_rawDesc = "" +
	"\n" +
...
func init() { file_web_v1_get_route_metrics_request_proto_init() }
func file_web_v1_get_route_metrics_request_proto_init() {
	if File_web_v1_get_route_metrics_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_web_v1_get_route_metrics_request_proto_rawDesc), len(file_web_v1_get_route_metrics_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_web_v1_get_route_metrics_request_proto_goTypes,
		DependencyIndexes: file_web_v1_get_route_metrics_request_proto_depIdxs,
		MessageInfos:      file_web_v1_get_route_metrics_request_proto_msgTypes,
	}.Build()
	File_web_v1_get_route_metrics_request_proto = out.File
	file_web_v1_get_route_metrics_request_proto_goTypes = nil
	file_web_v1_get_route_metrics_request_proto_depIdxs = nil
}
