...
func (x *HttpResponse) Reset() {
	*x = HttpResponse{}
	mi := &file_web_v1_http_response_proto_msgTypes[0]
...
var File_web_v1_http_response_proto protoreflect.FileDescriptor

const file_web_v1_http_response_proto_rawDesc = "" +
	"\n" +
	"\x1aweb/v1/http_response.proto\x12\x06web.v1\x1a\x15common/v1/error.proto\x1a common/v1/request_metadata.proto\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xcd\v\n" +
...
func init() { file_web_v1_http_response_proto_init() }
func file_web_v1_http_response_proto_init() {
	if File_web_v1_http_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_web_v1_http_response_proto_rawDesc), len(file_web_v1_http_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_web_v1_http_response_proto_goTypes,
		DependencyIndexes: file_web_v1_http_response_proto_depIdxs,
		MessageInfos:      file_web_v1_http_response_proto_msgTypes,
	}.Build()
	File_web_v1_http_response_proto = out.File
	file_web_v1_http_response_proto_goTypes = nil
	file_web_v1_http_response_proto_depIdxs = nil
}
