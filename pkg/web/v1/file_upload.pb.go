...
// 	protoc        (unknown)
// source: web/v1/file_upload.proto
...
func (x *FileUpload) Reset() {
	*x = FileUpload{}
	mi := &file_web_v1_file_upload_proto_msgTypes[0]
...
var File_web_v1_file_upload_proto protoreflect.FileDescriptor

const file_web_v1_file_upload_proto_rawDesc = "" +
	"\n" +
	"\x18web/v1/file_upload.proto\x12\x06web.v1\x1a\x16web/v1/mime_type.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x9f\x01\n" +
	"\n" +
	"FileUpload\x12&\n" +
	...
	"\vdestination\x18\x04 \x01(\tR\vdestinationB+Z!github.com/jdfalk/gcommon/pkg/web\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_web_v1_file_upload_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_web_v1_file_upload_proto_goTypes = []any{
	(*FileUpload)(nil), // 0: web.v1.FileUpload
	(*MimeType)(nil),   // 1: web.v1.MimeType
}
var file_web_v1_file_upload_proto_depIdxs = []int32{
...
func init() { file_web_v1_file_upload_proto_init() }
func file_web_v1_file_upload_proto_init() {
	if File_web_v1_file_upload_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_web_v1_file_upload_proto_rawDesc), len(file_web_v1_file_upload_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_web_v1_file_upload_proto_goTypes,
		DependencyIndexes: file_web_v1_file_upload_proto_depIdxs,
		MessageInfos:      file_web_v1_file_upload_proto_msgTypes,
	}.Build()
	File_web_v1_file_upload_proto = out.File
	file_web_v1_file_upload_proto_goTypes = nil
	file_web_v1_file_upload_proto_depIdxs = nil
}
