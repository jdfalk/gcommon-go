...
// 	protoc        (unknown)
// source: databasepb/v1/query_row_request.proto
...
func (x *QueryRowRequest) Reset() {
	*x = QueryRowRequest{}
	mi := &file_databasepb_v1_query_row_request_proto_msgTypes[0]
...
func (x *QueryRowRequest) GetMetadata() *commonpb.RequestMetadata {
	if x != nil {
...
func (x *QueryRowRequest) SetMetadata(v *commonpb.RequestMetadata) {
...
var File_databasepb_v1_query_row_request_proto protoreflect.FileDescriptor

const file_databasepb_v1_query_row_request_proto_rawDesc = "" +
	"\n" +
	"%databasepb/v1/query_row_request.proto\x12\vdatabase.v1\x1a\"commonpb/v1/request_metadata.proto\x1a!databasepb/v1/query_options.proto\x1a#databasepb/v1/query_parameter.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xbf\x02\n" +
	...
	"\bmetadata\x18\x06 \x01(\v2\x1a.common.v1.RequestMetadataR\bmetadataB\xa6\x01\n" +
	"\x0fcom.database.v1B\x14QueryRowRequestProtoP\x01Z(github.com/jdfalk/gcommon/pkg/databasepb\xa2\x02\x03DXX\xaa\x02\vDatabase.V1\xca\x02\vDatabase\\V1\xe2\x02\x17Database\\V1\\GPBMetadata\xea\x02\fDatabase::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_databasepb_v1_query_row_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_databasepb_v1_query_row_request_proto_goTypes = []any{
...
var file_databasepb_v1_query_row_request_proto_depIdxs = []int32{
	1, // 0: database.v1.QueryRowRequest.parameters:type_name -> database.v1.QueryParameter
	2, // 1: database.v1.QueryRowRequest.options:type_name -> database.v1.QueryOptions
	3, // 2: database.v1.QueryRowRequest.metadata:type_name -> common.v1.RequestMetadata
...
func init() { file_databasepb_v1_query_row_request_proto_init() }
func file_databasepb_v1_query_row_request_proto_init() {
	if File_databasepb_v1_query_row_request_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_databasepb_v1_query_row_request_proto_rawDesc), len(file_databasepb_v1_query_row_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_databasepb_v1_query_row_request_proto_goTypes,
		DependencyIndexes: file_databasepb_v1_query_row_request_proto_depIdxs,
		MessageInfos:      file_databasepb_v1_query_row_request_proto_msgTypes,
	}.Build()
	File_databasepb_v1_query_row_request_proto = out.File
	file_databasepb_v1_query_row_request_proto_goTypes = nil
	file_databasepb_v1_query_row_request_proto_depIdxs = nil
}
