...
// 	protoc        (unknown)
// source: databasepb/v1/column_metadata.proto
...
func (x *ColumnMetadata) Reset() {
	*x = ColumnMetadata{}
	mi := &file_databasepb_v1_column_metadata_proto_msgTypes[0]
...
var File_databasepb_v1_column_metadata_proto protoreflect.FileDescriptor

const file_databasepb_v1_column_metadata_proto_rawDesc = "" +
	"\n" +
	"#databasepb/v1/column_metadata.proto\x12\vdatabase.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x91\x02\n" +
	"\x0eColumnMetadata\x12\x1d\n" +
	...
	"\x05scale\x18\x05 \x01(\x05R\x05scale\x12I\n" +
	"\bmetadata\x18\x06 \x03(\v2).database.v1.ColumnMetadata.MetadataEntryB\x02(\x01R\bmetadata\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xa5\x01\n" +
	"\x0fcom.database.v1B\x13ColumnMetadataProtoP\x01Z(github.com/jdfalk/gcommon/pkg/databasepb\xa2\x02\x03DXX\xaa\x02\vDatabase.V1\xca\x02\vDatabase\\V1\xe2\x02\x17Database\\V1\\GPBMetadata\xea\x02\fDatabase::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_databasepb_v1_column_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_databasepb_v1_column_metadata_proto_goTypes = []any{
	(*ColumnMetadata)(nil), // 0: database.v1.ColumnMetadata
	nil,                    // 1: database.v1.ColumnMetadata.MetadataEntry
}
var file_databasepb_v1_column_metadata_proto_depIdxs = []int32{
	1, // 0: database.v1.ColumnMetadata.metadata:type_name -> database.v1.ColumnMetadata.MetadataEntry
...
func init() { file_databasepb_v1_column_metadata_proto_init() }
func file_databasepb_v1_column_metadata_proto_init() {
	if File_databasepb_v1_column_metadata_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_databasepb_v1_column_metadata_proto_rawDesc), len(file_databasepb_v1_column_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_databasepb_v1_column_metadata_proto_goTypes,
		DependencyIndexes: file_databasepb_v1_column_metadata_proto_depIdxs,
		MessageInfos:      file_databasepb_v1_column_metadata_proto_msgTypes,
	}.Build()
	File_databasepb_v1_column_metadata_proto = out.File
	file_databasepb_v1_column_metadata_proto_goTypes = nil
	file_databasepb_v1_column_metadata_proto_depIdxs = nil
}
