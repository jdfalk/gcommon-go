...
// 	protoc        (unknown)
// source: databasepb/v1/execute_request.proto
...
func (x *ExecuteRequest) Reset() {
	*x = ExecuteRequest{}
	mi := &file_databasepb_v1_execute_request_proto_msgTypes[0]
...
func (x *ExecuteRequest) GetMetadata() *commonpb.RequestMetadata {
	if x != nil {
...
func (x *ExecuteRequest) SetMetadata(v *commonpb.RequestMetadata) {
...
var File_databasepb_v1_execute_request_proto protoreflect.FileDescriptor

const file_databasepb_v1_execute_request_proto_rawDesc = "" +
	"\n" +
	"#databasepb/v1/execute_request.proto\x12\vdatabase.v1\x1a\"commonpb/v1/request_metadata.proto\x1a#databasepb/v1/execute_options.proto\x1a#databasepb/v1/query_parameter.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xcc\x02\n" +
	...
	"\x0etransaction_id\x18\x06 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\rtransactionIdB\xa5\x01\n" +
	"\x0fcom.database.v1B\x13ExecuteRequestProtoP\x01Z(github.com/jdfalk/gcommon/pkg/databasepb\xa2\x02\x03DXX\xaa\x02\vDatabase.V1\xca\x02\vDatabase\\V1\xe2\x02\x17Database\\V1\\GPBMetadata\xea\x02\fDatabase::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_databasepb_v1_execute_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_databasepb_v1_execute_request_proto_goTypes = []any{
...
var file_databasepb_v1_execute_request_proto_depIdxs = []int32{
	1, // 0: database.v1.ExecuteRequest.parameters:type_name -> database.v1.QueryParameter
	2, // 1: database.v1.ExecuteRequest.options:type_name -> database.v1.ExecuteOptions
	3, // 2: database.v1.ExecuteRequest.metadata:type_name -> common.v1.RequestMetadata
...
func init() { file_databasepb_v1_execute_request_proto_init() }
func file_databasepb_v1_execute_request_proto_init() {
	if File_databasepb_v1_execute_request_proto != nil {
		return
	}
	file_databasepb_v1_execute_options_proto_init()
	file_databasepb_v1_query_parameter_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_databasepb_v1_execute_request_proto_rawDesc), len(file_databasepb_v1_execute_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_databasepb_v1_execute_request_proto_goTypes,
		DependencyIndexes: file_databasepb_v1_execute_request_proto_depIdxs,
		MessageInfos:      file_databasepb_v1_execute_request_proto_msgTypes,
	}.Build()
	File_databasepb_v1_execute_request_proto = out.File
	file_databasepb_v1_execute_request_proto_goTypes = nil
	file_databasepb_v1_execute_request_proto_depIdxs = nil
}
