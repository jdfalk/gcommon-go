...
// 	protoc        (unknown)
// source: databasepb/v1/cache_entry.proto
...
func (x *CacheEntry) Reset() {
	*x = CacheEntry{}
	mi := &file_databasepb_v1_cache_entry_proto_msgTypes[0]
...
var File_databasepb_v1_cache_entry_proto protoreflect.FileDescriptor

const file_databasepb_v1_cache_entry_proto_rawDesc = "" +
	"\n" +
	"\x1fdatabasepb/v1/cache_entry.proto\x12\vdatabase.v1\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\x80\x04\n" +
	"\n" +
	"CacheEntry\x12\x10\n" +
	...
	"\bmetadata\x18\b \x03(\v2%.database.v1.CacheEntry.MetadataEntryB\x02(\x01R\bmetadata\x12\x1c\n" +
	"\tnamespace\x18\t \x01(\tR\tnamespace\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xa1\x01\n" +
	"\x0fcom.database.v1B\x0fCacheEntryProtoP\x01Z(github.com/jdfalk/gcommon/pkg/databasepb\xa2\x02\x03DXX\xaa\x02\vDatabase.V1\xca\x02\vDatabase\\V1\xe2\x02\x17Database\\V1\\GPBMetadata\xea\x02\fDatabase::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_databasepb_v1_cache_entry_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_databasepb_v1_cache_entry_proto_goTypes = []any{
	(*CacheEntry)(nil),            // 0: database.v1.CacheEntry
	nil,                           // 1: database.v1.CacheEntry.MetadataEntry
	(*anypb.Any)(nil),             // 2: google.protobuf.Any
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_databasepb_v1_cache_entry_proto_depIdxs = []int32{
	2, // 0: database.v1.CacheEntry.value:type_name -> google.protobuf.Any
	3, // 1: database.v1.CacheEntry.created_at:type_name -> google.protobuf.Timestamp
	3, // 2: database.v1.CacheEntry.last_accessed_at:type_name -> google.protobuf.Timestamp
	3, // 3: database.v1.CacheEntry.expires_at:type_name -> google.protobuf.Timestamp
	1, // 4: database.v1.CacheEntry.metadata:type_name -> database.v1.CacheEntry.MetadataEntry
...
func init() { file_databasepb_v1_cache_entry_proto_init() }
func file_databasepb_v1_cache_entry_proto_init() {
	if File_databasepb_v1_cache_entry_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_databasepb_v1_cache_entry_proto_rawDesc), len(file_databasepb_v1_cache_entry_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_databasepb_v1_cache_entry_proto_goTypes,
		DependencyIndexes: file_databasepb_v1_cache_entry_proto_depIdxs,
		MessageInfos:      file_databasepb_v1_cache_entry_proto_msgTypes,
	}.Build()
	File_databasepb_v1_cache_entry_proto = out.File
	file_databasepb_v1_cache_entry_proto_goTypes = nil
	file_databasepb_v1_cache_entry_proto_depIdxs = nil
}
