...
// 	protoc        (unknown)
// source: databasepb/v1/result_set.proto
...
func (x *ResultSet) Reset() {
	*x = ResultSet{}
	mi := &file_databasepb_v1_result_set_proto_msgTypes[0]
...
var File_databasepb_v1_result_set_proto protoreflect.FileDescriptor

const file_databasepb_v1_result_set_proto_rawDesc = "" +
	"\n" +
	"\x1edatabasepb/v1/result_set.proto\x12\vdatabase.v1\x1a#databasepb/v1/column_metadata.proto\x1a\x17databasepb/v1/row.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xc5\x01\n" +
	"\tResultSet\x12A\n" +
	"\acolumns\x18\x01 \x03(\v2\x1b.database.v1.ColumnMetadataB\n" +
	"\xbaH\x05\x92\x01\x02\b\x01(\x01R\acolumns\x120\n" +
	"\x04rows\x18\x02 \x03(\v2\x10.database.v1.RowB\n" +
	"\xbaH\x05\x92\x01\x02\b\x01(\x01R\x04rows\x12(\n" +
	"\vtotal_count\x18\x03 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\n" +
	"totalCount\x12\x19\n" +
	"\bhas_more\x18\x04 \x01(\bR\ahasMoreB\xa0\x01\n" +
	"\x0fcom.database.v1B\x0eResultSetProtoP\x01Z(github.com/jdfalk/gcommon/pkg/databasepb\xa2\x02\x03DXX\xaa\x02\vDatabase.V1\xca\x02\vDatabase\\V1\xe2\x02\x17Database\\V1\\GPBMetadata\xea\x02\fDatabase::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_databasepb_v1_result_set_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_databasepb_v1_result_set_proto_goTypes = []any{
	(*ResultSet)(nil),      // 0: database.v1.ResultSet
	(*ColumnMetadata)(nil), // 1: database.v1.ColumnMetadata
	(*Row)(nil),            // 2: database.v1.Row
}
var file_databasepb_v1_result_set_proto_depIdxs = []int32{
	1, // 0: database.v1.ResultSet.columns:type_name -> database.v1.ColumnMetadata
	2, // 1: database.v1.ResultSet.rows:type_name -> database.v1.Row
...
func init() { file_databasepb_v1_result_set_proto_init() }
func file_databasepb_v1_result_set_proto_init() {
	if File_databasepb_v1_result_set_proto != nil {
		return
	}
	file_databasepb_v1_column_metadata_proto_init()
	file_databasepb_v1_row_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_databasepb_v1_result_set_proto_rawDesc), len(file_databasepb_v1_result_set_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_databasepb_v1_result_set_proto_goTypes,
		DependencyIndexes: file_databasepb_v1_result_set_proto_depIdxs,
		MessageInfos:      file_databasepb_v1_result_set_proto_msgTypes,
	}.Build()
	File_databasepb_v1_result_set_proto = out.File
	file_databasepb_v1_result_set_proto_goTypes = nil
	file_databasepb_v1_result_set_proto_depIdxs = nil
}
