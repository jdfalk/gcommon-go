...
// 	protoc        (unknown)
// source: databasepb/v1/cockroach_config.proto
...
type CockroachConfig struct {
	...
	xxx_hidden_Database           *string                `protobuf:"bytes,5,opt,name=database"`
	xxx_hidden_SslMode            *string                `protobuf:"bytes,6,opt,name=ssl_mode,json=sslMode"`
	xxx_hidden_ApplicationName    *string                `protobuf:"bytes,7,opt,name=application_name,json=applicationName"`
	xxx_hidden_RetryBackoffFactor float32                `protobuf:"fixed32,8,opt,name=retry_backoff_factor,json=retryBackoffFactor"`
	xxx_hidden_MaxRetries         int32                  `protobuf:"varint,9,opt,name=max_retries,json=maxRetries"`
...
func (x *CockroachConfig) Reset() {
	*x = CockroachConfig{}
	mi := &file_databasepb_v1_cockroach_config_proto_msgTypes[0]
...
func (x *CockroachConfig) GetSslMode() string {
	if x != nil {
		if x.xxx_hidden_SslMode != nil {
			return *x.xxx_hidden_SslMode
		}
		return ""
	}
	return ""
...
func (x *CockroachConfig) GetApplicationName() string {
	if x != nil {
		if x.xxx_hidden_ApplicationName != nil {
...
func (x *CockroachConfig) GetRetryBackoffFactor() float32 {
	if x != nil {
		return x.xxx_hidden_RetryBackoffFactor
	}
	return 0
}
...
func (x *CockroachConfig) SetRetryBackoffFactor(v float32) {
	x.xxx_hidden_RetryBackoffFactor = v
...
func (b0 CockroachConfig_builder) Build() *CockroachConfig {
	...
	if b.SslMode != nil {
		...
		x.xxx_hidden_SslMode = b.SslMode
	}
	if b.ApplicationName != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 6, 9)
		x.xxx_hidden_ApplicationName = b.ApplicationName
	}
	if b.RetryBackoffFactor != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 7, 9)
		x.xxx_hidden_RetryBackoffFactor = *b.RetryBackoffFactor
	}
	if b.MaxRetries != nil {
...
var File_databasepb_v1_cockroach_config_proto protoreflect.FileDescriptor

const file_databasepb_v1_cockroach_config_proto_rawDesc = "" +
	"\n" +
	"$databasepb/v1/cockroach_config.proto\x12\vdatabase.v1\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa9\x02\n" +
	...
	"\bssl_mode\x18\x06 \x01(\tR\asslMode\x124\n" +
	...
	"maxRetriesB\xa6\x01\n" +
	"\x0fcom.database.v1B\x14CockroachConfigProtoP\x01Z(github.com/jdfalk/gcommon/pkg/databasepb\xa2\x02\x03DXX\xaa\x02\vDatabase.V1\xca\x02\vDatabase\\V1\xe2\x02\x17Database\\V1\\GPBMetadata\xea\x02\fDatabase::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_databasepb_v1_cockroach_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_databasepb_v1_cockroach_config_proto_goTypes = []any{
	(*CockroachConfig)(nil), // 0: database.v1.CockroachConfig
}
var file_databasepb_v1_cockroach_config_proto_depIdxs = []int32{
...
func init() { file_databasepb_v1_cockroach_config_proto_init() }
func file_databasepb_v1_cockroach_config_proto_init() {
	if File_databasepb_v1_cockroach_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_databasepb_v1_cockroach_config_proto_rawDesc), len(file_databasepb_v1_cockroach_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_databasepb_v1_cockroach_config_proto_goTypes,
		DependencyIndexes: file_databasepb_v1_cockroach_config_proto_depIdxs,
		MessageInfos:      file_databasepb_v1_cockroach_config_proto_msgTypes,
	}.Build()
	File_databasepb_v1_cockroach_config_proto = out.File
	file_databasepb_v1_cockroach_config_proto_goTypes = nil
	file_databasepb_v1_cockroach_config_proto_depIdxs = nil
}
