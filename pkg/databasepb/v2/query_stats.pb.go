...
// 	protoc        (unknown)
// source: databasepb/v2/query_stats.proto
...
func (x *DatabaseQueryStats) Reset() {
	*x = DatabaseQueryStats{}
	mi := &file_databasepb_v2_query_stats_proto_msgTypes[0]
...
var File_databasepb_v2_query_stats_proto protoreflect.FileDescriptor

const file_databasepb_v2_query_stats_proto_rawDesc = "" +
	"\n" +
	"\x1fdatabasepb/v2/query_stats.proto\x12\vdatabase.v2\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\x89\x02\n" +
	"\x12DatabaseQueryStats\x12D\n" +
	"\x0eexecution_time\x18\x01 \x01(\v2\x19.google.protobuf.DurationB\x02(\x01R\rexecutionTime\x12$\n" +
	"\trow_count\x18\x02 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\browCount\x12*\n" +
	...
	"\rcost_estimate\x18\x05 \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\fcostEstimateB\xa4\x01\n" +
	"\x0fcom.database.v2B\x0fQueryStatsProtoP\x01Z+github.com/jdfalk/gcommon/pkg/databasepb/v2\xa2\x02\x03DXX\xaa\x02\vDatabase.V2\xca\x02\vDatabase\\V2\xe2\x02\x17Database\\V2\\GPBMetadata\xea\x02\fDatabase::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_databasepb_v2_query_stats_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_databasepb_v2_query_stats_proto_goTypes = []any{
	(*DatabaseQueryStats)(nil),  // 0: database.v2.DatabaseQueryStats
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_databasepb_v2_query_stats_proto_depIdxs = []int32{
	1, // 0: database.v2.DatabaseQueryStats.execution_time:type_name -> google.protobuf.Duration
...
func init() { file_databasepb_v2_query_stats_proto_init() }
func file_databasepb_v2_query_stats_proto_init() {
	if File_databasepb_v2_query_stats_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_databasepb_v2_query_stats_proto_rawDesc), len(file_databasepb_v2_query_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_databasepb_v2_query_stats_proto_goTypes,
		DependencyIndexes: file_databasepb_v2_query_stats_proto_depIdxs,
		MessageInfos:      file_databasepb_v2_query_stats_proto_msgTypes,
	}.Build()
	File_databasepb_v2_query_stats_proto = out.File
	file_databasepb_v2_query_stats_proto_goTypes = nil
	file_databasepb_v2_query_stats_proto_depIdxs = nil
}
