...
// 	protoc        (unknown)
// source: databasepb/v2/pebble_config.proto
...
func (x *PebbleConfig) Reset() {
	*x = PebbleConfig{}
	mi := &file_databasepb_v2_pebble_config_proto_msgTypes[0]
...
var File_databasepb_v2_pebble_config_proto protoreflect.FileDescriptor

const file_databasepb_v2_pebble_config_proto_rawDesc = "" +
	"\n" +
	"!databasepb/v2/pebble_config.proto\x12\vdatabase.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xd2\x01\n" +
	"\fPebbleConfig\x12\x1b\n" +
	...
	"\vcompression\x18\x05 \x01(\bR\vcompressionB\xa6\x01\n" +
	"\x0fcom.database.v2B\x11PebbleConfigProtoP\x01Z+github.com/jdfalk/gcommon/pkg/databasepb/v2\xa2\x02\x03DXX\xaa\x02\vDatabase.V2\xca\x02\vDatabase\\V2\xe2\x02\x17Database\\V2\\GPBMetadata\xea\x02\fDatabase::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_databasepb_v2_pebble_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_databasepb_v2_pebble_config_proto_goTypes = []any{
	(*PebbleConfig)(nil), // 0: database.v2.PebbleConfig
}
var file_databasepb_v2_pebble_config_proto_depIdxs = []int32{
...
func init() { file_databasepb_v2_pebble_config_proto_init() }
func file_databasepb_v2_pebble_config_proto_init() {
	if File_databasepb_v2_pebble_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_databasepb_v2_pebble_config_proto_rawDesc), len(file_databasepb_v2_pebble_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_databasepb_v2_pebble_config_proto_goTypes,
		DependencyIndexes: file_databasepb_v2_pebble_config_proto_depIdxs,
		MessageInfos:      file_databasepb_v2_pebble_config_proto_msgTypes,
	}.Build()
	File_databasepb_v2_pebble_config_proto = out.File
	file_databasepb_v2_pebble_config_proto_goTypes = nil
	file_databasepb_v2_pebble_config_proto_depIdxs = nil
}
