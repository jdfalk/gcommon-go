...
// 	protoc        (unknown)
// source: databasepb/v2/execute_request.proto
...
func (x *ExecuteRequest) Reset() {
	*x = ExecuteRequest{}
	mi := &file_databasepb_v2_execute_request_proto_msgTypes[0]
...
func (x *ExecuteRequest) GetMetadata() *v2.RequestMetadata {
	if x != nil {
...
func (x *ExecuteRequest) SetMetadata(v *v2.RequestMetadata) {
...
var File_databasepb_v2_execute_request_proto protoreflect.FileDescriptor

const file_databasepb_v2_execute_request_proto_rawDesc = "" +
	"\n" +
	"#databasepb/v2/execute_request.proto\x12\vdatabase.v2\x1a\"commonpb/v2/request_metadata.proto\x1a#databasepb/v2/execute_options.proto\x1a#databasepb/v2/query_parameter.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xcc\x02\n" +
	"\x0eExecuteRequest\x12%\n" +
	"\tstatement\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\tstatement\x12G\n" +
	"\n" +
	"parameters\x18\x02 \x03(\v2\x1b.database.v2.QueryParameterB\n" +
	"\xbaH\x05\x92\x01\x02\b\x01(\x01R\n" +
	"parameters\x12#\n" +
	"\bdatabase\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\bdatabase\x129\n" +
	"\aoptions\x18\x04 \x01(\v2\x1b.database.v2.ExecuteOptionsB\x02(\x01R\aoptions\x12:\n" +
	"\bmetadata\x18\x05 \x01(\v2\x1a.common.v2.RequestMetadataB\x02(\x01R\bmetadata\x12.\n" +
	"\x0etransaction_id\x18\x06 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\rtransactionIdB\xa8\x01\n" +
	"\x0fcom.database.v2B\x13ExecuteRequestProtoP\x01Z+github.com/jdfalk/gcommon/pkg/databasepb/v2\xa2\x02\x03DXX\xaa\x02\vDatabase.V2\xca\x02\vDatabase\\V2\xe2\x02\x17Database\\V2\\GPBMetadata\xea\x02\fDatabase::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_databasepb_v2_execute_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_databasepb_v2_execute_request_proto_goTypes = []any{
	(*ExecuteRequest)(nil),     // 0: database.v2.ExecuteRequest
	(*QueryParameter)(nil),     // 1: database.v2.QueryParameter
	(*ExecuteOptions)(nil),     // 2: database.v2.ExecuteOptions
	(*v2.RequestMetadata)(nil), // 3: common.v2.RequestMetadata
}
var file_databasepb_v2_execute_request_proto_depIdxs = []int32{
	1, // 0: database.v2.ExecuteRequest.parameters:type_name -> database.v2.QueryParameter
	2, // 1: database.v2.ExecuteRequest.options:type_name -> database.v2.ExecuteOptions
	3, // 2: database.v2.ExecuteRequest.metadata:type_name -> common.v2.RequestMetadata
...
func init() { file_databasepb_v2_execute_request_proto_init() }
func file_databasepb_v2_execute_request_proto_init() {
	if File_databasepb_v2_execute_request_proto != nil {
		return
	}
	file_databasepb_v2_execute_options_proto_init()
	file_databasepb_v2_query_parameter_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_databasepb_v2_execute_request_proto_rawDesc), len(file_databasepb_v2_execute_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_databasepb_v2_execute_request_proto_goTypes,
		DependencyIndexes: file_databasepb_v2_execute_request_proto_depIdxs,
		MessageInfos:      file_databasepb_v2_execute_request_proto_msgTypes,
	}.Build()
	File_databasepb_v2_execute_request_proto = out.File
	file_databasepb_v2_execute_request_proto_goTypes = nil
	file_databasepb_v2_execute_request_proto_depIdxs = nil
}
