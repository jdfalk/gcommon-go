...
// 	protoc        (unknown)
// source: databasepb/v2/get_response.proto
...
func (x *GetResponse) Reset() {
	*x = GetResponse{}
	mi := &file_databasepb_v2_get_response_proto_msgTypes[0]
...
var File_databasepb_v2_get_response_proto protoreflect.FileDescriptor

const file_databasepb_v2_get_response_proto_rawDesc = "" +
	"\n" +
	" databasepb/v2/get_response.proto\x12\vdatabase.v2\x1a\x1fdatabasepb/v2/cache_entry.proto\x1a!google/protobuf/go_features.proto\"s\n" +
	"\vGetResponse\x121\n" +
...
var file_databasepb_v2_get_response_proto_depIdxs = []int32{
...
func init() { file_databasepb_v2_get_response_proto_init() }
func file_databasepb_v2_get_response_proto_init() {
	if File_databasepb_v2_get_response_proto != nil {
		return
	}
	file_databasepb_v2_cache_entry_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_databasepb_v2_get_response_proto_rawDesc), len(file_databasepb_v2_get_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_databasepb_v2_get_response_proto_goTypes,
		DependencyIndexes: file_databasepb_v2_get_response_proto_depIdxs,
		MessageInfos:      file_databasepb_v2_get_response_proto_msgTypes,
	}.Build()
	File_databasepb_v2_get_response_proto = out.File
	file_databasepb_v2_get_response_proto_goTypes = nil
	file_databasepb_v2_get_response_proto_depIdxs = nil
}
