...
// 	protoc        (unknown)
// source: databasepb/v2/cockroach_config.proto
...
func (x *CockroachConfig) Reset() {
	*x = CockroachConfig{}
	mi := &file_databasepb_v2_cockroach_config_proto_msgTypes[0]
...
var File_databasepb_v2_cockroach_config_proto protoreflect.FileDescriptor

const file_databasepb_v2_cockroach_config_proto_rawDesc = "" +
	"\n" +
	"$databasepb/v2/cockroach_config.proto\x12\vdatabase.v2\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa9\x02\n" +
...
var file_databasepb_v2_cockroach_config_proto_depIdxs = []int32{
...
func init() { file_databasepb_v2_cockroach_config_proto_init() }
func file_databasepb_v2_cockroach_config_proto_init() {
	if File_databasepb_v2_cockroach_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_databasepb_v2_cockroach_config_proto_rawDesc), len(file_databasepb_v2_cockroach_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_databasepb_v2_cockroach_config_proto_goTypes,
		DependencyIndexes: file_databasepb_v2_cockroach_config_proto_depIdxs,
		MessageInfos:      file_databasepb_v2_cockroach_config_proto_msgTypes,
	}.Build()
	File_databasepb_v2_cockroach_config_proto = out.File
	file_databasepb_v2_cockroach_config_proto_goTypes = nil
	file_databasepb_v2_cockroach_config_proto_depIdxs = nil
}
