...
// 	protoc        (unknown)
// source: databasepb/v2/query_parameter.proto
...
func (x *QueryParameter) Reset() {
	*x = QueryParameter{}
	mi := &file_databasepb_v2_query_parameter_proto_msgTypes[0]
...
var File_databasepb_v2_query_parameter_proto protoreflect.FileDescriptor

const file_databasepb_v2_query_parameter_proto_rawDesc = "" +
	"\n" +
	"#databasepb/v2/query_parameter.proto\x12\vdatabase.v2\x1a\x19google/protobuf/any.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"s\n" +
...
var file_databasepb_v2_query_parameter_proto_depIdxs = []int32{
...
func init() { file_databasepb_v2_query_parameter_proto_init() }
func file_databasepb_v2_query_parameter_proto_init() {
	if File_databasepb_v2_query_parameter_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_databasepb_v2_query_parameter_proto_rawDesc), len(file_databasepb_v2_query_parameter_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_databasepb_v2_query_parameter_proto_goTypes,
		DependencyIndexes: file_databasepb_v2_query_parameter_proto_depIdxs,
		MessageInfos:      file_databasepb_v2_query_parameter_proto_msgTypes,
	}.Build()
	File_databasepb_v2_query_parameter_proto = out.File
	file_databasepb_v2_query_parameter_proto_goTypes = nil
	file_databasepb_v2_query_parameter_proto_depIdxs = nil
}
