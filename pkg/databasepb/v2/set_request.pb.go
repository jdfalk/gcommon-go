...
// 	protoc        (unknown)
// source: databasepb/v2/set_request.proto
...
func (x *SetRequest) Reset() {
	*x = SetRequest{}
	mi := &file_databasepb_v2_set_request_proto_msgTypes[0]
...
func (x *SetRequest) GetMetadata() *v2.RequestMetadata {
	if x != nil {
...
func (x *SetRequest) SetMetadata(v *v2.RequestMetadata) {
...
var File_databasepb_v2_set_request_proto protoreflect.FileDescriptor

const file_databasepb_v2_set_request_proto_rawDesc = "" +
	"\n" +
	"\x1fdatabasepb/v2/set_request.proto\x12\vdatabase.v2\x1a\"commonpb/v2/request_metadata.proto\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\x1a!google/protobuf/go_features.proto\x1a\x1bbuf/validate/validate.proto\"\xa2\x03\n" +
	"\n" +
	"SetRequest\x12\x19\n" +
	...
	"\bmetadata\x18\x05 \x01(\v2\x1a.common.v2.RequestMetadataB\x02(\x01R\bmetadata\x12\x1c\n" +
	"\toverwrite\x18\x06 \x01(\bR\toverwrite\x12U\n" +
	"\x0eentry_metadata\x18\a \x03(\v2*.database.v2.SetRequest.EntryMetadataEntryB\x02(\x01R\rentryMetadata\x1a@\n" +
	"\x12EntryMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xa4\x01\n" +
	"\x0fcom.database.v2B\x0fSetRequestProtoP\x01Z+github.com/jdfalk/gcommon/pkg/databasepb/v2\xa2\x02\x03DXX\xaa\x02\vDatabase.V2\xca\x02\vDatabase\\V2\xe2\x02\x17Database\\V2\\GPBMetadata\xea\x02\fDatabase::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_databasepb_v2_set_request_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_databasepb_v2_set_request_proto_goTypes = []any{
	(*SetRequest)(nil),          // 0: database.v2.SetRequest
	nil,                         // 1: database.v2.SetRequest.EntryMetadataEntry
	(*anypb.Any)(nil),           // 2: google.protobuf.Any
	(*durationpb.Duration)(nil), // 3: google.protobuf.Duration
	(*v2.RequestMetadata)(nil),  // 4: common.v2.RequestMetadata
}
var file_databasepb_v2_set_request_proto_depIdxs = []int32{
	2, // 0: database.v2.SetRequest.value:type_name -> google.protobuf.Any
	3, // 1: database.v2.SetRequest.ttl:type_name -> google.protobuf.Duration
	4, // 2: database.v2.SetRequest.metadata:type_name -> common.v2.RequestMetadata
	1, // 3: database.v2.SetRequest.entry_metadata:type_name -> database.v2.SetRequest.EntryMetadataEntry
...
func init() { file_databasepb_v2_set_request_proto_init() }
func file_databasepb_v2_set_request_proto_init() {
	if File_databasepb_v2_set_request_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_databasepb_v2_set_request_proto_rawDesc), len(file_databasepb_v2_set_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_databasepb_v2_set_request_proto_goTypes,
		DependencyIndexes: file_databasepb_v2_set_request_proto_depIdxs,
		MessageInfos:      file_databasepb_v2_set_request_proto_msgTypes,
	}.Build()
	File_databasepb_v2_set_request_proto = out.File
	file_databasepb_v2_set_request_proto_goTypes = nil
	file_databasepb_v2_set_request_proto_depIdxs = nil
}
